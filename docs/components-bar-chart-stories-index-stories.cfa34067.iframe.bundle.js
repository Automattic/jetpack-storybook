(()=>{(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[1383],{"../charts/src/components/bar-chart/stories/index.stories.tsx":(g,m,n)=>{var _,v,y,f,x,O,E,D,b,j,P,S,w,T,R,A,L,W,B,M,C;"use strict";n.r(m),n.d(m,{Default:()=>c,ErrorStates:()=>r,FixedDimensions:()=>t,ManyDataSeries:()=>e,SingleSeries:()=>h,WithLegend:()=>s,WithVerticalLegend:()=>a,__namedExportsOrder:()=>p,default:()=>l});var u=n("../charts/src/components/bar-chart/bar-chart.tsx"),o=n("../charts/src/components/bar-chart/stories/sample-data.ts"),d=n("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const l={title:"JS Packages/Charts/Types/Bar Chart",component:u.A,parameters:{layout:"centered"},decorators:[I=>(0,d.jsx)("div",{style:{resize:"both",overflow:"auto",padding:"2rem",width:"800px",maxWidth:"1200px",border:"1px dashed #ccc",display:"inline-block"},children:(0,d.jsx)(I,{})})]},c={args:{withTooltips:!0,data:[o.A[0],o.A[1],o.A[2]],showLegend:!1,legendOrientation:"horizontal",gridVisibility:"x"}},h={args:{...c.args,data:[o.A[0]]},parameters:{docs:{description:{story:"Bar chart with a single data series."}}}},e={args:{...c.args,data:o.A},parameters:{docs:{description:{story:"Bar chart with many data series."}}}},s={args:{...c.args,data:o.A,showTooltips:!0,showLegend:!0,legendOrientation:"horizontal"}},a={args:{...s.args,data:[o.A[0]],showLegend:!0,legendOrientation:"vertical"}},t={args:{...c.args,width:800,height:400,data:[o.A[0],o.A[1],o.A[2]]},parameters:{docs:{description:{story:"Bar chart with fixed dimensions that override the responsive behavior."}}}},r={render:()=>(0,d.jsxs)("div",{style:{display:"grid",gap:"20px"},children:[(0,d.jsxs)("div",{children:[(0,d.jsx)("h3",{children:"Empty Data"}),(0,d.jsx)("div",{style:{width:"400px",height:"300px"},children:(0,d.jsx)(u.A,{data:[]})})]}),(0,d.jsxs)("div",{children:[(0,d.jsx)("h3",{children:"Invalid Data"}),(0,d.jsx)("div",{style:{width:"400px",height:"300px"},children:(0,d.jsx)(u.A,{data:[{label:"Invalid Series",data:[{date:new Date("invalid"),value:10,label:"Invalid Date"},{date:new Date("2024-01-02"),value:null,label:"Null Value"}],options:{}}]})})]})]})};r.parameters={docs:{description:{story:"Examples of how the bar chart handles various error states including empty data and invalid data."}}};const p=["Default","SingleSeries","ManyDataSeries","WithLegend","WithVerticalLegend","FixedDimensions","ErrorStates"];c.parameters={...c.parameters,docs:{...(_=c.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    withTooltips: true,
...
}`,...(y=(v=c.parameters)==null?void 0:v.docs)==null?void 0:y.source}}},h.parameters={...h.parameters,docs:{...(f=h.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    data: [data[0]]
  },
...
}`,...(O=(x=h.parameters)==null?void 0:x.docs)==null?void 0:O.source}}},e.parameters={...e.parameters,docs:{...(E=e.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    data
  },
...
}`,...(b=(D=e.parameters)==null?void 0:D.docs)==null?void 0:b.source}}},s.parameters={...s.parameters,docs:{...(j=s.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    data,
    showTooltips: true,
...
}`,...(S=(P=s.parameters)==null?void 0:P.docs)==null?void 0:S.source}}},a.parameters={...a.parameters,docs:{...(w=a.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    ...WithLegend.args,
    data: [data[0]],
    showLegend: true,
...
}`,...(R=(T=a.parameters)==null?void 0:T.docs)==null?void 0:R.source}}},t.parameters={...t.parameters,docs:{...(A=t.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    width: 800,
    height: 400,
...
}`,...(W=(L=t.parameters)==null?void 0:L.docs)==null?void 0:W.source}}},r.parameters={...r.parameters,docs:{...(B=r.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'grid',
    gap: '20px'
  }}>
