"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[3665],{"../../../node_modules/.pnpm/@storybook+addon-actions@8.5.8_storybook@8.5.8/node_modules/@storybook/addon-actions/dist/index.mjs":(i,s,e)=>{e.d(s,{XI:()=>E});var n=e("storybook/internal/preview-api"),t=e("storybook/internal/preview-errors"),d=e("@storybook/global"),o=e("../../../node_modules/.pnpm/uuid@9.0.1/node_modules/uuid/dist/esm-browser/v4.js"),B="actions",w="storybook/actions",j=null,p=`${w}/action-event`,R=null,U="$___storybook.isCyclic",v={depth:10,clearOnStoryChange:!0,limit:50},P=(l={})=>{Object.assign(v,l)},x=(l,a)=>{let r=Object.getPrototypeOf(l);return!r||a(r)?r:x(r,a)},u=l=>!!(typeof l=="object"&&l&&x(l,a=>/^Synthetic(?:Base)?Event$/.test(a.constructor.name))&&typeof l.persist=="function"),O=l=>{if(u(l)){let a=Object.create(l.constructor.prototype,Object.getOwnPropertyDescriptors(l));a.persist();let r=Object.getOwnPropertyDescriptor(a,"view"),c=r?.value;return typeof c=="object"&&c?.constructor.name==="Window"&&Object.defineProperty(a,"view",{...r,value:Object.create(c.constructor.prototype)}),a}return l},_=()=>typeof crypto=="object"&&typeof crypto.getRandomValues=="function"?(0,o.A)():Date.now().toString(36)+Math.random().toString(36).substring(2);function E(l,a={}){let r={...v,...a},c=function(...g){if(a.implicit){let M=("__STORYBOOK_PREVIEW__"in d.global?d.global.__STORYBOOK_PREVIEW__:void 0)?.storyRenders.find(h=>h.phase==="playing"||h.phase==="rendering");if(M){let h=!window?.FEATURES?.disallowImplicitActionsInRenderV8,T=new t.ImplicitActionsDuringRendering({phase:M.phase,name:l,deprecated:h});if(h)console.warn(T);else throw T}}let m=n.addons.getChannel(),D=_(),b=5,C=g.map(O),L=g.length>1?C:C[0],y={id:D,count:0,data:{name:l,args:L},options:{...r,maxDepth:b+(r.depth||3),allowFunction:r.allowFunction||!1}};m.emit(p,y)};return c.isAction=!0,c.implicit=a.implicit,c}var A=(...l)=>{let a=v,r=l;r.length===1&&Array.isArray(r[0])&&([r]=r),r.length!==1&&typeof r[r.length-1]!="string"&&(a={...v,...r.pop()});let c=r[0];(r.length!==1||typeof c=="string")&&(c={},r.forEach(m=>{c[m]=m}));let g={};return Object.keys(c).forEach(m=>{g[m]=E(c[m],a)}),g}},"../ai-client/src/components/ai-control/stories/block-ai-control.stories.tsx":(i,s,e)=>{e.r(s),e.d(s,{Default:()=>u,__namedExportsOrder:()=>O,default:()=>v});var n=e("../../../node_modules/.pnpm/@storybook+addon-actions@8.5.8_storybook@8.5.8/node_modules/@storybook/addon-actions/dist/index.mjs"),t=e("storybook/internal/preview-api"),d=e.n(t),o=e("../../../node_modules/.pnpm/@wordpress+components@29.5.0_@types+react@18.3.18_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/notice/index.js"),B=e("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),w=e("../ai-client/src/components/message/index.tsx"),j=e("../ai-client/src/components/ai-control/index.tsx"),p=e("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),R=`/**
...
`,U={Default:{startLoc:{col:24,line:69},endLoc:{col:1,line:124},startBody:{col:24,line:69},endBody:{col:1,line:124}}};const v={title:"JS Packages/AI Client/AI Control/Block AI Control",component:j.N0,decorators:[_=>(0,p.jsx)("div",{style:{backgroundColor:"white"},children:(0,p.jsx)(_,{})})],argTypes:{state:{control:{type:"select"},options:["init","requesting","suggesting","done","error"]},error:{control:{type:"select"},options:["None","Error notice"],mapping:{None:null,"Error notice":(0,p.jsx)(o.A,{status:"error",isDismissible:!0,children:"Error message"})}},customFooter:{control:{type:"select"},options:["None","Guideline message","Error message","Upgrade message"],mapping:{None:null,"Guideline message":(0,p.jsx)(w.Yj,{}),"Error message":(0,p.jsx)(w.Kw,{onTryAgainClick:(0,n.XI)("onTryAgainClick"),onUpgradeClick:(0,n.XI)("onUpgradeClick")}),"Upgrade message":(0,p.jsx)(w.AK,{requestsRemaining:10,onUpgradeClick:(0,n.XI)("onUpgradeClick")})}}},parameters:{storySource:{source:`/**
 * External dependencies
 */
import { action } from '@storybook/addon-actions';
import { useArgs } from '@storybook/preview-api';
...
export const Default = DefaultTemplate.bind({});
Default.args = DefaultArgs;`,locationsMap:{default:{startLoc:{col:24,line:69},endLoc:{col:1,line:124},startBody:{col:24,line:69},endBody:{col:1,line:124}}}},controls:{exclude:/on[A-Z].*/}}},P=_=>{const[{value:E},A,l]=(0,t.useArgs)(),a=D=>{A({value:D,showAccept:!1}),_?.onChange?.(D)},r=()=>{A({state:"requesting",error:null,showAccept:!1}),setTimeout(()=>{A({state:"suggesting"}),setTimeout(()=>{A({state:"done",showAccept:!0})},3e3)},1e3),_?.onSend?.(E)},c=()=>{A({state:"done",error:null,showAccept:!0}),_?.onStop?.()},g=()=>{l(),_?.onAccept?.()},m=()=>{l(),_?.onDiscard?.()};return(0,p.jsx)(j.N0,{..._,onChange:a,onSend:r,onStop:c,onAccept:g,onDiscard:m,value:_?.value??E})},x={value:"",placeholder:"Placeholder",acceptLabel:"Accept",showButtonLabels:!0,disabled:!1,isTransparent:!1,state:"init",showAccept:!1,showGuideLine:!0,customFooter:null,onChange:(0,n.XI)("onChange"),onSend:(0,n.XI)("onSend"),onStop:(0,n.XI)("onStop"),onAccept:(0,n.XI)("onAccept"),onDiscard:(0,n.XI)("onDiscard"),showRemove:!1,banner:null,error:null},u=P.bind({});u.args=x;const O=["Default"];u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`args => {
  const [{
    value
  }, updateArgs, resetArgs] = useArgs();
  const handleChange = (newValue: string) => {
