...
`,B={Default:{startLoc:{col:23,line:7},endLoc:{col:53,line:7},startBody:{col:23,line:7},endBody:{col:53,line:7}},Disabled:{startLoc:{col:24,line:13},endLoc:{col:54,line:13},startBody:{col:24,line:13},endBody:{col:54,line:13}}};const P={parameters:{storySource:{source:`import React from 'react';
import Textarea from '..';
export default {
  title: 'Plugins/Protect/Textarea',
  component: Textarea
