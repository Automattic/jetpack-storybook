...
}`,...j.parameters?.docs?.source}}}},"../charts/src/components/pie-chart/pie-chart.tsx":(y,d,e)=>{e.d(d,{A:()=>se});var l=e("../../../node_modules/.pnpm/@visx+group@3.12.0_react@18.3.1/node_modules/@visx/group/esm/Group.js"),o=e("../../../node_modules/.pnpm/@visx+shape@3.12.0_react@18.3.1/node_modules/@visx/shape/esm/shapes/Pie.js"),a=e("../../../node_modules/.pnpm/clsx@2.1.1/node_modules/clsx/dist/clsx.mjs"),s=e("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),n=e("../../../node_modules/.pnpm/@visx+event@3.12.0/node_modules/@visx/event/esm/localPoint.js"),u=e("../../../node_modules/.pnpm/@visx+tooltip@3.12.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@visx/tooltip/esm/hooks/useTooltip.js");const C=({withTooltips:r})=>{const{tooltipOpen:M,tooltipLeft:b,tooltipTop:v,tooltipData:E,hideTooltip:I,showTooltip:W}=(0,u.A)(),L=(0,s.useCallback)((P,O)=>{if(!r)return;const R=(0,n.A)(P);R&&W({tooltipData:O,tooltipLeft:R.x,tooltipTop:R.y-10})},[r,W]),N=(0,s.useCallback)(()=>{r&&I()},[r,I]);return{onMouseMove:L,onMouseLeave:N,tooltipOpen:M,tooltipData:E||null,tooltipLeft:b,tooltipTop:v}};var A=e("../charts/src/providers/chart-context/utils.ts"),p=e("../charts/src/providers/chart-context/global-charts-provider.tsx"),i=e("../charts/src/providers/theme/theme-provider.tsx"),h=e("../charts/src/providers/theme/themes.ts"),_=e("../charts/src/components/legend/legend.tsx"),g=e("../charts/src/components/legend/use-chart-legend-data.ts"),f=e("../charts/src/components/shared/use-element-height.ts"),S=e("../charts/src/components/shared/with-responsive.tsx"),T=e("../charts/src/components/tooltip/base-tooltip.tsx"),D=e("../../../node_modules/.pnpm/style-loader@2.0.0_webpack@5.94.0/node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js"),j=e.n(D),V=e("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.94.0/node_modules/css-loader/dist/cjs.js!../../../node_modules/.pnpm/postcss-loader@8.1.1_postcss@8.4.47_typescript@5.8.3_webpack@5.94.0/node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[14].use[2]!../../../node_modules/.pnpm/sass-loader@16.0.5_sass-embedded@1.87.0_webpack@5.94.0/node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[3]!../charts/src/components/pie-chart/pie-chart.module.scss"),U={};U.insert="head",U.singleton=!1;var Pe=j()(V.A,U);const z=V.A.locals||{};var c=e("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const ne=r=>{if(!r.length)return{isValid:!1,message:"No data available"};if(r.some(v=>v.percentage<0||v.value<0))return{isValid:!1,message:"Invalid data: Negative values are not allowed"};const b=r.reduce((v,E)=>v+E.percentage,0);return Math.abs(b-100)>.01?{isValid:!1,message:"Invalid percentage total: Must equal 100"}:{isValid:!0,message:""}},Y=({data:r,chartId:M,withTooltips:b=!1,className:v,showLegend:E=!1,legendOrientation:I="horizontal",legendAlignmentHorizontal:W="center",legendAlignmentVertical:L="bottom",legendShape:N="circle",size:P,thickness:O=1,padding:R=20,gapScale:H=0,cornerScale:B=0,children:oe=null})=>{const k=(0,i.RW)(),Q=(0,A.R)(M),[ae,re]=(0,f.v)(),{onMouseMove:le,onMouseLeave:ie,tooltipOpen:de,tooltipData:X,tooltipLeft:ce,tooltipTop:pe}=C({withTooltips:b}),ue=(0,s.useMemo)(()=>({showValues:!0}),[]),$=(0,g.B)(r,k,ue),{isValid:J,message:me}=ne(r),he=(0,s.useMemo)(()=>({thickness:O,gapScale:H,cornerScale:B}),[O,H,B]);if((0,A.t)(Q,$,k,"pie",J,he),!J)return(0,c.jsx)("div",{className:(0,a.A)("pie-chart",z["pie-chart"],v),children:(0,c.jsx)("div",{className:z["error-message"],children:me})});const Z=P,q=P,K=E&&L==="top"?q-re:q,_e=Math.min(Z,K)/2,ge=Z/2,fe=K/2,ve=H*(2*Math.PI/r.length),w=_e-R,ee=O===0?0:w*(1-O),xe=(w-ee)/2,ye=B?Math.min(B*w,xe):0,Ae=r.map((m,x)=>({...m,index:x})),te={value:m=>m.value,fill:m=>m?.color||k.colors[m.index]};return(0,c.jsxs)("div",{className:(0,a.A)("pie-chart",z["pie-chart"],v),style:{display:"flex",flexDirection:E&&L==="top"?"column-reverse":"column"},children:[(0,c.jsx)("svg",{viewBox:`0 0 ${P} ${K}`,preserveAspectRatio:"xMidYMid meet",width:P,height:K,children:(0,c.jsxs)(l.A,{top:fe,left:ge,children:[(0,c.jsx)(o.A,{data:Ae,pieValue:te.value,outerRadius:w,innerRadius:ee,padAngle:ve,cornerRadius:ye,children:m=>m.arcs.map((x,Se)=>{const[Te,De]=m.path.centroid(x),je=x.endAngle-x.startAngle>=.25,be=Ee=>le(Ee,x.data),G={d:m.path(x)||"",fill:te.fill(x.data)};return b&&(G.onMouseMove=be,G.onMouseLeave=ie),(0,c.jsxs)("g",{children:[(0,c.jsx)("path",{...G}),je&&(0,c.jsx)("text",{x:Te,y:De,dy:".33em",fill:k.labelBackgroundColor||h.zQ.labelBackgroundColor,fontSize:12,textAnchor:"middle",pointerEvents:"none",children:x.data.label})]},`arc-${Se}`)})}),oe]})}),E&&(0,c.jsx)(_.s,{items:$,orientation:I,alignmentHorizontal:W,alignmentVertical:L,className:z["pie-chart-legend"],shape:N,ref:ae,chartId:Q}),b&&de&&X&&(0,c.jsx)(T.R,{data:X,top:pe||0,left:ce||0,style:{transform:"translate(-50%, -100%)"}})]})},F=r=>(0,s.useContext)(p.mJ)?(0,c.jsx)(Y,{...r}):(0,c.jsx)(p.Sx,{children:(0,c.jsx)(Y,{...r})});F.displayName="PieChart";const se=(0,S.F)(F);try{piechart.displayName="piechart",piechart.__docgenInfo={description:"",displayName:"piechart",props:{size:{defaultValue:null,description:"Size of the chart in pixels for pie and donut charts",name:"size",required:!1,type:{name:"number"}},height:{defaultValue:null,description:"Height of the chart in pixels",name:"height",required:!1,type:{name:"number"}},width:{defaultValue:null,description:"Width of the chart in pixels",name:"width",required:!1,type:{name:"number"}},className:{defaultValue:null,description:"Additional CSS class name for the chart container",name:"className",required:!1,type:{name:"string"}},children:{defaultValue:{value:"null"},description:"Use the children prop to render additional elements on the chart.",name:"children",required:!1,type:{name:"ReactNode"}},data:{defaultValue:null,description:"Array of data points to display in the chart",name:"data",required:!0,type:{name:"DataPointPercentage[]"}},options:{defaultValue:null,description:"More options for the chart.",name:"options",required:!1,type:{name:"{ yScale?: ScaleOptions; xScale?: ScaleOptions; axis?: { x?: AxisOptions; y?: AxisOptions; }; }"}},onPointerDown:{defaultValue:null,description:"Callback function for pointer down event",name:"onPointerDown",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerMove:{defaultValue:null,description:"Callback function for pointer move event",name:"onPointerMove",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerUp:{defaultValue:null,description:"Callback function for pointer up event",name:"onPointerUp",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerOut:{defaultValue:null,description:"Callback function for pointer out event",name:"onPointerOut",required:!1,type:{name:"(event: PointerEvent<Element>) => void"}},thickness:{defaultValue:{value:"1"},description:`Thickness of the pie chart.
