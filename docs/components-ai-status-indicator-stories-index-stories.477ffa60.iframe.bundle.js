...
Done.args = {
  state: 'done',
  size: 48
};`,locationsMap:{default:{startLoc:{col:24,line:33},endLoc:{col:1,line:41},startBody:{col:24,line:33},endBody:{col:1,line:41}},init:{startLoc:{col:24,line:33},endLoc:{col:1,line:41},startBody:{col:24,line:33},endBody:{col:1,line:41}},requesting:{startLoc:{col:24,line:33},endLoc:{col:1,line:41},startBody:{col:24,line:33},endBody:{col:1,line:41}},suggesting:{startLoc:{col:24,line:33},endLoc:{col:1,line:41},startBody:{col:24,line:33},endBody:{col:1,line:41}},error:{startLoc:{col:24,line:33},endLoc:{col:1,line:41},startBody:{col:24,line:33},endBody:{col:1,line:41}},done:{startLoc:{col:24,line:33},endLoc:{col:1,line:41},startBody:{col:24,line:33},endBody:{col:1,line:41}}}}},title:"JS Packages/AI Client/AiStatusIndicator",component:d.A,argTypes:{state:{control:{type:"select"},options:["init","requesting","suggesting","done","error"]},size:{control:{type:"select"},options:[24,32,48,64]},action:{table:{disable:!0}}}},o=j=>{const f={state:j.state,size:j.size};return(0,u.jsx)(d.A,{...f})},r=o.bind({});r.args={state:"init",size:24};const t=o.bind({});t.args={state:"init",size:48};const s=o.bind({});s.args={state:"requesting",size:48};const n=o.bind({});n.args={state:"suggesting",size:48};const c=o.bind({});c.args={state:"error",size:48};const l=o.bind({});l.args={state:"done",size:48};const y=["_default","Init","Requesting","Suggesting","Error","Done"];r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`(args: AiStatusIndicatoryStoryProps) => {
  const props: AiStatusIndicatorProps = {
    state: args.state,
    size: args.size
  };
