"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[4696],{"../charts/src/components/legend/stories/index.stories.tsx":(P,y,i)=>{i.r(y),i.d(y,{Horizontal:()=>d,Vertical:()=>_,WithLongLabels:()=>u,__namedExportsOrder:()=>b,default:()=>m});var o=i("../charts/src/components/legend/base-legend.tsx"),x=`import { Meta, StoryObj } from '@storybook/react';
