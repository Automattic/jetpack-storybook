"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[53,977],{"../charts/src/charts/sparkline/stories/index.docs.mdx"(L,y,i){i.r(y),i.d(y,{default:()=>o});var S=i("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=i("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),f=i("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.28_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),r=i("../../../node_modules/.pnpm/@storybook+addon-docs@10.2.11_@types+react@18.3.28_esbuild@0.25.9_storybook@10.2.11_@te_623b11407ff81c3407704a8a948465b9/node_modules/@storybook/addon-docs/dist/blocks.js"),s=i("../charts/src/charts/sparkline/stories/index.stories.tsx");function l(u){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...(0,f.R)(),...u.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(r.W8,{title:"JS Packages/Charts Library/Charts/Sparkline",of:s}),`
...
`]})]})}function o(u={}){const{wrapper:t}={...(0,f.R)(),...u.components};return t?(0,e.jsx)(t,{...u,children:(0,e.jsx)(l,{...u})}):l(u)}},"../charts/src/charts/sparkline/stories/index.stories.tsx"(L,y,i){i.r(y),i.d(y,{Animation:()=>k,AspectRatio:()=>A,Dashboard:()=>R,Default:()=>g,EmptyData:()=>T,Responsive:()=>O,SinglePoint:()=>E,TwoPoints:()=>v,__namedExportsOrder:()=>q,default:()=>K});var S=i("../../../node_modules/.pnpm/clsx@2.1.1/node_modules/clsx/dist/clsx.mjs"),e=i("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),f=i("../charts/src/providers/chart-context/hooks/use-global-charts-theme.ts"),r=i("../charts/src/charts/line-chart/line-chart.tsx"),s=i("../charts/src/charts/private/with-responsive/with-responsive.tsx"),l=i("../../../node_modules/.pnpm/style-loader@2.0.0_webpack@5.105.2/node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js"),o=i.n(l),u=i("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.105.2/node_modules/css-loader/dist/cjs.js!../../../node_modules/.pnpm/postcss-loader@8.2.0_postcss@8.5.6_typescript@5.9.3_webpack@5.105.2/node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[14].use[2]!../../../node_modules/.pnpm/sass-loader@16.0.5_sass-embedded@1.97.2_webpack@5.105.2/node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[3]!../charts/src/charts/sparkline/sparkline.module.scss"),t={};t.insert="head",t.singleton=!1;var I=o()(u.A,t);const m=u.A.locals||{};var d=i("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const x=100,C=40,j=(h,b,D)=>{const w=new Date(2e3,0,1);return[{label:"sparkline",data:h.map((M,Y)=>({date:new Date(w.getTime()+Y*864e5),value:M})),options:{stroke:b,seriesLineStyle:D?{strokeWidth:D}:void 0}}]},n=(0,e.forwardRef)(({data:h,width:b=x,height:D=C,color:w,strokeWidth:M,withGradientFill:Y=!0,gradient:N,className:F,chartId:$,margin:H,animation:Z},W)=>{const U=(0,f.p)(),X=U.sparkline?.strokeWidth??1.5,V=M??X,P=(0,e.useMemo)(()=>!h||h.length===0?[]:j(h,w,V),[h,w,V]),J=(0,e.useMemo)(()=>{const B=U.sparkline?.margin??{top:2,right:2,bottom:2,left:2};return{...B,...H??B}},[H,U.sparkline?.margin]),Q=(0,e.useMemo)(()=>!N||P.length===0?P:P.map(B=>({...B,options:{...B.options,gradient:{from:N.from||w||"#000000",to:N.to||"#ffffff",fromOpacity:N.fromOpacity??.5,toOpacity:N.toOpacity??0}}})),[P,N,w]);if(!h||h.length===0)return(0,d.jsx)("div",{ref:W,className:(0,S.A)("sparkline",m.sparkline,m["sparkline--empty"],F),style:{width:b,height:D},"data-testid":"sparkline-empty"});if(h.length===1){const B=b/2,G=D/2,ee=w||"#000000";return(0,d.jsx)("div",{ref:W,className:(0,S.A)("sparkline",m.sparkline,m["sparkline--single-point"],F),style:{width:b,height:D},"data-testid":"sparkline-single-point",children:(0,d.jsx)("svg",{width:b,height:D,"aria-hidden":"true",children:(0,d.jsx)("circle",{cx:B,cy:G,r:V*1.5,fill:ee})})})}return(0,d.jsx)("div",{ref:W,className:(0,S.A)("sparkline",m.sparkline,F),"data-testid":"sparkline",children:(0,d.jsx)(r.W,{data:Q,width:b,height:D,margin:J,chartId:$,withGradientFill:Y,withTooltips:!1,showLegend:!1,gridVisibility:"none",options:{axis:{x:{display:!1},y:{display:!1}}},curveType:"monotone",animation:Z})})});n.displayName="SparklineComponent";const a=n;a.displayName="SparklineUnresponsive";const c=(0,s.F)(a);try{ResponsiveChart.displayName="ResponsiveChart",ResponsiveChart.__docgenInfo={description:"",displayName:"ResponsiveChart",props:{className:{defaultValue:null,description:"Additional CSS class name",name:"className",required:!1,type:{name:"string"}},data:{defaultValue:null,description:`Array of numeric values to plot
...
Automatically respects user's prefers-reduced-motion system setting.`,name:"animation",required:!1,type:{name:"boolean"}},width:{defaultValue:null,description:"",name:"width",required:!1,type:{name:"number"}},height:{defaultValue:null,description:"",name:"height",required:!1,type:{name:"number"}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:"number"}},maxWidth:{defaultValue:{value:"1200"},description:"The maximum width of the chart. Defaults to 1200.",name:"maxWidth",required:!1,type:{name:"number"}},aspectRatio:{defaultValue:null,description:`The aspect ratio of the chart (height = width * aspectRatio).
...
Creates a rising effect where the line scales up from the bottom.
Automatically respects user's prefers-reduced-motion system setting.`,name:"animation",required:!1,type:{name:"boolean"}}}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/charts/sparkline/sparkline.tsx#SparklineUnresponsive"]={docgenInfo:a.__docgenInfo,name:"SparklineUnresponsive",path:"../charts/src/charts/sparkline/sparkline.tsx#SparklineUnresponsive"})}catch{}var p=i("../charts/src/stories/chart-decorator.tsx");const K={title:"JS Packages/Charts Library/Charts/Sparkline",component:c,parameters:{layout:"centered"},decorators:[p.OI],argTypes:{data:{control:"object",description:"Array of numeric values to plot",table:{category:"Data"}},width:{control:{type:"number",min:50,max:400},description:"Width of the sparkline in pixels",table:{category:"Dimensions"}},height:{control:{type:"number",min:20,max:200},description:"Height of the sparkline in pixels",table:{category:"Dimensions"}},color:{control:"color",description:"Color for the line stroke",table:{category:"Visual Style"}},strokeWidth:{control:{type:"number",min:1,max:5},description:"Line stroke width in pixels",table:{category:"Visual Style"}},withGradientFill:{control:"boolean",description:"Whether to render gradient fill beneath the line",table:{category:"Visual Style"}},gradient:{control:"object",description:"Gradient configuration",table:{category:"Visual Style"}},className:{control:"text",description:"Additional CSS class name",table:{category:"Styling"}},margin:{control:"object",description:"Margin around the chart",table:{category:"Dimensions"}},animation:{control:"boolean",description:"Enable entry animation on initial render",table:{category:"Visual Style"}}}},g={args:{data:[10,15,12,18,22,25,23,28],width:120,height:48,color:"#4CAF50",containerHeight:100}},O={args:{data:g.args?.data,color:"#9C27B0"}},A={args:{data:g.args?.data,color:"#9C27B0",aspectRatio:.3}},T={args:{...g.args,data:[]}},E={args:{...g.args,data:[42],color:"#9C27B0"}},v={args:{...g.args,data:[10,20],color:"#3F51B5"}},R={render:()=>{const h=[{label:"Speeding up",value:28,data:[10,15,12,18,22,25,23,28],color:"#4CAF50"},{label:"Efficient",value:90,data:[80,82,85,83,87,90,88,92],color:"#2196F3"},{label:"Unstable",value:65,data:[50,75,45,80,40,85,55,65],color:"#FF9800"}];return(0,d.jsx)("div",{style:{display:"flex",gap:"24px",flexWrap:"wrap"},children:h.map(b=>(0,d.jsxs)("div",{style:{padding:"16px",border:"1px solid #e0e0e0",borderRadius:"8px",minWidth:"200px"},children:[(0,d.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:"8px"},children:[(0,d.jsx)("span",{style:{fontSize:"14px",color:"#666"},children:b.label}),(0,d.jsx)("span",{style:{fontSize:"18px",fontWeight:"bold"},children:b.value})]}),(0,d.jsx)(c,{data:b.data,width:180,height:48,color:b.color})]},b.label))})},args:{containerHeight:150}},k={args:{...g.args,animation:!0}},q=["Default","Responsive","AspectRatio","EmptyData","SinglePoint","TwoPoints","Dashboard","Animation"];g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  args: {
    data: defaultData,
    width: 120,
    height: 48,
...
}`,...v.parameters?.docs?.source},description:{story:"Two data points render as a minimal line segment.",...v.parameters?.docs?.description}}},R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  render: () => {
    const metrics = [{
      label: 'Speeding up',
      value: 28,
...
}`,...R.parameters?.docs?.source},description:{story:"Dashboard example showing sparklines in metric cards - a common real-world use case.",...R.parameters?.docs?.description}}},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    animation: true
  }
}`,...k.parameters?.docs?.source},description:{story:`Sparkline with entry animation that creates a smooth rising effect.
The animation respects the user's prefers-reduced-motion setting for accessibility.`,...k.parameters?.docs?.description}}};try{g.displayName="Default",g.__docgenInfo={description:`Basic sparkline with all controls available for customization.
