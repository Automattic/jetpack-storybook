...
HeadlineH3.args = {
  weight: 'bold'
};`,locationsMap:{default:{startLoc:{col:17,line:55},endLoc:{col:1,line:63},startBody:{col:17,line:55},endBody:{col:1,line:63}},"headline-h-2":{startLoc:{col:19,line:43},endLoc:{col:2,line:48},startBody:{col:19,line:43},endBody:{col:2,line:48}},"headline-h-3":{startLoc:{col:19,line:49},endLoc:{col:2,line:54},startBody:{col:19,line:49},endBody:{col:2,line:54}}}}},title:"JS Packages/Components/Text/Heading",component:l.H2,argTypes:{children:{control:{type:"text"}},weight:{control:{type:"select"},options:t}}};function H({children:a}){return(0,e.jsxs)("div",{className:r.A.instance,children:[(0,e.jsx)("span",{children:"Text above to the the component..."}),a,(0,e.jsx)("span",{children:"Text below to the the component..."})]})}const g=a=>(0,e.jsx)(H,{children:(0,e.jsx)(l.H2,{...a,children:a?.children||"Headline Medium - Manage your Jetpack plan and products all in one place"})}),h=a=>(0,e.jsx)(H,{children:(0,e.jsx)(l.H3,{...a,children:a?.children||"Headline Small - Manage your Jetpack plan and products all in one place"})}),x=a=>(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(g,{...a}),(0,e.jsx)(h,{...a})]}),y={},i=x.bind({});i.args=y;const c=g.bind({});c.storyName="H2",c.args={weight:"bold"};const p=h.bind({});p.storyName="H3",p.args={weight:"bold"};const E=["Default","HeadlineH2","HeadlineH3"];i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`args => {
  return <>
            <TemplateH2 {...args} />
            <TemplateH3 {...args} />
        </>;
