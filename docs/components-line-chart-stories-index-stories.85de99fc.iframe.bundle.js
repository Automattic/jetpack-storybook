...
`}}}},j=o.bind({});j.args={showLegend:!0,smoothing:!1,data:[{...i.B2[0],label:"New York"},{...i.B2[1],label:"New York last year",group:"new-york",options:{type:"comparison"}},{...i.B2[2],label:"Tokyo"},{...i.B2[3],label:"Tokyo last year",group:"tokyo",options:{type:"comparison"}}]};const r=["Default","SingleSeries","ManySeries","WithInteractiveLegend","CustomLegendPositioning","WithCompositionLegend","CustomDimensions","FixedDimensions","GradientFilled","GradientCustomColors","GradientTransparent","ErrorStates","WithoutSmoothing","WithPointerEvents","CurveTypes","SmartFormatting","BrokenLine","DateStringFormats","Comparison"];g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`args => {
...
}`,...L.parameters?.docs?.source}}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`args => {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const {
    seriesCount,
    dimensionMode,
  ...
  return <LineChart {...chartProps} {...dimensions} data={data} withTooltipCrosshairs={crosshairConfig} />;
}`,..._.parameters?.docs?.source}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`args => {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const {
    seriesCount,
    dimensionMode,
