"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[805,8513],{"../charts/src/charts/pie-chart/stories/donut.docs.mdx"(S,m,r){r.r(m),r.d(m,{default:()=>b});var d=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),y=r("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.26_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),i=r("../../../node_modules/.pnpm/@storybook+addon-docs@10.2.3_@types+react@18.3.26_esbuild@0.25.9_storybook@10.2.3_@test_1e909a19285aafcb7051ac1c3970312d/node_modules/@storybook/addon-docs/dist/blocks.js"),p=r("../charts/src/charts/pie-chart/stories/donut.stories.tsx");function j(u){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...(0,y.R)(),...u.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(i.W8,{title:"JS Packages/Charts Library/Charts/Donut Chart",of:p}),`
...
}`,...L.parameters?.docs?.source}}}},"../charts/src/components/legend/hooks/use-chart-legend-items.ts"(S,m,r){r.d(m,{f:()=>t});var d=r("../number-formatters/src/index.ts"),e=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),y=r("../charts/src/providers/chart-context/hooks/use-global-charts-context.ts"),i=r("../charts/src/utils/format-percentage.ts");function p(s,o,n="percentage"){if(!o||n==="none")return"";if("percentage"in s){const a=s;switch(n){case"percentage":return(0,i.E)(a.percentage);case"value":return(0,d.ZV)(a.value);case"valueDisplay":return a.valueDisplay||(0,d.ZV)(a.value);default:return""}}return"value"in s&&s.value!==null?(0,d.ZV)(s.value):""}function j(s,o,n,a,x){if(o){const v=n||a;if(v)return{...s,glyphSize:x,renderGlyph:v}}return s}function b(s,o,n,a,x,v,l){const g=(h,f)=>{const{color:A,glyph:_,shapeStyles:T}=o({data:h,index:f,legendShape:l}),C={label:h.label,value:n?h.data?.length?.toString()||"0":"",color:A,shapeStyle:T};return j(C,a,_,v,x)};return s.map(g)}function u(s,o,n,a,x,v,l,g){const h=(f,A)=>{const{color:_,glyph:T,shapeStyles:C}=o({data:f,index:A,legendShape:g}),P={label:f.label,value:p(f,n,a),color:_,shapeStyle:C};return j(P,x,T,l,v)};return s.map(h)}function t(s,o={},n){const{showValues:a=!1,legendValueDisplay:x="percentage",withGlyph:v=!1,glyphSize:l=8,renderGlyph:g}=o,{getElementStyles:h}=(0,y.j)();return(0,e.useMemo)(()=>!s||!Array.isArray(s)||s.length===0?[]:"data"in s[0]?b(s,h,a,v,l,g,n):u(s,h,a,x,v,l,g,n),[s,h,a,x,v,l,g,n])}},"../charts/src/hooks/use-element-size.ts"(S,m,r){r.d(m,{L:()=>e});var d=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");function e({initialWidth:y=0,initialHeight:i=0}={}){const[p,j]=(0,d.useState)(y),[b,u]=(0,d.useState)(i),t=(0,d.useRef)(null);return[(0,d.useCallback)(o=>{if(t.current&&(t.current.disconnect(),t.current=null),o){const n=()=>{const x=o.getBoundingClientRect();j(x.width||0),u(x.height||0)};n();const a=new ResizeObserver(n);a.observe(o),t.current=a}},[]),p,b]}},"../charts/src/stories/legend-config.tsx"(S,m,r){r.d(m,{r:()=>d});const d={showLegend:{control:{type:"boolean"},description:"Show or hide the legend",table:{category:"Legend"}},legendPosition:{control:{type:"select"},options:["top","bottom"],description:"Position of the legend relative to the chart",table:{category:"Legend"}},legendAlignment:{control:{type:"select"},options:["start","center","end"],description:"Horizontal alignment of the legend within its position",table:{category:"Legend"}},legendOrientation:{control:{type:"select"},options:["horizontal","vertical"],description:"Layout direction of legend items",table:{category:"Legend"}},legendShape:{control:{type:"select"},options:["circle","rect"],description:"Shape of the legend marker icon",table:{category:"Legend"}},withLegendGlyph:{control:{type:"boolean"},table:{category:"Legend"},description:"Show glyphs in legend (Line charts only)"},legendValueDisplay:{control:{type:"select"},options:["percentage","value","valueDisplay","none"],table:{category:"Legend"},description:'What type of value to display in the legend when showValues is true. Note: Enable "showLegend" to see the effect of this control.'},legendMaxWidth:{control:{type:"text"},table:{category:"Legend"},description:'Maximum width for legend items as CSS value (e.g. "200px", "50%", "10rem"). When set, text overflow behavior is controlled by legendTextOverflow.'},legendTextOverflow:{control:{type:"select"},options:["wrap","ellipsis"],table:{category:"Legend"},description:'Controls how text behaves when it exceeds legendMaxWidth. "ellipsis" truncates with ... (ideal for widgets), "wrap" allows text to wrap to multiple lines.'},legendItemClassName:{control:{type:"text"},table:{category:"Legend"},description:"Additional CSS class name for legend items. This allows consumers to customize individual legend item styling."},legendInteractive:{control:{type:"boolean"},table:{category:"Legend"},description:"Enable interactive legend items that can toggle series visibility. Requires GlobalChartsProvider and chartId to be set."}};try{d.displayName="legendArgTypes",d.__docgenInfo={description:`Shared legend configuration for chart stories
Provides consistent argTypes and decorators across all chart legend stories`,displayName:"legendArgTypes",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/stories/legend-config.tsx#legendArgTypes"]={docgenInfo:d.__docgenInfo,name:"legendArgTypes",path:"../charts/src/stories/legend-config.tsx#legendArgTypes"})}catch{}},"../charts/src/utils/format-percentage.ts"(S,m,r){r.d(m,{E:()=>e});var d=r("../number-formatters/src/index.ts");const e=y=>(0,d.ZV)(y/100,{numberFormatOptions:{style:"percent",minimumFractionDigits:0,maximumFractionDigits:2}})}}]);
