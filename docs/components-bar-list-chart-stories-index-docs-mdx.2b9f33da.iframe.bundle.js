(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[4304,5718],{"../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.25_react@18.3.1/node_modules/@mdx-js/react/lib/index.js":((V,p,a)=>{"use strict";a.d(p,{R:()=>u,x:()=>h});var x=a("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");const e={},v=x.createContext(e);function u(d){const s=x.useContext(v);return x.useMemo(function(){return typeof d=="function"?d(s):{...s,...d}},[s,d])}function h(d){let s;return d.disableParentContext?s=typeof d.components=="function"?d.components(e):d.components||e:s=u(d.components),x.createElement(v.Provider,{value:s},d.children)}}),"../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.25_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive":(V=>{function p(a){var x=new Error("Cannot find module '"+a+"'");throw x.code="MODULE_NOT_FOUND",x}p.keys=()=>[],p.resolve=p,p.id="../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.25_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive",V.exports=p}),"../../../node_modules/.pnpm/clsx@2.1.1/node_modules/clsx/dist/clsx.mjs":((V,p,a)=>{"use strict";a.d(p,{A:()=>v});function x(u){var h,d,s="";if(typeof u=="string"||typeof u=="number")s+=u;else if(typeof u=="object")if(Array.isArray(u)){var o=u.length;for(h=0;h<o;h++)u[h]&&(d=x(u[h]))&&(s&&(s+=" "),s+=d)}else for(d in u)u[d]&&(s&&(s+=" "),s+=d);return s}function e(){for(var u,h,d=0,s="",o=arguments.length;d<o;d++)(u=arguments[d])&&(h=x(u))&&(s&&(s+=" "),s+=h);return s}const v=e}),"../../../node_modules/.pnpm/deepmerge@4.3.1/node_modules/deepmerge/dist/cjs.js":(V=>{"use strict";var p=function(n){return a(n)&&!x(n)};function a(r){return!!r&&typeof r=="object"}function x(r){var n=Object.prototype.toString.call(r);return n==="[object RegExp]"||n==="[object Date]"||u(r)}var e=typeof Symbol=="function"&&Symbol.for,v=e?Symbol.for("react.element"):60103;function u(r){return r.$$typeof===v}function h(r){return Array.isArray(r)?[]:{}}function d(r,n){return n.clone!==!1&&n.isMergeableObject(r)?T(h(r),r,n):r}function s(r,n,i){return r.concat(n).map(function(l){return d(l,i)})}function o(r,n){if(!n.customMerge)return T;var i=n.customMerge(r);return typeof i=="function"?i:T}function t(r){return Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(r).filter(function(n){return Object.propertyIsEnumerable.call(r,n)}):[]}function f(r){return Object.keys(r).concat(t(r))}function y(r,n){try{return n in r}catch{return!1}}function m(r,n){return y(r,n)&&!(Object.hasOwnProperty.call(r,n)&&Object.propertyIsEnumerable.call(r,n))}function g(r,n,i){var l={};return i.isMergeableObject(r)&&f(r).forEach(function(c){l[c]=d(r[c],i)}),f(n).forEach(function(c){m(r,c)||(y(r,c)&&i.isMergeableObject(n[c])?l[c]=o(c,i)(r[c],n[c],i):l[c]=d(n[c],i))}),l}function T(r,n,i){i=i||{},i.arrayMerge=i.arrayMerge||s,i.isMergeableObject=i.isMergeableObject||p,i.cloneUnlessOtherwiseSpecified=d;var l=Array.isArray(n),c=Array.isArray(r),j=l===c;return j?l?i.arrayMerge(r,n,i):g(r,n,i):d(n,i)}T.all=function(n,i){if(!Array.isArray(n))throw new Error("first argument should be an array");return n.reduce(function(l,c){return T(l,c,i)},{})};var C=T;V.exports=C}),"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive":(V=>{function p(a){var x=new Error("Cannot find module '"+a+"'");throw x.code="MODULE_NOT_FOUND",x}p.keys=()=>[],p.resolve=p,p.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive",V.exports=p}),"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive":(V=>{function p(a){var x=new Error("Cannot find module '"+a+"'");throw x.code="MODULE_NOT_FOUND",x}p.keys=()=>[],p.resolve=p,p.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive",V.exports=p}),"../charts/src/components/bar-list-chart/bar-list-chart.tsx":((V,p,a)=>{"use strict";a.d(p,{A:()=>i});var x=a("../number-formatters/src/index.ts"),e=a("../../../node_modules/.pnpm/@visx+group@3.12.0_react@18.3.1/node_modules/@visx/group/esm/Group.js"),v=a("../../../node_modules/.pnpm/@visx+scale@3.12.0/node_modules/@visx/scale/esm/scales/band.js"),u=a("../../../node_modules/.pnpm/@visx+scale@3.12.0/node_modules/@visx/scale/esm/createScale.js"),h=a("../../../node_modules/.pnpm/@visx+text@3.12.0_react@18.3.1/node_modules/@visx/text/esm/Text.js"),d=a("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),s=a("../charts/src/providers/chart-context/global-charts-provider.tsx"),o=a("../charts/src/components/bar-chart/bar-chart.tsx"),t=a("../charts/src/components/private/with-responsive/with-responsive.tsx"),f=a("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const y=l=>{const c=l;return c&&"bandwidth"in c?c?.bandwidth()??0:0},m=({textProps:l,x:c,y:j,label:O,formatter:b})=>(0,f.jsx)(h.A,{...l,textAnchor:"start",x:c,y:j,children:b(O)}),g=({textProps:l,x:c,y:j,value:O,formatter:b})=>(0,f.jsx)(h.A,{...l,textAnchor:"end",x:c,y:j,fontWeight:500,children:b(O)}),T=({ticks:l,tickLabelProps:c,yOffset:j,labelPosition:O,valuePosition:b,data:P,labelFormatter:_,valueFormatter:S,LabelComponent:E=m,ValueComponent:D=g})=>{if(l.length===0)return null;const A=l.map(({value:M,index:w})=>typeof c=="function"?c(M,w,l):{});return l.map(({from:M,formattedValue:w},L)=>{const R=A[L]??{};delete R.textAnchor,delete R.dx;const W=P.reduce((q,{data:I})=>q+(I[L]?.value??0),0),B=M.y+j;return(0,f.jsxs)(e.A,{children:[(0,f.jsx)(E,{textProps:R,x:O,y:B,label:w,formatter:_}),(0,f.jsx)(D,{textProps:R,x:b,y:B,value:W,formatter:S,data:P,index:L})]},L)})},C=(l,c,j,O)=>{if(!O)return 0;const b=l.map(({label:D})=>D),P=(0,u.A)({type:"band",range:[0,j],domain:b,...c}),_=(0,v.A)({domain:b,range:[0,y(P)],padding:c.paddingInner});return-(y(_)+6)},r=({data:l,width:c,height:j,options:O={},margin:b={left:0,right:20,bottom:0,top:0},...P})=>{const _=(0,d.useMemo)(()=>{const S=l.length>1,E={paddingInner:S?.3:.1,padding:S?.3:.1},D={zero:!0},A={...E,...O.yScale??{}},M={...D,...O.xScale??{}};return{yScale:A,xScale:M,labelPosition:O.labelPosition??(S?0:10),valueFormatter:O.valueFormatter??(w=>(0,x.qe)(w)),labelFormatter:O.labelFormatter??(w=>String(w)),valuePosition:O.valuePosition??c,yOffset:O.yOffset??C(l,A,j,S)}},[O,c,l,j]);return(0,f.jsx)(o.A,{orientation:"horizontal",gridVisibility:"none",data:l,width:c,height:j,margin:b,options:{axis:{y:{children:S=>(0,f.jsx)(T,{...S,data:l,yOffset:_.yOffset,labelPosition:_.labelPosition,valuePosition:_.valuePosition,labelFormatter:_.labelFormatter,valueFormatter:_.valueFormatter,LabelComponent:O.labelComponent,ValueComponent:O.valueComponent})},x:{children:()=>null}},xScale:_.xScale,yScale:_.yScale},...P})},n=l=>(0,d.useContext)(s.m)?(0,f.jsx)(r,{...l}):(0,f.jsx)(s.S,{children:(0,f.jsx)(r,{...l})});n.displayName="BarListChart";const i=(0,t.F)(n);try{ResponsiveChart.displayName="ResponsiveChart",ResponsiveChart.__docgenInfo={description:"",displayName:"ResponsiveChart",props:{size:{defaultValue:null,description:"Size of the chart in pixels for pie and donut charts",name:"size",required:!1,type:{name:"number"}},height:{defaultValue:null,description:"Height of the chart in pixels",name:"height",required:!1,type:{name:"number"}},width:{defaultValue:null,description:"Width of the chart in pixels",name:"width",required:!1,type:{name:"number"}},className:{defaultValue:null,description:"Additional CSS class name for the chart container",name:"className",required:!1,type:{name:"string"}},data:{defaultValue:null,description:"Array of data points to display in the chart",name:"data",required:!0,type:{name:"SeriesData[]"}},onPointerDown:{defaultValue:null,description:"Callback function for pointer down event",name:"onPointerDown",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerMove:{defaultValue:null,description:"Callback function for pointer move event",name:"onPointerMove",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerUp:{defaultValue:null,description:"Callback function for pointer up event",name:"onPointerUp",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerOut:{defaultValue:null,description:"Callback function for pointer out event",name:"onPointerOut",required:!1,type:{name:"(event: PointerEvent<Element>) => void"}},options:{defaultValue:null,description:"More options for the chart.",name:"options",required:!1,type:{name:'{ yScale: Omit<ScaleOptions, "type">; xScale: Omit<ScaleOptions, "type">; labelFormatter?: (value: string) => string; valueFormatter?: (value: number) => string; ... 4 more ...; valueComponent?: ComponentType<...>; }'}},orientation:{defaultValue:null,description:"",name:"orientation",required:!1,type:{name:"enum",value:[{value:'"horizontal"'},{value:'"vertical"'}]}},chartId:{defaultValue:null,description:"Optional unique identifier for the chart (auto-generated if not provided)",name:"chartId",required:!1,type:{name:"string"}},margin:{defaultValue:null,description:"Chart margins",name:"margin",required:!1,type:{name:"{ top?: number; right?: number; bottom?: number; left?: number; }"}},withTooltips:{defaultValue:null,description:"Whether to show tooltips on hover. False by default.",name:"withTooltips",required:!1,type:{name:"boolean"}},showLegend:{defaultValue:null,description:"Whether to show legend",name:"showLegend",required:!1,type:{name:"boolean"}},legendOrientation:{defaultValue:null,description:"Legend orientation",name:"legendOrientation",required:!1,type:{name:"enum",value:[{value:'"horizontal"'},{value:'"vertical"'}]}},legendShape:{defaultValue:null,description:"Legend shape",name:"legendShape",required:!1,type:{name:"LegendShape<SeriesData[], number>"}},legendPosition:{defaultValue:null,description:`Legend position (where the legend appears)
...
- 'ellipsis': Truncate with ellipsis (ideal for widgets/small devices)
- 'wrap': Wrap text to multiple lines (default, ideal for larger displays)`,name:"legendTextOverflow",required:!1,type:{name:"enum",value:[{value:'"wrap"'},{value:'"ellipsis"'}]}},legendItemClassName:{defaultValue:null,description:`Additional CSS class name for legend items.
This allows consumers to customize individual legend item styling.`,name:"legendItemClassName",required:!1,type:{name:"string"}},gridVisibility:{defaultValue:null,description:"Grid visibility. x is default when orientation is vertical. y is default when orientation is horizontal.",name:"gridVisibility",required:!1,type:{name:"enum",value:[{value:'"none"'},{value:'"x"'},{value:'"y"'},{value:'"xy"'}]}}}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/components/bar-list-chart/bar-list-chart.tsx#BarListChart"]={docgenInfo:n.__docgenInfo,name:"BarListChart",path:"../charts/src/components/bar-list-chart/bar-list-chart.tsx#BarListChart"})}catch{}}),"../charts/src/components/bar-list-chart/stories/index.docs.mdx":((V,p,a)=>{"use strict";a.r(p),a.d(p,{default:()=>s});var x=a("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=a("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),v=a("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.25_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),u=a("../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.25_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist/blocks.mjs"),h=a("../charts/src/components/bar-list-chart/stories/index.stories.tsx");function d(o){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...(0,v.R)(),...o.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(u.W8,{title:"JS Packages/Charts/Types/Bar List Chart",of:h}),`
...
`]})]})}function s(o={}){const{wrapper:t}={...(0,v.R)(),...o.components};return t?(0,e.jsx)(t,{...o,children:(0,e.jsx)(d,{...o})}):d(o)}}),"../charts/src/components/bar-list-chart/stories/index.stories.tsx":((V,p,a)=>{"use strict";a.r(p),a.d(p,{CustomLabelComponent:()=>c,CustomValueComponent:()=>j,Default:()=>i,MultiSeries:()=>l,__namedExportsOrder:()=>O,default:()=>n});var x=a("../number-formatters/src/index.ts"),e=a("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),v=a("../../../node_modules/.pnpm/classnames@2.5.1/node_modules/classnames/index.js"),u=a.n(v),h=["className","innerRef"];function d(){return d=Object.assign?Object.assign.bind():function(b){for(var P=1;P<arguments.length;P++){var _=arguments[P];for(var S in _)Object.prototype.hasOwnProperty.call(_,S)&&(b[S]=_[S])}return b},d.apply(this,arguments)}function s(b,P){if(b==null)return{};var _={},S=Object.keys(b),E,D;for(D=0;D<S.length;D++)E=S[D],!(P.indexOf(E)>=0)&&(_[E]=b[E]);return _}function o(b){var P=b.className,_=b.innerRef,S=s(b,h);return e.createElement("circle",d({ref:_,className:u()("visx-circle",P)},S))}var t=a("../../../node_modules/.pnpm/@visx+text@3.12.0_react@18.3.1/node_modules/@visx/text/esm/Text.js"),f=a("../charts/src/providers/chart-context/hooks/use-global-charts-theme.ts"),y=a("../charts/src/stories/chart-decorator.tsx"),m=a("../charts/src/stories/theme-config.tsx"),g=a("../charts/src/stories/sample-data/index.ts"),T=a("../charts/src/components/bar-list-chart/bar-list-chart.tsx"),C=a("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const n={title:"JS Packages/Charts/Types/Bar List Chart",component:T.A,parameters:{layout:"centered"},decorators:[y.OI],argTypes:{...y.xo,...m.jW}},i={args:{withTooltips:!0,data:g.V_,containerWidth:"600px",containerHeight:"332px"}},l={args:{...i.args,data:g._v}},c={args:{...i.args,data:g.V_,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{xScale:{},yScale:{},labelComponent:({textProps:b,x:P,y:_,label:S,formatter:E})=>{const A=(0,f.p)().colors[1];return(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(o,{cx:P+6,cy:_,r:8,fill:A}),(0,C.jsx)(t.A,{...b,textAnchor:"start",x:P+24,y:_,fontWeight:500,children:E(S)})]})}}}},j={args:{...i.args,data:g._v,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{xScale:{},yScale:{},valueComponent:({textProps:b,x:P,y:_,value:S,formatter:E,data:D,index:A})=>{const M=D[0].data[A].value,w=D[1].data[A].value,L=w===0?0:((M-w)/w*100).toFixed(0);return(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(t.A,{...b,textAnchor:"end",x:P,y:_,dx:-50,fontWeight:500,children:E(S)}),(0,C.jsx)(t.A,{...b,textAnchor:"end",x:P,y:_,dx:-10,fill:"#008A20",fontWeight:500,children:`${Number(L)>0?"+":""}${L}%`})]})},valueFormatter:b=>`$${(0,x.qe)(b)}`}}},O=["Default","MultiSeries","CustomLabelComponent","CustomValueComponent"];i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
    withTooltips: true,
    data: salesByProduct,
...
}`,...j.parameters?.docs?.source}}}}),"../charts/src/components/tooltip/accessible-tooltip.tsx":((V,p,a)=>{"use strict";a.d(p,{JZ:()=>d,OZ:()=>h});var x=a("../../../node_modules/.pnpm/@visx+xychart@3.12.0_@react-spring+web@9.7.5_react-dom@18.3.1_react@18.3.1__react@18.3._4b886f56cd4cf4d0010e6b97cb6a93f7/node_modules/@visx/xychart/esm/components/Tooltip.js"),e=a("../../../node_modules/.pnpm/@visx+xychart@3.12.0_@react-spring+web@9.7.5_react-dom@18.3.1_react@18.3.1__react@18.3._4b886f56cd4cf4d0010e6b97cb6a93f7/node_modules/@visx/xychart/esm/context/TooltipContext.js"),v=a("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),u=a("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const h=({renderTooltip:s,selectedIndex:o,tooltipRef:t,keyboardFocusedClassName:f,series:y=[],mode:m="group",...g})=>{const T=(0,v.useContext)(e.A),C=(0,v.useMemo)(()=>{if(m!=="individual")return[];if(y.length===0)return[];const n=Math.max(...y.map(l=>l.data.length)),i=[];for(let l=0;l<n;l++)for(let c=0;c<y.length;c++){const j=y[c];l<j.data.length&&i.push({datum:j.data[l],seriesLabel:j.label,seriesIndex:c,dataPointIndex:l})}return i},[y,m]);(0,v.useEffect)(()=>{if(o===void 0){T?.hideTooltip();return}if(m==="group")y.forEach((n,i)=>{if(o<n.data.length){const l=n.data[o];T?.showTooltip({datum:l,key:n.label,index:i})}});else if(m==="individual"&&o<C.length){const n=C[o];T?.showTooltip({datum:n.datum,key:n.seriesLabel,index:n.seriesIndex})}},[o,C,y]);const r=(0,v.useMemo)(()=>{if(s)return n=>{const i=s(n);return o!==void 0?(0,u.jsx)("div",{ref:t,tabIndex:-1,role:"tooltip","aria-atomic":"true",className:f,"data-testid":`chart-tooltip-${o}`,children:i},`chart-tooltip-${o}`):(0,u.jsx)("div",{role:"tooltip","aria-live":"polite",children:i})}},[s,o,t,f]);return(0,u.jsx)(x.A,{...g,renderTooltip:r})},d=({selectedIndex:s,setSelectedIndex:o,isNavigating:t,setIsNavigating:f,chartRef:y,totalPoints:m})=>{const g=(0,v.useCallback)(n=>{n&&s!==void 0&&n.focus()},[s]),T=(0,v.useCallback)(()=>{!t&&s!==void 0&&o(0)},[t,s,o]),C=(0,v.useCallback)(()=>{f(!1)},[f]),r=(0,v.useCallback)(n=>{if(m===0)return;if(n.key==="Tab"){y.current?.focus(),o(void 0),f(!1);return}const i=s===void 0?-1:s;if(i+1>=m&&["ArrowRight"].includes(n.key)){y.current?.focus(),o(void 0),f(!1);return}n.preventDefault(),["ArrowRight"].includes(n.key)?(f(!0),o((i+1)%m)):["ArrowLeft"].includes(n.key)?(f(!0),o((i-1+m)%m)):n.key==="Escape"&&(o(void 0),f(!1),y.current?.focus())},[m,s,o,f,y]);return{tooltipRef:g,onChartFocus:T,onChartBlur:C,onChartKeyDown:r}};try{h.displayName="AccessibleTooltip",h.__docgenInfo={description:"",displayName:"AccessibleTooltip",props:{renderTooltip:{defaultValue:null,description:"",name:"renderTooltip",required:!1,type:{name:"(params: RenderTooltipParams<DataPointDate>) => ReactNode"}},selectedIndex:{defaultValue:null,description:"",name:"selectedIndex",required:!1,type:{name:"number"}},tooltipRef:{defaultValue:null,description:"",name:"tooltipRef",required:!1,type:{name:"(element: HTMLDivElement) => void"}},keyboardFocusedClassName:{defaultValue:null,description:"",name:"keyboardFocusedClassName",required:!1,type:{name:"string"}},tooltipData:{defaultValue:null,description:`Flattened tooltip data prepared by parent component
