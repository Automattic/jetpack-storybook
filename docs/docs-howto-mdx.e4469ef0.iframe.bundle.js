...
`,(0,e.jsx)(i.Hw,{language:"jsx",code:a.C`
		/**
...
`})}),`
`,(0,e.jsx)(o.p,{children:"Any edits to SCSS, HTML, JSX or other files should be hot-loaded so you can see changes to styles or components."})]})}function m(s={}){const{wrapper:o}={...(0,c.a)(),...s.components};return o?(0,e.jsx)(o,{...s,children:(0,e.jsx)(l,{...s})}):l(s)}},"../../../node_modules/.pnpm/memoizerific@1.11.3/node_modules/memoizerific sync recursive":r=>{function n(t){var d=new Error("Cannot find module '"+t+"'");throw d.code="MODULE_NOT_FOUND",d}n.keys=()=>[],n.resolve=n,n.id="../../../node_modules/.pnpm/memoizerific@1.11.3/node_modules/memoizerific sync recursive",r.exports=n}}]);})();
