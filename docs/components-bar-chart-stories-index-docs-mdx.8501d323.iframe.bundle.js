(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[8731],{"../../../node_modules/.pnpm/@mdx-js+react@3.1.0_@types+react@18.3.23_react@18.3.1/node_modules/@mdx-js/react/lib/index.js":(h,i,r)=>{"use strict";r.d(i,{R:()=>t,x:()=>s});var a=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");const e={},o=a.createContext(e);function t(d){const l=a.useContext(o);return a.useMemo(function(){return typeof d=="function"?d(l):{...l,...d}},[l,d])}function s(d){let l;return d.disableParentContext?l=typeof d.components=="function"?d.components(e):d.components||e:l=t(d.components),a.createElement(o.Provider,{value:l},d.children)}},"../charts/src/components/bar-chart/stories/index.docs.mdx":(h,i,r)=>{"use strict";r.r(i),r.d(i,{default:()=>x});var a=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),o=r("../../../node_modules/.pnpm/@mdx-js+react@3.1.0_@types+react@18.3.23_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),t=r("../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist/blocks.mjs"),s=r("../charts/src/components/bar-chart/stories/index.stories.tsx"),d=r("../charts/src/components/bar-chart/stories/legend.stories.tsx");function l(c){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...(0,o.R)(),...c.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(t.W8,{title:"JS Packages/Charts/Types/Bar Chart",of:s}),`
...
`,(0,e.jsx)(t.Hl,{of:s.SingleSeries}),`
...
`,(0,e.jsx)(t.Hl,{of:s.HorizontalBarChart}),`
`,(0,e.jsx)(t.kL,{language:"jsx",code:`<BarChart
	data={data}
...
`,(0,e.jsx)(t.Hl,{of:s.ManyDataSeries}),`
`,(0,e.jsx)(t.kL,{language:"jsx",code:`<BarChart
...
`,(0,e.jsx)(t.Hl,{of:s.WithPatterns}),`
`,(0,e.jsx)(t.kL,{language:"jsx",code:`<BarChart
	data={data}
	withPatterns={true}
	withTooltips={true}
...
`,(0,e.jsx)(t.Hl,{of:s.SmartFormatting}),`
...
`,(0,e.jsx)(t.Hl,{of:s.ZeroValueComparison}),`
`,(0,e.jsx)(t.kL,{language:"jsx",code:`<BarChart
	data={dataWithZeros}
	showZeroValues={true}
	withTooltips={true}
...
`,(0,e.jsx)(t.Hl,{of:s.FixedDimensions}),`
...
`]}),`
`,(0,e.jsx)(n.p,{children:"The component automatically adapts bar colors, patterns, and styling based on the active theme while maintaining accessibility standards."})]})}function x(c={}){const{wrapper:n}={...(0,o.R)(),...c.components};return n?(0,e.jsx)(n,{...c,children:(0,e.jsx)(l,{...c})}):l(c)}},"../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive":h=>{function i(r){var a=new Error("Cannot find module '"+r+"'");throw a.code="MODULE_NOT_FOUND",a}i.keys=()=>[],i.resolve=i,i.id="../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive",h.exports=i},"../charts/src/components/bar-chart/stories/legend.stories.tsx":(h,i,r)=>{"use strict";r.r(i),r.d(i,{AlignmentPositioning:()=>j,Default:()=>n,HorizontalBars:()=>p,VerticalOrientation:()=>g,__namedExportsOrder:()=>m,default:()=>l});var a=r("../charts/src/stories/decorator-config.tsx"),e=r("../charts/src/stories/legend-config.tsx"),o=r("../charts/src/components/bar-chart/bar-chart.tsx"),t=r("../charts/src/components/bar-chart/stories/sample-data.ts"),s=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const l={title:"JS Packages/Charts/Types/Bar Chart/Legend",component:o.A,parameters:{layout:"centered"},decorators:a.p,argTypes:e.r},x=u=>(0,s.jsx)(o.A,{...u}),c={data:t.A.slice(0,3),containerWidth:"800px",containerHeight:"400px",showLegend:!0,legendOrientation:"horizontal",withTooltips:!0},n=x.bind({});n.args={...c};const j=x.bind({});j.args={...c,legendAlignmentHorizontal:"right",legendAlignmentVertical:"top"};const g=x.bind({});g.args={...c,legendOrientation:"vertical",legendAlignmentHorizontal:"right",legendAlignmentVertical:"top"};const p=x.bind({});p.args={...c,orientation:"horizontal",legendAlignmentHorizontal:"right",legendAlignmentVertical:"top"};const m=["Default","AlignmentPositioning","VerticalOrientation","HorizontalBars"];n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"args => <BarChart {...args} />",...n.parameters?.docs?.source}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:"args => <BarChart {...args} />",...j.parameters?.docs?.source}}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:"args => <BarChart {...args} />",...g.parameters?.docs?.source}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:"args => <BarChart {...args} />",...p.parameters?.docs?.source}}}},"../charts/src/stories/decorator-config.tsx":(h,i,r)=>{"use strict";r.d(i,{p:()=>o});var a=r("../charts/src/providers/theme/theme-provider.tsx"),e=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const o=[(t,{args:s})=>(0,e.jsx)(a.NP,{theme:s.theme,children:(0,e.jsx)("div",{style:{resize:s.resize??"both",overflow:"auto",padding:"1rem",width:s.containerWidth??"800px",height:s.containerHeight??"600px",minWidth:"400px",maxWidth:"1200px",border:"1px dashed #ccc"},children:(0,e.jsx)(t,{})})})];try{o.displayName="sharedDecorator",o.__docgenInfo={description:"Shared decorator for legend stories with theme support and resizable container",displayName:"sharedDecorator",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/stories/decorator-config.tsx#sharedDecorator"]={docgenInfo:o.__docgenInfo,name:"sharedDecorator",path:"../charts/src/stories/decorator-config.tsx#sharedDecorator"})}catch{}},"../charts/src/stories/legend-config.tsx":(h,i,r)=>{"use strict";r.d(i,{r:()=>e});var a=r("../charts/src/providers/theme/themes.ts");const e={showLegend:{control:{type:"boolean"},table:{category:"Legend"}},legendAlignmentHorizontal:{control:{type:"select"},options:["left","center","right"],table:{category:"Legend"}},legendAlignmentVertical:{control:{type:"select"},options:["top","bottom"],table:{category:"Legend"}},legendOrientation:{control:{type:"select"},options:["horizontal","vertical"],table:{category:"Legend"}},legendShape:{control:{type:"select"},options:["circle","rect"],table:{category:"Legend"}},withLegendGlyph:{control:{type:"boolean"},table:{category:"Legend"},description:"Show glyphs in legend (Line charts only)"},theme:{control:{type:"select"},options:{default:void 0,jetpack:a.QI,woo:a.pk},defaultValue:void 0,table:{category:"Theme"}}};try{e.displayName="legendArgTypes",e.__docgenInfo={description:`Shared legend configuration for chart stories
Provides consistent argTypes and decorators across all chart legend stories`,displayName:"legendArgTypes",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/stories/legend-config.tsx#legendArgTypes"]={docgenInfo:e.__docgenInfo,name:"legendArgTypes",path:"../charts/src/stories/legend-config.tsx#legendArgTypes"})}catch{}},"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive":h=>{function i(r){var a=new Error("Cannot find module '"+r+"'");throw a.code="MODULE_NOT_FOUND",a}i.keys=()=>[],i.resolve=i,i.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive",h.exports=i},"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive":h=>{function i(r){var a=new Error("Cannot find module '"+r+"'");throw a.code="MODULE_NOT_FOUND",a}i.keys=()=>[],i.resolve=i,i.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive",h.exports=i}}]);
