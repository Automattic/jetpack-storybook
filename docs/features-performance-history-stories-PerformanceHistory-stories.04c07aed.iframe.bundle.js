"use strict";(()=>{var Z=Object.defineProperty;var U=(i,a,t)=>a in i?Z(i,a,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[a]=t;var B=(i,a,t)=>(U(i,typeof a!="symbol"?a+"":a,t),t);(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[1852],{"../../plugins/boost/app/assets/src/js/features/performance-history/stories/PerformanceHistory.stories.tsx":(i,a,t)=>{var C,P,D;t.r(a),t.d(a,{__namedExportsOrder:()=>k,_default:()=>y,default:()=>w});var c=t("../components/components/boost-score-graph/index.tsx"),l=t("../components/components/spinner/index.jsx"),p=t("../components/components/popover/index.tsx"),d=t("../components/components/gridicon/index.tsx"),r=t("../components/components/button/index.tsx"),_=t("../../../node_modules/.pnpm/@wordpress+components@25.11.0_react-dom@18.2.0_react@18.2.0/node_modules/@wordpress/components/build-module/panel/index.js"),m=t("../../../node_modules/.pnpm/@wordpress+components@25.11.0_react-dom@18.2.0_react@18.2.0/node_modules/@wordpress/components/build-module/panel/body.js"),h=t("../../../node_modules/.pnpm/@wordpress+components@25.11.0_react-dom@18.2.0_react@18.2.0/node_modules/@wordpress/components/build-module/panel/row.js"),E=t("../../../node_modules/.pnpm/@wordpress+i18n@4.45.0/node_modules/@wordpress/i18n/build-module/index.js"),s=t("../../../node_modules/.pnpm/react@18.2.0/node_modules/react/jsx-runtime.js");const e=E.__,o=({children:v})=>(0,s.jsxs)("div",{className:"jb-performance-history__dummy",children:[v,(0,s.jsx)(c.Z,{isPlaceholder:!0})]});o.displayName="DummyGraph";const n=({periods:v,startDate:O,endDate:z,needsUpgrade:V,handleUpgrade:L,isFreshStart:A,handleDismissFreshStart:M,isLoading:T})=>T?(0,s.jsx)("div",{className:"jb-performance-history__dummy",children:(0,s.jsx)(l.Z,{color:"#000000"})}):V?(0,s.jsx)(o,{children:(0,s.jsx)(p.Z,{icon:(0,s.jsx)(d.Z,{icon:"lock"}),action:(0,s.jsx)(r.Z,{onClick:L,children:e("Upgrade now!","jetpack-boost")}),children:(0,s.jsx)("p",{children:e("Upgrade and learn more about your site performance over time.","jetpack-boost")})})}):A?(0,s.jsx)(o,{children:(0,s.jsx)(p.Z,{icon:(0,s.jsx)(d.Z,{icon:"checkmark"}),action:(0,s.jsx)(r.Z,{onClick:M,children:e("Okay, got it!","jetpack-boost")}),children:(0,s.jsxs)("p",{children:[e("Hello there! Jetpack Boost premium has been activated.","jetpack-boost"),(0,s.jsx)("br",{}),e("Your scores will be recorded from now on.","jetpack-boost")]})})}):(0,s.jsx)(c.Z,{periods:v,startDate:O,endDate:z});n.displayName="GraphComponent";const u=({periods:v,onToggle:O,isOpen:z,startDate:V,endDate:L,isLoading:A,needsUpgrade:M=!1,handleUpgrade:T=()=>{},isFreshStart:R=!0,onDismissFreshStart:H=()=>{}})=>(0,s.jsx)(_.Z,{children:(0,s.jsx)(m.ZP,{title:e("Historical Performance","jetpack-boost"),initialOpen:z,onToggle:O,className:"jb-performance-history__panel",children:(0,s.jsx)(h.Z,{children:(0,s.jsx)("div",{style:{flexGrow:1,minHeight:"300px"},children:(0,s.jsx)(n,{periods:v,startDate:V,endDate:L,isFreshStart:R,needsUpgrade:M,handleUpgrade:T,handleDismissFreshStart:H,isLoading:A})})})})});u.displayName="PerformanceHistory";try{u.displayName="PerformanceHistory",u.__docgenInfo={description:"",displayName:"PerformanceHistory",props:{periods:{defaultValue:null,description:"",name:"periods",required:!0,type:{name:"any"}},onToggle:{defaultValue:null,description:"",name:"onToggle",required:!0,type:{name:"any"}},isOpen:{defaultValue:null,description:"",name:"isOpen",required:!0,type:{name:"any"}},startDate:{defaultValue:null,description:"",name:"startDate",required:!0,type:{name:"any"}},endDate:{defaultValue:null,description:"",name:"endDate",required:!0,type:{name:"any"}},isLoading:{defaultValue:null,description:"",name:"isLoading",required:!0,type:{name:"any"}},needsUpgrade:{defaultValue:{value:"false"},description:"",name:"needsUpgrade",required:!1,type:{name:"boolean"}},handleUpgrade:{defaultValue:{value:`() => {
		/* noop */
		...
		/* noop */
	}`},description:"",name:"onDismissFreshStart",required:!1,type:{name:"() => void"}}}},typeof STORYBOOK_REACT_CLASSES!="undefined"&&(STORYBOOK_REACT_CLASSES["../../plugins/boost/app/assets/src/js/features/performance-history/performance-history.tsx#PerformanceHistory"]={docgenInfo:u.__docgenInfo,name:"PerformanceHistory",path:"../../plugins/boost/app/assets/src/js/features/performance-history/performance-history.tsx#PerformanceHistory"})}catch(v){}var x=`import type { Meta } from '@storybook/react';
