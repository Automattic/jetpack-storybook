(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[8125],{"../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.0.8_@test_ca37a3433c216fd610726ebbc5860d83/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive":(l=>{function n(a){var o=new Error("Cannot find module '"+a+"'");throw o.code="MODULE_NOT_FOUND",o}n.keys=()=>[],n.resolve=n,n.id="../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.0.8_@test_ca37a3433c216fd610726ebbc5860d83/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive",l.exports=n}),"../charts/src/charts/pie-semi-circle-chart/stories/index.docs.mdx":((l,n,a)=>{"use strict";a.r(n),a.d(n,{default:()=>h});var o=a("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=a("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),c=a("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.26_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),i=a("../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.0.8_@test_ca37a3433c216fd610726ebbc5860d83/node_modules/@storybook/addon-docs/dist/blocks.js"),s=a("../charts/src/charts/pie-semi-circle-chart/stories/index.stories.tsx");function d(r){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...(0,c.R)(),...r.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(i.W8,{title:"JS Packages/Charts Library/Charts/Pie Semi Circle Chart",of:s}),`
...
`,(0,e.jsx)(i.kL,{language:"jsx",code:`import { PieSemiCircleChart } from '@automattic/charts';
...
`,(0,e.jsxs)(t.p,{children:["For detailed information about component props, types, and method signatures, see the ",(0,e.jsx)(t.a,{href:"./?path=/docs/js-packages-charts-library-charts-pie-semi-circle-chart-api-reference--docs",children:"Pie Semi Circle Chart API Reference"}),"."]}),`
...
`,(0,e.jsx)(i.Hl,{of:s.Default}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`const basicData = [
{
	label: 'Category A',
	value: 60,
	percentage: 60,
...
`,(0,e.jsxs)(t.p,{children:["For detailed information about all optional props, see the ",(0,e.jsx)(t.a,{href:"./?path=/docs/js-packages-charts-library-charts-pie-semi-circle-chart-api-reference--docs",children:"Pie Semi Circle Chart API Reference"}),"."]}),`
...
`,(0,e.jsx)(i.Hl,{of:s.WithTooltips}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<PieSemiCircleChart
data={ data }
width={ 600 }
withTooltips={ true }
...
`,(0,e.jsx)(i.kL,{language:"jsx",code:`// Thin ring (thickness: 0.2)
<PieSemiCircleChart
data={ data }
width={ 400 }
thickness={ 0.2 }
...
`,(0,e.jsx)(i.Hl,{of:s.Responsiveness}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`// Responsive chart adapts to container width
<PieSemiCircleChart
data={ data }
thickness={ 0.4 }
...
`,(0,e.jsx)(i.kL,{language:"jsx",code:`const customColorData = [
{
	label: 'Primary',
	value: 60,
	percentage: 60,
...
`,(0,e.jsx)(t.p,{children:"The Pie Semi Circle Chart component supports an optional entry animation that creates a smooth reveal effect when the chart first renders:"}),`
...
`,(0,e.jsxs)(t.li,{children:[(0,e.jsx)(t.strong,{children:"Effect"}),": Creates a radial wipe reveal effect that sweeps clockwise from the top, progressively revealing the chart segments"]}),`
...
`,(0,e.jsx)(i.kL,{language:"jsx",code:`// Legend at top-right
<PieSemiCircleChart
data={ data }
showLegend={ true }
legendAlignment="end"
...
`,(0,e.jsx)(i.kL,{language:"jsx",code:`const singlePointData = [
{
	label: 'Complete',
	value: 100,
	percentage: 100,
...
`,(0,e.jsx)(i.kL,{language:"jsx",code:`const formattedData = [
{
	label: 'Users',
	value: 15000,
...
`,(0,e.jsx)(i.kL,{language:"jsx",code:`// Full pie chart
<PieChart
data={ data }
size={ 400 }
/>
...
`,(0,e.jsx)(i.kL,{language:"jsx",code:`// Full pie chart - must sum to 100
const fullPieData = [
...
];`})]})}function h(r={}){const{wrapper:t}={...(0,c.R)(),...r.components};return t?(0,e.jsx)(t,{...r,children:(0,e.jsx)(d,{...r})}):d(r)}})}]);
