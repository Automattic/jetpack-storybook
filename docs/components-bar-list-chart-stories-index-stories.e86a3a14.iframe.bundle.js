...
`,Z={Default:{startLoc:{col:23,line:29},endLoc:{col:1,line:34},startBody:{col:23,line:29},endBody:{col:1,line:34}},MultiSeries:{startLoc:{col:27,line:35},endLoc:{col:1,line:40},startBody:{col:27,line:35},endBody:{col:1,line:40}},CustomLabelComponent:{startLoc:{col:36,line:41},endLoc:{col:1,line:77},startBody:{col:36,line:41},endBody:{col:1,line:77}},CustomValueComponent:{startLoc:{col:36,line:78},endLoc:{col:1,line:126},startBody:{col:36,line:78},endBody:{col:1,line:126}}};const se={title:"JS Packages/Charts/Types/Bar List Chart",component:M,parameters:{storySource:{source:`import { formatNumberCompact } from '@automattic/number-formatters';
import { Circle } from '@visx/shape';
import { Text } from '@visx/text';
import React from 'react';
import BarListChart from '../bar-list-chart';
...
};`,locationsMap:{default:{startLoc:{col:23,line:29},endLoc:{col:1,line:34},startBody:{col:23,line:29},endBody:{col:1,line:34}},"multi-series":{startLoc:{col:27,line:35},endLoc:{col:1,line:40},startBody:{col:27,line:35},endBody:{col:1,line:40}},"custom-label-component":{startLoc:{col:36,line:41},endLoc:{col:1,line:77},startBody:{col:36,line:41},endBody:{col:1,line:77}},"custom-value-component":{startLoc:{col:36,line:78},endLoc:{col:1,line:126},startBody:{col:36,line:78},endBody:{col:1,line:126}}}},layout:"centered"},decorators:[t=>(0,i.jsx)("div",{style:{resize:"both",overflow:"auto",padding:"2rem",width:"800px",maxWidth:"1200px",border:"1px dashed #ccc",display:"inline-block"},children:(0,i.jsx)(t,{})})]},m={args:{withTooltips:!0,data:P}},K={args:{...m.args,data:ne}},R={args:{...m.args,data:P,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{labelComponent:({textProps:t,x:s,y:l,label:o,formatter:h})=>(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(d,{cx:s+6,cy:l,r:8}),(0,i.jsx)(r.A,{...t,textAnchor:"start",x:s+24,y:l,fontWeight:500,children:h(o)})]})}}},q={args:{...m.args,data:ne,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{valueComponent:({textProps:t,x:s,y:l,value:o,formatter:h,data:g,index:f})=>{const S=g[0].data[f].value,T=g[1].data[f].value,j=T===0?0:((S-T)/T*100).toFixed(0);return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(r.A,{...t,textAnchor:"end",x:s,y:l,dx:-50,fontWeight:500,children:h(o)}),(0,i.jsx)(r.A,{...t,textAnchor:"end",x:s,y:l,dx:-10,fill:"#008A20",fontWeight:500,children:`${Number(j)>0?"+":""}${j}%`})]})},valueFormatter:t=>`$${(0,C.qe)(t)}`}}},le=["Default","MultiSeries","CustomLabelComponent","CustomValueComponent"];m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    withTooltips: true,
    data: salesByProduct
  }
