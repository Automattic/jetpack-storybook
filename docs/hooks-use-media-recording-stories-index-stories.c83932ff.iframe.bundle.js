"use strict";(()=>{(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[8260],{"../ai-client/src/hooks/use-media-recording/stories/index.stories.tsx":($,f,m)=>{var C,h,S;m.r(f),m.d(f,{Default:()=>u,__namedExportsOrder:()=>I,default:()=>T});var y=m("../../../node_modules/.pnpm/@wordpress+components@26.0.0_@types+react@18.2.33_react-dom@18.2.0_react@18.2.0/node_modules/@wordpress/components/build-module/button/index.js"),a=m("../../../node_modules/.pnpm/react@18.2.0/node_modules/react/index.js");function M(n){return new Promise(t=>{const r=new Audio(n);r.addEventListener("durationchange",function(){if(this.duration===1/0)return;const s=this.duration;r.remove(),t(s)},!1),r.load(),r.currentTime=24*60*60,r.volume=0,r.play()})}function L(n,{addDecimalPart:t=!0}={}){n=n*1e3;const r=Math.floor(n/36e5),s=Math.floor(n/6e4)%60,l=Math.floor(n/1e3)%60,c=Math.floor(n/10)%100,i=[r>0?r.toString().padStart(2,"0")+":":"",r>0||s>0?s.toString().padStart(2,"0")+":":"",l.toString().padStart(2,"0")];return t&&i.push("."+c.toString().padStart(2,"0")),i.join("")}var e=m("../../../node_modules/.pnpm/react@18.2.0/node_modules/react/jsx-runtime.js");function b({url:n}){const[t,r]=(0,a.useState)(0);return(0,a.useEffect)(()=>{n&&M(n).then(r)},[n]),(0,e.jsx)("span",{children:L(t,{addDecimalPart:!1})})}b.displayName="AudioDurationDisplay";try{audiodurationdisplay.displayName="audiodurationdisplay",audiodurationdisplay.__docgenInfo={description:"AudioDurationDisplay component.",displayName:"audiodurationdisplay",props:{url:{defaultValue:null,description:"",name:"url",required:!0,type:{name:"string"}}}},typeof STORYBOOK_REACT_CLASSES!="undefined"&&(STORYBOOK_REACT_CLASSES["../ai-client/src/components/audio-duration-display/index.tsx#audiodurationdisplay"]={docgenInfo:audiodurationdisplay.__docgenInfo,name:"audiodurationdisplay",path:"../ai-client/src/components/audio-duration-display/index.tsx#audiodurationdisplay"})}catch(n){}function _({onDone:n}={}){const t=(0,a.useRef)(null),[r,s]=(0,a.useState)("inactive"),[l,c]=(0,a.useState)(null),i=(0,a.useRef)([]).current;function g(){return new Blob(i,{type:"audio/webm"})}const P=(0,a.useCallback)(o=>{var d,p;if(!o)return(d=t==null?void 0:t.current)==null?void 0:d.start();o<100&&(o=100),(p=t==null?void 0:t.current)==null||p.start(o)},[]),O=(0,a.useCallback)(()=>{var o;(o=t==null?void 0:t.current)==null||o.pause()},[]),w=(0,a.useCallback)(()=>{var o;(o=t==null?void 0:t.current)==null||o.resume()},[]),N=(0,a.useCallback)(()=>{var o;(o=t==null?void 0:t.current)==null||o.stop()},[]);function D(){s("recording")}function j(){s("inactive"),n==null||n(g()),i.length=0}function B(){s("paused")}function A(){s("recording")}function k(o){const{data:d}=o;d!=null&&d.size&&(i.push(d),c(g()))}return(0,a.useEffect)(()=>{var d;if(!((d=navigator.mediaDevices)!=null&&d.getUserMedia))return;const o={audio:!0};return navigator.mediaDevices.getUserMedia(o).then(p=>{t.current=new MediaRecorder(p),t.current.addEventListener("start",D),t.current.addEventListener("stop",j),t.current.addEventListener("pause",B),t.current.addEventListener("resume",A),t.current.addEventListener("dataavailable",k)}).catch(p=>{throw p}),()=>{t!=null&&t.current&&(t.current.removeEventListener("start",D),t.current.removeEventListener("stop",j),t.current.removeEventListener("pause",B),t.current.removeEventListener("resume",A),t.current.removeEventListener("dataavailable",k))}},[]),{state:r,blob:l,url:l?URL.createObjectURL(l):null,start:P,pause:O,resume:w,stop:N}}var z=`/**
