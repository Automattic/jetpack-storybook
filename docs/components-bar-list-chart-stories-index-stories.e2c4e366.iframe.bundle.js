...
};`,locationsMap:{default:{startLoc:{col:23,line:29},endLoc:{col:1,line:34},startBody:{col:23,line:29},endBody:{col:1,line:34}},"multi-series":{startLoc:{col:27,line:35},endLoc:{col:1,line:41},startBody:{col:27,line:35},endBody:{col:1,line:41}},"custom-label-component":{startLoc:{col:36,line:42},endLoc:{col:1,line:78},startBody:{col:36,line:42},endBody:{col:1,line:78}},"custom-value-component":{startLoc:{col:36,line:79},endLoc:{col:1,line:128},startBody:{col:36,line:79},endBody:{col:1,line:128}}}},layout:"centered"},decorators:[t=>(0,a.jsx)("div",{style:{resize:"both",overflow:"auto",padding:"2rem",width:"800px",maxWidth:"1200px",border:"1px dashed #ccc",display:"inline-block"},children:(0,a.jsx)(t,{})})]},u={args:{withTooltips:!0,data:L}},x={args:{...u.args,data:_,showLegend:!0}},f={args:{...u.args,data:L,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{labelComponent:({textProps:t,x:e,y:r,label:n,formatter:o})=>(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(A.A,{cx:e+6,cy:r,r:8}),(0,a.jsx)(h.A,{...t,textAnchor:"start",x:e+24,y:r,fontWeight:500,children:o(n)})]})}}},y={args:{...u.args,data:_,showLegend:!0,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{valueComponent:({textProps:t,x:e,y:r,value:n,formatter:o,data:c,index:l})=>{const i=c[0].data[l].value,d=c[1].data[l].value,m=d===0?0:((i-d)/d*100).toFixed(0);return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(h.A,{...t,textAnchor:"end",x:e,y:r,dx:-50,fontWeight:500,children:o(n)}),(0,a.jsx)(h.A,{...t,textAnchor:"end",x:e,y:r,dx:-10,fill:"#008A20",fontWeight:500,children:`${Number(m)>0?"+":""}${m}%`})]})},valueFormatter:t=>`$${(0,S.qe)(t)}`}}},U=["Default","MultiSeries","CustomLabelComponent","CustomValueComponent"];u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  args: {
    withTooltips: true,
    data: salesByProduct
  }
