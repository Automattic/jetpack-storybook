...
`,T={Default:{startLoc:{col:17,line:55},endLoc:{col:2,line:57},startBody:{col:17,line:55},endBody:{col:2,line:57}},BreakpointMatch:{startLoc:{col:31,line:97},endLoc:{col:1,line:183},startBody:{col:31,line:97},endBody:{col:1,line:183}}};const m=({items:x,fluid:A,horizontalGap:v,horizontalSpacing:C})=>(0,t.jsxs)(c.A,{className:r.container,horizontalSpacing:C,fluid:A,horizontalGap:v,children:[x.map(({sm:M,lg:g,md:S},I)=>{const P=Number.isInteger(M?.start)?JSON.stringify(M):M,O=Number.isInteger(S?.start)?JSON.stringify(S):S,N=Number.isInteger(g?.start)?JSON.stringify(g):g;return(0,t.jsxs)(a.A,{sm:M,md:S,lg:g,className:r.col,children:[M?`sm=${P} `:"",S?`md=${O} `:"",g?`lg=${N} `:""]},`${P}${O}${N}${I}`)}),(0,t.jsx)(a.A,{children:(0,t.jsxs)(c.A,{fluid:!0,horizontalSpacing:0,horizontalGap:1,children:[(0,t.jsx)(a.A,{className:r.col,children:"Composition Example"}),(0,t.jsx)(a.A,{className:r.col,children:"Composition Example"})]})})]}),j={parameters:{storySource:{source:`/* wp:polyfill */
