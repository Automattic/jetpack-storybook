"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[5951],{"../charts/src/charts/line-chart/stories/glyph.stories.tsx"(z,C,l){l.r(C),l.d(C,{Custom:()=>m,CustomPerDataPoint:()=>b,CustomSvg:()=>f,End:()=>u,InTooltip:()=>v,Start:()=>y,__namedExportsOrder:()=>O,default:()=>D});var S=l("../../../node_modules/.pnpm/@visx+glyph@3.12.0_react@18.3.1/node_modules/@visx/glyph/esm/glyphs/GlyphStar.js"),e=l("../charts/src/providers/chart-context/global-charts-provider.tsx"),L=l("../charts/src/providers/chart-context/hooks/use-global-charts-theme.ts"),r=l("../charts/src/stories/theme-config.tsx"),o=l("../charts/src/charts/line-chart/line-chart.tsx"),x=l("../charts/src/charts/line-chart/stories/config.tsx"),s=l("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const G={...r.yI,glyph:x.Em},c=(d,{args:t})=>{const i=t,a=i.themeName,h=G[a||"default"];return(0,s.jsx)(e.S,{theme:h,children:(0,s.jsx)("div",{style:{resize:"both",overflow:"auto",padding:"2rem",width:"800px",height:i.containerHeight||"400px",maxWidth:"1200px",border:"1px dashed #ccc",display:"inline-block"},children:(0,s.jsx)(d,{})})})},D={...x.Nc,title:"JS Packages/Charts Library/Charts/Line Chart/Glyphs",decorators:[c],argTypes:{...x.Nc.argTypes,themeName:{...r.jW.themeName,options:["default","custom","glyph"]},withStartGlyphs:{control:"boolean",description:"Show glyphs at line start",table:{category:"Glyphs"}},withEndGlyphs:{control:"boolean",description:"Show glyphs at line end",table:{category:"Glyphs"}},withLegendGlyph:{control:"boolean",description:"Show glyphs in legend",table:{category:"Glyphs"}},glyphType:{control:"radio",options:["default","star","heart"],description:"Glyph shape",table:{category:"Glyphs"}},glyphSize:{control:{type:"range",min:4,max:16,step:1},description:"Glyph size (radius)",table:{category:"Glyphs"}}}},k=({color:d,size:t,x:i,y:a})=>{const p=typeof i=="number"&&typeof a=="number"&&(i!==0||a!==0)?{transform:`translate(${i}, ${a})`}:{};return(0,s.jsx)("g",{...p,children:(0,s.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:t*2,height:t*2,viewBox:"0 0 24 24",style:{overflow:"visible",pointerEvents:"none"},children:(0,s.jsx)("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z",fill:d,stroke:d,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",transform:"translate(-12, -12)"})})})},g=d=>{const{glyphType:t,glyphSize:i,...a}=d;let h=a.renderGlyph;t==="star"?h=({color:_,size:w,x:P,y:T})=>(0,s.jsx)(S.A,{top:T,left:P,size:w*w,fill:_}):t==="heart"&&(h=({color:_,size:w,x:P,y:T})=>(0,s.jsx)(k,{color:_,size:w,x:P,y:T}));const p=i?{radius:i}:a.glyphStyle;return(0,s.jsx)(o.A,{...a,renderGlyph:h,glyphStyle:p})},j={...x.pn,withStartGlyphs:!0},y=g.bind({});y.args={...j};const u=g.bind({});u.args={...j,withStartGlyphs:!1,withEndGlyphs:!0};const m=g.bind({});m.args={...j,withLegendGlyph:!0,renderGlyph:({color:d,size:t,x:i,y:a})=>(0,s.jsx)(S.A,{top:a,left:i,size:t*t,fill:d}),glyphStyle:{radius:10}};const E=({color:d,size:t,x:i,y:a})=>{const p=typeof i=="number"&&typeof a=="number"&&(i!==0||a!==0)?{transform:`translate(${i}, ${a})`}:{};return(0,s.jsx)("g",{...p,children:(0,s.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:t*2,height:t*2,viewBox:"0 0 24 24",style:{overflow:"visible",pointerEvents:"none"},children:(0,s.jsx)("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z",fill:d,stroke:d,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",transform:"translate(-12, -12)"})})})},f=g.bind({});f.args={...j,withLegendGlyph:!0,renderGlyph:({color:d,size:t,x:i,y:a})=>(0,s.jsx)(E,{color:d,size:t,x:i,y:a}),glyphStyle:{radius:8}};const A=({tooltipData:d})=>{const t=(0,L.p)();return(0,s.jsxs)("div",{children:[(0,s.jsx)("div",{style:{marginBottom:"0.5rem"},children:d?.nearestDatum?.datum?.date?.toLocaleDateString()}),(0,s.jsx)("div",{children:Object.entries(d?.datumByKey||{}).map(([i,a],h)=>{const{datum:p}=a;return(0,s.jsx)("div",{children:(0,s.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"0.5rem",marginBottom:"0.2rem"},children:[(0,s.jsx)("svg",{width:20,height:20,children:(0,s.jsx)(S.A,{size:100,top:10,left:10,fill:"#fff",stroke:t.colors[h%t.colors.length]})}),i,": ",p.value]})},i)})})]})},v=g.bind({});v.args={...j,renderGlyph:({color:d,size:t,x:i,y:a})=>(0,s.jsx)(S.A,{top:a,left:i,size:t*t,fill:"#fff",stroke:d}),glyphStyle:{radius:10},renderTooltip:A};const b=g.bind({});b.args={...j,showLegend:!0,withStartGlyphs:!0,withLegendGlyph:!0,themeName:"glyph",glyphStyle:{radius:8}};const O=["Start","End","Custom","CustomSvg","InTooltip","CustomPerDataPoint"];y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`args => {
  const {
    glyphType,
    glyphSize,
    ...chartProps
...
}`,...y.parameters?.docs?.source}}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`args => {
  const {
    glyphType,
    glyphSize,
    ...chartProps
  ...
  return <LineChart {...chartProps} renderGlyph={renderGlyph} glyphStyle={glyphStyle} />;
}`,...b.parameters?.docs?.source}}}},"../charts/src/charts/line-chart/stories/index.docs.mdx"(z,C,l){l.r(C),l.d(C,{default:()=>G});var S=l("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=l("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),L=l("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.26_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),r=l("../../../node_modules/.pnpm/@storybook+addon-docs@10.2.3_@types+react@18.3.26_esbuild@0.25.9_storybook@10.2.3_@test_1e909a19285aafcb7051ac1c3970312d/node_modules/@storybook/addon-docs/dist/blocks.js"),o=l("../charts/src/charts/line-chart/stories/index.stories.tsx"),x=l("../charts/src/charts/line-chart/stories/glyph.stories.tsx");function s(c){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...(0,L.R)(),...c.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(r.W8,{title:"JS Packages/Charts Library/Charts/Line Chart",of:o}),`
...
`]}),`
`,(0,e.jsxs)(n.p,{children:[(0,e.jsx)(n.strong,{children:"Note"}),": The animation plays once when the chart initially renders and does not repeat."]})]})}function G(c={}){const{wrapper:n}={...(0,L.R)(),...c.components};return n?(0,e.jsx)(n,{...c,children:(0,e.jsx)(s,{...c})}):s(c)}}}]);
