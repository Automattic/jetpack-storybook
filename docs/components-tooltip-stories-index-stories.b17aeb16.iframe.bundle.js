...
`,r={Default:{startLoc:{col:17,line:60},endLoc:{col:2,line:72},startBody:{col:17,line:60},endBody:{col:2,line:72}},CustomComponent:{startLoc:{col:17,line:60},endLoc:{col:2,line:72},startBody:{col:17,line:60},endBody:{col:2,line:72}}};const i=({data:p})=>(0,e.jsxs)("div",{style:{padding:"8px"},children:[(0,e.jsx)("strong",{style:{display:"block",marginBottom:"4px"},children:p.label}),(0,e.jsxs)("div",{style:{color:"#888"},children:["Value: ",p.value]})]}),m={title:"JS Packages/Charts/Composites/Tooltip",component:d.R,parameters:{storySource:{source:`import { BaseTooltip } from '../index';
...
};`,locationsMap:{default:{startLoc:{col:17,line:60},endLoc:{col:2,line:72},startBody:{col:17,line:60},endBody:{col:2,line:72}},"custom-component":{startLoc:{col:17,line:60},endLoc:{col:2,line:72},startBody:{col:17,line:60},endBody:{col:2,line:72}}}},layout:"centered",docs:{description:{component:"A flexible tooltip component that can display data with custom styling and layout."}}},argTypes:{data:{description:"The data object containing label and value",control:"object"},top:{description:"Distance from top of container",control:{type:"range",min:0,max:200}},left:{description:"Distance from left of container",control:{type:"range",min:0,max:200}},style:{description:"Additional CSS styles to apply",control:"object"}}},a=p=>(0,e.jsx)("div",{style:{position:"relative",padding:"2rem",border:"1px dashed #ccc",width:"300px",height:"200px",background:"#f5f5f5"},children:(0,e.jsx)(d.R,{...p})}),n=a.bind({});n.args={top:100,left:100,data:{label:"Monthly Sales",value:4200}};const o=a.bind({});o.args={...n.args,component:i,data:{label:"Q4 Performance",value:27},style:{backgroundColor:"#fff",color:"#333",boxShadow:"0 2px 8px rgba(0,0,0,0.15)"}};const s=["Default","CustomComponent"];n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`args => <div style={{
  position: 'relative',
  padding: '2rem',
  border: '1px dashed #ccc',
  width: '300px',
