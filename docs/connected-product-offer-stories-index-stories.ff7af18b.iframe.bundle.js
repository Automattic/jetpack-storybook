"use strict";(()=>{(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[9414],{"../../packages/my-jetpack/_inc/components/connected-product-offer/stories/index.stories.jsx":(D,l,e)=>{var v,b,C;e.r(l),e.d(l,{Default:()=>d,__namedExportsOrder:()=>w,default:()=>B});var y=e("../../../node_modules/.pnpm/react@18.2.0/node_modules/react/index.js"),u=e("../components/components/product-offer/index.tsx"),s=e("../../../node_modules/.pnpm/prop-types@15.8.1/node_modules/prop-types/index.js"),p=e.n(s),a=e("../../packages/my-jetpack/_inc/hooks/use-my-jetpack-connection/index.js"),m=e("../../packages/my-jetpack/_inc/hooks/use-product/index.js");function k(n,i){const{siteSuffix:o,myJetpackUrl:g}=(window==null?void 0:window.myJetpackInitialState)||{},P=new URL("https://wordpress.com/checkout/"),t=new URL(`${P}${o}/${n}`);return t.searchParams.set("redirect_to",g),i||t.searchParams.set("unlinked",1),t.searchParams.set("site",o),t.toString()}var _=e("../../../node_modules/.pnpm/react@18.2.0/node_modules/react/jsx-runtime.js");const r=n=>{let{slug:i,onClick:o,trackButtonClick:g,...P}=n;const{detail:t,isFetching:R}=(0,m.i)(i),{title:E,longDescription:F,features:J,pricingForUi:T,isBundle:L,supportedProducts:I,hasRequiredPlan:S}=t,{isFree:O,fullPricePerMonth:W,currencyCode:Z,discountPricePerMonth:H,wpcomProductSlug:x}=T,{isUserConnected:N}=(0,a.Z)(),G=!O&&!S&&x?k(x,N):null,$=(0,y.useCallback)(()=>{g(),o&&o()},[o,g]);return(0,_.jsx)(u.Z,{slug:i,title:E,description:F,features:J,pricing:{isFree:O,price:W,offPrice:H,currency:Z},isBundle:L,supportedProducts:I,hasRequiredPlan:S,onAdd:$,addProductUrl:o?void 0:G,isLoading:R,...P})};r.displayName="ConnectedProductOffer",r.propTypes={slug:p().string.isRequired},r.defaultProps={trackButtonClick:()=>{}},r.__docgenInfo={description:`Product Detail component.
...
`,ne={Default:{startLoc:{col:35,line:26},endLoc:{col:78,line:26},startBody:{col:35,line:26},endBody:{col:78,line:26}}};const B={title:"Packages/My Jetpack/Connected Product Offer",component:c,parameters:{storySource:{source:`
import React from 'react';
import ConnectedProductOffer from '../index.jsx';
import { getAllMockData, getProductSlugs } from './utils.js';
export default {
...
};`,locationsMap:{default:{startLoc:{col:35,line:26},endLoc:{col:78,line:26},startBody:{col:35,line:26},endBody:{col:78,line:26}}}},layout:"centered"},argTypes:{slug:{control:{type:"select"},options:U(!0)},isCard:{control:{type:"boolean"}}}},M=A(),h=n=>(0,_.jsx)(c,{...n});h.displayName="DefaultDefaultProductOffer";const d=h.bind({});d.parameters={mockData:M},d.args={slug:"backup",isCard:!1},d.parameters={...d.parameters,docs:{...(v=d.parameters)==null?void 0:v.docs,source:{originalSource:"args => <ConnectedProductOffer {...args} />",...(C=(b=d.parameters)==null?void 0:b.docs)==null?void 0:C.source}}};const w=["Default"]},"../../packages/my-jetpack/_inc/hooks/use-my-jetpack-connection/index.js":(D,l,e)=>{e.d(l,{Z:()=>u});var y=e("../connection/components/use-connection/index.jsx");function u(){const{apiRoot:s,apiNonce:p}=myJetpackRest,{topJetpackMenuItemUrl:a}=myJetpackInitialState,m=(0,y.Z)({apiRoot:s,apiNonce:p}),k=m.isRegistered;return{apiNonce:p,apiRoot:s,...m,isSiteConnected:k,topJetpackMenuItemUrl:a}}},"../../packages/my-jetpack/_inc/hooks/use-product/index.js":(D,l,e)=>{e.d(l,{i:()=>p});var y=e("../../../node_modules/.pnpm/@wordpress+data@9.2.0_react@18.2.0/node_modules/@wordpress/data/build-module/components/use-dispatch/use-dispatch.js"),u=e("../../../node_modules/.pnpm/@wordpress+data@9.2.0_react@18.2.0/node_modules/@wordpress/data/build-module/components/use-select/index.js"),s=e("../../packages/my-jetpack/_inc/state/store.js");function p(a){const{activateProduct:m,deactivateProduct:k,installStandalonePluginForProduct:_}=(0,y.Z)(s.t),r=(0,u.Z)(c=>c(s.t).getProduct(a));return{activate:()=>m(a),deactivate:()=>k(a),installStandalonePlugin:()=>_(a),productsList:(0,u.Z)(c=>c(s.t).getProducts()),detail:r,isActive:r.status==="active",isFetching:(0,u.Z)(c=>c(s.t).isFetching(a)),status:r.status}}}}]);})();
