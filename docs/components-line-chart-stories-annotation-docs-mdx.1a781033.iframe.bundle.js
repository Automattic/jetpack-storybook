(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[3601,7733],{"../../../node_modules/.pnpm/@mdx-js+react@3.1.0_@types+react@18.3.23_react@18.3.1/node_modules/@mdx-js/react/lib/index.js":(c,o,s)=>{"use strict";s.d(o,{R:()=>t,x:()=>a});var i=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");const e={},d=i.createContext(e);function t(r){const l=i.useContext(d);return i.useMemo(function(){return typeof r=="function"?r(l):{...l,...r}},[l,r])}function a(r){let l;return r.disableParentContext?l=typeof r.components=="function"?r.components(e):r.components||e:l=t(r.components),i.createElement(d.Provider,{value:l},r.children)}},"../charts/src/components/line-chart/stories/annotation.docs.mdx":(c,o,s)=>{"use strict";s.r(o),s.d(o,{default:()=>l});var i=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),d=s("../../../node_modules/.pnpm/@mdx-js+react@3.1.0_@types+react@18.3.23_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),t=s("../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist/blocks.mjs"),a=s("../charts/src/components/line-chart/stories/annotation.stories.tsx");function r(h){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...(0,d.R)(),...h.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(t.W8,{title:"JS Packages/Charts/Types/Line Chart/Annotations",of:a}),`
...
`}),`
`,(0,e.jsx)(n.p,{children:"The new compound component pattern provides better TypeScript support, more flexibility, and clearer composition."})]})}function l(h={}){const{wrapper:n}={...(0,d.R)(),...h.components};return n?(0,e.jsx)(n,{...h,children:(0,e.jsx)(r,{...h})}):r(h)}},"../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive":c=>{function o(s){var i=new Error("Cannot find module '"+s+"'");throw i.code="MODULE_NOT_FOUND",i}o.keys=()=>[],o.resolve=o,o.id="../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive",c.exports=o},"../charts/src/components/line-chart/stories/annotation.stories.tsx":(c,o,s)=>{"use strict";s.r(o),s.d(o,{Colored:()=>u,Custom:()=>m,Default:()=>n,Horizontal:()=>p,Mixed:()=>x,Vertical:()=>j,__namedExportsOrder:()=>_,default:()=>r});var i=s("../charts/src/stories/sample-data/index.ts"),e=s("../charts/src/components/line-chart/line-chart.tsx"),d=s("../charts/src/components/line-chart/stories/config.tsx"),t=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const r={...d.N,title:"JS Packages/Charts/Types/Line Chart/Annotations",args:{...d.p}},l=b=>C=>(0,t.jsx)(e.A,{...C,children:(0,t.jsxs)(e.A.AnnotationsOverlay,{children:[(0,t.jsx)(e.A.Annotation,{datum:i.B2[0].data[10],title:"Notable event",subtitle:"This is a notable event",...b?.[0]||{}}),(0,t.jsx)(e.A.Annotation,{datum:i.B2[1].data[i.B2[1].data.length-10],title:"Another notable event",subtitle:"This is another notable event",...b?.[1]||{}}),(0,t.jsx)(e.A.Annotation,{datum:i.B2[2].data[i.B2[2].data.length-51],title:"Concerning event",subtitle:"This is a concerning event",...b?.[2]||{}})]})}),n=l([{},{},{styles:{circleSubject:{fill:"var(--jp-red)"},connector:{stroke:"var(--jp-red)"},label:{anchorLineStroke:"var(--jp-red)"}}}]).bind({}),j=l([{subjectType:"line-vertical"},{subjectType:"line-vertical"},{subjectType:"line-vertical",styles:{connector:{stroke:"var(--jp-red)"},label:{anchorLineStroke:"var(--jp-red)"}}}]).bind({}),p=l([{subjectType:"line-horizontal"},{subjectType:"line-horizontal"},{subjectType:"line-horizontal",styles:{connector:{stroke:"var(--jp-red)"},label:{anchorLineStroke:"var(--jp-red)"}}}]).bind({}),x=l([{subjectType:"circle"},{subjectType:"line-vertical"},{subjectType:"line-horizontal",styles:{connector:{stroke:"var(--jp-red)"},label:{anchorLineStroke:"var(--jp-red)"}}}]).bind({}),u=l([{styles:{label:{backgroundFill:"#98C8DF",showAnchorLine:!1},circleSubject:{fill:"#98C8DF"},connector:{stroke:"#98C8DF"}}},{styles:{label:{backgroundFill:"#006DAB",fontColor:"#fff",showAnchorLine:!1},circleSubject:{fill:"#006DAB"},connector:{stroke:"#006DAB"}}},{styles:{label:{backgroundFill:"var(--jp-red)",showAnchorLine:!1,fontColor:"#fff"},circleSubject:{fill:"var(--jp-red)"},connector:{stroke:"var(--jp-red)"}}}]).bind({}),y=()=>(0,t.jsx)("span",{style:{background:"black",color:"white",width:"24px",height:"24px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%"},children:"D"}),g={subjectType:"line-vertical",styles:{label:{showAnchorLine:!1,y:"start"}},title:"Deployed",renderLabel:()=>(0,t.jsx)("span",{style:{transform:"translate(0, 6px)"},children:(0,t.jsx)(y,{})}),renderLabelPopover:()=>(0,t.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:"0.5rem"},children:[(0,t.jsxs)("div",{style:{margin:0,display:"flex",alignItems:"center",gap:"6px",paddingBlock:"0.25rem "},children:[(0,t.jsx)(y,{}),(0,t.jsx)("strong",{children:"Deploy finished"})]}),(0,t.jsx)("p",{style:{margin:0},children:"Thu. Apr 24, 2025. 09:57:23 UTC"})]})},f=()=>(0,t.jsx)("span",{style:{background:"var(--jp-red)",color:"white",width:"20px",height:"20px",display:"inline-flex",alignItems:"center",justifyContent:"center",borderRadius:"50%"},children:"!"}),v={subjectType:"circle",styles:{circleSubject:{radius:0},label:{showAnchorLine:!1},connector:{stroke:"transparent"}},title:"Alert",renderLabel:()=>(0,t.jsx)(f,{}),renderLabelPopover:()=>(0,t.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:"0.5rem"},children:[(0,t.jsxs)("div",{style:{margin:0,display:"flex",alignItems:"center",gap:"6px",paddingBlock:"0.25rem "},children:[(0,t.jsx)(f,{}),(0,t.jsx)("strong",{children:"Origin HTTP 5xx Response Codes Rate Anomaly [Beta]"})]}),(0,t.jsx)("p",{style:{margin:0},children:"Unusually high number of HTTP 5xx response codes detected on Origin"})]})},m=l([{...g},{...g},{...v}]).bind({}),_=["Default","Vertical","Horizontal","Mixed","Colored","Custom"];n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`createAnnotationTemplate([{}, {}, {
  styles: {
    circleSubject: {
      fill: 'var(--jp-red)'
    },
...
}])`,...n.parameters?.docs?.source}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`createAnnotationTemplate([{
  subjectType: 'line-vertical'
}, {
  subjectType: 'line-vertical'
}, {
...
}])`,...j.parameters?.docs?.source}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`createAnnotationTemplate([{
  subjectType: 'line-horizontal'
}, {
  subjectType: 'line-horizontal'
}, {
...
}])`,...p.parameters?.docs?.source}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`createAnnotationTemplate([{
  subjectType: 'circle'
}, {
  subjectType: 'line-vertical'
}, {
...
}])`,...x.parameters?.docs?.source}}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`createAnnotationTemplate([{
  styles: {
    label: {
...
}])`,...u.parameters?.docs?.source}}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`createAnnotationTemplate([{
  ...customTopAnnotationArgs
}, {
  ...customTopAnnotationArgs
}, {
  ...customBottomAnnotationArgs
}])`,...m.parameters?.docs?.source}}}},"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive":c=>{function o(s){var i=new Error("Cannot find module '"+s+"'");throw i.code="MODULE_NOT_FOUND",i}o.keys=()=>[],o.resolve=o,o.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive",c.exports=o},"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive":c=>{function o(s){var i=new Error("Cannot find module '"+s+"'");throw i.code="MODULE_NOT_FOUND",i}o.keys=()=>[],o.resolve=o,o.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive",c.exports=o}}]);
