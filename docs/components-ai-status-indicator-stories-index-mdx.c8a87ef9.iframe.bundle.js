...
Done.args = {
  state: 'done',
  size: 48
};`,locationsMap:{default:{startLoc:{col:24,line:26},endLoc:{col:1,line:34},startBody:{col:24,line:26},endBody:{col:1,line:34}},init:{startLoc:{col:24,line:26},endLoc:{col:1,line:34},startBody:{col:24,line:26},endBody:{col:1,line:34}},requesting:{startLoc:{col:24,line:26},endLoc:{col:1,line:34},startBody:{col:24,line:26},endBody:{col:1,line:34}},suggesting:{startLoc:{col:24,line:26},endLoc:{col:1,line:34},startBody:{col:24,line:26},endBody:{col:1,line:34}},error:{startLoc:{col:24,line:26},endLoc:{col:1,line:34},startBody:{col:24,line:26},endBody:{col:1,line:34}},done:{startLoc:{col:24,line:26},endLoc:{col:1,line:34},startBody:{col:24,line:26},endBody:{col:1,line:34}}}}},title:"JS Packages/AI Client/AiStatusIndicator",component:o.A,argTypes:{state:{control:{type:"select"},options:["init","requesting","suggesting","done","error"]},size:{control:{type:"select"},options:[24,32,48,64]},action:{table:{disable:!0}}}},s=g=>{const j={state:g.state,size:g.size};return(0,n.jsx)(o.A,{...j})},r=s.bind({});r.args={state:"init",size:24};const u=s.bind({});u.args={state:"init",size:48};const i=s.bind({});i.args={state:"requesting",size:48};const a=s.bind({});a.args={state:"suggesting",size:48};const m=s.bind({});m.args={state:"error",size:48};const _=s.bind({});_.args={state:"done",size:48};const y=["_default","Init","Requesting","Suggesting","Error","Done"];r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`(args: AiStatusIndicatoryStoryProps) => {
  const props: AiStatusIndicatorProps = {
    state: args.state,
    size: args.size
  };
  return <AiStatusIndicator {...props} />;
}`,...r.parameters?.docs?.source}}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`(args: AiStatusIndicatoryStoryProps) => {
  const props: AiStatusIndicatorProps = {
    state: args.state,
    size: args.size
  };
