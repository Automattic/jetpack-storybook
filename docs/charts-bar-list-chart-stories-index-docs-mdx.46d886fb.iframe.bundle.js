"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[593,2885],{"../../../node_modules/.pnpm/clsx@2.1.1/node_modules/clsx/dist/clsx.mjs":((M,P,l)=>{l.d(P,{A:()=>S});function T(s){var d,c,f="";if(typeof s=="string"||typeof s=="number")f+=s;else if(typeof s=="object")if(Array.isArray(s)){var v=s.length;for(d=0;d<v;d++)s[d]&&(c=T(s[d]))&&(f&&(f+=" "),f+=c)}else for(c in s)s[c]&&(f&&(f+=" "),f+=c);return f}function e(){for(var s,d,c=0,f="",v=arguments.length;c<v;c++)(s=arguments[c])&&(d=T(s))&&(f&&(f+=" "),f+=d);return f}const S=e}),"../../../node_modules/.pnpm/deepmerge@4.3.1/node_modules/deepmerge/dist/cjs.js":(M=>{var P=function(n){return l(n)&&!T(n)};function l(a){return!!a&&typeof a=="object"}function T(a){var n=Object.prototype.toString.call(a);return n==="[object RegExp]"||n==="[object Date]"||s(a)}var e=typeof Symbol=="function"&&Symbol.for,S=e?Symbol.for("react.element"):60103;function s(a){return a.$$typeof===S}function d(a){return Array.isArray(a)?[]:{}}function c(a,n){return n.clone!==!1&&n.isMergeableObject(a)?O(d(a),a,n):a}function f(a,n,o){return a.concat(n).map(function(r){return c(r,o)})}function v(a,n){if(!n.customMerge)return O;var o=n.customMerge(a);return typeof o=="function"?o:O}function t(a){return Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(a).filter(function(n){return Object.propertyIsEnumerable.call(a,n)}):[]}function y(a){return Object.keys(a).concat(t(a))}function D(a,n){try{return n in a}catch{return!1}}function B(a,n){return D(a,n)&&!(Object.hasOwnProperty.call(a,n)&&Object.propertyIsEnumerable.call(a,n))}function V(a,n,o){var r={};return o.isMergeableObject(a)&&y(a).forEach(function(i){r[i]=c(a[i],o)}),y(n).forEach(function(i){B(a,i)||(D(a,i)&&o.isMergeableObject(n[i])?r[i]=v(i,o)(a[i],n[i],o):r[i]=c(n[i],o))}),r}function O(a,n,o){o=o||{},o.arrayMerge=o.arrayMerge||f,o.isMergeableObject=o.isMergeableObject||P,o.cloneUnlessOtherwiseSpecified=c;var r=Array.isArray(n),i=Array.isArray(a),x=r===i;return x?r?o.arrayMerge(a,n,o):V(a,n,o):c(n,o)}O.all=function(n,o){if(!Array.isArray(n))throw new Error("first argument should be an array");return n.reduce(function(r,i){return O(r,i,o)},{})};var C=O;M.exports=C}),"../charts/src/charts/bar-list-chart/bar-list-chart.tsx":((M,P,l)=>{l.d(P,{A:()=>o});var T=l("../number-formatters/src/index.ts"),e=l("../../../node_modules/.pnpm/@visx+group@3.12.0_react@18.3.1/node_modules/@visx/group/esm/Group.js"),S=l("../../../node_modules/.pnpm/@visx+scale@3.12.0/node_modules/@visx/scale/esm/scales/band.js"),s=l("../../../node_modules/.pnpm/@visx+scale@3.12.0/node_modules/@visx/scale/esm/createScale.js"),d=l("../../../node_modules/.pnpm/@visx+text@3.12.0_react@18.3.1/node_modules/@visx/text/esm/Text.js"),c=l("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),f=l("../charts/src/providers/chart-context/global-charts-provider.tsx"),v=l("../charts/src/charts/bar-chart/bar-chart.tsx"),t=l("../charts/src/charts/private/with-responsive/with-responsive.tsx"),y=l("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const D=r=>{const i=r;return i&&"bandwidth"in i?i?.bandwidth()??0:0},B=({textProps:r,x:i,y:x,label:m,formatter:_})=>(0,y.jsx)(d.A,{...r,textAnchor:"start",x:i,y:x,children:_(m)}),V=({textProps:r,x:i,y:x,value:m,formatter:_})=>(0,y.jsx)(d.A,{...r,textAnchor:"end",x:i,y:x,fontWeight:500,children:_(m)}),O=({ticks:r,tickLabelProps:i,yOffset:x,labelPosition:m,valuePosition:_,data:h,labelFormatter:u,valueFormatter:p,LabelComponent:g=B,ValueComponent:b=V})=>{if(r.length===0)return null;const j=r.map(({value:A,index:w})=>typeof i=="function"?i(A,w,r):{});return r.map(({from:A,formattedValue:w},L)=>{const E=j[L]??{};delete E.textAnchor,delete E.dx;const R=h.reduce((W,{data:F})=>W+(F[L]?.value??0),0),I=A.y+x;return(0,y.jsxs)(e.A,{children:[(0,y.jsx)(g,{textProps:E,x:m,y:I,label:w,formatter:u}),(0,y.jsx)(b,{textProps:E,x:_,y:I,value:R,formatter:p,data:h,index:L})]},L)})},C=(r,i,x,m)=>{if(!m)return 0;const _=r.map(({label:b})=>b),h=(0,s.A)({type:"band",range:[0,x],domain:_,...i}),u=(0,S.A)({domain:_,range:[0,D(h)],padding:i.paddingInner});return-(D(u)+6)},a=({data:r,width:i,height:x,options:m={},margin:_={left:0,right:20,bottom:0,top:0},...h})=>{const u=(0,c.useMemo)(()=>{const p=r.length>1,g={paddingInner:p?.3:.1,padding:p?.3:.1},b={zero:!0},j={...g,...m.yScale??{}},A={...b,...m.xScale??{}};return{yScale:j,xScale:A,labelPosition:m.labelPosition??(p?0:10),valueFormatter:m.valueFormatter??(w=>(0,T.qe)(w)),labelFormatter:m.labelFormatter??(w=>String(w)),valuePosition:m.valuePosition??i,yOffset:m.yOffset??C(r,j,x,p)}},[m,i,r,x]);return(0,y.jsx)(v.A,{orientation:"horizontal",gridVisibility:"none",data:r,width:i,height:x,margin:_,options:{axis:{y:{children:p=>(0,y.jsx)(O,{...p,data:r,yOffset:u.yOffset,labelPosition:u.labelPosition,valuePosition:u.valuePosition,labelFormatter:u.labelFormatter,valueFormatter:u.valueFormatter,LabelComponent:m.labelComponent,ValueComponent:m.valueComponent})},x:{children:()=>null}},xScale:u.xScale,yScale:u.yScale},...h})},n=r=>(0,c.useContext)(f.m)?(0,y.jsx)(a,{...r}):(0,y.jsx)(f.S,{children:(0,y.jsx)(a,{...r})});n.displayName="BarListChart";const o=(0,t.F)(n);try{ResponsiveChart.displayName="ResponsiveChart",ResponsiveChart.__docgenInfo={description:"",displayName:"ResponsiveChart",props:{width:{defaultValue:null,description:"Width of the chart in pixels",name:"width",required:!1,type:{name:"number"}},height:{defaultValue:null,description:"Height of the chart in pixels",name:"height",required:!1,type:{name:"number"}},size:{defaultValue:null,description:"Size of the chart in pixels for pie and donut charts",name:"size",required:!1,type:{name:"number"}},className:{defaultValue:null,description:"Additional CSS class name for the chart container",name:"className",required:!1,type:{name:"string"}},orientation:{defaultValue:null,description:"",name:"orientation",required:!1,type:{name:"enum",value:[{value:'"horizontal"'},{value:'"vertical"'}]}},onPointerDown:{defaultValue:null,description:"Callback function for pointer down event",name:"onPointerDown",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerMove:{defaultValue:null,description:"Callback function for pointer move event",name:"onPointerMove",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerUp:{defaultValue:null,description:"Callback function for pointer up event",name:"onPointerUp",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerOut:{defaultValue:null,description:"Callback function for pointer out event",name:"onPointerOut",required:!1,type:{name:"(event: PointerEvent<Element>) => void"}},data:{defaultValue:null,description:"Array of data points to display in the chart",name:"data",required:!0,type:{name:"SeriesData[]"}},options:{defaultValue:null,description:"More options for the chart.",name:"options",required:!1,type:{name:'{ yScale: Omit<ScaleOptions, "type">; xScale: Omit<ScaleOptions, "type">; labelFormatter?: (value: string) => string; valueFormatter?: (value: number) => string; ... 4 more ...; valueComponent?: ComponentType<...>; }'}},margin:{defaultValue:null,description:"Chart margins",name:"margin",required:!1,type:{name:"{ top?: number; right?: number; bottom?: number; left?: number; }"}},legendItemClassName:{defaultValue:null,description:`Additional CSS class name for legend items.
...
`,(0,e.jsx)(s.Hl,{of:d.CustomLabelComponent}),`
...
`,(0,e.jsx)(s.Hl,{of:d.CustomValueComponent}),`
...
`]})]})}function f(v={}){const{wrapper:t}={...(0,S.R)(),...v.components};return t?(0,e.jsx)(t,{...v,children:(0,e.jsx)(c,{...v})}):c(v)}}),"../charts/src/charts/bar-list-chart/stories/index.stories.tsx":((M,P,l)=>{l.r(P),l.d(P,{Animation:()=>i,CustomLabelComponent:()=>x,CustomValueComponent:()=>m,Default:()=>o,MultiSeries:()=>r,__namedExportsOrder:()=>_,default:()=>n});var T=l("../number-formatters/src/index.ts"),e=l("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),S=l("../../../node_modules/.pnpm/classnames@2.5.1/node_modules/classnames/index.js"),s=l.n(S),d=["className","innerRef"];function c(){return c=Object.assign?Object.assign.bind():function(h){for(var u=1;u<arguments.length;u++){var p=arguments[u];for(var g in p)Object.prototype.hasOwnProperty.call(p,g)&&(h[g]=p[g])}return h},c.apply(this,arguments)}function f(h,u){if(h==null)return{};var p={},g=Object.keys(h),b,j;for(j=0;j<g.length;j++)b=g[j],!(u.indexOf(b)>=0)&&(p[b]=h[b]);return p}function v(h){var u=h.className,p=h.innerRef,g=f(h,d);return e.createElement("circle",c({ref:p,className:s()("visx-circle",u)},g))}var t=l("../../../node_modules/.pnpm/@visx+text@3.12.0_react@18.3.1/node_modules/@visx/text/esm/Text.js"),y=l("../charts/src/providers/chart-context/hooks/use-global-charts-theme.ts"),D=l("../charts/src/stories/chart-decorator.tsx"),B=l("../charts/src/stories/theme-config.tsx"),V=l("../charts/src/stories/sample-data/index.ts"),O=l("../charts/src/charts/bar-list-chart/bar-list-chart.tsx"),C=l("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const n={title:"JS Packages/Charts Library/Charts/Bar List Chart",component:O.A,parameters:{layout:"centered"},decorators:[D.OI],argTypes:{...D.xo,...B.jW}},o={args:{...B.In,withTooltips:!0,data:V.V_,containerWidth:"600px",containerHeight:"332px"}},r={args:{...o.args,data:V._v}},i={args:{...o.args,animation:!0}},x={args:{...o.args,data:V.V_,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{xScale:{},yScale:{},labelComponent:({textProps:h,x:u,y:p,label:g,formatter:b})=>{const A=(0,y.p)().colors[1];return(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(v,{cx:u+6,cy:p,r:8,fill:A}),(0,C.jsx)(t.A,{...h,textAnchor:"start",x:u+24,y:p,fontWeight:500,children:b(g)})]})}}}},m={args:{...o.args,data:V._v,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{xScale:{},yScale:{},valueComponent:({textProps:h,x:u,y:p,value:g,formatter:b,data:j,index:A})=>{const w=j[0].data[A].value,L=j[1].data[A].value,E=L===0?0:((w-L)/L*100).toFixed(0);return(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(t.A,{...h,textAnchor:"end",x:u,y:p,dx:-50,fontWeight:500,children:b(g)}),(0,C.jsx)(t.A,{...h,textAnchor:"end",x:u,y:p,dx:-10,fill:"#008A20",fontWeight:500,children:`${Number(E)>0?"+":""}${E}%`})]})},valueFormatter:h=>`$${(0,T.qe)(h)}`}}},_=["Default","MultiSeries","Animation","CustomLabelComponent","CustomValueComponent"];o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    ...sharedThemeArgs,
    withTooltips: true,
    data: salesByProduct,
