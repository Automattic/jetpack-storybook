(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[1972],{"../../../node_modules/.pnpm/@mdx-js+react@3.1.0_@types+react@18.3.23_react@18.3.1/node_modules/@mdx-js/react/lib/index.js":(l,r,t)=>{"use strict";t.d(r,{R:()=>s,x:()=>c});var i=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");const e={},a=i.createContext(e);function s(d){const o=i.useContext(a);return i.useMemo(function(){return typeof d=="function"?d(o):{...o,...d}},[o,d])}function c(d){let o;return d.disableParentContext?o=typeof d.components=="function"?d.components(e):d.components||e:o=s(d.components),i.createElement(a.Provider,{value:o},d.children)}},"../charts/src/components/pie-chart/stories/donut.docs.mdx":(l,r,t)=>{"use strict";t.r(r),t.d(r,{default:()=>g});var i=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),a=t("../../../node_modules/.pnpm/@mdx-js+react@3.1.0_@types+react@18.3.23_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),s=t("../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist/blocks.mjs"),c=t("../charts/src/components/pie-chart/stories/donut.stories.tsx"),d=t("../charts/src/components/pie-chart/stories/donut-legend.stories.tsx");function o(h){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...(0,a.R)(),...h.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(s.W8,{title:"JS Packages/Charts/Types/Donut Chart",of:c}),`
...
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"onPointerDown"})}),", ",(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"onPointerUp"})}),", ",(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"onPointerMove"})}),", ",(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"onPointerOut"})}),": Event handlers"]}),`
...
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"legendAlignmentHorizontal"})})," (default: ",(0,e.jsx)(n.code,{children:"'center'"}),"): Legend horizontal alignment"]}),`
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"legendAlignmentVertical"})})," (default: ",(0,e.jsx)(n.code,{children:"'bottom'"}),"): Legend vertical alignment"]}),`
`]}),`
...
`,(0,e.jsx)(s.Hl,{of:c.WithTooltipsDoughnut}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<PieChart
	thickness={ 0.5 }
	withTooltips={ true }
	data={ data }
...
`,(0,e.jsx)(s.kL,{language:"jsx",code:`// Responsive text sizing
...
`,(0,e.jsx)(s.kL,{language:"jsx",code:`// Responsive donut - fills parent container
<PieChart
	thickness={ 0.4 }
	data={ data }
	maxWidth={ 600 }
...
`,(0,e.jsx)(s.kL,{language:"jsx",code:`// The chart validates:
...
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<PieChart thickness={ 0.5 } data={ data }>
	<Group>
		<Text
			textAnchor="middle"
			verticalAnchor="middle"
...
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<PieChart thickness={ 0.4 } data={ conversionData }>
	<Group>
		<Text textAnchor="middle" verticalAnchor="middle" fontSize={ 32 } fontWeight="bold">
			12.5%
		</Text>
...
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<PieChart thickness={ 0.3 } data={ taskData }>
	<Group>
		<Text textAnchor="middle" verticalAnchor="middle" fontSize={ 24 } fontWeight="bold">
			24/30
		</Text>
...
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<PieChart thickness={ 0.5 } data={ budgetData }>
	<Group>
...
`})})]})}function g(h={}){const{wrapper:n}={...(0,a.R)(),...h.components};return n?(0,e.jsx)(n,{...h,children:(0,e.jsx)(o,{...h})}):o(h)}},"../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive":l=>{function r(t){var i=new Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}r.keys=()=>[],r.resolve=r,r.id="../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive",l.exports=r},"../charts/src/components/pie-chart/stories/donut-legend.stories.tsx":(l,r,t)=>{"use strict";t.r(r),t.d(r,{AlignmentPositioning:()=>j,Default:()=>x,VerticalOrientation:()=>p,__namedExportsOrder:()=>m,default:()=>h});var i=t("../../../node_modules/.pnpm/@visx+group@3.12.0_react@18.3.1/node_modules/@visx/group/esm/Group.js"),e=t("../../../node_modules/.pnpm/@visx+text@3.12.0_react@18.3.1/node_modules/@visx/text/esm/Text.js"),a=t("../charts/src/components/pie-chart/pie-chart.tsx"),s=t("../charts/src/stories/decorator-config.tsx"),c=t("../charts/src/stories/legend-config.tsx"),d=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const o=[{label:"Active Users",value:65e3,valueDisplay:"65K",percentage:65},{label:"Inactive Users",value:35e3,valueDisplay:"35K",percentage:35}],h={title:"JS Packages/Charts/Types/Donut Chart/Legend",component:a.A,parameters:{layout:"centered"},decorators:s.p,argTypes:c.r},n=_=>(0,d.jsx)(a.A,{..._}),u={resize:"none",containerWidth:"432px",containerHeight:"480px",thickness:.4,gapScale:.03,padding:20,cornerScale:.03,withTooltips:!0,data:o,showLegend:!0,legendOrientation:"horizontal",children:(0,d.jsxs)(i.A,{children:[(0,d.jsx)(e.A,{textAnchor:"middle",verticalAnchor:"middle",fontSize:24,y:-16,children:"User Activity"}),(0,d.jsx)(e.A,{textAnchor:"middle",verticalAnchor:"middle",fontSize:18,y:16,children:"Total: 100K Users"})]})},x=n.bind({});x.args={...u};const j=n.bind({});j.args={...u,legendAlignmentHorizontal:"right",legendAlignmentVertical:"top"};const p=n.bind({});p.args={...u,legendOrientation:"vertical",legendAlignmentHorizontal:"right",legendAlignmentVertical:"top"};const m=["Default","AlignmentPositioning","VerticalOrientation"];x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:"args => <PieChart {...args} />",...x.parameters?.docs?.source}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:"args => <PieChart {...args} />",...j.parameters?.docs?.source}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:"args => <PieChart {...args} />",...p.parameters?.docs?.source}}}},"../charts/src/stories/legend-config.tsx":(l,r,t)=>{"use strict";t.d(r,{r:()=>e});var i=t("../charts/src/providers/theme/themes.ts");const e={showLegend:{control:{type:"boolean"},table:{category:"Legend"}},legendAlignmentHorizontal:{control:{type:"select"},options:["left","center","right"],table:{category:"Legend"}},legendAlignmentVertical:{control:{type:"select"},options:["top","bottom"],table:{category:"Legend"}},legendOrientation:{control:{type:"select"},options:["horizontal","vertical"],table:{category:"Legend"}},legendShape:{control:{type:"select"},options:["circle","rect"],table:{category:"Legend"}},withLegendGlyph:{control:{type:"boolean"},table:{category:"Legend"},description:"Show glyphs in legend (Line charts only)"},theme:{control:{type:"select"},options:{default:void 0,jetpack:i.QI,woo:i.pk},defaultValue:void 0,table:{category:"Theme"}}};try{e.displayName="legendArgTypes",e.__docgenInfo={description:`Shared legend configuration for chart stories
Provides consistent argTypes and decorators across all chart legend stories`,displayName:"legendArgTypes",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/stories/legend-config.tsx#legendArgTypes"]={docgenInfo:e.__docgenInfo,name:"legendArgTypes",path:"../charts/src/stories/legend-config.tsx#legendArgTypes"})}catch{}},"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive":l=>{function r(t){var i=new Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}r.keys=()=>[],r.resolve=r,r.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive",l.exports=r},"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive":l=>{function r(t){var i=new Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}r.keys=()=>[],r.resolve=r,r.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive",l.exports=r}}]);
