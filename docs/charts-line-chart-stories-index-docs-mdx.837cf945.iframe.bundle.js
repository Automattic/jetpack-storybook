(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[5951],{"../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.1.10_@tes_8b6d8444bcdd16ef895876f31adb8bdf/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive":(v=>{function c(o){var h=new Error("Cannot find module '"+o+"'");throw h.code="MODULE_NOT_FOUND",h}c.keys=()=>[],c.resolve=c,c.id="../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.1.10_@tes_8b6d8444bcdd16ef895876f31adb8bdf/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive",v.exports=c}),"../charts/src/charts/line-chart/stories/glyph.stories.tsx":((v,c,o)=>{"use strict";o.r(c),o.d(c,{Custom:()=>S,CustomPerDataPoint:()=>T,CustomSvg:()=>P,End:()=>k,InTooltip:()=>E,Start:()=>_,__namedExportsOrder:()=>M,default:()=>D});var h=o("../../../node_modules/.pnpm/@visx+glyph@3.12.0_react@18.3.1/node_modules/@visx/glyph/esm/glyphs/GlyphStar.js"),e=o("../charts/src/providers/chart-context/global-charts-provider.tsx"),y=o("../charts/src/providers/chart-context/hooks/use-global-charts-theme.ts"),i=o("../charts/src/stories/theme-config.tsx"),d=o("../charts/src/charts/line-chart/line-chart.tsx"),g=o("../charts/src/charts/line-chart/stories/config.tsx"),s=o("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const b={...i.yI,glyph:g.Em},p=(l,{args:t})=>{const r=t.themeName,a=b[r||"default"];return(0,s.jsx)(e.S,{theme:a,children:(0,s.jsx)("div",{style:{resize:"both",overflow:"auto",padding:"2rem",width:"800px",maxWidth:"1200px",border:"1px dashed #ccc",display:"inline-block"},children:(0,s.jsx)(l,{})})})},D={...g.Nc,title:"JS Packages/Charts Library/Charts/Line Chart/Glyphs",decorators:[p],argTypes:{...g.Nc.argTypes,themeName:{...i.jW.themeName,options:["default","custom","glyph"]},withStartGlyphs:{control:"boolean",description:"Show glyphs at line start",table:{category:"Glyphs"}},withEndGlyphs:{control:"boolean",description:"Show glyphs at line end",table:{category:"Glyphs"}},withLegendGlyph:{control:"boolean",description:"Show glyphs in legend",table:{category:"Glyphs"}},glyphType:{control:"radio",options:["default","star","heart"],description:"Glyph shape",table:{category:"Glyphs"}},glyphSize:{control:{type:"range",min:4,max:16,step:1},description:"Glyph size (radius)",table:{category:"Glyphs"}}}},A=({color:l,size:t,x:r,y:a})=>{const j=typeof r=="number"&&typeof a=="number"&&(r!==0||a!==0)?{transform:`translate(${r}, ${a})`}:{};return(0,s.jsx)("g",{...j,children:(0,s.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:t*2,height:t*2,viewBox:"0 0 24 24",style:{overflow:"visible",pointerEvents:"none"},children:(0,s.jsx)("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z",fill:l,stroke:l,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",transform:"translate(-12, -12)"})})})},u=l=>{const{glyphType:t,glyphSize:r,...a}=l;let x=a.renderGlyph;t==="star"?x=({color:C,size:f,x:L,y:w})=>(0,s.jsx)(h.A,{top:w,left:L,size:f*f,fill:C}):t==="heart"&&(x=({color:C,size:f,x:L,y:w})=>(0,s.jsx)(A,{color:C,size:f,x:L,y:w}));const j=r?{radius:r}:a.glyphStyle;return(0,s.jsx)(d.A,{...a,renderGlyph:x,glyphStyle:j})},m={...g.pn,withStartGlyphs:!0},_=u.bind({});_.args={...m};const k=u.bind({});k.args={...m,withStartGlyphs:!1,withEndGlyphs:!0};const S=u.bind({});S.args={...m,withLegendGlyph:!0,renderGlyph:({color:l,size:t,x:r,y:a})=>(0,s.jsx)(h.A,{top:a,left:r,size:t*t,fill:l}),glyphStyle:{radius:10}};const G=({color:l,size:t,x:r,y:a})=>{const j=typeof r=="number"&&typeof a=="number"&&(r!==0||a!==0)?{transform:`translate(${r}, ${a})`}:{};return(0,s.jsx)("g",{...j,children:(0,s.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:t*2,height:t*2,viewBox:"0 0 24 24",style:{overflow:"visible",pointerEvents:"none"},children:(0,s.jsx)("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z",fill:l,stroke:l,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",transform:"translate(-12, -12)"})})})},P=u.bind({});P.args={...m,withLegendGlyph:!0,renderGlyph:({color:l,size:t,x:r,y:a})=>(0,s.jsx)(G,{color:l,size:t,x:r,y:a}),glyphStyle:{radius:8}};const O=({tooltipData:l})=>{const t=(0,y.p)();return(0,s.jsxs)("div",{children:[(0,s.jsx)("div",{style:{marginBottom:"0.5rem"},children:l?.nearestDatum?.datum?.date?.toLocaleDateString()}),(0,s.jsx)("div",{children:Object.entries(l?.datumByKey||{}).map(([r,a],x)=>{const{datum:j}=a;return(0,s.jsx)("div",{children:(0,s.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"0.5rem",marginBottom:"0.2rem"},children:[(0,s.jsx)("svg",{width:20,height:20,children:(0,s.jsx)(h.A,{size:100,top:10,left:10,fill:"#fff",stroke:t.colors[x%t.colors.length]})}),r,": ",j.value]})},r)})})]})},E=u.bind({});E.args={...m,renderGlyph:({color:l,size:t,x:r,y:a})=>(0,s.jsx)(h.A,{top:a,left:r,size:t*t,fill:"#fff",stroke:l}),glyphStyle:{radius:10},renderTooltip:O};const T=u.bind({});T.args={...m,showLegend:!0,withStartGlyphs:!0,withLegendGlyph:!0,themeName:"glyph",glyphStyle:{radius:8}};const M=["Start","End","Custom","CustomSvg","InTooltip","CustomPerDataPoint"]}),"../charts/src/charts/line-chart/stories/index.docs.mdx":((v,c,o)=>{"use strict";o.r(c),o.d(c,{default:()=>b});var h=o("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=o("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),y=o("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.26_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),i=o("../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.1.10_@tes_8b6d8444bcdd16ef895876f31adb8bdf/node_modules/@storybook/addon-docs/dist/blocks.js"),d=o("../charts/src/charts/line-chart/stories/index.stories.tsx"),g=o("../charts/src/charts/line-chart/stories/glyph.stories.tsx");function s(p){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...(0,y.R)(),...p.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(i.W8,{title:"JS Packages/Charts Library/Charts/Line Chart",of:d}),`
...
`,(0,e.jsx)(i.Hl,{of:d.SingleSeries}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<LineChart
	data={[
		{
			label: 'Temperature',
			data: [
...
`,(0,e.jsx)(i.kL,{language:"jsx",code:`// Theme configuration example
const customTheme = {
	lineChart: {
		lineStyles: {
			comparison: {
...
`,(0,e.jsx)(i.Hl,{of:d.GradientFilled}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<LineChart
	data={data}
...
`,(0,e.jsx)(i.Hl,{of:d.GradientCustomColors}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`const data = [
	{
		label: 'Revenue',
		data: chartData,
		options: {
...
`,(0,e.jsx)(i.Hl,{of:d.GradientTransparent}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`const data = [
	{
		label: 'Temperature',
...
`,(0,e.jsx)(i.Hl,{of:d.WithPointerEvents}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<LineChart
	data={data}
...
`,(0,e.jsx)(i.Hl,{of:d.CustomLegendPositioning}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<LineChart
	data={data}
	showLegend={true}
...
`,(0,e.jsx)(i.kL,{language:"jsx",code:`import { GlobalChartsProvider, LineChart } from '@automattic/charts';
...
`,(0,e.jsx)(i.Hl,{of:d.SmartFormatting}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<LineChart
	data={data}
	options={{
		axis: {
...
`,(0,e.jsx)(i.Hl,{of:d.FixedDimensions}),`
...
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<LineChart data={data}>
	<LineChart.AnnotationsOverlay>
		<LineChart.Annotation
...
`,(0,e.jsx)(i.Hl,{of:d.DateStringFormats}),`
...
`,(0,e.jsx)(i.kL,{language:"tsx",code:`import { GlobalChartsProvider, LineChart, type ChartTheme } from '@automattic/charts';
...
`,(0,e.jsx)(i.kL,{language:"tsx",code:`<LineChart
	data={ data }
	width={ 800 }
	height={ 400 }
	animation={ true }
...
`]}),`
`,(0,e.jsxs)(n.p,{children:[(0,e.jsx)(n.strong,{children:"Note"}),": The animation plays once when the chart initially renders and does not repeat."]})]})}function b(p={}){const{wrapper:n}={...(0,y.R)(),...p.components};return n?(0,e.jsx)(n,{...p,children:(0,e.jsx)(s,{...p})}):s(p)}})}]);
