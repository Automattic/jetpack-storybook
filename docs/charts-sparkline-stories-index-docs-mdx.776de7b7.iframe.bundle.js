...
Use the controls panel to experiment with colors, gradients, dimensions, and data.`,...O.parameters?.docs?.description}}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  args: {
    data: [],
    width: 120,
    height: 48
  }
}`,...T.parameters?.docs?.source},description:{story:"Empty data renders an empty container gracefully.",...T.parameters?.docs?.description}}},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: {
    data: [42],
    color: '#9C27B0',
    width: 120,
...
}`,...A.parameters?.docs?.source},description:{story:"Single data point renders as a circle instead of a line.",...A.parameters?.docs?.description}}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  args: {
    data: [10, 20],
    color: '#3F51B5',
    width: 120,
...
}`,...E.parameters?.docs?.source},description:{story:"Two data points render as a minimal line segment.",...E.parameters?.docs?.description}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    width: '200px',
    resize: 'horizontal',
    overflow: 'auto',
...
}`,...j.parameters?.docs?.source},description:{story:`Responsive sparkline that adjusts to container width using aspectRatio.
Drag the corner of the container to resize and see the sparkline adapt.`,...j.parameters?.docs?.description}}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  render: () => {
    const metrics = [{
      label: 'Speeding up',
      value: 28,
...
}`,...v.parameters?.docs?.source},description:{story:"Dashboard example showing sparklines in metric cards - a common real-world use case.",...v.parameters?.docs?.description}}};try{O.displayName="Default",O.__docgenInfo={description:`Basic sparkline with all controls available for customization.
Use the controls panel to experiment with colors, gradients, dimensions, and data.`,displayName:"Default",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/charts/sparkline/stories/index.stories.tsx#Default"]={docgenInfo:O.__docgenInfo,name:"Default",path:"../charts/src/charts/sparkline/stories/index.stories.tsx#Default"})}catch{}try{T.displayName="EmptyData",T.__docgenInfo={description:"Empty data renders an empty container gracefully.",displayName:"EmptyData",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/charts/sparkline/stories/index.stories.tsx#EmptyData"]={docgenInfo:T.__docgenInfo,name:"EmptyData",path:"../charts/src/charts/sparkline/stories/index.stories.tsx#EmptyData"})}catch{}try{A.displayName="SinglePoint",A.__docgenInfo={description:"Single data point renders as a circle instead of a line.",displayName:"SinglePoint",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/charts/sparkline/stories/index.stories.tsx#SinglePoint"]={docgenInfo:A.__docgenInfo,name:"SinglePoint",path:"../charts/src/charts/sparkline/stories/index.stories.tsx#SinglePoint"})}catch{}try{E.displayName="TwoPoints",E.__docgenInfo={description:"Two data points render as a minimal line segment.",displayName:"TwoPoints",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/charts/sparkline/stories/index.stories.tsx#TwoPoints"]={docgenInfo:E.__docgenInfo,name:"TwoPoints",path:"../charts/src/charts/sparkline/stories/index.stories.tsx#TwoPoints"})}catch{}try{j.displayName="Responsive",j.__docgenInfo={description:`Responsive sparkline that adjusts to container width using aspectRatio.
Drag the corner of the container to resize and see the sparkline adapt.`,displayName:"Responsive",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/charts/sparkline/stories/index.stories.tsx#Responsive"]={docgenInfo:j.__docgenInfo,name:"Responsive",path:"../charts/src/charts/sparkline/stories/index.stories.tsx#Responsive"})}catch{}try{v.displayName="Dashboard",v.__docgenInfo={description:"Dashboard example showing sparklines in metric cards - a common real-world use case.",displayName:"Dashboard",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/charts/sparkline/stories/index.stories.tsx#Dashboard"]={docgenInfo:v.__docgenInfo,name:"Dashboard",path:"../charts/src/charts/sparkline/stories/index.stories.tsx#Dashboard"})}catch{}}),"../charts/src/stories/chart-decorator.tsx":((b,p,o)=>{"use strict";o.d(p,{OI:()=>c,cg:()=>r,xo:()=>k});var _=o("../number-formatters/src/index.ts"),e=o("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),f=o("../charts/src/providers/chart-context/global-charts-provider.tsx"),t=o("../charts/src/stories/theme-config.tsx"),i=o("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const c=(h,d)=>{const y=d.args;return r(()=>(0,i.jsx)("div",{style:{resize:y.resize||"both",overflow:"auto",padding:"1rem",width:y.containerWidth||"800px",height:y.containerHeight,maxWidth:"1200px",border:"1px dashed #ccc",display:"inline-block"},children:(0,i.jsx)(h,{})}),d)},n=h=>/^#[0-9A-Fa-f]{3}$|^#[0-9A-Fa-f]{6}$/.test(h),u=({children:h,themeName:d="default",accentColor:y=t.Zs})=>{(0,e.useEffect)(()=>{typeof window<"u"&&window.navigator?.language&&(0,_.xS)(window.navigator.language)},[]);const S=t.yI[d],R=n(y)?y:t.Zs,s=d==="custom"?`custom-${R}`:d;return(0,i.jsxs)(i.Fragment,{children:[d==="custom"&&(0,i.jsx)("style",{children:`
						:root {
							--wpds-color-bg-interactive-brand: ${R};
						}
					`}),(0,i.jsx)(f.S,{theme:S,children:h},s)]})},r=(h,{args:d})=>{const y=d,S=y.themeName,R=y.accentColor;return(0,i.jsx)(u,{themeName:S,accentColor:R,children:(0,i.jsx)(h,{})})},k={maxWidth:{control:{type:"number",min:100,max:1200},description:"Maximum width of the chart in pixels (responsive mode)",table:{category:"Dimensions"}},aspectRatio:{control:{type:"number",min:0,max:1},description:"Height as a ratio of width (0-1, responsive mode)",table:{category:"Dimensions"}},resizeDebounceTime:{control:{type:"number",min:0,max:1e4},description:"Debounce time in ms for resize events (performance)",table:{category:"Performance"}},containerWidth:{control:{type:"text"},description:'CSS width value for the chart container (e.g., "400px", "100%")'},containerHeight:{control:{type:"text"},description:'CSS height value for the chart container (e.g., "400px", "100%")'},resize:{control:{type:"select"},options:["none","both","horizontal","vertical"],description:"Resize behavior for the chart container"}};try{c.displayName="chartDecorator",c.__docgenInfo={description:`Shared decorator for chart stories with GlobalChartsProvider and dynamic theme support
