...
`,x={Default:{startLoc:{col:17,line:20},endLoc:{col:1,line:42},startBody:{col:17,line:20},endBody:{col:1,line:42}},BothAxes:{startLoc:{col:17,line:20},endLoc:{col:1,line:42},startBody:{col:17,line:20},endBody:{col:1,line:42}}};const u={parameters:{storySource:{source:`import { scaleBand, scaleLinear } from '@visx/scale';
import GridControl from '../grid-control';
