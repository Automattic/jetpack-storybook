"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[1499],{"../scan/src/components/threat-fixer-button/stories/index.stories.tsx":(y,h,u)=>{u.r(h),u.d(h,{Default:()=>n,DeleteCoreFile:()=>l,DeleteDirectory:()=>i,DeleteFile:()=>s,DeletePlugin:()=>a,DeleteTheme:()=>o,ErrorFixer:()=>f,Loading:()=>g,ReplaceCoreFile:()=>p,ReplaceFile:()=>x,ReplaceSaltKeys:()=>d,StaleFixer:()=>_,Update:()=>c,__namedExportsOrder:()=>S,default:()=>m});var r=u("../scan/src/components/threat-fixer-button/index.tsx"),t=u("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),F=`import ThreatFixerButton from '../index.tsx';
