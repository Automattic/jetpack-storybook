...
}`,...g.parameters?.docs?.source}}}},"../charts/src/components/pie-chart/pie-chart.tsx":(y,d,e)=>{e.d(d,{A:()=>ae});var i=e("../../../node_modules/.pnpm/@visx+group@3.12.0_react@18.3.1/node_modules/@visx/group/esm/Group.js"),a=e("../../../node_modules/.pnpm/@visx+shape@3.12.0_react@18.3.1/node_modules/@visx/shape/esm/shapes/Pie.js"),n=e("../../../node_modules/.pnpm/clsx@2.1.1/node_modules/clsx/dist/clsx.mjs"),s=e("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),t=e("../../../node_modules/.pnpm/@visx+event@3.12.0/node_modules/@visx/event/esm/localPoint.js"),u=e("../../../node_modules/.pnpm/@visx+tooltip@3.12.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@visx/tooltip/esm/hooks/useTooltip.js");const A=({withTooltips:o})=>{const{tooltipOpen:E,tooltipLeft:x,tooltipTop:v,tooltipData:S,hideTooltip:M,showTooltip:L}=(0,u.A)(),D=(0,s.useCallback)((P,T)=>{if(!o)return;const O=(0,t.A)(P);O&&L({tooltipData:T,tooltipLeft:O.x,tooltipTop:O.y-10})},[o,L]),W=(0,s.useCallback)(()=>{o&&M()},[o,M]);return{onMouseMove:D,onMouseLeave:W,tooltipOpen:E,tooltipData:S||null,tooltipLeft:x,tooltipTop:v}};var r=e("../charts/src/providers/chart-context/utils.ts"),l=e("../charts/src/providers/chart-context/global-charts-provider.tsx"),m=e("../charts/src/providers/theme/theme-provider.tsx"),h=e("../charts/src/providers/theme/themes.ts"),j=e("../charts/src/components/legend/legend.tsx"),_=e("../charts/src/components/legend/use-chart-legend-data.ts"),g=e("../charts/src/components/shared/use-element-height.ts"),z=e("../charts/src/components/shared/with-responsive.tsx"),q=e("../charts/src/components/tooltip/base-tooltip.tsx"),ee=e("../../../node_modules/.pnpm/style-loader@2.0.0_webpack@5.94.0/node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js"),te=e.n(ee),N=e("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.94.0/node_modules/css-loader/dist/cjs.js!../../../node_modules/.pnpm/postcss-loader@8.1.1_postcss@8.4.47_typescript@5.8.3_webpack@5.94.0/node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[14].use[2]!../../../node_modules/.pnpm/sass-loader@16.0.5_sass-embedded@1.87.0_webpack@5.94.0/node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[3]!../charts/src/components/pie-chart/pie-chart.module.scss"),B={};B.insert="head",B.singleton=!1;var De=te()(N.A,B);const C=N.A.locals||{};var c=e("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const se=o=>{if(!o.length)return{isValid:!1,message:"No data available"};if(o.some(v=>v.percentage<0||v.value<0))return{isValid:!1,message:"Invalid data: Negative values are not allowed"};const x=o.reduce((v,S)=>v+S.percentage,0);return Math.abs(x-100)>.01?{isValid:!1,message:"Invalid percentage total: Must equal 100"}:{isValid:!0,message:""}},U=({data:o,chartId:E,withTooltips:x=!1,className:v,showLegend:S=!1,legendOrientation:M="horizontal",legendAlignmentHorizontal:L="center",legendAlignmentVertical:D="bottom",legendShape:W="circle",size:P,thickness:T=1,padding:O=20,gapScale:K=0,cornerScale:R=0,children:ne=null})=>{const V=(0,m.RW)(),Y=(0,r.R)(E),[oe,re]=(0,g.v)(),{onMouseMove:le,onMouseLeave:ie,tooltipOpen:de,tooltipData:G,tooltipLeft:ce,tooltipTop:pe}=A({withTooltips:x}),ue=(0,s.useMemo)(()=>({showValues:!0}),[]),F=(0,_.B)(o,V,ue),{isValid:Q,message:me}=se(o),he=(0,s.useMemo)(()=>({thickness:T,gapScale:K,cornerScale:R}),[T,K,R]);if((0,r.t)(Y,F,V,"pie",Q,he),!Q)return(0,c.jsx)("div",{className:(0,n.A)("pie-chart",C["pie-chart"],v),children:(0,c.jsx)("div",{className:C["error-message"],children:me})});const X=P,$=P,I=S&&D==="top"?$-re:$,_e=Math.min(X,I)/2,ge=X/2,ve=I/2,fe=K*(2*Math.PI/o.length),w=_e-O,J=T===0?0:w*(1-T),ye=(w-J)/2,xe=R?Math.min(R*w,ye):0,Se=o.map((p,f)=>({...p,index:f})),Z={value:p=>p.value,fill:p=>p?.color||V.colors[p.index]};return(0,c.jsxs)("div",{className:(0,n.A)("pie-chart",C["pie-chart"],v),style:{display:"flex",flexDirection:S&&D==="top"?"column-reverse":"column"},children:[(0,c.jsx)("svg",{viewBox:`0 0 ${P} ${I}`,preserveAspectRatio:"xMidYMid meet",width:P,height:I,children:(0,c.jsxs)(i.A,{top:ve,left:ge,children:[(0,c.jsx)(a.A,{data:Se,pieValue:Z.value,outerRadius:w,innerRadius:J,padAngle:fe,cornerRadius:xe,children:p=>p.arcs.map((f,be)=>{const[je,Pe]=p.path.centroid(f),Te=f.endAngle-f.startAngle>=.25,Ae=Ee=>le(Ee,f.data),k={d:p.path(f)||"",fill:Z.fill(f.data)};return x&&(k.onMouseMove=Ae,k.onMouseLeave=ie),(0,c.jsxs)("g",{children:[(0,c.jsx)("path",{...k}),Te&&(0,c.jsx)("text",{x:je,y:Pe,dy:".33em",fill:V.labelBackgroundColor||h.zQ.labelBackgroundColor,fontSize:12,textAnchor:"middle",pointerEvents:"none",children:f.data.label})]},`arc-${be}`)})}),ne]})}),S&&(0,c.jsx)(j.s,{items:F,orientation:M,alignmentHorizontal:L,alignmentVertical:D,className:C["pie-chart-legend"],shape:W,ref:oe,chartId:Y}),x&&de&&G&&(0,c.jsx)(q.R,{data:G,top:pe||0,left:ce||0,style:{transform:"translate(-50%, -100%)"}})]})},H=o=>(0,s.useContext)(l.mJ)?(0,c.jsx)(U,{...o}):(0,c.jsx)(l.Sx,{children:(0,c.jsx)(U,{...o})});H.displayName="PieChart";const ae=(0,z.F)(H);try{piechart.displayName="piechart",piechart.__docgenInfo={description:"",displayName:"piechart",props:{size:{defaultValue:null,description:"Size of the chart in pixels for pie and donut charts",name:"size",required:!1,type:{name:"number"}},height:{defaultValue:null,description:"Height of the chart in pixels",name:"height",required:!1,type:{name:"number"}},width:{defaultValue:null,description:"Width of the chart in pixels",name:"width",required:!1,type:{name:"number"}},className:{defaultValue:null,description:"Additional CSS class name for the chart container",name:"className",required:!1,type:{name:"string"}},children:{defaultValue:{value:"null"},description:"Use the children prop to render additional elements on the chart.",name:"children",required:!1,type:{name:"ReactNode"}},data:{defaultValue:null,description:"Array of data points to display in the chart",name:"data",required:!0,type:{name:"DataPointPercentage[]"}},options:{defaultValue:null,description:"More options for the chart.",name:"options",required:!1,type:{name:"{ yScale?: ScaleOptions; xScale?: ScaleOptions; axis?: { x?: AxisOptions; y?: AxisOptions; }; }"}},onPointerDown:{defaultValue:null,description:"Callback function for pointer down event",name:"onPointerDown",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerMove:{defaultValue:null,description:"Callback function for pointer move event",name:"onPointerMove",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerUp:{defaultValue:null,description:"Callback function for pointer up event",name:"onPointerUp",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerOut:{defaultValue:null,description:"Callback function for pointer out event",name:"onPointerOut",required:!1,type:{name:"(event: PointerEvent<Element>) => void"}},thickness:{defaultValue:{value:"1"},description:`Thickness of the pie chart.
