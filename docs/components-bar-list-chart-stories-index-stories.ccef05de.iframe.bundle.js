...
`,Z={Default:{startLoc:{col:23,line:29},endLoc:{col:1,line:34},startBody:{col:23,line:29},endBody:{col:1,line:34}},MultiSeries:{startLoc:{col:27,line:35},endLoc:{col:1,line:40},startBody:{col:27,line:35},endBody:{col:1,line:40}},CustomLabelComponent:{startLoc:{col:36,line:41},endLoc:{col:1,line:77},startBody:{col:36,line:41},endBody:{col:1,line:77}},CustomValueComponent:{startLoc:{col:36,line:78},endLoc:{col:1,line:126},startBody:{col:36,line:78},endBody:{col:1,line:126}}};const se={title:"JS Packages/Charts/Types/Bar List Chart",component:R,parameters:{storySource:{source:`import { formatNumberCompact } from '@automattic/number-formatters';
import { Circle } from '@visx/shape';
import { Text } from '@visx/text';
import React from 'react';
import BarListChart from '../bar-list-chart';
...
};`,locationsMap:{default:{startLoc:{col:23,line:29},endLoc:{col:1,line:34},startBody:{col:23,line:29},endBody:{col:1,line:34}},"multi-series":{startLoc:{col:27,line:35},endLoc:{col:1,line:40},startBody:{col:27,line:35},endBody:{col:1,line:40}},"custom-label-component":{startLoc:{col:36,line:41},endLoc:{col:1,line:77},startBody:{col:36,line:41},endBody:{col:1,line:77}},"custom-value-component":{startLoc:{col:36,line:78},endLoc:{col:1,line:126},startBody:{col:36,line:78},endBody:{col:1,line:126}}}},layout:"centered"},decorators:[n=>(0,c.jsx)("div",{style:{resize:"both",overflow:"auto",padding:"2rem",width:"800px",maxWidth:"1200px",border:"1px dashed #ccc",display:"inline-block"},children:(0,c.jsx)(n,{})})]},m={args:{withTooltips:!0,data:V}},H={args:{...m.args,data:ne}},W={args:{...m.args,data:V,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{labelComponent:({textProps:n,x:s,y:l,label:o,formatter:f})=>(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(i,{cx:s+6,cy:l,r:8}),(0,c.jsx)(r.A,{...n,textAnchor:"start",x:s+24,y:l,fontWeight:500,children:f(o)})]})}}},q={args:{...m.args,data:ne,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{valueComponent:({textProps:n,x:s,y:l,value:o,formatter:f,data:S,index:h})=>{const P=S[0].data[h].value,O=S[1].data[h].value,T=O===0?0:((P-O)/O*100).toFixed(0);return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(r.A,{...n,textAnchor:"end",x:s,y:l,dx:-50,fontWeight:500,children:f(o)}),(0,c.jsx)(r.A,{...n,textAnchor:"end",x:s,y:l,dx:-10,fill:"#008A20",fontWeight:500,children:`${Number(T)>0?"+":""}${T}%`})]})},valueFormatter:n=>`$${(0,C.qe)(n)}`}}},le=["Default","MultiSeries","CustomLabelComponent","CustomValueComponent"];m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    withTooltips: true,
    data: salesByProduct
  }
