...
`]})]})}function h(c={}){const{wrapper:s}={...(0,d.R)(),...c.components};return s?(0,e.jsx)(s,{...c,children:(0,e.jsx)(a,{...c})}):a(c)}},"../charts/src/charts/geo-chart/stories/index.stories.tsx"(_,l,t){t.r(l),t.d(l,{AspectRatio:()=>h,Default:()=>o,EmptyData:()=>s,EuropeanCountries:()=>p,FixedDimensions:()=>a,SingleCountry:()=>c,USStates:()=>u,__namedExportsOrder:()=>m,default:()=>n});var i=t("../charts/src/stories/sample-data/index.ts"),e=t("../charts/src/charts/geo-chart/geo-chart.tsx"),d=t("../charts/src/charts/geo-chart/stories/config.tsx");const n={...d.s,title:"JS Packages/Charts Library/Charts/Geo Chart",component:e.A},o={args:{...d._}},a={args:{...o.args,width:600,height:300}},h={args:{...o.args,aspectRatio:.5}},c={args:{...o.args,data:[["Country","Views"],["United States",1500]]}},s={args:{...o.args,data:[["Country","Views"]]}},u={args:{...o.args,region:"US",resolution:"provinces",data:i.fP}},p={args:{...o.args,region:"150",resolution:"countries",data:i.F_}},m=["Default","FixedDimensions","AspectRatio","SingleCountry","EmptyData","USStates","EuropeanCountries"];o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    ...geoChartStoryArgs
  }
