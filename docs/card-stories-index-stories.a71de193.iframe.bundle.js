...
`,k={Default:{startLoc:{col:17,line:20},endLoc:{col:2,line:29},startBody:{col:17,line:20},endBody:{col:2,line:29}}};const S={parameters:{storySource:{source:`import React from 'react';
import { HashRouter, Routes, Route } from 'react-router-dom';
import Card from '..';
