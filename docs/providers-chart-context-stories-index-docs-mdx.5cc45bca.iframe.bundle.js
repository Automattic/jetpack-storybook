(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[1069],{"../../../node_modules/.pnpm/@storybook+addon-docs@10.1.10_@types+react@18.3.26_esbuild@0.25.9_storybook@10.1.10_@te_0dab3ad5060a2aa8d937367f454f05ee/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive":(l=>{function r(s){var a=new Error("Cannot find module '"+s+"'");throw a.code="MODULE_NOT_FOUND",a}r.keys=()=>[],r.resolve=r,r.id="../../../node_modules/.pnpm/@storybook+addon-docs@10.1.10_@types+react@18.3.26_esbuild@0.25.9_storybook@10.1.10_@te_0dab3ad5060a2aa8d937367f454f05ee/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive",l.exports=r}),"../charts/src/providers/chart-context/stories/index.docs.mdx":((l,r,s)=>{"use strict";s.r(r),s.d(r,{default:()=>h});var a=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),d=s("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.26_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),n=s("../../../node_modules/.pnpm/@storybook+addon-docs@10.1.10_@types+react@18.3.26_esbuild@0.25.9_storybook@10.1.10_@te_0dab3ad5060a2aa8d937367f454f05ee/node_modules/@storybook/addon-docs/dist/blocks.js"),o=s("../charts/src/providers/chart-context/stories/index.stories.tsx");function c(i){const t={code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...(0,d.R)(),...i.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(n.W8,{title:"JS Packages/Charts Library/Chart Context",of:o}),`
...
`,(0,e.jsx)(n.kL,{language:"tsx",code:`import { GlobalChartsProvider, LineChart, BarChart } from '@automattic/charts';
...
`,(0,e.jsx)(n.kL,{language:"tsx",code:`// Data with group assignments
const data = [
	{
...
`,(0,e.jsx)(n.Hl,{of:o.WithColorOverrides}),`
`,(0,e.jsx)(n.kL,{language:"tsx",code:`// Some elements have color overrides, others use global coordination
...
`,(0,e.jsx)(n.kL,{language:"tsx",code:`const customTheme: ChartTheme = {
...
`,(0,e.jsx)(n.kL,{language:"tsx",code:`// Only customize colors - everything else uses defaults
const brandColors = {
...
`]}),`
`,(0,e.jsx)(n.kL,{language:"tsx",code:`// Charts automatically register with a unique ID
<LineChart
	data={ data }
...
`,(0,e.jsx)(n.kL,{language:"tsx",code:`import { useGlobalChartsContext } from '@automattic/charts';
...
`,(0,e.jsx)(n.kL,{language:"tsx",code:`import { useGlobalChartsTheme } from '@automattic/charts';
...
`,(0,e.jsx)(n.kL,{language:"tsx",code:`import { useChartRegistration } from '@automattic/charts';
...
`,(0,e.jsx)(n.kL,{language:"tsx",code:`function CustomChartElement( { seriesData, index, isHighlighted } ) {
...
`,(0,e.jsx)(n.kL,{language:"tsx",code:`function DashboardWithCentralizedLegends() {
	return (
		<GlobalChartsProvider>
...
`,(0,e.jsx)(n.kL,{language:"tsx",code:`// Theme with 3 colors
const limitedTheme = {
...
`,(0,e.jsx)(n.kL,{language:"tsx",code:`// This will throw a helpful error
...
}`})]})}function h(i={}){const{wrapper:t}={...(0,d.R)(),...i.components};return t?(0,e.jsx)(t,{...i,children:(0,e.jsx)(c,{...i})}):c(i)}})}]);
