...
`,T={Default:{startLoc:{col:17,line:55},endLoc:{col:2,line:57},startBody:{col:17,line:55},endBody:{col:2,line:57}},BreakpointMatch:{startLoc:{col:31,line:97},endLoc:{col:1,line:183},startBody:{col:31,line:97},endBody:{col:1,line:183}}};const c=({items:v,fluid:C,horizontalGap:j,horizontalSpacing:E})=>(0,s.jsxs)(p.A,{className:i.container,horizontalSpacing:E,fluid:C,horizontalGap:j,children:[v.map(({sm:f,lg:x,md:I},L)=>{const A=Number.isInteger(f?.start)?JSON.stringify(f):f,N=Number.isInteger(I?.start)?JSON.stringify(I):I,O=Number.isInteger(x?.start)?JSON.stringify(x):x;return(0,s.jsxs)(l.A,{sm:f,md:I,lg:x,className:i.col,children:[f?`sm=${A} `:"",I?`md=${N} `:"",x?`lg=${O} `:""]},`${A}${N}${O}${L}`)}),(0,s.jsx)(l.A,{children:(0,s.jsxs)(p.A,{fluid:!0,horizontalSpacing:0,horizontalGap:1,children:[(0,s.jsx)(l.A,{className:i.col,children:"Composition Example"}),(0,s.jsx)(l.A,{className:i.col,children:"Composition Example"})]})})]}),S={parameters:{storySource:{source:`/* wp:polyfill */
