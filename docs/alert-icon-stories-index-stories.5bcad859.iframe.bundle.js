...
`,y={Default:{startLoc:{col:23,line:15},endLoc:{col:54,line:15},startBody:{col:23,line:15},endBody:{col:54,line:15}}};const E={parameters:{storySource:{source:`
import React from 'react';
import AlertIcon from '../index.jsx';
export default {
  title: 'Plugins/Protect/Alert Icon',
