...
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"height"})}),": Height of the chart container. Accepts a number (pixels) or CSS string. Falls back to ",(0,e.jsx)(n.code,{children:"style.height"})," if set, otherwise defaults to ",(0,e.jsx)(n.code,{children:'"100%"'})]}),`
...
`,(0,e.jsx)(n.h3,{id:"custom-container-styling",children:"Custom Container Styling"}),`
`,(0,e.jsxs)(n.p,{children:["Use the ",(0,e.jsx)(n.code,{children:"style"})," prop or ",(0,e.jsx)(n.code,{children:"className"})," prop to customize the chart container:"]}),`
`,(0,e.jsx)(s.kL,{language:"tsx",code:`<ConversionFunnelChart
	mainRate={10.3}
	steps={funnelData}
...
/>`}),`
`,(0,e.jsx)(n.h3,{id:"css-custom-properties",children:"CSS Custom Properties"}),`
`,(0,e.jsx)(n.p,{children:"The component exposes CSS custom properties for font customization:"}),`
`,(0,e.jsx)(s.kL,{language:"css",code:`.my-custom-funnel {
...
`,(0,e.jsxs)(n.p,{children:["By default, the chart fills its parent container's height (",(0,e.jsx)(n.code,{children:'height="100%"'}),"), consistent with other chart components in the library. The parent container must have an explicit height for this to take effect. To use a fixed height, pass the ",(0,e.jsx)(n.code,{children:"height"})," prop:"]}),`
`,(0,e.jsx)(s.Hl,{of:i.FixedDimensions}),`
`,(0,e.jsx)(s.kL,{language:"tsx",code:`{/* Fixed height */}
<ConversionFunnelChart
	mainRate={10.3}
	changeIndicator="+2%"
	steps={funnelData}
...
`]})]})}function l(r={}){const{wrapper:n}={...(0,o.R)(),...r.components};return n?(0,e.jsx)(n,{...r,children:(0,e.jsx)(c,{...r})}):c(r)}}}]);
