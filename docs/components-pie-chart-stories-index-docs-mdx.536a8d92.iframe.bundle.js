...
`})})]})}function p(a={}){const{wrapper:n}={...(0,h.R)(),...a.components};return n?(0,e.jsx)(n,{...a,children:(0,e.jsx)(o,{...a})}):o(a)}},"../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive":l=>{function t(s){var d=new Error("Cannot find module '"+s+"'");throw d.code="MODULE_NOT_FOUND",d}t.keys=()=>[],t.resolve=t,t.id="../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive",l.exports=t},"../charts/src/components/pie-chart/stories/pie-legend.stories.tsx":(l,t,s)=>{"use strict";s.r(t),s.d(t,{AlignmentPositioning:()=>x,Default:()=>n,VerticalOrientation:()=>j,__namedExportsOrder:()=>g,default:()=>o});var d=s("../charts/src/stories/decorator-config.tsx"),e=s("../charts/src/stories/legend-config.tsx"),h=s("../charts/src/components/pie-chart/pie-chart.tsx"),r=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const c=[{label:"Desktop",value:45e3,valueDisplay:"45K",percentage:45},{label:"Mobile",value:35e3,valueDisplay:"35K",percentage:35},{label:"Tablet",value:2e4,valueDisplay:"20K",percentage:20}],o={title:"JS Packages/Charts/Types/Pie Chart/Legend",component:h.A,parameters:{layout:"centered"},decorators:d.p,argTypes:e.r},p=m=>(0,r.jsx)(h.A,{...m}),a={data:c,resize:"none",containerWidth:"432px",containerHeight:"480px",thickness:0,innerRadius:0,gapScale:.03,padding:20,cornerScale:.03,withTooltips:!0,showLegend:!0,legendOrientation:"horizontal"},n=p.bind({});n.args={...a};const x=p.bind({});x.args={...a,legendAlignmentHorizontal:"right",legendAlignmentVertical:"top"};const j=p.bind({});j.args={...a,legendOrientation:"vertical",legendAlignmentHorizontal:"right",legendAlignmentVertical:"top",containerHeight:"524px"};const g=["Default","AlignmentPositioning","VerticalOrientation"];n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"args => <PieChart {...args} />",...n.parameters?.docs?.source}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:"args => <PieChart {...args} />",...x.parameters?.docs?.source}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:"args => <PieChart {...args} />",...j.parameters?.docs?.source}}}},"../charts/src/stories/legend-config.tsx":(l,t,s)=>{"use strict";s.d(t,{r:()=>e});var d=s("../charts/src/providers/theme/themes.ts");const e={showLegend:{control:"boolean",table:{category:"Legend"}},legendAlignmentHorizontal:{control:"select",options:["left","center","right"],table:{category:"Legend"}},legendAlignmentVertical:{control:"select",options:["top","bottom"],table:{category:"Legend"}},legendOrientation:{control:"select",options:["horizontal","vertical"],table:{category:"Legend"}},legendShape:{control:"select",options:["circle","rect"],table:{category:"Legend"}},withLegendGlyph:{control:"boolean",table:{category:"Legend"},description:"Show glyphs in legend (Line charts only)"},theme:{control:"select",options:{default:void 0,jetpack:d.QI,woo:d.pk},defaultValue:void 0,table:{category:"Theme"}}};try{e.displayName="legendArgTypes",e.__docgenInfo={description:`Shared legend configuration for chart stories
