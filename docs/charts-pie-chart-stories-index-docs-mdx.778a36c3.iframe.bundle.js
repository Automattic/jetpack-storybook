"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[365],{"../charts/src/charts/pie-chart/stories/index.docs.mdx"(c,r,i){i.r(r),i.d(r,{default:()=>d});var h=i("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=i("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),o=i("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.28_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),s=i("../../../node_modules/.pnpm/@storybook+addon-docs@10.2.11_@types+react@18.3.28_esbuild@0.25.9_storybook@10.2.11_@te_623b11407ff81c3407704a8a948465b9/node_modules/@storybook/addon-docs/dist/blocks.js"),t=i("../charts/src/charts/pie-chart/stories/index.stories.tsx");function l(a){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...(0,o.R)(),...a.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(s.W8,{title:"JS Packages/Charts Library/Charts/Pie Chart",of:t}),`
...
`,(0,e.jsxs)(n.ul,{children:[`
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"size"})}),": Maximum diameter of the pie in pixels. The pie shrinks if the container is smaller. When omitted, the pie fills available space."]}),`
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"width"})})," / ",(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"height"})}),": Explicit container dimensions in pixels. When omitted, the chart fills its parent."]}),`
...
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"gap"})})," (default: ",(0,e.jsx)(n.code,{children:"'md'"}),"): Gap between chart elements (SVG, legend, children). Uses WordPress design system tokens."]}),`
...
`,(0,e.jsx)(s.Hl,{of:t.CompositionAPI}),`
...
`,(0,e.jsx)(s.Hl,{of:t.WithTooltips}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<PieChart
	size={ 400 }
	data={ data }
	withTooltips={ true }
...
`,(0,e.jsxs)(n.p,{children:["Use the composition API to add a legend by placing ",(0,e.jsx)(n.code,{children:"<PieChart.Legend />"})," as a child:"]}),`
`,(0,e.jsx)(s.Hl,{of:t.WithCompositionLegend}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<PieChart size={ 400 } data={ data }>
	<PieChart.Legend />
</PieChart>`}),`
...
`,(0,e.jsx)(s.Hl,{of:t.CustomLabelColors}),`
...
`,(0,e.jsxs)(n.p,{children:["Use the ",(0,e.jsx)(n.code,{children:"size"})," prop to constrain the maximum pie diameter. The pie will shrink if the container is smaller, but won't grow beyond this value:"]}),`
`,(0,e.jsx)(s.Hl,{of:t.WithSize}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`// Constrained pie diameter (container still fills parent)
...
`,(0,e.jsx)(n.p,{children:"The Pie Chart component supports an optional entry animation that creates a smooth reveal effect when the chart first renders:"}),`
...
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:"Effect"}),": Creates a radial wipe reveal effect that sweeps clockwise from the top, progressively revealing the chart segments"]}),`
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:"Duration"}),": 1000ms (1 second)"]}),`
`]}),`
`,(0,e.jsxs)(n.p,{children:[(0,e.jsx)(n.strong,{children:"Note"}),": The animation plays once when the chart initially renders and does not repeat."]})]})}function d(a={}){const{wrapper:n}={...(0,o.R)(),...a.components};return n?(0,e.jsx)(n,{...a,children:(0,e.jsx)(l,{...a})}):l(a)}}}]);
