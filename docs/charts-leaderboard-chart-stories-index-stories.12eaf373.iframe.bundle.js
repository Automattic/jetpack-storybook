...
}`,...P.parameters?.docs?.source}}}},"../charts/src/charts/leaderboard-chart/leaderboard-chart.tsx"(G,g,e){e.d(g,{A:()=>Z});var s=e("../../../node_modules/.pnpm/@wordpress+components@32.1.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/text/component.mjs"),u=e("../../../node_modules/.pnpm/@wordpress+components@32.1.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/grid/component.mjs"),f=e("../../../node_modules/.pnpm/@wordpress+components@32.1.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/v-stack/component.mjs"),c=e("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),a=e("../../../node_modules/.pnpm/@wordpress+i18n@6.12.0/node_modules/@wordpress/i18n/build-module/index.mjs"),m=e("../../../node_modules/.pnpm/clsx@2.1.1/node_modules/clsx/dist/clsx.mjs"),l=e("../charts/src/components/legend/legend.tsx"),p=e("../charts/src/hooks/use-prefers-reduced-motion.ts"),d=e("../charts/src/providers/chart-context/hooks/use-chart-id.ts"),i=e("../charts/src/providers/chart-context/hooks/use-global-charts-theme.ts"),L=e("../charts/src/providers/chart-context/hooks/use-global-charts-context.ts"),O=e("../charts/src/providers/chart-context/hooks/use-chart-registration.ts"),v=e("../charts/src/providers/chart-context/global-charts-provider.tsx"),S=e("../charts/src/utils/format-metric-value.ts"),E=e("../charts/src/utils/create-composition.ts"),j=e("../charts/src/charts/private/chart-composition/use-chart-children.ts"),w=e("../charts/src/charts/private/single-chart-context/single-chart-context.tsx"),W=e("../charts/src/charts/private/with-responsive/with-responsive.tsx");const A=a.__;function M({data:t,primaryColor:_,secondaryColor:h,withComparison:y=!1,withOverlayLabel:B=!1,legendLabels:x}){const{leaderboardChart:H}=(0,i.p)(),{getElementStyles:K}=(0,L.j)();return(0,c.useMemo)(()=>{if(!t||t.length===0)return[];const X=[],{color:J}=K({index:0,overrideColor:_||H.primaryColor});if(X.push({label:x?.primary||A("Current period","jetpack-charts"),value:"",color:J}),y&&!B){const{color:Y}=K({index:1,overrideColor:h||H.secondaryColor});X.push({label:x?.comparison||A("Previous period","jetpack-charts"),value:"",color:Y})}return X},[t,_,h,y,x,H,K,B])}var T=e("../../../node_modules/.pnpm/style-loader@2.0.0_webpack@5.105.2/node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js"),D=e.n(T),V=e("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.105.2/node_modules/css-loader/dist/cjs.js!../../../node_modules/.pnpm/postcss-loader@8.2.0_postcss@8.5.6_typescript@5.9.3_webpack@5.105.2/node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[14].use[2]!../../../node_modules/.pnpm/sass-loader@16.0.5_sass-embedded@1.97.2_webpack@5.105.2/node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[3]!../charts/src/charts/leaderboard-chart/leaderboard-chart.module.scss"),C={};C.insert="head",C.singleton=!1;var re=D()(V.A,C);const n=V.A.locals||{};var o=e("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const U=a.__,I=t=>(0,S.d)(t,"number",{useMultipliers:!0,decimals:1}),F=t=>(0,S.d)(t/100,"average",{decimals:0,signDisplay:"exceptZero"}),R=({label:t})=>(0,o.jsx)(o.Fragment,{children:typeof t=="string"?(0,o.jsx)(s.A,{className:n.label,children:t}):t}),N=({entry:t,withComparison:_,withOverlayLabel:h,primaryColor:y,secondaryColor:B,animation:x,isPrimaryVisible:H=!0,isComparisonVisible:K=!0})=>(0,o.jsxs)("div",{className:(0,m.A)(n.barWithLabelContainer,{[n["is-overlay"]]:h}),children:[(0,o.jsx)(R,{label:t.label}),H&&(0,o.jsx)("div",{className:(0,m.A)(n.bar,{[n["bar--animated"]]:x}),style:{width:t.currentShare+"%",backgroundColor:y}}),_&&!h&&K&&(0,o.jsx)("div",{className:(0,m.A)(n.bar,{[n["bar--animated"]]:x}),style:{width:t.previousShare+"%",backgroundColor:B}})]}),P=({data:t,chartId:_,withComparison:h=!1,withOverlayLabel:y=!1,primaryColor:B,secondaryColor:x,valueFormatter:H=I,deltaFormatter:K=F,animation:X,loading:J=!1,showLegend:Y=!1,legendOrientation:ie="horizontal",legendPosition:te="bottom",legendAlignment:de="center",legendShape:ce="circle",legendShapeWidth:me=8,legendShapeHeight:ue=8,legendLabels:pe,legendInteractive:q=!1,className:oe,style:ne,children:he})=>{const b=(0,d.R)(_),{leaderboardChart:ge}=(0,i.p)(),{otherChildren:se}=(0,j.n)(he,"LeaderboardChart"),{labelSpacing:fe,rowGap:ye,columnGap:be,primaryColor:ve,secondaryColor:Ce,deltaColors:_e}=ge,{getElementStyles:le,isSeriesVisible:ee}=(0,L.j)(),{color:xe}=le({index:0,overrideColor:B||ve}),{color:Le}=le({index:1,overrideColor:x||Ce}),z=M({data:t||[],primaryColor:B,secondaryColor:x,withComparison:h,withOverlayLabel:y,legendLabels:pe}),Q=(0,c.useMemo)(()=>!b||!q||z.length===0?!0:ee(b,z[0].label),[b,q,z,ee]),ae=(0,c.useMemo)(()=>!b||!q||z.length<2?!0:ee(b,z[1].label),[b,q,z,ee]),Se=(0,c.useMemo)(()=>q?h&&!y?!Q&&!ae:!Q:!1,[q,Q,ae,h,y]),Ee=!!(t&&t.length>0),we=(0,c.useMemo)(()=>({withComparison:h,withOverlayLabel:y}),[h,y]);(0,O.t)({chartId:b,legendItems:z,chartType:"leaderboard",isDataValid:Ee,metadata:we});const Ae=(0,p.j)();return!t||t.length===0?(0,o.jsx)(w.O.Provider,{value:{chartId:b,chartWidth:0,chartHeight:0},children:(0,o.jsxs)("div",{className:(0,m.A)(n.leaderboardChart,{[n["leaderboardChart--loading"]]:J},oe),style:ne,children:[(0,o.jsx)("div",{className:n.emptyState,children:U(J?"Loading\u2026":"No data available","jetpack-charts")}),se]})}):(0,o.jsx)(w.O.Provider,{value:{chartId:b,chartWidth:0,chartHeight:0},children:(0,o.jsxs)("div",{className:(0,m.A)(n.leaderboardChart,{[n["leaderboardChart--loading"]]:J,[n["leaderboardChart--with-legend"]]:Y,[n["leaderboardChart--legend-top"]]:Y&&te==="top"},oe),style:ne,children:[Se?(0,o.jsx)("div",{className:n.emptyState,children:U("All series are hidden. Click legend items to show data.","jetpack-charts")}):(0,o.jsx)(u.A,{templateColumns:"minmax(0, 1fr) auto",rowGap:ye,columnGap:be,children:t.map($=>{const Ve=Math.sign($.delta)+1,Pe=_e[Ve];return(0,o.jsxs)(c.Fragment,{children:[(0,o.jsx)(f.A,{spacing:fe,children:(0,o.jsx)(N,{entry:$,withComparison:h,withOverlayLabel:y,primaryColor:xe,secondaryColor:Le,isPrimaryVisible:Q,isComparisonVisible:ae,animation:X&&!J&&!Ae})}),(0,o.jsxs)("div",{className:(0,m.A)(n.valueContainer,{[n.overlayLabel]:y}),children:[Q&&(0,o.jsx)(s.A,{children:H($.currentValue)}),h&&ae&&(0,o.jsx)(s.A,{style:{color:Pe},children:K($.delta)})]})]},$.id)})}),Y&&(0,o.jsx)(l.s,{orientation:ie,position:te,alignment:de,shape:ce,shapeWidth:me,shapeHeight:ue,chartId:b,interactive:q}),se]})})},k=t=>(0,c.useContext)(v.m)?(0,o.jsx)(P,{...t}):(0,o.jsx)(v.S,{children:(0,o.jsx)(P,{...t})});k.displayName="LeaderboardChart";const r=(0,E.E)(k,{Legend:l.s}),Z=(0,E.E)((0,W.F)(k),{Legend:l.s});try{leaderboardchart.displayName="leaderboardchart",leaderboardchart.__docgenInfo={description:"",displayName:"leaderboardchart",props:{className:{defaultValue:null,description:"Additional CSS class name for the chart container",name:"className",required:!1,type:{name:"string"}},loading:{defaultValue:{value:"false"},description:"Whether the chart is in loading state",name:"loading",required:!1,type:{name:"boolean"}},style:{defaultValue:null,description:"Custom styling for the chart container",name:"style",required:!1,type:{name:"CSSProperties & { '--a8c--charts--leaderboard--bar--border-radius'?: string; }"}},children:{defaultValue:null,description:"Child components for composition API",name:"children",required:!1,type:{name:"ReactNode"}},data:{defaultValue:null,description:"Array of data points to display in the chart",name:"data",required:!0,type:{name:"LeaderboardEntry[]"}},chartId:{defaultValue:null,description:"Optional unique identifier for the chart (auto-generated if not provided)",name:"chartId",required:!1,type:{name:"string"}},legendInteractive:{defaultValue:{value:"false"},description:`Enable interactive legend items that can toggle series visibility.
