import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Uu as ee,ju as i,t as a,vc as o,wc as te}from"./build-module-2iv4IIRq.js";import{Et as s}from"./build-module-l8c-_EUg2.js";import{m as c,sn as ne,wt as re}from"./hooks-BX-hK1je.js";import{t as l}from"./src-D3rb7jHr.js";import{K as ie,r as u,tn as d}from"./date-period-dropdown-wHQzrlbV.js";import"./constants-C7AKabD4.js";import{r as ae,t as oe}from"./leaderboard-skeleton-CSHyVlxz.js";import{i as se,r as f,t as p}from"./register-report-mocks-COgpo4YT.js";import{b as m,g as ce,v as le}from"./report-metric-BEiuaALL.js";import{t as h}from"./widget-state-D6-tq-Yj.js";import{t as g}from"./src-DgVkoS0S.js";import{a as _,c as v,d as y,i as b,l as x,n as S,o as C,r as w,s as ue,u as de}from"./with-widget-canvas-BFSPq0gd.js";var T,E,D,O=e((()=>{T=`_root_19tfr_1`,E=`_content_19tfr_9`,D={root:T,content:E}}));function k(){let{rows:e,isLoading:n,isFetching:r,isError:i,error:a,refetch:o}=ie({group:`posts`,max:10}),c=(0,ee.useMemo)(()=>{let t=Math.max(...e.map(e=>e.value),0);return e.map(e=>({id:e.id,label:(0,j.jsx)(ce,{id:e.postId,label:e.label,link:e.link,origin:{report:`comments`,section:`posts`}}),currentValue:e.value,currentShare:ne(e.value,t)}))},[e]);return(0,j.jsxs)(s,{className:D.root,children:[(0,j.jsx)(`div`,{className:D.content,children:(0,j.jsx)(h,{isLoading:n,isFetching:r,isError:i,isEmpty:e.length===0,error:re(a,{retryDescription:t(`We couldn't load commented posts. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:o}),empty:{icon:te,description:t(`None of your posts or pages have comments yet.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,j.jsx)(oe,{rows:10}),children:(0,j.jsx)(ae,{data:c,withOverlayLabel:!0,showLegend:!1,dataFormat:M})})}),(0,j.jsx)(m,{children:(0,j.jsx)(le,{report:`comments`,section:`posts`,ariaLabel:t(`See the commented posts report`,`jetpack-premium-analytics-pkg`)})})]})}function A({attributes:e={}}){return(0,j.jsx)(c,{attributes:e,children:(0,j.jsx)(k,{})})}var j,M,N=e((()=>{u(),g(),i(),n(),a(),l(),O(),j=r(),M={type:`number`,options:{useMultipliers:!0,decimals:0}}})),P,F=e((()=>{a(),P={icon:o,attributes:[],example:{attributes:{}}}})),I,L,R,z,B,V,H,fe=e((()=>{I=`jpa/most-commented-posts`,L=`All-time most commented posts`,R=`The posts and pages that receive the most comments.`,z={content:`The posts and pages that received the most comments.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},B=`stats`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function U(){return(0,W.jsx)(A,{attributes:{reportParams:d()}})}function pe(e){return(0,W.jsx)(ue,{...e,widgetType:b(H,P),renderModule:G,renderComponent:A,attributes:{reportParams:d(!0)}})}var W,G,K,q,J,Y,X,Z,Q,$;e((()=>{u(),v(),_(),de(),S(),f(),N(),F(),fe(),W=r(),se(),G=`storybook/most-commented-posts`,K={title:`Packages/Premium Analytics/Widgets/MostCommentedPosts`,component:A,tags:[`autodocs`],parameters:{docs:{description:{component:`The "All-time most commented posts" widget. Ranks the posts and pages that receive the most comments, linking each row to the published post. One half of the Jetpack Stats Comments module; "All-time most commented authors" covers the other.`}}}},q={render:U,decorators:[w,y]},J={render:U,tags:[`!autodocs`],decorators:[w,y],beforeEach:p(`loading`)},Y={render:U,tags:[`!autodocs`],decorators:[w,y],beforeEach:p(`error`)},X={render:U,tags:[`!autodocs`],decorators:[w,y],beforeEach:p(`error-retryable`)},Z={render:U,tags:[`!autodocs`],decorators:[w,y],beforeEach:p(`empty`)},Q={render:e=>(0,W.jsx)(pe,{...e}),args:{...C},argTypes:{...x},decorators:[y]},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
