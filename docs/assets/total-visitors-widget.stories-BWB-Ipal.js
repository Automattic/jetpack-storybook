import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{n as o,ui as s}from"./build-module-CDRs4YxF.js";import{dt as ee,kn as te,t as c}from"./src-Dq5FM30o.js";import{b as l,g as u}from"./hooks-Chc7IXb5.js";import{n as ne}from"./sparkline-DlqgSMsy.js";import{j as re,qt as d,t as f,vn as ie}from"./src-B5JGvL-s.js";import{n as p,t as m}from"./src-CY2THOde.js";import{M as ae}from"./chart-tooltip-DcOXtYLY.js";import{t as oe}from"./metric-sparkline-skeleton-HBOZ37Eg.js";import{G as h,J as g,W as se}from"./report-metric-6zfwbEAX.js";import{t as ce}from"./widget-state-CBoEg3sC.js";import{C as _,D as le,E as ue,S as v,T as y,b as de,t as fe,w as pe,x as b}from"./src-D9vNzIYU.js";var x,S,C,w,T=t((()=>{x=`_root_lau5r_1`,S=`_body_lau5r_9`,C=`_chart_lau5r_21`,w={root:x,body:S,chart:C}}));function me(){let{reportParams:e}=l(),{primary:t,isLoading:n,isFetching:i,isError:a,error:o,refetch:c}=re((0,D.useMemo)(()=>ie({...e,stat_fields:`views,visitors`,period:k}),[e])),u=t.data,d=Number(u?.summary?.visitors??0),f=p(d,`number`,j),m=p(d,`number`,d>=1e3?A:j),h=(0,D.useMemo)(()=>(u?.data??[]).map(e=>Number(e.visitors??0)),[u]);return(0,O.jsx)(`div`,{className:w.root,children:(0,O.jsx)(ce,{isLoading:n,isFetching:i,isError:a&&h.length===0,isEmpty:h.length===0,error:ae(o,{retryDescription:r(`We couldn't load your visitors. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}),empty:{icon:s,description:r(`No visitors in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,O.jsx)(oe,{}),children:(0,O.jsxs)(`div`,{className:w.body,children:[(0,O.jsx)(te,{variant:`heading-2xl`,title:f,children:m===f?m:(0,O.jsxs)(O.Fragment,{children:[(0,O.jsx)(`span`,{"aria-hidden":`true`,children:m}),(0,O.jsx)(ee,{children:f})]})}),(0,O.jsx)(`div`,{className:w.chart,children:(0,O.jsx)(ne,{data:h,maxWidth:1/0})})]})})})}function E({attributes:e={},setError:t}){return(0,O.jsx)(u,{attributes:e,setError:t,children:(0,O.jsx)(me,{})})}var D,O,k,A,j,he=t((()=>{f(),c(),m(),fe(),i(),o(),D=e(n(),1),T(),O=a(),k=`day`,A={useMultipliers:!0,decimals:1},j={decimals:0}})),M,N=t((()=>{o(),M={icon:s}})),P,F,I,L,R,z,B,ge=t((()=>{P=`jpa/total-visitors`,F=`Total visitors`,I=`Total visitors for the selected period, with the trend over time.`,L={content:`The number of visitors to your site. A returning visitor is counted once per day.`,links:[{label:`Learn more`,href:`https://wordpress.com/support/stats/#visitors`}]},R=`stats`,z=`framed`,B={name:P,title:F,description:I,help:L,category:R,presentation:z}}));function _e(){return(0,U.jsx)(E,{attributes:{reportParams:d(!1)}})}function V(e){return(0,U.jsx)(E,{attributes:{reportParams:d(!1,e)}})}function H(e){return(0,U.jsx)(y,{...e,widgetType:G,renderModule:W,renderComponent:E,attributes:{reportParams:d(!1)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{f(),se(),ue(),_(),de(),he(),N(),ge(),U=a(),h(),W=`storybook/total-visitors`,G=v(B,M),K={title:`Packages/Premium Analytics/Widgets/TotalVisitors`,component:E,tags:[`autodocs`],parameters:{docs:{description:{component:`The "Total visitors" card: the selected period's visitor total as a large figure over an area sparkline of the trend. The total sums each day's visitors, so a returning visitor counts once per day — the card carries that caveat in its info popover. There is no WithComparison story: the widget strips comparison from its request and renders no delta.`}}}},q={render:_e,decorators:[b]},J={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(g(`stats/visits`,`loading`),()=>g(`stats/visits`,null))},Y={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(g(`stats/visits`,`error`),()=>g(`stats/visits`,null))},X={render:()=>V(`last-12-months`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(g(`stats/visits`,`error-retryable`),()=>g(`stats/visits`,null))},Z={render:()=>V(`last-year`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(g(`stats/visits`,`empty`),()=>g(`stats/visits`,null))},Q={render:e=>(0,U.jsx)(H,{...e}),args:{...pe},argTypes:{...le}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
