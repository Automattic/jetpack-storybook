...
`,(0,v.jsx)(o,{language:`jsx`,code:`import { PieSemiCircleChart } from '@automattic/charts';
...
`,(0,v.jsx)(s,{of:l}),`
`,(0,v.jsx)(o,{language:`jsx`,code:`<PieSemiCircleChart
	data={ data }
	thickness={ 0.4 }
	label="OS"
	note="Windows +10%"
...
`,(0,v.jsx)(o,{language:`jsx`,code:`// Thin ring (thickness: 0.2)
<PieSemiCircleChart
	data={ data }
	width={ 400 }
	thickness={ 0.2 }
...
`,(0,v.jsx)(o,{language:`jsx`,code:`const singlePointData = [
	{
		label: 'Complete',
		value: 100,
		percentage: 100,
...
`,(0,v.jsx)(s,{of:f}),`
`,(0,v.jsx)(o,{language:`jsx`,code:`<PieSemiCircleChart data={ data }>
...
`,(0,v.jsx)(o,{language:`jsx`,code:`const customColorData = [
	{
		label: 'Primary',
		value: 60,
		percentage: 60,
...
`,(0,v.jsxs)(t.ul,{children:[`
`,(0,v.jsxs)(t.li,{children:[(0,v.jsx)(t.strong,{children:`Label`}),`: Uses `,(0,v.jsx)(t.code,{children:`--wpds-font-size-lg`}),` (default 16px), `,(0,v.jsx)(t.code,{children:`--wpds-font-weight-medium`}),` (default 499), positioned above the chart`]}),`
`,(0,v.jsxs)(t.li,{children:[(0,v.jsx)(t.strong,{children:`Note`}),`: Uses `,(0,v.jsx)(t.code,{children:`--wpds-font-size-md`}),` (default 13px), positioned below the label`]}),`
`]}),`
`,(0,v.jsx)(o,{language:`jsx`,code:`<PieSemiCircleChart
	data={ data }
	width={ 600 }
...
`,(0,v.jsx)(o,{language:`tsx`,code:`import { GlobalChartsProvider, PieSemiCircleChart, type ChartTheme } from '@automattic/charts';
...
`,(0,v.jsx)(s,{of:l}),`
`,(0,v.jsx)(o,{language:`jsx`,code:`// Fill parent container (default) - parent needs explicit height
...
`,(0,v.jsx)(o,{language:`jsx`,code:`const formattedData = [
	{
		label: 'Users',
		value: 15000,
...
`,(0,v.jsx)(o,{language:`jsx`,code:`// Full pie chart
<PieChart
	data={ data }
	size={ 400 }
/>
...
`,(0,v.jsx)(o,{language:`jsx`,code:`// Full pie chart - must sum to 100
const fullPieData = [
...
];`})]})}function _(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,v.jsx)(t,{...e,children:(0,v.jsx)(g,{...e})}):g(e)}var v;e((()=>{v=t(),r(),i(),m()}))();export{_ as default};