import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{t as n,ul as r}from"./build-module-2iv4IIRq.js";import{m as ee}from"./hooks-BGt6LoW1.js";import{n as i,t as a}from"./build-module-CddCdeny.js";import{rt as o,t as s}from"./src-CJGEmgc4.js";import{r as c,tn as l}from"./date-period-dropdown-DHu2gHeT.js";import{i as te,r as ne}from"./register-report-mocks-sSGbz5XB.js";import{m as re,t as ie}from"./src-3DGVn4e6.js";import{a as ae,c as oe,i as u,l as d,n as f,o as p,r as m,s as h}from"./with-widget-canvas-DNZGVay_.js";import{n as g,t as _}from"./force-stats-mock-state-D_G6-LjH.js";function v({attributes:e={},setError:t}){return(0,y.jsx)(ee,{attributes:e,setError:t,options:{from:`/`},children:(0,y.jsx)(re,{})})}var y,b=e((()=>{ie(),y=t()})),x,S=e((()=>{n(),x={icon:r}})),C,w,T,E,D,O,k,A=e((()=>{C=`jpa/store-conversion-rate-bookings`,w=`Store conversion rate - Bookings`,T=`Store conversion rate for booking products over the selected time period.`,E={content:`Track your booking conversion funnel from sessions to completed bookings over the selected time period.`},D=`bookings`,O=`framed`,k={name:C,title:w,description:T,help:E,category:D,presentation:O}}));function j(e){let t={active_sessions:String(e?4860:5480),visitors:String(e?3920:4410),with_cart_addition:String(e?970:1215),reached_checkout:String(e?430:560),completed_checkout:String(e?218:310),date_start:`2026-05-01T00:00:00.000Z`,date_end:`2026-05-31T23:59:59.999Z`};return{summary:t,data:[t]}}function M(){W||(W=!0,a.use(async(e,t)=>{if(!String(e.path??e.url??``).startsWith(B))return t(e);let n=G%2==1;return G+=1,j(n)}))}function N(e=!1,t=H){return{reportParams:l(e,t)}}function P({withComparison:e,preset:t}){let n=!!e,r=t??H;return!n&&r===H?`getDefaultQueryParams()`:n&&r===H?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function F(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<StoreConversionRateBookingsRender
\tattributes={ {
\t\treportParams: ${P(e)},
\t} }
/>`}function I({withComparison:e,preset:t}){return(0,z.jsx)(v,{attributes:N(e,t)})}function L(e){return(0,z.jsx)(v,{attributes:N(!1,e)})}function R({withComparison:e,preset:t,...n}){return(0,z.jsx)(h,{...n,widgetType:u(k,x),renderModule:V,renderComponent:v,attributes:N(e,t)})}var z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{c(),s(),i(),ne(),oe(),ae(),f(),g(),b(),S(),A(),z=t(),B=`/jetpack-premium-analytics/v1/proxy/v2/analytics/reports/sessions/by-conversion-rate`,V=`storybook/store-conversion-rate-bookings`,H=`last-30-days`,U=o,W=!1,G=0,te(),M(),K={title:`Packages/Premium Analytics/Widgets/StoreConversionRateBookings`,component:v,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:U,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`Dashboard widget that displays the booking product conversion funnel for the selected period.`}}}},q={render:I,args:{preset:H,withComparison:!1},decorators:[m],parameters:{docs:{source:{transform:(e,t)=>F(t.args)}}}},J={render:I,args:{preset:H,withComparison:!0},decorators:[m],parameters:{docs:{source:{transform:(e,t)=>F(t.args)}}}},Y={render:()=>L(`last-90-days`),tags:[`!autodocs`],decorators:[m],beforeEach:()=>(_(`sessions/by-conversion-rate`,`loading`),()=>_(`sessions/by-conversion-rate`,null))},X={render:()=>L(`last-7-days`),tags:[`!autodocs`],decorators:[m],beforeEach:()=>(_(`sessions/by-conversion-rate`,`error`),()=>_(`sessions/by-conversion-rate`,null))},Z={render:()=>L(`last-365-days`),tags:[`!autodocs`],decorators:[m],beforeEach:()=>(_(`sessions/by-conversion-rate`,`empty`),()=>_(`sessions/by-conversion-rate`,null))},Q={render:e=>(0,z.jsx)(R,{...e}),args:{...p,preset:H,withComparison:!0},argTypes:{...d,preset:{control:`select`,options:U,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
