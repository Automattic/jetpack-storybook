import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DQ5lAs4a.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{n as i,rl as a}from"./build-module-Bt8gOW8e.js";import{It as o,p as s,s as c}from"./hooks-DLXILeQ8.js";import{n as l,t as u}from"./build-module-DyqCcxre.js";import{l as d,t as f}from"./src-nQqIBmxK.js";import{n as p,t as m}from"./register-report-mocks-CnZ_77AT.js";import{i as h,n as g,r as _,t as v}from"./widget-dashboard-with-widget-089p4ezJ.js";import{c as y,t as b}from"./src-BW7XE8Jy.js";function x({attributes:e={},setError:t}){return(0,S.jsx)(c,{attributes:e,setError:t,options:{from:`/`},children:(0,S.jsx)(y,{limit:5})})}var S,C=e((()=>{b(),S=r()})),w,T=e((()=>{n(),i(),w={name:`jpa/top-performing-products`,title:t(`Top performing products`,`jetpack-premium-analytics`),description:t(`Shows the top products by net revenue over the selected time period.`,`jetpack-premium-analytics`),icon:a}}));function E(e){let t=e.reduce((e,t)=>({total_orders:e.total_orders+Number(t.orders_count),total_quantity:e.total_quantity+Number(t.total_quantity),total_revenue:e.total_revenue+Number(t.product_net_revenue)}),{total_orders:0,total_quantity:0,total_revenue:0});return{data:e,summary:{total_orders:String(t.total_orders),total_products:String(e.length),total_quantity:String(t.total_quantity),total_revenue:t.total_revenue.toFixed(2)}}}function D(e){L||(L=!0,u.use(async(t,n)=>{let r=t.path??t.url??``;return r.startsWith(P)?E(e):r.startsWith(F)?e.map(e=>({id:Number(e.product_id),name:e.product_name,images:[]})):n(t)}))}function O(e=!1,t=z){return{reportParams:o(e,t)}}function k({withComparison:e,preset:t}){let n=!!e,r=t??z;return!n&&r===z?`getDefaultQueryParams()`:n&&r===z?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function A(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
