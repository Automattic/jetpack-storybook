import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as ee,t as i}from"./build-module-CbwHEf9N.js";import{Cc as a,_c as o,n as s}from"./build-module-CDRs4YxF.js";import{ln as te,t as c}from"./src-DTW6Avdq.js";import{$ as ne,G as re,K as ie,S as ae,U as l,b as u,w as oe}from"./report-metric-CfF6QW2f.js";import{F as d,qt as f,t as p}from"./src-DXQx-HLd.js";import"./constants-B1kGztHF.js";import{rt as se,x as ce}from"./chart-tooltip-DPvHn5um.js";import{r as m,t as h}from"./leaderboard-skeleton-DLIroc8e.js";import{t as g}from"./widget-state-BcvJNT8Q.js";import{C as _,D as v,E as y,O as b,S as x,T as S,b as le,k as C,t as ue,w as de,x as w}from"./src-CS4QJABu.js";var T,E,D,O=e((()=>{T=`_root_jzzhc_1`,E=`_content_jzzhc_9`,D={root:T,content:E}}));function k(){let{rows:e,isLoading:n,isFetching:r,isError:i,error:o,refetch:s}=d({group:`posts`,max:10}),c=(0,ee.useMemo)(()=>{let t=Math.max(...e.map(e=>e.value),0);return e.map(e=>({id:e.id,label:(0,j.jsx)(u,{id:e.postId,label:e.label,link:e.link}),currentValue:e.value,currentShare:se(e.value,t)}))},[e]);return(0,j.jsxs)(te,{className:D.root,children:[(0,j.jsx)(`div`,{className:D.content,children:(0,j.jsx)(g,{isLoading:n,isFetching:r,isError:i,isEmpty:e.length===0,error:ce(o,{retryDescription:t(`We couldn't load commented posts. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:s}),empty:{icon:a,description:t(`None of your posts or pages have comments yet.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,j.jsx)(h,{rows:10}),children:(0,j.jsx)(m,{data:c,withOverlayLabel:!0,showLegend:!1,dataFormat:M})})}),(0,j.jsx)(oe,{children:(0,j.jsx)(ae,{report:`comments`,section:`posts`,ariaLabel:t(`See the commented posts report`,`jetpack-premium-analytics-pkg`)})})]})}function A({attributes:e={}}){return(0,j.jsx)(ne,{attributes:e,children:(0,j.jsx)(k,{})})}var j,M,N=e((()=>{p(),ue(),i(),n(),s(),c(),O(),j=r(),M={type:`number`,options:{useMultipliers:!0,decimals:0}}})),P,F=e((()=>{s(),P={icon:o,attributes:[],example:{attributes:{}}}})),I,L,R,z,B,V,H,fe=e((()=>{I=`jpa/most-commented-posts`,L=`Top commented posts`,R=`The posts and pages that receive the most comments.`,z={content:`Your posts and pages, ranked by the number of comments they have received.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},B=`stats`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function U(){return(0,W.jsx)(A,{attributes:{reportParams:f()}})}function pe(e){return(0,W.jsx)(S,{...e,widgetType:x(H,P),renderModule:G,renderComponent:A,attributes:{reportParams:f(!0)}})}var W,G,K,q,J,Y,X,Z,Q,$;e((()=>{p(),y(),_(),b(),le(),re(),N(),F(),fe(),W=r(),ie(),G=`storybook/most-commented-posts`,K={title:`Packages/Premium Analytics/Widgets/MostCommentedPosts`,component:A,tags:[`autodocs`],parameters:{docs:{description:{component:`The "Top commented posts" widget. Ranks the posts and pages that receive the most comments, linking each row to the published post. One half of the Jetpack Stats Comments module; "Top commented authors" covers the other.`}}}},q={render:U,decorators:[w,C]},J={render:U,tags:[`!autodocs`],decorators:[w,C],beforeEach:l(`loading`)},Y={render:U,tags:[`!autodocs`],decorators:[w,C],beforeEach:l(`error`)},X={render:U,tags:[`!autodocs`],decorators:[w,C],beforeEach:l(`error-retryable`)},Z={render:U,tags:[`!autodocs`],decorators:[w,C],beforeEach:l(`empty`)},Q={render:e=>(0,W.jsx)(pe,{...e}),args:{...de},argTypes:{...v},decorators:[C]},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
