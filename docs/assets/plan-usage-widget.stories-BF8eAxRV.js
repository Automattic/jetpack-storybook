import{i as e}from"./preload-helper-usAeo7Bx.js";import{c as t,n,r,t as i}from"./build-module-Da_5_6n_.js";import{n as a,t as o}from"./clsx-SUvPW2lx.js";import{t as s}from"./jsx-runtime-D2pHJD-r.js";import{O as c,t as l}from"./build-module-DrryaqBL.js";import{ct as u,n as d}from"./build-module-DmVuor49.js";import{Vi as ee,Wi as f}from"./iframe-a_up9Qn8.js";import{R as te,W as p,t as ne,u as re}from"./build-module-DokNvSv5.js";import{n as m,t as ie}from"./src-3Lv7Etdm.js";import{Gt as ae,Yn as h,ar as g,ut as _}from"./chart-tooltip-B-p4R1ne.js";import{C as oe,E as v,O as y,S as se,T as b,k as x,w as S}from"./report-metric-BEx9Ox4P.js";import{t as C}from"./widget-state-jmx0JXRV.js";import{S as w,b as ce,t as le,x as ue,y as de}from"./src-bT7CpZTu.js";var T,E,D,O,k,A,j,fe=e((()=>{T=`_root_1i6zp_1`,E=`_progress_1i6zp_9`,D=`_progressMeter_1i6zp_24`,O=`_isOverLimit_1i6zp_46`,k=`_progressLabel_1i6zp_55`,A=`_note_1i6zp_61`,j={root:T,progress:E,progressMeter:D,isOverLimit:O,progressLabel:k,note:A}}));function pe(e){return n(e>=2?`You've surpassed your limit for two consecutive periods already.`:`You've surpassed your limit the past month.`,`jetpack-premium-analytics`)}function me(){let e=f()?.site,t=e?.wpcom?.blog_id;return!e?.admin_url||!t?void 0:`${e.admin_url}admin.php?page=stats#!/stats/purchase/${t}?from=jetpack-premium-analytics&productType=commercial&redirect_uri=admin.php%3Fpage%3Djetpack-premium-analytics-wp-admin`}function he({limit:e,usage:i,daysToReset:a,overLimitMonths:s}){let l=i??0,u=l>=e,d=me();return(0,P.jsxs)(te,{className:j.root,direction:`column`,align:`stretch`,justify:`safe center`,gap:`md`,children:[(0,P.jsxs)(`div`,{className:o(j.progress,u&&j.isOverLimit),children:[(0,P.jsx)(`progress`,{className:j.progressMeter,value:Math.min(l,e),max:e,"aria-label":n(`Plan usage`,`jetpack-premium-analytics`)}),(0,P.jsx)(p,{className:j.progressLabel,variant:`body-sm`,children:t(n(`%1$s / %2$s views`,`jetpack-premium-analytics`),m(l,`number`,{decimals:0}),m(e,`number`,{decimals:0}))}),a!==void 0&&(0,P.jsx)(p,{className:j.progressLabel,variant:`body-sm`,children:t(r(`Restarts in %d day`,`Restarts in %d days`,a,`jetpack-premium-analytics`),a)})]}),(!!s||d)&&(0,P.jsxs)(p,{className:j.note,variant:`body-sm`,children:[s?(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(`strong`,{children:pe(s)}),` `]}):null,d&&c(n(`Do you want to increase your views limit? <a>Upgrade now</a>`,`jetpack-premium-analytics`),{a:(0,P.jsx)(re,{href:d})})]})]})}function M(){let{data:e,isLoading:t,isFetching:r,isError:i,refetch:a}=ae(),o=e?.views_limit,s=typeof o==`number`&&o>0,c=f()?.site?.host===`vip`;return(0,P.jsx)(C,{isLoading:t,isFetching:r,isError:!e&&i,isEmpty:!s,error:{description:n(`We couldn't load plan usage. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:n(`Retry`,`jetpack-premium-analytics`),onClick:a}]},empty:{icon:u,description:n(`Plan usage isn't available for your current plan.`,`jetpack-premium-analytics`)},children:s&&(0,P.jsx)(he,{limit:o,usage:e?.current_usage?.views_count,daysToReset:e?.current_usage?.days_to_reset,overLimitMonths:c?null:e?.over_limit_months})})}function N({attributes:e={}}){return(0,P.jsx)(x,{attributes:e,children:(0,P.jsx)(M,{})})}var P,F=e((()=>{ee(),_(),ie(),le(),l(),i(),d(),ne(),a(),fe(),P=s()})),I,L=e((()=>{i(),d(),I={name:`jpa/plan-usage`,title:n(`Plan usage`,`jetpack-premium-analytics`),icon:u,help:{content:n(`Billable views are your total views minus your two highest-traffic days each billing cycle, so big spikes won't count against your limit. You'll only need to upgrade if you exceed your limit for three cycles in a row.`,`jetpack-premium-analytics`),links:[{label:n(`Learn more`,`jetpack-premium-analytics`),href:`https://jetpack.com/support/jetpack-stats/free-or-paid/`}]},attributes:[],example:{attributes:{}}}}));function R(e){return()=>(b(`jetpack-stats/usage`,e),g.removeQueries({queryKey:[`stats-app`,`plan-usage`]}),()=>{b(`jetpack-stats/usage`,null),g.removeQueries({queryKey:[`stats-app`,`plan-usage`]})})}function z({vip:e}){return()=>(S(`jetpack-stats/usage`,y),e&&(window.JetpackScriptData.site.host=`vip`),g.removeQueries({queryKey:[`stats-app`,`plan-usage`]}),()=>{S(`jetpack-stats/usage`,null),e&&delete window.JetpackScriptData.site.host,g.removeQueries({queryKey:[`stats-app`,`plan-usage`]})})}function B({withComparison:e}){return(0,V.jsx)(N,{attributes:{reportParams:h(e)}})}function ge({withComparison:e,...t}){return(0,V.jsx)(ce,{...t,widgetType:{...I,presentation:`framed`},renderModule:H,renderComponent:N,attributes:{reportParams:h(e)}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{_(),v(),se(),ue(),F(),L(),V=s(),oe(),window.JetpackScriptData={...window.JetpackScriptData,site:{...window.JetpackScriptData?.site,admin_url:`https://example.com/wp-admin/`,wpcom:{blog_id:123456789}}},H=`storybook/plan-usage`,U=e=>(0,V.jsx)(`div`,{style:{width:`100%`,height:`360px`},children:(0,V.jsx)(e,{})}),W={title:`Packages/Premium Analytics/Widgets/PlanUsage`,component:N,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`}},parameters:{docs:{description:{component:`The "Plan usage" widget. Shows billable views used in the current billing cycle against the plan's limit as a horizontal usage meter — figures and days-until-reset inside the bar, an upgrade note below it — following the Stats "Plan usage" section. The usage endpoint is a point-in-time reading with no date range or comparison period.`}}}},G={render:B,args:{withComparison:!1},decorators:[U]},K={render:B,args:{withComparison:!0},decorators:[U],parameters:{docs:{description:{story:`The usage endpoint has no comparison period, so this renders identically to Default even when comparison report params are supplied.`}}}},q={render:B,args:{withComparison:!1},tags:[`!autodocs`],decorators:[U],beforeEach:R(`loading`)},J={render:B,args:{withComparison:!1},tags:[`!autodocs`],decorators:[U],beforeEach:R(`error`)},Y={render:B,args:{withComparison:!1},tags:[`!autodocs`],decorators:[U],beforeEach:R(`empty`)},X={render:B,args:{withComparison:!1},tags:[`!autodocs`],decorators:[U],beforeEach:z({vip:!1})},Z={render:B,args:{withComparison:!1},tags:[`!autodocs`],decorators:[U],beforeEach:z({vip:!0})},Q={render:e=>(0,V.jsx)(ge,{...e}),args:{...de,withComparison:!0},argTypes:{...w,withComparison:{control:`boolean`}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
