import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{E as n,t as r}from"./build-module-WkxPr6kR.js";import{a as i,r as a}from"./text-DNyawDL-.js";import{It as o,Lt as s,Rt as c,zt as l}from"./iframe-Doxa4OB_.js";var u,d,f,p,m,h=e((()=>{u=`_container_6hkcb_1`,d=`_col_6hkcb_5`,f=`_yes_6hkcb_12`,p=`_no_6hkcb_18`,m={container:u,col:d,yes:f,no:p}})),g,_,v,y,b,x,S;e((()=>{r(),i(),l(),s(),h(),g=t(),_=({items:e,fluid:t,horizontalGap:n,horizontalSpacing:r})=>(0,g.jsxs)(o,{className:m.container,horizontalSpacing:r,fluid:t,horizontalGap:n,children:[e.map(({sm:e,lg:t,md:n},r)=>{let i=Number.isInteger(e?.start)?JSON.stringify(e):e,a=Number.isInteger(n?.start)?JSON.stringify(n):n,o=Number.isInteger(t?.start)?JSON.stringify(t):t;return(0,g.jsxs)(c,{sm:e,md:n,lg:t,className:m.col,children:[e?`sm=${i} `:``,n?`md=${a} `:``,t?`lg=${o} `:``]},`${i}${a}${o}${r}`)}),(0,g.jsx)(c,{children:(0,g.jsxs)(o,{fluid:!0,horizontalSpacing:0,horizontalGap:1,children:[(0,g.jsx)(c,{className:m.col,children:`Composition Example`}),(0,g.jsx)(c,{className:m.col,children:`Composition Example`})]})})]}),v={title:`JS Packages/Components/Layout`,component:_},y=e=>(0,g.jsx)(_,{...e}),b=y.bind({}),b.args={fluid:!1,horizontalSpacing:10,horizontalGap:5,items:[{sm:2,md:5,lg:4},{sm:2,md:3,lg:{start:6,end:12}},{sm:2,md:3,lg:6},{sm:2,md:5,lg:{start:9,end:12}},{sm:2,md:5,lg:4},{sm:2,md:3,lg:8}]},x=e=>{let t=n(`small`,`<`),r=n(`small`),i=n(`small`),s=n(`large`,`<`),l=i&&s,u=n(`large`,`<`),d=n(`small`,`<`),f=n(`small`),p=n(`large`),h=n(`large`,`<`),_=n(`large`);return(0,g.jsxs)(o,{children:[(0,g.jsx)(a,{variant:`headline-small`,children:`Small`}),(0,g.jsxs)(c,{children:[(0,g.jsx)(a,{variant:`title-small`,children:`Is Small`}),(0,g.jsx)(a,{className:t?m.yes:m.no,children:t?`Yes`:`False`})]}),(0,g.jsxs)(c,{children:[(0,g.jsx)(a,{variant:`title-small`,children:`Is greater than Small`}),(0,g.jsx)(a,{className:r?m.yes:m.no,children:r?`Yes`:`False`})]}),(0,g.jsx)(a,{variant:`headline-small`,children:`Medium`}),(0,g.jsxs)(c,{children:[(0,g.jsx)(a,{variant:`title-small`,children:`Is Medium`}),(0,g.jsx)(a,{className:l?m.yes:m.no,children:l?`Yes`:`False`})]}),(0,g.jsxs)(c,{children:[(0,g.jsx)(a,{variant:`title-small`,children:`Is less then Medium`}),(0,g.jsx)(a,{className:d?m.yes:m.no,children:d?`Yes`:`False`})]}),(0,g.jsxs)(c,{children:[(0,g.jsx)(a,{variant:`title-small`,children:`Is less then OR Medium`}),(0,g.jsx)(a,{className:u?m.yes:m.no,children:u?`Yes`:`False`})]}),(0,g.jsxs)(c,{children:[(0,g.jsx)(a,{variant:`title-small`,children:`Is greater then Medium`}),(0,g.jsx)(a,{className:p?m.yes:m.no,children:p?`Yes`:`False`})]}),(0,g.jsxs)(c,{children:[(0,g.jsx)(a,{variant:`title-small`,children:`Is greater then OR Medium`}),(0,g.jsx)(a,{className:f?m.yes:m.no,children:f?`Yes`:`False`})]}),(0,g.jsx)(a,{variant:`headline-small`,children:`Large`}),(0,g.jsxs)(c,{children:[(0,g.jsx)(a,{variant:`title-small`,children:`Is Large`}),(0,g.jsx)(a,{className:_?m.yes:m.no,children:_?`Yes`:`False`})]}),(0,g.jsxs)(c,{children:[(0,g.jsx)(a,{variant:`title-small`,children:`Is less than Large`}),(0,g.jsx)(a,{className:h?m.yes:m.no,children:h?`Yes`:`False`})]})]})},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`args => <Layout {...args} />`,...b.parameters?.docs?.source}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`args => {
