import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{_ as o,t as s}from"./build-module-CbwHEf9N.js";import{n as c,w as l}from"./build-module-CDRs4YxF.js";import{J as u,at as d,b as f,ct as p,ot as m,q as ee,tt as te}from"./report-metric-CG4McNXT.js";import{Gt as h,ft as g,it as ne,t as _,tt as re,ut as ie}from"./src-Boe-c6TP.js";import{x as v}from"./chart-tooltip-DEV3Aqbv.js";import{t as ae}from"./widget-state-BsgP3UWI.js";import{C as oe,D as y,E as se,O as ce,S as le,T as ue,b as de,k as b,t as x,w as S,x as C}from"./src-D-0P4cBO.js";import{n as fe,t as pe}from"./register-stats-mocks-CbnL6rJz.js";import{n as w,t as T}from"./force-stats-mock-state-CFiaSJfH.js";function me(e){let t=re((0,E.useMemo)(()=>{let t={...e,max:O};return delete t.comp,delete t.compare_from,delete t.compare_to,delete t.compare_preset,t},[e]),{maxRows:1,postTypes:D}),n=t.comparisonRows?.rows[0],r=Number(n?.id??0)||0,i=g(ne(r)),a=ie({postId:r,fields:[`views`,`like_count`,`post`]}),o=a.data,s=o?.post?.ID,c=o&&(s===void 0||s===r)?o:void 0,l=r>0&&!c&&!a.isError,u=t.isLoading||r>0&&(i.isLoading||a.isLoading||l),d=t.isFetching||i.isFetching||a.isFetching,f=t.isError,p=()=>{t.refetch(),r>0&&(i.refetch(),a.refetch())},m=i.data??null;return{post:n?{id:r,title:m?.title||String(n.label??``),url:m?.url||n.link||``,date:m?.date||(typeof n.date==`string`?n.date:``),imageUrl:m?.imageUrl??``,imageAlt:m?.imageAlt??``,views:c?.views,likeCount:c?.like_count,commentCount:c?.post?.comment_count}:null,isLoading:u,isFetching:d,isError:f,error:t.error,refetch:p}}var E,D,O,he=t((()=>{_(),E=e(n(),1),D=[`post`],O=20}));function ge(){let{reportParams:e}=d(),{post:t,isLoading:n,isFetching:i,isError:a,error:s,refetch:c}=me(e),u=(0,o.useMemo)(()=>p(e),[e]),m=t?[{key:`views`,label:r(`Views`,`jetpack-premium-analytics-pkg`),value:t.views},{key:`likes`,label:r(`Likes`,`jetpack-premium-analytics-pkg`),value:t.likeCount},{key:`comments`,label:r(`Comments`,`jetpack-premium-analytics-pkg`),value:t.commentCount}]:[];return(0,A.jsx)(ae,{isLoading:n,isFetching:i,isError:a,isEmpty:!t,error:v(s,{retryDescription:r(`We couldn't load your most popular post. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}),empty:{icon:l,description:r(`No post views in this period.`,`jetpack-premium-analytics-pkg`)},children:t&&(0,A.jsx)(f,{title:t.title,url:t.url,postId:t.id,detailSearch:u,date:t.date,imageUrl:t.imageUrl,imageAlt:t.imageAlt,metrics:m})})}function k({attributes:e={}}){return(0,A.jsx)(te,{attributes:e,children:(0,A.jsx)(ge,{})})}var A,_e=t((()=>{m(),x(),s(),i(),c(),he(),A=a()})),j,M=t((()=>{c(),j={icon:l,attributes:[],example:{attributes:{}}}})),N,P,F,I,L,R,z,ve=t((()=>{N=`jpa/popular-post`,P=`Popular post`,F=`Your most-viewed post for the selected date range, with its all-time stats.`,I={content:`Your most viewed post in the selected date range, with its all-time views, likes, and comments.`},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function ye(){return(0,H.jsx)(k,{attributes:{reportParams:h()}})}function B(e){return(0,H.jsx)(k,{attributes:{reportParams:h(!1,e)}})}function V(e){return(0,H.jsx)(ue,{...e,widgetType:le(z,j),renderModule:U,renderComponent:k,attributes:{reportParams:h(!0)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{_(),ee(),pe(),oe(),w(),se(),ce(),de(),_e(),M(),ve(),H=a(),u(),fe(),U=`storybook/popular-post`,W={title:`Packages/Premium Analytics/Widgets/PopularPost`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:"The \"Popular post\" widget shows the site's most-viewed post for the dashboard's date range, with its publish date and its all-time views, likes, and comments. Changing the date range changes which post wins, not the totals shown for it: every tile comes from the all-time `stats/post` response, so the three cannot measure different periods. There is no `WithComparison` story: the card shows no period-over-period delta, so the dashboard story below carries the comparison report params instead."}}}},G={render:ye,decorators:[C,b]},K={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[C,b],beforeEach:()=>(T(`stats/top-posts`,`loading`),()=>T(`stats/top-posts`,null))},q={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[C,b],beforeEach:()=>(T(`stats/top-posts`,`error`),()=>T(`stats/top-posts`,null))},J={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[C,b],beforeEach:()=>(T(`stats/top-posts`,`error-retryable`),()=>T(`stats/top-posts`,null))},Y={render:()=>B(`last-year`),tags:[`!autodocs`],decorators:[C,b],beforeEach:()=>(T(`stats/top-posts`,`empty`),()=>T(`stats/top-posts`,null))},X={render:e=>(0,H.jsx)(V,{...e}),args:{...S,widgetWidth:2,widgetHeight:2},argTypes:{...y}},Z={render:e=>(0,H.jsx)(V,{...e}),args:{...S,widgetWidth:2,widgetHeight:1},argTypes:{...y}},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...S,widgetWidth:1,widgetHeight:1},argTypes:{...y}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
