import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{s as i,t as a,yi as o}from"./build-module-2iv4IIRq.js";import{Et as s,On as c}from"./build-module-l8c-_EUg2.js";import{m as l,v as ee}from"./hooks-Ofn0_bvh.js";import{t as u}from"./src-tJVR7ayc.js";import{Nn as d,g as te,r as f,tn as p}from"./date-period-dropdown-DhhPpENn.js";import{a as ne}from"./src-JQgHfU4y2.js";import{t as re}from"./chart-empty-state-CFyS3teD.js";import{c as m,i as ie,r as ae}from"./register-report-mocks-CzXaY-E0.js";import{t as oe}from"./widget-state-YaJf-SYE.js";import{t as se}from"./src-1s2pM8AK.js";import{a as h,c as ce,i as le,l as g,n as _,o as v,r as y,s as ue}from"./with-widget-canvas-Bb3tCRA8.js";var b,x,S,C,w,T,E=e((()=>{b=`_root_o9l91_1`,x=`_content_o9l91_11`,S=`_list_o9l91_23`,C=`_item_o9l91_31`,w=`_link_o9l91_40`,T={root:b,content:x,list:S,item:C,link:w}}));function D({pages:e}){return(0,k.jsx)(`ul`,{className:T.list,children:e.map((e,t)=>{let n=ne(e.link);return(0,k.jsx)(`li`,{className:T.item,children:n?(0,k.jsx)(c,{className:T.link,href:n,variant:`unstyled`,openInNewTab:!0,title:e.label,children:e.label}):(0,k.jsx)(`span`,{className:T.link,title:e.label,children:e.label})},`${t}-${e.link}`)})})}function de(){let{reportParams:e}=ee(),n=d(e.post_id),{data:r,isLoading:a,isFetching:o,isError:c,refetch:l}=te(n),u;if(n<=0)u=(0,k.jsx)(re,{icon:i,text:t(`Select a video to see where it is embedded across your site.`,`jetpack-premium-analytics-pkg`)});else{let e=r?.pages??[];u=(0,k.jsx)(oe,{isLoading:a,isFetching:o,isError:e.length===0&&c,isEmpty:e.length===0,error:{description:t(`We couldn't load video embeds. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:()=>void l()}]},empty:{icon:i,description:t(`This video has not been embedded on any pages yet.`,`jetpack-premium-analytics-pkg`)},children:(0,k.jsx)(D,{pages:e})})}return(0,k.jsx)(s,{className:T.root,children:(0,k.jsx)(`div`,{className:T.content,children:u})})}function O({attributes:e={}}){return(0,k.jsx)(l,{attributes:e,children:(0,k.jsx)(de,{})})}var k,A=e((()=>{f(),se(),n(),a(),u(),E(),k=r()})),j,fe=e((()=>{a(),j={icon:o}})),M,N,P,F,I,L,R,z=e((()=>{M=`jpa/video-detail-embeds`,N=`Used on posts & pages`,P=`Pages where the selected video is embedded, sourced from Jetpack Stats.`,F={content:`Lists every page on your site where the selected video is embedded, so you can see where it is being watched.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},I=`stats`,L=`framed`,R={name:M,title:N,description:P,help:F,category:I,presentation:L}}));function B(e,t=!1){return{...p(t,e),post_id:G}}function pe(){return(0,H.jsx)(O,{attributes:{reportParams:B()}})}function V(e){return(0,H.jsx)(O,{attributes:{reportParams:B(e)}})}function me(e){return(0,H.jsx)(ue,{...e,widgetType:le(R,j),renderModule:U,renderComponent:O,attributes:{reportParams:B(void 0,!0)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),ae(),ce(),h(),_(),A(),fe(),z(),H=r(),ie(),U=`storybook/video-detail-embeds`,W=`stats/video/`,G=105,K={title:`Packages/Premium Analytics/Widgets/VideoDetailEmbeds`,component:O,tags:[`autodocs`],parameters:{docs:{description:{component:"Dashboard widget listing the pages where a single video is embedded, sourced from the Jetpack Stats `stats/video/%d` module via `useStatsSingleVideo`. The widget is scoped to one video through the host-composed `reportParams.post_id`; without one it prompts to select a video. In Storybook the data is served by `registerReportMocks`."}}}},q={render:pe,decorators:[y]},J={render:()=>(0,H.jsx)(O,{attributes:{reportParams:p(!1)}}),decorators:[y]},Y={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(W,`loading`),()=>m(W,null))},X={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(W,`error`),()=>m(W,null))},Z={render:()=>V(`last-365-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(W,`empty`),()=>m(W,null))},Q={render:e=>(0,H.jsx)(me,{...e}),args:{...v},argTypes:{...g}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
