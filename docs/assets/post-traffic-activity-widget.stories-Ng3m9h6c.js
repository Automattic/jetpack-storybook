import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-yGZutq_9.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{t as i,y as a}from"./build-module-B1v_iyu9.js";import{Gu as o,Nu as s,t as c,wl as l}from"./build-module-zwSmKorH.js";import{St as u,X as ee,dn as d,mn as f,ot as te,t as p,x as m,y as h}from"./date-fns-CeH7Uo-X.js";import{Fn as g,W as _,b as ne,dt as v,g as y}from"./hooks-tH3pCjPa.js";import{i as b,r as x}from"./heatmap-chart-DClH-Flm.js";import{M as re,t as ie}from"./src-DFNM1k7F.js";import{Dn as ae,en as S,i as C,yt as w}from"./date-filters-panel-CK2D9yIi.js";import{n as oe}from"./use-element-size-XoXca_wq.js";import{r as se}from"./metric-sparkline-skeleton-K7u0iOi7.js";import{i as ce,o as le}from"./monthly-heatmap-BXi2smIh.js";import{i as T,r as ue,s as E}from"./register-report-mocks-yycxlQwG.js";import{t as de}from"./widget-state-DrTEtYvq.js";import{t as fe}from"./src-Dslj4W-S.js";import{a as pe,c as me,i as he,l as ge,n as _e,o as ve,r as D,s as ye}from"./with-widget-canvas-hIij5fvl.js";import{n as be,r as xe,t as Se}from"./with-site-locale-CVenMu6B.js";var O,k,A,j,M,N,P,Ce=e((()=>{O=`_root_1k3qu_3`,k=`_body_1k3qu_12`,A=`_content_1k3qu_3`,j=`_chartArea_1k3qu_29`,M=`_chartHost_1k3qu_43`,N=`_heatmap_1k3qu_50`,P={root:O,body:k,content:A,chartArea:j,chartHost:M,heatmap:N}}));function we(e,t,n){let{data:r,isLoading:i,isFetching:a,isError:s,refetch:c}=w({postId:e,fields:[`data`]}),[l,p]=(0,o.useState)(0);(0,o.useEffect)(()=>{p(0)},[t.from,t.to,n]);let g=v(t.from),_=v(t.to),{days:ne,isPaged:y,canShowOlder:b}=(0,o.useMemo)(()=>{if(!g||!_||g>_)return{days:[],isPaged:!1,canShowOlder:!1};let e=r?.data??[],t=new Map(e.map(e=>[e.date,e.views])),i=d(h(g),{weekStartsOn:1}),a=te(h(_),{weekStartsOn:1}),o=i<m(a,n-1),s=m(a,l*n),c=m(s,n-1);if(o&&c<i){c=i;let e=f(i,n-1);s=e<a?e:a}let p=h(_);return{days:u({start:c,end:p<s?p:s}).map(e=>{let n=ee(e,`yyyy-MM-dd`);return{dateString:n,value:(n>=g&&n<=_?t.get(n):void 0)||null}}),isPaged:o,canShowOlder:i<c}},[r,g,_,l,n]),x=(0,o.useCallback)(()=>{p(e=>b?e+1:e)},[b]),re=(0,o.useCallback)(()=>{p(e=>Math.max(0,e-1))},[]);return{days:ne,isPaged:y,canShowOlder:b,canShowNewer:l>0,showOlder:x,showNewer:re,isLoading:i,isFetching:a,isError:s,hasData:!!r,refetch:c}}var Te=e((()=>{C(),s(),p(),fe()}));function Ee(e){return e?g({availWidth:e,cellWidth:L,cellGap:4,minColumns:R}):ke}function De(e){return e?Math.max(B,Math.min(z,Math.floor((e-V)/7))):z}function Oe(){let{reportParams:e}=ne(),n=ae(e.post_id),[r,i]=(0,o.useState)(),s=a(e=>{let t=e[0]?.contentRect;if(t){let e=Math.round(t.width);i(t=>t===e?t:e)}}),{days:c,isPaged:l,canShowOlder:u,canShowNewer:ee,showOlder:d,showNewer:f,isLoading:te,isFetching:p,isError:m,refetch:h}=we(n,e,Ee(r)*7),[g,y]=oe(),ie=De(y.height),{data:S,rowLabels:C}=x(c),w=v(e.from),T=v(e.to),ue=(0,o.useCallback)(({value:e,cellLabel:n,row:r,column:i})=>{let a=c[i*7+r];return(0,I.jsx)(ce,{value:e,cellLabel:n,emptyLabel:a&&w&&T&&a.dateString>=w&&a.dateString<=T?t(`No views`,`jetpack-premium-analytics-pkg`):t(`No data`,`jetpack-premium-analytics-pkg`),formatValue:_})},[c,w,T]);return(0,I.jsx)(`div`,{ref:s,className:P.root,children:(0,I.jsx)(`div`,{className:P.body,children:(0,I.jsx)(de,{isLoading:te,isFetching:p,isError:m,isEmpty:n<=0||S.length===0,error:{description:t(`We couldn't load this traffic activity. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:h}]},empty:{icon:re,description:t(`Open a post or page report to see its traffic activity here.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,I.jsx)(se,{}),children:(0,I.jsx)(`div`,{className:P.content,children:(0,I.jsx)(`div`,{ref:g,className:P.chartArea,children:(0,I.jsx)(le,{pager:l?{canShowOlder:u,canShowNewer:ee,showOlder:d,showNewer:f}:void 0,className:P.chartHost,children:(0,I.jsx)(b,{data:S,rowLabels:C,primaryColor:`var(--wp-admin-theme-color, #3858e9)`,withTooltips:!0,maxCellWidth:64,maxCellHeight:ie,renderTooltip:ue,className:P.heatmap})})})})})})})}function F({attributes:e={}}){return(0,I.jsx)(y,{attributes:e,children:(0,I.jsx)(Oe,{})})}var I,L,R,ke,z,B,V,Ae=e((()=>{C(),ie(),fe(),i(),s(),n(),Ce(),Te(),I=r(),L=64,R=4,ke=16,z=42,B=8,V=44})),je,Me=e((()=>{c(),je={icon:l,attributes:[],example:{attributes:{}}}})),Ne,Pe,Fe,Ie,Le,Re,ze,Be=e((()=>{Ne=`jpa/post-traffic-activity`,Pe=`Traffic activity`,Fe=`Daily views for the post or page being viewed, as a calendar heatmap.`,Ie={content:`Daily views for the post or page being viewed, as a calendar heatmap.`},Le=`stats`,Re=`framed`,ze={name:Ne,title:Pe,description:Fe,help:Ie,category:Le,presentation:Re}}));function Ve({hasPostScope:e,preset:t},n=!1){return{reportParams:{...S(n,t),...e?{post_id:W}:{}}}}function H(e){return(0,U.jsx)(F,{attributes:Ve(e)})}function He({hasPostScope:e,preset:t,...n}){return(0,U.jsx)(ye,{...n,widgetType:he(ze,je),renderModule:Ue,renderComponent:F,attributes:Ve({hasPostScope:e,preset:t},!0)})}var U,W,Ue,G,We,K,q,J,Y,X,Z,Q,$;e((()=>{C(),ue(),me(),pe(),Se(),_e(),Ae(),Me(),Be(),U=r(),T(),W=779,Ue=`storybook/post-traffic-activity`,G=`stats/post/${W}`,We={title:`Packages/Premium Analytics/Widgets/PostTrafficActivity`,component:F,tags:[`autodocs`],decorators:[xe],argTypes:{...be,hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."},preset:{control:`select`,options:[`last-30-days`,`last-365-days`],description:`Dashboard date range used to exercise single-page and paged layouts.`}},parameters:{docs:{description:{component:`The "Traffic activity" widget: the scoped post's daily views over the dashboard date range as a calendar heatmap — the post detail Traffic view's activity card, replacing the legacy months table. Days without traffic stay blank cells, per the design, while the grid stays complete. Without a post scope the widget renders a scopeless empty state.`}}}},K={render:H,args:{hasPostScope:!0,preset:`last-30-days`},decorators:[D]},q={render:H,args:{hasPostScope:!0,preset:`last-365-days`},decorators:[D]},J={render:H,args:{hasPostScope:!1,preset:`last-30-days`},decorators:[D]},Y={render:H,args:{hasPostScope:!0,preset:`last-30-days`},tags:[`!autodocs`],decorators:[D],beforeEach:()=>(E(G,`loading`),()=>E(G,null))},X={render:H,args:{hasPostScope:!0,preset:`last-30-days`},tags:[`!autodocs`],decorators:[D],beforeEach:()=>(E(G,`error`),()=>E(G,null))},Z={render:H,args:{hasPostScope:!0,preset:`last-30-days`},tags:[`!autodocs`],decorators:[D],beforeEach:()=>(E(G,`empty`),()=>E(G,null))},Q={render:e=>(0,U.jsx)(He,{...e}),args:{...ve,widgetWidth:3,widgetHeight:2,hasPostScope:!0,preset:`last-30-days`},argTypes:{...ge,hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."},preset:{control:`select`,options:[`last-30-days`,`last-365-days`],description:`Dashboard date range used to exercise single-page and paged layouts.`}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
