import{n as e}from"./chunk-zsgVPwQN.js";import{Gn as t,Jm as n,Mm as r,Om as i,Wm as a,cm as o,jn as s,qm as c,t as l}from"./iframe-B17T4UF1.js";import{n as u,t as d}from"./layout-BKZbKW3q.js";var f=e((()=>{})),p,m,h,g=e((()=>{l(),o(),c(),u(),f(),p=a(),m=(e,t)=>{switch(e){case`fail_domain_forbidden`:case`fail_ip_forbidden`:case`fail_domain_tld`:case`fail_subdomain_wpcom`:case`siteurl_private_ip`:return n(`Your site host is on a private network. Sites can connect to WordPress.com only on public sites.`,`jetpack-connection-js`);case`connection_disabled`:return n(`This site has been suspended.`,`jetpack-connection-js`)}if(t)return i(n(`Unavailable in <a>Offline Mode</a>`,`jetpack-connection-js`),{a:(0,p.jsx)(`a`,{href:r(`jetpack-support-development-mode`),target:`_blank`,rel:`noopener noreferrer`})})},h=({title:e,images:r,children:i,assetBaseUrl:a,isLoading:o,buttonLabel:c,handleButtonClick:l,displayButtonError:u,errorCode:f,buttonIsLoading:h,loadingLabel:g,footer:_,isOfflineMode:v,logo:y})=>(0,p.jsx)(d,{title:e,assetBaseUrl:a,images:r,className:`jp-connection__connect-screen`+(o?` jp-connection__connect-screen__loading`:``),logo:y,children:(0,p.jsxs)(`div`,{className:`jp-connection__connect-screen__content`,children:[i,(0,p.jsx)(`div`,{className:`jp-connection__connect-screen__tos`,children:(0,p.jsx)(s,{agreeButtonLabel:c})}),(0,p.jsx)(t,{label:c,onClick:l,displayError:u||v,errorMessage:m(f,v),isLoading:h,isDisabled:v}),(0,p.jsx)(`span`,{className:`jp-connection__connect-screen__loading-message`,role:`status`,children:h?g||n(`Loading`,`jetpack-connection-js`):``}),_&&(0,p.jsx)(`div`,{className:`jp-connection__connect-screen__footer`,children:_})]})})})),_,v,y,b,x,S,C,w,T,E;e((()=>{g(),_=a(),{action:v}=__STORYBOOK_MODULE_ACTIONS__,y={title:`JS Packages/Connection/Connect Screen`,component:h},b=e=>(0,_.jsxs)(h,{...e,children:[(0,_.jsx)(`p`,{children:`Secure and speed up your site for free with Jetpack's powerful WordPress tools`}),(0,_.jsxs)(`ul`,{children:[(0,_.jsx)(`li`,{children:`Speed up your site with optimized images`}),(0,_.jsx)(`li`,{children:`Protect your site against bot attacks`}),(0,_.jsx)(`li`,{children:`Get notifications if your site goes offline`}),(0,_.jsx)(`li`,{children:`Enhance your site with dozens of other features`})]})]}),x={buttonIsLoading:!1,buttonLabel:`Set up Jetpack`,displayButtonError:!1,handleButtonClick:v(`onButtonClick`),title:`Over 5 million WordPress sites are faster and more secure`,assetBaseUrl:`/`,images:[`connect-right.png`]},S=b.bind({}),S.args=x,C=b.bind({}),C.args={...x,buttonIsLoading:!0},w=b.bind({}),w.args={...x,displayButtonError:!0},T=b.bind({}),T.args={...x,footer:(0,_.jsx)(`div`,{children:`Hi I'm a Footer`})},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`props => <ConnectScreenVisual {...props}>
