import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as ee,t as i}from"./build-module-CbwHEf9N.js";import{Dc as a,Wr as o,n as s}from"./build-module-CDRs4YxF.js";import{lr as c,t as l}from"./src-OIjaQk1N.js";import{E as te,J as u,K as d,P as ne,Y as re,nt as ie,w as ae}from"./report-metric-DvbymNiD.js";import{$ as oe,Dt as f,_r as p,an as m,h as se,v as ce}from"./chart-tooltip-JHv3HFje.js";import{t as le}from"./leaderboard-chart-98BYhS9Q.js";import{t as h}from"./widget-state-DIziXein.js";import{C as g,D as _,E as v,O as y,S as b,T as x,b as S,k as C,t as ue,w as de,x as w}from"./src-B1MCLR9S.js";var T,E,D,fe=e((()=>{T=`_root_1hs5m_1`,E=`_content_1hs5m_11`,D={root:T,content:E}}));function O({max:e}){let{rows:n,isLoading:r,isFetching:i,isError:o,error:s,refetch:l}=m({group:`authors`,max:e}),u=(0,ee.useMemo)(()=>{let e=Math.max(...n.map(e=>e.value),0);return n.map(t=>({id:t.id,...ne({label:t.label,media:{kind:`avatar`,url:t.avatarUrl,name:t.label},action:t.link?{kind:`link`,href:t.link}:{kind:`static`}}),currentValue:t.value,currentShare:oe(t.value,e)}))},[n]);return(0,A.jsxs)(c,{className:D.root,children:[(0,A.jsx)(`div`,{className:D.content,children:(0,A.jsx)(h,{isLoading:r,isFetching:i,isError:o,isEmpty:n.length===0,error:se(s,{retryDescription:t(`We couldn't load comment authors. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:l}),empty:{icon:a,description:t(`No one has commented on your site yet.`,`jetpack-premium-analytics-pkg`)},children:(0,A.jsx)(le,{data:u,withOverlayLabel:!0,showLegend:!1,dataFormat:j})})}),(0,A.jsx)(te,{children:(0,A.jsx)(ae,{report:`comments`,section:`authors`,ariaLabel:t(`See the comment authors report`,`jetpack-premium-analytics-pkg`)})})]})}function k({attributes:e={}}){return(0,A.jsx)(ie,{attributes:e,children:(0,A.jsx)(O,{max:ce(e.max,M)})})}var A,j,M,N=e((()=>{f(),ue(),i(),n(),s(),l(),fe(),A=r(),j={type:`number`,options:{useMultipliers:!0,decimals:0}},M=10})),P,F=e((()=>{n(),s(),P={icon:o,attributes:[{id:`max`,label:t(`Number of results`,`jetpack-premium-analytics-pkg`),type:`integer`}],example:{attributes:{max:10}}}})),I,L,R,z,B,V,H,pe=e((()=>{I=`jpa/most-commented-authors`,L=`Top commented authors`,R=`The people who comment the most on your site.`,z={content:`Your most active commenters, ranked by the number of comments they have left.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},B=`stats`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function U(){return(0,W.jsx)(k,{attributes:{reportParams:p()}})}function me(e){return(0,W.jsx)(x,{...e,widgetType:b(H,P),renderModule:G,renderComponent:k,attributes:{reportParams:p(!0)}})}var W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),v(),g(),y(),S(),u(),N(),F(),pe(),W=r(),re(),G=`storybook/most-commented-authors`,K={title:`Packages/Premium Analytics/Widgets/MostCommentedAuthors`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:`The "Top commented authors" widget. Ranks the people who comment most on the site by comment count, linking each guest commenter to the comment management screen filtered to them. One half of the Jetpack Stats Comments module; "Top commented posts" covers the other.`}}}},q={render:U,decorators:[w,C]},J={render:U,tags:[`!autodocs`],decorators:[w,C],beforeEach:d(`loading`)},Y={render:U,tags:[`!autodocs`],decorators:[w,C],beforeEach:d(`error`)},X={render:U,tags:[`!autodocs`],decorators:[w,C],beforeEach:d(`error-retryable`)},Z={render:U,tags:[`!autodocs`],decorators:[w,C],beforeEach:d(`empty`)},Q={render:e=>(0,W.jsx)(me,{...e}),args:{...de},argTypes:{..._},decorators:[C]},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
