import{i as e}from"./preload-helper-usAeo7Bx.js";import{c as t,n,t as r}from"./build-module-Da_5_6n_.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{An as a,n as o}from"./build-module-C3k6FW0l.js";import{Ot as s,nn as c,t as l}from"./build-module-CgLlJIuz.js";import{Ct as u,b as d,f,s as p}from"./hooks-C_SpG7ct.js";import{i as m}from"./metric-tabs-chart-BpSzNmyd.js";import{n as h,t as g}from"./register-report-mocks-XdkLFX6G.js";import{i as _,n as v,r as y,t as b}from"./widget-dashboard-with-widget-CII2OBVb.js";import{t as x}from"./src-B_OqB7EC.js";var S,C,w,T,E,D,O=e((()=>{S=`_root_11sgc_1`,C=`_label_11sgc_6`,w=`_value_11sgc_10`,T=`_caption_11sgc_14`,E=`_placeholder_11sgc_18`,D={root:S,label:C,value:w,caption:T,placeholder:E}}));function k({label:e,value:r,percent:i}){return(0,M.jsxs)(s,{direction:`column`,gap:`xs`,children:[(0,M.jsx)(c,{variant:`heading-md`,render:(0,M.jsx)(`h4`,{}),className:D.label,children:e}),(0,M.jsx)(c,{variant:`heading-2xl`,className:D.value,children:r}),(0,M.jsx)(c,{variant:`body-md`,className:D.caption,children:t(n(`%d%% of views`,`jetpack-premium-analytics`),i)})]})}function A(){let{data:e,isLoading:t,isError:r}=d(),i=e;return r?(0,M.jsx)(c,{className:D.placeholder,children:n(`Unable to load insights.`,`jetpack-premium-analytics`)}):t&&!i?.hour?(0,M.jsx)(m,{}):!i?.day||!i?.hour?(0,M.jsx)(c,{className:D.placeholder,children:n(`Not enough data to determine your most popular time yet.`,`jetpack-premium-analytics`)}):(0,M.jsxs)(s,{className:D.root,direction:`column`,gap:`lg`,children:[(0,M.jsx)(k,{label:n(`Best day`,`jetpack-premium-analytics`),value:i.day,percent:i.percent??0}),(0,M.jsx)(k,{label:n(`Best hour`,`jetpack-premium-analytics`),value:i.hour,percent:i.hourPercent??0})]})}function j({attributes:e={}}){return(0,M.jsx)(p,{attributes:e,children:(0,M.jsx)(A,{})})}var M,N=e((()=>{f(),x(),r(),l(),O(),M=i()})),P,F=e((()=>{r(),o(),P={name:`jpa/most-popular-time`,title:n(`Most popular time`,`jetpack-premium-analytics`),icon:a}}));function I({withComparison:e}){return(0,R.jsx)(j,{attributes:{reportParams:u(e)}})}function L({withComparison:e,...t}){return(0,R.jsx)(v,{...t,widgetType:{name:P.name,title:P.title,icon:P.icon,presentation:`framed`},renderModule:z,renderComponent:j,attributes:{reportParams:u(e)}})}var R,z,B,V,H,U,W,G;e((()=>{f(),g(),y(),N(),F(),R=i(),h(),z=`storybook/most-popular-time`,B=e=>(0,R.jsx)(`div`,{style:{width:`100%`,height:`360px`},children:(0,R.jsx)(e,{})}),V={title:`Packages/Premium Analytics/Widgets/MostPopularTime`,component:j,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`}},parameters:{docs:{description:{component:`The "Most popular time" widget. Shows the day of week and hour of day that draw the most views, each with its share of the total. The insights endpoint reports across the whole lifetime of the site, so there is no date range or comparison period.`}}}},H={render:I,args:{withComparison:!1},decorators:[B]},U={render:I,args:{withComparison:!0},decorators:[B],parameters:{docs:{description:{story:`The insights endpoint has no comparison period, so this renders identically to Default even when comparison report params are supplied.`}}}},W={render:e=>(0,R.jsx)(L,{...e}),args:{...b,withComparison:!0},argTypes:{..._,withComparison:{control:`boolean`}}},H.parameters={...H.parameters,docs:{...H.parameters?.docs,source:{originalSource:`{
