...
`})}),`
`,(0,c.jsxs)(t.p,{children:[`The default line color, used when the `,(0,c.jsx)(t.code,{children:`color`}),` prop is not provided, is the first series palette color — set in CSS as `,(0,c.jsx)(t.code,{children:`--a8c-charts-color-series-1`}),`, not through the theme object.`]}),`
`,(0,c.jsxs)(t.p,{children:[`The gradient's default `,(0,c.jsx)(t.code,{children:`to`}),` color is `,(0,c.jsx)(t.code,{children:`--a8c-charts-color-background`}),`, declared in CSS the same way.`]}),`
