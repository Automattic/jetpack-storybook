import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{n as i,o as a}from"./build-module-DmVuor49.js";import{W as o,g as s,t as c}from"./build-module-LU_6Qj-1.js";import{Xn as l,ft as ee,ut as u}from"./chart-tooltip-Cq5jhKaK.js";import{t as d}from"./chart-empty-state-y6x-YAUC.js";import{C as f,N as p,S as m,T as h,k as g}from"./report-metric-DM2LTy4R.js";import{t as _}from"./widget-state-Cc04oFW3.js";import{C as v,S as y,T as b,b as te,t as ne,w as x,x as S}from"./src-LAPZU3wC.js";var C,w,T,E,D,O,k=e((()=>{C=`_root_p2q2t_1`,w=`_content_p2q2t_11`,T=`_list_p2q2t_24`,E=`_item_p2q2t_32`,D=`_link_p2q2t_41`,O={root:C,content:w,list:T,item:E,link:D}}));function A(e){let t=typeof e==`number`?e:Number.parseInt(e??``,10);return Number.isInteger(t)&&t>0?t:NaN}function j({pages:e}){return(0,P.jsx)(`ul`,{className:O.list,children:e.map((e,t)=>(0,P.jsx)(`li`,{className:O.item,children:(0,P.jsx)(s,{className:O.link,href:e.link,variant:`unstyled`,openInNewTab:!0,title:e.label,children:e.label})},`${t}-${e.link}`))})}function M(){let{reportParams:e}=p(),n=A(e.post_id),{data:r,isLoading:i,isFetching:s,isError:c,refetch:l}=ee(n,e),u;if(!Number.isInteger(n))u=(0,P.jsx)(d,{icon:a,text:t(`Select a video to see where it is embedded across your site.`,`jetpack-premium-analytics`)});else{let e=r?.pages??[];u=(0,P.jsx)(_,{isLoading:i,isFetching:s,isError:e.length===0&&c,isEmpty:e.length===0,error:{description:t(`We couldn't load video embeds. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:()=>void l()}]},empty:{icon:a,description:t(`This video has not been embedded on any pages yet.`,`jetpack-premium-analytics`)},children:(0,P.jsx)(j,{pages:e})})}return(0,P.jsx)(o,{className:O.root,children:(0,P.jsx)(`div`,{className:O.content,children:u})})}function N({attributes:e={}}){return(0,P.jsx)(g,{attributes:e,children:(0,P.jsx)(M,{})})}var P,F=e((()=>{u(),ne(),n(),i(),c(),k(),P=r()})),I,L=e((()=>{n(),i(),I={name:`jpa/video-detail-embeds`,title:t(`Video embeds`,`jetpack-premium-analytics`),help:{content:t(`Lists every page on your site where the selected video is embedded, so you can see where it is being watched.`,`jetpack-premium-analytics`),links:[{label:t(`Learn more`,`jetpack-premium-analytics`),href:`https://jetpack.com/support/jetpack-stats/`}]},icon:a}}));function R(e,t=!1){return{...l(t,e),post_id:G}}function z(){return(0,H.jsx)(N,{attributes:{reportParams:R()}})}function B(e){return(0,H.jsx)(N,{attributes:{reportParams:R(e)}})}function V(e){return(0,H.jsx)(v,{...e,widgetType:I,renderModule:U,renderComponent:N,attributes:{reportParams:R(void 0,!0)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{u(),m(),x(),te(),F(),L(),H=r(),f(),U=`storybook/video-detail-embeds`,W=`stats/video/`,G=105,K={title:`Packages/Premium Analytics/Widgets/VideoDetailEmbeds`,component:N,tags:[`autodocs`],parameters:{docs:{description:{component:"Dashboard widget listing the pages where a single video is embedded, sourced from the Jetpack Stats `stats/video/%d` module via `useStatsSingleVideo`. The widget is scoped to one video through the host-composed `reportParams.post_id`; without one it prompts to select a video. In Storybook the data is served by `registerReportMocks`."}}}},q={render:z,decorators:[S]},J={render:()=>(0,H.jsx)(N,{attributes:{reportParams:l(!1)}}),decorators:[S]},Y={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(h(W,`loading`),()=>h(W,null))},X={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(h(W,`error`),()=>h(W,null))},Z={render:()=>B(`last-365-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(h(W,`empty`),()=>h(W,null))},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...y},argTypes:{...b}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
