import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Nn as i,n as a}from"./build-module-DmVuor49.js";import{R as o,W as s,t as c}from"./build-module-Oq2YRM6F.js";import{C as l,t as u}from"./src-B3le4dug.js";import{G as d,K as f,Or as p,Pt as m,b as h,cr as g,yt as _}from"./chart-tooltip-BtX3Jjce.js";import{t as ee}from"./leaderboard-chart-6vbiAia1.js";import{M as v,N as y,U as te,z as b}from"./report-metric-CWPPaMwH.js";import{t as ne}from"./widget-state-CE3oTs97.js";import{C as re,S as ie,T as ae,b as x,t as S,w as oe,x as C}from"./src-BAp3Kd5h.js";import{n as w,t as T}from"./src-wxObwIP2.js";import{n as se,t as ce}from"./register-stats-mocks-DGkfWl-d.js";import{n as le,t as E}from"./force-stats-mock-state-me5gilGe.js";var D,O,k,A,ue=e((()=>{D=`_root_al0b4_1`,O=`_content_al0b4_9`,k=`_itemLabel_al0b4_17`,A={root:D,content:O,itemLabel:k}}));function de(e,t){let n=String(e.label??``);return{key:n,label:h(n,t===`browser`?j:M),views:e.value,previousViews:e.previousValue}}function fe({reportParams:e,max:t,deviceProperty:n}){let{comparisonRows:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:l}=m({...e,deviceProperty:n},{maxRows:t}),u=p(c),d=(r?.rows??[]).map(e=>de(e,n));return{data:d,hasComparison:i,isLoading:a,isFetching:o,isError:d.length===0&&s,errorReason:u,refetch:l}}var j,M,pe=e((()=>{n(),_(),S(),j={chrome:t(`Chrome`,`jetpack-premium-analytics`),safari:t(`Safari`,`jetpack-premium-analytics`),firefox:t(`Firefox`,`jetpack-premium-analytics`),edge:t(`Edge`,`jetpack-premium-analytics`),opera:t(`Opera`,`jetpack-premium-analytics`),samsung:t(`Samsung Internet`,`jetpack-premium-analytics`),ie:t(`IE`,`jetpack-premium-analytics`),yandex:t(`Yandex`,`jetpack-premium-analytics`),miui:t(`Mi Browser`,`jetpack-premium-analytics`),other:t(`Other`,`jetpack-premium-analytics`)},M={windows:t(`Windows`,`jetpack-premium-analytics`),mac:t(`macOS`,`jetpack-premium-analytics`),android:t(`Android`,`jetpack-premium-analytics`),linux:t(`Linux`,`jetpack-premium-analytics`),ios:t(`iOS`,`jetpack-premium-analytics`),ipad:t(`iPad`,`jetpack-premium-analytics`),iphone:t(`iPhone`,`jetpack-premium-analytics`),ipados:t(`iPadOS`,`jetpack-premium-analytics`),macos:t(`macOS`,`jetpack-premium-analytics`),chrome:t(`Chrome OS`,`jetpack-premium-analytics`),android_tablet:t(`Android Tablet`,`jetpack-premium-analytics`),other:t(`Other`,`jetpack-premium-analytics`)}}));function me({max:e,platformDimension:n}){let{reportParams:r}=te(),{data:i,hasComparison:a,isLoading:c,isFetching:u,isError:p,errorReason:m,refetch:h}=fe({reportParams:r,max:e,deviceProperty:n}),g=Math.max(...i.map(e=>e.views),0),_=Math.max(...i.map(e=>e.previousViews??0),0),v=a,y=i.map((e,t)=>{let n=e.previousViews;return{id:`${t}-${e.key}`,label:(0,P.jsx)(o,{align:`center`,className:A.itemLabel,children:(0,P.jsx)(s,{children:e.label})}),currentValue:e.views,currentShare:d(e.views,g),previousValue:n,previousShare:v&&n!==void 0?d(n,_):void 0,delta:v&&n!==void 0?f(e.views,n):void 0}}),b=m===`upgrade-required`;return(0,P.jsx)(`div`,{className:A.content,children:(0,P.jsx)(ne,{isLoading:c,isFetching:u,isError:p,isEmpty:i.length===0,error:{description:t(b?`Platform stats are not included in your current plan.`:`We couldn't load platform data. Please try again in a moment.`,`jetpack-premium-analytics`),actions:b?void 0:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:h}]},empty:{icon:l,description:t(`No platform data in this period.`,`jetpack-premium-analytics`)},children:(0,P.jsx)(ee,{data:y,withComparison:a,withOverlayLabel:!0,showLegend:!1,dataFormat:F})})})}function N({attributes:e}){let t=e?.max??10,n=e?.platformDimension??`browser`;return(0,P.jsx)(b,{attributes:e,children:(0,P.jsx)(`div`,{className:A.root,children:(0,P.jsx)(me,{max:t,platformDimension:n})})})}var P,F,I=e((()=>{u(),n(),c(),S(),ue(),pe(),P=r(),F={type:`number`,options:{useMultipliers:!0,decimals:0}}})),L,R=e((()=>{n(),a(),T(),L={name:`jpa/top-platforms`,title:t(`Top Platforms`,`jetpack-premium-analytics`),help:{content:t(`A breakdown of the operating systems and browsers your visitors used, sorted by views.`,`jetpack-premium-analytics`),links:[{label:t(`Learn more`,`jetpack-premium-analytics`),href:`https://jetpack.com/support/jetpack-stats/`}]},icon:i,attributes:[{id:`max`,label:t(`Max rows`,`jetpack-premium-analytics`),type:`number`},{id:`platformDimension`,label:t(`View by`,`jetpack-premium-analytics`),type:`text`,Edit:w,elements:[{label:t(`Browser`,`jetpack-premium-analytics`),value:`browser`},{label:t(`OS`,`jetpack-premium-analytics`),value:`platform`}],relevance:`high`}],example:{attributes:{max:10,platformDimension:`browser`}}}}));function z({withComparison:e,platformDimension:t}){return{max:10,platformDimension:t,reportParams:g(e)}}function B(e){return(0,H.jsx)(N,{attributes:z(e)})}function V(e){return(0,H.jsx)(N,{attributes:{max:10,platformDimension:`browser`,reportParams:g(!1,e)}})}function he(e){return(0,H.jsx)(N,{...e})}function ge({withComparison:e,platformDimension:t,...n}){return(0,H.jsx)(re,{...n,widgetType:W,renderModule:U,renderComponent:he,attributes:z({withComparison:e,platformDimension:t})})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{_(),oe(),x(),v(),ce(),le(),I(),R(),H=r(),y(),se(),U=`storybook/top-platforms`,W={name:L.name,title:L.title,icon:L.icon,attributes:L.attributes,example:L.example,presentation:`framed`},G={title:`Packages/Premium Analytics/Widgets/TopPlatforms`,component:N,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},platformDimension:{control:`radio`,options:[`browser`,`platform`],description:`The "View by" toolbar attribute rendered by the widget host.`}},parameters:{docs:{description:{component:"The \"Top Platforms\" widget. Shows browser and OS breakdown as a ranked leaderboard. The active dimension is the `platformDimension` attribute (`relevance: 'high'`), exposed as a control by the widget host."}}}},K={render:B,args:{withComparison:!1,platformDimension:`browser`},decorators:[C]},q={render:B,args:{withComparison:!0,platformDimension:`browser`},decorators:[C]},J={render:B,args:{withComparison:!1,platformDimension:`platform`},decorators:[C]},Y={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(E(`stats/devices`,`loading`),()=>E(`stats/devices`,null))},X={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(E(`stats/devices`,`error`),()=>E(`stats/devices`,null))},Z={render:()=>V(`last-365-days`),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(E(`stats/devices`,`empty`),()=>E(`stats/devices`,null))},Q={render:e=>(0,H.jsx)(ge,{...e}),args:{...ie,withComparison:!0,platformDimension:`browser`},argTypes:{...ae,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},platformDimension:{control:`radio`,options:[`browser`,`platform`],description:`The "View by" toolbar attribute rendered by the widget host.`}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
