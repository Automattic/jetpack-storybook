import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-Da_5_6n_.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{n as o,w as s}from"./build-module-DmVuor49.js";import{n as c,r as l}from"./line-chart-Csm4PlcD.js";import{c as u,t as d}from"./src-DN9VFS2M.js";import{$ as ee,$n as f,An as te,In as ne,Jn as re,Rn as ie,ct as ae,ot as p,ut as m}from"./chart-tooltip-C4NUtjXe.js";import{t as h}from"./metric-tabs-chart-B8EjErm6.js";import{D as g,F as oe,T as _,j as v,w as y}from"./report-metric-DerWADBf.js";import{t as se}from"./widget-state-B76seV2w.js";import{C as b,S as x,T as S,b as C,t as w,w as T,x as E}from"./src-0WK5HJj0.js";import{i as D,t as ce}from"./src-Dh4_FIP6.js";var O,k,A=t((()=>{i(),O=[{id:`net-sales`,label:r(`Net sales`,`jetpack-premium-analytics`),description:r(`Monitor your total revenue — after any discounts, returns, or adjustments — over a set period of time.`,`jetpack-premium-analytics`),metricType:`general`,metricKey:`orders_value_net`},{id:`orders`,label:r(`Orders`,`jetpack-premium-analytics`),description:r(`See a breakdown of when orders are placed to identify peak selling periods.`,`jetpack-premium-analytics`),metricType:`general`,metricKey:`orders_no`},{id:`bookings`,label:r(`Bookings`,`jetpack-premium-analytics`),description:r(`See a breakdown of when bookings are placed to identify peak selling periods.`,`jetpack-premium-analytics`),metricType:`booking`,metricKey:`orders_no`},{id:`visitors`,label:r(`Visitors`,`jetpack-premium-analytics`),description:r(`Track website visitor trends and monitor traffic patterns over time.`,`jetpack-premium-analytics`),metricType:`visitors`,metricKey:`visitors`},{id:`conversion-rate`,label:r(`Store conversion rate`,`jetpack-premium-analytics`),description:r(`Track your store's conversion funnel from sessions to completed orders.`,`jetpack-premium-analytics`),metricType:`conversion`,metricKey:`conversion_rate`},{id:`customers`,label:r(`Customers`,`jetpack-premium-analytics`),description:r(`Track the total number of customers (new and returning) who placed orders during the selected time period.`,`jetpack-premium-analytics`),metricType:`customers`,metricKey:`customers`}],k=O.map(e=>e.id)})),le,ue,de=t((()=>{le=`_widgetRoot_8wi56_1`,ue={widgetRoot:le}}));function fe(){return{summary:{date_start:``,date_end:``,total_sales:0,orders_no:0,avg_items:0,average_order_value:0,orders_value_net:0,orders_value_gross:0,product_net_revenue:0,profit_margin:0,cogs_amount:0,coupons:0,refunds:0,paid_orders_count:0,paid_net_sales:0,unpaid_orders_count:0,unpaid_net_sales:0},data:[]}}function pe(){return{summary:{date_start:``,date_end:``,active_sessions:0,visitors:0},data:[]}}function me(){return{summary:{date_start:``,date_end:``,active_sessions:0,visitors:0,with_cart_addition:0,reached_checkout:0,completed_checkout:0,conversion_rate:0},data:[],steps:[],overallRate:0}}function j(){return{summary:{total_net_sales:0,total_gross_sales:0,total_discounts:0,total_refunds:0,total_orders:0,total_average_order_value:0,total_avg_items_per_order:0,total_customers:0,new_customers:0,returning_customers:0,new_customer_sales:0,new_customer_gross_sales:0,new_customer_discounts:0,new_customer_refunds:0,new_customer_orders:0,new_customer_avg_order_value:0,new_customer_avg_items_per_order:0,returning_customer_sales:0,returning_customer_gross_sales:0,returning_customer_discounts:0,returning_customer_refunds:0,returning_customer_orders:0,returning_customer_avg_order_value:0,returning_customer_avg_items_per_order:0,date_start:``,date_end:``,customers:0},data:[]}}function he(e,t){if(e.metricType===`visitors`)return p({primary:t.visitors.primary.data??pe(),comparison:t.visitors.comparison.data??pe(),metricKey:e.metricKey,emptyDataFallback:`empty-array`});if(e.metricType===`conversion`)return p({primary:t.conversion.primary.data??me(),comparison:t.conversion.comparison.data??me(),metricKey:e.metricKey,emptyDataFallback:`empty-array`});if(e.metricType===`customers`)return p({primary:t.customers.primary.data??j(),comparison:t.customers.comparison.data??j(),metricKey:e.metricKey,emptyDataFallback:`empty-array`});let n=e.metricType===`booking`?t.booking:t.general;return p({primary:n.primary.data??fe(),comparison:n.comparison.data??fe(),metricKey:e.metricKey,emptyDataFallback:`empty-array`})}function ge({metricIds:e=k}){let{reportParams:t}=oe(),n=(0,N.useMemo)(()=>{let t=new Set(e);return O.filter(e=>t.has(e.id))},[e]),i=(0,N.useMemo)(()=>new Set(n.map(e=>e.metricType)),[n]),a=re(t,{enabled:i.has(`general`)}),{primary:o,comparison:c}=a,l=re({...t,filters:[ee]},{enabled:i.has(`booking`)}),{primary:u,comparison:d}=l,f=te(t,{enabled:i.has(`visitors`)}),{primary:p,comparison:m}=f,g=ne(t,{enabled:i.has(`conversion`)}),{primary:_,comparison:v}=g,y=ie(t,{enabled:i.has(`customers`)}),{primary:b,comparison:x}=y,S=(0,N.useMemo)(()=>[i.has(`general`)?a:null,i.has(`booking`)?l:null,i.has(`visitors`)?f:null,i.has(`conversion`)?g:null,i.has(`customers`)?y:null].filter(e=>e!==null),[i,a,l,f,g,y]),C=S.some(e=>e.isError&&!e.hasData),w=(0,N.useCallback)(()=>Promise.all(S.map(e=>e.refetch())),[S]),T=(0,N.useMemo)(()=>n.map(e=>{let[t,n]=e.metricType===`booking`?[u.data?.summary??{},d.data?.summary??{}]:e.metricType===`visitors`?[p.data?.summary??{},m.data?.summary??{}]:e.metricType===`conversion`?[_.data?.summary??{},v.data?.summary??{}]:e.metricType===`customers`?[b.data?.summary??{},x.data?.summary??{}]:[o.data?.summary??{},c.data?.summary??{}];return{...e,primary:Number(t[e.metricKey]??0),comparison:n[e.metricKey]===void 0?null:Number(n[e.metricKey])}}),[n,u.data,d.data,p.data,m.data,_.data,v.data,b.data,x.data,o.data,c.data]),E=(0,N.useMemo)(()=>({general:{primary:o,comparison:c},booking:{primary:u,comparison:d},visitors:{primary:p,comparison:m},conversion:{primary:_,comparison:v},customers:{primary:b,comparison:x}}),[o,c,u,d,p,m,_,v,b,x]),D=(0,N.useMemo)(()=>T.map(e=>{let t=he(e,E);return{key:e.id,label:e.label,value:e.primary,previousValue:e.comparison,current:t[0]?.data??[],previous:t[1]?.data,dataFormat:ae(e.metricKey),description:e.description}}),[T,E]),ce=S.some(e=>e.isLoading&&!e.hasData),A=S.some(e=>e.isFetching);return(0,P.jsx)(`div`,{className:ue.widgetRoot,children:(0,P.jsx)(se,{isLoading:ce,isError:C,isEmpty:!D.length,error:{description:r(`We couldn't load store performance data. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:r(`Retry`,`jetpack-premium-analytics`),onClick:w}]},empty:{icon:s,description:r(`No metric selected. Please select a metric from the metrics list.`,`jetpack-premium-analytics`)},renderLoading:(0,P.jsx)(h,{metrics:D,dataFormat:F,loading:!0,groupLabel:r(`Store metric`,`jetpack-premium-analytics`)}),children:(0,P.jsx)(h,{metrics:D,dataFormat:F,loading:A,groupLabel:r(`Store metric`,`jetpack-premium-analytics`)})})})}function M({attributes:e={}}){return(0,P.jsx)(v,{attributes:e,options:{from:`/`},children:(0,P.jsx)(ge,{metricIds:e.metrics})})}var N,P,F,_e=t((()=>{m(),w(),i(),o(),N=e(n(),1),A(),de(),P=a(),F={type:`number`,options:{useMultipliers:!0,decimals:0}}})),I,ve=t((()=>{i(),o(),ce(),A(),I={name:`jpa/store-performance`,title:r(`Store performance`,`jetpack-premium-analytics`),help:{content:r(`Shows key store performance metrics at a glance.`,`jetpack-premium-analytics`)},icon:s,attributes:[{id:`metrics`,label:r(`Metrics`,`jetpack-premium-analytics`),type:`array`,relevance:`high`,Edit:D,elements:O.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:k}}}}));function L({withComparison:e=!1,preset:t=U,metrics:n=k}){return{reportParams:f(e,t),metrics:n}}function ye({withComparison:e,preset:t}){let n=!!e,r=t??U;return!n&&r===U?`getDefaultQueryParams()`:n&&r===U?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function R(e=k){return`[ ${e.map(e=>`'${e}'`).join(`, `)} ]`}function z(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
