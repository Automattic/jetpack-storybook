import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as i,t as a}from"./build-module-CbwHEf9N.js";import{t as o,y as s}from"./build-module-BShXUI3N.js";import{Zc as c,n as l,tl as u,xl as d}from"./build-module-CDRs4YxF.js";import{C as f,Et as ee,T as p,bn as m,et as h,hn as g,t as _,ut as te}from"./date-fns-Bm9dQUxr.js";import{sn as v,t as y,yn as b}from"./src-cwJFza-O.js";import{J as x,at as S,j as ne,q as re,tt as C}from"./report-metric-DGboxC5_.js";import{n as ie,o as ae}from"./heatmap-chart-k-1lcfRP.js";import{M as oe,t as w}from"./src-BKLK-O8P.js";import{o as se}from"./calendar-heatmap-window-BM8EG75J.js";import{Cr as ce,Hn as le,Nt as T,Ur as ue,r as de,v as E}from"./chart-tooltip-B4z7ZybC.js";import{t as fe}from"./widget-state-Dwhwd2v1.js";import{C as pe,D as me,E as he,S as ge,T as _e,b as ve,t as D,w as ye,x as O}from"./src-914kMeCc.js";var k,A,j,M,N,P,be=e((()=>{k=`_root_1uv97_4`,A=`_pager_1uv97_11`,j=`_body_1uv97_23`,M=`_content_1uv97_28`,N=`_heatmap_1uv97_44`,P={root:k,pager:A,body:j,content:M,heatmap:N}}));function xe(e,t,n){let{data:r,isLoading:a,isFetching:o,isError:s,refetch:c}=le({postId:e,fields:[`data`]}),[l,u]=(0,i.useState)(0);(0,i.useEffect)(()=>{u(0)},[t.from,t.to,n]);let d=E(t.from),_=E(t.to),{days:v,isPaged:y,canShowOlder:b}=(0,i.useMemo)(()=>{if(!d||!_||d>_)return{days:[],isPaged:!1,canShowOlder:!1};let e=r?.data??[],t=new Map(e.map(e=>[e.date,e.views])),i=g(f(d),{weekStartsOn:1}),a=te(f(_),{weekStartsOn:1}),o=i<p(a,n-1),s=p(a,l*n),c=p(s,n-1);if(o&&c<i){c=i;let e=m(i,n-1);s=e<a?e:a}let u=f(_);return{days:ee({start:c,end:u<s?u:s}).map(e=>{let n=h(e,`yyyy-MM-dd`);return{dateString:n,value:(n>=d&&n<=_?t.get(n):void 0)||null}}),isPaged:o,canShowOlder:i<c}},[r,d,_,l,n]),x=(0,i.useCallback)(()=>{u(e=>b?e+1:e)},[b]),S=(0,i.useCallback)(()=>{u(e=>Math.max(0,e-1))},[]);return{days:v,isPaged:y,canShowOlder:b,canShowNewer:l>0,showOlder:x,showNewer:S,isLoading:a,isFetching:o,isError:s,hasData:!!r,refetch:c}}var Se=e((()=>{T(),a(),_(),D()}));function Ce(e){return e?se({availWidth:e,cellWidth:L,cellGap:R,minColumns:z}):B}function we(){let{reportParams:e}=S(),n=ue(e.post_id),[r,a]=(0,i.useState)(),o=s(e=>{let t=e[0]?.contentRect;if(t){let e=Math.round(t.width);a(t=>t===e?t:e)}}),{days:l,isPaged:d,canShowOlder:f,canShowNewer:ee,showOlder:p,showNewer:m,isLoading:h,isFetching:g,isError:_,hasData:te,refetch:y}=xe(n,e,Ce(r)*7),{data:x,rowLabels:re}=(0,i.useMemo)(()=>ae(l),[l]),C=E(e.from),w=E(e.to),se=(0,i.useCallback)(({value:e,cellLabel:n,row:r,column:i})=>{let a=l[i*7+r];return(0,I.jsx)(ne,{value:e,cellLabel:n,emptyLabel:a&&C&&w&&a.dateString>=C&&a.dateString<=w?t(`No views`,`jetpack-premium-analytics-pkg`):t(`No data`,`jetpack-premium-analytics-pkg`),formatValue:de})},[l,C,w]);return(0,I.jsx)(`div`,{ref:o,className:P.root,children:(0,I.jsx)(`div`,{className:P.body,children:(0,I.jsx)(fe,{isLoading:h&&!te,isFetching:g,isError:_,isEmpty:n<=0||x.length===0,error:{description:t(`We couldn't load this traffic activity. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:y}]},empty:{icon:oe,description:t(`Open a post or page report to see its traffic activity here.`,`jetpack-premium-analytics-pkg`)},children:(0,I.jsxs)(`div`,{className:P.content,children:[d&&(0,I.jsxs)(v,{align:`center`,justify:`flex-end`,gap:`sm`,className:P.pager,children:[(0,I.jsx)(b,{type:`button`,variant:`minimal`,tone:`neutral`,size:`small`,onClick:p,disabled:!f,"aria-label":t(`Older activity`,`jetpack-premium-analytics-pkg`),children:(0,I.jsx)(b.Icon,{icon:u,size:16})}),(0,I.jsx)(b,{type:`button`,variant:`minimal`,tone:`neutral`,size:`small`,onClick:m,disabled:!ee,"aria-label":t(`Newer activity`,`jetpack-premium-analytics-pkg`),children:(0,I.jsx)(b.Icon,{icon:c,size:16})})]}),(0,I.jsx)(ie,{data:x,rowLabels:re,primaryColor:`var(--wp-admin-theme-color, #3858e9)`,withTooltips:!0,maxCellWidth:64,maxCellHeight:42,renderTooltip:se,className:P.heatmap})]})})})})}function F({attributes:e={}}){return(0,I.jsx)(C,{attributes:e,children:(0,I.jsx)(we,{})})}var I,L,R,z,B,Te=e((()=>{T(),w(),D(),o(),a(),n(),l(),y(),be(),Se(),I=r(),L=64,R=4,z=4,B=16})),V,Ee=e((()=>{l(),V={icon:d,attributes:[],example:{attributes:{}}}})),H,U,W,G,De,Oe,ke,Ae=e((()=>{H=`jpa/post-traffic-activity`,U=`Traffic activity`,W=`Daily views for the post or page being viewed, as a calendar heatmap.`,G={content:`Daily views for the post or page being viewed, as a calendar heatmap.`},De=`stats`,Oe=`framed`,ke={name:H,title:U,description:W,help:G,category:De,presentation:Oe}}));function je({hasPostScope:e,preset:t},n=!1){return{reportParams:{...ce(n,t),...e?{post_id:J}:{}}}}function K(e){return(0,q.jsx)(F,{attributes:je(e)})}function Me({hasPostScope:e,preset:t,...n}){return(0,q.jsx)(_e,{...n,widgetType:ge(ke,V),renderModule:Ne,renderComponent:F,attributes:je({hasPostScope:e,preset:t},!0)})}var q,J,Ne,Pe,Y,X,Z,Q,$;e((()=>{T(),re(),he(),pe(),ve(),Te(),Ee(),Ae(),q=r(),x(),J=779,Ne=`storybook/post-traffic-activity`,Pe={title:`Packages/Premium Analytics/Widgets/PostTrafficActivity`,component:F,tags:[`autodocs`],argTypes:{hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."},preset:{control:`select`,options:[`last-30-days`,`last-365-days`],description:`Dashboard date range used to exercise single-page and paged layouts.`}},parameters:{docs:{description:{component:`The "Traffic activity" widget: the scoped post's daily views over the dashboard date range as a calendar heatmap — the post detail Traffic view's activity card, replacing the legacy months table. Days without traffic stay blank cells, per the design, while the grid stays complete. Without a post scope the widget renders a scopeless empty state.`}}}},Y={render:K,args:{hasPostScope:!0,preset:`last-30-days`},decorators:[O]},X={render:K,args:{hasPostScope:!0,preset:`last-365-days`},decorators:[O]},Z={render:K,args:{hasPostScope:!1,preset:`last-30-days`},decorators:[O]},Q={render:e=>(0,q.jsx)(Me,{...e}),args:{...ye,widgetWidth:4,widgetHeight:2,hasPostScope:!0,preset:`last-30-days`},argTypes:{...me,hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."},preset:{control:`select`,options:[`last-30-days`,`last-365-days`],description:`Dashboard date range used to exercise single-page and paged layouts.`}}},Y.parameters={...Y.parameters,docs:{...Y.parameters?.docs,source:{originalSource:`{
