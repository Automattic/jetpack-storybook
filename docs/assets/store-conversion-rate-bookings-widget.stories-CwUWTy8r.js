import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Nn as i,n as a}from"./build-module-DmVuor49.js";import{n as o,t as s}from"./build-module-DAOsljNC.js";import{c,t as l}from"./src-DN9VFS2M.js";import{ht as u,ir as d}from"./chart-tooltip-BvKnA4Ej.js";import{M as f,N as p,z as m}from"./report-metric-BBgOiYJZ.js";import{C as h,S as g,T as _,b as v,m as y,t as b,w as x,x as S}from"./src-Vd2hm5Bb.js";import{n as C,t as w}from"./force-stats-mock-state-hPxGaJ3I.js";function T({attributes:e={},setError:t}){return(0,E.jsx)(m,{attributes:e,setError:t,options:{from:`/`},children:(0,E.jsx)(y,{})})}var E,D=e((()=>{b(),E=r()})),O,k=e((()=>{n(),a(),O={name:`jpa/store-conversion-rate-bookings`,title:t(`Store conversion rate - Bookings`,`jetpack-premium-analytics`),help:{content:t(`Track your booking conversion funnel from sessions to completed bookings over the selected time period.`,`jetpack-premium-analytics`)},icon:i}}));function A(e){let t={active_sessions:String(e?4860:5480),visitors:String(e?3920:4410),with_cart_addition:String(e?970:1215),reached_checkout:String(e?430:560),completed_checkout:String(e?218:310),date_start:`2026-05-01T00:00:00.000Z`,date_end:`2026-05-31T23:59:59.999Z`};return{summary:t,data:[t]}}function j(){U||(U=!0,s.use(async(e,t)=>{if(!String(e.path??e.url??``).startsWith(z))return t(e);let n=W%2==1;return W+=1,A(n)}))}function M(e=!1,t=V){return{reportParams:d(e,t)}}function N({withComparison:e,preset:t}){let n=!!e,r=t??V;return!n&&r===V?`getDefaultQueryParams()`:n&&r===V?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function P(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<StoreConversionRateBookingsRender
\tattributes={ {
\t\treportParams: ${N(e)},
\t} }
/>`}function F({withComparison:e,preset:t}){return(0,R.jsx)(T,{attributes:M(e,t)})}function I(e){return(0,R.jsx)(T,{attributes:M(!1,e)})}function L({withComparison:e,preset:t,...n}){return(0,R.jsx)(h,{...n,widgetType:O,renderModule:B,renderComponent:T,attributes:M(e,t)})}var R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;e((()=>{u(),l(),o(),f(),x(),v(),C(),D(),k(),R=r(),z=`/jetpack-premium-analytics/v1/proxy/v2/analytics/reports/sessions/by-conversion-rate`,B=`storybook/store-conversion-rate-bookings`,V=`last-30-days`,H=c,U=!1,W=0,p(),j(),G={title:`Packages/Premium Analytics/Widgets/StoreConversionRateBookings`,component:T,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:H,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`Dashboard widget that displays the booking product conversion funnel for the selected period.`}}}},K={render:F,args:{preset:V,withComparison:!1},decorators:[S],parameters:{docs:{source:{transform:(e,t)=>P(t.args)}}}},q={render:F,args:{preset:V,withComparison:!0},decorators:[S],parameters:{docs:{source:{transform:(e,t)=>P(t.args)}}}},J={render:()=>I(`last-90-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(w(`sessions/by-conversion-rate`,`loading`),()=>w(`sessions/by-conversion-rate`,null))},Y={render:()=>I(`last-7-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(w(`sessions/by-conversion-rate`,`error`),()=>w(`sessions/by-conversion-rate`,null))},X={render:()=>I(`last-365-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(w(`sessions/by-conversion-rate`,`empty`),()=>w(`sessions/by-conversion-rate`,null))},Z={render:e=>(0,R.jsx)(L,{...e}),args:{...g,preset:V,withComparison:!0},argTypes:{..._,preset:{control:`select`,options:H,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
