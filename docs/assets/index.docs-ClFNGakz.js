import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-C5iwM-ZN.js";import{i as r,n as i,r as a,t as o}from"./blocks-Dj-kpWo0.js";import{t as s}from"./mdx-react-shim-CnEoHihG.js";import{AdvancedFormatting as c,Animation as l,CurrencyFormatting as u,CustomColors as d,CustomLabel as f,Default as p,EmptyData as m,EmptyDataWithChildren as h,FitRows as g,FitRowsInteractive as _,Interactive as v,LargeValues as y,Loading as b,NegativeGrowth as x,NumberFormatting as S,OverlayLabelWithImage as C,SmallDataset as w,WithCompositionLegend as T,WithLegendLabels as E,WithOverlayLabel as D,WithoutComparison as O,n as k,t as A}from"./index.stories-WB3OJuuY.js";function j(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,N.jsxs)(N.Fragment,{children:[(0,N.jsx)(i,{title:`JS Packages/Charts Library/Charts/Leaderboard Chart`,of:A}),`
...
`,(0,N.jsxs)(t.li,{children:[(0,N.jsx)(t.strong,{children:(0,N.jsx)(t.code,{children:`primaryColor`})}),`: Primary color for current period bars (defaults to the first palette slot)`]}),`
`,(0,N.jsxs)(t.li,{children:[(0,N.jsx)(t.strong,{children:(0,N.jsx)(t.code,{children:`secondaryColor`})}),`: Secondary color for comparison period bars (defaults to the second palette slot)`]}),`
`]}),`
`,(0,N.jsx)(t.p,{children:(0,N.jsx)(t.strong,{children:`Data Formatting:`})}),`
`,(0,N.jsxs)(t.ul,{children:[`
`,(0,N.jsxs)(t.li,{children:[(0,N.jsx)(t.strong,{children:(0,N.jsx)(t.code,{children:`valueFormatter`})}),`: Custom formatter function for values (a string or a React node) - defaults to `,(0,N.jsx)(t.code,{children:`formatMetricValue`}),` with compact notation`]}),`
...
`,(0,N.jsx)(t.p,{children:`Override the palette defaults with custom primary and secondary colors:`}),`
`,(0,N.jsx)(o,{of:d}),`
`,(0,N.jsx)(a,{language:`tsx`,code:`<LeaderboardChart
	data={data}
	withComparison={true}
...
`,(0,N.jsx)(t.p,{children:`Leaderboard Charts integrate seamlessly with the chart theming system. The default theme has neutral styling, and is automatically applied to all charts unless a custom theme is provided.`}),`
...
`,(0,N.jsxs)(t.p,{children:[`Every other color works the same way — declare its catalog role. The closest declaration inside the provider tree wins, so scope the rule to one dashboard, or to `,(0,N.jsx)(t.code,{children:`.a8c-charts-scope`}),` to move every chart on the page:`]}),`
