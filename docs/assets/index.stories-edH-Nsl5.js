import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{$r as r,Ap as i,Bh as a,Fr as o,Hh as s,Ip as c,Uh as l,Vh as u,co as d,fi as f,fr as p,ki as m,kt as h,t as g,wg as _,zh as v,zn as y}from"./iframe-CnZIOEIw.js";var b,x,S,C,w,T,E=e((()=>{b=`_label_13cbv_1`,x=`_disabled_13cbv_22`,S=`_large_13cbv_27`,C=`_input_13cbv_7`,w=`_loader_13cbv_64`,T={label:b,"input-wrapper":`_input-wrapper_13cbv_7`,disabled:x,large:S,"is-textarea":`_is-textarea_13cbv_31`,input:C,"with-icon":`_with-icon_13cbv_50`,"icon-wrapper":`_icon-wrapper_13cbv_53`,"clear-icon":`_clear-icon_13cbv_61`,loader:w}})),D,O,k,A,j,M=e((()=>{g(),m(),i(),s(),p(),u(),D=t(_()),E(),O=v(),k=({className:e,disabled:t=!1,loading:n=!1,icon:r=null,endAdornment:i=null,onChange:o,onEnter:s,size:c=`small`,...l})=>{let u=(0,D.useCallback)(e=>{o?.(e.currentTarget.value)},[o]),f=(0,D.useCallback)(e=>{s!=null&&[`Enter`,`NumpadEnter`].includes(e.code)&&s(e.currentTarget.value)},[s]),p={className:a(T.input,{[T[`with-icon`]]:r!=null}),onChange:u,onKeyUp:f,disabled:t,"aria-disabled":t},m=l?.type===`textarea`;return(0,O.jsx)(`div`,{className:a(e,T[`input-wrapper`],{[T.disabled]:t,[T.large]:c===`large`,[T[`is-textarea`]]:m}),children:m?(0,O.jsx)(`textarea`,{...l,...p}):(0,O.jsxs)(O.Fragment,{children:[n||r?(0,O.jsx)(`div`,{className:a(T[`icon-wrapper`],{[T.loader]:n}),children:n?(0,O.jsx)(d,{}):r}):null,(0,O.jsx)(`input`,{...l,...p,value:l.value}),i]})})},A=({name:e,label:t,className:n,size:r=`small`,...i})=>t?(0,O.jsxs)(`div`,{className:n,children:[(0,O.jsx)(y,{component:`label`,variant:r===`small`?`body-small`:`body`,htmlFor:e,mb:1,className:T.label,children:t}),(0,O.jsx)(k,{name:e,size:r,...i})]}):(0,O.jsx)(k,{className:n,size:r,...i}),j=({placeholder:e=l(`Search your library`,`jetpack-videopress-pkg`),onSearch:t,wait:n=500,...i})=>{let o=c(t,n),s=(0,D.useCallback)(e=>{i.onEnter?.(e),t(e)},[i.onEnter,t]),u=(0,D.useCallback)(e=>{i.onChange?.(e),o(e)},[i.onChange]),d=(0,D.useCallback)(()=>{i.onChange?.(``),t(``)},[i.onChange]);return(0,O.jsx)(A,{...i,icon:(0,O.jsx)(h,{size:24}),placeholder:e,type:`text`,onEnter:s,onChange:u,endAdornment:(0,O.jsx)(O.Fragment,{children:!!i.value&&(0,O.jsx)(`div`,{className:a(T[`icon-wrapper`]),children:(0,O.jsx)(f,{icon:r,onClick:d,className:a(T[`clear-icon`])})})})})}})),N=n({Default:()=>V,Search:()=>K,TextArea:()=>W,WithIcon:()=>H,WithLabel:()=>U,__namedExportsOrder:()=>q,default:()=>L}),P,F,I,L,R,z,B,V,H,U,W,G,K,q,J=e((()=>{p(),P=t(_()),M(),F=v(),{action:I}=__STORYBOOK_MODULE_ACTIONS__,L={title:`Packages/VideoPress/Input`,component:A,argTypes:{size:{options:[`small`,`large`],control:{type:`radio`}},type:{options:[`text`,`textarea`,`number`,`url`,`email`,`password`,`tel`,`search`],control:{type:`select`}}}},R=e=>{I(`onEnter`)(e)},z={placeholder:`Placeholder text`,disabled:!1,loading:!1,size:`small`,type:`text`,label:``},B=e=>{let[t,n]=(0,P.useState)(``),r=e=>{n(e)};return(0,F.jsx)(A,{...e,value:t,onChange:r,onEnter:R})},V=B.bind({}),V.args=z,H=B.bind({}),H.args={...z,icon:(0,F.jsx)(f,{icon:o,size:24})},U=B.bind({}),U.args={...z,label:`My Label`},W=B.bind({}),W.args={...z,type:`textarea`},G=e=>{let[t,n]=(0,P.useState)(``),r=e=>{n(e),I(`onChange`)(e)};return(0,F.jsx)(j,{...e,value:t,onChange:r,onEnter:R})},K=G.bind({}),K.args={disabled:!1,loading:!1,onEnter:I(`onEnter`),onChange:I(`onChange`),onSearch:I(`onSearch`),wait:500},V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`args => {
