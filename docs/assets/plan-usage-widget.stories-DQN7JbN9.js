import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,r as n,t as r,u as i}from"./build-module-DQ5lAs4a.js";import{n as a,t as o}from"./clsx-SUvPW2lx.js";import{t as s}from"./jsx-runtime-D2pHJD-r.js";import{j as c,t as l}from"./build-module-DMs68Vfd.js";import{ii as u,n as d}from"./build-module-Bt8gOW8e.js";import{Bt as f,U as ee,Yt as p,p as m,s as te}from"./hooks-Cw-H66ea.js";import{Fr as h,Mr as ne}from"./iframe-C1pf2pwS.js";import{K as g,R as re,t as ie,u as ae}from"./build-module-BAze1CUO.js";import{n as _,t as v}from"./src-CTTL0FAF.js";import{a as y,i as b,n as oe,r as x,s as S,t as C}from"./register-report-mocks-BPl_Kj4W.js";import{t as w}from"./widget-state-D4P9dT61.js";import{i as se,n as ce,r as le,t as ue}from"./widget-dashboard-with-widget-BY2z4b5b.js";import{t as de}from"./src-C0QqKDKI.js";var T,E,D,O,k,A,j,fe=e((()=>{T=`_root_1i6zp_1`,E=`_progress_1i6zp_9`,D=`_progressMeter_1i6zp_24`,O=`_isOverLimit_1i6zp_46`,k=`_progressLabel_1i6zp_55`,A=`_note_1i6zp_61`,j={root:T,progress:E,progressMeter:D,isOverLimit:O,progressLabel:k,note:A}}));function pe(e){return t(e>=2?`You've surpassed your limit for two consecutive periods already.`:`You've surpassed your limit the past month.`,`jetpack-premium-analytics`)}function me(){let e=h()?.site,t=e?.wpcom?.blog_id;return!e?.admin_url||!t?void 0:`${e.admin_url}admin.php?page=stats#!/stats/purchase/${t}?from=jetpack-premium-analytics&productType=commercial&redirect_uri=admin.php%3Fpage%3Djetpack-premium-analytics-wp-admin`}function he({limit:e,usage:r,daysToReset:a,overLimitMonths:s}){let l=r??0,u=l>=e,d=me();return(0,P.jsxs)(re,{className:j.root,direction:`column`,align:`stretch`,justify:`safe center`,gap:`md`,children:[(0,P.jsxs)(`div`,{className:o(j.progress,u&&j.isOverLimit),children:[(0,P.jsx)(`progress`,{className:j.progressMeter,value:Math.min(l,e),max:e,"aria-label":t(`Plan usage`,`jetpack-premium-analytics`)}),(0,P.jsx)(g,{className:j.progressLabel,variant:`body-sm`,children:i(t(`%1$s / %2$s views`,`jetpack-premium-analytics`),_(l,`number`,{decimals:0}),_(e,`number`,{decimals:0}))}),a!==void 0&&(0,P.jsx)(g,{className:j.progressLabel,variant:`body-sm`,children:i(n(`Restarts in %d day`,`Restarts in %d days`,a,`jetpack-premium-analytics`),a)})]}),(!!s||d)&&(0,P.jsxs)(g,{className:j.note,variant:`body-sm`,children:[s?(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(`strong`,{children:pe(s)}),` `]}):null,d&&c(t(`Do you want to increase your views limit? <a>Upgrade now</a>`,`jetpack-premium-analytics`),{a:(0,P.jsx)(ae,{href:d})})]})]})}function M(){let{data:e,isLoading:n,isFetching:r,isError:i,refetch:a}=ee(),o=e?.views_limit,s=typeof o==`number`&&o>0,c=h()?.site?.host===`vip`;return(0,P.jsx)(w,{isLoading:n,isFetching:r,isError:i,isEmpty:!s,error:{description:t(`We couldn't load plan usage. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:a}]},empty:{icon:u,description:t(`Plan usage isn't available for your current plan.`,`jetpack-premium-analytics`)},children:s&&(0,P.jsx)(he,{limit:o,usage:e?.current_usage?.views_count,daysToReset:e?.current_usage?.days_to_reset,overLimitMonths:c?null:e?.over_limit_months})})}function N({attributes:e={}}){return(0,P.jsx)(te,{attributes:e,children:(0,P.jsx)(M,{})})}var P,F=e((()=>{ne(),m(),v(),de(),l(),r(),d(),ie(),a(),fe(),P=s()})),I,L=e((()=>{r(),d(),I={name:`jpa/plan-usage`,title:t(`Plan usage`,`jetpack-premium-analytics`),icon:u,help:{content:t(`Billable views are your total views minus your two highest-traffic days each billing cycle, so big spikes won't count against your limit. You'll only need to upgrade if you exceed your limit for three cycles in a row.`,`jetpack-premium-analytics`),links:[{label:t(`Learn more`,`jetpack-premium-analytics`),href:`https://jetpack.com/support/jetpack-stats/free-or-paid/`}]},attributes:[],example:{attributes:{}}}}));function R(e){return()=>(b(`jetpack-stats/usage`,e),p.removeQueries({queryKey:[`stats-app`,`plan-usage`]}),()=>{b(`jetpack-stats/usage`,null),p.removeQueries({queryKey:[`stats-app`,`plan-usage`]})})}function z({vip:e}){return()=>(x(`jetpack-stats/usage`,S),e&&(window.JetpackScriptData.site.host=`vip`),p.removeQueries({queryKey:[`stats-app`,`plan-usage`]}),()=>{x(`jetpack-stats/usage`,null),e&&delete window.JetpackScriptData.site.host,p.removeQueries({queryKey:[`stats-app`,`plan-usage`]})})}function B({withComparison:e}){return(0,V.jsx)(N,{attributes:{reportParams:f(e)}})}function ge({withComparison:e,...t}){return(0,V.jsx)(ce,{...t,widgetType:{...I,presentation:`framed`},renderModule:H,renderComponent:N,attributes:{reportParams:f(e)}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{m(),y(),C(),le(),F(),L(),V=s(),oe(),window.JetpackScriptData={...window.JetpackScriptData,site:{...window.JetpackScriptData?.site,admin_url:`https://example.com/wp-admin/`,wpcom:{blog_id:123456789}}},H=`storybook/plan-usage`,U=e=>(0,V.jsx)(`div`,{style:{width:`100%`,height:`360px`},children:(0,V.jsx)(e,{})}),W={title:`Packages/Premium Analytics/Widgets/PlanUsage`,component:N,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`}},parameters:{docs:{description:{component:`The "Plan usage" widget. Shows billable views used in the current billing cycle against the plan's limit as a horizontal usage meter — figures and days-until-reset inside the bar, an upgrade note below it — following the Stats "Plan usage" section. The usage endpoint is a point-in-time reading with no date range or comparison period.`}}}},G={render:B,args:{withComparison:!1},decorators:[U]},K={render:B,args:{withComparison:!0},decorators:[U],parameters:{docs:{description:{story:`The usage endpoint has no comparison period, so this renders identically to Default even when comparison report params are supplied.`}}}},q={render:B,args:{withComparison:!1},tags:[`!autodocs`],decorators:[U],beforeEach:R(`loading`)},J={render:B,args:{withComparison:!1},tags:[`!autodocs`],decorators:[U],beforeEach:R(`error`)},Y={render:B,args:{withComparison:!1},tags:[`!autodocs`],decorators:[U],beforeEach:R(`empty`)},X={render:B,args:{withComparison:!1},tags:[`!autodocs`],decorators:[U],beforeEach:z({vip:!1})},Z={render:B,args:{withComparison:!1},tags:[`!autodocs`],decorators:[U],beforeEach:z({vip:!0})},Q={render:e=>(0,V.jsx)(ge,{...e}),args:{...ue,withComparison:!0},argTypes:{...se,withComparison:{control:`boolean`}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
