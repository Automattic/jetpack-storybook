import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{_ as o,t as s}from"./build-module-CbwHEf9N.js";import{n as c,w as l}from"./build-module-CDRs4YxF.js";import{J as u,at as d,ct as f,ot as p,q as m,tt as ee,v as te}from"./report-metric-CUJ3Gh6_.js";import{ft as h,mt as ne,ot as re,qt as g,rt as ie,t as _}from"./src-56SjHKng.js";import{x as ae}from"./chart-tooltip-WHUgZUgy.js";import{t as oe}from"./post-highlight-card-skeleton-BTaDnfNK.js";import{t as se}from"./widget-state-B-6QxAet.js";import{C as ce,D as v,E as le,O as ue,S as de,T as fe,b as pe,k as y,t as b,w as x,x as S}from"./src-KyGwFKrH.js";import{n as me,t as C}from"./register-stats-mocks-BUlzOFL3.js";import{n as w,t as T}from"./force-stats-mock-state-D5Q7w7xE.js";function he(e){let t=ie((0,E.useMemo)(()=>{let t={...e,max:O};return delete t.comp,delete t.compare_from,delete t.compare_to,delete t.compare_preset,t},[e]),{maxRows:1,postTypes:D}),n=t.comparisonRows?.rows[0],r=Number(n?.id??0)||0,i=ne(re(r)),a=h({postId:r,fields:[`views`,`like_count`,`post`]}),o=a.data,s=o?.post?.ID,c=o&&(s===void 0||s===r)?o:void 0,l=r>0&&!c&&!a.isError,u=t.isLoading||r>0&&(i.isLoading||a.isLoading||l),d=t.isFetching||i.isFetching||a.isFetching,f=t.isError,p=()=>{t.refetch(),r>0&&(i.refetch(),a.refetch())},m=i.data??null;return{post:n?{id:r,title:m?.title||String(n.label??``),url:m?.url||n.link||``,date:m?.date||(typeof n.date==`string`?n.date:``),imageUrl:m?.imageUrl??``,imageAlt:m?.imageAlt??``,views:c?.views,likeCount:c?.like_count,commentCount:c?.post?.comment_count}:null,isLoading:u,isFetching:d,isError:f,error:t.error,refetch:p}}var E,D,O,ge=t((()=>{_(),E=e(n(),1),D=[`post`],O=20}));function _e(){let{reportParams:e}=d(),{post:t,isLoading:n,isFetching:i,isError:a,error:s,refetch:c}=he(e),u=(0,o.useMemo)(()=>f(e),[e]),p=t?[{key:`views`,label:r(`Views`,`jetpack-premium-analytics-pkg`),value:t.views},{key:`likes`,label:r(`Likes`,`jetpack-premium-analytics-pkg`),value:t.likeCount},{key:`comments`,label:r(`Comments`,`jetpack-premium-analytics-pkg`),value:t.commentCount}]:[];return(0,A.jsx)(se,{isLoading:n,isFetching:i,isError:a,isEmpty:!t,error:ae(s,{retryDescription:r(`We couldn't load your most popular post. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}),empty:{icon:l,description:r(`No post views in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,A.jsx)(oe,{}),children:t&&(0,A.jsx)(te,{title:t.title,url:t.url,postId:t.id,detailSearch:u,date:t.date,imageUrl:t.imageUrl,imageAlt:t.imageAlt,metrics:p})})}function k({attributes:e={}}){return(0,A.jsx)(ee,{attributes:e,children:(0,A.jsx)(_e,{})})}var A,ve=t((()=>{p(),b(),s(),i(),c(),ge(),A=a()})),j,M=t((()=>{c(),j={icon:l,attributes:[],example:{attributes:{}}}})),N,P,F,I,L,R,z,ye=t((()=>{N=`jpa/popular-post`,P=`Popular post`,F=`Your most-viewed post for the selected date range, with its all-time stats.`,I={content:`Your most viewed post in the selected date range, with its all-time views, likes, and comments.`},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function be(){return(0,H.jsx)(k,{attributes:{reportParams:g()}})}function B(e){return(0,H.jsx)(k,{attributes:{reportParams:g(!1,e)}})}function V(e){return(0,H.jsx)(fe,{...e,widgetType:de(z,j),renderModule:U,renderComponent:k,attributes:{reportParams:g(!0)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{_(),m(),C(),ce(),w(),le(),ue(),pe(),ve(),M(),ye(),H=a(),u(),me(),U=`storybook/popular-post`,W={title:`Packages/Premium Analytics/Widgets/PopularPost`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:"The \"Popular post\" widget shows the site's most-viewed post for the dashboard's date range, with its publish date and its all-time views, likes, and comments. Changing the date range changes which post wins, not the totals shown for it: every tile comes from the all-time `stats/post` response, so the three cannot measure different periods. There is no `WithComparison` story: the card shows no period-over-period delta, so the dashboard story below carries the comparison report params instead."}}}},G={render:be,decorators:[S,y]},K={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[S,y],beforeEach:()=>(T(`stats/top-posts`,`loading`),()=>T(`stats/top-posts`,null))},q={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[S,y],beforeEach:()=>(T(`stats/top-posts`,`error`),()=>T(`stats/top-posts`,null))},J={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[S,y],beforeEach:()=>(T(`stats/top-posts`,`error-retryable`),()=>T(`stats/top-posts`,null))},Y={render:()=>B(`last-year`),tags:[`!autodocs`],decorators:[S,y],beforeEach:()=>(T(`stats/top-posts`,`empty`),()=>T(`stats/top-posts`,null))},X={render:e=>(0,H.jsx)(V,{...e}),args:{...x,widgetWidth:2,widgetHeight:2},argTypes:{...v}},Z={render:e=>(0,H.jsx)(V,{...e}),args:{...x,widgetWidth:2,widgetHeight:1},argTypes:{...v}},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...x,widgetWidth:1,widgetHeight:1},argTypes:{...v}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
