import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DQ5lAs4a.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{N as i,t as a}from"./build-module-DMs68Vfd.js";import{n as o,rl as s}from"./build-module-Bt8gOW8e.js";import{A as c,t as l}from"./src-CT5b53ej.js";import{Kn as u,jt as d,or as f,ut as p}from"./chart-tooltip-Cd6R28vB.js";import{t as m}from"./metric-tabs-chart-DgZsRbyw.js";import{C as h,N as g,S as _,T as v,k as y}from"./report-metric-BSkCvVUy.js";import{t as b}from"./widget-state-CqW7LysR.js";import{S as x,b as S,t as ee,x as te,y as ne}from"./src-ZlSzubd8.js";import{n as re,r as C}from"./with-widget-canvas-Dz43KNHY.js";import{n as ie,t as ae}from"./src-BIoci1og.js";var w,T,E,oe=e((()=>{w=`_root_kn78g_1`,T=`_emptyState_kn78g_10`,E={root:w,emptyState:T}})),D,O,k,A=e((()=>{n(),o(),ae(),D=[{id:`views`,label:t(`Views`,`jetpack-premium-analytics`)},{id:`visitors`,label:t(`Visitors`,`jetpack-premium-analytics`)},{id:`likes`,label:t(`Likes`,`jetpack-premium-analytics`)},{id:`comments`,label:t(`Comments`,`jetpack-premium-analytics`)}],O=D.map(e=>e.id),k={name:`jpa/traffic-chart`,title:t(`Traffic`,`jetpack-premium-analytics`),help:{content:t(`Compare views, visitors, likes, and comments over the selected period, with the previous period overlaid for comparison.`,`jetpack-premium-analytics`)},icon:s,attributes:[{id:`granularity`,label:t(`Group by`,`jetpack-premium-analytics`),type:`text`,elements:[{label:t(`Auto`,`jetpack-premium-analytics`),value:`auto`},{label:t(`By days`,`jetpack-premium-analytics`),value:`day`},{label:t(`By weeks`,`jetpack-premium-analytics`),value:`week`},{label:t(`By months`,`jetpack-premium-analytics`),value:`month`}],relevance:`high`},{id:`metrics`,label:t(`Metrics`,`jetpack-premium-analytics`),type:`array`,relevance:`high`,Edit:ie,elements:D.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{granularity:`auto`,metrics:O}}}}));function j(e,t){return Number(e?.summary?.[t]??0)}function M(e,t){return(e?.data??[]).map(e=>({date:f(e.date_start),value:Number(e[t]??0)}))}function N(e,t,n,r,i){let a=n?M(t,r):void 0,o=!!a?.length;return{key:r,label:i,value:j(e,r),previousValue:o?j(t,r):void 0,current:M(e,r),previous:o?a:void 0}}function P(e,t,n){return{...e,stat_fields:t,period:n}}function F(e,t,n=O){let r=(0,i.useMemo)(()=>new Set(n),[n]),a=r.has(`views`)||r.has(`visitors`),o=r.has(`likes`)||r.has(`comments`),s=(0,i.useMemo)(()=>P(e,`views,visitors`,t),[e,t]),c=(0,i.useMemo)(()=>P(e,`likes,comments`,t),[e,t]),l=d(s,{enabled:a}),u=d(c,{enabled:o}),f=l.primary.data,p=l.comparison.data,m=l.hasComparison,h=u.primary.data,g=u.comparison.data,_=u.hasComparison,v=(0,i.useMemo)(()=>D.filter(e=>r.has(e.id)).map(e=>{let t=e.id===`views`||e.id===`visitors`;return N(t?f:h,t?p:g,t?m:_,e.id,e.label)}),[r,f,p,m,h,g,_]),{refetch:y}=l,{refetch:b}=u,x=(0,i.useCallback)(()=>{y(),b()},[y,b]),S=l.isError&&!f?.data?.length||u.isError&&!h?.data?.length;return{metrics:v,isLoading:l.isLoading||u.isLoading,isFetching:l.isFetching||u.isFetching,isError:S,refetch:x}}var se=e((()=>{p(),a(),A()}));function ce(e){switch(e){case`week`:return`week`;case`month`:case`quarter`:case`year`:return`month`;default:return`day`}}function le({granularity:e,metrics:n}){let{reportParams:r}=g(),{metrics:i,isLoading:a,isFetching:o,isError:s,refetch:l}=F(r,e===`auto`?ce(r.interval):e,n),u=t(`Traffic metric`,`jetpack-premium-analytics`);return i.length?(0,L.jsx)(`div`,{className:E.root,children:(0,L.jsx)(b,{isLoading:a,isError:s,isEmpty:i.every(e=>e.current.length===0),error:{description:t(`We couldn't load traffic data. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:l}]},empty:{icon:c,description:t(`No traffic data in this period.`,`jetpack-premium-analytics`)},renderLoading:(0,L.jsx)(m,{metrics:i,dataFormat:R,loading:!0,groupLabel:u}),children:(0,L.jsx)(m,{metrics:i,dataFormat:R,loading:o,groupLabel:u})})}):(0,L.jsx)(`div`,{className:E.emptyState,children:t(`No metric selected. Please select a metric from the metrics list.`,`jetpack-premium-analytics`)})}function I({attributes:e={},setError:t}){return(0,L.jsx)(y,{attributes:e,setError:t,options:{from:`/`},children:(0,L.jsx)(le,{granularity:e.granularity??`auto`,metrics:e.metrics})})}var L,R,ue=e((()=>{ee(),l(),n(),oe(),se(),L=r(),R={type:`number`,options:{useMultipliers:!0,decimals:0}}}));function z({withComparison:e,metrics:t}){return(0,V.jsx)(I,{attributes:{reportParams:u(e),metrics:t}})}function B(e){return(0,V.jsx)(I,{attributes:{reportParams:u(!1,e)}})}function de({withComparison:e,metrics:t,...n}){return(0,V.jsx)(S,{...n,widgetType:U,renderModule:H,renderComponent:I,attributes:{reportParams:u(e),metrics:t}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{p(),te(),re(),_(),ue(),A(),V=r(),h(),H=`storybook/traffic-chart`,U={name:k.name,title:k.title,icon:k.icon,attributes:k.attributes,example:k.example},W={metrics:{control:`check`,options:O}},G={metrics:O},K={title:`Packages/Premium Analytics/Widgets/TrafficChart`,component:I,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`},...W},parameters:{docs:{description:{component:"Traffic over the selected period as selectable metric tabs — Views, Visitors, Likes, and Comments — over a comparative line chart. The date range and comparison come from the dashboard controls; the \"Group by\" control is the `granularity` attribute and the tab selection is the `metrics` attribute (both `relevance: 'high'`), exposed by the widget host. When comparison is on the previous period is overlaid as a same-colour dashed line and each tab shows its period-over-period delta. Views/visitors and likes/comments are fetched as two parallel requests (mirroring Calypso) to keep latency down; a pair's request is skipped while neither of its metrics is selected. Data comes from the `useStatsVisits` hook; in Storybook it is served by `registerReportMocks`."}}}},q={render:z,args:{withComparison:!1,...G},decorators:[C]},J={render:z,args:{withComparison:!0,...G},decorators:[C]},Y={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(v(`stats/visits`,`loading`),()=>v(`stats/visits`,null))},X={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(v(`stats/visits`,`error`),()=>v(`stats/visits`,null))},Z={render:()=>B(`last-365-days`),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(v(`stats/visits`,`empty`),()=>v(`stats/visits`,null))},Q={render:e=>(0,V.jsx)(de,{...e}),args:{...ne,withComparison:!0,...G},argTypes:{...x,withComparison:{control:`boolean`},...W}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
