import{i as e}from"./preload-helper-usAeo7Bx.js";import{f as t,n,t as r}from"./build-module-yGZutq_9.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{Gu as a,Nu as o,_a as s,t as c}from"./build-module-zwSmKorH.js";import{b as l,en as u,g as d,r as ee,rn as f,tn as p}from"./hooks-1sbxUh5m.js";import{en as m,i as h,lt as te}from"./date-filters-panel-B9i11_yc.js";import{a as g}from"./src-CnU4gkhF.js";import"./constants-B1kGztHF.js";import{r as _,t as ne}from"./leaderboard-skeleton-DslJcObl.js";import{i as v,r as y}from"./register-report-mocks-CU-0P7gZ.js";import{N as b,S as re,b as ie,j as ae,w as oe}from"./report-metric-BEd5pxf6.js";import{t as se}from"./widget-state-DTTvqQeU.js";import{t as ce}from"./src-Q8WIHIXL.js";import{a as le,c as ue,d as x,i as de,l as fe,n as pe,o as me,r as S,s as he,u as ge}from"./with-widget-canvas-0dl_RFTX.js";import{n as _e,t as ve}from"./register-stats-mocks-guVTm97D.js";import{n as ye,t as C}from"./force-stats-mock-state-DDSge2Tv.js";var w,T,E,D,be=e((()=>{w=`_placeholder_1oate_1`,T=`_root_1oate_9`,E=`_content_1oate_18`,D={placeholder:w,root:T,content:E}}));function xe(e){return typeof e.label==`string`&&e.label?e.label:e.link??``}function O(e){let t=g(e.link);return{label:xe(e),value:e.views,previousValue:e.previousValue,...t?{href:t}:{},icon:e.icon,children:e.children?.map(O),...e.childrenHaveComparison?{childrenHaveComparison:!0}:{}}}function Se(e,r,i){let a=p(e.map(e=>e.value),r?e.map(e=>e.previousValue):[]);return e.map((e,o)=>{let s=e.previousValue,c=!!e.children?.length;return{id:`${o}-${e.href??e.label}`,...ae({label:e.label,media:{kind:`favicon`,url:e.icon??void 0},action:b({href:e.href,hasChildren:c,drillDown:i?{onClick:()=>i(e),ariaLabel:t(n(`View clicked links for %s`,`jetpack-premium-analytics-pkg`),e.label)}:void 0})}),currentValue:e.value,currentShare:u(e.value,a),previousValue:s,previousShare:r&&s!==void 0?u(s,a):void 0,delta:r&&s!==void 0?f(e.value,s):void 0}})}function Ce({rows:e=[],withComparison:t=!1,onDrillDown:n}){return(0,j.jsx)(_,{data:Se(e,t,n),withComparison:t,withOverlayLabel:!0,showLegend:!1,dataFormat:M})}function k(){let{reportParams:e}=l(),{drillDownItem:t,drillDown:r,resetDrillDown:i}=ee(),{comparisonRows:o,hasComparison:c,isLoading:u,isFetching:d,isError:f,refetch:p}=te({...e,max:10},{maxRows:10}),m=(0,a.useMemo)(()=>(o?.rows??[]).map(O),[o]),h=(0,a.useMemo)(()=>m.find(e=>e.label===t)??null,[m,t]),g=!!h?.children?.length,_=g?h.children??[]:m,v=g?!!h?.childrenHaveComparison:c;(0,a.useEffect)(()=>{t&&!g&&!u&&!d&&!f&&i()},[t,g,u,d,f,i]);let y=(0,a.useCallback)(e=>{r(e.label)},[r]),b=g?(0,j.jsx)(oe,{label:n(`All clicks`,`jetpack-premium-analytics-pkg`),ariaLabel:n(`View all clicks`,`jetpack-premium-analytics-pkg`),onClick:i}):null;return(0,j.jsxs)(`div`,{className:D.content,children:[b,(0,j.jsx)(se,{isLoading:u,isFetching:d,isError:m.length===0&&f,isEmpty:_.length===0,error:{description:n(`We couldn't load clicks. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:n(`Retry`,`jetpack-premium-analytics-pkg`),onClick:p}]},empty:{icon:s,description:n(`No clicks in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,j.jsx)(ne,{rows:10}),children:(0,j.jsx)(Ce,{rows:_,withComparison:v,onDrillDown:g?void 0:y})})]})}function A({attributes:e={}}){return(0,j.jsx)(d,{attributes:e,children:(0,j.jsxs)(`div`,{className:D.root,children:[(0,j.jsx)(k,{}),(0,j.jsx)(re,{children:(0,j.jsx)(ie,{report:`clicks`})})]})})}var j,M,we=e((()=>{h(),ce(),o(),r(),c(),be(),j=i(),M={type:`number`,options:{useMultipliers:!0,decimals:0}}})),N,Te=e((()=>{c(),N={icon:s,attributes:[],example:{attributes:{}}}})),P,F,I,L,R,z,B,Ee=e((()=>{P=`jpa/clicks`,F=`Top links clicked`,I=`Most clicked external links on your site.`,L={content:`The external links your visitors clicked most often, sorted by clicks.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},R=`traffic`,z=`framed`,B={name:P,title:F,description:I,help:L,category:R,presentation:z}}));function V({withComparison:e}){return(0,U.jsx)(A,{attributes:{reportParams:m(e)}})}function H(e){return(0,U.jsx)(A,{attributes:{reportParams:m(!1,e)}})}function De({withComparison:e,...t}){return(0,U.jsx)(he,{...t,widgetType:G,renderModule:W,renderComponent:A,attributes:{reportParams:m(e)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{h(),y(),ve(),ye(),ue(),ge(),le(),pe(),we(),Te(),Ee(),U=i(),v(),_e(),W=`storybook/clicks`,G=de(B,N),K={title:`Packages/Premium Analytics/Widgets/Clicks`,component:A,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`The "Clicks" widget. Shows the most-clicked external domains as a ranked leaderboard, using the global dashboard date range. Top-level rows drill down into clicked destination URLs when available.`}}}},q={render:V,args:{withComparison:!1},decorators:[S,x]},J={render:V,args:{withComparison:!0},decorators:[S,x]},Y={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[S,x],beforeEach:()=>(C(`stats/clicks`,`loading`),()=>C(`stats/clicks`,null))},X={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[S,x],beforeEach:()=>(C(`stats/clicks`,`error`),()=>C(`stats/clicks`,null))},Z={render:()=>H(`last-365-days`),tags:[`!autodocs`],decorators:[S,x],beforeEach:()=>(C(`stats/clicks`,`empty`),()=>C(`stats/clicks`,null))},Q={render:e=>(0,U.jsx)(De,{...e}),args:{...me,withComparison:!0},argTypes:{...fe,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
