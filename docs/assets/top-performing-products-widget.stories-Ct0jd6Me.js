import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DQ5lAs4a.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{n as i,rl as a}from"./build-module-Bt8gOW8e.js";import{n as o,t as s}from"./build-module-DZHUqpPN.js";import{l as c,t as l}from"./src-hyofVqDU.js";import{Kn as u,ut as ee}from"./chart-tooltip-Cd6R28vB.js";import{C as d,S as f,k as p}from"./report-metric-BSkCvVUy.js";import{S as m,b as h,c as g,t as _,x as v,y}from"./src-ZlSzubd8.js";import{n as b,r as x}from"./with-widget-canvas-Dz43KNHY.js";import{n as S,t as C}from"./force-stats-mock-state-CQT0C_sO.js";function w({attributes:e={},setError:t}){return(0,T.jsx)(p,{attributes:e,setError:t,options:{from:`/`},children:(0,T.jsx)(g,{limit:5})})}var T,E=e((()=>{_(),T=r()})),D,O=e((()=>{n(),i(),D={name:`jpa/top-performing-products`,title:t(`Top performing products`,`jetpack-premium-analytics`),help:{content:t(`Your best-selling products by revenue over the selected time period.`,`jetpack-premium-analytics`)},icon:a}}));function k(e){let t=e.reduce((e,t)=>({total_orders:e.total_orders+Number(t.orders_count),total_quantity:e.total_quantity+Number(t.total_quantity),total_revenue:e.total_revenue+Number(t.product_net_revenue)}),{total_orders:0,total_quantity:0,total_revenue:0});return{data:e,summary:{total_orders:String(t.total_orders),total_products:String(e.length),total_quantity:String(t.total_quantity),total_revenue:t.total_revenue.toFixed(2)}}}function A(e){V||(V=!0,s.use(async(t,n)=>{let r=t.path??t.url??``;return r.startsWith(R)?k(e):r.startsWith(z)?e.map(e=>({id:Number(e.product_id),name:e.product_name,images:[]})):n(t)}))}function j(e=!1,t=U){return{reportParams:u(e,t)}}function M({withComparison:e,preset:t}){let n=!!e,r=t??U;return!n&&r===U?`getDefaultQueryParams()`:n&&r===U?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function N(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
