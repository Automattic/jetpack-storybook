import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-yGZutq_9.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Gu as ee,Nu as i,Ps as a,t as o}from"./build-module-zwSmKorH.js";import{J as s,Y as c,g as l,m as te}from"./hooks-D9-5bKhf.js";import{n as ne,t as re}from"./src-gYceOeaM.js";import{en as ie,i as u,v as d}from"./date-filters-panel-DXxSsBcd.js";import"./constants-B1kGztHF.js";import{t as ae}from"./leaderboard-skeleton-BS2d84lc.js";import{t as oe}from"./metric-list-z1GvFWaT.js";import{i as se,r as ce,s as f}from"./register-report-mocks-Bek115LU.js";import{P as le,S as ue,b as de}from"./report-metric-Cwl9tNr_.js";import{t as fe}from"./widget-state-DoDeK2hZ.js";import{t as p}from"./src-DmKbijpS.js";import{a as pe,c as m,d as h,i as me,l as g,n as _,o as v,r as y,s as he,u as ge}from"./with-widget-canvas-BjVB14N8.js";var b,x,S,C,_e=e((()=>{b=`_widget_1veb5_3`,x=`_body_1veb5_11`,S=`_list_1veb5_18`,C={widget:b,body:x,list:S}}));function ve(e,t){return(e?.data?.[0]?.items??[]).slice(0,t>0?t:void 0).map((e,t)=>({id:e.id??t,postId:e.id,link:typeof e.link==`string`?e.link:null,label:String(e.label??``),opensRate:e.opens_rate,clicksRate:e.clicks_rate}))}function ye({attributes:e}){let n=e?.metric??`opens`,{data:r,isLoading:i,isFetching:o,isError:s,refetch:c}=d({quantity:10}),l=(0,ee.useMemo)(()=>ve(r,10),[r]);return(0,T.jsxs)(`div`,{className:C.widget,children:[(0,T.jsx)(`div`,{className:C.body,children:(0,T.jsx)(fe,{isLoading:i,isFetching:o,isError:l.length===0&&s,isEmpty:l.length===0,error:{description:t(`We couldn't load email stats. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:c}]},empty:{icon:a,description:t(`Your latest emails will appear here once you send a newsletter.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,T.jsx)(ae,{rows:10}),children:(0,T.jsx)(D,{rows:l,metric:n})})}),(0,T.jsx)(ue,{children:(0,T.jsx)(de,{report:`emails`})})]})}function w({attributes:e={}}){return(0,T.jsx)(l,{attributes:e,children:(0,T.jsx)(ye,{attributes:e})})}var T,E,D,be=e((()=>{u(),re(),p(),i(),n(),o(),_e(),T=r(),E={opens:`email-opens`,clicks:`email-clicks`},D=({rows:e=[],metric:t=`opens`})=>{let n=te(E[t]),r=e.map(e=>{let r=t===`clicks`?e.clicksRate:e.opensRate;return{id:e.id,label:(0,T.jsx)(le,{id:e.postId,label:e.label,link:e.link,search:n,title:e.label}),value:ne(r/100,`percentage`,{decimals:2,signDisplay:`never`})}});return(0,T.jsx)(oe,{className:C.list,items:r})}})),O,xe=e((()=>{n(),o(),s(),O={icon:a,attributes:[{id:`metric`,label:t(`View by`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:c,elements:[{label:t(`By open rate`,`jetpack-premium-analytics-pkg`),value:`opens`},{label:t(`By click rate`,`jetpack-premium-analytics-pkg`),value:`clicks`}],relevance:`high`}],example:{attributes:{metric:`opens`}}}})),k,A,j,M,N,P,F,Se=e((()=>{k=`jpa/stats-emails`,A=`Latest emails sent`,j=`Open and click rates for your latest emails.`,M={content:`Your most recently sent emails, including their open and click rates.`},N=`stats`,P=`framed`,F={name:k,title:A,description:j,help:M,category:N,presentation:P}}));function I(){return(0,L.jsx)(w,{attributes:{metric:`opens`}})}function Ce(e){return(0,L.jsx)(he,{...e,widgetType:me(F,O),renderModule:R,renderComponent:w,attributes:{metric:`opens`}})}var L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{u(),p(),ce(),m(),ge(),pe(),_(),be(),xe(),Se(),L=r(),se(),R=`storybook/emails`,z={title:`Packages/Premium Analytics/Widgets/Emails`,component:D,tags:[`autodocs`],parameters:{docs:{description:{component:`Lists the latest emails with their open or click rate. Close-up stories use fixtures; the dashboard story uses a mocked report.`}}}},B=[{id:1,postId:1,link:`https://example.com/stand-out/`,label:`4 Ways to Make Your Website Stand Out`,opensRate:38.1,clicksRate:3.81},{id:2,postId:2,link:`https://example.com/develop-locally/`,label:`Develop Locally on Linux with WordPress.com`,opensRate:41.2,clicksRate:5.98},{id:3,postId:3,link:`https://example.com/new-themes/`,label:`10 Brand-New WordPress.com Themes for 2026`,opensRate:35.7,clicksRate:7.12},{id:4,postId:4,link:`https://example.com/languages/`,label:`WordPress.com Is Now Available in More Languages`,opensRate:52.4,clicksRate:8.93},{id:5,postId:5,link:`https://example.com/wordcamp-europe/`,label:`WordCamp Europe 2026: What to Expect`,opensRate:47.9,clicksRate:10.25},{id:6,postId:6,link:`https://example.com/collaborate/`,label:`Click, Comment, Done: A Better Way to Collaborate`,opensRate:44.3,clicksRate:10.38}],V=[{id:1,postId:1,link:`https://example.com/long-subject/`,label:`An exhaustively long, keyword-stuffed subject line that almost certainly needs to be truncated before it overflows the row`,opensRate:22.5,clicksRate:4.1},{id:2,postId:2,link:`https://example.com/monthly-digest/`,label:`Your monthly digest: billing, new features, and what is coming next`,opensRate:33.8,clicksRate:6.7}],H=e=>(0,L.jsx)(l,{attributes:{reportParams:ie()},children:(0,L.jsx)(e,{})}),U={args:{rows:B},decorators:[y,H,h]},W={args:{rows:B,metric:`clicks`},decorators:[y,H,h]},G={render:I,tags:[`!autodocs`],decorators:[y,h],beforeEach:()=>(f(`stats/emails/summary`,`loading`),()=>f(`stats/emails/summary`,null))},K={render:I,tags:[`!autodocs`],decorators:[y,h],beforeEach:()=>(f(`stats/emails/summary`,`error`),()=>f(`stats/emails/summary`,null))},q={render:I,tags:[`!autodocs`],decorators:[y,h],beforeEach:()=>(f(`stats/emails/summary`,`empty`),()=>f(`stats/emails/summary`,null))},J={args:{rows:V},decorators:[y,H,h]},Y=(e,t=`auto`)=>n=>(0,L.jsx)(`div`,{style:{width:e,height:t,border:`1px dashed #ccc`,borderRadius:`8px`,containerType:`inline-size`,containerName:`widget`},children:(0,L.jsx)(n,{})}),X={args:{rows:B},decorators:[Y(`448px`),H,h]},Z={args:{rows:B},decorators:[Y(`576px`),H,h]},Q={render:e=>(0,L.jsx)(Ce,{...e}),args:{...v},argTypes:{...g}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  args: {
    rows: mockRows
  },
