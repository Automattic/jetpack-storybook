import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Ms as i,hi as a,hn as o,li as s,t as c}from"./build-module-2iv4IIRq.js";import{Mt as ee}from"./build-module-BX6MUpOQ2.js";import{Q as l,Y as te,g as ne}from"./hooks-BZdnU2i8.js";import{p as re,t as ie}from"./src-C-E2d-Lb.js";import{t as ae}from"./src-BDgtBGgf.js";import{$t as u,Tn as oe,V as se,r as d}from"./date-period-dropdown-C_e51F9K.js";import{r as ce,t as le}from"./metric-tile-grid-skeleton-CNGXzlLR.js";import{i as ue,r as f,s as p}from"./register-report-mocks-14O4qXKD.js";import{t as m}from"./widget-state-C6otIR5f.js";import{t as de}from"./src-DV1oOjg9.js";import{a as h,c as g,i as _,l as v,n as fe,o as pe,r as y,s as me}from"./with-widget-canvas-GV7UPa4E.js";var b,x,S,C=e((()=>{b=`_root_1qhg5_2`,x=`_placeholder_1qhg5_11`,S={root:b,placeholder:x}})),w,T,E,D=e((()=>{n(),c(),te(),w=[{id:`total`,label:t(`Total subscribers`,`jetpack-premium-analytics-pkg`)},{id:`paid`,label:t(`Paid subscribers`,`jetpack-premium-analytics-pkg`)},{id:`free`,label:t(`Free subscribers`,`jetpack-premium-analytics-pkg`)},{id:`social`,label:t(`Social followers`,`jetpack-premium-analytics-pkg`)}],T=w.map(e=>e.id),E={icon:s,attributes:[{id:`metrics`,label:t(`Metrics`,`jetpack-premium-analytics-pkg`),type:`array`,relevance:`high`,Edit:l,elements:w.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:T}}}}));function he({metrics:e=T}){let{data:n,isLoading:r,isFetching:i,isError:a,refetch:o}=se(),s=new Set(e),c=!!n&&Object.values(n).some(e=>e!==void 0),l=w.filter(({id:e})=>s.has(e)).map(({id:e,label:t})=>({key:e,label:t,icon:j[e].icon,value:j[e].count(n)}));return(0,k.jsx)(`div`,{className:S.root,children:(0,k.jsx)(m,{isLoading:r,isFetching:i,isError:a&&!c,isEmpty:!c,error:{description:t(`We couldn't load subscriber highlights. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:o}]},empty:{icon:re,description:t(`No subscriber counts available yet.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,k.jsx)(le,{tiles:l.length}),children:l.length===0?(0,k.jsx)(ee,{className:S.placeholder,children:t(`Select at least one metric to display.`,`jetpack-premium-analytics-pkg`)}):(0,k.jsx)(ce,{tiles:l,dataFormat:A})})})}function O({attributes:e={}}){return(0,k.jsx)(ne,{attributes:e,children:(0,k.jsx)(he,{metrics:e.metrics})})}var k,A,j,M=e((()=>{d(),ie(),de(),n(),c(),ae(),C(),D(),k=r(),A={type:`number`,options:{useMultipliers:!0,decimals:0}},j={total:{icon:s,count:e=>e?.total_subscribers??0},paid:{icon:a,count:e=>e?.paid_subscribers??0},free:{icon:i,count:e=>e?.email_subscribers??0},social:{icon:o,count:e=>e?.social_followers??0}}})),N,P,F,I,L,R,z,ge=e((()=>{N=`jpa/subscriber-highlights`,P=`Subscriber highlights`,F=`Your subscriber totals at a glance — total, paid, free, and social followers.`,I={content:`A summary of your subscribers — total, paid, free, and social followers.`},L=`subscribers`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function B({metrics:e}){return(0,H.jsx)(O,{attributes:{reportParams:u(),metrics:e}})}function V(){oe.removeQueries({queryKey:[`stats`,`subscribers-counts`]})}function _e({metrics:e,...t}){return(0,H.jsx)(me,{...t,widgetType:W,renderModule:U,renderComponent:O,attributes:{reportParams:u(!0),metrics:e}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{d(),g(),h(),fe(),f(),M(),D(),ge(),H=r(),ue(),U=`storybook/subscriber-highlights`,W=_(z,E),G={metrics:{control:`check`,options:T}},K={metrics:T},q={title:`Packages/Premium Analytics/Widgets/SubscriberHighlights`,component:O,tags:[`autodocs`],argTypes:{...G},parameters:{docs:{description:{component:"The \"Subscriber highlights\" widget. Shows current subscriber totals — total, paid, free, and social followers — as a grid of metric tiles. Which tiles appear is controlled by the `metrics` attribute (`relevance: 'high'`), exposed inline in the widget header and in the settings drawer. Data comes from the designated `useStatsSubscribersCounts` hook; in Storybook it is served by `registerReportMocks()` (the `subscribers/counts` handler). The counts module has no comparison period, so the tiles show bare counts."}}}},J={render:B,args:{...K},decorators:[y]},Y={render:B,args:{...K},tags:[`!autodocs`],decorators:[y],beforeEach:()=>(V(),p(`subscribers/counts`,`loading`),()=>{p(`subscribers/counts`,null),V()})},X={render:B,args:{...K},tags:[`!autodocs`],decorators:[y],beforeEach:()=>(V(),p(`subscribers/counts`,`error`),()=>{p(`subscribers/counts`,null),V()})},Z={render:B,args:{...K},tags:[`!autodocs`],decorators:[y],beforeEach:()=>(V(),p(`subscribers/counts`,`empty`),()=>{p(`subscribers/counts`,null),V()})},Q={render:e=>(0,H.jsx)(_e,{...e}),args:{...pe,widgetWidth:1,widgetHeight:1,...K},argTypes:{...v,...G}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
