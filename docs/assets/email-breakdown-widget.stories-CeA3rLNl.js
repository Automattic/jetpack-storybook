import{i as e}from"./preload-helper-usAeo7Bx.js";import{c as t,n,t as r}from"./build-module-Da_5_6n_.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{A as a,t as o}from"./build-module-DrryaqBL.js";import{t as s,x as c}from"./build-module-Nbr4nybP.js";import{o as l}from"./build-module-BBZHmQRP.js";import{Zt as u,n as d}from"./build-module-DmVuor49.js";import{t as f}from"./geo-chart-DoQpNLxw.js";import{t as p,u as m}from"./build-module-BIEX-HpI.js";import{bt as h,dt as g,er as _,ir as v,v as y,xt as b}from"./chart-tooltip-Cp0t5VrC.js";import{n as ee,t as te}from"./with-chart-theme-B4MzXVOY.js";import{t as ne}from"./leaderboard-chart-Bq1M4myf.js";import{H as re,M as ie,P as x,R as ae,j as oe,w as se}from"./report-metric-CT0V0PjD.js";import{t as ce}from"./widget-state-CY1w3xno.js";import{C as le,S as ue,T as de,b as fe,t as pe,w as me,x as S}from"./src-BJoM39-b.js";import{n as C,t as he}from"./src-CfVJQ17A.js";var w,T,E,D,O,k,A,j,M,N,ge=e((()=>{w=`_root_1np1d_1`,T=`_content_1np1d_10`,E=`_locationContent_1np1d_20`,D=`_leaderboard_1np1d_29`,O=`_map_1np1d_36`,k=`_label_1np1d_58`,A=`_flag_1np1d_72`,j=`_labelText_1np1d_79`,M=`_labelLink_1np1d_91`,N={root:w,content:T,locationContent:E,leaderboard:D,map:O,label:k,flag:A,labelText:j,labelLink:M}}));function P(e){return(e?.data?.[0]?.items??[]).map(e=>({label:String(e.label??``),value:e.value,countryCode:e.countryCode,countryFull:e.countryFull?String(e.countryFull):void 0,link:e.link}))}function _e({postId:e,view:t,metric:n,max:r}){let i=t===`links`,o=i?`country`:F[t],s=b(e,o,{enabled:!i&&n===`opens`}),c=h(e,o,{enabled:!i&&n===`clicks`}),l=h(e,`link`,{enabled:i}),u=h(e,`user-content-link`,{enabled:i}),d=n===`clicks`?c:s,f=i?[l,u]:[d],p=l.data,m=u.data,g=d.data,_=(0,a.useMemo)(()=>(i?[...P(p).filter(e=>!e.link),...P(m).filter(e=>!!e.link)].sort(v):P(g)).map((e,t)=>({...e,id:t})),[i,p,m,g]);return{allRows:_,rows:(0,a.useMemo)(()=>_.slice(0,r>0?r:void 0),[_,r]),isLoading:f.some(e=>e.isLoading),isFetching:f.some(e=>e.isFetching),isError:f.some(e=>e.isError&&e.data===void 0),refetch:()=>f.forEach(e=>e.refetch())}}var F,ve=e((()=>{g(),o(),F={countries:`country`,devices:`device`,clients:`client`}}));function ye(e,t){return[[n(`Country`,`jetpack-premium-analytics`),n(t===`clicks`?`Clicks`:`Opens`,`jetpack-premium-analytics`)],...e.filter(e=>!!e.countryCode).map(e=>[e.countryCode,e.value])]}function be(e,r){let i=Math.max(...e.map(e=>e.value),0);return e.map(e=>{let a;if(r===`countries`){let r=e.countryCode?y(e.countryCode):null;a=(0,L.jsx)(`div`,{className:N.label,children:(0,L.jsx)(se,{label:e.label,imageUrl:r??void 0,imageAlt:t(n(`Flag of %s`,`jetpack-premium-analytics`),e.countryFull??e.label),imageClassName:N.flag})})}else if(r===`links`){let t=l(e.link);a=t?(0,L.jsx)(m,{className:N.labelLink,href:t,variant:`unstyled`,openInNewTab:!0,title:e.label,children:e.label}):(0,L.jsx)(`span`,{className:N.labelText,title:e.label,children:e.label})}else a=(0,L.jsx)(`span`,{className:N.labelText,title:e.label,children:e.label});return{id:String(e.id),label:a,currentValue:e.value,currentShare:i>0?e.value/i*100:0,previousValue:0,previousShare:0,delta:0}})}function xe(e){switch(e){case`devices`:return n(`No device data for this email yet.`,`jetpack-premium-analytics`);case`clients`:return n(`No email client data for this email yet.`,`jetpack-premium-analytics`);case`links`:return n(`No link clicks for this email yet.`,`jetpack-premium-analytics`);default:return n(`No country data for this email yet.`,`jetpack-premium-analytics`)}}function Se(e){let t=typeof e==`number`?e:Number.parseInt(e??``,10);return Number.isInteger(t)&&t>0?t:0}function Ce({view:e,metric:t,max:n,showMap:r}){let{reportParams:i}=re(),a=Se(i.post_id),{allRows:o,rows:s,isLoading:c,isFetching:l,isError:u,refetch:d}=_e({postId:a,view:e,metric:t,max:n});return(0,L.jsx)(we,{rows:s,mapRows:o,view:e,showMap:r,metric:t,isLoading:c,isFetching:l,isError:u,hasEmail:a>0,onRetry:d})}function I({attributes:e={}}){return(0,L.jsx)(ae,{attributes:e,children:(0,L.jsx)(Ce,{view:e.view??`countries`,metric:e.metric??`opens`,max:e.max??10,showMap:e.showMap??!1})})}var L,R,z,we,Te=e((()=>{pe(),s(),o(),r(),d(),p(),ge(),ve(),L=i(),R={type:`number`,options:{useMultipliers:!0,decimals:0}},z=720,we=({rows:e=[],mapRows:t=e,view:r=`countries`,showMap:i=!1,metric:o=`opens`,isLoading:s=!1,isFetching:l=!1,isError:d=!1,hasEmail:p=!0,onRetry:m})=>{let h=(0,a.useMemo)(()=>be(e,r),[e,r]),g=(0,a.useMemo)(()=>ye(t,o),[t,o]),[_,v]=(0,a.useState)(),y=c(e=>{let t=e[0]?.contentRect;if(t){let e=Math.round(t.width);v(t=>t===e?t:e)}}),b=i&&r===`countries`&&g.length>1&&(_??0)>=z;return(0,L.jsx)(`div`,{ref:y,className:N.root,children:(0,L.jsx)(ce,{isLoading:s,isFetching:l,isError:d,isEmpty:e.length===0,error:{description:n(`We couldn't load this email's breakdown. Please try again in a moment.`,`jetpack-premium-analytics`),actions:m?[{label:n(`Retry`,`jetpack-premium-analytics`),onClick:m}]:void 0},empty:{icon:u,description:p?xe(r):n(`Select an email to see its breakdown.`,`jetpack-premium-analytics`)},children:(0,L.jsxs)(`div`,{className:b?N.locationContent:N.content,children:[(0,L.jsx)(ne,{className:N.leaderboard,data:h,withComparison:!1,withOverlayLabel:!0,showLegend:!1,dataFormat:R}),b&&(0,L.jsx)(`div`,{className:N.map,"data-testid":`email-breakdown-map`,children:(0,L.jsx)(f,{data:g})})]})})})}})),B,Ee=e((()=>{r(),d(),he(),B={name:`jpa/email-breakdown`,title:n(`Email breakdown`,`jetpack-premium-analytics`),help:{content:n(`Breaks a sent email down by countries, devices, email clients, or clicked links.`,`jetpack-premium-analytics`)},icon:u,attributes:[{id:`view`,label:n(`Break down by`,`jetpack-premium-analytics`),type:`text`,Edit:C,elements:[{label:n(`Countries`,`jetpack-premium-analytics`),value:`countries`},{label:n(`Devices`,`jetpack-premium-analytics`),value:`devices`},{label:n(`Email clients`,`jetpack-premium-analytics`),value:`clients`},{label:n(`Links`,`jetpack-premium-analytics`),value:`links`}]},{id:`metric`,label:n(`Metric`,`jetpack-premium-analytics`),type:`text`,Edit:C,elements:[{label:n(`Opens`,`jetpack-premium-analytics`),value:`opens`},{label:n(`Clicks`,`jetpack-premium-analytics`),value:`clicks`}],isVisible:({view:e})=>e!==`links`},{id:`max`,label:n(`Number of results`,`jetpack-premium-analytics`),type:`integer`}],example:{attributes:{view:`countries`,metric:`opens`,max:10}}}}));function De(e){return B.attributes.find(t=>t.id===e)?.elements?.map(e=>e.value)??[]}function Oe({view:e,metric:t,showMap:n}){return(0,H.jsx)(I,{attributes:{reportParams:{..._(),post_id:U},view:e,metric:t,showMap:n}})}function V(e){return(0,H.jsx)(I,{attributes:{reportParams:{..._(!1),post_id:e},view:`countries`,metric:`opens`}})}function ke({view:e,metric:t,showMap:n,...r}){return(0,H.jsx)(le,{...r,widgetType:{...B,presentation:`framed`},renderModule:Ae,renderComponent:I,attributes:{reportParams:{..._(!0),post_id:U},view:e,metric:t,showMap:n}})}var H,Ae,U,W,G,je,K,q,J,Y,X,Z,Q,$;e((()=>{g(),oe(),te(),me(),fe(),Te(),Ee(),H=i(),ie(),Ae=`storybook/email-breakdown`,U=1234,W=De(`view`),G=De(`metric`),je={title:`Packages/Premium Analytics/Widgets/EmailBreakdown`,component:I,tags:[`autodocs`],argTypes:{view:{control:`select`,options:W},metric:{control:`select`,options:G},showMap:{control:`boolean`}},parameters:{docs:{description:{component:"The \"Email breakdown\" widget. Breaks a single sent email down by countries, devices, email clients, or clicked links, rendered as a leaderboard. The `view` attribute (`relevance: 'high'`) is exposed as a control by the widget host; the `metric` attribute picks the opens or clicks breakdown for the dimension views, while `links` always reads the clicks breakdown (merging internal link types with clicked user-content links, like the Calypso links module). Scoped to one email via a mocked `reportParams.post_id`. The email breakdown endpoints have no comparison period, so the widget renders without deltas."}}},decorators:[ee]},K={render:Oe,args:{view:`countries`,metric:`opens`,showMap:!1},decorators:[S]},q={render:Oe,args:{view:`countries`,metric:`clicks`,showMap:!0},decorators:[S]},J={render:()=>V(5601),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(x(`stats/opens/emails`,`loading`),()=>x(`stats/opens/emails`,null))},Y={render:()=>V(5602),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(x(`stats/opens/emails`,`error`),()=>x(`stats/opens/emails`,null))},X={render:()=>V(5603),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(x(`stats/opens/emails`,`empty`),()=>x(`stats/opens/emails`,null))},Z={render:()=>(0,H.jsx)(I,{attributes:{reportParams:_(!1),view:`countries`}}),decorators:[S]},Q={render:e=>(0,H.jsx)(ke,{...e}),args:{...ue,view:`countries`,metric:`opens`,showMap:!1},argTypes:{...de,view:{control:`select`,options:W},metric:{control:`select`,options:G},showMap:{control:`boolean`}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
