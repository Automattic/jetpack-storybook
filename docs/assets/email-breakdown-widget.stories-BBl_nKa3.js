import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n,u as r}from"./build-module-DQ5lAs4a.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{N as a,t as o}from"./build-module-DMs68Vfd.js";import{Ts as s,n as c}from"./build-module-Bt8gOW8e.js";import{t as l,u}from"./build-module-BAze1CUO.js";import{Kn as d,Xn as ee,_t as te,gt as f,ut as p,y as m}from"./chart-tooltip-ClIvRUzH.js";import{n as h,t as g}from"./with-chart-theme-hMJqwUpU.js";import{t as ne}from"./leaderboard-chart-D4uyqD7q.js";import{E as re,S as ie,g as ae}from"./report-metric-C9QRZwAo.js";import{i as _,n as v,t as oe}from"./register-report-mocks-CEOd2Lr0.js";import{t as se}from"./widget-state-CkRqQWXE.js";import{S as ce,b as le,t as y,x as ue,y as de}from"./src-DeeVzTNc.js";var b,x,S,C,w,T,E,fe=e((()=>{b=`_root_ssfjg_1`,x=`_leaderboard_ssfjg_10`,S=`_label_ssfjg_19`,C=`_flag_ssfjg_33`,w=`_labelText_ssfjg_40`,T=`_labelLink_ssfjg_52`,E={root:b,leaderboard:x,label:S,flag:C,labelText:w,labelLink:T}}));function D(e){return(e?.data?.[0]?.items??[]).map(e=>({label:String(e.label??``),value:e.value,countryCode:e.countryCode,countryFull:e.countryFull?String(e.countryFull):void 0,link:e.link}))}function pe({postId:e,view:t,metric:n,max:r}){let i=t===`links`,o=i?`country`:O[t],s=te(e,o,{enabled:!i&&n===`opens`}),c=f(e,o,{enabled:!i&&n===`clicks`}),l=f(e,`link`,{enabled:i}),u=f(e,`user-content-link`,{enabled:i}),d=n===`clicks`?c:s,p=i?[l,u]:[d],m=l.data,h=u.data,g=d.data;return{rows:(0,a.useMemo)(()=>(i?[...D(m).filter(e=>!e.link),...D(h).filter(e=>!!e.link)].sort(ee):D(g)).slice(0,r>0?r:void 0).map((e,t)=>({...e,id:t})),[i,m,h,g,r]),isLoading:p.some(e=>e.isLoading),isFetching:p.some(e=>e.isFetching),isError:p.some(e=>e.isError&&e.data===void 0),refetch:()=>p.forEach(e=>e.refetch())}}var O,me=e((()=>{p(),o(),O={countries:`country`,devices:`device`,clients:`client`}}));function he(e){if(!e)return null;try{let{protocol:t}=new URL(e);return t===`http:`||t===`https:`?e:null}catch{return null}}function ge(e,n){let i=Math.max(...e.map(e=>e.value),0);return e.map(e=>{let a;if(n===`countries`){let n=e.countryCode?m(e.countryCode):null;a=(0,j.jsx)(`div`,{className:E.label,children:(0,j.jsx)(ae,{label:e.label,imageUrl:n??void 0,imageAlt:r(t(`Flag of %s`,`jetpack-premium-analytics`),e.countryFull??e.label),imageClassName:E.flag})})}else if(n===`links`){let t=he(e.link);a=t?(0,j.jsx)(u,{className:E.labelLink,href:t,variant:`unstyled`,openInNewTab:!0,title:e.label,children:e.label}):(0,j.jsx)(`span`,{className:E.labelText,title:e.label,children:e.label})}else a=(0,j.jsx)(`span`,{className:E.labelText,title:e.label,children:e.label});return{id:String(e.id),label:a,currentValue:e.value,currentShare:i>0?e.value/i*100:0,previousValue:0,previousShare:0,delta:0}})}function _e(e){switch(e){case`devices`:return t(`No device data for this email yet.`,`jetpack-premium-analytics`);case`clients`:return t(`No email client data for this email yet.`,`jetpack-premium-analytics`);case`links`:return t(`No link clicks for this email yet.`,`jetpack-premium-analytics`);default:return t(`No country data for this email yet.`,`jetpack-premium-analytics`)}}function k(e){let t=typeof e==`number`?e:Number.parseInt(e??``,10);return Number.isInteger(t)&&t>0?t:0}function ve({view:e,metric:t,max:n}){let{reportParams:r}=re(),i=k(r.post_id),{rows:a,isLoading:o,isFetching:s,isError:c,refetch:l}=pe({postId:i,view:e,metric:t,max:n});return(0,j.jsx)(N,{rows:a,view:e,isLoading:o,isFetching:s,isError:c,hasEmail:i>0,onRetry:l})}function A({attributes:e={}}){return(0,j.jsx)(ie,{attributes:e,children:(0,j.jsx)(ve,{view:e.view??`countries`,metric:e.metric??`opens`,max:e.max??10})})}var j,M,N,P=e((()=>{y(),o(),n(),c(),l(),fe(),me(),j=i(),M={type:`number`,options:{useMultipliers:!0,decimals:0}},N=({rows:e=[],view:n=`countries`,isLoading:r=!1,isFetching:i=!1,isError:o=!1,hasEmail:c=!0,onRetry:l})=>{let u=(0,a.useMemo)(()=>ge(e,n),[e,n]);return(0,j.jsx)(`div`,{className:E.root,children:(0,j.jsx)(se,{isLoading:r,isFetching:i,isError:o,isEmpty:e.length===0,error:{description:t(`We couldn't load this email's breakdown. Please try again in a moment.`,`jetpack-premium-analytics`),actions:l?[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:l}]:void 0},empty:{icon:s,description:c?_e(n):t(`Select an email to see its breakdown.`,`jetpack-premium-analytics`)},children:(0,j.jsx)(ne,{className:E.leaderboard,data:u,withComparison:!1,withOverlayLabel:!0,showLegend:!1,dataFormat:M})})})}})),F,ye=e((()=>{n(),c(),F={name:`jpa/email-breakdown`,title:t(`Email breakdown`,`jetpack-premium-analytics`),help:{content:t(`Breaks a sent email down by countries, devices, email clients, or clicked links.`,`jetpack-premium-analytics`)},icon:s,attributes:[{id:`view`,label:t(`Break down by`,`jetpack-premium-analytics`),type:`text`,elements:[{label:t(`Countries`,`jetpack-premium-analytics`),value:`countries`},{label:t(`Devices`,`jetpack-premium-analytics`),value:`devices`},{label:t(`Email clients`,`jetpack-premium-analytics`),value:`clients`},{label:t(`Links`,`jetpack-premium-analytics`),value:`links`}],relevance:`high`},{id:`metric`,label:t(`Metric`,`jetpack-premium-analytics`),type:`text`,elements:[{label:t(`Opens`,`jetpack-premium-analytics`),value:`opens`},{label:t(`Clicks`,`jetpack-premium-analytics`),value:`clicks`}],isVisible:({view:e})=>e!==`links`},{id:`max`,label:t(`Number of results`,`jetpack-premium-analytics`),type:`integer`}],example:{attributes:{view:`countries`,metric:`opens`,max:10}}}}));function I(e){return F.attributes.find(t=>t.id===e)?.elements?.map(e=>e.value)??[]}function L({withComparison:e,view:t,metric:n}){return(0,z.jsx)(A,{attributes:{reportParams:{...d(e),post_id:V},view:t,metric:n}})}function R(e){return(0,z.jsx)(A,{attributes:{reportParams:{...d(!1),post_id:e},view:`countries`,metric:`opens`}})}function be({withComparison:e,view:t,metric:n,...r}){return(0,z.jsx)(le,{...r,widgetType:{...F,presentation:`framed`},renderModule:B,renderComponent:A,attributes:{reportParams:{...d(e),post_id:V},view:t,metric:n}})}var z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{p(),oe(),g(),ue(),P(),ye(),z=i(),v(),B=`storybook/email-breakdown`,V=1234,H=I(`view`),U=I(`metric`),W=e=>(0,z.jsx)(`div`,{style:{width:`100%`,height:`320px`},children:(0,z.jsx)(e,{})}),G={title:`Packages/Premium Analytics/Widgets/EmailBreakdown`,component:A,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`},view:{control:`select`,options:H},metric:{control:`select`,options:U}},parameters:{docs:{description:{component:"The \"Email breakdown\" widget. Breaks a single sent email down by countries, devices, email clients, or clicked links, rendered as a leaderboard. The `view` attribute (`relevance: 'high'`) is exposed as a control by the widget host; the `metric` attribute picks the opens or clicks breakdown for the dimension views, while `links` always reads the clicks breakdown (merging internal link types with clicked user-content links, like the Calypso links module). Scoped to one email via a mocked `reportParams.post_id`. These endpoints have no comparison period, so the widget renders without deltas even when the date picker injects comparison params."}}},decorators:[h]},K={render:L,args:{withComparison:!1,view:`countries`,metric:`opens`},decorators:[W]},q={render:L,args:{withComparison:!0,view:`countries`,metric:`opens`},decorators:[W]},J={render:()=>R(5601),tags:[`!autodocs`],decorators:[W],beforeEach:()=>(_(`stats/opens/emails`,`loading`),()=>_(`stats/opens/emails`,null))},Y={render:()=>R(5602),tags:[`!autodocs`],decorators:[W],beforeEach:()=>(_(`stats/opens/emails`,`error`),()=>_(`stats/opens/emails`,null))},X={render:()=>R(5603),tags:[`!autodocs`],decorators:[W],beforeEach:()=>(_(`stats/opens/emails`,`empty`),()=>_(`stats/opens/emails`,null))},Z={render:()=>(0,z.jsx)(A,{attributes:{reportParams:d(!1),view:`countries`}}),decorators:[W]},Q={render:e=>(0,z.jsx)(be,{...e}),args:{...de,withComparison:!0,view:`countries`,metric:`opens`},argTypes:{...ce,withComparison:{control:`boolean`},view:{control:`select`,options:H},metric:{control:`select`,options:U}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
