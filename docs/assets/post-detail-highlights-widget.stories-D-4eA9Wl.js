import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as i,t as a}from"./build-module-CbwHEf9N.js";import{Ht as o,On as s,_c as c,ll as l,n as u}from"./build-module-CDRs4YxF.js";import{$ as d,G as f,K as p,rt as ee}from"./report-metric-CZGk3pJU.js";import{M as te,t as m}from"./src-BKLK-O8P.js";import{Gt as h,pn as ne,t as g,ut as _}from"./src-DCbi8ow8.js";import{v}from"./chart-tooltip-mdsQYAXX.js";import{r as re,t as ie}from"./metric-tile-grid-skeleton-C3Qi2AZE.js";import{t as ae}from"./widget-state-CEIPGY-o.js";import{C as oe,D as se,E as y,S as b,T as ce,b as x,t as S,w as le,x as C}from"./src-BenUPZSz.js";var w,T,E=e((()=>{w=`_root_owpvf_1`,T={root:w}}));function D(e,t,n){let r=0;for(let i of e)i.date>=t&&i.date<=n&&(r+=i.views);return r}function O(e,t){let{data:n,isLoading:r,isFetching:a,isError:o,refetch:s}=_({postId:e,fields:[`data`,`like_count`,`post`]});return{...(0,i.useMemo)(()=>{let e=n?.data??[],r=v(t.from),i=v(t.to),a=v(t.compare_from),o=v(t.compare_to),s=t.comp===`1`,c=r&&i?D(e,r,i):e.reduce((e,t)=>e+t.views,0),l;return s&&(l=a&&o?D(e,a,o):null),{views:c,viewsPrevious:l,comments:n?.post?.comment_count??0,likes:n?.like_count??0,hasComparison:s}},[n,t.comp,t.from,t.to,t.compare_from,t.compare_to]),isLoading:r,isFetching:a,isError:o,hasData:!!n,refetch:s}}var k=e((()=>{g(),S(),a()}));function A(){let{reportParams:e}=ee(),n=ne(e.post_id),{views:r,viewsPrevious:a,comments:l,likes:u,hasComparison:d,isLoading:f,isFetching:p,isError:m,hasData:h,refetch:g}=O(n,e),_=(0,i.useMemo)(()=>[{key:`views`,label:t(`Views`,`jetpack-premium-analytics-pkg`),icon:s,value:r,previousValue:a,note:t(`Views in the selected date range.`,`jetpack-premium-analytics-pkg`)},{key:`likes`,label:t(`Likes`,`jetpack-premium-analytics-pkg`),icon:o,value:u,previousValue:d?null:void 0,note:P()},{key:`comments`,label:t(`Comments`,`jetpack-premium-analytics-pkg`),icon:c,value:l,previousValue:d?null:void 0,note:P()}],[r,a,l,u,d]);return(0,M.jsx)(`div`,{className:T.root,children:(0,M.jsx)(ae,{isLoading:f&&!h,isFetching:p,isError:!h&&m,isEmpty:n<=0,error:{description:t(`We couldn't load this post's highlights. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:g}]},empty:{icon:te,description:t(`Open a post or page report to see its highlights here.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,M.jsx)(ie,{tiles:_.length}),children:(0,M.jsx)(re,{tiles:_,dataFormat:N})})})}function j({attributes:e={}}){return(0,M.jsx)(d,{attributes:e,children:(0,M.jsx)(A,{})})}var M,N,P,ue=e((()=>{g(),m(),S(),a(),n(),u(),E(),k(),M=r(),N={type:`number`,options:{useMultipliers:!0,decimals:0}},P=()=>t(`All-time total — this metric has no per-post history.`,`jetpack-premium-analytics-pkg`)})),F,de=e((()=>{u(),F={icon:l,attributes:[],example:{attributes:{}}}})),I,L,R,z,B,V,H,fe=e((()=>{I=`jpa/post-detail-highlights`,L=`Post highlights`,R=`Views, comments, and likes for the post or page being viewed.`,z={content:`Views, comments, and likes for the post or page being viewed.`},B=`stats`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function U({withComparison:e,hasPostScope:t}){return{reportParams:{...h(e),...t?{post_id:K}:{}}}}function W(e){return(0,G.jsx)(j,{attributes:U(e)})}function pe({withComparison:e,hasPostScope:t,...n}){return(0,G.jsx)(ce,{...n,widgetType:b(H,F),renderModule:q,renderComponent:j,attributes:U({withComparison:e,hasPostScope:t})})}var G,K,q,J,Y,X,Z,Q,$;e((()=>{g(),f(),y(),oe(),x(),ue(),de(),fe(),G=r(),p(),K=779,q=`storybook/post-detail-highlights`,J={title:`Packages/Premium Analytics/Widgets/PostDetailHighlights`,component:j,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}},parameters:{docs:{description:{component:`The "Post highlights" widget: the scoped post's views, comments, and likes as metric tiles — the post detail Traffic view's highlights card. Views is period-scoped and carries a delta when comparison is on; comments and likes are lifetime totals with no per-post history, so their tiles show a note instead of a delta. Without a post scope the widget renders a scopeless empty state.`}}}},Y={render:W,args:{withComparison:!1,hasPostScope:!0},decorators:[C]},X={render:W,args:{withComparison:!0,hasPostScope:!0},decorators:[C]},Z={render:W,args:{withComparison:!1,hasPostScope:!1},decorators:[C]},Q={render:e=>(0,G.jsx)(pe,{...e}),args:{...le,widgetWidth:4,widgetHeight:1,withComparison:!0,hasPostScope:!0},argTypes:{...se,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}}},Y.parameters={...Y.parameters,docs:{...Y.parameters?.docs,source:{originalSource:`{
