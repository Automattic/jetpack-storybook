import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-Dc9vccxP.js";import{i as r,n as i,r as a,t as o}from"./blocks-AMzEaZ-D.js";import{t as s}from"./mdx-react-shim-CsonYCkT.js";import{Animation as c,AspectRatio as l,CurveTypes as u,Default as d,ErrorStates as f,PercentageStack as p,SingleSeries as m,Streamgraph as h,Unstacked as g,WithCompositionLegend as _,WithDefaultHiddenSeries as v,Zoomable as y,n as b,t as x}from"./index.stories-BQ0JxTy7.js";function S(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(i,{title:`JS Packages/Charts Library/Charts/Area Chart`,of:x}),`
...
`,(0,w.jsxs)(t.p,{children:[`Use `,(0,w.jsx)(t.code,{children:`defaultHiddenSeries`}),` to hide selected series initially while keeping them available through an interactive legend. The first defined list is used; later values for the same `,(0,w.jsx)(t.code,{children:`chartId`}),` are ignored. User changes persist until the chart remounts or its ID changes.`]}),`
`,(0,w.jsx)(o,{of:v}),`
