import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DQ5lAs4a.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{c as i,n as a}from"./build-module-Bt8gOW8e.js";import{R as o,t as s,u as c}from"./build-module-BAze1CUO.js";import{Kn as l,ft as u,ut as d}from"./chart-tooltip-ClIvRUzH.js";import{t as f}from"./chart-empty-state-4wWcyzeU.js";import{E as ee,S as p}from"./report-metric-C9QRZwAo.js";import{i as m,n as te,t as h}from"./register-report-mocks-CEOd2Lr0.js";import{t as g}from"./widget-state-CkRqQWXE.js";import{S as _,b as v,t as y,x as b,y as x}from"./src-DeeVzTNc.js";var S,C,w,T,E,D,O=e((()=>{S=`_root_1yikk_1`,C=`_content_1yikk_11`,w=`_list_1yikk_24`,T=`_item_1yikk_32`,E=`_link_1yikk_41`,D={root:S,content:C,list:w,item:T,link:E}}));function k(e){let t=typeof e==`number`?e:Number.parseInt(e??``,10);return Number.isInteger(t)&&t>0?t:NaN}function A({pages:e}){return(0,N.jsx)(`ul`,{className:D.list,children:e.map((e,t)=>(0,N.jsx)(`li`,{className:D.item,children:(0,N.jsx)(c,{className:D.link,href:e.link,variant:`unstyled`,openInNewTab:!0,title:e.label,children:e.label})},`${t}-${e.link}`))})}function j(){let{reportParams:e}=ee(),n=k(e.post_id),{data:r,isLoading:a,isFetching:s,isError:c,refetch:l}=u(n,e),d;if(!Number.isInteger(n))d=(0,N.jsx)(f,{icon:i,text:t(`Select a video to see where it is embedded across your site.`,`jetpack-premium-analytics`)});else{let e=r?.pages??[];d=(0,N.jsx)(g,{isLoading:a,isFetching:s,isError:e.length===0&&c,isEmpty:e.length===0,error:{description:t(`We couldn't load video embeds. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:()=>void l()}]},empty:{icon:i,description:t(`This video has not been embedded on any pages yet.`,`jetpack-premium-analytics`)},children:(0,N.jsx)(A,{pages:e})})}return(0,N.jsx)(o,{className:D.root,children:(0,N.jsx)(`div`,{className:D.content,children:d})})}function M({attributes:e={}}){return(0,N.jsx)(p,{attributes:e,children:(0,N.jsx)(j,{})})}var N,P=e((()=>{d(),y(),n(),a(),s(),O(),N=r()})),F,ne=e((()=>{n(),a(),F={name:`jpa/video-detail-embeds`,title:t(`Video embeds`,`jetpack-premium-analytics`),help:{content:t(`Lists every page on your site where the selected video is embedded, so you can see where it is being watched.`,`jetpack-premium-analytics`),links:[{label:t(`Learn more`,`jetpack-premium-analytics`),href:`https://jetpack.com/support/jetpack-stats/`}]},icon:i}}));function I(e,t){return{...l(e,t),post_id:U}}function L({withComparison:e}){return(0,B.jsx)(M,{attributes:{reportParams:I(e)}})}function R(e){return(0,B.jsx)(M,{attributes:{reportParams:I(!1,e)}})}function z({withComparison:e,...t}){return(0,B.jsx)(v,{...t,widgetType:F,renderModule:V,renderComponent:M,attributes:{reportParams:I(e)}})}var B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{d(),h(),b(),P(),ne(),B=r(),te(),V=`storybook/video-detail-embeds`,H=`stats/video/`,U=105,W=e=>(0,B.jsx)(`div`,{style:{width:`380px`,height:`520px`,margin:`0 auto`,padding:`16px`,boxSizing:`border-box`,background:`#fff`,border:`1px solid #e0e0e0`,borderRadius:`8px`,overflow:`hidden`},children:(0,B.jsx)(e,{})}),G={title:`Packages/Premium Analytics/Widgets/VideoDetailEmbeds`,component:M,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`}},parameters:{docs:{description:{component:"Dashboard widget listing the pages where a single video is embedded, sourced from the Jetpack Stats `stats/video/%d` module via `useStatsSingleVideo`. The widget is scoped to one video through the host-composed `reportParams.post_id`; without one it prompts to select a video. The single-video module has no comparison data, so the `WithComparison` control only exercises that the widget still renders normally when comparison params are present. In Storybook the data is served by `registerReportMocks`."}}}},K={render:L,args:{withComparison:!1},decorators:[W]},q={render:L,args:{withComparison:!0},decorators:[W]},J={render:()=>(0,B.jsx)(M,{attributes:{reportParams:l(!1)}}),decorators:[W]},Y={render:()=>R(`last-90-days`),tags:[`!autodocs`],decorators:[W],beforeEach:()=>(m(H,`loading`),()=>m(H,null))},X={render:()=>R(`last-7-days`),tags:[`!autodocs`],decorators:[W],beforeEach:()=>(m(H,`error`),()=>m(H,null))},Z={render:()=>R(`last-365-days`),tags:[`!autodocs`],decorators:[W],beforeEach:()=>(m(H,`empty`),()=>m(H,null))},Q={render:e=>(0,B.jsx)(z,{...e}),args:{...x,withComparison:!0},argTypes:{..._,withComparison:{control:`boolean`}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
