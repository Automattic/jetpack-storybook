...
`}}},L=g.bind({}),L.args={...u,showLegend:!0,smoothing:!1,data:[{...o[0],label:`New York`},{...o[1],label:`New York last year`,group:`new-york`,options:{type:`comparison`}},{...o[2],label:`Tokyo`},{...o[3],label:`Tokyo last year`,group:`tokyo`,options:{type:`comparison`}}]},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`args => {
  ...
  return <LineChart {...chartProps} {...dimensions} data={data} legend={legend} withTooltipCrosshairs={crosshairConfig} />;
}`,...L.parameters?.docs?.source}}},R=[`Default`,`Zoomable`,`FixedDimensions`,`AspectRatio`,`SingleSeries`,`ManySeries`,`Animation`,`WithLegend`,`WithCompositionLegend`,`GradientFilled`,`GradientCustomColors`,`GradientTransparent`,`ErrorStates`,`WithoutSmoothing`,`WithPointerEvents`,`CurveTypes`,`SmartFormatting`,`BrokenLine`,`DateStringFormats`,`Comparison`]}));z();export{C as Animation,b as AspectRatio,F as BrokenLine,L as Comparison,M as CurveTypes,I as DateStringFormats,_ as Default,k as ErrorStates,y as FixedDimensions,D as GradientCustomColors,E as GradientFilled,O as GradientTransparent,S as ManySeries,x as SingleSeries,N as SmartFormatting,T as WithCompositionLegend,w as WithLegend,j as WithPointerEvents,A as WithoutSmoothing,v as Zoomable,R as __namedExportsOrder,h as default,z as n,p as t};