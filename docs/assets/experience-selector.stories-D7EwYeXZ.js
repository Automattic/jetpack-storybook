import{n as e}from"./chunk-zsgVPwQN.js";import{Cd as t,Ha as n,Td as r,_x as i,bd as a,eu as o,gx as s,px as c,ud as l,wd as u}from"./iframe-BfgWixbs.js";import{c as d,i as f,l as p,n as m,o as h,r as g,s as _,t as v}from"./experience-option-ms2uonrL.js";var y=e((()=>{}));function b(){let{isUpdating:e,supportsOnlyClassicSearch:t,isWpcom:n,blockOverlayEnabled:r}=a(e=>({isUpdating:e(_).isUpdatingJetpackSettings(),supportsOnlyClassicSearch:e(_).supportsOnlyClassicSearch(),isWpcom:e(_).isWpcom(),blockOverlayEnabled:e(_).isBlockOverlayEnabled()}),[]),s=f.filter(e=>!(e===g.OFF&&n||e===g.OVERLAY_BLOCKS&&!r)),c=n=>e||t&&(n===g.EMBEDDED||n===g.OVERLAY||n===g.OVERLAY_BLOCKS);return(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`h2`,{id:`jp-search-experience-selector-heading`,className:`jp-search-experience-selector__heading`,children:i(`Select a search experience for your visitors`,`jetpack-search-pkg`)}),(0,x.jsx)(`div`,{className:`jp-search-experience-selector`,children:(0,x.jsx)(`fieldset`,{className:`jp-search-experience-selector__fieldset`,"aria-labelledby":`jp-search-experience-selector-heading`,children:(0,x.jsx)(o,{columns:[1,2],gap:6,children:s.map(e=>(0,x.jsx)(v,{experience:e,disabled:c(e)},e))})})})]})}var x,S=e((()=>{n(),l(),s(),d(),h(),m(),y(),x=c(),b.__docgenInfo={description:`Top-level dashboard control: a fieldset of cards. Inactive cards behave
