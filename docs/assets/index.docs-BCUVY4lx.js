import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-Bl-wt6oH.js";import{i as r,n as i,r as a,t as o}from"./blocks-DZC1wdyY.js";import{t as s}from"./mdx-react-shim-D91qv4VJ.js";import{Down as c,Neutral as l,Up as u,WithoutIcon as d,n as f,t as p}from"./index.stories-BcQpNnn_.js";function m(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(i,{title:`JS Packages/Charts Library/Components/Trend Indicator`,of:p}),`
...
them.`}),`
`,(0,g.jsxs)(t.p,{children:[`Used inside a `,(0,g.jsx)(t.code,{children:`GlobalChartsProvider`}),`, `,(0,g.jsx)(t.code,{children:`TrendIndicator`}),` resolves these from the provider's catalog, so set the override on the provider wrapper or on an element between it and `,(0,g.jsx)(t.code,{children:`TrendIndicator`}),` — see TOKENS.md for the full precedence order. Used standalone (no provider above it), `,(0,g.jsx)(t.code,{children:`TrendIndicator`}),` declares its own catalog on itself, so the override must target the `,(0,g.jsx)(t.code,{children:`TrendIndicator`}),` element directly — via the `,(0,g.jsx)(t.code,{children:`style`}),` prop, or a rule matching the `,(0,g.jsx)(t.code,{children:`className`}),` you pass it:`]}),`
`,(0,g.jsx)(a,{language:`tsx`,code:`<TrendIndicator
direction="up"
value="+12%"
className="my-custom-trend"
/>`}),`
`,(0,g.jsx)(a,{language:`css`,code:`/* Defaults shown — these resolve to the WPDS tokens below: */
.my-custom-trend {
...
`,(0,g.jsxs)(t.p,{children:[`Setting these on an ancestor of a standalone `,(0,g.jsx)(t.code,{children:`TrendIndicator`}),` has no effect: the component's own catalog declaration on itself always beats a value merely inherited from further up the tree. Make sure any custom colors meet contrast requirements.`]}),`
