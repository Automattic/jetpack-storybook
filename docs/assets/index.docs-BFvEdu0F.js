import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-DqHYKsKC.js";import{i as r,n as i,r as a,t as o}from"./blocks-BdaELp6e.js";import{t as s}from"./mdx-react-shim-DxgW15YS.js";import{Default as c,WithColorOverrides as l,n as u,t as d}from"./index.stories-CQPnCUCT.js";function f(e){let t={a:`a`,code:`code`,em:`em`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...n(),...e.components};return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(i,{title:`JS Packages/Charts Library/Chart Context`,of:d}),`
...
`,(0,m.jsxs)(t.p,{children:[(0,m.jsx)(t.strong,{children:`Colors are CSS, not JS.`}),` Every color a chart paints has a `,(0,m.jsx)(t.code,{children:`--a8c-charts-color-*`}),` catalog role behind it, declared anywhere inside the provider tree. The closest declaration wins, so scope a rule to one dashboard, or to `,(0,m.jsx)(t.code,{children:`.a8c-charts-scope`}),` to reach every chart on the page:`]}),`
...
`,(0,m.jsxs)(t.p,{children:[`Series colors work the same way, through the five `,(0,m.jsx)(t.code,{children:`--a8c-charts-color-series-*`}),` slots. See `,(0,m.jsx)(t.a,{href:`#the-series-palette`,children:`The Series Palette`}),`.`]}),`
`,(0,m.jsxs)(t.p,{children:[`The `,(0,m.jsx)(t.code,{children:`theme`}),` prop's matching color fields are deprecated and will be removed; `,(0,m.jsx)(t.code,{children:`TOKENS.md`}),` maps each one to the role that replaces it. What stays on `,(0,m.jsx)(t.code,{children:`theme`}),` is everything with no role behind it — `,(0,m.jsx)(t.code,{children:`tickLength`}),`, stroke widths, font weights, the heatmap's compact sizing, the annotation geometry:`]}),`
`,(0,m.jsx)(a,{language:`tsx`,code:`<GlobalChartsProvider theme={ { tickLength: 6 } }>
...
`,(0,m.jsx)(t.p,{children:`Access just the theme when you only need the non-color settings — sizing, weights, tick length. For colors, declare the catalog role on your own element instead: it inherits from the provider wrapper, so it already carries whatever the charts beside it are using, and it keeps following an override the theme snapshot would miss.`}),`
...
`,(0,m.jsx)(a,{language:`css`,code:`.my-panel {
