import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{D as i,S as a,i as o,l as s,r as c,t as l,u}from"./hooks-4klF9VS4.js";import{g as d,o as f,p,t as m}from"./src-Dw-SuLzD.js";import{k as h,t as g,u as _}from"./helpers-DzuAouaa.js";import{t as v}from"./leaderboard-chart-wkIDFZo1.js";import{c as y,i as b,n as x,s as S,t as C}from"./widget-loading-overlay-CNgYQ314.js";function w({view:e}){let{reportParams:t}=s(),{primary:n,hasComparison:r,isLoading:i,isFetching:o,hasData:l,isError:u,error:m,refetch:g}=a((0,T.useMemo)(()=>({...t,view:e}),[t,e])),y=i&&!l,b=o&&l,S=(0,T.useMemo)(()=>_(n.data),[n.data]),C=(0,T.useMemo)(()=>h(t),[t]),w=(0,T.useMemo)(()=>{switch(e){case`source`:return f;case`channel`:return p;case`campaign`:return d;default:return f}},[e]);return c(u,m,g)?null:y?(0,E.jsx)(x,{}):(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(v,{data:S,withComparison:r,legendLabels:C,emptyStateIcon:w,style:{"--a8c--charts--leaderboard--bar--border-radius":`0 1px 1px 0`}}),b&&(0,E.jsx)(x,{})]})}var T,E,D=t((()=>{u(),m(),T=e(n(),1),b(),C(),o(),g(),l(),E=r()})),O,k,A,j,M,N,P,F,I,L;t((()=>{u(),S(),D(),O=r(),k={title:`Packages/Premium Analytics/Widgets Toolkit/Widgets/SalesByUtm`,component:w,tags:[`autodocs`],decorators:[y(i(!0))],argTypes:{view:{control:`select`,options:[`source`,`channel`,`campaign`],description:`The order attribution view to display`}},parameters:{docs:{description:{component:`Displays a leaderboard chart showing sales breakdown by UTM parameters. Supports three views: source (referral source), channel (marketing channel), and campaign (campaign name).`}}}},A={args:{view:`source`}},j={args:{view:`channel`}},M={args:{view:`campaign`}},N=e=>t=>(0,O.jsx)(`div`,{style:{width:e,border:`1px dashed #ccc`,borderRadius:`8px`,padding:`16px`,background:`#fafafa`},children:(0,O.jsx)(t,{})}),P={args:{view:`source`},decorators:[N(`280px`)]},F={args:{view:`source`},decorators:[N(`448px`)]},I={args:{view:`source`},decorators:[N(`640px`)]},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: {
    view: 'source'
  }
