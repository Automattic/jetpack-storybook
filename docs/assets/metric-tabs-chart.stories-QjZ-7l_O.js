...
}`,..._.parameters?.docs?.source},description:{story:`On a short tile the chart is dropped and only the metric cards remain, so it
never collapses into an unreadable sliver.`,..._.parameters?.docs?.description}}},v=[`Default`,`SingleMetric`,`Loading`,`Compact`]}))();export{_ as Compact,m as Default,g as Loading,h as SingleMetric,v as __namedExportsOrder,p as default};