import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{i as r,n as i,t as a}from"./build-module-yGZutq_9.js";import{t as o}from"./jsx-runtime-D2pHJD-r.js";import{t as s,wl as c}from"./build-module-zwSmKorH.js";import{B as l,F as u,G as d,K as f,L as ee,P as te,Q as p,R as m,b as ne,dt as re,et as ie,g as h}from"./hooks-DeRGi1OL.js";import{M as ae,t as g}from"./src-DFNM1k7F.js";import{G as oe,j as _,m as se,p as v,t as y,u as ce}from"./src-B477hvom.js";import{Dn as le,en as ue,i as b,yt as de}from"./date-filters-panel-UPAwjp15.js";import{r as fe}from"./metric-sparkline-skeleton-BjwlzuBr.js";import{t as pe}from"./monthly-heatmap-BomnxVKw.js";import{i as me,r as he,s as x}from"./register-report-mocks-CpSYqE4D.js";import{t as ge}from"./widget-state-wm0v4KGK.js";import{t as S}from"./src-BEbKO0eW.js";import{a as _e,c as ve,d as ye,i as be,l as xe,n as Se,o as Ce,r as C,s as we,u as Te}from"./with-widget-canvas-CTGbkhVG.js";function Ee(e){return Object.entries(e).flatMap(([e,t])=>Object.keys(t.months).map(t=>l({year:Number(e),month:Number(t)-1})))}function De(e,t,n,r){let i=e?.years??{},a=Ee(i);if(a.length===0||t===`average`&&!e?.averages)return[];let o=t===`average`?e.averages:i,s=Math.min(...a,r?l(r):1/0),c=Math.max(l(n),...a),u=Math.floor(s/12),d=Math.floor(c/12),f=[];for(let e=d;e>=u;e--){let n=o[String(e)],r=Array.from({length:12},(t,r)=>{let i=l({year:e,month:r});return i<s?`before`:i>c?`after`:n?.months[String(r+1)]??0}),i=(t===`average`?n?.overall:n?.total)??null;f.push({year:e,months:r,total:i})}return f}var Oe=t((()=>{S()}));function ke(e,t,n){let r=e[e.length-1],i=r?.months.findIndex(e=>typeof e==`number`)??-1;return!r||i<0||n&&r.year===n.year&&i===n.month?t:new Date(_([r.year,i,1],se()).getTime())}function Ae(e,t){let{data:n,isLoading:r,isFetching:i,isError:a,error:o,refetch:s}=de({postId:e,fields:[`years`,`averages`,`post`]}),c=(0,w.useMemo)(()=>{let e=n?.post;return ce(e?.post_date??(e?.post_date_gmt?`${e.post_date_gmt}Z`:void 0))},[n]),{rows:l,lifeStartsAt:u}=(0,w.useMemo)(()=>{let e=v(),r=c?v(c):void 0,i=r&&{year:r.getFullYear(),month:r.getMonth()},a=De(n,t,{year:e.getFullYear(),month:e.getMonth()},i);return{rows:a,lifeStartsAt:ke(a,c,i)}},[n,t,c]);return{rows:l,lifeStartsAt:u,isLoading:r,isFetching:i,isError:a,error:o,refetch:s}}var w,je=t((()=>{b(),y(),w=e(n(),1),Oe()}));function Me({metric:e}){let{reportParams:t}=ne(),n=le(t.post_id),{rows:r,lifeStartsAt:a,isLoading:o,isFetching:s,isError:c,error:l,refetch:d}=Ae(n,e),{onChange:f,onApply:p,timeZone:m}=ie(),h=(0,E.useMemo)(()=>r.map(e=>({year:e.year,months:e.months.map(e=>typeof e==`number`?e:null),total:e.total})),[r]),g=(0,E.useCallback)(({year:e,month:t})=>{let n={lifeStartsAt:a,timeZone:m},r=t===void 0?u(e,n):te({year:e,month:t},n);r&&(f(r,oe),p())},[a,m,f,p]),_=c&&r.length===0;return(0,D.jsx)(ge,{isLoading:o,isFetching:s,isError:_,isEmpty:n<=0||r.length===0,error:_?re(l,{retryDescription:i(`We couldn't load this post's traffic. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:d}):null,empty:{icon:ae,description:i(n>0?`No views yet.`:`Open a post or page report to see its all-time traffic here.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,D.jsx)(fe,{}),children:(0,D.jsx)(pe,{rows:h,...ee(e),onSelect:g})})}function T({attributes:e={}}){return(0,D.jsx)(h,{attributes:e,children:(0,D.jsx)(Me,{metric:m(e.metric)})})}var E,D,Ne=t((()=>{b(),y(),g(),p(),S(),a(),E=e(n(),1),je(),D=o()})),O,Pe=t((()=>{d(),a(),s(),O={icon:c,attributes:[{id:`metric`,label:r(`Metric`,`label for the views metric selector`,`jetpack-premium-analytics-pkg`),type:`text`,relevance:`high`,Edit:f,elements:[{value:`total`,label:i(`Total views`,`jetpack-premium-analytics-pkg`)},{value:`average`,label:i(`Daily average`,`jetpack-premium-analytics-pkg`)}]}],example:{attributes:{metric:`total`}}}})),k,A,j,M,N,P,F,Fe=t((()=>{k=`jpa/post-all-time-traffic`,A=`All-time traffic`,j=`Every month of views for the post or page being viewed, across its whole life.`,M={content:`Every month of views for the post or page being viewed, shaded by how it compares to the rest. Always the full history: the period above doesn't narrow it. Pick a month to read the rest of the page over it. Daily average leaves the current day out, as the classic Stats table does.`},N=`stats`,P=`framed`,F={name:k,title:A,description:j,help:M,category:N,presentation:P}}));function I({hasPostScope:e,metric:t},n=!1){return{metric:t,reportParams:{...ue(n),...e?{post_id:z}:{}}}}function L(e){return(0,R.jsx)(T,{attributes:I(e)})}function Ie({hasPostScope:e,metric:t,...n}){return(0,R.jsx)(we,{...n,widgetType:be(F,O),renderModule:B,renderComponent:T,attributes:I({hasPostScope:e,metric:t},!0)})}var R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{b(),he(),ve(),_e(),Te(),Se(),Ne(),Pe(),Fe(),R=o(),me(),z=779,B=`storybook/post-all-time-traffic`,V=`stats/post/${z}`,H={control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."},U={control:`radio`,options:[`total`,`average`],description:"The `metric` attribute: the month's views, or its views per day."},W={title:`Packages/Premium Analytics/Widgets/PostAllTimeTraffic`,component:T,tags:[`autodocs`],decorators:[ye],argTypes:{hasPostScope:H,metric:U},parameters:{docs:{description:{component:"The \"All-time traffic\" widget: every month of the scoped post's views, one row per year closed by a Totals column outside the colour scale, as total views or views per day. The `metric` attribute has `relevance: 'high'`, so the framed host renders its select in the header; the close-up stories set it as an arg. It always covers the post's whole life, whatever period the page shows, and picking a month applies that month to the page. Without a post scope the widget renders a scopeless empty state."}}}},G={render:L,args:{hasPostScope:!0,metric:`total`},decorators:[C]},K={render:L,args:{hasPostScope:!0,metric:`average`},decorators:[C]},q={render:L,args:{hasPostScope:!1,metric:`total`},decorators:[C]},J={render:L,args:{hasPostScope:!0,metric:`total`},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(x(V,`loading`),()=>x(V,null))},Y={render:L,args:{hasPostScope:!0,metric:`total`},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(x(V,`error`),()=>x(V,null))},X={render:L,args:{hasPostScope:!0,metric:`total`},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(x(V,`error-retryable`),()=>x(V,null))},Z={render:L,args:{hasPostScope:!0,metric:`total`},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(x(V,`empty`),()=>x(V,null))},Q={render:e=>(0,R.jsx)(Ie,{...e}),args:{...Ce,widgetWidth:3,widgetHeight:2,hasPostScope:!0,metric:`total`},argTypes:{...xe,hasPostScope:H,metric:U}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
