import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-Da_5_6n_.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{n as o,o as s}from"./build-module-DoJYX5DX.js";import{$ as ee,D as c,E as te,G as l,H as u,S as d,U as f,Y as p,v as m,w as h}from"./report-metric-B88CITdf.js";import{J as ne,X as re,g as ie,h as ae,m as oe,q as g,sn as se,ur as _,xt as v}from"./chart-tooltip-DYeL-Ebj.js";import{t as y}from"./leaderboard-chart-BeFibmCX.js";import{t as ce}from"./widget-state-D2kmnSNs.js";import{C as le,D as ue,E as de,O as fe,S as pe,T as me,b as he,k as b,t as x,w as ge,x as S}from"./src-DuJJqcEZ.js";function _e(e=[]){return e.map(e=>{let t=Number(e.id);return{...Number.isInteger(t)&&t>0?{id:t}:{},key:ae(e),label:ie(e),link:e.link,plays:e.plays,previousPlays:e.previousPlays}})}var ve=t((()=>{x()})),C,w,T,E,D,O,ye=t((()=>{C=`_labelLink_w5lmg_1`,w=`_labelText_w5lmg_2`,T=`_internalLink_w5lmg_3`,E=`_root_w5lmg_28`,D=`_content_w5lmg_36`,O={labelLink:C,labelText:w,internalLink:T,root:E,content:D}})),k,A=t((()=>{i(),o(),k={icon:s,attributes:[{id:`max`,label:r(`Maximum videos`,`jetpack-premium-analytics-pkg`),type:`integer`}],example:{attributes:{max:7}}}}));function be(e,t){return(0,P.jsx)(m,{id:e.id,label:e.label,link:e.link,search:t,classNames:{internal:O.internalLink,external:O.labelLink,plain:O.labelText},title:e.label})}function xe(e,t){let n=ne(e.map(e=>e.plays),e.map(e=>e.previousPlays));return e.map(e=>({id:e.key,label:be(e,t),currentValue:e.plays,currentShare:g(e.plays,n),previousValue:e.previousPlays,previousShare:e.previousPlays===void 0?void 0:g(e.previousPlays,n),delta:e.previousPlays===void 0?void 0:re(e.plays,e.previousPlays)}))}function j({max:e}){let{reportParams:t}=ee(),{primary:n,comparisonRows:i,hasComparison:a,isLoading:o,isFetching:c,hasData:l,isError:u,refetch:d}=se((0,N.useMemo)(()=>({...t,max:e}),[t,e]),{maxRows:e}),f=(o||n.isPending)&&!l,p=(0,N.useMemo)(()=>_e(i?.rows??[]),[i]),m=(0,N.useMemo)(()=>te(t),[t]),h=(0,N.useMemo)(()=>xe(p,m),[p,m]);return(0,P.jsx)(ce,{isLoading:f,isFetching:c,isError:p.length===0&&u,isEmpty:p.length===0,error:{description:r(`We couldn't load video plays. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:d}]},empty:{icon:s,description:r(`No VideoPress plays in this period.`,`jetpack-premium-analytics-pkg`)},children:(0,P.jsx)(y,{data:h,withComparison:a,withOverlayLabel:!0,showLegend:!1,dataFormat:{type:`number`,options:{useMultipliers:!0,decimals:0}}})})}function M({attributes:e={},setError:t}){return(0,P.jsx)(p,{attributes:e,setError:t,children:(0,P.jsxs)(`div`,{className:O.root,children:[(0,P.jsx)(`div`,{className:O.content,children:(0,P.jsx)(j,{max:oe(e.max,7)})}),(0,P.jsx)(c,{children:(0,P.jsx)(d,{report:`videos`})})]})})}var N,P,Se=t((()=>{v(),h(),x(),i(),o(),N=e(n(),1),ve(),ye(),A(),P=a()})),F,I,L,R,z,B,V,Ce=t((()=>{F=`jpa/videopress`,I=`Top videos`,L=`Your most played VideoPress videos, sourced from Jetpack Stats.`,R={content:`The published videos your visitors watched most often, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},z=`stats`,B=`framed`,V={name:F,title:I,description:L,help:R,category:z,presentation:B}}));function H({withComparison:e}){return(0,W.jsx)(M,{attributes:{max:7,reportParams:_(e)}})}function U(e){return(0,W.jsx)(M,{attributes:{max:7,reportParams:_(!1,e)}})}function we({withComparison:e,...t}){return(0,W.jsx)(me,{...t,widgetType:pe(V,k),renderModule:G,renderComponent:M,attributes:{max:7,reportParams:_(e)}})}var W,G,K,q,J,Y,X,Z,Q,$;t((()=>{v(),u(),de(),fe(),le(),he(),Se(),A(),Ce(),W=a(),f(),G=`storybook/videopress`,K={title:`Packages/Premium Analytics/Widgets/VideoPress`,component:M,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`}},parameters:{docs:{description:{component:"Dashboard widget showing the site's most played VideoPress videos as a leaderboard, with internal video-detail links and optional period-over-period comparison. It is sourced from the Jetpack Stats `video-plays` module via `useStatsVideoPlays`; in Storybook the data is served by `registerReportMocks`."}}}},q={render:H,args:{withComparison:!1},decorators:[S,b]},J={render:H,args:{withComparison:!0},decorators:[S,b]},Y={render:()=>U(`last-90-days`),tags:[`!autodocs`],decorators:[S,b],beforeEach:()=>(l(`stats/video-plays`,`loading`),()=>l(`stats/video-plays`,null))},X={render:()=>U(`last-7-days`),tags:[`!autodocs`],decorators:[S,b],beforeEach:()=>(l(`stats/video-plays`,`error`),()=>l(`stats/video-plays`,null))},Z={render:()=>U(`last-365-days`),tags:[`!autodocs`],decorators:[S,b],beforeEach:()=>(l(`stats/video-plays`,`empty`),()=>l(`stats/video-plays`,null))},Q={render:e=>(0,W.jsx)(we,{...e}),args:{...ge,withComparison:!0},argTypes:{...ue,withComparison:{control:`boolean`}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
