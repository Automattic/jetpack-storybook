import{i as e}from"./preload-helper-usAeo7Bx.js";import{c as t,n,t as r}from"./build-module-Da_5_6n_.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{A as a,t as o}from"./build-module-DrryaqBL.js";import{Ot as s,n as c}from"./build-module-DmVuor49.js";import{r as l}from"./hooks-6AFKnQdU.js";import{t as ee}from"./geo-chart-BqUcE-WL.js";import{R as u,t as d}from"./build-module-Ckp86Qtw.js";import{S as te,t as f}from"./src-B3le4dug.js";import{H as ne,S as re,V as ie,ht as p,ir as m,rn as h}from"./chart-tooltip-BvKnA4Ej.js";import{t as ae}from"./leaderboard-chart-TIHSX7P7.js";import{M as g,N as oe,U as se,b as ce,w as le,z as _}from"./report-metric-BBgOiYJZ.js";import{t as ue}from"./widget-state-Dq0PZ7To.js";import{C as de,S as v,T as fe,b as y,t as pe,w as b,x}from"./src-Vd2hm5Bb.js";import{n as S,t as C}from"./src-CPsF629a.js";import{n as w,t as T}from"./register-stats-mocks-Dq9_UdMK.js";import{n as E,t as D}from"./force-stats-mock-state-hPxGaJ3I.js";var O,k,A,j,M,N,P,F,I,L,me=e((()=>{O=`_root_erick_1`,k=`_backLink_erick_9`,A=`_content_erick_17`,j=`_bodyHeader_erick_25`,M=`_stateArea_erick_32`,N=`_chartArea_erick_38`,P=`_leaderboardPanel_erick_48`,F=`_leaderboard_erick_48`,I=`_geoChart_erick_64`,L={root:O,backLink:k,content:A,bodyHeader:j,stateArea:M,chartArea:N,leaderboardPanel:P,leaderboard:F,geoChart:I}}));function he(e){if(!e.countryCode)return null;let t=typeof e.label==`string`?e.label:String(e.label),n=e.countryFull??e.countryCode;return{key:`${e.countryCode}:${t}`,label:t,countryCode:e.countryCode,countryFull:n,value:e.views,previousValue:e.previousViews,region:e.region??``}}function ge({reportParams:e,max:t,geoMode:n=`country`,countryFilter:r}){let{primary:i,comparison:a,comparisonRows:o,hasComparison:s,isLoading:c,isFetching:l,hasData:ee,isError:u,refetch:d}=h({...e,geoMode:n,max:t,...r?{filter_by_country:r}:{}},{maxRows:t}),te=i.isPlaceholderData||a.isPlaceholderData,f=(o?.rows??[]).map(he).filter(e=>e!==null);return{data:f,hasComparison:s,isLoading:c,isFetching:l,hasData:ee,isError:f.length===0&&u,isPlaceholderData:te,refetch:d}}var _e=e((()=>{p()}));function R(e){return e.toUpperCase()===`TW`?`Taiwan`:e.toUpperCase()}function ve({max:e,geoGranularity:r}){let{reportParams:i}=se(),[o,s]=(0,a.useState)(()=>new Set(H)),{drillDownItem:c,drillDown:d,resetDrillDown:f}=l();(0,a.useEffect)(()=>{r===`city`&&f()},[f,r]);let p=r===`country`?c:void 0,m=r===`country`&&p?`region`:r,{data:h,hasComparison:g,isLoading:oe,isFetching:_,isError:de,isPlaceholderData:v,refetch:fe}=ge({reportParams:i,max:e,geoMode:m,countryFilter:m===`region`?p?.code:void 0}),[y,pe]=(0,a.useState)({geoMode:m,selectedCountry:p});(0,a.useEffect)(()=>{v||pe({geoMode:m,selectedCountry:p})},[p,m,v]);let b=v?y.geoMode:m,x=v?y.selectedCountry:p,S=x?.code.toUpperCase(),C=b===`region`&&!!S&&!o.has(S),w=b===`region`&&!!x&&!C,T=w?x:void 0,E=b===`city`,D=(0,a.useMemo)(()=>{let e=new Map;return E?(h.forEach(t=>{let n=t.countryCode.toUpperCase(),r=e.get(n);e.set(n,{countryFull:t.countryFull,value:(r?.value??0)+t.value})}),Array.from(e.entries())):[]},[h,E]),O=(0,a.useCallback)(e=>{let t=`${e.message??``} ${e.detailedMessage??``}`,n=!!S&&C,r=!!S&&H.has(S);!n&&!r&&!t.includes(V)||(e.id&&typeof window<`u`&&window.google?.visualization?.errors?.removeError?.(e.id),n&&(H.add(S),s(e=>{if(e.has(S))return e;let t=new Set(e);return t.add(S),t})))},[S,C]),k=(0,a.useMemo)(()=>{let e=[n(b===`region`&&!w?`Location`:`Country`,`jetpack-premium-analytics`),n(`Views`,`jetpack-premium-analytics`)];if(T){let t=T.code.toUpperCase(),n=h.filter(e=>e.countryCode.toUpperCase()===t).reduce((e,t)=>e+t.value,0);return[e,[{v:R(t),f:T.name},n]]}return E?[e,...D.map(([e,t])=>[{v:R(e),f:t.countryFull},t.value])]:[e,...h.map(e=>[e.label,e.value])]},[D,h,T,b,E,w]),A=(0,a.useMemo)(()=>{let e=Math.max(...h.map(e=>e.value),0),r=Math.max(...h.map(e=>e.previousValue??0),0);return h.map(i=>{let a=re(i.countryCode),o=i.previousValue,s=i.countryCode;return{id:i.key,...le({label:i.label,media:{kind:`flag`,url:a??void 0,country:i.countryFull},action:b===`country`&&s?{kind:`drillDown`,onClick:()=>d({code:s,name:i.countryFull}),ariaLabel:t(n(`View regions in %s`,`jetpack-premium-analytics`),i.countryFull)}:{kind:`static`}}),currentValue:i.value,previousValue:o,currentShare:ie(i.value,e),previousShare:g&&o!==void 0?ie(o,r):void 0,delta:g&&o!==void 0?ne(i.value,o):void 0}})},[h,b,g,d]),j=x?(0,B.jsx)(ce,{label:n(`All Locations`,`jetpack-premium-analytics`),ariaLabel:n(`View all locations`,`jetpack-premium-analytics`),onClick:f,className:L.backLink}):null,M=j?(0,B.jsx)(u,{direction:`row`,align:`center`,className:L.bodyHeader,children:j}):null;return(0,B.jsxs)(`div`,{className:L.content,children:[M,(0,B.jsx)(`div`,{className:L.stateArea,children:(0,B.jsx)(ue,{isLoading:oe,isFetching:_,isError:de,isEmpty:h.length===0,error:{description:n(`We couldn't load location data. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:n(`Retry`,`jetpack-premium-analytics`),onClick:fe}]},empty:{icon:te,description:n(`No location data in this period.`,`jetpack-premium-analytics`)},children:(0,B.jsxs)(`div`,{className:L.chartArea,children:[(0,B.jsx)(`div`,{className:L.leaderboardPanel,children:(0,B.jsx)(ae,{data:A,withOverlayLabel:!0,withComparison:g,showLegend:!1,dataFormat:{type:`number`,options:{useMultipliers:!0,decimals:0}},className:L.leaderboard})}),(0,B.jsx)(`div`,{className:L.geoChart,children:(0,B.jsx)(ee,{data:k,resizeDebounceTime:100,region:C?x?.code??`world`:`world`,resolution:C?`provinces`:`countries`,onError:O})})]})})})]})}function z({attributes:e={}}){let t=e?.max??10,n=e?.geoGranularity??`country`;return(0,B.jsx)(_,{attributes:e,children:(0,B.jsx)(`div`,{className:L.root,children:(0,B.jsx)(ve,{max:t,geoGranularity:n})})})}var B,V,H,ye=e((()=>{pe(),f(),o(),r(),d(),me(),_e(),B=i(),V=`Requested map does not exist`,H=new Set})),U,be=e((()=>{r(),c(),C(),U={name:`jpa/locations`,title:n(`Locations`,`jetpack-premium-analytics`),help:{content:n(`The countries, regions, and cities where your visitors came from, sorted by views.`,`jetpack-premium-analytics`),links:[{label:n(`Learn more`,`jetpack-premium-analytics`),href:`https://jetpack.com/support/jetpack-stats/`}]},icon:s,attributes:[{id:`max`,label:n(`Number of results`,`jetpack-premium-analytics`),type:`integer`},{id:`geoGranularity`,label:n(`View by`,`jetpack-premium-analytics`),type:`text`,Edit:S,elements:[{label:n(`Countries`,`jetpack-premium-analytics`),value:`country`},{label:n(`Cities`,`jetpack-premium-analytics`),value:`city`}],relevance:`high`}],example:{attributes:{max:10,geoGranularity:`country`}}}}));function xe({withComparison:e,geoGranularity:t}){return{geoGranularity:t,max:10,reportParams:m(e)}}function W(e){return(0,K.jsx)(z,{attributes:xe(e)})}function G(e){return(0,K.jsx)(z,{attributes:{geoGranularity:`country`,max:10,reportParams:m(!1,e)}})}function Se(e){return(0,K.jsx)(z,{...e})}function Ce({withComparison:e,geoGranularity:t,...n}){return(0,K.jsx)(de,{...n,widgetType:Te,renderModule:we,renderComponent:Se,attributes:xe({withComparison:e,geoGranularity:t})})}var K,we,Te,Ee,q,J,Y,X,Z,Q,$,De;e((()=>{p(),b(),y(),g(),T(),E(),ye(),be(),K=i(),oe(),w(),we=`storybook/locations`,Te={name:U.name,title:U.title,icon:U.icon,attributes:U.attributes,example:U.example,presentation:`framed`},Ee={title:`Packages/Premium Analytics/Widgets/Locations`,component:z,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},geoGranularity:{control:`radio`,options:[`country`,`city`],description:`The "View by" toolbar attribute rendered by the widget host.`}},parameters:{docs:{description:{component:"The \"Locations\" widget. Shows visitor views by country or city, with country drill-down into regions, using the global dashboard date range. The Countries/Cities view is the `geoGranularity` attribute (`relevance: 'high'`), exposed as a control by the widget host."}}}},q={render:W,args:{withComparison:!1,geoGranularity:`country`},decorators:[x]},J={render:W,args:{withComparison:!0,geoGranularity:`country`},decorators:[x]},Y={render:W,args:{withComparison:!1,geoGranularity:`city`},decorators:[x]},X={render:()=>G(`last-90-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(D(`stats/location-views`,`loading`),()=>D(`stats/location-views`,null))},Z={render:()=>G(`last-7-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(D(`stats/location-views`,`error`),()=>D(`stats/location-views`,null))},Q={render:()=>G(`last-365-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(D(`stats/location-views`,`empty`),()=>D(`stats/location-views`,null))},$={render:e=>(0,K.jsx)(Ce,{...e}),args:{...v,widgetWidth:2,widgetHeight:1,withComparison:!0,geoGranularity:`country`},argTypes:{...fe,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},geoGranularity:{control:`radio`,options:[`country`,`city`],description:`The "View by" toolbar attribute rendered by the widget host.`}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
