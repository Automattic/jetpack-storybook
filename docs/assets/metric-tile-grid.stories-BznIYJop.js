import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{O as n,Q as r,an as i,gt as a,n as o}from"./build-module-DmVuor49.js";import{n as s,t as c}from"./metric-tile-grid-bWgBSd3O.js";var l,u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{o(),s(),l=t(),u={type:`number`,options:{useMultipliers:!0,decimals:0}},d=[{key:`posts`,icon:r,label:`Posts`,value:12},{key:`words`,icon:a,label:`Words`,value:34567},{key:`likes`,icon:n,label:`Likes`,value:891},{key:`comments`,icon:i,label:`Comments`,value:42}],f=(e,t)=>function(n){return(0,l.jsx)(`div`,{style:{width:e,height:t,display:`flex`,flexDirection:`column`},children:(0,l.jsx)(n,{})})},p={title:`Packages/Premium Analytics/Widgets Toolkit/Components/MetricTileGrid`,component:c,tags:[`autodocs`],parameters:{docs:{description:{component:`Responsive grid of metric tiles that follows the widget cell size and picks its own layout — no column count needed. A narrow cell renders compact rows (icon and label on the left, value on the right); a wide but short cell spreads the tiles across a single row; a wide and tall cell uses a balanced two-column grid of large centered tiles.`}}}},m={args:{tiles:d,dataFormat:u},decorators:[f(`100%`,`480px`)]},h={args:{tiles:d,dataFormat:u},decorators:[f(`360px`,`480px`)]},g={args:{tiles:d,dataFormat:u},decorators:[f(`100%`,`220px`)]},_={args:{tiles:d,dataFormat:u},decorators:[f(`1026px`,`280px`)]},v={args:{tiles:d.slice(0,3),dataFormat:u},decorators:[f(`100%`,`480px`)]},y={args:{dataFormat:u,tiles:[{key:`views`,icon:r,label:`Views`,value:18400,previousValue:16100},{key:`visitors`,icon:n,label:`Visitors`,value:12100,previousValue:10800,note:`Sum of daily visitors — a returning visitor is counted once per day.`},{key:`likes`,icon:n,label:`Likes`,value:842,previousValue:905},{key:`comments`,icon:i,label:`Comments`,value:296,previousValue:null}]},decorators:[f(`100%`,`320px`)]},b={args:{tiles:[{key:`openRate`,icon:r,label:`Open rate`,value:null,dataFormat:{type:`percentage`,options:{decimals:1}}},{key:`clickRate`,icon:n,label:`Click rate`,value:.381,dataFormat:{type:`percentage`,options:{decimals:1}}}]},decorators:[f(`100%`,`320px`)]},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    tiles: TILES,
