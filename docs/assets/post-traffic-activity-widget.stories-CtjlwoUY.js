import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{A as i,t as a}from"./build-module-DrryaqBL.js";import{t as o,x as s}from"./build-module-Nbr4nybP.js";import{C as c,T as l,X as u,bt as d,ln as f,mn as p,ot as m,t as h}from"./date-fns-B2pKki1V.js";import{Cn as g,Dn as _,Un as v,n as y}from"./build-module-DmVuor49.js";import{n as b,o as x}from"./heatmap-chart-BI5KVSBs.js";import{K as S,W as C,t as w}from"./build-module-LU_6Qj-1.js";import{A as ee,t as T}from"./src-B3le4dug.js";import{Xn as E,hn as D,ut as O}from"./chart-tooltip-Cq5jhKaK.js";import{C as te,N as ne,S as re,k as ie}from"./report-metric-DM2LTy4R.js";import{t as ae}from"./widget-state-Cc04oFW3.js";import{C as oe,S as se,T as ce,b as le,t as ue,w as de,x as k}from"./src-LAPZU3wC.js";var A,j,M,N,P,F,fe=e((()=>{A=`_root_1uv97_4`,j=`_pager_1uv97_11`,M=`_body_1uv97_23`,N=`_content_1uv97_28`,P=`_heatmap_1uv97_44`,F={root:A,pager:j,body:M,content:N,heatmap:P}}));function I(e){let t=e?.slice(0,10);return t&&/^\d{4}-\d{2}-\d{2}$/.test(t)&&!Number.isNaN(c(t).getTime())?t:void 0}function pe(e,t,n){let{data:r,isLoading:a,isFetching:o,isError:s,refetch:h}=D({postId:e,fields:[`data`]}),[g,_]=(0,i.useState)(0);(0,i.useEffect)(()=>{_(0)},[t.from,t.to,n]);let v=I(t.from),y=I(t.to),{days:b,isPaged:x,canShowOlder:S}=(0,i.useMemo)(()=>{if(!v||!y||v>y)return{days:[],isPaged:!1,canShowOlder:!1};let e=r?.data??[],t=new Map(e.map(e=>[e.date,e.views])),i=f(c(v),{weekStartsOn:1}),a=m(c(y),{weekStartsOn:1}),o=i<l(a,n-1),s=l(a,g*n),h=l(s,n-1);if(o&&h<i){h=i;let e=p(i,n-1);s=e<a?e:a}return{days:d({start:h,end:s}).map(e=>{let n=u(e,`yyyy-MM-dd`);return{dateString:n,value:(n>=v&&n<=y?t.get(n):void 0)||null}}),isPaged:o,canShowOlder:i<h}},[r,v,y,g,n]),C=(0,i.useCallback)(()=>{_(e=>S?e+1:e)},[S]),w=(0,i.useCallback)(()=>{_(e=>Math.max(0,e-1))},[]);return{days:b,isPaged:x,canShowOlder:S,canShowNewer:g>0,showOlder:C,showNewer:w,isLoading:a,isFetching:o,isError:s,hasData:!!r,refetch:h}}var me=e((()=>{O(),a(),h()}));function he(e){return e?Math.max(B,Math.floor((e-z)/68)):V}function ge(){let{reportParams:e}=ne(),n=Number(e.post_id),r=Number.isInteger(n)&&n>0?n:0,[a,o]=(0,i.useState)(),c=s(e=>{let t=e[0]?.contentRect;if(t){let e=Math.round(t.width);o(t=>t===e?t:e)}}),{days:l,isPaged:u,canShowOlder:d,canShowNewer:f,showOlder:p,showNewer:m,isLoading:h,isFetching:v,isError:y,hasData:w,refetch:T}=pe(r,e,he(a)*7),{data:E,rowLabels:D}=(0,i.useMemo)(()=>x(l),[l]);return(0,R.jsx)(`div`,{ref:c,className:F.root,children:(0,R.jsx)(`div`,{className:F.body,children:(0,R.jsx)(ae,{isLoading:h&&!w,isFetching:v,isError:y,isEmpty:r<=0||E.length===0,error:{description:t(`We couldn't load this traffic activity. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:T}]},empty:{icon:ee,description:t(`Open a post or page report to see its traffic activity here.`,`jetpack-premium-analytics`)},children:(0,R.jsxs)(`div`,{className:F.content,children:[u&&(0,R.jsxs)(C,{align:`center`,justify:`flex-end`,gap:`sm`,className:F.pager,children:[(0,R.jsx)(S,{type:`button`,variant:`minimal`,tone:`neutral`,size:`small`,onClick:p,disabled:!d,"aria-label":t(`Older activity`,`jetpack-premium-analytics`),children:(0,R.jsx)(S.Icon,{icon:_,size:16})}),(0,R.jsx)(S,{type:`button`,variant:`minimal`,tone:`neutral`,size:`small`,onClick:m,disabled:!f,"aria-label":t(`Newer activity`,`jetpack-premium-analytics`),children:(0,R.jsx)(S.Icon,{icon:g,size:16})})]}),(0,R.jsx)(b,{data:E,rowLabels:D,primaryColor:`var(--wp-admin-theme-color, #3858e9)`,withTooltips:!0,maxCellWidth:64,maxCellHeight:42,className:F.heatmap})]})})})})}function L({attributes:e={}}){return(0,R.jsx)(ie,{attributes:e,children:(0,R.jsx)(ge,{})})}var R,z,B,V,_e=e((()=>{T(),ue(),o(),a(),n(),y(),w(),fe(),me(),R=r(),z=48,B=4,V=16})),H,ve=e((()=>{n(),y(),H={name:`jpa/post-traffic-activity`,title:t(`Traffic activity`,`jetpack-premium-analytics`),help:{content:t(`Daily views for the post or page being viewed, as a calendar heatmap.`,`jetpack-premium-analytics`)},icon:v,attributes:[],example:{attributes:{}}}}));function U({hasPostScope:e,preset:t},n=!1){return{reportParams:{...E(n,t),...e?{post_id:K}:{}}}}function W(e){return(0,G.jsx)(L,{attributes:U(e)})}function ye({hasPostScope:e,preset:t,...n}){return(0,G.jsx)(oe,{...n,widgetType:{...H,presentation:`framed`},renderModule:q,renderComponent:L,attributes:U({hasPostScope:e,preset:t},!0)})}var G,K,q,J,Y,X,Z,Q,$;e((()=>{O(),re(),de(),le(),_e(),ve(),G=r(),te(),K=779,q=`storybook/post-traffic-activity`,J={title:`Packages/Premium Analytics/Widgets/PostTrafficActivity`,component:L,tags:[`autodocs`],argTypes:{hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."},preset:{control:`select`,options:[`last-30-days`,`last-365-days`],description:`Dashboard date range used to exercise single-page and paged layouts.`}},parameters:{docs:{description:{component:`The "Traffic activity" widget: the scoped post's daily views over the dashboard date range as a calendar heatmap — the post detail Traffic view's activity card, replacing the legacy months table. Days without traffic stay blank cells, per the design, while the grid stays complete. Without a post scope the widget renders a scopeless empty state.`}}}},Y={render:W,args:{hasPostScope:!0,preset:`last-30-days`},decorators:[k]},X={render:W,args:{hasPostScope:!0,preset:`last-365-days`},decorators:[k]},Z={render:W,args:{hasPostScope:!1,preset:`last-30-days`},decorators:[k]},Q={render:e=>(0,G.jsx)(ye,{...e}),args:{...se,widgetWidth:4,widgetHeight:2,hasPostScope:!0,preset:`last-30-days`},argTypes:{...ce,hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."},preset:{control:`select`,options:[`last-30-days`,`last-365-days`],description:`Dashboard date range used to exercise single-page and paged layouts.`}}},Y.parameters={...Y.parameters,docs:{...Y.parameters?.docs,source:{originalSource:`{
