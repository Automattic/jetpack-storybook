import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{Mn as o,n as s}from"./build-module-CDRs4YxF.js";import{J as c,U as l,X as u,Z as d,at as f,q as ee,tt as te}from"./report-metric-BywRn0bl.js";import{E as p,mn as ne,qt as m,t as h,xn as re}from"./src-BqoIAWGs.js";import{t as ie,u as ae}from"./src-DE8Ki5qG.js";import{x as oe}from"./chart-tooltip-CBXJFs6e.js";import{t as se}from"./widget-state-CCVIVgZN.js";import{C as g,D as ce,E as _,S as v,T as y,b as le,t as b,w as ue,x}from"./src-CNbqXo4B.js";var S,C,w=t((()=>{S=`_root_onyev_1`,C={root:S}}));function T(e){let t=e.reduce((e,t)=>!e||t.total>e.total?t:e,void 0);return t&&t.total>0?t:void 0}function E(){let{reportParams:e}=f(),{primary:t,isLoading:n,isFetching:r,isError:i,error:a,refetch:o}=p((0,D.useMemo)(()=>ne({...e}),[e])),s=t.data,c=(0,D.useMemo)(()=>s?s.buckets.map(({hour:e,views:t})=>({hour:e,total:t,average:t/s.days})):[],[s]);return{buckets:c,peak:(0,D.useMemo)(()=>{let e=T(c);return e&&{...e,label:ae(e.hour)}},[c]),isLoading:n,isFetching:r,isError:i,error:a,refetch:o}}var D,de=t((()=>{h(),ie(),b(),D=e(n(),1)}));function fe(){let{buckets:e,peak:t,isLoading:n,isFetching:i,isError:a,error:s,refetch:c}=E(),u=(0,k.useMemo)(()=>e.map(e=>e.average),[e]),d=a&&(!t||s instanceof re),f=t&&t.average<10&&!Number.isInteger(t.average)?1:0;return(0,A.jsx)(`div`,{className:C.root,children:(0,A.jsx)(se,{isLoading:n,isFetching:i,isError:d,isEmpty:!t,error:d?oe(s,{retryDescription:r(`We couldn't load your popular hours. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}):null,empty:{icon:o,description:r(`No views in this period.`,`jetpack-premium-analytics-pkg`)},children:(0,A.jsx)(l,{label:t?.label??``,value:t?.average??0,points:u,valueDecimals:f,valueUnit:`views-per-day`})})})}function O({attributes:e={},setError:t}){return(0,A.jsx)(te,{attributes:e,setError:t,children:(0,A.jsx)(fe,{})})}var k,A,pe=t((()=>{h(),b(),i(),s(),k=e(n(),1),w(),de(),A=a()})),j,M=t((()=>{s(),j={icon:o}})),N,P,F,I,L,R,z,me=t((()=>{N=`jpa/popular-hours`,P=`Popular hours`,F=`The hour of the day that draws the most views, with the distribution across the day.`,I={content:`The hours of the day when your site received the most views on average. Ranges longer than a year show the most recent 12 months.`,links:[{label:`Learn more`,href:`https://wordpress.com/support/stats/learn-insights-about-your-website/`}]},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function he(){return(0,V.jsx)(O,{attributes:{reportParams:m(!1)}})}function B(e){return(0,V.jsx)(O,{attributes:{reportParams:m(!1,e)}})}function ge(e){return(0,V.jsx)(y,{...e,widgetType:U,renderModule:H,renderComponent:O,attributes:{reportParams:m(!0)}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{h(),ee(),_(),g(),le(),pe(),M(),me(),V=a(),c(),H=`storybook/popular-hours`,U=v(z,j),W={title:`Packages/Premium Analytics/Widgets/PopularHours`,component:O,tags:[`autodocs`],parameters:{docs:{description:{component:"The \"Popular hours\" card: the busiest hour of the day for the selected range, as a site-format hour label and its mean daily views, over an area chart of the whole day's distribution. Data comes from `stats/views-by/hour-of-day`, which folds the range into 24 buckets in the site's own timezone; `stats/insights` also reports an hours map, but keyed in UTC while its `highest_hour` is offset-applied, so its chart and headline disagree. Because the endpoint rejects ranges longer than 366 days, the client limits `all time` and long custom ranges to the most recent 12 months. There is no WithComparison story — the widget strips comparison from its request and renders no delta, so it would be identical to Default."}}}},G={render:he,decorators:[x]},K={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(d(`stats/views-by/hour-of-day`,`loading`),()=>d(`stats/views-by/hour-of-day`,null))},q={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(d(`stats/views-by/hour-of-day`,`error`),()=>d(`stats/views-by/hour-of-day`,null))},J={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(d(`stats/views-by/hour-of-day`,`error-retryable`),()=>d(`stats/views-by/hour-of-day`,null))},Y={render:()=>B(`last-30-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(u(`stats/views-by/hour-of-day`,{date:`2026-01-01`,start_date:`2025-12-03`,days:30,dimension:`day-of-week`,fields:[`period`,`views`],data:[[`Mon`,100]]}),()=>u(`stats/views-by/hour-of-day`,null))},X={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(u(`stats/views-by/hour-of-day`,{date:`2026-01-01`,start_date:`2025-01-01`,days:366,dimension:`hour-of-day`,fields:[`period`,`views`],data:[[`7`,4],[`19`,18]]}),()=>u(`stats/views-by/hour-of-day`,null))},Z={render:()=>B(`last-year`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(d(`stats/views-by/hour-of-day`,`empty`),()=>d(`stats/views-by/hour-of-day`,null))},Q={render:e=>(0,V.jsx)(ge,{...e}),args:{...ue},argTypes:{...ce}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
