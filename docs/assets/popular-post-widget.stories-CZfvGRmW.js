import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{_ as o,t as s}from"./build-module-CbwHEf9N.js";import{n as c,w as l}from"./build-module-CDRs4YxF.js";import{C as u,b as d,g as f,x as p}from"./hooks-C4nRgT-Q.js";import{ft as ee,mt as te,ot as ne,qt as m,rt as h,t as g}from"./src-nqpizkIW.js";import{x as _}from"./chart-tooltip-CoSs-C7k.js";import{t as re}from"./post-highlight-card-skeleton-C6I5ABdg.js";import{K as ie,q as ae,v as oe}from"./report-metric-rbDkxP91.js";import{t as se}from"./widget-state-BuxierFL.js";import{C as ce,D as v,E as le,O as ue,S as de,T as fe,b as pe,k as y,t as me,w as b,x}from"./src-BdbOy7LB.js";import{n as S,t as C}from"./register-stats-mocks-PjT5aNAw.js";import{n as he,t as w}from"./force-stats-mock-state-DIq7HFIh.js";function ge(e){let t=h((0,T.useMemo)(()=>{let t={...e,max:D};return delete t.comp,delete t.compare_from,delete t.compare_to,delete t.compare_preset,t},[e]),{maxRows:1,postTypes:E}),n=t.comparisonRows?.rows[0],r=Number(n?.id??0)||0,i=te(ne(r)),a=ee({postId:r,fields:[`views`,`like_count`,`post`]}),o=a.data,s=o?.post?.ID,c=o&&(s===void 0||s===r)?o:void 0,l=r>0&&!c&&!a.isError,u=t.isLoading||r>0&&(i.isLoading||a.isLoading||l),d=t.isFetching||i.isFetching||a.isFetching,f=t.isError,p=()=>{t.refetch(),r>0&&(i.refetch(),a.refetch())},m=i.data??null;return{post:n?{id:r,title:m?.title||String(n.label??``),url:m?.url||n.link||``,date:m?.date||(typeof n.date==`string`?n.date:``),imageUrl:m?.imageUrl??``,imageAlt:m?.imageAlt??``,views:c?.views,likeCount:c?.like_count,commentCount:c?.post?.comment_count}:null,isLoading:u,isFetching:d,isError:f,error:t.error,refetch:p}}var T,E,D,_e=t((()=>{g(),T=e(n(),1),E=[`post`],D=20}));function ve(){let{reportParams:e}=d(),{post:t,isLoading:n,isFetching:i,isError:a,error:s,refetch:c}=ge(e),f=(0,o.useMemo)(()=>u(e),[e]),p=t?[{key:`views`,label:r(`Views`,`jetpack-premium-analytics-pkg`),value:t.views},{key:`likes`,label:r(`Likes`,`jetpack-premium-analytics-pkg`),value:t.likeCount},{key:`comments`,label:r(`Comments`,`jetpack-premium-analytics-pkg`),value:t.commentCount}]:[];return(0,k.jsx)(se,{isLoading:n,isFetching:i,isError:a,isEmpty:!t,error:_(s,{retryDescription:r(`We couldn't load your most popular post. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}),empty:{icon:l,description:r(`No post views in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,k.jsx)(re,{}),children:t&&(0,k.jsx)(oe,{title:t.title,url:t.url,postId:t.id,detailSearch:f,date:t.date,imageUrl:t.imageUrl,imageAlt:t.imageAlt,metrics:p})})}function O({attributes:e={}}){return(0,k.jsx)(f,{attributes:e,children:(0,k.jsx)(ve,{})})}var k,A=t((()=>{p(),me(),s(),i(),c(),_e(),k=a()})),j,M=t((()=>{c(),j={icon:l,attributes:[],example:{attributes:{}}}})),N,P,F,I,L,R,z,ye=t((()=>{N=`jpa/popular-post`,P=`Popular post`,F=`Your most-viewed post for the selected date range, with its all-time stats.`,I={content:`Your most viewed post in the selected date range, with its all-time views, likes, and comments.`},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function be(){return(0,H.jsx)(O,{attributes:{reportParams:m()}})}function B(e){return(0,H.jsx)(O,{attributes:{reportParams:m(!1,e)}})}function V(e){return(0,H.jsx)(fe,{...e,widgetType:de(z,j),renderModule:U,renderComponent:O,attributes:{reportParams:m(!0)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{g(),ie(),C(),ce(),he(),le(),ue(),pe(),A(),M(),ye(),H=a(),ae(),S(),U=`storybook/popular-post`,W={title:`Packages/Premium Analytics/Widgets/PopularPost`,component:O,tags:[`autodocs`],parameters:{docs:{description:{component:"The \"Popular post\" widget shows the site's most-viewed post for the dashboard's date range, with its publish date and its all-time views, likes, and comments. Changing the date range changes which post wins, not the totals shown for it: every tile comes from the all-time `stats/post` response, so the three cannot measure different periods. There is no `WithComparison` story: the card shows no period-over-period delta, so the dashboard story below carries the comparison report params instead."}}}},G={render:be,decorators:[x,y]},K={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[x,y],beforeEach:()=>(w(`stats/top-posts`,`loading`),()=>w(`stats/top-posts`,null))},q={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[x,y],beforeEach:()=>(w(`stats/top-posts`,`error`),()=>w(`stats/top-posts`,null))},J={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[x,y],beforeEach:()=>(w(`stats/top-posts`,`error-retryable`),()=>w(`stats/top-posts`,null))},Y={render:()=>B(`last-year`),tags:[`!autodocs`],decorators:[x,y],beforeEach:()=>(w(`stats/top-posts`,`empty`),()=>w(`stats/top-posts`,null))},X={render:e=>(0,H.jsx)(V,{...e}),args:{...b,widgetWidth:2,widgetHeight:2},argTypes:{...v}},Z={render:e=>(0,H.jsx)(V,{...e}),args:{...b,widgetWidth:2,widgetHeight:1},argTypes:{...v}},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...b,widgetWidth:1,widgetHeight:1},argTypes:{...v}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
