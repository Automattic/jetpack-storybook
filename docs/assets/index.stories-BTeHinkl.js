import{n as e,o as t}from"./chunk-zsgVPwQN.js";import{$h as n,Lh as r,Ph as i,Qm as a,Rh as o,Si as s,ia as c,xg as l,yh as u,zh as d}from"./iframe-MZs08VNT.js";import{a as f,t as p}from"./shared-extension-utils-qRMYQkPJ.js";var m,h=e((()=>{m={"message-box-control":`_message-box-control_pregs_90`}}));function g({label:e=b(),placeholder:t=y(),message:r=``,onChange:i,disabled:a,maxLength:o,analyticsData:s=null}){let{recordEvent:l}=f(),u=(0,_.useRef)(!0),p=o-r.length;return(0,v.jsx)(c,{value:r,label:e,onChange:(0,_.useCallback)(e=>{i(e),u.current&&=(l(`jetpack_social_custom_message_changed`,s),!1)},[s,u,i,l]),disabled:a,maxLength:o,placeholder:t,rows:4,help:n(d(`%d character remaining`,`%d characters remaining`,p,`jetpack-publicize-pkg`),p),__nextHasNoMarginBottom:!0,className:m[`message-box-control`]})}var _,v,y,b,x=e((()=>{p(),s(),r(),_=t(l()),h(),v=i(),y=()=>o(`Write a custom message for your social audience here. This message will override your social post content.`,`jetpack-publicize-pkg`),b=()=>o(`Message`,`jetpack-publicize-pkg`)})),S,C,w,T,E,D,O,k,A;e((()=>{a(),x(),S=i(),C={title:`Packages/Publicize/Message Box Control`,component:g,argTypes:{onChange:{action:`changed`},maxLength:{control:{type:`number`,min:10,max:500}},disabled:{control:`boolean`},analyticsData:{control:`object`},label:{control:`text`},placeholder:{control:`text`}}},w=e=>{let[t,n]=(0,u.useState)(e.message);return(0,S.jsx)(g,{message:t,onChange:(0,u.useCallback)(t=>{n(t),e.onChange(t)},[e]),disabled:e.disabled,maxLength:e.maxLength,analyticsData:e.analyticsData,label:e.label,placeholder:e.placeholder})},T={message:`Check out my latest blog post!`,maxLength:280,disabled:!1,analyticsData:{location:`storybook`}},E=w.bind({}),E.args=T,D=w.bind({}),D.args={...T,message:``},O=w.bind({}),O.args={...T,disabled:!0},k=w.bind({}),k.args={...T,message:``,label:`Custom Social Message`,placeholder:`Type your personalized social media post here...`},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`(args: MessageBoxControlProps) => {
