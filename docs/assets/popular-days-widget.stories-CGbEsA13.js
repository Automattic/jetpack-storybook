import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-yGZutq_9.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{t as o,wl as s}from"./build-module-zwSmKorH.js";import{W as c,t as l}from"./date-fns-CeH7Uo-X.js";import{_t as ee,b as te,g as ne}from"./hooks-BH5dCSxw.js";import{t as re,x as ie}from"./src-DFNM1k7F.js";import{S as ae,b as oe,t as u}from"./src-B477hvom.js";import{l as se,t as d}from"./src-BATBuJ8k.js";import{$t as f,Dn as p,L as ce,r as m}from"./date-period-dropdown-BcXFcJdU.js";import{t as le}from"./metric-sparkline-skeleton-BQxqcH8u.js";import{i as ue,r as de,s as h}from"./register-report-mocks-VZYvRNvX.js";import{z as fe}from"./report-metric-DHr5d9L1.js";import{t as pe}from"./widget-state-CeqhaAs1.js";import{t as g}from"./src-BFVgsco2.js";import{a as _,c as v,i as me,l as he,n as ge,o as _e,r as y,s as ve}from"./with-widget-canvas-CCj6JxN2.js";var b,x,ye=t((()=>{b=`_root_1j6if_1`,x={root:b}}));function be(e){return se(e)}function xe(e){let t=oe(e.date_start??e.time_interval??e.period);return t?ae(t,C):null}function Se(e){let t=e.views??e.value;return typeof t==`number`?t:Number(t??0)||0}function Ce(e){let t=Array.from({length:7},()=>({total:0,occurrences:0}));return e.forEach(e=>{let n=xe(e);if(!n)return;let r=(c(n)+6)%7;t[r].total+=Se(e),t[r].occurrences+=1}),t.map(({total:e,occurrences:t},n)=>({weekday:n,label:be(n),total:e,occurrences:t,average:t?e/t:0}))}function S(e){return e.filter(e=>e.occurrences>0&&e.total>0).reduce((e,t)=>!e||t.average>e.average?t:e,void 0)}var C,w=t((()=>{u(),d(),l(),C=`yyyy-MM-dd`}));function T(){let{reportParams:e}=te(),{primary:t,isLoading:n,isFetching:r,isError:i,error:a,refetch:o}=ce((0,E.useMemo)(()=>p({...e,stat_fields:O,period:D}),[e])),s=t.data,c=(0,E.useMemo)(()=>Ce(s?.data??[]),[s]);return{buckets:c,peak:(0,E.useMemo)(()=>S(c),[c]),isLoading:n,isFetching:r,isError:i,error:a,refetch:o}}var E,D,O,k=t((()=>{m(),g(),E=e(n(),1),w(),D=`day`,O=`views,visitors`}));function A(){let{buckets:e,peak:t,isLoading:n,isFetching:i,isError:a,error:o,refetch:s}=T(),c=(0,M.useMemo)(()=>e.map(e=>e.average),[e]),l=a&&!t;return(0,N.jsx)(`div`,{className:x.root,children:(0,N.jsx)(pe,{isLoading:n,isFetching:i,isError:l,isEmpty:!t,error:l?ee(o,{retryDescription:r(`We couldn't load your popular days. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:s}):null,empty:{icon:ie,description:r(`No views in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,N.jsx)(le,{withHeadlineCount:!0}),children:(0,N.jsx)(fe,{label:t?.label??``,value:t?.average??0,points:c})})})}function j({attributes:e={},setError:t}){return(0,N.jsx)(ne,{attributes:e,setError:t,children:(0,N.jsx)(A,{})})}var M,N,we=t((()=>{re(),g(),i(),M=e(n(),1),ye(),k(),N=a()})),P,Te=t((()=>{o(),P={icon:s}})),F,I,L,R,z,B,V,Ee=t((()=>{F=`jpa/popular-days`,I=`Popular days`,L=`The day of the week that draws the most views, with the distribution across the week.`,R={content:`The days of the week when your site received the most views on average.`,links:[{label:`Learn more`,href:`https://wordpress.com/support/stats/learn-insights-about-your-website/`}]},z=`stats`,B=`framed`,V={name:F,title:I,description:L,help:R,category:z,presentation:B}}));function De(){return(0,U.jsx)(j,{attributes:{reportParams:f(!1)}})}function H(e){return(0,U.jsx)(j,{attributes:{reportParams:f(!1,e)}})}function Oe(e){return(0,U.jsx)(ve,{...e,widgetType:G,renderModule:W,renderComponent:j,attributes:{reportParams:f(!0)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{m(),de(),v(),_(),ge(),we(),Te(),Ee(),U=a(),ue(),W=`storybook/popular-days`,G=me(V,P),K={title:`Packages/Premium Analytics/Widgets/PopularDays`,component:j,tags:[`autodocs`],parameters:{docs:{description:{component:'The "Popular days" card: the busiest day of the week for the selected range, as the weekday name and its mean views, over an area chart of the whole week\'s distribution. Both figures are means per occurrence of that weekday, not totals — a user-selected range rarely spans a whole number of weeks, so totals would let a weekday win on having occurred one extra time. Data comes from `stats/visits` at daily granularity, folded into seven buckets client-side; `stats/insights` also reports weekday views but over a window fixed at ten weeks, so it cannot follow the date picker. There is no WithComparison story — the widget strips comparison from its request and renders no delta, so it would be identical to Default.'}}}},q={render:De,decorators:[y]},J={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(h(`stats/visits`,`loading`),()=>h(`stats/visits`,null))},Y={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(h(`stats/visits`,`error`),()=>h(`stats/visits`,null))},X={render:()=>H(`last-12-months`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(h(`stats/visits`,`error-retryable`),()=>h(`stats/visits`,null))},Z={render:()=>H(`last-year`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(h(`stats/visits`,`empty`),()=>h(`stats/visits`,null))},Q={render:e=>(0,U.jsx)(Oe,{...e}),args:{..._e},argTypes:{...he}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
