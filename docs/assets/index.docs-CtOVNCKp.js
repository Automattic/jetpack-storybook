import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-C1hVpwrU.js";import{i as r,n as i,r as a,t as o}from"./blocks-NmFBKDVX.js";import{t as s}from"./mdx-react-shim-CSXXrJyY.js";import{Animation as c,CompositionAPI as l,CustomLabelColors as u,Default as d,ErrorStates as f,WithCompositionLegend as p,WithSize as m,WithTooltips as h,n as g,t as _}from"./index.stories-BdoHVEC3.js";function v(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(i,{title:`JS Packages/Charts Library/Charts/Pie Chart`,of:_}),`
...
`,(0,b.jsx)(a,{language:`jsx`,code:`import { GlobalChartsProvider } from '@automattic/charts';
...
`,(0,b.jsx)(t.p,{children:`Both props are deprecated in favor of the catalog roles they now point at. Declaring the role in CSS anywhere inside the provider tree beats either prop.`}),`
`,(0,b.jsxs)(t.ul,{children:[`
`,(0,b.jsxs)(t.li,{children:[(0,b.jsx)(t.strong,{children:(0,b.jsx)(t.code,{children:`labelTextColor`})}),` - Controls the color of text displayed on pie chart segments. Defaults to `,(0,b.jsx)(t.code,{children:`var(--a8c-charts-color-label-on-fill, #FFFFFF)`}),`, so labels are white until the role is declared.`]}),`
`,(0,b.jsxs)(t.li,{children:[(0,b.jsx)(t.strong,{children:(0,b.jsx)(t.code,{children:`labelBackgroundColor`})}),` - Controls the background color of labels. Defaults to `,(0,b.jsx)(t.code,{children:`var(--a8c-charts-color-label-background, transparent)`}),`, so a label reads straight off the slice. Any color value creates a rounded rectangle behind each label for enhanced readability, transparency included (e.g., `,(0,b.jsx)(t.code,{children:`rgba(0, 0, 0, 0.7)`}),`).`]}),`
`]}),`
...
`,(0,b.jsx)(t.p,{children:`Pie Charts integrate seamlessly with the chart theming system. The default theme has neutral colors and styling, and is automatically applied to all charts unless a custom theme is provided.`}),`
