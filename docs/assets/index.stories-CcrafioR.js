import{n as e}from"./chunk-zsgVPwQN.js";import{Km as t,Mh as n,Oh as r,Sr as i,fh as a,gh as o,ir as s,jh as c,jn as l,t as u}from"./iframe-BpS3yrGi.js";import{n as d,t as f}from"./layout-C4B7ZXp7.js";var p=e((()=>{})),m,h,g,_=e((()=>{u(),t(),c(),s(),d(),p(),m=r(),h=(e,t)=>{switch(e){case`fail_domain_forbidden`:case`fail_ip_forbidden`:case`fail_domain_tld`:case`fail_subdomain_wpcom`:case`siteurl_private_ip`:return n(`Your site host is on a private network. Sites can connect to WordPress.com only on public sites.`,`jetpack-connection-js`);case`connection_disabled`:return n(`This site has been suspended.`,`jetpack-connection-js`)}if(t)return a(n(`Unavailable in <a>Offline Mode</a>`,`jetpack-connection-js`),{a:(0,m.jsx)(`a`,{href:o(`jetpack-support-development-mode`),target:`_blank`,rel:`noopener noreferrer`})})},g=({title:e,images:t,children:r,assetBaseUrl:a,isLoading:o,buttonLabel:s,handleButtonClick:c,displayButtonError:u,errorCode:d,buttonIsLoading:p,loadingLabel:g,footer:_,isOfflineMode:v,logo:y})=>(0,m.jsx)(f,{title:e,assetBaseUrl:a,images:t,className:`jp-connection__connect-screen`+(o?` jp-connection__connect-screen__loading`:``),logo:y,children:(0,m.jsxs)(`div`,{className:`jp-connection__connect-screen__content`,children:[r,(0,m.jsx)(`div`,{className:`jp-connection__connect-screen__tos`,children:(0,m.jsx)(l,{agreeButtonLabel:s})}),(0,m.jsx)(i,{className:`jp-connection__connect-screen__action-button`,onClick:c,loading:p,disabled:v,children:s}),(u||v)&&(0,m.jsx)(`p`,{className:`jp-connection__connect-screen__error`,children:h(d,v)||n(`An error occurred. Please try again.`,`jetpack-connection-js`)}),(0,m.jsx)(`span`,{className:`jp-connection__connect-screen__loading-message`,role:`status`,children:p?g||n(`Loading`,`jetpack-connection-js`):``}),_&&(0,m.jsx)(`div`,{className:`jp-connection__connect-screen__footer`,children:_})]})})})),v,y,b,x,S,C,w,T,E,D;e((()=>{_(),v=r(),{action:y}=__STORYBOOK_MODULE_ACTIONS__,b={title:`JS Packages/Connection/Connect Screen`,component:g},x=e=>(0,v.jsxs)(g,{...e,children:[(0,v.jsx)(`p`,{children:`Secure and speed up your site for free with Jetpack's powerful WordPress tools`}),(0,v.jsxs)(`ul`,{children:[(0,v.jsx)(`li`,{children:`Speed up your site with optimized images`}),(0,v.jsx)(`li`,{children:`Protect your site against bot attacks`}),(0,v.jsx)(`li`,{children:`Get notifications if your site goes offline`}),(0,v.jsx)(`li`,{children:`Enhance your site with dozens of other features`})]})]}),S={buttonIsLoading:!1,buttonLabel:`Set up Jetpack`,displayButtonError:!1,handleButtonClick:y(`onButtonClick`),title:`Over 5 million WordPress sites are faster and more secure`,assetBaseUrl:`/`,images:[`connect-right.png`]},C=x.bind({}),C.args=S,w=x.bind({}),w.args={...S,buttonIsLoading:!0},T=x.bind({}),T.args={...S,displayButtonError:!0},E=x.bind({}),E.args={...S,footer:(0,v.jsx)(`div`,{children:`Hi I'm a Footer`})},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`props => <ConnectScreenVisual {...props}>
