import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{s as i,t as a,yi as o}from"./build-module-2iv4IIRq.js";import{Et as s,On as c}from"./build-module-l8c-_EUg2.js";import{m as l,v as ee}from"./hooks-Cah8-vY3.js";import{t as u}from"./src-BulC0n5b.js";import{$t as d,Mn as te,m as ne,t as f}from"./src-CAJG7LuR.js";import{t as re}from"./chart-empty-state-DNuIuq5y.js";import{c as p,i as ie,r as ae}from"./register-report-mocks-DS2M6jca.js";import{a as oe}from"./src-B9bL1H9V.js";import{t as se}from"./widget-state-CUoOJ2uc.js";import{t as ce}from"./src-kgvnKwmS.js";import{a as m,d as le,f as ue,i as h,n as g,p as _,r as v,u as de}from"./with-widget-canvas-DnqmTRjs.js";var y,b,x,S,C,w,T=e((()=>{y=`_root_o9l91_1`,b=`_content_o9l91_11`,x=`_list_o9l91_23`,S=`_item_o9l91_31`,C=`_link_o9l91_40`,w={root:y,content:b,list:x,item:S,link:C}}));function E({pages:e}){return(0,k.jsx)(`ul`,{className:w.list,children:e.map((e,t)=>{let n=oe(e.link);return(0,k.jsx)(`li`,{className:w.item,children:n?(0,k.jsx)(c,{className:w.link,href:n,variant:`unstyled`,openInNewTab:!0,title:e.label,children:e.label}):(0,k.jsx)(`span`,{className:w.link,title:e.label,children:e.label})},`${t}-${e.link}`)})})}function D(){let{reportParams:e}=ee(),n=te(e.post_id),{data:r,isLoading:a,isFetching:o,isError:c,refetch:l}=ne(n),u;if(n<=0)u=(0,k.jsx)(re,{icon:i,text:t(`Select a video to see where it is embedded across your site.`,`jetpack-premium-analytics-pkg`)});else{let e=r?.pages??[];u=(0,k.jsx)(se,{isLoading:a,isFetching:o,isError:e.length===0&&c,isEmpty:e.length===0,error:{description:t(`We couldn't load video embeds. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:()=>void l()}]},empty:{icon:i,description:t(`This video has not been embedded on any pages yet.`,`jetpack-premium-analytics-pkg`)},children:(0,k.jsx)(E,{pages:e})})}return(0,k.jsx)(s,{className:w.root,children:(0,k.jsx)(`div`,{className:w.content,children:u})})}function O({attributes:e={}}){return(0,k.jsx)(l,{attributes:e,children:(0,k.jsx)(D,{})})}var k,A=e((()=>{f(),ce(),n(),a(),u(),T(),k=r()})),j,fe=e((()=>{a(),j={icon:o}})),M,N,P,F,I,L,R,z=e((()=>{M=`jpa/video-detail-embeds`,N=`Used on posts & pages`,P=`Pages where the selected video is embedded, sourced from Jetpack Stats.`,F={content:`Lists every page on your site where the selected video is embedded, so you can see where it is being watched.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},I=`stats`,L=`framed`,R={name:M,title:N,description:P,help:F,category:I,presentation:L}}));function B(e,t=!1){return{...d(t,e),post_id:G}}function pe(){return(0,H.jsx)(O,{attributes:{reportParams:B()}})}function V(e){return(0,H.jsx)(O,{attributes:{reportParams:B(e)}})}function me(e){return(0,H.jsx)(le,{...e,widgetType:h(R,j),renderModule:U,renderComponent:O,attributes:{reportParams:B(void 0,!0)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),ae(),ue(),m(),g(),A(),fe(),z(),H=r(),ie(),U=`storybook/video-detail-embeds`,W=`stats/video/`,G=105,K={title:`Packages/Premium Analytics/Widgets/VideoDetailEmbeds`,component:O,tags:[`autodocs`],parameters:{docs:{description:{component:"Dashboard widget listing the pages where a single video is embedded, sourced from the Jetpack Stats `stats/video/%d` module via `useStatsSingleVideo`. The widget is scoped to one video through the host-composed `reportParams.post_id`; without one it prompts to select a video. In Storybook the data is served by `registerReportMocks`."}}}},q={render:pe,decorators:[v]},J={render:()=>(0,H.jsx)(O,{attributes:{reportParams:d(!1)}}),decorators:[v]},Y={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>(p(W,`loading`),()=>p(W,null))},X={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>(p(W,`error`),()=>p(W,null))},Z={render:()=>V(`last-365-days`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>(p(W,`empty`),()=>p(W,null))},Q={render:e=>(0,H.jsx)(me,{...e}),args:{...de},argTypes:{..._}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
