import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{Do as o,Ht as s,On as c,hc as l,n as u,ui as d}from"./build-module-Bb7IR3OP.js";import{Tr as ee,t as f}from"./src-CSbUP7aE.js";import{$ as p,K as m,Y as h,q as te,rt as ne}from"./report-metric-BRuIZsuS.js";import{n as re,t as g}from"./src-DTGWQK4B.js";import{Wt as ie,dr as _,xt as v}from"./chart-tooltip-DXg9f6a_.js";import{t as ae}from"./metric-tile-grid-BQZwMaas.js";import{C as oe,D as se,E as ce,S as le,T as ue,b as de,t as fe,w as pe,x as y}from"./src-DijKZpVl.js";import{t as me}from"./widget-state-BPMsNppS.js";import{i as he,t as ge}from"./src-CLZ5cVGh.js";var b,x,S,_e=t((()=>{b=`_root_4wv3p_5`,x=`_state_4wv3p_10`,S={root:b,state:x}})),C,w,T,E=t((()=>{i(),u(),ge(),C=[{id:`views`,label:r(`Views`,`jetpack-premium-analytics-pkg`)},{id:`visitors`,label:r(`Visitors`,`jetpack-premium-analytics-pkg`)},{id:`likes`,label:r(`Likes`,`jetpack-premium-analytics-pkg`)},{id:`comments`,label:r(`Comments`,`jetpack-premium-analytics-pkg`)}],w=C.map(e=>e.id),T={icon:o,attributes:[{id:`metrics`,label:r(`Metrics`,`jetpack-premium-analytics-pkg`),type:`array`,relevance:`high`,Edit:he,elements:C.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:w}}}}));function ve({metricIds:e=w}){let{reportParams:t}=ne(),{primary:n,comparison:i,hasComparison:a,isLoading:s,isFetching:c,isError:l,refetch:u}=ie(t),d=n.data,f=i.data,p=(0,O.useMemo)(()=>{let t=new Set(e);return C.filter(e=>t.has(e.id))},[e]);if(p.length===0)return(0,k.jsx)(`div`,{className:S.root,children:(0,k.jsx)(`div`,{className:S.state,children:(0,k.jsx)(ee,{children:r(`Select at least one metric to display.`,`jetpack-premium-analytics-pkg`)})})});let m=!d||p.every(({id:e})=>j[e].value(d)===0),h=p.map(({id:e,label:t})=>{let{icon:n,note:r,value:i}=j[e],o=d?i(d):0;return{key:e,icon:n,label:t,value:o,previousValue:a&&f?i(f):null,note:r,valueTitle:re(o,`number`,{decimals:0})}});return(0,k.jsx)(`div`,{className:S.root,children:(0,k.jsx)(me,{isLoading:(s||n.isPending)&&!d,isFetching:c,isError:!d&&l,isEmpty:m,error:{description:r(`We couldn't load the site overview. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:u}]},empty:{icon:o,description:r(`No stats recorded for this period.`,`jetpack-premium-analytics-pkg`)},children:(0,k.jsx)(ae,{tiles:h,dataFormat:A})})})}function D({attributes:e={}}){return(0,k.jsx)(p,{attributes:e,children:(0,k.jsx)(ve,{metricIds:e.metrics})})}var O,k,A,j,ye=t((()=>{v(),g(),fe(),i(),u(),f(),O=e(n(),1),_e(),E(),k=a(),A={type:`number`,options:{useMultipliers:!0,decimals:0}},j={views:{icon:c,value:e=>e.views},visitors:{icon:d,value:e=>e.visitors,note:r(`Sum of daily visitors — a returning visitor is counted once per day, not once for the whole period.`,`jetpack-premium-analytics-pkg`)},likes:{icon:s,value:e=>e.likes},comments:{icon:l,value:e=>e.comments}}})),M,N,P,F,I,L,R,be=t((()=>{M=`jpa/site-overview`,N=`Site overview`,P=`Views, visitors, likes, and comments for the selected period, with period-over-period change.`,F={content:`A summary of your site's views, visitors, likes, and comments, with period-over-period change.`},I=`stats`,L=`framed`,R={name:M,title:N,description:P,help:F,category:I,presentation:L}}));function z({withComparison:e,metrics:t}){return(0,V.jsx)(D,{attributes:{reportParams:_(e),metrics:t}})}function B(e){return(0,V.jsx)(D,{attributes:{reportParams:_(!1,e),...G}})}function xe({withComparison:e,metrics:t,...n}){return(0,V.jsx)(ue,{...n,widgetType:U,renderModule:H,renderComponent:D,attributes:{reportParams:_(e),metrics:t}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{v(),m(),ce(),oe(),de(),ye(),E(),be(),V=a(),te(),H=`storybook/site-overview`,U=le(R,T),W={metrics:{control:`check`,options:w,description:`Metric tiles to show in the widget body.`}},G={metrics:w},K={title:`Packages/Premium Analytics/Widgets/SiteOverview`,component:D,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`},...W},parameters:{docs:{description:{component:"The \"Site overview\" widget. Shows the selected period's headline traffic and engagement — views, visitors, likes, and comments — as metric tiles, sourced from the Jetpack Stats `summary` endpoint. Which tiles appear is controlled by the `metrics` attribute (`relevance: 'high'`), exposed inline in the widget header and in the settings drawer. This module has genuine period-over-period comparison data, so the `WithComparison` story shows a change indicator on each tile."}}}},q={render:z,args:{withComparison:!1,...G},decorators:[y]},J={render:z,args:{withComparison:!0,...G},decorators:[y]},Y={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(h(`stats/summary`,`loading`),()=>h(`stats/summary`,null))},X={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(h(`stats/summary`,`error`),()=>h(`stats/summary`,null))},Z={render:()=>B(`last-365-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(h(`stats/summary`,`empty`),()=>h(`stats/summary`,null))},Q={render:e=>(0,V.jsx)(xe,{...e}),args:{...pe,withComparison:!0,...G},argTypes:{...se,withComparison:{control:`boolean`},...W}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
