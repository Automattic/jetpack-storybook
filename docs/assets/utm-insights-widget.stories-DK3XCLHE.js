import{i as e}from"./preload-helper-usAeo7Bx.js";import{S as t,n,t as r}from"./build-module-DyKOxfM8.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{_ as a,t as o}from"./build-module-CbwHEf9N.js";import{n as s,w as c}from"./build-module-Bb7IR3OP.js";import{Tr as ee,t as l}from"./src-DfGoM4Wo.js";import{E as u,G as d,S as te,W as f,Z as p,b as ne,tt as re,w as ie}from"./report-metric-C2qSdc10.js";import{t as m,v as ae}from"./src-q13B8HIT.js";import{r as oe}from"./hooks-D8xIM8Ni.js";import{Bt as h,J as se,X as ce,d as le,q as g,ur as _,xt as v}from"./chart-tooltip-Q7InuXI3.js";import{t as ue}from"./leaderboard-chart-DDNzyKO1.js";import{C as y,D as b,E as x,O as S,S as de,T as fe,b as pe,k as C,t as me,w as he,x as w}from"./src-Chtk5f2b.js";import{t as ge}from"./widget-state-BcIxksOs.js";import{n as _e,t as ve}from"./src-CLT1S195.js";import{n as ye,t as be}from"./register-stats-mocks-CJc_LZBp.js";import{n as xe,t as T}from"./force-stats-mock-state-C9a8q0MB.js";var E,D,O,k,A,j,M,Se=e((()=>{E=`_root_sv0g9_1`,D=`_content_sv0g9_9`,O=`_backLink_sv0g9_17`,k=`_itemLabel_sv0g9_25`,A=`_itemLabelInset_sv0g9_37`,j=`_itemLabelText_sv0g9_41`,M={root:E,content:D,backLink:O,itemLabel:k,itemLabelInset:A,itemLabelText:j}}));function N(e){return typeof e.label==`string`?e.label:String(e.label)}function Ce(e){return{postId:e.id,label:N(e),value:e.value,previousValue:e.previousValue,href:e.href}}function we(e){return{label:N(e),value:e.value,previousValue:e.previousValue,children:e.children?.map(Ce),childrenHaveComparison:e.childrenHaveComparison}}function Te({reportParams:e,utmParam:t,max:n}){let{comparisonRows:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:ee}=h({...e,utmParam:t,max:n},{maxRows:n}),l=(r?.rows??[]).map(we),u=l.length===0&&s;return{data:l,hasComparison:i,isLoading:a,isFetching:o,isError:u,error:u?c:null,refetch:ee}}var Ee=e((()=>{v()}));function De(e){switch(e){case`utm_source,utm_medium`:return`source-medium`;case`utm_campaign,utm_source,utm_medium`:return`campaign-source-medium`;case`utm_source`:return`source`;case`utm_medium`:return`medium`;case`utm_campaign`:return`campaign`}}function Oe({utmDimension:e,max:r,showReportLink:i}){let{reportParams:o}=re(),{drillDownItem:s,drillDown:c,resetDrillDown:l}=oe();(0,a.useEffect)(()=>{l()},[l,e]);let{data:d,hasComparison:f,isLoading:p,isFetching:m,isError:h,error:_,refetch:v}=Te({reportParams:o,utmParam:e,max:r}),y=(0,a.useMemo)(()=>d.find(e=>e.label===s)??null,[d,s]),b=!!y?.children?.length,x=(0,a.useMemo)(()=>b?y?.children??[]:d,[d,b,y]),S=b?!!y?.childrenHaveComparison:f;(0,a.useEffect)(()=>{s&&!b&&!p&&!m&&!h&&l()},[s,b,p,m,h,l]);let de=(0,a.useMemo)(()=>{let e=se(x.map(e=>e.value),S?x.map(e=>e.previousValue):[]);return x.map((r,i)=>{let a=r.previousValue,o=`postId`in r?r:null;return{id:`${i}-${r.label}`,label:o?(0,F.jsx)(ne,{id:o.postId,label:o.label,link:o.href,variant:`overlay`,className:M.itemLabelInset}):(0,F.jsx)(`span`,{className:M.itemLabel,children:(0,F.jsx)(ee,{className:M.itemLabelText,children:r.label})}),currentValue:r.value,currentShare:g(r.value,e),previousValue:a,previousShare:S&&a!==void 0?g(a,e):void 0,delta:S&&a!==void 0?ce(r.value,a):void 0,...!b&&`children`in r&&r.children?.length&&{onClick:()=>c(r.label),ariaLabel:t(n(`View posts for %s`,`jetpack-premium-analytics-pkg`),r.label)}}})},[x,b,c,S]);return(0,F.jsxs)(F.Fragment,{children:[b?(0,F.jsx)(u,{label:n(`All UTM Insights`,`jetpack-premium-analytics-pkg`),ariaLabel:n(`View all UTM insights`,`jetpack-premium-analytics-pkg`),onClick:l,className:M.backLink}):null,(0,F.jsx)(`div`,{className:M.content,children:(0,F.jsx)(ge,{isLoading:p,isFetching:m,isError:h,isEmpty:d.length===0,error:le(_,{retryDescription:n(`We couldn't load UTM data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:v}),empty:{icon:ae,description:n(`No UTM data in this period.`,`jetpack-premium-analytics-pkg`)},children:(0,F.jsx)(ue,{data:de,withComparison:S,withOverlayLabel:!0,showLegend:!1,dataFormat:I})})}),i&&(0,F.jsx)(ie,{children:(0,F.jsx)(te,{report:`utm`,section:De(e)})})]})}function P({attributes:e={}}){let t=e.utmDimension??L,n=e.max??10,r=e.showReportLink??!0;return(0,F.jsx)(p,{attributes:e,children:(0,F.jsx)(`div`,{className:M.root,children:(0,F.jsx)(Oe,{utmDimension:t,max:n,showReportLink:r})})})}var F,I,L,ke=e((()=>{o(),r(),l(),me(),m(),Se(),Ee(),F=i(),I={type:`number`,options:{useMultipliers:!0,decimals:0}},L=`utm_source,utm_medium`})),R,Ae=e((()=>{r(),s(),ve(),R={icon:c,attributes:[{id:`utmDimension`,label:n(`UTM parameter`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:_e,elements:[{label:n(`Source / Medium`,`jetpack-premium-analytics-pkg`),value:`utm_source,utm_medium`},{label:n(`Campaign / Source / Medium`,`jetpack-premium-analytics-pkg`),value:`utm_campaign,utm_source,utm_medium`},{label:n(`Source`,`jetpack-premium-analytics-pkg`),value:`utm_source`},{label:n(`Medium`,`jetpack-premium-analytics-pkg`),value:`utm_medium`},{label:n(`Campaign`,`jetpack-premium-analytics-pkg`),value:`utm_campaign`}],relevance:`high`},{id:`max`,label:n(`Number of results`,`jetpack-premium-analytics-pkg`),type:`integer`}],example:{attributes:{utmDimension:`utm_source,utm_medium`,max:10}}}})),z,B,V,je,Me,Ne,Pe,Fe=e((()=>{z=`jpa/utm-insights`,B=`Top UTM`,V=`Traffic breakdown by UTM parameters — source, medium, campaign, and combinations.`,je={content:`Your top UTM campaigns, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},Me=`traffic`,Ne=`framed`,Pe={name:z,title:B,description:V,help:je,category:Me,presentation:Ne}}));function H(e){return(0,U.jsx)(P,{attributes:{utmDimension:`utm_source,utm_medium`,max:10,reportParams:_(!1,e)}})}function Ie({withComparison:e,...t}){return(0,U.jsx)(fe,{...t,widgetType:Le,renderModule:W,renderComponent:P,attributes:{utmDimension:`utm_source,utm_medium`,max:10,reportParams:_(e)}})}var U,W,Le,Re,G,K,q,J,Y,X,Z,Q,$;e((()=>{v(),x(),S(),y(),pe(),f(),be(),xe(),ke(),Ae(),Fe(),U=i(),d(),ye(),W=`storybook/utm-insights`,Le=de(Pe,R),Re={title:`Packages/Premium Analytics/Widgets/UtmInsights`,component:P,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params and deltas.`}},parameters:{docs:{description:{component:`The "UTM Insights" widget. Shows traffic breakdown by UTM parameter as a ranked leaderboard. The active dimension (Source/Medium, Campaign, etc.) is switched via a dropdown in the widget header and persisted per widget instance.`}}}},G={render:({withComparison:e})=>(0,U.jsx)(P,{attributes:{utmDimension:`utm_source,utm_medium`,max:10,reportParams:_(e)}}),args:{withComparison:!1},decorators:[w,C]},K={render:({withComparison:e})=>(0,U.jsx)(P,{attributes:{utmDimension:`utm_source,utm_medium`,max:10,reportParams:_(e)}}),args:{withComparison:!0},decorators:[w,C]},q={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[w,C],beforeEach:()=>(T(`stats/utm`,`loading`),()=>T(`stats/utm`,null))},J={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[w,C],beforeEach:()=>(T(`stats/utm`,`error`),()=>T(`stats/utm`,null))},Y={render:()=>H(`last-12-months`),tags:[`!autodocs`],decorators:[w,C],beforeEach:()=>(T(`stats/utm`,`error-retryable`),()=>T(`stats/utm`,null))},X={render:()=>H(`last-365-days`),tags:[`!autodocs`],decorators:[w,C],beforeEach:()=>(T(`stats/utm`,`empty`),()=>T(`stats/utm`,null))},Z={render:({withComparison:e})=>(0,U.jsx)(P,{attributes:{utmDimension:`utm_campaign`,max:10,reportParams:_(e)}}),args:{withComparison:!1},decorators:[w,C]},Q={render:e=>(0,U.jsx)(Ie,{...e}),args:{...he,withComparison:!1},argTypes:{...b,withComparison:{control:`boolean`,description:`Include previous-period comparison report params and deltas.`}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
  render: ({
    withComparison
