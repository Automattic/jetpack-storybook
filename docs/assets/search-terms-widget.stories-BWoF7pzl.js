import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-yGZutq_9.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Gu as i,Nu as a,kn as o,t as s}from"./build-module-zwSmKorH.js";import{bt as c}from"./build-module-CpMuGSvV.js";import{Jt as l,Yt as u,Zt as d,b as f,dt as ee,g as p}from"./hooks-DeRGi1OL.js";import{t as m}from"./src-DzGfxOhQ.js";import{t as h,u as te}from"./src-DFNM1k7F.js";import{en as g,i as _,st as ne}from"./date-filters-panel-UPAwjp15.js";import"./constants-B1kGztHF.js";import{r as re,t as ie}from"./leaderboard-skeleton-C4AZTpvQ.js";import{i as ae,r as v,s as y}from"./register-report-mocks-CpSYqE4D.js";import{S as oe,b as se,j as ce}from"./report-metric-DUjMaIyc.js";import{t as le}from"./widget-state-wm0v4KGK.js";import{t as b}from"./src-BEbKO0eW.js";import{a as ue,c as x,d as S,i as de,l as fe,n as pe,o as C,r as w,s as me,u as he}from"./with-widget-canvas-CTGbkhVG.js";var T,E,D,ge=e((()=>{T=`_root_19tfr_1`,E=`_content_19tfr_9`,D={root:T,content:E}}));function _e({reportParams:e,max:t}){let{comparisonRows:n,comparison:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:l}=ne(e,{maxRows:t}),u=i&&!r.isError,d=(n?.rows??[]).map(e=>({label:typeof e.label==`string`?e.label:String(e.label),views:e.views,previousViews:u?e.previousViews:void 0})),f=d.length===0&&s;return{data:d,isLoading:a,isFetching:o,isError:f,error:f?c:null,hasComparison:u,refetch:l}}var ve=e((()=>{_()}));function ye(){let{reportParams:e}=f(),{data:n,isLoading:r,isFetching:a,isError:o,error:s,hasComparison:p,refetch:m}=_e({reportParams:e,max:10}),h=(0,i.useMemo)(()=>{let e=u(n.map(e=>e.views),p?n.map(e=>e.previousViews):[]);return n.map((t,n)=>{let r=t.previousViews;return{id:`${n}-${t.label}`,...ce({label:t.label,media:{kind:`none`},action:{kind:`static`}}),currentValue:t.views,previousValue:r,currentShare:l(t.views,e),previousShare:p&&r!==void 0?l(r,e):void 0,delta:p&&r!==void 0?d(t.views,r):void 0}})},[n,p]);return(0,k.jsxs)(c,{className:D.root,children:[(0,k.jsx)(`div`,{className:D.content,children:(0,k.jsx)(le,{isLoading:r,isFetching:a,isError:o,isEmpty:n.length===0,error:ee(s,{retryDescription:t(`We couldn't load search terms. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:m}),empty:{icon:te,description:t(`No search terms in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,k.jsx)(ie,{rows:10}),children:(0,k.jsx)(re,{data:h,withComparison:p,withOverlayLabel:!0,showLegend:!1,dataFormat:{type:`number`,options:{useMultipliers:!0,decimals:0}}})})}),(0,k.jsx)(oe,{children:(0,k.jsx)(se,{report:`search-terms`})})]})}function O({attributes:e={}}){return(0,k.jsx)(p,{attributes:e,children:(0,k.jsx)(ye,{})})}var k,A=e((()=>{b(),h(),a(),n(),m(),ge(),ve(),k=r()})),j,M=e((()=>{s(),j={icon:o,attributes:[],example:{attributes:{}}}})),N,P,F,I,L,R,z,be=e((()=>{N=`jpa/search-terms`,P=`Top searched terms`,F=`The search terms visitors use to find your site.`,I={content:`The most popular search terms visitors used to find your site.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function B({withComparison:e}){return(0,H.jsx)(O,{attributes:{reportParams:g(e)}})}function V(e){return(0,H.jsx)(O,{attributes:{reportParams:g(!1,e)}})}function xe(e){return(0,H.jsx)(O,{...e})}function Se({withComparison:e,...t}){return(0,H.jsx)(me,{...t,widgetType:W,renderModule:U,renderComponent:xe,attributes:{reportParams:g(e)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{_(),x(),he(),ue(),pe(),v(),A(),M(),be(),H=r(),ae(),U=`storybook/search-terms`,W=de(z,j),G={title:`Packages/Premium Analytics/Widgets/SearchTerms`,component:O,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`}},parameters:{docs:{description:{component:`The "Search Terms" widget. Displays the top search queries visitors used to reach the site, ranked by view count. Ported from the Jetpack Stats Search Terms module.`}}}},K={render:B,args:{withComparison:!1},decorators:[w,S]},q={render:B,args:{withComparison:!0},decorators:[w,S]},J={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[w,S],beforeEach:()=>(y(`stats/search-terms`,`loading`),()=>y(`stats/search-terms`,null))},Y={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[w,S],beforeEach:()=>(y(`stats/search-terms`,`error`),()=>y(`stats/search-terms`,null))},X={render:()=>V(`last-12-months`),tags:[`!autodocs`],decorators:[w,S],beforeEach:()=>(y(`stats/search-terms`,`error-retryable`),()=>y(`stats/search-terms`,null))},Z={render:()=>V(`last-year`),tags:[`!autodocs`],decorators:[w,S],beforeEach:()=>(y(`stats/search-terms`,`empty`),()=>y(`stats/search-terms`,null))},Q={render:e=>(0,H.jsx)(Se,{...e}),args:{...C,withComparison:!0},argTypes:{...fe,withComparison:{control:`boolean`}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
