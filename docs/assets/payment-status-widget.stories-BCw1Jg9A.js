import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-2QZQpBH2.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{fl as o,t as s}from"./build-module-zwSmKorH.js";import{Bt as c}from"./build-module-D5hqcG7F.js";import{b as l,f as ee,g as u}from"./hooks-DKdSugtl.js";import{c as te,t as d}from"./src-DFNM1k7F.js";import{t as f}from"./src-BQD93-DN.js";import{C as p,t as m}from"./src-BGYku0wI.js";import{Kt as ne,Zt as h,t as g}from"./src-CZ15QJn2.js";import{Dt as re,et as ie}from"./chart-tooltip-VE09iklY.js";import{r as ae,t as oe}from"./donut-chart-skeleton-xmmPvDtD.js";import{G as se,K as _,Y as v}from"./report-metric-T2DKTFub.js";import{t as ce}from"./widget-state-C8Uws0tq.js";import{C as le,D as ue,E as de,S as fe,T as pe,b as y,t as b,w as x,x as S}from"./src-mEXT56Hm.js";var C,w,me=t((()=>{C=`_container_18scw_1`,w={container:C}}));function he(){let{reportParams:e}=l(),{primary:t,comparison:n,hasComparison:i,isLoading:a,isFetching:o,hasData:s,isError:u,refetch:d}=ne({...e,filters:re}),{chartData:f,total:p,comparisonTotal:m,legendData:h}=(0,T.useMemo)(()=>ie(t.data,n.data),[t.data,n.data]),g=ee(f);return(0,E.jsx)(ce,{isLoading:a,isFetching:o,isError:u&&!s,isEmpty:f.length===0,error:{description:r(`We couldn't load payment data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:d}]},empty:{icon:te,description:r(`No order revenue in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,E.jsx)(oe,{}),children:(0,E.jsx)(c,{className:w.container,direction:`column`,align:`center`,justify:`center`,children:(0,E.jsx)(ae,{chartData:f,value:p,styles:g,comparisonValue:i?m:null,legendData:h,showLegend:!0,dataFormat:{type:`currency`,options:{useMultipliers:!0,decimals:1}},maxSize:null,withTooltips:!0})})})}var T,E,ge=t((()=>{g(),d(),b(),i(),f(),T=e(n(),1),me(),E=a()}));function D({attributes:e={}}){return(0,O.jsx)(u,{attributes:e,options:{from:`/`},children:(0,O.jsx)(he,{})})}var O,_e=t((()=>{b(),ge(),O=a()})),k,A=t((()=>{s(),k={icon:o}})),j,M,N,P,F,I,L,ve=t((()=>{j=`jpa/payment-status`,M=`Payment status`,N=`Shows the breakdown of paid vs unpaid order revenue over the selected time period.`,P={content:`Shows the breakdown of paid vs unpaid order revenue over the selected time period.`},F=`store`,I=`framed`,L={name:j,title:M,description:N,help:P,category:F,presentation:I}}));function R(e=!1,t=W){return{reportParams:h(e,t)}}function ye({withComparison:e,preset:t}){let n=!!e,r=t??W;return!n&&r===W?`getDefaultQueryParams()`:n&&r===W?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function z(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
