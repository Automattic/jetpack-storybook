import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DQ5lAs4a.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{N as i,t as a}from"./build-module-DMs68Vfd.js";import{Ht as o,n as s}from"./build-module-Bt8gOW8e.js";import{A as c,t as l}from"./src-CT5b53ej.js";import{g as u,t as d}from"./src-hyofVqDU.js";import{Kn as f,un as p,ut as m}from"./chart-tooltip-ClIvRUzH.js";import{E as h,S as g,o as _}from"./report-metric-C9QRZwAo.js";import{n as v,t as y}from"./register-report-mocks-CEOd2Lr0.js";import{t as b}from"./widget-state-CkRqQWXE.js";import{S as x,b as S,t as C,x as w,y as T}from"./src-DeeVzTNc.js";var E,D,O=e((()=>{E=`_root_1fmq0_3`,D={root:E}}));function k(){let{reportParams:e}=h(),n=Number(e.post_id),r=Number.isInteger(n)&&n>0?n:0,{data:a,isLoading:o,isFetching:s,isError:l,refetch:d}=p({postId:r,number:M}),f=(0,i.useMemo)(()=>(a?.likes??[]).map(e=>({id:e.ID,name:e.name||e.login,avatarUrl:e.avatar_URL,href:e.login?`https://wordpress.com/reader/users/${e.login}`:void 0,secondaryText:u(e.date_liked)})),[a]),m=a?.found??0,g=r<=0||!!a&&f.length===0;return(0,j.jsx)(`div`,{className:D.root,children:(0,j.jsx)(b,{isLoading:o&&!a,isFetching:s,isError:!a&&l,isEmpty:g,error:{description:t(`We couldn't load these likes. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:d}]},empty:{icon:c,description:t(r<=0?`Open a post or page report to see its likes here.`:`There are no likes yet.`,`jetpack-premium-analytics`)},children:(0,j.jsx)(_,{items:f,moreCount:Math.max(0,m-f.length)})})})}function A({attributes:e={}}){return(0,j.jsx)(g,{attributes:e,children:(0,j.jsx)(k,{})})}var j,M,N=e((()=>{m(),d(),l(),C(),a(),n(),O(),j=r(),M=10})),P,F=e((()=>{n(),s(),P={name:`jpa/post-likes`,title:t(`Latest likes`,`jetpack-premium-analytics`),help:{content:t(`The people who liked the post or page being viewed.`,`jetpack-premium-analytics`)},icon:o,attributes:[],example:{attributes:{}}}}));function I({hasPostScope:e}){return{reportParams:{...f(!1),...e?{post_id:B}:{}}}}function L(e){return(0,z.jsx)(A,{attributes:I(e)})}function R({hasPostScope:e,...t}){return(0,z.jsx)(S,{...t,widgetType:{...P,presentation:`framed`},renderModule:V,renderComponent:A,attributes:I({hasPostScope:e})})}var z,B,V,H,U,W,G,K,q;e((()=>{m(),y(),w(),N(),F(),z=r(),v(),B=779,V=`storybook/post-likes`,H=e=>(0,z.jsx)(`div`,{style:{width:`360px`,height:`480px`},children:(0,z.jsx)(e,{})}),U={title:`Packages/Premium Analytics/Widgets/PostLikes`,component:A,tags:[`autodocs`],argTypes:{hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}},parameters:{docs:{description:{component:`The "Latest likes" widget: the scoped post's likers as an avatar roster with an "N more" footer — the post detail Traffic view's likes card. Each row carries the like's relative time. Without a post scope the widget renders a scopeless empty state.`}}}},W={render:L,args:{hasPostScope:!0},decorators:[H]},G={render:L,args:{hasPostScope:!1},decorators:[H]},K={render:e=>(0,z.jsx)(R,{...e}),args:{...T,widgetWidth:1,widgetHeight:2,hasPostScope:!0},argTypes:{...x,hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}}},W.parameters={...W.parameters,docs:{...W.parameters?.docs,source:{originalSource:`{
