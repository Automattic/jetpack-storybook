import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DQ5lAs4a.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{N as i,t as a}from"./build-module-DMs68Vfd.js";import{jt as o,n as s}from"./build-module-Dg-H1fk8.js";import{a as c,f as l,u}from"./hooks-FpqG2apL.js";import{A as d,S as f,t as p}from"./build-module-D4KKMcSq.js";import{nr as m,t as h}from"./build-module-B_jg7Ns4.js";import{n as g,t as _}from"./with-chart-theme-BfbqUc3N.js";import{t as v}from"./leaderboard-chart-CYk_mVtW.js";import{i as y}from"./metric-tabs-chart-DI2KyBX3.js";import{n as b,t as ee}from"./register-report-mocks-DzZbcDjd.js";import{t as te}from"./src-DOm-76F7.js";import{i as ne,n as re,r as ie,t as ae}from"./widget-dashboard-with-widget-CUgUmPco.js";var x,S,C,w,T,E,D,O=e((()=>{x=`_root_18zfn_1`,S=`_header_18zfn_9`,C=`_metricSelect_18zfn_13`,w=`_leaderboard_18zfn_17`,T=`_label_18zfn_27`,E=`_placeholder_18zfn_37`,D={root:x,header:S,metricSelect:C,leaderboard:w,label:T,placeholder:E}}));function oe(e,t){let n=e=>t===`opens`?e.opensRate:e.clicksRate,r=Math.max(...e.map(n),0);return e.map(e=>{let t=n(e);return{id:String(e.id),label:(0,M.jsx)(`span`,{className:D.label,title:e.label,children:e.label}),currentValue:t/100,currentShare:r>0?t/r*100:0,previousValue:0,previousShare:0,delta:0}})}function k(e,t){return(e?.data?.[0]?.items??[]).slice(0,t>0?t:void 0).map((e,t)=>({id:e.id??t,label:String(e.label??``),opensRate:e.opens_rate,clicksRate:e.clicks_rate}))}function A({attributes:e}){let t=e?.max??10,{data:n,isLoading:r,isFetching:a,isError:o}=l({quantity:t>0?Math.min(t,30):30});return(0,M.jsx)(N,{rows:(0,i.useMemo)(()=>k(n,t),[n,t]),isLoading:r,isFetching:a,isError:o})}function j({attributes:e}){return(0,M.jsx)(c,{children:(0,M.jsx)(A,{attributes:e})})}var M,N,P=e((()=>{u(),te(),h(),a(),n(),p(),O(),M=r(),N=({rows:e=[],isLoading:n=!1,isFetching:r=!1,isError:a=!1,initialMetric:o=`opens`})=>{let[s,c]=(0,i.useState)(o),l=(0,i.useCallback)(e=>c(e),[]),u=(0,i.useMemo)(()=>oe(e,s),[e,s]),p;return p=a?(0,M.jsx)(d,{className:D.placeholder,children:t(`Unable to load email stats.`,`jetpack-premium-analytics`)}):n&&e.length===0?(0,M.jsx)(y,{}):(0,M.jsx)(v,{className:D.leaderboard,data:u,loading:r,withComparison:!1,withOverlayLabel:!0,showLegend:!1,emptyStateText:t(`Your latest emails will appear here once you send a newsletter.`,`jetpack-premium-analytics`),dataFormat:{type:`percentage`,options:{decimals:2,signDisplay:`never`}}}),(0,M.jsxs)(f,{className:D.root,children:[(0,M.jsxs)(f,{direction:`row`,justify:`space-between`,align:`center`,className:D.header,children:[(0,M.jsx)(d,{children:t(`Latest emails sent`,`jetpack-premium-analytics`)}),(0,M.jsx)(m,{__next40pxDefaultSize:!0,__nextHasNoMarginBottom:!0,label:t(`View by`,`jetpack-premium-analytics`),hideLabelFromVision:!0,value:s,options:[{label:t(`Open rate`,`jetpack-premium-analytics`),value:`opens`},{label:t(`Click rate`,`jetpack-premium-analytics`),value:`clicks`}],onChange:l,className:D.metricSelect})]}),p]})}})),F,I=e((()=>{n(),s(),F={name:`jpa/stats-emails`,title:t(`Emails`,`jetpack-premium-analytics`),icon:o,attributes:[{id:`max`,label:t(`Number of results`,`jetpack-premium-analytics`),type:`integer`}],example:{attributes:{max:10}}}}));function L(e){return(0,R.jsx)(re,{...e,widgetType:{name:F.name,title:F.title,icon:F.icon,presentation:`full-bleed`},renderModule:z,renderComponent:j,attributes:{max:6}})}var R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{ee(),_(),ie(),P(),I(),R=r(),b(),z=`storybook/emails`,B={title:`Packages/Premium Analytics/Widgets/Emails`,component:N,tags:[`autodocs`],parameters:{docs:{description:{component:'The "Emails" widget. Lists the most recently sent emails with a selector to switch between open rate and click rate, rendered as a leaderboard. The close-up stories drive the presentational `EmailsLeaderboard` with fixtures; `WidgetDashboardWithWidget` mounts the real dashboard with the data-connected widget (fed by a mocked `stats/emails/summary` response).'}}},decorators:[g]},V=[{id:1,label:`4 Ways to Make Your Website Stand Out`,opensRate:38.1,clicksRate:3.81},{id:2,label:`Develop Locally on Linux with WordPress.com`,opensRate:41.2,clicksRate:5.98},{id:3,label:`10 Brand-New WordPress.com Themes for 2026`,opensRate:35.7,clicksRate:7.12},{id:4,label:`WordPress.com Is Now Available in More Languages`,opensRate:52.4,clicksRate:8.93},{id:5,label:`WordCamp Europe 2026: What to Expect`,opensRate:47.9,clicksRate:10.25},{id:6,label:`Click, Comment, Done: A Better Way to Collaborate`,opensRate:44.3,clicksRate:10.38}],H=[{id:1,label:`An exhaustively long, keyword-stuffed subject line that almost certainly needs to be truncated before it overflows the row`,opensRate:22.5,clicksRate:4.1},{id:2,label:`Your monthly digest: billing, new features, and what is coming next`,opensRate:33.8,clicksRate:6.7}],U={args:{rows:V}},W={args:{rows:V,initialMetric:`clicks`}},G={args:{rows:[],isLoading:!0}},K={args:{rows:[]}},q={args:{isError:!0}},J={args:{rows:H}},Y=(e,t=`auto`)=>n=>(0,R.jsx)(`div`,{style:{width:e,height:t,border:`1px dashed #ccc`,borderRadius:`8px`,containerType:`inline-size`,containerName:`widget`},children:(0,R.jsx)(n,{})}),X={args:{rows:V},decorators:[Y(`448px`)]},Z={args:{rows:V},decorators:[Y(`576px`)]},Q={render:e=>(0,R.jsx)(L,{...e}),args:{...ae},argTypes:{...ne}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  args: {
    rows: mockRows
  }
