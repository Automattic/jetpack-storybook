import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-BsD-IqES.js";import{i as r,n as i,r as a,t as o}from"./blocks-Bb5RGZFC.js";import{t as s}from"./mdx-react-shim-sBDG0VeL.js";import{Start as c,t as l}from"./glyph.stories-DW4OAmxd.js";import{Animation as u,BrokenLine as d,ComparisonMulti as f,ComparisonSingle as p,CurveTypes as m,DateStringFormats as h,Default as g,ErrorStates as _,GradientCustomColors as v,GradientFilled as y,GradientTransparent as b,SingleSeries as x,SmartFormatting as S,WithCompositionLegend as C,WithDefaultHiddenSeries as w,WithPointerEvents as T,Zoomable as E,n as D,t as O}from"./index.stories-BXoAgiwK.js";function k(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(i,{title:`JS Packages/Charts Library/Charts/Line Chart`,of:O}),`
...
/>`}),`
`,(0,j.jsxs)(t.p,{children:[`Tooltips render inside the chart's own wrapper, not in a `,(0,j.jsx)(t.code,{children:`document.body`}),` portal, so they stack with the page like any other element and a sticky or fixed header paints over them. `,(0,j.jsx)(t.code,{children:`detectBounds`}),` keeps the box inside the nearest ancestor that clips its overflow (`,(0,j.jsx)(t.code,{children:`overflow: hidden`}),`, `,(0,j.jsx)(t.code,{children:`clip`}),`, `,(0,j.jsx)(t.code,{children:`auto`}),` or `,(0,j.jsx)(t.code,{children:`scroll`}),`), or inside the viewport when nothing clips, flipping and then clamping it; it may reach past the chart wrapper into that ancestor. Only an ancestor smaller than the box itself can still cut it off.`]}),`
