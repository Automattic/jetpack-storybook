import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-BsD-IqES.js";import{i as r,n as i,r as a,t as o}from"./blocks-Bb5RGZFC.js";import{t as s}from"./mdx-react-shim-sBDG0VeL.js";import{Animation as c,Default as l,ErrorStates as u,FixedDimensions as d,WithCompositionLegend as f,WithTooltips as p,n as m,t as h}from"./index.stories-B65AHnAD.js";function g(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(i,{title:`JS Packages/Charts Library/Charts/Pie Semi Circle Chart`,of:h}),`
...
`,(0,v.jsxs)(t.p,{children:[`Segments automatically use the palette, but you can override individual segment colors using the `,(0,v.jsx)(t.code,{children:`color`}),` property in your data:`]}),`
...
`,(0,v.jsxs)(t.ul,{children:[`
`,(0,v.jsxs)(t.li,{children:[(0,v.jsx)(t.strong,{children:`Label`}),`: Uses `,(0,v.jsx)(t.code,{children:`--wpds-typography-font-size-lg`}),` and `,(0,v.jsx)(t.code,{children:`--wpds-typography-font-weight-emphasis`}),`, positioned above the chart`]}),`
`,(0,v.jsxs)(t.li,{children:[(0,v.jsx)(t.strong,{children:`Note`}),`: Uses `,(0,v.jsx)(t.code,{children:`--wpds-typography-font-size-md`}),`, positioned below the label`]}),`
`]}),`
`,(0,v.jsx)(t.p,{children:`Each resolves to the design system's value for that token.`}),`
`,(0,v.jsx)(a,{language:`jsx`,code:`<PieSemiCircleChart
	data={ data }
	width={ 600 }
...
`,(0,v.jsx)(t.p,{children:`Pie Semi Circle Charts integrate seamlessly with the chart theming system. The default theme has neutral styling, and is automatically applied to all charts unless a custom theme is provided.`}),`
`,(0,v.jsxs)(t.p,{children:[(0,v.jsx)(t.strong,{children:`Segment colors come from the palette custom properties, not the theme object.`}),` Set as many of the five slots as you need; an unset slot is skipped, and charts generates accessible colors beyond whatever you set:`]}),`
