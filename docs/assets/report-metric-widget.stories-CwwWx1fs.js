import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./with-widget-root-Db9Qu-vy.js";import{n as r,t as i}from"./report-metric-BtYx7su6.js";var a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;e((()=>{n(),r(),a=(e,t)=>{let n=new Date(e);return n.setDate(n.getDate()+t),n.toISOString().split(`T`)[0]},o=[.85,1.1,.95,1.2,.9,1.05,.95],s=(e,t,n={start:`2024-01-01`,end:`2024-01-07`})=>{let r=new Date(n.start);return{summary:{date_start:n.start,date_end:n.end,[e]:t},data:o.map((n,i)=>({date_start:a(r,i),[e]:t*n}))}},c={start:`2024-01-08`,end:`2024-01-14`},l={start:`2024-01-01`,end:`2024-01-07`},u=e=>{let{metricKey:t,primaryValue:n,comparisonValue:r,isLoading:i=!1,isFetching:a=!1,hasData:o=!0,includeData:u=!0}=e;return{primary:{data:u?s(t,n,c):void 0},comparison:{data:r===void 0?void 0:s(t,r,l)},timezone:`UTC`,isLoading:i,isFetching:a,hasData:o,isError:!1,error:null,refetch:()=>Promise.resolve()}},d={title:`Packages/Premium Analytics/Widgets Toolkit/Components/ReportMetricWidget`,component:i,tags:[`autodocs`],parameters:{docs:{description:{component:`Internal component that displays a metric with time series chart and optional comparison period.`}}},decorators:[t()]},f={args:{metricKey:`total_sales`,data:u({metricKey:`total_sales`,primaryValue:0,isLoading:!0,hasData:!1,includeData:!1}),dataFormat:{type:`currency`}}},p={args:{metricKey:`total_sales`,data:u({metricKey:`total_sales`,primaryValue:45678.99,isFetching:!0,hasData:!0}),dataFormat:{type:`currency`}}},m={args:{metricKey:`total_sales`,data:u({metricKey:`total_sales`,primaryValue:0,isLoading:!1,hasData:!1,includeData:!1}),dataFormat:{type:`currency`}},parameters:{docs:{description:{story:`When there is no data and loading is complete, the component renders nothing (returns null).`}}}},h={args:{metricKey:`orders_no`,data:u({metricKey:`orders_no`,primaryValue:1234}),dataFormat:{type:`number`}}},g={args:{metricKey:`total_sales`,data:u({metricKey:`total_sales`,primaryValue:1234567.89}),dataFormat:{type:`currency`,options:{useMultipliers:!0,decimals:1}}}},_={args:{metricKey:`conversion_rate`,data:u({metricKey:`conversion_rate`,primaryValue:.342}),dataFormat:{type:`percentage`,options:{decimals:1}}}},v={args:{metricKey:`total_sales`,data:u({metricKey:`total_sales`,primaryValue:45678.99,comparisonValue:38500}),dataFormat:{type:`currency`}}},y={args:{metricKey:`total_sales`,data:u({metricKey:`total_sales`,primaryValue:45678.99}),dataFormat:{type:`currency`}}},b={args:{metricKey:`total_sales`,data:u({metricKey:`total_sales`,primaryValue:35e3,comparisonValue:45678.99}),dataFormat:{type:`currency`}}},x={args:{metricKey:`total_sales`,data:u({metricKey:`total_sales`,primaryValue:45678.99,comparisonValue:38500}),dataFormat:{type:`currency`}}},S={args:{metricKey:`total_sales`,data:u({metricKey:`total_sales`,primaryValue:9876543.21,comparisonValue:7654321}),dataFormat:{type:`currency`,options:{useMultipliers:!0,decimals:1}}}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
