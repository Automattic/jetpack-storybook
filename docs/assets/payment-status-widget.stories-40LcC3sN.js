import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DQ5lAs4a.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{n as o,rl as s}from"./build-module-Bt8gOW8e.js";import{Bt as c,Lt as l,a as u,d as ee,on as d,p as f,s as p}from"./hooks-Cw-H66ea.js";import{R as m,t as h}from"./build-module-BAze1CUO.js";import{i as g,t as _}from"./src-DFyLNOp-.js";import{l as v,t as y}from"./src-DsEGMN_I.js";import{C as b,K as x}from"./chart-tooltip-7cDeUVQH.js";import{t as te}from"./donut-chart-NwxHaZAt.js";import{n as S}from"./widget-loading-overlay-CZo6ZUln.js";import{n as C,t as w}from"./register-report-mocks-BPl_Kj4W.js";import{i as T,n as E,r as D,t as O}from"./widget-dashboard-with-widget-BY2z4b5b.js";import{t as k}from"./src-C0QqKDKI.js";var A,j,ne=t((()=>{A=`_container_18scw_1`,j={container:A}}));function re(){let{reportParams:e}=ee(),{primary:t,comparison:n,hasComparison:r,isLoading:i,isFetching:a,hasData:o,isError:s,error:c,refetch:f}=l({...e,filters:x}),p=i&&!o,h=a&&o,{chartData:_,total:v,comparisonTotal:y,legendData:C}=(0,M.useMemo)(()=>b(t.data,n.data),[t.data,n.data]),w=d(_);return u(s,c,f)?null:p?(0,N.jsx)(S,{}):(0,N.jsxs)(N.Fragment,{children:[(0,N.jsx)(m,{className:j.container,direction:`column`,align:`center`,justify:`center`,children:(0,N.jsx)(te,{chartData:_,value:v,styles:w,comparisonValue:r?y:null,legendData:C,showLegend:!0,dataFormat:{type:`currency`,options:{useMultipliers:!0,decimals:1}},maxSize:null,emptyStateIcon:g,withTooltips:!0})}),h&&(0,N.jsx)(S,{})]})}var M,N,ie=t((()=>{f(),_(),k(),h(),M=e(n(),1),ne(),N=a()}));function P({attributes:e={},setError:t}){return(0,F.jsx)(p,{attributes:e,setError:t,options:{from:`/`},children:(0,F.jsx)(re,{})})}var F,I=t((()=>{k(),ie(),F=a()})),L,R=t((()=>{i(),o(),L={name:`jpa/payment-status`,title:r(`Payment status`,`jetpack-premium-analytics`),description:r(`Shows the breakdown of paid vs unpaid order revenue over the selected time period.`,`jetpack-premium-analytics`),icon:s}}));function z(e=!1,t=K){return{reportParams:c(e,t)}}function B({withComparison:e,preset:t}){let n=!!e,r=t??K;return!n&&r===K?`getDefaultQueryParams()`:n&&r===K?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function V(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
