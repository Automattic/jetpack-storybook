import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{Ht as o,On as s,_c as c,ko as l,n as u,ui as d}from"./build-module-CDRs4YxF.js";import{Tn as ee,t as f}from"./src-NeV_lg2z.js";import{J as p,Z as m,at as te,q as h,tt as ne}from"./report-metric-CG4McNXT.js";import{Gt as g,t as _,w as re}from"./src-Boe-c6TP.js";import{n as ie,t as ae}from"./src-CsA_y1X9.js";import{c as oe,d as se}from"./chart-tooltip-DEV3Aqbv.js";import{r as v,t as ce}from"./metric-tile-grid-skeleton-7D8gKbdh.js";import{t as le}from"./widget-state-BsgP3UWI.js";import{C as ue,D as de,E as fe,S as pe,T as me,b as he,t as ge,w as _e,x as y}from"./src-D-0P4cBO.js";var b,x,S,ve=t((()=>{b=`_root_4wv3p_5`,x=`_state_4wv3p_10`,S={root:b,state:x}})),C,w,T,E=t((()=>{i(),u(),oe(),C=[{id:`views`,label:r(`Views`,`jetpack-premium-analytics-pkg`)},{id:`visitors`,label:r(`Visitors`,`jetpack-premium-analytics-pkg`)},{id:`comments`,label:r(`Comments`,`jetpack-premium-analytics-pkg`)},{id:`likes`,label:r(`Likes`,`jetpack-premium-analytics-pkg`)}],w=C.map(e=>e.id),T={icon:l,attributes:[{id:`metrics`,label:r(`Metrics`,`jetpack-premium-analytics-pkg`),type:`array`,relevance:`high`,Edit:se,elements:C.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:w}}}}));function ye({metricIds:e=w}){let{reportParams:t}=te(),{primary:n,comparison:i,hasComparison:a,isLoading:o,isFetching:s,isError:c,refetch:u}=re(t),d=n.data,f=i.data,p=(0,O.useMemo)(()=>{let t=new Set(e);return C.filter(e=>t.has(e.id))},[e]);if(p.length===0)return(0,k.jsx)(`div`,{className:S.root,children:(0,k.jsx)(`div`,{className:S.state,children:(0,k.jsx)(ee,{children:r(`Select at least one metric to display.`,`jetpack-premium-analytics-pkg`)})})});let m=!d||p.every(({id:e})=>j[e].value(d)===0),h=p.map(({id:e,label:t})=>{let{icon:n,note:r,value:i}=j[e],o=d?i(d):0;return{key:e,icon:n,label:t,value:o,previousValue:a&&f?i(f):null,note:r,valueTitle:ie(o,`number`,{decimals:0})}});return(0,k.jsx)(`div`,{className:S.root,children:(0,k.jsx)(le,{isLoading:(o||n.isPending)&&!d,isFetching:s,isError:!d&&c,isEmpty:m,error:{description:r(`We couldn't load the site overview. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:u}]},empty:{icon:l,description:r(`No stats recorded for this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,k.jsx)(ce,{tiles:p.length}),children:(0,k.jsx)(v,{tiles:h,dataFormat:A})})})}function D({attributes:e={}}){return(0,k.jsx)(ne,{attributes:e,children:(0,k.jsx)(ye,{metricIds:e.metrics})})}var O,k,A,j,be=t((()=>{_(),ae(),ge(),i(),u(),f(),O=e(n(),1),ve(),E(),k=a(),A={type:`number`,options:{useMultipliers:!0,decimals:0}},j={views:{icon:s,value:e=>e.views},visitors:{icon:d,value:e=>e.visitors,note:r(`Sum of daily visitors — a returning visitor is counted once per day, not once for the whole period.`,`jetpack-premium-analytics-pkg`)},likes:{icon:o,value:e=>e.likes},comments:{icon:c,value:e=>e.comments}}})),M,N,P,F,I,L,R,xe=t((()=>{M=`jpa/site-overview`,N=`Site overview`,P=`Views, visitors, likes, and comments for the selected period, with period-over-period change.`,F={content:`A summary of your site's views, visitors, likes, and comments, with period-over-period change.`},I=`stats`,L=`framed`,R={name:M,title:N,description:P,help:F,category:I,presentation:L}}));function z({withComparison:e,metrics:t}){return(0,V.jsx)(D,{attributes:{reportParams:g(e),metrics:t}})}function B(e){return(0,V.jsx)(D,{attributes:{reportParams:g(!1,e),...G}})}function Se({withComparison:e,metrics:t,...n}){return(0,V.jsx)(me,{...n,widgetType:U,renderModule:H,renderComponent:D,attributes:{reportParams:g(e),metrics:t}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{_(),h(),fe(),ue(),he(),be(),E(),xe(),V=a(),p(),H=`storybook/site-overview`,U=pe(R,T),W={metrics:{control:`check`,options:w,description:`Metric tiles to show in the widget body.`}},G={metrics:w},K={title:`Packages/Premium Analytics/Widgets/SiteOverview`,component:D,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`},...W},parameters:{docs:{description:{component:"The \"Site overview\" widget. Shows the selected period's headline traffic and engagement — views, visitors, likes, and comments — as metric tiles, sourced from the Jetpack Stats `summary` endpoint. Which tiles appear is controlled by the `metrics` attribute (`relevance: 'high'`), exposed inline in the widget header and in the settings drawer. This module has genuine period-over-period comparison data, so the `WithComparison` story shows a change indicator on each tile."}}}},q={render:z,args:{withComparison:!1,...G},decorators:[y]},J={render:z,args:{withComparison:!0,...G},decorators:[y]},Y={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(`stats/summary`,`loading`),()=>m(`stats/summary`,null))},X={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(`stats/summary`,`error`),()=>m(`stats/summary`,null))},Z={render:()=>B(`last-365-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(`stats/summary`,`empty`),()=>m(`stats/summary`,null))},Q={render:e=>(0,V.jsx)(Se,{...e}),args:{..._e,withComparison:!0,...G},argTypes:{...de,withComparison:{control:`boolean`},...W}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
