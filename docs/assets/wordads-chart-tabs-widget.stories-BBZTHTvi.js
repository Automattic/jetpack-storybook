import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-yGZutq_9.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Gu as i,Nu as a,fl as o,t as s}from"./build-module-zwSmKorH.js";import{C as c,V as l,q as ee,tt as te,y as ne}from"./wp-date-settings-C2FTLsmo.js";import{b as re,t as ie}from"./src-DFNM1k7F.js";import{G as ae,Y as oe,q as u,t as se}from"./src-D3q39AVo.js";import{a as ce,en as d,gn as f,i as p,tn as le,w as ue}from"./date-filters-panel-BsEkk73S.js";import{r as de,t as fe}from"./metric-tabs-chart-skeleton-xCSzE7-q.js";import{G as m,K as h,Y as g}from"./report-metric-v_eEwWT1.js";import{t as _}from"./widget-state-B81G7oW6.js";import{C as v,D as pe,E as me,S as he,T as ge,b as _e,t as y,w as ve,x as b}from"./src-BwQjruTt.js";import{n as ye,r as be,t as xe}from"./with-site-time-zone-CQY2F8be.js";var x,S=e((()=>{p(),x=le()})),C,w=e((()=>{se(),C={presetIds:[oe,u,ae],periods:[`day`,`week`,`month`,`year`]}})),T,E,D=e((()=>{T=`_root_sp1nf_1`,E={root:T}})),O,k,A=e((()=>{n(),O={type:`currency`,options:{decimals:2}},k=[{id:`impressions`,label:t(`Ads Served`,`jetpack-premium-analytics-pkg`)},{id:`cpm`,label:t(`Average CPM`,`jetpack-premium-analytics-pkg`),dataFormat:O},{id:`revenue`,label:t(`Revenue`,`jetpack-premium-analytics-pkg`),dataFormat:O}]}));function j(e,t){let{primary:n,timezone:r,isLoading:a,isFetching:o,isError:s,refetch:c}=ue((0,i.useMemo)(()=>({...e,period:t}),[e,t])),l=n.data;return{metrics:(0,i.useMemo)(()=>k.map(e=>te({primary:l,comparison:void 0,hasComparison:!1,field:e.id,label:e.label,dataFormat:e.dataFormat,zone:r})),[l,r]),isLoading:a,isFetching:o,isError:s&&!l?.data?.length,isEmpty:l!==void 0&&!l.data?.length,refetch:c}}var M=e((()=>{p(),a(),A(),y()}));function Se(){let{reportParams:e}=c(),{metrics:n,isLoading:r,isFetching:i,isError:a,isEmpty:o,refetch:s}=j(e,ce(e,C.periods));return(0,P.jsx)(`div`,{className:E.root,children:(0,P.jsx)(_,{isLoading:r,isFetching:i,isError:a,isEmpty:o,error:{description:t(`We couldn't load WordAds data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:s}]},empty:{icon:re,description:t(`No WordAds data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,P.jsx)(fe,{}),children:(0,P.jsx)(de,{metrics:n,dataFormat:F,groupLabel:t(`WordAds metric`,`jetpack-premium-analytics-pkg`)})})})}function N({attributes:e={}}){let t=e.reportParams??x;return(0,P.jsx)(f,{offersComparison:!1,children:(0,P.jsx)(ne,{attributes:{...e,reportParams:t},children:(0,P.jsx)(Se,{})})})}var P,F,Ce=e((()=>{p(),ie(),y(),n(),S(),w(),D(),M(),P=r(),F={type:`number`,options:{useMultipliers:!0,decimals:0}}})),I,we=e((()=>{l(),s(),S(),w(),I={icon:o,attributes:[ee({withIntervalControl:!0,grain:C})],example:{attributes:{reportParams:x}}}})),L,R,z,B,V,H,U,Te=e((()=>{L=`jpa/wordads-chart-tabs`,R=`WordAds`,z=`Track ads served, average CPM, and revenue over the selected period.`,B={content:`Track ads served, average CPM, and revenue over the selected period.`},V=`stats`,H=`framed`,U={name:L,title:R,description:z,help:B,category:V,presentation:H}}));function W(e,t){return()=>(0,G.jsx)(N,{attributes:{reportParams:{...d(!1,e),interval:t}}})}function Ee({...e}){return(0,G.jsx)(ge,{...e,widgetType:he(U,I),renderModule:K,renderComponent:N,attributes:{reportParams:d(!1)}})}var G,K,q,J,Y,X,Z,Q,$;e((()=>{me(),p(),m(),v(),_e(),xe(),Ce(),we(),Te(),G=r(),h(),K=`storybook/wordads-chart-tabs`,q={title:`Packages/Premium Analytics/Widgets/WordAdsChartTabs`,component:N,tags:[`autodocs`],decorators:[be],argTypes:{...ye},parameters:{docs:{description:{component:"WordAds performance over the selected period as selectable metric tabs — Ads Served, Average CPM, and Revenue, matching the Calypso WordAds page's tabs — over a line chart. Ads Served is a count; CPM and revenue are currency (WordAds pays USD). The widget hosts its own date range and bucket-size controls in its header, saved onto the widget instance; which metric is plotted is the chart's own tab selection. WordAds stats are computed nightly, so the last bucket of a range ending today stays empty until that run lands; only a range ending in the future is clamped back to today. Data comes from the `useStatsWordAdsStats` hook (the `wordads` proxy prefix); in Storybook it is served by `registerReportMocks`. Requires WordAds to be active on the site for live data."}}}},J={render:W(`last-30-days`,`day`),decorators:[b]},Y={render:W(`last-90-days`,`week`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(g(`wordads/stats`,`loading`),()=>g(`wordads/stats`,null))},X={render:W(`last-7-days`,`day`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(g(`wordads/stats`,`error`),()=>g(`wordads/stats`,null))},Z={render:W(`last-365-days`,`month`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(g(`wordads/stats`,`empty`),()=>g(`wordads/stats`,null))},Q={render:e=>(0,G.jsx)(Ee,{...e}),args:{...ve},argTypes:{...pe}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
