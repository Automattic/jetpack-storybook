...
@return {import('react').Element} - The selector.`,methods:[],displayName:`ExperienceSelector`}})),C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;e((()=>{o(),d(),h(),S(),C=l(),{action:w}=__STORYBOOK_MODULE_ACTIONS__,T={title:`Packages/Search/ExperienceSelector`,component:b,parameters:{layout:`padded`},argTypes:{isWpcom:{control:`boolean`,description:"Seed `siteData.isWpcom` — hides the Off row."},supportsOnlyClassicSearch:{control:`boolean`,description:"Seed `sitePlan.supports_only_classic_search` — disables Embedded + Overlay."}},args:{isWpcom:!1,supportsOnlyClassicSearch:!1}},E=w(`saveExperience`),D=w(`setPendingExperience`),O=(e,t={},r={})=>{let a=i(),o=n(_,{...p,actions:{...p.actions,saveExperience:e=>(E(e),{type:`STORYBOOK_NOOP`}),setPendingExperience:e=>(D(e),p.actions.setPendingExperience(e))},initialState:{...p.initialState||{},jetpackSettings:e,sitePlan:{supports_instant_search:!0,...t},siteData:r}});return a.register(o),a},k=(e,t)=>(0,C.jsx)(r,{value:O(e,{supports_only_classic_search:t.supportsOnlyClassicSearch},{isWpcom:t.isWpcom}),children:(0,C.jsx)(b,{})}),A=e=>k({module_active:!0,instant_search_enabled:!0,pending_experience:null,experience:g.OVERLAY,is_updating:!1},e),j=e=>k({module_active:!0,instant_search_enabled:!0,pending_experience:g.INLINE,experience:g.OVERLAY,is_updating:!1},e),M=e=>k({module_active:!0,instant_search_enabled:!0,pending_experience:g.INLINE,experience:g.OVERLAY,is_updating:!0},e),N=e=>k({module_active:!0,instant_search_enabled:!1,pending_experience:null,experience:g.INLINE,is_updating:!1},e),N.args={supportsOnlyClassicSearch:!0},P=e=>k({module_active:!0,instant_search_enabled:!0,pending_experience:null,experience:g.EMBEDDED,is_updating:!1},e),F=e=>k({module_active:!0,instant_search_enabled:!0,pending_experience:null,experience:g.OVERLAY,is_updating:!1},e),I=e=>k({module_active:!0,instant_search_enabled:!1,pending_experience:null,experience:g.INLINE,is_updating:!1},e),L=e=>k({module_active:!1,instant_search_enabled:!1,pending_experience:null,experience:g.OFF,is_updating:!1},e),R=e=>k({module_active:!0,instant_search_enabled:!0,pending_experience:null,experience:g.OVERLAY,is_updating:!1},e),R.args={isWpcom:!0},A.__docgenInfo={description:``,methods:[],displayName:`Clean`},j.__docgenInfo={description:``,methods:[],displayName:`Dirty`},M.__docgenInfo={description:``,methods:[],displayName:`Saving`},N.__docgenInfo={description:``,methods:[],displayName:`ClassicOnlyPlan`},P.__docgenInfo={description:``,methods:[],displayName:`EmbeddedActive`},F.__docgenInfo={description:``,methods:[],displayName:`OverlayActive`},I.__docgenInfo={description:``,methods:[],displayName:`InlineActive`},L.__docgenInfo={description:``,methods:[],displayName:`OffActive`},R.__docgenInfo={description:``,methods:[],displayName:`WpcomSite`},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`args => renderWithStoryArgs({
  module_active: true,
