...
`,(0,m.jsx)(t.h3,{id:`globalchartsprovider`,children:`GlobalChartsProvider`}),`
`,(0,m.jsx)(t.p,{children:`The main provider component that enables chart context functionality.`}),`
`,(0,m.jsx)(t.p,{children:(0,m.jsx)(t.strong,{children:`Props:`})}),`
`,(0,m.jsxs)(t.table,{children:[(0,m.jsx)(t.thead,{children:(0,m.jsxs)(t.tr,{children:[(0,m.jsx)(t.th,{children:`Prop`}),(0,m.jsx)(t.th,{children:`Type`}),(0,m.jsx)(t.th,{children:`Default`}),(0,m.jsx)(t.th,{children:`Description`})]})}),(0,m.jsxs)(t.tbody,{children:[(0,m.jsxs)(t.tr,{children:[(0,m.jsx)(t.td,{children:(0,m.jsx)(t.code,{children:`theme`})}),(0,m.jsx)(t.td,{children:(0,m.jsx)(t.code,{children:`Partial<ChartTheme>`})}),(0,m.jsx)(t.td,{children:(0,m.jsx)(t.code,{children:`defaultTheme`})}),(0,m.jsx)(t.td,{children:`Custom theme object that gets merged with the default theme`})]}),(0,m.jsxs)(t.tr,{children:[(0,m.jsx)(t.td,{children:(0,m.jsx)(t.code,{children:`children`})}),(0,m.jsx)(t.td,{children:(0,m.jsx)(t.code,{children:`ReactNode`})}),(0,m.jsx)(t.td,{children:`-`}),(0,m.jsxs)(t.td,{children:[(0,m.jsx)(t.strong,{children:`Required.`}),` Chart components and other React elements`]})]})]})]}),`
`,(0,m.jsx)(t.h3,{id:`globalchartscontextvalue`,children:`GlobalChartsContextValue`}),`
`,(0,m.jsxs)(t.p,{children:[`The context value shape provided by `,(0,m.jsx)(t.code,{children:`useGlobalChartsContext`}),`:`]}),`
`,(0,m.jsx)(t.pre,{children:(0,m.jsx)(t.code,{className:`language-typescript`,children:`interface GlobalChartsContextValue {
	// Chart registry
...
`})}),`
`,(0,m.jsx)(t.h3,{id:`chartregistration-type`,children:`ChartRegistration Type`}),`
`,(0,m.jsx)(t.pre,{children:(0,m.jsx)(t.code,{className:`language-typescript`,children:`interface ChartRegistration {
	legendItems: BaseLegendItem[];
	chartType: string;
	metadata?: Record<string, unknown>;
}
`})}),`
`,(0,m.jsx)(t.h3,{id:`elementstyles-type`,children:`ElementStyles Type`}),`
`,(0,m.jsx)(t.pre,{children:(0,m.jsx)(t.code,{className:`language-typescript`,children:`interface ElementStyles {
	color: string;
