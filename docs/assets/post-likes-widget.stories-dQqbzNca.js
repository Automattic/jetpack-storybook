import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Uu as ee,Vt as i,ju as a,t as o}from"./build-module-2iv4IIRq.js";import{b as s,g as c}from"./hooks-D420VZp3.js";import{M as te,t as l}from"./src-C-E2d-Lb.js";import{k as u,t as d}from"./src-D1E5MwTJ.js";import{Mn as ne,gt as re,r as f,tn as ie}from"./date-period-dropdown-Dxgo0KDc.js";import{c as p,i as ae,r as oe}from"./register-report-mocks-DCjOL7Af.js";import{t as se}from"./widget-state-CjSMtsIU.js";import{r as m,t as h}from"./subscriber-list-skeleton-DCIMd8_O.js";import{t as g}from"./src-BoQjZ3aI.js";import{a as _,c as ce,i as le,l as ue,n as v,o as y,r as b,s as x}from"./with-widget-canvas-D2F1garE.js";var S,C,w=e((()=>{S=`_root_6wdsv_2`,C={root:S}}));function T(){let{reportParams:e}=s(),n=ne(e.post_id),{data:r,isLoading:i,isFetching:a,isError:o,refetch:c}=re({postId:n,number:O}),l=(0,ee.useMemo)(()=>(r?.likes??[]).map(e=>({id:e.ID,name:e.name||e.login,avatarUrl:e.avatar_URL,href:e.login?`https://wordpress.com/reader/users/${e.login}`:void 0,secondaryText:u(e.date_liked)})),[r]),d=r?.found??0,f=n<=0||!!r&&l.length===0;return(0,D.jsx)(`div`,{className:C.root,children:(0,D.jsx)(se,{isLoading:i,isFetching:a,isError:!r&&o,isEmpty:f,renderLoading:(0,D.jsx)(h,{rows:O}),error:{description:t(`We couldn't load these likes. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:c}]},empty:{icon:te,description:t(n<=0?`Open a post or page report to see its likes here.`:`There are no likes yet.`,`jetpack-premium-analytics-pkg`)},children:(0,D.jsx)(m,{items:l,moreCount:Math.max(0,d-l.length)})})})}function E({attributes:e={}}){return(0,D.jsx)(c,{attributes:e,children:(0,D.jsx)(T,{})})}var D,O,de=e((()=>{f(),d(),l(),g(),a(),n(),w(),D=r(),O=10})),k,A=e((()=>{o(),k={icon:i,attributes:[],example:{attributes:{}}}})),j,M,N,P,F,I,L,R=e((()=>{j=`jpa/post-likes`,M=`Latest likes`,N=`The people who liked the post or page being viewed.`,P={content:`The people who liked the post or page being viewed.`},F=`stats`,I=`framed`,L={name:j,title:M,description:N,help:P,category:F,presentation:I}}));function z({hasPostScope:e}){return{reportParams:{...ie(!1),...e?{post_id:U}:{}}}}function B(e){return(0,H.jsx)(E,{attributes:z(e)})}function V({hasPostScope:e,...t}){return(0,H.jsx)(x,{...t,widgetType:le(L,k),renderModule:W,renderComponent:E,attributes:z({hasPostScope:e})})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),oe(),ce(),_(),v(),de(),A(),R(),H=r(),ae(),U=779,W=`storybook/post-likes`,G=`posts/${U}/likes`,K={title:`Packages/Premium Analytics/Widgets/PostLikes`,component:E,tags:[`autodocs`],argTypes:{hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}},parameters:{docs:{description:{component:`The "Latest likes" widget: the scoped post's likers as an avatar roster with an "N more" footer — the post detail Traffic view's likes card. Each row carries the like's relative time. Without a post scope the widget renders a scopeless empty state.`}}}},q={render:B,args:{hasPostScope:!0},decorators:[b]},J={render:B,args:{hasPostScope:!1},decorators:[b]},Y={render:B,args:{hasPostScope:!0},tags:[`!autodocs`],decorators:[b],beforeEach:()=>(p(G,`loading`),()=>p(G,null))},X={render:B,args:{hasPostScope:!0},tags:[`!autodocs`],decorators:[b],beforeEach:()=>(p(G,`error`),()=>p(G,null))},Z={render:B,args:{hasPostScope:!0},tags:[`!autodocs`],decorators:[b],beforeEach:()=>(p(G,`empty`),()=>p(G,null))},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...y,widgetWidth:1,widgetHeight:2,hasPostScope:!0},argTypes:{...ue,hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
