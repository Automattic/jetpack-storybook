import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Tn as i,Uu as a,Vt as o,ju as s,t as c,ul as l,vc as ee}from"./build-module-2iv4IIRq.js";import{m as u,v as te}from"./hooks-Cj_Fmvum.js";import{M as ne,t as d}from"./src-C-E2d-Lb.js";import{$t as f,Mn as re,t as p,vt as m}from"./src-nYBQ2yP0.js";import{L as h}from"./helpers-B4MbMU4M.js";import{r as g,t as ie}from"./metric-tile-grid-skeleton-eZraO3Fy.js";import{c as _,i as ae,r as oe}from"./register-report-mocks-Dj6syrWc.js";import{t as se}from"./widget-state-MjWQMHsw.js";import{t as v}from"./src-BtOn3QZQ.js";import{a as ce,d as le,f as ue,i as de,n as y,p as fe,r as b,u as x}from"./with-widget-canvas-B-2SYneu.js";var S,C,pe=e((()=>{S=`_root_owpvf_1`,C={root:S}}));function w(e,t,n){let r=0;for(let i of e)i.date>=t&&i.date<=n&&(r+=i.views);return r}function me(e,t){let{data:n,isLoading:r,isFetching:i,isError:o,refetch:s}=m({postId:e,fields:[`data`,`like_count`,`post`]});return{...(0,a.useMemo)(()=>{let e=n?.data??[],r=h(t.from),i=h(t.to),a=h(t.compare_from),o=h(t.compare_to),s=t.comp===`1`,c=r&&i?w(e,r,i):e.reduce((e,t)=>e+t.views,0),l;return s&&(l=a&&o?w(e,a,o):null),{views:c,viewsPrevious:l,comments:n?.post?.comment_count??0,likes:n?.like_count??0,hasComparison:s}},[n,t.comp,t.from,t.to,t.compare_from,t.compare_to]),isLoading:r,isFetching:i,isError:o,hasData:!!n,refetch:s}}var T=e((()=>{p(),v(),s()}));function E(){let{reportParams:e}=te(),n=re(e.post_id),{views:r,viewsPrevious:s,comments:c,likes:l,hasComparison:u,isLoading:d,isFetching:f,isError:p,hasData:m,refetch:h}=me(n,e),_=(0,a.useMemo)(()=>[{key:`views`,label:t(`Views`,`jetpack-premium-analytics-pkg`),icon:i,value:r,previousValue:s,note:t(`Views in the selected date range.`,`jetpack-premium-analytics-pkg`)},{key:`likes`,label:t(`Likes`,`jetpack-premium-analytics-pkg`),icon:o,value:l,previousValue:u?null:void 0,note:A()},{key:`comments`,label:t(`Comments`,`jetpack-premium-analytics-pkg`),icon:ee,value:c,previousValue:u?null:void 0,note:A()}],[r,s,c,l,u]);return(0,O.jsx)(`div`,{className:C.root,children:(0,O.jsx)(se,{isLoading:d,isFetching:f,isError:!m&&p,isEmpty:n<=0,error:{description:t(`We couldn't load this post's highlights. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:h}]},empty:{icon:ne,description:t(`Open a post or page report to see its highlights here.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,O.jsx)(ie,{tiles:_.length}),children:(0,O.jsx)(g,{tiles:_,dataFormat:k})})})}function D({attributes:e={}}){return(0,O.jsx)(u,{attributes:e,children:(0,O.jsx)(E,{})})}var O,k,A,he=e((()=>{p(),d(),v(),s(),n(),c(),pe(),T(),O=r(),k={type:`number`,options:{useMultipliers:!0,decimals:0}},A=()=>t(`All-time total — this metric has no per-post history.`,`jetpack-premium-analytics-pkg`)})),j,ge=e((()=>{c(),j={icon:l,attributes:[],example:{attributes:{}}}})),M,N,P,F,I,L,R,_e=e((()=>{M=`jpa/post-detail-highlights`,N=`Post highlights`,P=`Views, comments, and likes for the post or page being viewed.`,F={content:`Views, comments, and likes for the post or page being viewed.`},I=`stats`,L=`framed`,R={name:M,title:N,description:P,help:F,category:I,presentation:L}}));function z({withComparison:e,hasPostScope:t}){return{reportParams:{...f(e),...t?{post_id:H}:{}}}}function B(e){return(0,V.jsx)(D,{attributes:z(e)})}function ve({withComparison:e,hasPostScope:t,...n}){return(0,V.jsx)(le,{...n,widgetType:de(R,j),renderModule:U,renderComponent:D,attributes:z({withComparison:e,hasPostScope:t})})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{p(),oe(),ue(),ce(),y(),he(),ge(),_e(),V=r(),ae(),H=779,U=`storybook/post-detail-highlights`,W=`stats/post/${H}`,G={title:`Packages/Premium Analytics/Widgets/PostDetailHighlights`,component:D,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}},parameters:{docs:{description:{component:`The "Post highlights" widget: the scoped post's views, comments, and likes as metric tiles — the post detail Traffic view's highlights card. Views is period-scoped and carries a delta when comparison is on; comments and likes are lifetime totals with no per-post history, so their tiles show a note instead of a delta. Without a post scope the widget renders a scopeless empty state.`}}}},K={render:B,args:{withComparison:!1,hasPostScope:!0},decorators:[b]},q={render:B,args:{withComparison:!0,hasPostScope:!0},decorators:[b]},J={render:B,args:{withComparison:!1,hasPostScope:!1},decorators:[b]},Y={render:B,args:{withComparison:!1,hasPostScope:!0},tags:[`!autodocs`],decorators:[b],beforeEach:()=>(_(W,`loading`),()=>_(W,null))},X={render:B,args:{withComparison:!1,hasPostScope:!0},tags:[`!autodocs`],decorators:[b],beforeEach:()=>(_(W,`error`),()=>_(W,null))},Z={render:B,args:{withComparison:!1,hasPostScope:!0},tags:[`!autodocs`],decorators:[b],beforeEach:()=>(_(W,`empty`),()=>_(W,null))},Q={render:e=>(0,V.jsx)(ve,{...e}),args:{...x,widgetWidth:3,widgetHeight:1,withComparison:!0,hasPostScope:!0},argTypes:{...fe,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
