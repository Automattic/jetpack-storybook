import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{t as i,y as a}from"./build-module-BTtYwVLI.js";import{Ms as o,Uu as s,ju as c,t as l}from"./build-module-2iv4IIRq.js";import{Ft as u,b as d,en as f,g as p}from"./hooks-hFuVIi58.js";import{t as m}from"./geo-chart-DWDmX_8w.js";import{$t as h,b as g,kn as _,on as ee,r as v,y}from"./date-period-dropdown-CPZQT5Bk.js";import{a as te}from"./src-DO95yEWv.js";import{n as ne,t as re}from"./with-chart-theme-CXX_vPai.js";import"./constants-B1kGztHF.js";import{r as ie}from"./leaderboard-skeleton-CRoXXj6t.js";import{i as ae,r as oe,s as b}from"./register-report-mocks-VojlBbJn.js";import{N as se}from"./report-metric-DSeVOQGj.js";import{t as ce}from"./widget-state-DRxOjVt5.js";import{t as le}from"./src-wVrRhu2j.js";import{a as ue,c as de,i as fe,l as pe,n as me,o as he,r as x,s as ge,t as _e}from"./with-widget-canvas-CqXLQIwD.js";var ve,S,C,w,T,E,ye=e((()=>{ve=`_root_g10fy_1`,S=`_content_g10fy_10`,C=`_locationContent_g10fy_20`,w=`_leaderboard_g10fy_29`,T=`_map_g10fy_36`,E={root:ve,content:S,locationContent:C,leaderboard:w,map:T}}));function D(e){return(e?.data?.[0]?.items??[]).map(e=>({label:String(e.label??``),value:e.value,countryCode:e.countryCode,countryFull:e.countryFull?String(e.countryFull):void 0,link:e.link,isOther:e.isOther}))}function be({postId:e,view:t,metric:n,max:r}){let i=t===`links`,a=i?`country`:O[t],o=g(e,a,{enabled:!i&&n===`opens`}),c=y(e,a,{enabled:!i&&n===`clicks`}),l=y(e,`link`,{enabled:i}),u=y(e,`user-content-link`,{enabled:i}),d=n===`clicks`?c:o,f=i?[l,u]:[d],p=l.data,m=u.data,h=d.data,_=(0,s.useMemo)(()=>(i?[...D(p).filter(e=>!e.link),...D(m).filter(e=>!!e.link)].sort(ee):D(h)).map((e,t)=>({...e,id:t})),[i,p,m,h]);return{allRows:_,rows:(0,s.useMemo)(()=>_.slice(0,r>0?r:void 0),[_,r]),isLoading:f.some(e=>e.isLoading),isFetching:f.some(e=>e.isFetching),isError:f.some(e=>e.isError&&e.data===void 0),refetch:()=>f.forEach(e=>e.refetch())}}var O,xe=e((()=>{v(),c(),O={countries:`country`,devices:`device`,clients:`client`}}));function Se(e,n){return[[t(`Country`,`jetpack-premium-analytics-pkg`),t(n===`clicks`?`Clicks`:`Opens`,`jetpack-premium-analytics-pkg`)],...e.filter(e=>!!e.countryCode).map(e=>[e.countryCode,e.value])]}function Ce(e,t){let n=Math.max(...e.map(e=>e.value),0);return e.map(e=>{let r=t===`countries`?{kind:`flag`,url:e.countryCode?u(e.countryCode)??void 0:void 0,country:e.countryFull??e.label}:{kind:`none`},i=t===`links`?te(e.link):null;return{id:String(e.id),...se({label:e.label,media:r,action:i?{kind:`link`,href:i}:{kind:`static`}}),currentValue:e.value,currentShare:f(e.value,n),previousValue:0,previousShare:0,delta:0}})}function we(e){switch(e){case`devices`:return t(`No device data for this email yet.`,`jetpack-premium-analytics-pkg`);case`clients`:return t(`No email client data for this email yet.`,`jetpack-premium-analytics-pkg`);case`links`:return t(`No link clicks for this email yet.`,`jetpack-premium-analytics-pkg`);default:return t(`No country data for this email yet.`,`jetpack-premium-analytics-pkg`)}}function Te({view:e,metric:t,showMap:n}){let{reportParams:r}=d(),i=_(r.post_id),{allRows:a,rows:o,isLoading:s,isFetching:c,isError:l,refetch:u}=be({postId:i,view:e,metric:t,max:10});return(0,A.jsx)(M,{rows:o,mapRows:a,view:e,showMap:n,metric:t,isLoading:s,isFetching:c,isError:l,hasEmail:i>0,onRetry:u})}function k({attributes:e={}}){return(0,A.jsx)(p,{attributes:e,children:(0,A.jsx)(Te,{view:e.view??`countries`,metric:e.metric??`opens`,showMap:e.showMap??!1})})}var A,j,M,Ee=e((()=>{v(),le(),i(),c(),n(),l(),ye(),xe(),A=r(),j={type:`number`,options:{useMultipliers:!0,decimals:0}},M=({rows:e=[],mapRows:n=e,view:r=`countries`,showMap:i=!1,metric:c=`opens`,isLoading:l=!1,isFetching:u=!1,isError:d=!1,hasEmail:f=!0,onRetry:p})=>{let h=(0,s.useMemo)(()=>Ce(e,r),[e,r]),g=(0,s.useMemo)(()=>Se(n,c),[n,c]),[_,ee]=(0,s.useState)(),v=a(e=>{let t=e[0]?.contentRect;if(t){let e=Math.round(t.width);ee(t=>t===e?t:e)}}),y=i&&r===`countries`&&g.length>1&&(_??0)>=720;return(0,A.jsx)(`div`,{ref:v,className:E.root,children:(0,A.jsx)(ce,{isLoading:l,isFetching:u,isError:d,isEmpty:e.length===0,error:{description:t(`We couldn't load this email's breakdown. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:p?[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:p}]:void 0},empty:{icon:o,description:f?we(r):t(`Select an email to see its breakdown.`,`jetpack-premium-analytics-pkg`)},children:(0,A.jsxs)(`div`,{className:y?E.locationContent:E.content,children:[(0,A.jsx)(ie,{className:E.leaderboard,data:h,withComparison:!1,withOverlayLabel:!0,showLegend:!1,dataFormat:j}),y&&(0,A.jsx)(`div`,{className:E.map,"data-testid":`email-breakdown-map`,children:(0,A.jsx)(m,{data:g})})]})})})}})),N,De=e((()=>{l(),N={icon:o,attributes:[],example:{attributes:{view:`countries`,metric:`opens`}}}})),P,F,Oe,I,L,R,z,ke=e((()=>{P=`jpa/email-breakdown`,F=`Email breakdown`,Oe=`Breaks a sent email down by countries, devices, email clients, or clicked links.`,I={content:`Breaks a sent email down by countries, devices, email clients, or clicked links.`},L=`stats`,R=`framed`,z={name:P,title:F,description:Oe,help:I,category:L,presentation:R}}));function B({view:e,metric:t,showMap:n}){return(0,H.jsx)(k,{attributes:{reportParams:{...h(),post_id:U},view:e,metric:t,showMap:n}})}function V(e){return(0,H.jsx)(k,{attributes:{reportParams:{...h(!1),post_id:e},view:`countries`,metric:`opens`}})}function Ae({view:e,metric:t,showMap:n,...r}){return(0,H.jsx)(ge,{...r,widgetType:fe(z,N),renderModule:je,renderComponent:k,attributes:{reportParams:{...h(!0),post_id:U},view:e,metric:t,showMap:n}})}var H,je,U,W,G,Me,K,Ne,q,J,Y,X,Z,Q,$,Pe;e((()=>{v(),oe(),re(),de(),ue(),me(),Ee(),De(),ke(),H=r(),ae(),je=`storybook/email-breakdown`,U=1234,W=[`countries`,`devices`,`clients`,`links`],G=[`opens`,`clicks`],Me=`802px`,K=(e,{args:t})=>(0,H.jsx)(_e,{width:t.showMap&&t.view===`countries`?Me:void 0,children:(0,H.jsx)(e,{})}),Ne={title:`Packages/Premium Analytics/Widgets/EmailBreakdown`,component:k,tags:[`autodocs`],argTypes:{view:{control:`select`,options:W},metric:{control:`select`,options:G},showMap:{control:`boolean`}},parameters:{docs:{description:{component:'The "Email breakdown" widget. Breaks a single sent email down by countries, devices, email clients, or clicked links, rendered as a leaderboard. Neither `view` nor `metric` is user-editable — the post detail page pins both per card, so the host renders no settings affordance. The `metric` attribute picks the opens or clicks breakdown for the dimension views, while `links` always reads the clicks breakdown (merging internal link types with clicked user-content links, like the Calypso links module). Scoped to one email via a mocked `reportParams.post_id`. The email breakdown endpoints have no comparison period, so the widget renders without deltas.'}}},decorators:[ne]},q={render:B,args:{view:`countries`,metric:`opens`,showMap:!1},decorators:[K]},J={render:B,args:{view:`countries`,metric:`clicks`,showMap:!0},decorators:[K]},Y={render:()=>V(5601),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(b(`stats/opens/emails`,`loading`),()=>b(`stats/opens/emails`,null))},X={render:()=>V(5602),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(b(`stats/opens/emails`,`error`),()=>b(`stats/opens/emails`,null))},Z={render:()=>V(5603),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(b(`stats/opens/emails`,`empty`),()=>b(`stats/opens/emails`,null))},Q={render:()=>(0,H.jsx)(k,{attributes:{reportParams:h(!1),view:`countries`}}),decorators:[x]},$={render:e=>(0,H.jsx)(Ae,{...e}),args:{...he,view:`countries`,metric:`opens`,showMap:!1},argTypes:{...pe,view:{control:`select`,options:W},metric:{control:`select`,options:G},showMap:{control:`boolean`}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
