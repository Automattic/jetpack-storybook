import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-B4wK7unp.js";import{i as r,n as i,r as a,t as o}from"./blocks-B2as4Quw.js";import{t as s}from"./mdx-react-shim-paIryr28.js";import{AspectRatio as c,Calendar as l,Compact as u,Default as d,ErrorStates as f,FixedDimensions as p,LargeValues as m,MaximumCellSize as h,MinimumCellSize as g,WithCompositionLegend as _,n as v,t as y}from"./index.stories-CWrd6eB7.js";function b(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(i,{title:`JS Packages/Charts Library/Charts/Heatmap Chart`,of:y}),`
...
`,(0,S.jsxs)(t.p,{children:[`By default the chart fills its parent container's dimensions, reflowing fluidly as the container resizes. Give it a height in one of three ways: an explicit height on the parent, an `,(0,S.jsx)(t.code,{children:`aspectRatio`}),` to derive the height from the available width, or fixed `,(0,S.jsx)(t.code,{children:`width`}),`/`,(0,S.jsx)(t.code,{children:`height`}),` props. Without one of these the chart has no height to fill and collapses, so always constrain it:`]}),`
`,(0,S.jsx)(a,{language:`jsx`,code:`// Fill parent container — parent needs explicit height
