import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{Mn as o,n as s}from"./build-module-CDRs4YxF.js";import{$ as c,G as l,J as u,K as d,V as ee,Y as f,rt as p}from"./report-metric-CfF6QW2f.js";import{E as m,bn as te,pn as ne,qt as h,t as g}from"./src-DXQx-HLd.js";import{t as _,u as re}from"./src-C80Pc2Jl.js";import{x as ie}from"./chart-tooltip-DPvHn5um.js";import{t as ae}from"./widget-state-BcvJNT8Q.js";import{C as oe,D as se,E as ce,S as le,T as ue,b as v,t as y,w as de,x as b}from"./src-CS4QJABu.js";var x,S,C=t((()=>{x=`_root_onyev_1`,S={root:x}}));function w(e){let t=e.reduce((e,t)=>!e||t.total>e.total?t:e,void 0);return t&&t.total>0?t:void 0}function T(){let{reportParams:e}=p(),{primary:t,isLoading:n,isFetching:r,isError:i,error:a,refetch:o}=m((0,E.useMemo)(()=>ne({...e}),[e])),s=t.data,c=(0,E.useMemo)(()=>s?s.buckets.map(({hour:e,views:t})=>({hour:e,total:t,average:t/s.days})):[],[s]);return{buckets:c,peak:(0,E.useMemo)(()=>{let e=w(c);return e&&{...e,label:re(e.hour)}},[c]),isLoading:n,isFetching:r,isError:i,error:a,refetch:o}}var E,D=t((()=>{g(),_(),y(),E=e(n(),1)}));function O(){let{buckets:e,peak:t,isLoading:n,isFetching:i,isError:a,error:s,refetch:c}=T(),l=(0,A.useMemo)(()=>e.map(e=>e.average),[e]),u=a&&(!t||s instanceof te),d=t&&t.average<10&&!Number.isInteger(t.average)?1:0;return(0,j.jsx)(`div`,{className:S.root,children:(0,j.jsx)(ae,{isLoading:n,isFetching:i,isError:u,isEmpty:!t,error:u?ie(s,{retryDescription:r(`We couldn't load your popular hours. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}):null,empty:{icon:o,description:r(`No views in this period.`,`jetpack-premium-analytics-pkg`)},children:(0,j.jsx)(ee,{label:t?.label??``,value:t?.average??0,points:l,valueDecimals:d,valueUnit:`views-per-day`})})})}function k({attributes:e={},setError:t}){return(0,j.jsx)(c,{attributes:e,setError:t,children:(0,j.jsx)(O,{})})}var A,j,fe=t((()=>{g(),y(),i(),s(),A=e(n(),1),C(),D(),j=a()})),M,pe=t((()=>{s(),M={icon:o}})),N,P,F,I,L,R,z,me=t((()=>{N=`jpa/popular-hours`,P=`Popular hours`,F=`The hour of the day that draws the most views, with the distribution across the day.`,I={content:`The hours of the day when your site received the most views on average. Ranges longer than a year show the most recent 12 months.`,links:[{label:`Learn more`,href:`https://wordpress.com/support/stats/learn-insights-about-your-website/`}]},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function he(){return(0,V.jsx)(k,{attributes:{reportParams:h(!1)}})}function B(e){return(0,V.jsx)(k,{attributes:{reportParams:h(!1,e)}})}function ge(e){return(0,V.jsx)(ue,{...e,widgetType:U,renderModule:H,renderComponent:k,attributes:{reportParams:h(!0)}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{g(),l(),ce(),oe(),v(),fe(),pe(),me(),V=a(),d(),H=`storybook/popular-hours`,U=le(z,M),W={title:`Packages/Premium Analytics/Widgets/PopularHours`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:"The \"Popular hours\" card: the busiest hour of the day for the selected range, as a site-format hour label and its mean daily views, over an area chart of the whole day's distribution. Data comes from `stats/views-by/hour-of-day`, which folds the range into 24 buckets in the site's own timezone; `stats/insights` also reports an hours map, but keyed in UTC while its `highest_hour` is offset-applied, so its chart and headline disagree. Because the endpoint rejects ranges longer than 366 days, the client limits `all time` and long custom ranges to the most recent 12 months. There is no WithComparison story — the widget strips comparison from its request and renders no delta, so it would be identical to Default."}}}},G={render:he,decorators:[b]},K={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(f(`stats/views-by/hour-of-day`,`loading`),()=>f(`stats/views-by/hour-of-day`,null))},q={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(f(`stats/views-by/hour-of-day`,`error`),()=>f(`stats/views-by/hour-of-day`,null))},J={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(f(`stats/views-by/hour-of-day`,`error-retryable`),()=>f(`stats/views-by/hour-of-day`,null))},Y={render:()=>B(`last-30-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(u(`stats/views-by/hour-of-day`,{date:`2026-01-01`,start_date:`2025-12-03`,days:30,dimension:`day-of-week`,fields:[`period`,`views`],data:[[`Mon`,100]]}),()=>u(`stats/views-by/hour-of-day`,null))},X={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(u(`stats/views-by/hour-of-day`,{date:`2026-01-01`,start_date:`2025-01-01`,days:366,dimension:`hour-of-day`,fields:[`period`,`views`],data:[[`7`,4],[`19`,18]]}),()=>u(`stats/views-by/hour-of-day`,null))},Z={render:()=>B(`last-year`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(f(`stats/views-by/hour-of-day`,`empty`),()=>f(`stats/views-by/hour-of-day`,null))},Q={render:e=>(0,V.jsx)(ge,{...e}),args:{...de},argTypes:{...se}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
