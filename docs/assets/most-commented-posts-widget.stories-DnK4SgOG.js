import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as ee,t as i}from"./build-module-CbwHEf9N.js";import{Cc as a,_c as o,n as s}from"./build-module-CDRs4YxF.js";import{ln as te,t as c}from"./src-Canu895G.js";import{G as l,J as ne,S as re,b as ie,q as ae,tt as u,w as oe}from"./report-metric-CdKPbOS4.js";import{F as se,qt as d,t as f}from"./src-Ci2M5OLA.js";import"./constants-B1kGztHF.js";import{rt as ce,x as le}from"./chart-tooltip-DBFsPjtF.js";import{r as p,t as m}from"./leaderboard-skeleton-BmD8jgUI.js";import{t as h}from"./widget-state-D-WCzMRJ.js";import{C as g,D as _,E as v,O as y,S as b,T as x,b as ue,k as S,t as de,w as fe,x as C}from"./src-B2_q1OjX.js";var w,T,E,D=e((()=>{w=`_root_jzzhc_1`,T=`_content_jzzhc_9`,E={root:w,content:T}}));function O(){let{rows:e,isLoading:n,isFetching:r,isError:i,error:o,refetch:s}=se({group:`posts`,max:10}),c=(0,ee.useMemo)(()=>{let t=Math.max(...e.map(e=>e.value),0);return e.map(e=>({id:e.id,label:(0,A.jsx)(ie,{id:e.postId,label:e.label,link:e.link}),currentValue:e.value,currentShare:ce(e.value,t)}))},[e]);return(0,A.jsxs)(te,{className:E.root,children:[(0,A.jsx)(`div`,{className:E.content,children:(0,A.jsx)(h,{isLoading:n,isFetching:r,isError:i,isEmpty:e.length===0,error:le(o,{retryDescription:t(`We couldn't load commented posts. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:s}),empty:{icon:a,description:t(`None of your posts or pages have comments yet.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,A.jsx)(m,{rows:10}),children:(0,A.jsx)(p,{data:c,withOverlayLabel:!0,showLegend:!1,dataFormat:j})})}),(0,A.jsx)(oe,{children:(0,A.jsx)(re,{report:`comments`,section:`posts`,ariaLabel:t(`See the commented posts report`,`jetpack-premium-analytics-pkg`)})})]})}function k({attributes:e={}}){return(0,A.jsx)(u,{attributes:e,children:(0,A.jsx)(O,{})})}var A,j,M=e((()=>{f(),de(),i(),n(),s(),c(),D(),A=r(),j={type:`number`,options:{useMultipliers:!0,decimals:0}}})),N,P=e((()=>{s(),N={icon:o,attributes:[],example:{attributes:{}}}})),F,I,L,R,z,B,V,pe=e((()=>{F=`jpa/most-commented-posts`,I=`Top commented posts`,L=`The posts and pages that receive the most comments.`,R={content:`Your posts and pages, ranked by the number of comments they have received.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},z=`stats`,B=`framed`,V={name:F,title:I,description:L,help:R,category:z,presentation:B}}));function H(){return(0,W.jsx)(k,{attributes:{reportParams:d()}})}function U(e){return(0,W.jsx)(x,{...e,widgetType:b(V,N),renderModule:G,renderComponent:k,attributes:{reportParams:d(!0)}})}var W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),v(),g(),y(),ue(),ae(),M(),P(),pe(),W=r(),ne(),G=`storybook/most-commented-posts`,K={title:`Packages/Premium Analytics/Widgets/MostCommentedPosts`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:`The "Top commented posts" widget. Ranks the posts and pages that receive the most comments, linking each row to the published post. One half of the Jetpack Stats Comments module; "Top commented authors" covers the other.`}}}},q={render:H,decorators:[C,S]},J={render:H,tags:[`!autodocs`],decorators:[C,S],beforeEach:l(`loading`)},Y={render:H,tags:[`!autodocs`],decorators:[C,S],beforeEach:l(`error`)},X={render:H,tags:[`!autodocs`],decorators:[C,S],beforeEach:l(`error-retryable`)},Z={render:H,tags:[`!autodocs`],decorators:[C,S],beforeEach:l(`empty`)},Q={render:e=>(0,W.jsx)(U,{...e}),args:{...fe},argTypes:{..._},decorators:[S]},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
