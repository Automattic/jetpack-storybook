import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{A as i,t as a}from"./build-module-DrryaqBL.js";import{Zt as o,n as s}from"./build-module-DmVuor49.js";import{a as ee}from"./hooks-Bsiig_bf.js";import{A as te,t as c}from"./src-B3le4dug.js";import{$n as l,ar as ne,ft as u,or as re,pt as d,ut as f}from"./chart-tooltip-C4NUtjXe.js";import{n as p,t as m}from"./with-chart-theme-aGowuwde.js";import{t as ie}from"./comparative-line-chart-CSLzuj6E.js";import{D as h,F as ae,T as g,j as _,w as v}from"./report-metric-DerWADBf.js";import{a as oe}from"./report-records-table-CHNVhge9.js";import{t as se}from"./widget-state-B76seV2w.js";import{C as y,S as b,T as x,b as S,t as C,w,x as T}from"./src-0WK5HJj0.js";import{n as E,t as ce}from"./src-Dh4_FIP6.js";var D,O,k,le=e((()=>{D=`_root_gxrb3_3`,O=`_chart_gxrb3_12`,k={root:D,chart:O}}));function ue(e){return t(e===`clicks`?`Total clicks`:`Total opens`,`jetpack-premium-analytics`)}function de(e){let t=typeof e==`number`?e:Number.parseInt(e??``,10);return Number.isInteger(t)&&t>0?t:0}function fe({metric:e,granularity:n}){let{reportParams:r}=ae(),a=de(r.post_id),o=a>0,s=!!(r.compare_from&&r.compare_to),c=(0,i.useMemo)(()=>({...r,from:r.compare_from??``,to:r.compare_to??``,preset:void 0,comp:void 0,compare_from:void 0,compare_to:void 0,compare_preset:void 0}),[r]),l=d(a,r,{enabled:o&&e===`opens`}),f=u(a,r,{enabled:o&&e===`clicks`}),p=d(a,c,{enabled:o&&s&&e===`opens`}),m=u(a,c,{enabled:o&&s&&e===`clicks`}),h=e===`clicks`?f:l,g=e===`clicks`?m:p,_=s&&g.isError&&g.data===void 0,v=(0,i.useCallback)(()=>{h.refetch(),s&&g.refetch()},[h,g,s]),y=h.data,b=s?g.data:void 0,x=N[e],S=(0,i.useMemo)(()=>{if(y)return n===`day`?y:ne(y,n,e=>{let t=Number(e[x]??0);return{value:t,[x]:t}})},[y,n,x]),C=(0,i.useMemo)(()=>{if(!y||!b)return;if(n===`day`)return b;let e=y.data.map(e=>re(e.time_interval,n));if(!e.length)return;let t=new Map,r=[];return b.data.forEach((n,i)=>{let a=e[Math.min(i,e.length-1)],o=Number(n[x]??0),s=t.get(a);s?s.value+=o:(t.set(a,{start:n,value:o}),r.push(a))}),{...b,data:r.map(e=>{let n=t.get(e);return{...n.start,value:n.value,[x]:n.value}})}},[y,b,n,x]),w=(0,i.useMemo)(()=>S?oe({primary:S,comparison:C,metrics:[{key:x,label:ue(e)}]}):[],[S,C,x,e]),T=ee(w),E=(S?.data?.length??0)>0;return(0,j.jsx)(`div`,{className:k.root,children:(0,j.jsx)(se,{isLoading:h.isLoading,isFetching:h.isFetching||s&&g.isFetching,isError:h.isError||_,isEmpty:!o||!E,error:{description:t(`We couldn't load this email's timeline. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:v}]},empty:{icon:te,description:t(o?`No activity for this email in this period.`:`Open an email report to see its timeline here.`,`jetpack-premium-analytics`)},children:(0,j.jsx)(ie,{className:k.chart,series:w,styles:T,dataFormat:M})})})}function A({attributes:e={}}){return(0,j.jsx)(_,{attributes:e,children:(0,j.jsx)(fe,{metric:e.metric??`opens`,granularity:e.granularity??`day`})})}var j,M,N,pe=e((()=>{f(),c(),C(),a(),n(),le(),j=r(),M={type:`number`,options:{useMultipliers:!0,decimals:0}},N={opens:`opens_count`,clicks:`clicks_count`}})),P,me=e((()=>{n(),s(),ce(),P={name:`jpa/email-time-series`,title:t(`Email performance`,`jetpack-premium-analytics`),icon:o,help:{content:t(`How a single email performed over time: opens or clicks per day since it was sent, following the dashboard date range. Weekly and monthly grouping aggregate the daily buckets.`,`jetpack-premium-analytics`)},attributes:[{id:`metric`,label:t(`Metric`,`jetpack-premium-analytics`),type:`text`,Edit:E,elements:[{label:t(`Opens`,`jetpack-premium-analytics`),value:`opens`},{label:t(`Clicks`,`jetpack-premium-analytics`),value:`clicks`}]},{id:`granularity`,label:t(`Group by`,`jetpack-premium-analytics`),type:`text`,Edit:E,elements:[{label:t(`By days`,`jetpack-premium-analytics`),value:`day`},{label:t(`By weeks`,`jetpack-premium-analytics`),value:`week`},{label:t(`By months`,`jetpack-premium-analytics`),value:`month`}],relevance:`high`}],example:{attributes:{metric:`opens`,granularity:`day`}}}}));function F(e){return P.attributes.find(t=>t.id===e)?.elements?.map(e=>e.value)??[]}function I({withComparison:e,metric:t,granularity:n}){return(0,R.jsx)(A,{attributes:{reportParams:{...l(e),post_id:B},metric:t,granularity:n}})}function L(e){return(0,R.jsx)(A,{attributes:{reportParams:{...l(!1),post_id:e},metric:`opens`,granularity:`day`}})}function he({withComparison:e,metric:t,granularity:n,...r}){return(0,R.jsx)(y,{...r,widgetType:{...P,presentation:`framed`},renderModule:z,renderComponent:A,attributes:{reportParams:{...l(e),post_id:B},metric:t,granularity:n}})}var R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),v(),m(),w(),S(),pe(),me(),R=r(),g(),z=`storybook/email-time-series`,B=1234,V=F(`metric`),H=F(`granularity`),U={title:`Packages/Premium Analytics/Widgets/EmailTimeSeries`,component:A,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`},metric:{control:`select`,options:V},granularity:{control:`select`,options:H}},parameters:{docs:{description:{component:"The \"Email performance\" widget. Draws a single sent email's opens or clicks per day as a line chart, spanning the dashboard date range — the chart section of the legacy email detail page. The `granularity` attribute (`relevance: 'high'`) is exposed as a control by the widget host; weekly grouping aggregates the daily buckets client-side because the endpoint only reports hourly/daily. Scoped to one email via a mocked `reportParams.post_id`. With the date picker's comparison on, the compare window is fetched as a second request and drawn as a dashed overlay with date-range legend labels."}}},decorators:[p]},W={render:I,args:{withComparison:!1,metric:`opens`,granularity:`day`},decorators:[T]},G={render:I,args:{withComparison:!0,metric:`opens`,granularity:`day`},decorators:[T]},K={render:I,args:{withComparison:!1,metric:`clicks`,granularity:`day`},decorators:[T]},q={render:I,args:{withComparison:!1,metric:`opens`,granularity:`week`},decorators:[T]},J={render:()=>L(5701),tags:[`!autodocs`],decorators:[T],beforeEach:()=>(h(`stats/opens/emails`,`loading`),()=>h(`stats/opens/emails`,null))},Y={render:()=>L(5702),tags:[`!autodocs`],decorators:[T],beforeEach:()=>(h(`stats/opens/emails`,`error`),()=>h(`stats/opens/emails`,null))},X={render:()=>L(5703),tags:[`!autodocs`],decorators:[T],beforeEach:()=>(h(`stats/opens/emails`,`empty`),()=>h(`stats/opens/emails`,null))},Z={render:()=>(0,R.jsx)(A,{attributes:{reportParams:l(!1),metric:`opens`}}),decorators:[T]},Q={render:e=>(0,R.jsx)(he,{...e}),args:{...b,withComparison:!0,metric:`opens`,granularity:`day`},argTypes:{...x,withComparison:{control:`boolean`},metric:{control:`select`,options:V},granularity:{control:`select`,options:H}}},W.parameters={...W.parameters,docs:{...W.parameters?.docs,source:{originalSource:`{
