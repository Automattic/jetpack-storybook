...
`}}},I=g.bind({}),I.args={...u,showLegend:!0,smoothing:!1,data:[{...s[0],label:`New York`},{...s[1],label:`New York last year`,group:`new-york`,options:{type:`comparison`}},{...s[2],label:`Tokyo`},{...s[3],label:`Tokyo last year`,group:`tokyo`,options:{type:`comparison`}}]},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`args => {
