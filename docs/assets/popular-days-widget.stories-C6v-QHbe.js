import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{n as o,xl as s}from"./build-module-CDRs4YxF.js";import{F as c,J as l,Yt as ee,et as te,t as ne}from"./date-fns-Bm9dQUxr.js";import{$ as u,G as d,K as re,V as ie,Y as f,rt as ae}from"./report-metric-BQq61pmH.js";import{t as oe,x as se}from"./src-BKLK-O8P.js";import{j as ce,t as le}from"./src-BNSVSo09.js";import{E as ue,Gt as p,dn as de,t as m}from"./src-DKUSXTG7.js";import{t as fe,u as pe}from"./src-7KyPhUmN.js";import{x as me}from"./chart-tooltip-z4mZVY6D.js";import{t as he}from"./metric-sparkline-skeleton-YznNVrTj.js";import{t as h}from"./widget-state-D9UHPG4g.js";import{C as g,D as ge,E as _e,S as ve,T as ye,b as _,t as v,w as be,x as y}from"./src-BLf2EwWu.js";var b,x,xe=t((()=>{b=`_root_onyev_1`,x={root:b}}));function Se(e){return pe((e+1)%7)}function Ce(e){let t=ce(e.date_start??e.time_interval??e.period);if(!t)return;let n=c(t,w,T);return ee(n)&&te(n,w)===t?n:void 0}function we(e){let t=e.views??e.value;return typeof t==`number`?t:Number(t??0)||0}function S(e){let t=Array.from({length:7},()=>({total:0,occurrences:0}));return e.forEach(e=>{let n=Ce(e);if(!n)return;let r=(l(n)+6)%7;t[r].total+=we(e),t[r].occurrences+=1}),t.map(({total:e,occurrences:t},n)=>({weekday:n,label:Se(n),total:e,occurrences:t,average:t?e/t:0}))}function C(e){return e.filter(e=>e.occurrences>0).reduce((e,t)=>!e||t.average>e.average?t:e,void 0)}var w,T,E=t((()=>{le(),fe(),ne(),w=`yyyy-MM-dd`,T=new Date(2001,0,1)}));function D(){let{reportParams:e}=ae(),{primary:t,isLoading:n,isFetching:r,isError:i,error:a,refetch:o}=ue((0,O.useMemo)(()=>de({...e,stat_fields:A,period:k}),[e])),s=t.data,c=(0,O.useMemo)(()=>S(s?.data??[]),[s]);return{buckets:c,peak:(0,O.useMemo)(()=>C(c),[c]),isLoading:n,isFetching:r,isError:i,error:a,refetch:o}}var O,k,A,Te=t((()=>{m(),v(),O=e(n(),1),E(),k=`day`,A=`views,visitors`}));function Ee(){let{buckets:e,peak:t,isLoading:n,isFetching:i,isError:a,error:o,refetch:s}=D(),c=(0,M.useMemo)(()=>e.map(e=>e.average),[e]),l=a&&!t;return(0,N.jsx)(`div`,{className:x.root,children:(0,N.jsx)(h,{isLoading:n,isFetching:i,isError:l,isEmpty:!t,error:l?me(o,{retryDescription:r(`We couldn't load your popular days. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:s}):null,empty:{icon:se,description:r(`No views in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,N.jsx)(he,{withHeadlineCount:!0}),children:(0,N.jsx)(ie,{label:t?.label??``,value:t?.average??0,points:c})})})}function j({attributes:e={},setError:t}){return(0,N.jsx)(u,{attributes:e,setError:t,children:(0,N.jsx)(Ee,{})})}var M,N,De=t((()=>{oe(),v(),i(),M=e(n(),1),xe(),Te(),N=a()})),P,Oe=t((()=>{o(),P={icon:s}})),F,I,L,R,z,B,V,ke=t((()=>{F=`jpa/popular-days`,I=`Popular days`,L=`The day of the week that draws the most views, with the distribution across the week.`,R={content:`The days of the week when your site received the most views on average.`,links:[{label:`Learn more`,href:`https://wordpress.com/support/stats/#popular-hours`}]},z=`stats`,B=`framed`,V={name:F,title:I,description:L,help:R,category:z,presentation:B}}));function Ae(){return(0,U.jsx)(j,{attributes:{reportParams:p(!1)}})}function H(e){return(0,U.jsx)(j,{attributes:{reportParams:p(!1,e)}})}function je(e){return(0,U.jsx)(ye,{...e,widgetType:G,renderModule:W,renderComponent:j,attributes:{reportParams:p(!0)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{m(),d(),_e(),g(),_(),De(),Oe(),ke(),U=a(),re(),W=`storybook/popular-days`,G=ve(V,P),K={title:`Packages/Premium Analytics/Widgets/PopularDays`,component:j,tags:[`autodocs`],parameters:{docs:{description:{component:'The "Popular days" card: the busiest day of the week for the selected range, as the weekday name and its mean views, over an area chart of the whole week\'s distribution. Both figures are means per occurrence of that weekday, not totals — a user-selected range rarely spans a whole number of weeks, so totals would let a weekday win on having occurred one extra time. Data comes from `stats/visits` at daily granularity, folded into seven buckets client-side; `stats/insights` also reports weekday views but over a window fixed at ten weeks, so it cannot follow the date picker. There is no WithComparison story — the widget strips comparison from its request and renders no delta, so it would be identical to Default.'}}}},q={render:Ae,decorators:[y]},J={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(f(`stats/visits`,`loading`),()=>f(`stats/visits`,null))},Y={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(f(`stats/visits`,`error`),()=>f(`stats/visits`,null))},X={render:()=>H(`last-12-months`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(f(`stats/visits`,`error-retryable`),()=>f(`stats/visits`,null))},Z={render:()=>H(`last-year`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(f(`stats/visits`,`empty`),()=>f(`stats/visits`,null))},Q={render:e=>(0,U.jsx)(je,{...e}),args:{...be},argTypes:{...ge}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
