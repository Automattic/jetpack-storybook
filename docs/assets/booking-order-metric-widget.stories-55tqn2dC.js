import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{at as n,it as r}from"./report-metric-BfYGxsdE.js";import{Dt as i,_r as a}from"./chart-tooltip-DuuBaBe_.js";import{n as o,t as s}from"./with-widget-root-E8zOUoek.js";import{n as c,t as l}from"./booking-order-metric-widget-CpIGqsaL.js";var u,d,f,p,m,h,g,_,v;e((()=>{i(),n(),s(),c(),u=t(),d={title:`Packages/Premium Analytics/Widgets Toolkit/Widgets/BookingOrderMetricWidget`,component:l,tags:[`autodocs`],parameters:{docs:{description:{component:`Displays booking order metrics over time with comparison support. Automatically filters data to show only booking product types (booking, bookable-event, bookable-service).`}}},decorators:[o(),e=>(0,u.jsx)(`div`,{style:{width:`100%`,height:`300px`},children:(0,u.jsx)(e,{})})]},f={args:{metricKey:`orders_no`}},p={args:{metricKey:`orders_no`},decorators:[e=>(0,u.jsx)(r.Provider,{value:{reportParams:a(!0)},children:(0,u.jsx)(e,{})})]},m=(e,t=`290px`)=>n=>(0,u.jsx)(r.Provider,{value:{reportParams:a(!0)},children:(0,u.jsx)(`div`,{style:{width:e,height:t,border:`1px dashed #ccc`,borderRadius:`8px`,padding:`16px`,background:`#fafafa`,containerType:`inline-size`,containerName:`widget`},children:(0,u.jsx)(n,{})})}),h={args:{metricKey:`orders_no`},decorators:[m(`256px`)]},g={args:{metricKey:`orders_no`},decorators:[m(`448px`)]},_={args:{metricKey:`orders_no`},decorators:[m(`576px`)]},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
    metricKey: 'orders_no'
  }
