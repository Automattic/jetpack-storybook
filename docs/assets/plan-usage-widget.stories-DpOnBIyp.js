import{i as e}from"./preload-helper-usAeo7Bx.js";import{c as t,n,r,t as i}from"./build-module-Da_5_6n_.js";import{n as a,t as o}from"./clsx-SUvPW2lx.js";import{t as s}from"./jsx-runtime-D2pHJD-r.js";import{O as c,t as l}from"./build-module-DrryaqBL.js";import{ct as u,n as d}from"./build-module-DoJYX5DX.js";import{G as ee,J as te,K as f,W as ne,X as re,Z as ie,q as p}from"./report-metric-B0s87GYF.js";import{Vi as ae,Wi as m}from"./iframe-B4yjnEQU.js";import{R as oe,W as h,t as se,u as ce}from"./build-module-DdIM1p_S.js";import{n as g,t as le}from"./src-C6vVc3AQ.js";import{Dr as _,an as v,ur as y,xt as b}from"./chart-tooltip-DEQMiDtr.js";import{t as ue}from"./widget-state-B9fopQoy.js";import{C as de,D as fe,E as pe,S as me,T as he,b as ge,t as _e,w as ve,x}from"./src-CSDnXF81.js";var S,C,w,T,E,D,O,ye=e((()=>{S=`_root_1i6zp_1`,C=`_progress_1i6zp_9`,w=`_progressMeter_1i6zp_24`,T=`_isOverLimit_1i6zp_46`,E=`_progressLabel_1i6zp_55`,D=`_note_1i6zp_61`,O={root:S,progress:C,progressMeter:w,isOverLimit:T,progressLabel:E,note:D}}));function be(e){return n(e>=2?`You've surpassed your limit for two consecutive periods already.`:`You've surpassed your limit the past month.`,`jetpack-premium-analytics-pkg`)}function xe(){let e=m()?.site,t=e?.wpcom?.blog_id;return!e?.admin_url||!t?void 0:`${e.admin_url}admin.php?page=stats#!/stats/purchase/${t}?from=jetpack-premium-analytics&productType=commercial&redirect_uri=admin.php%3Fpage%3Djetpack-premium-analytics-wp-admin`}function k({limit:e,usage:i,daysToReset:a,overLimitMonths:s}){let l=i??0,u=l>=e,d=xe();return(0,j.jsxs)(oe,{className:O.root,direction:`column`,align:`stretch`,justify:`safe center`,gap:`md`,children:[(0,j.jsxs)(`div`,{className:o(O.progress,u&&O.isOverLimit),children:[(0,j.jsx)(`progress`,{className:O.progressMeter,value:Math.min(l,e),max:e,"aria-label":n(`Plan usage`,`jetpack-premium-analytics-pkg`)}),(0,j.jsx)(h,{className:O.progressLabel,variant:`body-sm`,children:t(n(`%1$s / %2$s views`,`jetpack-premium-analytics-pkg`),g(l,`number`,{decimals:0}),g(e,`number`,{decimals:0}))}),a!==void 0&&(0,j.jsx)(h,{className:O.progressLabel,variant:`body-sm`,children:t(r(`Restarts in %d day`,`Restarts in %d days`,a,`jetpack-premium-analytics-pkg`),a)})]}),(!!s||d)&&(0,j.jsxs)(h,{className:O.note,variant:`body-sm`,children:[s?(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`strong`,{children:be(s)}),` `]}):null,d&&c(n(`Do you want to increase your views limit? <a>Upgrade now</a>`,`jetpack-premium-analytics-pkg`),{a:(0,j.jsx)(ce,{href:d})})]})]})}function Se(){let{data:e,isLoading:t,isFetching:r,isError:i,refetch:a}=v(),o=e?.views_limit,s=typeof o==`number`&&o>0,c=m()?.site?.host===`vip`;return(0,j.jsx)(ue,{isLoading:t,isFetching:r,isError:!e&&i,isEmpty:!s,error:{description:n(`We couldn't load plan usage. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:n(`Retry`,`jetpack-premium-analytics-pkg`),onClick:a}]},empty:{icon:u,description:n(`Plan usage isn't available for your current plan.`,`jetpack-premium-analytics-pkg`)},children:s&&(0,j.jsx)(k,{limit:o,usage:e?.current_usage?.views_count,daysToReset:e?.current_usage?.days_to_reset,overLimitMonths:c?null:e?.over_limit_months})})}function A({attributes:e={}}){return(0,j.jsx)(ie,{attributes:e,children:(0,j.jsx)(Se,{})})}var j,Ce=e((()=>{ae(),b(),le(),_e(),l(),i(),d(),se(),a(),ye(),j=s()})),M,we=e((()=>{d(),M={icon:u,attributes:[],example:{attributes:{}}}})),N,P,F,I,L,R,z,Te=e((()=>{N=`jpa/plan-usage`,P=`Plan usage`,F=`How your billable views compare to your plan's monthly limit.`,I={content:`Billable views are your total views minus your two highest-traffic days each billing cycle, so big spikes won't count against your limit. You'll only need to upgrade if you exceed your limit for three cycles in a row.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/free-or-paid/`}]},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function B(e){return()=>(p(`jetpack-stats/usage`,e),_.removeQueries({queryKey:[`stats-app`,`plan-usage`]}),()=>{p(`jetpack-stats/usage`,null),_.removeQueries({queryKey:[`stats-app`,`plan-usage`]})})}function V({vip:e}){return()=>(f(`jetpack-stats/usage`,re),e&&(window.JetpackScriptData.site.host=`vip`),_.removeQueries({queryKey:[`stats-app`,`plan-usage`]}),()=>{f(`jetpack-stats/usage`,null),e&&delete window.JetpackScriptData.site.host,_.removeQueries({queryKey:[`stats-app`,`plan-usage`]})})}function H(){return(0,U.jsx)(A,{attributes:{reportParams:y()}})}function Ee(e){return(0,U.jsx)(he,{...e,widgetType:me(z,M),renderModule:W,renderComponent:A,attributes:{reportParams:y(!0)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{b(),te(),ne(),pe(),de(),ge(),Ce(),we(),Te(),U=s(),ee(),window.JetpackScriptData={...window.JetpackScriptData,site:{...window.JetpackScriptData?.site,admin_url:`https://example.com/wp-admin/`,wpcom:{blog_id:123456789}}},W=`storybook/plan-usage`,G={title:`Packages/Premium Analytics/Widgets/PlanUsage`,component:A,tags:[`autodocs`],parameters:{docs:{description:{component:`The "Plan usage" widget. Shows billable views used in the current billing cycle against the plan's limit as a horizontal usage meter — figures and days-until-reset inside the bar, an upgrade note below it — following the Stats "Plan usage" section. The usage endpoint is a point-in-time reading with no date range or comparison period.`}}}},K={render:H,decorators:[x]},q={render:H,tags:[`!autodocs`],decorators:[x],beforeEach:B(`loading`)},J={render:H,tags:[`!autodocs`],decorators:[x],beforeEach:B(`error`)},Y={render:H,tags:[`!autodocs`],decorators:[x],beforeEach:B(`empty`)},X={render:H,tags:[`!autodocs`],decorators:[x],beforeEach:V({vip:!1})},Z={render:H,tags:[`!autodocs`],decorators:[x],beforeEach:V({vip:!0})},Q={render:e=>(0,U.jsx)(Ee,{...e}),args:{...ve},argTypes:{...fe}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
