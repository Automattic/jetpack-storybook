import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Ot as i,n as a}from"./build-module-DmVuor49.js";import{c as o,t as s}from"./src-DN9VFS2M.js";import{dr as c,dt as l,er as u}from"./chart-tooltip-Cp0t5VrC.js";import{M as d,P as f,R as p,j as m}from"./report-metric-CT0V0PjD.js";import{C as h,S as g,T as _,b as v,t as y,w as b,y as x}from"./src-BJoM39-b.js";import{t as S}from"./visitors-by-location-widget-BAMBXIO6.js";function C({attributes:e={},setError:t}){return(0,w.jsx)(p,{attributes:e,setError:t,options:{from:`/`},children:(0,w.jsx)(S,{})})}var w,T=e((()=>{y(),w=r()})),E,D=e((()=>{n(),a(),E={name:`jpa/visitors-by-location`,title:t(`Visitors by location`,`jetpack-premium-analytics`),help:{content:t(`See where your store visitors are located geographically.`,`jetpack-premium-analytics`)},icon:i}}));function O(e=!1,t=I){return{reportParams:u(e,t)}}function k({withComparison:e,preset:t}){let n=!!e,r=t??I;return!n&&r===I?`getDefaultQueryParams()`:n&&r===I?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function A(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<VisitorsByLocationRender
\tattributes={ {
\t\treportParams: ${k(e)},
\t} }
/>`}function j({withComparison:e,preset:t}){return(0,P.jsx)(C,{attributes:O(e,t)})}function M(e){return(0,P.jsx)(C,{attributes:O(!1,e)})}function N({withComparison:e,preset:t,...n}){return(0,P.jsx)(c,{children:(0,P.jsx)(h,{...n,widgetType:E,renderModule:F,renderComponent:C,attributes:O(e,t)})})}var P,F,I,L,R,z,B,V,H,U,W,G,K;e((()=>{l(),s(),b(),v(),m(),T(),D(),P=r(),d(),F=`storybook/visitors-by-location`,I=`last-30-days`,L=o,R=e=>(0,P.jsx)(c,{children:(0,P.jsx)(x,{children:(0,P.jsx)(e,{})})}),z={title:`Packages/Premium Analytics/Widgets/VisitorsByLocation`,component:C,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:L,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`The "Visitors by location" widget. Fetches the visitors report and displays where store visitors are located geographically.`}}}},B={render:j,args:{preset:I,withComparison:!1},decorators:[R],parameters:{docs:{source:{transform:(e,t)=>A(t.args)}}}},V={render:j,args:{preset:I,withComparison:!0},decorators:[R],parameters:{docs:{source:{transform:(e,t)=>A(t.args)}}}},H={render:()=>M(`last-90-days`),tags:[`!autodocs`],decorators:[R],beforeEach:()=>(f(`sessions/by-location`,`loading`),()=>f(`sessions/by-location`,null))},U={render:()=>M(`last-7-days`),tags:[`!autodocs`],decorators:[R],beforeEach:()=>(f(`sessions/by-location`,`error`),()=>f(`sessions/by-location`,null))},W={render:()=>M(`last-365-days`),tags:[`!autodocs`],decorators:[R],beforeEach:()=>(f(`sessions/by-location`,`empty`),()=>f(`sessions/by-location`,null))},G={render:e=>(0,P.jsx)(N,{...e}),args:{...g,preset:I,withComparison:!0},argTypes:{..._,preset:{control:`select`,options:L,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
