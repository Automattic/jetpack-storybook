...
}`,...P.parameters?.docs?.source},description:{story:`The **Insights-like** instance: the year surface (all time plus calendar
...
in the range itself — and names only the bucket.`,...P.parameters?.docs?.description}}},F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`{
  args: {
    title: 'Site traffic'
  },
  render: ({
...
}`,...F.parameters?.docs?.source},description:{story:`The same header in a box too narrow for two halves: the title and the
...
shows it at any window size.`,...F.parameters?.docs?.description}}},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  args: {
    title: 'Site traffic',
...
}`,...I.parameters?.docs?.source},description:{story:`The left half on its own: nothing in the controls slot.`,...I.parameters?.docs?.description}}},L=[`Default`,`YearSurface`,`Stacked`,`WithoutControls`]}))();export{N as Default,F as Stacked,I as WithoutControls,P as YearSurface,L as __namedExportsOrder,j as default};