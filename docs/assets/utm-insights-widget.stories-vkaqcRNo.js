import{i as e}from"./preload-helper-usAeo7Bx.js";import{S as t,n,t as r}from"./build-module-DyKOxfM8.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{_ as a,t as o}from"./build-module-CbwHEf9N.js";import{Wi as s,n as c}from"./build-module-CDRs4YxF.js";import{Tn as l,t as u}from"./src-D4Dr25V7.js";import{b as d,g as f,r as ee}from"./hooks-C4nRgT-Q.js";import{b as te,t as p}from"./src-BKLK-O8P.js";import{b as m,qt as h,t as g}from"./src-nqpizkIW.js";import"./constants-B1kGztHF.js";import{c as ne,it as re,l as _,ot as ie,rt as ae,x as oe}from"./chart-tooltip-CoSs-C7k.js";import{r as se,t as ce}from"./leaderboard-skeleton-BRMU1xTg.js";import{E as le,K as v,S as ue,b as de,q as y,w as fe}from"./report-metric-rbDkxP91.js";import{t as pe}from"./widget-state-BuxierFL.js";import{C as b,D as x,E as me,O as he,S as ge,T as _e,b as ve,k as S,t as ye,w as be,x as C}from"./src-BdbOy7LB.js";import{n as xe,t as Se}from"./register-stats-mocks-PjT5aNAw.js";import{n as Ce,t as w}from"./force-stats-mock-state-DIq7HFIh.js";var T,E,we,Te,D,O,k,Ee=e((()=>{T=`_root_sv0g9_1`,E=`_content_sv0g9_9`,we=`_backLink_sv0g9_17`,Te=`_itemLabel_sv0g9_25`,D=`_itemLabelInset_sv0g9_37`,O=`_itemLabelText_sv0g9_41`,k={root:T,content:E,backLink:we,itemLabel:Te,itemLabelInset:D,itemLabelText:O}}));function A(e){return typeof e.label==`string`?e.label:String(e.label)}function De(e){return{postId:e.id,label:A(e),value:e.value,previousValue:e.previousValue,href:e.href}}function Oe(e){return{label:A(e),value:e.value,previousValue:e.previousValue,children:e.children?.map(De),childrenHaveComparison:e.childrenHaveComparison}}function ke({reportParams:e,utmParam:t,max:n}){let{comparisonRows:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:l}=m({...e,utmParam:t,max:n},{maxRows:n}),u=(r?.rows??[]).map(Oe),d=u.length===0&&s;return{data:u,hasComparison:i,isLoading:a,isFetching:o,isError:d,error:d?c:null,refetch:l}}var Ae=e((()=>{g()}));function je(e){switch(e){case`utm_source,utm_medium`:return`source-medium`;case`utm_campaign,utm_source,utm_medium`:return`campaign-source-medium`;case`utm_source`:return`source`;case`utm_medium`:return`medium`;case`utm_campaign`:return`campaign`}}function Me({utmDimension:e,showReportLink:r}){let{reportParams:i}=d(),{drillDownItem:o,drillDown:s,resetDrillDown:c}=ee();(0,a.useEffect)(()=>{c()},[c,e]);let{data:u,hasComparison:f,isLoading:p,isFetching:m,isError:h,error:g,refetch:ne}=ke({reportParams:i,utmParam:e,max:10}),_=(0,a.useMemo)(()=>u.find(e=>e.label===o)??null,[u,o]),v=!!_?.children?.length,y=(0,a.useMemo)(()=>v?_?.children??[]:u,[u,v,_]),b=v?!!_?.childrenHaveComparison:f;(0,a.useEffect)(()=>{o&&!v&&!p&&!m&&!h&&c()},[o,v,p,m,h,c]);let x=(0,a.useMemo)(()=>{let e=re(y.map(e=>e.value),b?y.map(e=>e.previousValue):[]);return y.map((r,i)=>{let a=r.previousValue,o=`postId`in r?r:null;return{id:`${i}-${r.label}`,label:o?(0,M.jsx)(de,{id:o.postId,label:o.label,link:o.href,variant:`overlay`,className:k.itemLabelInset}):(0,M.jsx)(`span`,{className:k.itemLabel,children:(0,M.jsx)(l,{className:k.itemLabelText,children:r.label})}),currentValue:r.value,currentShare:ae(r.value,e),previousValue:a,previousShare:b&&a!==void 0?ae(a,e):void 0,delta:b&&a!==void 0?ie(r.value,a):void 0,...!v&&`children`in r&&r.children?.length&&{onClick:()=>s(r.label),ariaLabel:t(n(`View posts for %s`,`jetpack-premium-analytics-pkg`),r.label)}}})},[y,v,s,b]);return(0,M.jsxs)(M.Fragment,{children:[v?(0,M.jsx)(le,{label:n(`All UTM insights`,`jetpack-premium-analytics-pkg`),ariaLabel:n(`View all UTM insights`,`jetpack-premium-analytics-pkg`),onClick:c,className:k.backLink}):null,(0,M.jsx)(`div`,{className:k.content,children:(0,M.jsx)(pe,{isLoading:p,isFetching:m,isError:h,isEmpty:u.length===0,error:oe(g,{retryDescription:n(`We couldn't load UTM data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:ne}),empty:{icon:te,description:n(`No UTM data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,M.jsx)(ce,{rows:10}),children:(0,M.jsx)(se,{data:x,withComparison:b,withOverlayLabel:!0,showLegend:!1,dataFormat:N})})}),r&&(0,M.jsx)(fe,{children:(0,M.jsx)(ue,{report:`utm`,section:je(e)})})]})}function j({attributes:e={}}){let t=e.utmDimension??P,n=e.showReportLink??!0;return(0,M.jsx)(f,{attributes:e,children:(0,M.jsx)(`div`,{className:k.root,children:(0,M.jsx)(Me,{utmDimension:t,showReportLink:n})})})}var M,N,P,Ne=e((()=>{o(),r(),u(),ye(),p(),Ee(),Ae(),M=i(),N={type:`number`,options:{useMultipliers:!0,decimals:0}},P=`utm_source,utm_medium`})),F,Pe=e((()=>{r(),c(),ne(),F={icon:s,attributes:[{id:`utmDimension`,label:n(`UTM parameter`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:_,elements:[{label:n(`Source / Medium`,`jetpack-premium-analytics-pkg`),value:`utm_source,utm_medium`},{label:n(`Campaign / Source / Medium`,`jetpack-premium-analytics-pkg`),value:`utm_campaign,utm_source,utm_medium`},{label:n(`Source`,`jetpack-premium-analytics-pkg`),value:`utm_source`},{label:n(`Medium`,`jetpack-premium-analytics-pkg`),value:`utm_medium`},{label:n(`Campaign`,`jetpack-premium-analytics-pkg`),value:`utm_campaign`}],relevance:`high`}],example:{attributes:{utmDimension:`utm_source,utm_medium`}}}})),I,L,R,z,B,V,H,Fe=e((()=>{I=`jpa/utm-insights`,L=`Top UTM`,R=`Traffic breakdown by UTM parameters — source, medium, campaign, and combinations.`,z={content:`Your top UTM campaigns, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},B=`traffic`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function U(e){return(0,W.jsx)(j,{attributes:{utmDimension:`utm_source,utm_medium`,reportParams:h(!1,e)}})}function Ie({withComparison:e,...t}){return(0,W.jsx)(_e,{...t,widgetType:Re,renderModule:Le,renderComponent:j,attributes:{utmDimension:`utm_source,utm_medium`,reportParams:h(e)}})}var W,Le,Re,ze,G,K,q,J,Y,X,Z,Q,$;e((()=>{g(),me(),he(),b(),ve(),v(),Se(),Ce(),Ne(),Pe(),Fe(),W=i(),y(),xe(),Le=`storybook/utm-insights`,Re=ge(H,F),ze={title:`Packages/Premium Analytics/Widgets/UtmInsights`,component:j,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params and deltas.`}},parameters:{docs:{description:{component:`The "UTM Insights" widget. Shows traffic breakdown by UTM parameter as a ranked leaderboard. The active dimension (Source/Medium, Campaign, etc.) is switched via a dropdown in the widget header and persisted per widget instance.`}}}},G={render:({withComparison:e})=>(0,W.jsx)(j,{attributes:{utmDimension:`utm_source,utm_medium`,reportParams:h(e)}}),args:{withComparison:!1},decorators:[C,S]},K={render:({withComparison:e})=>(0,W.jsx)(j,{attributes:{utmDimension:`utm_source,utm_medium`,reportParams:h(e)}}),args:{withComparison:!0},decorators:[C,S]},q={render:()=>U(`last-90-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/utm`,`loading`),()=>w(`stats/utm`,null))},J={render:()=>U(`last-7-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/utm`,`error`),()=>w(`stats/utm`,null))},Y={render:()=>U(`last-12-months`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/utm`,`error-retryable`),()=>w(`stats/utm`,null))},X={render:()=>U(`last-year`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/utm`,`empty`),()=>w(`stats/utm`,null))},Z={render:({withComparison:e})=>(0,W.jsx)(j,{attributes:{utmDimension:`utm_campaign`,reportParams:h(e)}}),args:{withComparison:!1},decorators:[C,S]},Q={render:e=>(0,W.jsx)(Ie,{...e}),args:{...be,withComparison:!1},argTypes:{...x,withComparison:{control:`boolean`,description:`Include previous-period comparison report params and deltas.`}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
  render: ({
    withComparison
