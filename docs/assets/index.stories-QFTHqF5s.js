import{n as e}from"./chunk-zsgVPwQN.js";import{Kv as t,Mr as n,My as r,Ny as i,_y as a,ar as o,ky as s,na as c,py as l,t as u}from"./iframe-DY8K1qQG.js";import{n as d,t as f}from"./layout-DUDSymIl.js";var p=e((()=>{})),m,h,g,_=e((()=>{u(),t(),r(),n(),d(),p(),m=s(),h=(e,t)=>{switch(e){case`fail_domain_forbidden`:case`fail_ip_forbidden`:case`fail_domain_tld`:case`fail_subdomain_wpcom`:case`siteurl_private_ip`:return i(`Your site host is on a private network. Sites can connect to WordPress.com only on public sites.`,`jetpack-connection-js`);case`connection_disabled`:return i(`This site has been suspended.`,`jetpack-connection-js`)}if(t)return l(i(`Unavailable in <a>Offline Mode</a>`,`jetpack-connection-js`),{a:(0,m.jsx)(`a`,{href:a(`jetpack-support-development-mode`),target:`_blank`,rel:`noopener noreferrer`})})},g=({title:e,images:t,children:n,assetBaseUrl:r,isLoading:a,buttonLabel:s,handleButtonClick:l,displayButtonError:u,errorCode:d,buttonIsLoading:p,loadingLabel:g,footer:_,isOfflineMode:v,logo:y})=>(0,m.jsx)(f,{title:e,assetBaseUrl:r,images:t,className:`jp-connection__connect-screen`+(a?` jp-connection__connect-screen__loading`:``),logo:y,children:(0,m.jsxs)(`div`,{className:`jp-connection__connect-screen__content`,children:[n,(0,m.jsx)(`div`,{className:`jp-connection__connect-screen__tos`,children:(0,m.jsx)(o,{agreeButtonLabel:s})}),(0,m.jsx)(c,{className:`jp-connection__connect-screen__action-button`,onClick:l,loading:p,disabled:v,children:s}),(u||v)&&(0,m.jsx)(`p`,{className:`jp-connection__connect-screen__error`,children:h(d,v)||i(`An error occurred. Please try again.`,`jetpack-connection-js`)}),(0,m.jsx)(`span`,{className:`jp-connection__connect-screen__loading-message`,role:`status`,children:p?g||i(`Loading`,`jetpack-connection-js`):``}),_&&(0,m.jsx)(`div`,{className:`jp-connection__connect-screen__footer`,children:_})]})})})),v,y,b,x,S,C,w,T,E,D;e((()=>{_(),v=s(),{action:y}=__STORYBOOK_MODULE_ACTIONS__,b={title:`JS Packages/Connection/Connect Screen`,component:g},x=e=>(0,v.jsxs)(g,{...e,children:[(0,v.jsx)(`p`,{children:`Secure and speed up your site for free with Jetpack's powerful WordPress tools`}),(0,v.jsxs)(`ul`,{children:[(0,v.jsx)(`li`,{children:`Speed up your site with optimized images`}),(0,v.jsx)(`li`,{children:`Protect your site against bot attacks`}),(0,v.jsx)(`li`,{children:`Get notifications if your site goes offline`}),(0,v.jsx)(`li`,{children:`Enhance your site with dozens of other features`})]})]}),S={buttonIsLoading:!1,buttonLabel:`Set up Jetpack`,displayButtonError:!1,handleButtonClick:y(`onButtonClick`),title:`Over 5 million WordPress sites are faster and more secure`,assetBaseUrl:`/`,images:[`connect-right.png`]},C=x.bind({}),C.args=S,w=x.bind({}),w.args={...S,buttonIsLoading:!0},T=x.bind({}),T.args={...S,displayButtonError:!0},E=x.bind({}),E.args={...S,footer:(0,v.jsx)(`div`,{children:`Hi I'm a Footer`})},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`props => <ConnectScreenVisual {...props}>
