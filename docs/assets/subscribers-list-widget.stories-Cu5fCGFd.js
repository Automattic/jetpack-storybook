import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-Da_5_6n_.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{n as o,ut as s}from"./build-module-DmVuor49.js";import{d as c,t as l}from"./src-B3le4dug.js";import{_ as u,t as d}from"./src-WOZhCJE0.js";import{Ct as f,rn as p,xr as m}from"./chart-tooltip-BOkbfvqL.js";import{I as h,L as g,U as ee,g as te,z as _}from"./report-metric-Bj8e507q.js";import{t as v}from"./widget-state-DcrSRSuQ.js";import{C as y,D as b,E as x,S as ne,T as S,b as C,t as w,w as T,x as E}from"./src-BujDAHCN.js";function D(e){return m(e).map((e,t)=>({id:e.subscription_id??`row-${t}`,name:e.label,avatarUrl:e.icon,href:e.link,secondaryText:u(e.date_subscribed)}))}function O({attributes:e}){let{data:t,isLoading:n,isFetching:i,isError:a,refetch:o}=p({type:`all`,max:e?.max&&e.max>0?e.max:6}),s=t,l=(0,A.useMemo)(()=>D(s),[s]),u=Number(s?.summary?.total??0),d=Math.max(u-l.length,0);return(0,j.jsx)(v,{isLoading:n,isFetching:i,isError:l.length===0&&a,isEmpty:l.length===0,error:{description:r(`We couldn't load subscribers. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:o}]},empty:{icon:c,description:r(`No subscribers yet.`,`jetpack-premium-analytics-pkg`)},children:(0,j.jsx)(M,{items:l,moreCount:d})})}function k({attributes:e={}}){return(0,j.jsx)(ee,{attributes:e,children:(0,j.jsx)(O,{attributes:e})})}var A,j,M,N=t((()=>{f(),d(),l(),w(),i(),A=e(n(),1),j=a(),M=({items:e=[],moreCount:t=0})=>(0,j.jsx)(`div`,{children:(0,j.jsx)(te,{items:e,moreCount:t})})})),P,F=t((()=>{i(),o(),P={icon:s,attributes:[{id:`max`,label:r(`Number of results`,`jetpack-premium-analytics-pkg`),type:`integer`}],example:{attributes:{max:6}}}})),I,L,R,z,B,V,H,U=t((()=>{I=`jpa/subscribers-list`,L=`Latest Subscribers`,R=`Your most recent subscribers.`,z={content:`Your most recent subscribers.`},B=`subscribers`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function W(e){return(0,G.jsx)(k,{attributes:{max:e}})}var G,K,q,J,Y,X,Z,Q,$;t((()=>{x(),y(),C(),h(),N(),F(),U(),G=a(),g(),K=`storybook/subscribers-list`,q={title:`Packages/Premium Analytics/Widgets/SubscribersList`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:'Dashboard widget listing the most recent subscribers (avatar + name + relative "since" time) with an "N more" footer. Data comes from the designated `useStatsFollowers` hook; in Storybook it is served by `registerReportMocks`.'}}}},J={render:()=>(0,G.jsx)(k,{attributes:{max:6}}),decorators:[E]},Y={render:()=>W(5),tags:[`!autodocs`],decorators:[E],beforeEach:()=>(_(`stats/followers`,`loading`),()=>_(`stats/followers`,null))},X={render:()=>W(7),tags:[`!autodocs`],decorators:[E],beforeEach:()=>(_(`stats/followers`,`error`),()=>_(`stats/followers`,null))},Z={render:()=>W(8),tags:[`!autodocs`],decorators:[E],beforeEach:()=>(_(`stats/followers`,`empty`),()=>_(`stats/followers`,null))},Q={render:e=>(0,G.jsx)(S,{...e,widgetType:ne(H,P),renderModule:K,renderComponent:k,attributes:{max:6}}),args:{...T},argTypes:{...b}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
