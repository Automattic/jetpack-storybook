...
`}}},I=g.bind({}),I.args={...u,showLegend:!0,smoothing:!1,data:[{...o[0],label:`New York`},{...o[1],label:`New York last year`,group:`new-york`,options:{type:`comparison`}},{...o[2],label:`Tokyo`},{...o[3],label:`Tokyo last year`,group:`tokyo`,options:{type:`comparison`}}]},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`args => {
