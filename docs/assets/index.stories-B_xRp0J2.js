...
`}}},q=g.bind({}),q.args={...u,showLegend:!0,legendCollapseGroups:!1,smoothing:!1,data:[{...s[0],label:`Views`,group:`views`},{...s[1],label:`Views — previous`,group:`views`,options:{type:`comparison`}}]},q.parameters={docs:{description:{story:'A primary series paired with a `type: "comparison"` previous-period series sharing the same `group`. `legend.collapseGroups` is off here, the default, so each series keeps its own legend item; turn the `legendCollapseGroups` control on to fold the pair into a single **Views** item.'}}},J=g.bind({}),J.args={...u,showLegend:!0,legendInteractive:!0,legendCollapseGroups:!0,rescaleYOnVisibilityChange:!1,smoothing:!1,data:[{...s[0],label:`Views`,group:`views`},{...s[1],label:`Views — previous`,group:`views`,options:{type:`comparison`}},{...s[2],label:`Visitors`,group:`visitors`},{...s[3],label:`Visitors — previous`,group:`visitors`,options:{type:`comparison`}}]},J.parameters={docs:{description:{story:'Two groups (`views` and `visitors`), each a primary series plus its `type: "comparison"` overlay. With `legend.collapseGroups` each group is a single legend item, and because `legend.interactive` is also on, clicking one toggles both its current and previous-period series at once. The value axis stays fixed as series are toggled. Turn the `legendCollapseGroups` control off to get one item per series, each toggling alone.'}}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`args => {
  ...
  return <LineChart {...chartProps} {...dimensions} data={data} legend={legend} withTooltipCrosshairs={crosshairConfig} />;
}`,...J.parameters?.docs?.source}}},Y=`Default.Zoomable.FixedDimensions.AspectRatio.SingleSeries.ManySeries.Animation.WithLegend.WithCompositionLegend.WithDefaultHiddenSeries.GradientFilled.GradientCustomColors.GradientTransparent.ErrorStates.BucketsWithNoData.SmallWholeNumberRange.WithoutSmoothing.WithPointerEvents.CurveTypes.SmartFormatting.BrokenLine.TimeAxisTickFormats.TimeAxisTickResolution.DateStringFormats.ComparisonSingle.ComparisonMulti`.split(`.`)}));X();export{C as Animation,b as AspectRatio,B as BrokenLine,M as BucketsWithNoData,J as ComparisonMulti,q as ComparisonSingle,L as CurveTypes,K as DateStringFormats,_ as Default,A as ErrorStates,y as FixedDimensions,O as GradientCustomColors,D as GradientFilled,k as GradientTransparent,S as ManySeries,x as SingleSeries,P as SmallWholeNumberRange,R as SmartFormatting,H as TimeAxisTickFormats,G as TimeAxisTickResolution,T as WithCompositionLegend,E as WithDefaultHiddenSeries,w as WithLegend,I as WithPointerEvents,F as WithoutSmoothing,v as Zoomable,Y as __namedExportsOrder,h as default,X as n,p as t};