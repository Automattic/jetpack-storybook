...
}`,...h.parameters?.docs?.source}}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:"{\n  render: () => <DateYearFilterWithState initialPreset={`year-${new Date().getFullYear()}`} disabled />\n}",...g.parameters?.docs?.source}}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  render: () => <div style={{
    width: '360px'
  }}>
            <DateYearFilterWithState isCompact />
        </div>
}`,..._.parameters?.docs?.source}}},v=[`Default`,`LongHistory`,`NoYearSelected`,`MeasuredContainer`,`Disabled`,`ForcedCompact`]}))();export{f as Default,g as Disabled,_ as ForcedCompact,p as LongHistory,h as MeasuredContainer,m as NoYearSelected,v as __namedExportsOrder,u as default};