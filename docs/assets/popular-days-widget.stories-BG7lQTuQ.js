import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{S as r,n as i,t as a}from"./build-module-DyKOxfM8.js";import{t as o}from"./jsx-runtime-D2pHJD-r.js";import{n as s,xl as c}from"./build-module-CDRs4YxF.js";import{F as l,J as u,Yt as d,et as f,t as p}from"./date-fns-Bm9dQUxr.js";import{Tr as m,sn as ee,t as h}from"./src-BSLPjMFP.js";import{K as g,X as _,et as te,it as ne,q as re}from"./report-metric-Ca_kXAW3.js";import{n as ie}from"./sparkline-DcZ1-6wt.js";import{t as ae,y as oe}from"./src-Cvyt29m2.js";import{j as se,t as ce}from"./src-HOdOyzOs.js";import{n as le,t as ue,u as de}from"./src-BZevBsj7.js";import{Tt as fe,Xt as pe,hr as v,i as me,p as he}from"./chart-tooltip-BQsM5vre.js";import{t as ge}from"./widget-state-CXHVbl5s.js";import{C as _e,D as ve,E as ye,S as be,T as xe,b as Se,t as y,w as Ce,x as b}from"./src-C9i3aD_R.js";var x,S,C,w,T,E,we=t((()=>{x=`_root_1y5xx_1`,S=`_body_1y5xx_9`,C=`_headline_1y5xx_20`,w=`_views_1y5xx_27`,T=`_chart_1y5xx_35`,E={root:x,body:S,headline:C,views:w,chart:T}}));function Te(e){return de((e+1)%7)}function Ee(e){let t=se(e.date_start??e.time_interval??e.period);if(!t)return;let n=l(t,D,O);return d(n)&&f(n,D)===t?n:void 0}function De(e){let t=e.views??e.value;return typeof t==`number`?t:Number(t??0)||0}function Oe(e){let t=Array.from({length:7},()=>({total:0,occurrences:0}));return e.forEach(e=>{let n=Ee(e);if(!n)return;let r=(u(n)+6)%7;t[r].total+=De(e),t[r].occurrences+=1}),t.map(({total:e,occurrences:t},n)=>({weekday:n,label:Te(n),total:e,occurrences:t,average:t?e/t:0}))}function ke(e){return e.filter(e=>e.occurrences>0).reduce((e,t)=>!e||t.average>e.average?t:e,void 0)}var D,O,Ae=t((()=>{ce(),ue(),p(),D=`yyyy-MM-dd`,O=new Date(2001,0,1)}));function je(){let{reportParams:e}=ne(),{primary:t,isLoading:n,isFetching:r,isError:i,error:a,refetch:o}=pe((0,k.useMemo)(()=>me({...e,stat_fields:j,period:A}),[e])),s=t.data,c=(0,k.useMemo)(()=>Oe(s?.data??[]),[s]);return{buckets:c,peak:(0,k.useMemo)(()=>ke(c),[c]),isLoading:n,isFetching:r,isError:i,error:a,refetch:o}}var k,A,j,Me=t((()=>{fe(),y(),k=e(n(),1),Ae(),A=`day`,j=`views,visitors`}));function Ne(){let{buckets:e,peak:t,isLoading:n,isFetching:a,isError:o,error:s,refetch:c}=je(),l=(0,N.useMemo)(()=>e.map(e=>e.average),[e]),u=o&&!t,d=t?.average??0,f=le(d,`number`,I),p=le(d,`number`,d>=1e3?F:I),h=i(`%s views`,`jetpack-premium-analytics-pkg`),g=r(h,p),_=r(h,f);return(0,P.jsx)(`div`,{className:E.root,children:(0,P.jsx)(ge,{isLoading:n,isFetching:a,isError:u,isEmpty:!t,error:u?he(s,{retryDescription:i(`We couldn't load your popular days. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}):null,empty:{icon:oe,description:i(`No views in this period.`,`jetpack-premium-analytics-pkg`)},children:(0,P.jsxs)(`div`,{className:E.body,children:[(0,P.jsxs)(`div`,{className:E.headline,children:[(0,P.jsx)(m,{variant:`heading-2xl`,children:t?.label}),(0,P.jsx)(m,{variant:`body-md`,className:E.views,title:f,children:g===_?g:(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(`span`,{"aria-hidden":`true`,children:g}),(0,P.jsx)(ee,{children:_})]})})]}),(0,P.jsx)(`div`,{className:E.chart,children:(0,P.jsx)(ie,{data:l,maxWidth:1/0})})]})})})}function M({attributes:e={},setError:t}){return(0,P.jsx)(te,{attributes:e,setError:t,children:(0,P.jsx)(Ne,{})})}var N,P,F,I,Pe=t((()=>{h(),ue(),ae(),y(),a(),N=e(n(),1),we(),Me(),P=o(),F={useMultipliers:!0,decimals:1},I={decimals:0}})),L,Fe=t((()=>{s(),L={icon:c}})),R,z,B,V,H,U,Ie,Le=t((()=>{R=`jpa/popular-days`,z=`Popular days`,B=`The day of the week that draws the most views, with the distribution across the week.`,V={content:`The days of the week when your site received the most views on average.`,links:[{label:`Learn more`,href:`https://wordpress.com/support/stats/#popular-hours`}]},H=`stats`,U=`framed`,Ie={name:R,title:z,description:B,help:V,category:H,presentation:U}}));function Re(){return(0,G.jsx)(M,{attributes:{reportParams:v(!1)}})}function W(e){return(0,G.jsx)(M,{attributes:{reportParams:v(!1,e)}})}function ze(e){return(0,G.jsx)(xe,{...e,widgetType:Ve,renderModule:Be,renderComponent:M,attributes:{reportParams:v(!0)}})}var G,Be,Ve,K,q,J,Y,X,Z,Q,$;t((()=>{fe(),g(),ye(),_e(),Se(),Pe(),Fe(),Le(),G=o(),re(),Be=`storybook/popular-days`,Ve=be(Ie,L),K={title:`Packages/Premium Analytics/Widgets/PopularDays`,component:M,tags:[`autodocs`],parameters:{docs:{description:{component:'The "Popular days" card: the busiest day of the week for the selected range, as the weekday name and its mean views, over an area chart of the whole week\'s distribution. Both figures are means per occurrence of that weekday, not totals — a user-selected range rarely spans a whole number of weeks, so totals would let a weekday win on having occurred one extra time. Data comes from `stats/visits` at daily granularity, folded into seven buckets client-side; `stats/insights` also reports weekday views but over a window fixed at ten weeks, so it cannot follow the date picker. There is no WithComparison story — the widget strips comparison from its request and renders no delta, so it would be identical to Default.'}}}},q={render:Re,decorators:[b]},J={render:()=>W(`last-90-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(_(`stats/visits`,`loading`),()=>_(`stats/visits`,null))},Y={render:()=>W(`last-7-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(_(`stats/visits`,`error`),()=>_(`stats/visits`,null))},X={render:()=>W(`last-12-months`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(_(`stats/visits`,`error-retryable`),()=>_(`stats/visits`,null))},Z={render:()=>W(`last-year`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(_(`stats/visits`,`empty`),()=>_(`stats/visits`,null))},Q={render:e=>(0,G.jsx)(ze,{...e}),args:{...Ce},argTypes:{...ve}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
