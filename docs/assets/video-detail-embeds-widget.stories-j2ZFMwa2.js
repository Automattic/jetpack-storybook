import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DQ5lAs4a.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{c as i,n as a}from"./build-module-C6Ow06jV.js";import{R as o,t as s,u as c}from"./build-module-JNPAD9ni.js";import{ft as l,qn as u,ut as d}from"./chart-tooltip-BIiKhH0l.js";import{t as ee}from"./chart-empty-state-B40T41jZ.js";import{C as f,N as p,S as m,T as h,k as g}from"./report-metric-D7PFtooA.js";import{t as _}from"./widget-state-CsCQdmg9.js";import{S as v,b as y,t as b,x as te,y as ne}from"./src-DMKl_JFZ.js";import{n as re,r as x}from"./with-widget-canvas-Dz43KNHY.js";var S,C,w,T,E,D,O=e((()=>{S=`_root_1yikk_1`,C=`_content_1yikk_11`,w=`_list_1yikk_24`,T=`_item_1yikk_32`,E=`_link_1yikk_41`,D={root:S,content:C,list:w,item:T,link:E}}));function k(e){let t=typeof e==`number`?e:Number.parseInt(e??``,10);return Number.isInteger(t)&&t>0?t:NaN}function A({pages:e}){return(0,N.jsx)(`ul`,{className:D.list,children:e.map((e,t)=>(0,N.jsx)(`li`,{className:D.item,children:(0,N.jsx)(c,{className:D.link,href:e.link,variant:`unstyled`,openInNewTab:!0,title:e.label,children:e.label})},`${t}-${e.link}`))})}function j(){let{reportParams:e}=p(),n=k(e.post_id),{data:r,isLoading:a,isFetching:s,isError:c,refetch:u}=l(n,e),d;if(!Number.isInteger(n))d=(0,N.jsx)(ee,{icon:i,text:t(`Select a video to see where it is embedded across your site.`,`jetpack-premium-analytics`)});else{let e=r?.pages??[];d=(0,N.jsx)(_,{isLoading:a,isFetching:s,isError:e.length===0&&c,isEmpty:e.length===0,error:{description:t(`We couldn't load video embeds. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:()=>void u()}]},empty:{icon:i,description:t(`This video has not been embedded on any pages yet.`,`jetpack-premium-analytics`)},children:(0,N.jsx)(A,{pages:e})})}return(0,N.jsx)(o,{className:D.root,children:(0,N.jsx)(`div`,{className:D.content,children:d})})}function M({attributes:e={}}){return(0,N.jsx)(g,{attributes:e,children:(0,N.jsx)(j,{})})}var N,P=e((()=>{d(),b(),n(),a(),s(),O(),N=r()})),F,I=e((()=>{n(),a(),F={name:`jpa/video-detail-embeds`,title:t(`Video embeds`,`jetpack-premium-analytics`),help:{content:t(`Lists every page on your site where the selected video is embedded, so you can see where it is being watched.`,`jetpack-premium-analytics`),links:[{label:t(`Learn more`,`jetpack-premium-analytics`),href:`https://jetpack.com/support/jetpack-stats/`}]},icon:i}}));function L(e,t){return{...u(e,t),post_id:W}}function R({withComparison:e}){return(0,V.jsx)(M,{attributes:{reportParams:L(e)}})}function z(e){return(0,V.jsx)(M,{attributes:{reportParams:L(!1,e)}})}function B({withComparison:e,...t}){return(0,V.jsx)(y,{...t,widgetType:F,renderModule:H,renderComponent:M,attributes:{reportParams:L(e)}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{d(),m(),te(),re(),P(),I(),V=r(),f(),H=`storybook/video-detail-embeds`,U=`stats/video/`,W=105,G={title:`Packages/Premium Analytics/Widgets/VideoDetailEmbeds`,component:M,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`}},parameters:{docs:{description:{component:"Dashboard widget listing the pages where a single video is embedded, sourced from the Jetpack Stats `stats/video/%d` module via `useStatsSingleVideo`. The widget is scoped to one video through the host-composed `reportParams.post_id`; without one it prompts to select a video. The single-video module has no comparison data, so the `WithComparison` control only exercises that the widget still renders normally when comparison params are present. In Storybook the data is served by `registerReportMocks`."}}}},K={render:R,args:{withComparison:!1},decorators:[x]},q={render:R,args:{withComparison:!0},decorators:[x]},J={render:()=>(0,V.jsx)(M,{attributes:{reportParams:u(!1)}}),decorators:[x]},Y={render:()=>z(`last-90-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(h(U,`loading`),()=>h(U,null))},X={render:()=>z(`last-7-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(h(U,`error`),()=>h(U,null))},Z={render:()=>z(`last-365-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(h(U,`empty`),()=>h(U,null))},Q={render:e=>(0,V.jsx)(B,{...e}),args:{...ne,withComparison:!0},argTypes:{...v,withComparison:{control:`boolean`}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
