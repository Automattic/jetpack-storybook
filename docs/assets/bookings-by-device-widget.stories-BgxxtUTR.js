import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Nn as i,n as a}from"./build-module-DmVuor49.js";import{c as o,t as s}from"./src-DN9VFS2M.js";import{cr as c,ct as l,yt as u}from"./chart-tooltip-BtX3Jjce.js";import{F as d,M as f,N as p,z as m}from"./report-metric-CWPPaMwH.js";import{C as h,S as g,T as _,b as v,t as y,w as b,x}from"./src-BAp3Kd5h.js";import{t as S}from"./sales-by-device-widget-CvlfrlyW.js";function C(){return(0,T.jsx)(S,{filter:l,emptyStateText:t(`No booking data in this period.`,`jetpack-premium-analytics`),errorText:t(`We couldn't load booking data by device. Please try again in a moment.`,`jetpack-premium-analytics`)})}function w({attributes:e={},setError:t}){return(0,T.jsx)(m,{attributes:e,setError:t,options:{from:`/`},children:(0,T.jsx)(C,{})})}var T,E=e((()=>{y(),n(),T=r()})),D,O=e((()=>{n(),a(),D={name:`jpa/bookings-by-device`,title:t(`Bookings by device`,`jetpack-premium-analytics`),help:{content:t(`See which devices your customers are using to make bookings in your store.`,`jetpack-premium-analytics`)},icon:i}}));function k(e=!1,t=L){return{reportParams:c(e,t)}}function A({withComparison:e,preset:t}){let n=!!e,r=t??L;return!n&&r===L?`getDefaultQueryParams()`:n&&r===L?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function j(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<BookingsByDeviceRender
\tattributes={ {
\t\treportParams: ${A(e)},
\t} }
/>`}function M({withComparison:e,preset:t}){return(0,F.jsx)(w,{attributes:k(e,t)})}function N(e){return(0,F.jsx)(w,{attributes:k(!1,e)})}function P({withComparison:e,preset:t,...n}){return(0,F.jsx)(h,{...n,widgetType:D,renderModule:I,renderComponent:w,attributes:k(e,t)})}var F,I,L,R,z,B,V,H,U,W,G,K;e((()=>{u(),s(),b(),v(),f(),E(),O(),F=r(),p(),I=`storybook/bookings-by-device`,L=`last-30-days`,R=o,z={title:`Packages/Premium Analytics/Widgets/BookingsByDevice`,component:w,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:R,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`Dashboard widget that displays which devices customers use to make bookings.`}}}},B={render:M,args:{preset:L,withComparison:!1},decorators:[x],parameters:{docs:{source:{transform:(e,t)=>j(t.args)}}}},V={render:M,args:{preset:L,withComparison:!0},decorators:[x],parameters:{docs:{source:{transform:(e,t)=>j(t.args)}}}},H={render:()=>N(`last-90-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(d(`order-attribution-by-product/device/summary`,`loading`),()=>d(`order-attribution-by-product/device/summary`,null))},U={render:()=>N(`last-7-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(d(`order-attribution-by-product/device/summary`,`error`),()=>d(`order-attribution-by-product/device/summary`,null))},W={render:()=>N(`last-365-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(d(`order-attribution-by-product/device/summary`,`empty`),()=>d(`order-attribution-by-product/device/summary`,null))},G={render:e=>(0,F.jsx)(P,{...e}),args:{...g,preset:L,withComparison:!0},argTypes:{..._,preset:{control:`select`,options:R,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
