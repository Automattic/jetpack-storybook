import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DQ5lAs4a.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{c as o,n as s}from"./build-module-Bt8gOW8e.js";import{Pt as c,d as ee,p as l,s as u,z as d}from"./hooks-Dboa4Xl3.js";import{t as f,u as p}from"./build-module-Bh3mpS28.js";import{F as m,a as h,c as g,i as _,o as v}from"./chart-tooltip-Bj6zblKW.js";import{t as y}from"./leaderboard-chart-sMEIUgwU.js";import{n as te,r as b,t as x}from"./register-report-mocks-BXjXbLk-.js";import{t as S}from"./widget-state-DHig6Hvi.js";import{i as C,n as w,r as ne,t as re}from"./widget-dashboard-with-widget-WqDWtCy_.js";import{t as T}from"./src-BFc_qV59.js";function E(e,t){let n=new Map(g(t).map(e=>[h(e),e.plays]));return g(e).map(e=>{let t=h(e);return{key:t,label:v(e),link:e.link,plays:e.plays,previousPlays:n.get(t)??null}})}var D=t((()=>{T()})),O,k,A,j=t((()=>{O=`_labelLink_d8nn2_1`,k=`_labelText_d8nn2_2`,A={labelLink:O,labelText:k}})),M,N=t((()=>{i(),s(),M={name:`jpa/videopress`,title:r(`VideoPress`,`jetpack-premium-analytics`),icon:o,attributes:[{id:`max`,label:r(`Maximum videos`,`jetpack-premium-analytics`),type:`integer`}],example:{attributes:{max:7}}}}));function P(e,t){let n=Math.max(...e.flatMap(e=>[e.plays,e.previousPlays??0]),1);return e.map(e=>{let r=e.previousPlays??0;return{id:e.key,label:e.link?(0,R.jsx)(p,{className:A.labelLink,href:e.link,variant:`unstyled`,openInNewTab:!0,title:e.label,children:e.label}):(0,R.jsx)(`span`,{className:A.labelText,title:e.label,children:e.label}),currentValue:e.plays,currentShare:e.plays/n*100,previousValue:r,previousShare:t?r/n*100:0,delta:t?m(e.plays,r):0}})}function F({max:e}){let{reportParams:t}=ee(),{primary:n,comparison:i,hasComparison:a,isLoading:s,isFetching:c,hasData:l,isError:u,refetch:f}=d((0,L.useMemo)(()=>({...t,max:e}),[t,e])),p=(s||n.isPending)&&!l,m=n.data,h=i.data,g=(0,L.useMemo)(()=>E(m,h),[m,h]),_=a&&g.some(e=>e.previousPlays!==null),v=(0,L.useMemo)(()=>P(g,_),[g,_]);return(0,R.jsx)(S,{isLoading:p,isFetching:c,isError:u,isEmpty:g.length===0,error:{description:r(`We couldn't load video plays. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:r(`Retry`,`jetpack-premium-analytics`),onClick:f}]},empty:{icon:o,description:r(`Learn which VideoPress videos your visitors watch most to understand what keeps them engaged.`,`jetpack-premium-analytics`)},children:(0,R.jsx)(y,{data:v,withComparison:_,withOverlayLabel:!0,showLegend:!1,dataFormat:{type:`number`,options:{useMultipliers:!0,decimals:0}}})})}function I({attributes:e={},setError:t}){return(0,R.jsx)(u,{attributes:e,setError:t,children:(0,R.jsx)(F,{max:_(e.max,7)})})}var L,R,z=t((()=>{l(),T(),i(),s(),f(),L=e(n(),1),D(),j(),N(),R=a()}));function B({withComparison:e}){return(0,U.jsx)(I,{attributes:{max:7,reportParams:c(e)}})}function V(e){return(0,U.jsx)(I,{attributes:{max:7,reportParams:c(!1,e)}})}function H({withComparison:e,...t}){return(0,U.jsx)(w,{...t,widgetType:M,renderModule:W,renderComponent:I,attributes:{max:7,reportParams:c(e)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{l(),x(),ne(),z(),N(),U=a(),te(),W=`storybook/videopress`,G=e=>(0,U.jsx)(`div`,{style:{width:`100%`,height:`360px`},children:(0,U.jsx)(e,{})}),K={title:`Packages/Premium Analytics/Widgets/VideoPress`,component:I,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`}},parameters:{docs:{description:{component:"Dashboard widget showing the site's most played VideoPress videos as a leaderboard, sourced from the Jetpack Stats `video-plays` module via `useStatsVideoPlays`, with optional period-over-period comparison. In Storybook the data is served by `registerReportMocks`."}}}},q={render:B,args:{withComparison:!1},decorators:[G]},J={render:B,args:{withComparison:!0},decorators:[G]},Y={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[G],beforeEach:()=>(b(`stats/video-plays`,`loading`),()=>b(`stats/video-plays`,null))},X={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[G],beforeEach:()=>(b(`stats/video-plays`,`error`),()=>b(`stats/video-plays`,null))},Z={render:()=>V(`last-365-days`),tags:[`!autodocs`],decorators:[G],beforeEach:()=>(b(`stats/video-plays`,`empty`),()=>b(`stats/video-plays`,null))},Q={render:e=>(0,U.jsx)(H,{...e}),args:{...re,withComparison:!0},argTypes:{...C,withComparison:{control:`boolean`}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
