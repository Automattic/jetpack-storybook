import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DQ5lAs4a.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{n as i,rl as a}from"./build-module-Bt8gOW8e.js";import{n as o,t as s}from"./build-module-DZHUqpPN.js";import{l as c,t as l}from"./src-hyofVqDU.js";import{Kn as u,ut as d}from"./chart-tooltip-Cd6R28vB.js";import{C as f,S as p,k as m}from"./report-metric-BSkCvVUy.js";import{S as h,b as g,o as _,t as v,x as y,y as b}from"./src-ZlSzubd8.js";import{n as x,r as S}from"./with-widget-canvas-Dz43KNHY.js";import{n as C,t as w}from"./force-stats-mock-state-CQT0C_sO.js";function T({attributes:e={},setError:t}){return(0,E.jsx)(m,{attributes:e,setError:t,options:{from:`/`},children:(0,E.jsx)(_,{limit:5})})}var E,D=e((()=>{v(),E=r()})),O,k=e((()=>{n(),i(),O={name:`jpa/top-performing-bookings`,title:t(`Top performing bookings`,`jetpack-premium-analytics`),help:{content:t(`Your best-selling bookings by revenue over the selected time period.`,`jetpack-premium-analytics`)},icon:a}}));function A(e){let t=e.reduce((e,t)=>({total_orders:e.total_orders+Number(t.orders_count),total_quantity:e.total_quantity+Number(t.total_quantity),total_revenue:e.total_revenue+Number(t.product_net_revenue)}),{total_orders:0,total_quantity:0,total_revenue:0});return{data:e,summary:{total_orders:String(t.total_orders),total_products:String(e.length),total_quantity:String(t.total_quantity),total_revenue:t.total_revenue.toFixed(2)}}}function j(e){H||(H=!0,s.use(async(t,n)=>{let r=t.path??t.url??``;return r.startsWith(z)?A(e):r.startsWith(B)?e.map(e=>({id:Number(e.product_id),name:e.product_name,images:[]})):n(t)}))}function M(e=!1,t=W){return{reportParams:u(e,t)}}function N({withComparison:e,preset:t}){let n=!!e,r=t??W;return!n&&r===W?`getDefaultQueryParams()`:n&&r===W?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function P(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
