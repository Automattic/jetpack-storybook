import{a as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./jsx-runtime-D2pHJD-r.js";import{c as r,i,n as a,o}from"./chart-decorator-DISXqzQ2.js";import{s}from"./chart-scope-BdFsoiv8.js";import{n as c}from"./line-chart-XKXuqdWL.js";import{b as l,h as u,k as d,s as f,v as p,x as m}from"./sample-data-BJw5YSHu.js";import{n as h}from"./bar-chart-BYXciGOB.js";import{t as g}from"./bar-list-chart-DkfbUsvt.js";import{n as _}from"./leaderboard-chart-BAfIe88i.js";import{r as v}from"./pie-chart-i7FgRylB.js";import{n as y}from"./pie-semi-circle-chart-qn5wbqBc.js";import{t as b}from"./src-BPHhsv8e.js";var x=e({AdminColorSchemeLeadsThePalette:()=>W,Default:()=>H,HostLocaleAndTimeZoneFormatDates:()=>q,HostTimeZoneDatesDayStrings:()=>Y,WithColorOverrides:()=>U,__namedExportsOrder:()=>X,default:()=>E}),S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z=t((()=>{b(),a(),u(),o(),S=n(),{expect:C,waitFor:w,within:T}=__STORYBOOK_MODULE_TEST__,E={title:`JS Packages/Charts Library/Global Context`,parameters:{layout:`centered`},decorators:[i],argTypes:{...r,showUnitedStates:{control:{type:`boolean`},description:`Show United States data in all charts`,defaultValue:!0},showGreatBritain:{control:{type:`boolean`},description:`Show Great Britain data in all charts`,defaultValue:!0},showJapan:{control:{type:`boolean`},description:`Show Japan data in all charts`,defaultValue:!0}}},D=[l[0],l[1],l[2]],O=`ectoplasm`,k=`#646c3e`,A=`#4a19ab`,j=f,M=p,N=[{...m[0],label:`United States`,group:`united-states`},{...m[1],label:`Great Britain`,group:`great-britain`},{...m[2],label:`Japan`,group:`japan`}],P=(e,t)=>e.filter(e=>!(e.group===`united-states`&&!t.showUnitedStates||e.group===`great-britain`&&!t.showGreatBritain||e.group===`japan`&&!t.showJapan)),F=(e,t)=>e.filter(e=>!(e.group===`united-states`&&!t.showUnitedStates||e.group===`great-britain`&&!t.showGreatBritain||e.group===`japan`&&!t.showJapan)),I=[{...l[0],options:{stroke:`#e74c3c`}},l[1],l[2]],L=f.map((e,t)=>t<=1?{...e,options:{...e.options,stroke:`#e74c3c`}}:e),R=[{...p[0],options:{stroke:`#e74c3c`}},p[1],p[2]],z=[{...N[0],color:`#e74c3c`},{...N[1]},{...N[2]}],B=({args:e})=>{let t=P(j,e),n=P(D,e),r=F(N,e),i=P(M,e),a=F(N,e);return(0,S.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(2, 1fr)`,gap:`4rem`,width:`100%`},children:[(0,S.jsx)(c,{data:t,width:350,height:250,withGradientFill:!1,showLegend:!0,withTooltips:!0,margin:{bottom:40}}),(0,S.jsx)(h,{data:n,width:350,height:250,withTooltips:!0,showLegend:!0}),(0,S.jsx)(y,{data:r,width:350,label:`Semi-Circle Chart`,withTooltips:!0,showLegend:!0}),(0,S.jsx)(g,{data:i,width:350,height:250,withTooltips:!0}),(0,S.jsx)(v,{size:300,data:r,withTooltips:!0,showLegend:!0}),(0,S.jsx)(v,{size:300,thickness:.5,data:a,withTooltips:!0,showLegend:!0}),(0,S.jsx)(_,{data:d,withComparison:!0,showLegend:!0})]})},V=({args:e})=>{let t=P(L,e),n=P(I,e),r=F(z,e),i=P(R,e),a=F(z,e);return(0,S.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(2, 1fr)`,gap:`4rem`,width:`100%`},children:[(0,S.jsx)(c,{data:t,width:350,height:250,withGradientFill:!1,showLegend:!0,withTooltips:!0,margin:{bottom:40}}),(0,S.jsx)(h,{data:n,width:350,height:250,withTooltips:!0,showLegend:!0}),(0,S.jsx)(y,{data:r,width:350,label:`Semi-Circle Chart`,withTooltips:!0,showLegend:!0}),(0,S.jsx)(g,{data:i,width:350,height:250,withTooltips:!0}),(0,S.jsx)(v,{size:300,data:r,withTooltips:!0,showLegend:!0}),(0,S.jsx)(v,{size:300,thickness:.5,data:a,withTooltips:!0,showLegend:!0}),(0,S.jsx)(_,{data:d,withComparison:!0,showLegend:!0,secondaryColor:`#e74c3c`})]})},H={render:(e,{args:t})=>(0,S.jsx)(B,{args:t}),args:{showUnitedStates:!0,showGreatBritain:!0,showJapan:!0}},U={render:(e,{args:t})=>(0,S.jsx)(V,{args:t}),args:{showUnitedStates:!0,showGreatBritain:!0,showJapan:!0}},W={render:()=>(0,S.jsx)(h,{width:400,height:200,data:[D[0]]}),args:{themeName:`custom`,accentColor:A,adminColorScheme:O},parameters:{docs:{description:{story:`Slot 1 reads \`--wp-admin-theme-color\` before the design system's brand token. With the admin scheme set to \`${O}\` and a different accent seeding the design system, the bar paints \`${k}\`.`}}},play:async({canvasElement:e})=>{let t=await w(()=>{let t=e.querySelector(`.visx-bar-group rect`);if(!t)throw Error(`No bar rendered yet.`);return t});await C(t.getAttribute(`fill`)).toBe(k),await C(t.getAttribute(`fill`)).not.toBe(A)}},G=[{label:`Views`,data:Array.from({length:5},(e,t)=>({date:new Date(Date.parse(`2026-08-02T15:30:00Z`)+t*24*60*60*1e3),value:40+t*6})),options:{}}],K=[{testId:`tokyo`,title:`de-DE · Asia/Tokyo`,locale:`de-DE`,timeZone:`Asia/Tokyo`},{testId:`los-angeles`,title:`en-US · America/Los_Angeles`,locale:`en-US`,timeZone:`America/Los_Angeles`}],q={render:()=>(0,S.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(2, 1fr)`,gap:`4rem`},children:K.map(({testId:e,title:t,locale:n,timeZone:r})=>(0,S.jsxs)(`div`,{"data-testid":e,children:[(0,S.jsx)(`h3`,{children:t}),(0,S.jsxs)(s,{locale:n,timeZone:r,children:[(0,S.jsx)(`div`,{"data-testid":`${e}-bars`,children:(0,S.jsx)(h,{data:G,width:350,height:200,withTooltips:!0})}),(0,S.jsx)(`div`,{"data-testid":`${e}-lines`,children:(0,S.jsx)(c,{data:G,width:350,height:200,withGradientFill:!1,withTooltips:!0,margin:{bottom:40}})})]})]},e))}),parameters:{docs:{description:{story:`The same five instants, dated and worded for two hosts. Hover a bar or a point to see the tooltip follow its axis.`}}},play:async({canvasElement:e})=>{let t=T(e);for(let e of[`bars`,`lines`]){let n=T(t.getByTestId(`tokyo-${e}`)),r=T(t.getByTestId(`los-angeles-${e}`));await C(await n.findByText(`3. Aug.`)).toBeInTheDocument(),await C(await r.findByText(`Aug 2`)).toBeInTheDocument()}}},J=[{label:`Views`,data:Array.from({length:5},(e,t)=>({dateString:`2026-08-0${t+2}`,value:40+t*6})),options:{}}],Y={render:()=>(0,S.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(2, 1fr)`,gap:`4rem`},children:K.map(({testId:e,title:t,locale:n,timeZone:r})=>(0,S.jsxs)(`div`,{"data-testid":`days-${e}`,children:[(0,S.jsx)(`h3`,{children:t}),(0,S.jsx)(s,{locale:n,timeZone:r,children:(0,S.jsx)(c,{data:J,width:350,height:200,withGradientFill:!1,withTooltips:!0,margin:{bottom:40}})})]},e))}),parameters:{docs:{description:{story:`Both columns start on Aug 2, the day the string names, whatever zone the browser is in.`}}},play:async({canvasElement:e})=>{let t=T(e),n=T(t.getByTestId(`days-tokyo`)),r=T(t.getByTestId(`days-los-angeles`));await C(await n.findByText(`2. Aug.`)).toBeInTheDocument(),await C(await r.findByText(`Aug 2`)).toBeInTheDocument()}},H.parameters={...H.parameters,docs:{...H.parameters?.docs,source:{originalSource:`{
  render: (_, {
    args
  }) => <ChartGrid args={args} />,
  args: {
...
}`,...Y.parameters?.docs?.source},description:{story:"The same day strings under two hosts, both landing on the day they name.\n\nA `dateString` names no instant, so it is read as midnight in the provider's `timeZone` rather\nthan the viewer's: switch your browser's own zone and nothing here moves.",...Y.parameters?.docs?.description}}},X=[`Default`,`WithColorOverrides`,`AdminColorSchemeLeadsThePalette`,`HostLocaleAndTimeZoneFormatDates`,`HostTimeZoneDatesDayStrings`]}));Z();export{W as AdminColorSchemeLeadsThePalette,H as Default,q as HostLocaleAndTimeZoneFormatDates,Y as HostTimeZoneDatesDayStrings,U as WithColorOverrides,X as __namedExportsOrder,E as default,Z as n,x as t};