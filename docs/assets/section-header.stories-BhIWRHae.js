...
}`,...H.parameters?.docs?.source},description:{story:`The left half on its own: nothing in the controls slot.`,...H.parameters?.docs?.description}}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...U.parameters?.docs?.source},description:{story:`The **detail-page** instance: a resource names the page, so the title is its
...
glyph. It is decorative by contract — the title already names the resource.`,...U.parameters?.docs?.description}}},W.parameters={...W.parameters,docs:{...W.parameters?.docs,source:{originalSource:`{
...
}`,...W.parameters?.docs?.source},description:{story:`The same header before the resource resolves: the title and subtitle slots
hold skeletons, so the page does not read as blank while the grid draws.`,...W.parameters?.docs?.description}}},G=[`Default`,`LongTitle`,`YearSurface`,`Stacked`,`Pinned`,`WithoutControls`,`WithVisualAndSubtitle`,`LoadingResource`]}))();export{L as Default,W as LoadingResource,R as LongTitle,V as Pinned,B as Stacked,U as WithVisualAndSubtitle,H as WithoutControls,z as YearSurface,G as __namedExportsOrder,I as default};