import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DQ5lAs4a.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{c as o,n as s}from"./build-module-Bt8gOW8e.js";import{S as c,d as l,it as u,s as d,tn as f}from"./hooks-vVT9DHIc.js";import{t as p,u as m}from"./build-module-BAze1CUO.js";import{P as h,a as g,i as _,o as v}from"./chart-tooltip-DNSI5yTk.js";import{t as y}from"./leaderboard-chart-C-5XAZ-c.js";import{i as b,n as x,t as ee}from"./register-report-mocks-DsVqLJR9.js";import{t as te}from"./widget-state-DP8d8ymJ.js";import{S,b as C,t as w,x as ne,y as T}from"./src-BnRzOHF6.js";function E(e=[]){return e.map(e=>({key:g(e),label:v(e),link:e.link,plays:e.plays,previousPlays:e.previousPlays}))}var D=t((()=>{w()})),O,k,A,j=t((()=>{O=`_labelLink_d8nn2_1`,k=`_labelText_d8nn2_2`,A={labelLink:O,labelText:k}})),M,N=t((()=>{i(),s(),M={name:`jpa/videopress`,title:r(`VideoPress`,`jetpack-premium-analytics`),icon:o,attributes:[{id:`max`,label:r(`Maximum videos`,`jetpack-premium-analytics`),type:`integer`}],example:{attributes:{max:7}}}}));function P(e){let t=Math.max(...e.flatMap(e=>[e.plays,e.previousPlays??0]),1);return e.map(e=>({id:e.key,label:e.link?(0,R.jsx)(m,{className:A.labelLink,href:e.link,variant:`unstyled`,openInNewTab:!0,title:e.label,children:e.label}):(0,R.jsx)(`span`,{className:A.labelText,title:e.label,children:e.label}),currentValue:e.plays,currentShare:e.plays/t*100,previousValue:e.previousPlays,previousShare:e.previousPlays===void 0?void 0:e.previousPlays/t*100,delta:e.previousPlays===void 0?void 0:h(e.plays,e.previousPlays)}))}function F({max:e}){let{reportParams:t}=l(),{primary:n,comparisonRows:i,hasComparison:a,isLoading:s,isFetching:c,hasData:d,isError:f,refetch:p}=u((0,L.useMemo)(()=>({...t,max:e}),[t,e]),{maxRows:e}),m=(s||n.isPending)&&!d,h=(0,L.useMemo)(()=>E(i?.rows??[]),[i]),g=(0,L.useMemo)(()=>P(h),[h]);return(0,R.jsx)(te,{isLoading:m,isFetching:c,isError:f,isEmpty:h.length===0,error:{description:r(`We couldn't load video plays. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:r(`Retry`,`jetpack-premium-analytics`),onClick:p}]},empty:{icon:o,description:r(`Learn which VideoPress videos your visitors watch most to understand what keeps them engaged.`,`jetpack-premium-analytics`)},children:(0,R.jsx)(y,{data:g,withComparison:a,withOverlayLabel:!0,showLegend:!1,dataFormat:{type:`number`,options:{useMultipliers:!0,decimals:0}}})})}function I({attributes:e={},setError:t}){return(0,R.jsx)(d,{attributes:e,setError:t,children:(0,R.jsx)(F,{max:_(e.max,7)})})}var L,R,z=t((()=>{c(),w(),i(),s(),p(),L=e(n(),1),D(),j(),N(),R=a()}));function B({withComparison:e}){return(0,U.jsx)(I,{attributes:{max:7,reportParams:f(e)}})}function V(e){return(0,U.jsx)(I,{attributes:{max:7,reportParams:f(!1,e)}})}function H({withComparison:e,...t}){return(0,U.jsx)(C,{...t,widgetType:M,renderModule:W,renderComponent:I,attributes:{max:7,reportParams:f(e)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{c(),ee(),ne(),z(),N(),U=a(),x(),W=`storybook/videopress`,G=e=>(0,U.jsx)(`div`,{style:{width:`100%`,height:`360px`},children:(0,U.jsx)(e,{})}),K={title:`Packages/Premium Analytics/Widgets/VideoPress`,component:I,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`}},parameters:{docs:{description:{component:"Dashboard widget showing the site's most played VideoPress videos as a leaderboard, sourced from the Jetpack Stats `video-plays` module via `useStatsVideoPlays`, with optional period-over-period comparison. In Storybook the data is served by `registerReportMocks`."}}}},q={render:B,args:{withComparison:!1},decorators:[G]},J={render:B,args:{withComparison:!0},decorators:[G]},Y={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[G],beforeEach:()=>(b(`stats/video-plays`,`loading`),()=>b(`stats/video-plays`,null))},X={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[G],beforeEach:()=>(b(`stats/video-plays`,`error`),()=>b(`stats/video-plays`,null))},Z={render:()=>V(`last-365-days`),tags:[`!autodocs`],decorators:[G],beforeEach:()=>(b(`stats/video-plays`,`empty`),()=>b(`stats/video-plays`,null))},Q={render:e=>(0,U.jsx)(H,{...e}),args:{...T,withComparison:!0},argTypes:{...S,withComparison:{control:`boolean`}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
