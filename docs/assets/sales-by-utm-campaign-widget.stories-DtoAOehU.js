import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{t as n,ul as r}from"./build-module-2iv4IIRq.js";import{m as i}from"./hooks-tF9F6mR2.js";import{rt as a,t as o}from"./src-CJGEmgc4.js";import{r as s,tn as c}from"./date-period-dropdown-DvNDXIsD.js";import{c as l,i as u,r as d}from"./register-report-mocks-DbWRMZMW.js";import{f,t as p}from"./src-BAwNXvbM.js";import{a as m,c as h,i as g,l as _,n as v,o as y,r as b,s as x}from"./with-widget-canvas-CfM6YvkV.js";function S({attributes:e={},setError:t}){return(0,C.jsx)(i,{attributes:e,setError:t,options:{from:`/`},children:(0,C.jsx)(f,{view:`campaign`})})}var C,w=e((()=>{p(),C=t()})),T,E=e((()=>{n(),T={icon:r}})),D,O,k,A,j,M,N,P=e((()=>{D=`jpa/sales-by-utm-campaign`,O=`Sales by UTM campaign`,k=`Shows the top UTM campaigns by order revenue over the selected time period.`,A={content:`See which marketing campaigns are driving sales in your store.`},j=`store`,M=`framed`,N={name:D,title:O,description:k,help:A,category:j,presentation:M}}));function F(e=!1,t=U){return{reportParams:c(e,t)}}function I({withComparison:e,preset:t}){let n=!!e,r=t??U;return!n&&r===U?`getDefaultQueryParams()`:n&&r===U?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function L(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<SalesByUtmCampaignRender
\tattributes={ {
\t\treportParams: ${I(e)},
\t} }
/>`}function R({withComparison:e,preset:t}){return(0,V.jsx)(S,{attributes:F(e,t)})}function z(e){return(0,V.jsx)(S,{attributes:F(!1,e)})}function B({withComparison:e,preset:t,...n}){return(0,V.jsx)(x,{...n,widgetType:g(N,T),renderModule:H,renderComponent:S,attributes:F(e,t)})}var V,H,U,W,G,K,q,J,Y,X,Z,Q;e((()=>{s(),o(),d(),h(),m(),v(),w(),E(),P(),V=t(),u(),H=`storybook/sales-by-utm-campaign`,U=`last-30-days`,W=a,G={title:`Packages/Premium Analytics/Widgets/SalesByUtmCampaign`,component:S,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:W,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`Dashboard widget that displays top UTM campaigns by order revenue for the selected period.`}}}},K={render:R,args:{preset:U,withComparison:!1},decorators:[b],parameters:{docs:{source:{transform:(e,t)=>L(t.args)}}}},q={render:R,args:{preset:U,withComparison:!0},decorators:[b],parameters:{docs:{source:{transform:(e,t)=>L(t.args)}}}},J={render:()=>z(`last-90-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(l(`order-attribution/campaign/summary`,`loading`),()=>l(`order-attribution/campaign/summary`,null))},Y={render:()=>z(`last-7-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(l(`order-attribution/campaign/summary`,`error`),()=>l(`order-attribution/campaign/summary`,null))},X={render:()=>z(`last-365-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(l(`order-attribution/campaign/summary`,`empty`),()=>l(`order-attribution/campaign/summary`,null))},Z={render:e=>(0,V.jsx)(B,{...e}),args:{...y,preset:U,withComparison:!0},argTypes:{..._,preset:{control:`select`,options:W,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
