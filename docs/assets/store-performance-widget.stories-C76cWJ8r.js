import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{Rt as ee,n as o}from"./build-module-Bb7IR3OP.js";import{G as s,W as c,Z as l,q as u,tt as te}from"./report-metric-CYHfdN1i.js";import{n as d,r as f}from"./line-chart-B-eKUSKr.js";import{t as p,x as m}from"./src-B-_HxovR.js";import{Mr as ne,Vn as re,Yn as ie,ar as h,ft as ae,qn as oe,ur as g,xt as _,yt as v}from"./chart-tooltip-Cw816hJP.js";import{t as se}from"./metric-tabs-chart-Bnn_e9ja.js";import{C as y,D as b,E as x,S as ce,T as S,b as C,t as w,w as T,x as E}from"./src-DypA9rWg.js";import{t as le}from"./widget-state-Dxlsu1FD.js";import{i as D,t as ue}from"./src-C6Ok38E4.js";var O,k,A=t((()=>{i(),O=[{id:`net-sales`,label:r(`Net sales`,`jetpack-premium-analytics-pkg`),description:r(`Monitor your total revenue — after any discounts, returns, or adjustments — over a set period of time.`,`jetpack-premium-analytics-pkg`),metricType:`general`,metricKey:`orders_value_net`},{id:`orders`,label:r(`Orders`,`jetpack-premium-analytics-pkg`),description:r(`See a breakdown of when orders are placed to identify peak selling periods.`,`jetpack-premium-analytics-pkg`),metricType:`general`,metricKey:`orders_no`},{id:`bookings`,label:r(`Bookings`,`jetpack-premium-analytics-pkg`),description:r(`See a breakdown of when bookings are placed to identify peak selling periods.`,`jetpack-premium-analytics-pkg`),metricType:`booking`,metricKey:`orders_no`},{id:`visitors`,label:r(`Visitors`,`jetpack-premium-analytics-pkg`),description:r(`Track website visitor trends and monitor traffic patterns over time.`,`jetpack-premium-analytics-pkg`),metricType:`visitors`,metricKey:`visitors`},{id:`conversion-rate`,label:r(`Store conversion rate`,`jetpack-premium-analytics-pkg`),description:r(`Track your store's conversion funnel from sessions to completed orders.`,`jetpack-premium-analytics-pkg`),metricType:`conversion`,metricKey:`conversion_rate`},{id:`customers`,label:r(`Customers`,`jetpack-premium-analytics-pkg`),description:r(`Track the total number of customers (new and returning) who placed orders during the selected time period.`,`jetpack-premium-analytics-pkg`),metricType:`customers`,metricKey:`customers`}],k=O.map(e=>e.id)})),de,fe,pe=t((()=>{de=`_widgetRoot_8wi56_1`,fe={widgetRoot:de}}));function me(){return{summary:{date_start:``,date_end:``,total_sales:0,orders_no:0,avg_items:0,average_order_value:0,orders_value_net:0,orders_value_gross:0,product_net_revenue:0,profit_margin:0,cogs_amount:0,coupons:0,refunds:0,paid_orders_count:0,paid_net_sales:0,unpaid_orders_count:0,unpaid_net_sales:0},data:[]}}function he(){return{summary:{date_start:``,date_end:``,active_sessions:0,visitors:0},data:[]}}function ge(){return{summary:{date_start:``,date_end:``,active_sessions:0,visitors:0,with_cart_addition:0,reached_checkout:0,completed_checkout:0,conversion_rate:0},data:[],steps:[],overallRate:0}}function j(){return{summary:{total_net_sales:0,total_gross_sales:0,total_discounts:0,total_refunds:0,total_orders:0,total_average_order_value:0,total_avg_items_per_order:0,total_customers:0,new_customers:0,returning_customers:0,new_customer_sales:0,new_customer_gross_sales:0,new_customer_discounts:0,new_customer_refunds:0,new_customer_orders:0,new_customer_avg_order_value:0,new_customer_avg_items_per_order:0,returning_customer_sales:0,returning_customer_gross_sales:0,returning_customer_discounts:0,returning_customer_refunds:0,returning_customer_orders:0,returning_customer_avg_order_value:0,returning_customer_avg_items_per_order:0,date_start:``,date_end:``,customers:0},data:[]}}function _e(e,t){if(e.metricType===`visitors`)return v({primary:t.visitors.primary.data??he(),comparison:t.visitors.comparison.data??he(),metricKey:e.metricKey,emptyDataFallback:`empty-array`});if(e.metricType===`conversion`)return v({primary:t.conversion.primary.data??ge(),comparison:t.conversion.comparison.data??ge(),metricKey:e.metricKey,emptyDataFallback:`empty-array`});if(e.metricType===`customers`)return v({primary:t.customers.primary.data??j(),comparison:t.customers.comparison.data??j(),metricKey:e.metricKey,emptyDataFallback:`empty-array`});let n=e.metricType===`booking`?t.booking:t.general;return v({primary:n.primary.data??me(),comparison:n.comparison.data??me(),metricKey:e.metricKey,emptyDataFallback:`empty-array`})}function ve({metricIds:e=k}){let{reportParams:t}=te(),n=(0,N.useMemo)(()=>{let t=new Set(e);return O.filter(e=>t.has(e.id))},[e]),i=(0,N.useMemo)(()=>new Set(n.map(e=>e.metricType)),[n]),a=h(t,{enabled:i.has(`general`)}),{primary:o,comparison:s}=a,c=h({...t,filters:[ae]},{enabled:i.has(`booking`)}),{primary:l,comparison:u}=c,d=re(t,{enabled:i.has(`visitors`)}),{primary:f,comparison:p}=d,m=oe(t,{enabled:i.has(`conversion`)}),{primary:g,comparison:_}=m,v=ie(t,{enabled:i.has(`customers`)}),{primary:y,comparison:b}=v,x=(0,N.useMemo)(()=>[i.has(`general`)?a:null,i.has(`booking`)?c:null,i.has(`visitors`)?d:null,i.has(`conversion`)?m:null,i.has(`customers`)?v:null].filter(e=>e!==null),[i,a,c,d,m,v]),ce=x.some(e=>e.isError&&!e.hasData),S=(0,N.useCallback)(()=>Promise.all(x.map(e=>e.refetch())),[x]),C=(0,N.useMemo)(()=>n.map(e=>{let[t,n]=e.metricType===`booking`?[l.data?.summary??{},u.data?.summary??{}]:e.metricType===`visitors`?[f.data?.summary??{},p.data?.summary??{}]:e.metricType===`conversion`?[g.data?.summary??{},_.data?.summary??{}]:e.metricType===`customers`?[y.data?.summary??{},b.data?.summary??{}]:[o.data?.summary??{},s.data?.summary??{}];return{...e,primary:Number(t[e.metricKey]??0),comparison:n[e.metricKey]===void 0?null:Number(n[e.metricKey])}}),[n,l.data,u.data,f.data,p.data,g.data,_.data,y.data,b.data,o.data,s.data]),w=(0,N.useMemo)(()=>({general:{primary:o,comparison:s},booking:{primary:l,comparison:u},visitors:{primary:f,comparison:p},conversion:{primary:g,comparison:_},customers:{primary:y,comparison:b}}),[o,s,l,u,f,p,g,_,y,b]),T=(0,N.useMemo)(()=>C.map(e=>{let t=_e(e,w);return{key:e.id,label:e.label,value:e.primary,previousValue:e.comparison,current:t[0]?.data??[],previous:t[1]?.data,dataFormat:ne(e.metricKey),description:e.description}}),[C,w]),E=x.some(e=>e.isLoading&&!e.hasData),D=x.some(e=>e.isFetching);return(0,P.jsx)(`div`,{className:fe.widgetRoot,children:(0,P.jsx)(le,{isLoading:E,isError:ce,isEmpty:!T.length,error:{description:r(`We couldn't load store performance data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:S}]},empty:{icon:ee,description:r(`No metric selected. Please select a metric from the metrics list.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,P.jsx)(se,{metrics:T,dataFormat:F,loading:!0,groupLabel:r(`Store metric`,`jetpack-premium-analytics-pkg`)}),children:(0,P.jsx)(se,{metrics:T,dataFormat:F,loading:D,groupLabel:r(`Store metric`,`jetpack-premium-analytics-pkg`)})})})}function M({attributes:e={}}){return(0,P.jsx)(l,{attributes:e,options:{from:`/`},children:(0,P.jsx)(ve,{metricIds:e.metrics})})}var N,P,F,ye=t((()=>{_(),w(),i(),o(),N=e(n(),1),A(),pe(),P=a(),F={type:`number`,options:{useMultipliers:!0,decimals:0}}})),I,be=t((()=>{i(),o(),ue(),A(),I={icon:ee,attributes:[{id:`metrics`,label:r(`Metrics`,`jetpack-premium-analytics-pkg`),type:`array`,relevance:`high`,Edit:D,elements:O.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:k}}}})),L,R,z,xe,Se,Ce,we=t((()=>{L=`jpa/store-performance`,R=`Store performance`,z=`Shows key store performance metrics at a glance.`,xe={content:`Shows key store performance metrics at a glance.`},Se=`store`,Ce={name:L,title:R,description:z,help:xe,category:Se}}));function B({withComparison:e=!1,preset:t=W,metrics:n=k}){return{reportParams:g(e,t),metrics:n}}function Te({withComparison:e,preset:t}){let n=!!e,r=t??W;return!n&&r===W?`getDefaultQueryParams()`:n&&r===W?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function Ee(e=k){return`[ ${e.map(e=>`'${e}'`).join(`, `)} ]`}function De(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
