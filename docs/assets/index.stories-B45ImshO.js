import{a as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./jsx-runtime-D2pHJD-r.js";import{t as r,u as i}from"./build-module-B4QCbA0t2.js";import{M as a,O as o,P as s,X as c,t as l,z as ee}from"./providers-BVvK6ful.js";import{c as te,r as ne,s as u,t as re}from"./chart-decorator-BVA28rW8.js";import{n as ie,r as ae,t as d}from"./legend-config-DvuGdtSm.js";import{S as oe,T as f,b as p,i as se,t as m}from"./sample-data-Cx3-uFO8.js";import{t as ce}from"./stories-CuIV-hKh.js";import{a as le,i as ue,n as h,r as de,t as g}from"./leaderboard-chart-CdKc6R37.js";var fe=e({AdvancedFormatting:()=>G,Animation:()=>P,AspectRatio:()=>w,CurrencyFormatting:()=>V,CustomColors:()=>F,CustomLabel:()=>W,Default:()=>S,EmptyData:()=>L,EmptyDataWithChildren:()=>R,FitRows:()=>Z,FitRowsInteractive:()=>Q,FixedDimensions:()=>C,Interactive:()=>M,LargeValues:()=>z,Loading:()=>A,MissingComparisonRows:()=>O,MissingComparisonRowsWithOverlayLabel:()=>k,MixedInteractivity:()=>N,NegativeGrowth:()=>B,NumberFormatting:()=>H,OverlayLabelWithImage:()=>q,SmallDataset:()=>I,WithCompositionLegend:()=>X,WithLegend:()=>J,WithLegendLabels:()=>Y,WithOverlayLabel:()=>E,WithoutComparison:()=>T,__namedExportsOrder:()=>$,default:()=>x}),_,pe,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,me=t((()=>{r(),l(),ce(),ie(),s(),ue(),de(),_=n(),{action:pe}=__STORYBOOK_MODULE_ACTIONS__,{expect:v,userEvent:y,waitFor:b}=__STORYBOOK_MODULE_TEST__,x={title:`JS Packages/Charts Library/Charts/Leaderboard Chart`,component:h,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{data:{control:`object`,description:`Array of leaderboard entries to display`,table:{type:{summary:`LeaderboardEntry[]`}}},withComparison:{control:`boolean`,description:`Whether to show comparison data (previous period bars and delta values)`,table:{defaultValue:{summary:`false`}}},primaryColor:{control:`color`,description:`Primary color for current period bars`,table:{defaultValue:{summary:a.leaderboardChart.primaryColor}}},secondaryColor:{control:`color`,description:`Secondary color for comparison period bars`,table:{defaultValue:{summary:a.leaderboardChart.secondaryColor}}},valueFormatter:{control:!1,description:`Custom formatter function for values`,table:{type:{summary:`(value: number) => string`},defaultValue:{summary:`formatMetricValue with compact notation`}}},deltaFormatter:{control:!1,description:`Custom formatter function for delta values`,table:{type:{summary:`(value: number) => string`},defaultValue:{summary:`formatMetricValue as percentage`}}},loading:{control:`boolean`,description:`Whether the chart is in loading state`,table:{defaultValue:{summary:`false`}}},className:{control:`text`,description:`Additional CSS class name for the chart container`,table:{type:{summary:`string`}}},style:{control:`object`,description:`Custom styling for the chart container`,table:{type:{summary:`React.CSSProperties`}}},withOverlayLabel:{control:`boolean`,description:`Whether to overlay the label on top of the bar`,table:{defaultValue:{summary:`false`}}},legendLabels:{control:`object`,description:`Custom labels for legend items`,table:{category:`Legend`,type:{summary:`{ primary?: string; comparison?: string }`},defaultValue:{summary:`undefined`}}},...ne,...ae,...te},args:{primaryColor:void 0,secondaryColor:void 0,themeName:`default`,showLegend:!1,legendPosition:`bottom`,legendAlignment:`center`,legendOrientation:`horizontal`,legendShape:`circle`,withOverlayLabel:!1},decorators:[re],render:e=>{let t=d(e);return(0,_.jsx)(h,{...e,legend:t})}},S={args:{...u,data:f,withComparison:!0,loading:!1}},C={args:{...S.args,width:300,height:400}},w={args:{...S.args,aspectRatio:.4}},T={args:{data:f,withComparison:!1,loading:!1}},E={args:{data:f,withOverlayLabel:!0}},D=f.map(e=>e.id===`social`||e.id===`referral`?{id:e.id,label:e.label,currentValue:e.currentValue,currentShare:e.currentShare}:e),O={args:{data:D,withComparison:!0,loading:!1},parameters:{docs:{description:{story:'Rows without a matching comparison-period value ("Social Media" and "Referral" here) omit `previousValue`/`previousShare`/`delta`. Those rows render no comparison bar and show a placeholder in the delta column instead of a fabricated value.'}}}},k={args:{data:D,withComparison:!0,withOverlayLabel:!0,loading:!1,style:{"--a8c-charts-border-radius-leaderboard-bar":`4px`}},parameters:{docs:{description:{story:`Missing comparison rows in the overlay-label variant, as used by the Premium Analytics Stats widgets. The delta column still shows a placeholder for rows without comparison data.`}}}},A={args:{data:f,withComparison:!0,loading:!0}},j=pe(`leaderboard-item-click`),M={args:{data:f.map(e=>({...e,label:(0,_.jsx)(`span`,{style:{display:`flex`,alignItems:`center`,minHeight:`40px`,padding:`0 6px`,fontSize:`13px`},children:e.label}),onClick:()=>j(e.id)})),withComparison:!0,withOverlayLabel:!0,style:{"--a8c-charts-border-radius-leaderboard-bar":`4px`}},render:e=>(0,_.jsx)(K,{...e}),parameters:{docs:{description:{story:"Rows with an `onClick` become interactive: the whole row is clickable and keyboard-focusable (Enter/Space), with a chevron revealed on hover/focus. The consumer supplies the action (e.g. drill-down)."}}}},N={args:{...u,data:f.map((e,t)=>t%2==0?{...e,onClick:()=>j(e.id)}:e),withComparison:!0,withOverlayLabel:!0},parameters:{docs:{description:{story:`Interactive and non-interactive rows with the overlay-label presentation used by Jetpack Stats. Being clickable is a visual affordance only — it must not change a row height or column alignment, otherwise a drill-down that swaps clickable parent rows for non-clickable child rows visibly shifts the list.`}}},play:async({canvasElement:e})=>{let t=e.querySelector(`[class*="leaderboardChart__content"] > *`),n=t.querySelectorAll(`:scope > [class*="row"]`);v(n).toHaveLength(f.length);let r=t.querySelectorAll(`:scope > button[class*="row"]`).length;v(r).toBeGreaterThan(0),v(r).toBeLessThan(f.length),v(new Set([...n].map(e=>e.getBoundingClientRect().height)).size).toBe(1);let i=(e,n)=>new Set([...t.querySelectorAll(e)].map(e=>e.getBoundingClientRect()[n]));v(i(`[class*="barWithLabelContainer"]`,`left`).size).toBe(1),v(i(`[class*="valueContainer"]`,`right`).size).toBe(1)}},P={args:{...S.args,animation:!0}},F={args:{data:f,withComparison:!0,loading:!1,primaryColor:`red`,secondaryColor:`green`}},I={args:{data:oe,withComparison:!0,loading:!1}},L={args:{data:[],withComparison:!0,loading:!1}},R={args:{data:[],withComparison:!0,loading:!1},render:e=>(0,_.jsx)(h,{...e,children:(0,_.jsx)(i,{direction:`row`,gap:`xs`,align:`center`,justify:`center`,children:`Child element`})})},z={args:{data:p,withComparison:!0,loading:!1}},B={args:{data:se,withComparison:!0,loading:!1}},V={args:{data:f,withComparison:!0,loading:!1,valueFormatter:e=>c(e,`currency`,{useMultipliers:!0,decimals:1}),deltaFormatter:e=>c(e/100,`average`,{decimals:0})}},H={args:{data:f,withComparison:!0,loading:!1,valueFormatter:e=>c(e,`number`,{useMultipliers:!1,decimals:0}),deltaFormatter:e=>c(e/100,`average`,{decimals:1})}},U=({label:e,imageColor:t,style:n={}})=>(0,_.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`,...n},children:[(0,_.jsx)(`img`,{src:`data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='50' height='50'><rect width='50' height='50' fill='${encodeURIComponent(t)}'/></svg>`,alt:`icon`,style:{width:`28px`,height:`28px`,verticalAlign:`middle`,borderRadius:`4px`}}),(0,_.jsx)(`span`,{style:{fontSize:`13px`},children:e})]}),W={args:{data:m.map(e=>({...e,label:(0,_.jsx)(U,{label:e.label,imageColor:e.imageColor})})),withComparison:!1,loading:!1}},G={args:{data:p,withComparison:!0,loading:!1,valueFormatter:e=>e>=1e6?c(e,`currency`,{useMultipliers:!0,decimals:1}):c(e,`currency`,{useMultipliers:!1,decimals:0}),deltaFormatter:e=>c(e/100,`average`,{decimals:1,signDisplay:`always`})}},K=e=>{let{getElementStyles:t}=o(),{color:n}=t({index:0,overrideColor:e.primaryColor}),r=ee(n,.08);return(0,_.jsx)(h,{...e,primaryColor:r})},q={args:{data:m.map(e=>({...e,label:(0,_.jsx)(U,{label:e.label,imageColor:e.imageColor,style:{padding:`6px`}})})),withComparison:!0,withOverlayLabel:!0,loading:!1,style:{"--a8c-charts-border-radius-leaderboard-bar":`4px`}},render:e=>(0,_.jsx)(K,{...e})},J={args:{data:f,withComparison:!0,loading:!1,showLegend:!0},parameters:{docs:{description:{story:"Props-based legend using `showLegend` and the `legend` config object. Use Storybook controls to adjust legend position, alignment, orientation, shape, and interactivity."}}}},Y={args:{data:f,withComparison:!0,loading:!1,showLegend:!0,legendLabels:{primary:`Aug 11-Sep 9, 2025`,comparison:`Jul 11-Aug 11, 2025`}},parameters:{docs:{description:{story:"Props-based legend using `showLegend`, the `legend` config object, and the `legendLabels` prop to customize primary and comparison labels. Other legend options (position, alignment, orientation, shape, interactivity) can be adjusted via Storybook controls."}}}},X={render:e=>{let t=d(e);return(0,_.jsx)(h,{...e,legend:{interactive:t?.interactive},chartId:`composition-leaderboard-chart`,children:(0,_.jsx)(h.Legend,{...t,shapeStyles:{width:8,height:8,...t?.shapeStyles}})})},args:{data:f,withComparison:!0,loading:!1},parameters:{docs:{description:{story:"Composition API using `<LeaderboardChart.Legend />` as a child component for explicit legend placement and configuration. This is the recommended approach for flexible legend positioning."}}}},Z={render:e=>(0,_.jsx)(g,{...e,fitRows:!0}),args:{data:f,loading:!1,containerWidth:`360px`,containerHeight:`180px`,withPadding:!1,resize:`vertical`},parameters:{docs:{description:{story:"`fitRows` shows only the rows that fit the chart height instead of scrolling, for charts placed in a fixed-height container such as a dashboard tile. Rows that do not fit keep their place in the layout but are hidden from painting, hit testing, focus order, and the accessibility tree, so growing the container reveals them again immediately. Drag the container's resize handle to watch the visible row count follow the height — a row appears only once it fits whole."}}},play:async({canvasElement:e})=>{await document.fonts.ready;let t=e.querySelector(`[class*="leaderboardChart__content"]`),n=[...t.querySelector(`:scope > [data-leaderboard-grid]`).querySelectorAll(`:scope > [data-row-index]`)],r=e=>getComputedStyle(e).visibility===`hidden`,i=()=>new Set(n.filter(e=>!r(e)).map(e=>e.getAttribute(`data-row-index`))).size;await b(()=>{let e=n.filter(r);v(e.length).toBeGreaterThan(0),v(e.length).toBeLessThan(n.length)}),v(getComputedStyle(t).overflow).toBe(`hidden`);let a=()=>{let e=t.getBoundingClientRect().bottom;for(let t of n)r(t)||v(t.getBoundingClientRect().bottom).toBeLessThanOrEqual(e+le)};a();let o=e.querySelector(`[data-testid="chart-story-container"]`),s=async(e,t)=>(o.style.height=`${e}px`,await b(()=>t(i())),a(),i()),c=i(),l=await s(100,e=>v(e).toBeLessThan(c));await s(280,e=>v(e).toBeGreaterThan(l)),await s(100,e=>v(e).toBe(l)),await s(180,e=>v(e).toBe(c))}},Q={render:e=>(0,_.jsx)(g,{...e,fitRows:!0}),args:{data:f.map(e=>({...e,onClick:()=>j(e.id)})),loading:!1,containerWidth:`360px`,containerHeight:`180px`,withPadding:!1,resize:`vertical`},parameters:{docs:{description:{story:"`fitRows` with interactive rows: the rows that do not fit are hidden with `visibility: hidden`, which also removes them from the tab order and the accessibility tree. Tab through the chart to verify focus only ever lands on a fully visible row."}}},play:async({canvasElement:e})=>{await document.fonts.ready;let t=[...e.querySelectorAll(`[data-row-index]`)],n=e=>getComputedStyle(e).visibility===`hidden`,r=[];await b(()=>{r=t.filter(e=>!n(e)),v(r.length).toBeGreaterThan(0),v(r.length).toBeLessThan(t.length)}),r[0].focus(),v(r[0]).toHaveFocus();for(let e of r.slice(1))await y.tab(),v(e).toHaveFocus();await y.tab(),v(t.filter(n)).not.toContain(e.ownerDocument.activeElement)}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  args: {
    ...sharedThemeArgs,
    data: sampleData,
    withComparison: true,
...
}`,...Q.parameters?.docs?.source}}},$=`Default.FixedDimensions.AspectRatio.WithoutComparison.WithOverlayLabel.MissingComparisonRows.MissingComparisonRowsWithOverlayLabel.Loading.Interactive.MixedInteractivity.Animation.CustomColors.SmallDataset.EmptyData.EmptyDataWithChildren.LargeValues.NegativeGrowth.CurrencyFormatting.NumberFormatting.CustomLabel.AdvancedFormatting.OverlayLabelWithImage.WithLegend.WithLegendLabels.WithCompositionLegend.FitRows.FitRowsInteractive`.split(`.`)}));me();export{G as AdvancedFormatting,P as Animation,w as AspectRatio,V as CurrencyFormatting,F as CustomColors,W as CustomLabel,S as Default,L as EmptyData,R as EmptyDataWithChildren,Z as FitRows,Q as FitRowsInteractive,C as FixedDimensions,M as Interactive,z as LargeValues,A as Loading,O as MissingComparisonRows,k as MissingComparisonRowsWithOverlayLabel,N as MixedInteractivity,B as NegativeGrowth,H as NumberFormatting,q as OverlayLabelWithImage,I as SmallDataset,X as WithCompositionLegend,J as WithLegend,Y as WithLegendLabels,E as WithOverlayLabel,T as WithoutComparison,$ as __namedExportsOrder,x as default,me as n,fe as t};