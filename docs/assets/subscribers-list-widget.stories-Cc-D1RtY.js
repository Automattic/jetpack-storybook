import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-2QZQpBH2.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{li as o,t as s}from"./build-module-2iv4IIRq.js";import{m as c}from"./hooks-BKiCUZkU.js";import{Za as l,ao as u,eo as d,to as ee}from"./iframe-DWzTVJij.js";import{p as te,t as ne}from"./src-C-E2d-Lb.js";import{k as re,t as ie}from"./src-CJGEmgc4.js";import{J as ae,pn as oe,r as f}from"./date-period-dropdown-D4R70JTy.js";import"./constants-C7AKabD4.js";import{c as p,i as se,r as m}from"./register-report-mocks-BEpCi-EW.js";import{S as h,b as g}from"./report-metric-awK846dy.js";import{t as _}from"./widget-state-oY2LJGRS.js";import{r as v,t as y}from"./subscriber-list-skeleton-BAx-bkBN.js";import{t as b}from"./src-CNKIafZC.js";import{a as x,c as S,i as ce,l as le,n as ue,o as de,r as C,s as fe}from"./with-widget-canvas-bvfwGRxT.js";var w,T,E,D=t((()=>{w=`_root_17ufc_2`,T=`_content_17ufc_9`,E={root:w,content:T}}));function O(){let e=ee()?.suffix;return e?`${u()?`https://wordpress.com`:`https://cloud.jetpack.com`}/subscribers/${e}`:null}function k(e){let t=oe(e),n=O();return t.map((e,t)=>({id:e.subscription_id??`row-${t}`,name:e.label,avatarUrl:e.icon,href:n&&e.subscription_id?`${n}/${e.subscription_id}`:null,secondaryText:re(e.date_subscribed)}))}function A(){let{data:e,isLoading:t,isFetching:n,isError:i,refetch:a}=ae({type:`all`,max:10}),o=e,s=(0,M.useMemo)(()=>k(o),[o]),c=Number(o?.summary?.total??0),l=Math.max(c-s.length,0);return(0,N.jsx)(_,{isLoading:t,isFetching:n,isError:s.length===0&&i,isEmpty:s.length===0,renderLoading:(0,N.jsx)(y,{rows:10}),error:{description:r(`We couldn't load subscribers. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:a}]},empty:{icon:te,description:r(`No subscribers yet.`,`jetpack-premium-analytics-pkg`)},children:(0,N.jsx)(P,{items:s,moreCount:l})})}function j({attributes:e={}}){let t=d()?.newsletter?.subscribersUrl;return(0,N.jsx)(c,{attributes:e,children:(0,N.jsxs)(`div`,{className:E.root,children:[(0,N.jsx)(`div`,{className:E.content,children:(0,N.jsx)(A,{})}),(0,N.jsx)(h,{children:t&&(0,N.jsx)(g,{href:t,children:r(`Manage subscribers`,`jetpack-premium-analytics-pkg`)})})]})})}var M,N,P,F=t((()=>{l(),f(),ie(),ne(),b(),i(),M=e(n(),1),D(),N=a(),P=({items:e=[],moreCount:t=0})=>(0,N.jsx)(v,{items:e,moreCount:t})})),I,L=t((()=>{s(),I={icon:o,attributes:[],example:{attributes:{}}}})),R,z,B,V,H,U,W,pe=t((()=>{R=`jpa/subscribers-list`,z=`Latest subscribers`,B=`Your most recent subscribers.`,V={content:`Your most recent subscribers.`},H=`subscribers`,U=`framed`,W={name:R,title:z,description:B,help:V,category:H,presentation:U}})),G,K,q,J,Y,X,Z,Q,$;t((()=>{S(),x(),ue(),m(),F(),L(),pe(),G=a(),se(),window.JetpackScriptData={...window.JetpackScriptData,site:{...window.JetpackScriptData?.site,suffix:`example.com`},newsletter:{...window.JetpackScriptData?.newsletter,subscribersUrl:`https://example.com/wp-admin/admin.php?page=jetpack-newsletter&p=%2F%3Ftab%3Dsubscribers`}},K=`storybook/subscribers-list`,q={title:`Packages/Premium Analytics/Widgets/SubscribersList`,component:j,tags:[`autodocs`],parameters:{docs:{description:{component:'Dashboard widget listing the most recent subscribers (avatar + name + relative "since" time) with an "N more" footer. Data comes from the designated `useStatsFollowers` hook; in Storybook it is served by `registerReportMocks`.'}}}},J={render:()=>(0,G.jsx)(j,{attributes:{}}),decorators:[C]},Y={render:()=>(0,G.jsx)(j,{attributes:{}}),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(p(`stats/followers`,`loading`),()=>p(`stats/followers`,null))},X={render:()=>(0,G.jsx)(j,{attributes:{}}),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(p(`stats/followers`,`error`),()=>p(`stats/followers`,null))},Z={render:()=>(0,G.jsx)(j,{attributes:{}}),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(p(`stats/followers`,`empty`),()=>p(`stats/followers`,null))},Q={render:e=>(0,G.jsx)(fe,{...e,widgetType:ce(W,I),renderModule:K,renderComponent:j,attributes:{}}),args:{...de},argTypes:{...le}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
