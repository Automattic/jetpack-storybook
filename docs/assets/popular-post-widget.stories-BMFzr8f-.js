import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-2QZQpBH2.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{C as o,t as s}from"./build-module-2iv4IIRq.js";import{E as c,Ot as l,m as u,v as d,y as f}from"./hooks-D2-uOzcc.js";import{K as p,t as m}from"./src-CJGEmgc4.js";import{$t as h,bt as g,c as _,ft as v,jn as ee,kn as te,l as ne,nt as re,t as y,vt as ie}from"./src-0ge7d6kt.js";import{t as ae}from"./post-highlight-card-skeleton-BvO1coBS.js";import{i as oe,r as se}from"./register-report-mocks-DAHzORiq.js";import{m as ce}from"./report-metric--Et_iyvv.js";import{t as b}from"./widget-state-BlFCjv4l.js";import{t as le}from"./src-Ddik3icB.js";import{a as ue,d as de,f as fe,h as x,i as pe,m as me,n as he,p as S,r as C,u as w}from"./with-widget-canvas-q45aoI9y.js";import{n as ge,t as _e}from"./register-stats-mocks-BZi9sgqC.js";import{n as ve,t as T}from"./force-stats-mock-state-DzBZCkRi.js";function ye(e,t){let n=v((0,E.useMemo)(()=>({...e,max:O}),[e]),{maxRows:1,postTypes:D,enabled:t}),r=t?n.comparisonRows?.rows[0]:void 0,i=Number(r?.id??0)||0,a=g(_(i));return{topRow:r,content:a.data??null,isLoading:n.isLoading||i>0&&a.isLoading,isFetching:n.isFetching||a.isFetching,isError:n.isError,error:n.error,refetch:()=>{n.refetch(),i>0&&a.refetch()}}}function be(e,t,n){let r=re((0,E.useMemo)(()=>({...t,max:0}),[t]),{enabled:n}),i=(0,E.useMemo)(()=>n?te(r.comparisonRows?.rows,e)?.children??[]:[],[n,r.comparisonRows,e]),a=(0,E.useMemo)(()=>i.map(e=>Number(e.id)||0).filter(Boolean),[i]),o=g(ne(a)),s=(0,E.useMemo)(()=>{let e=new Set((o.data??[]).map(e=>e.id));return i.find(t=>e.has(Number(t.id)))},[i,o.data]),c=Number(s?.id??0)||0,l=a.length>0,u=l&&o.isError;return{topRow:s,content:o.data?.find(e=>e.id===c)??null,isLoading:r.isLoading||l&&o.isLoading,isFetching:r.isFetching||o.isFetching,isError:r.isError||u,error:r.error??(u?o.error:null),refetch:()=>{r.refetch(),l&&o.refetch()}}}var E,D,O,xe=t((()=>{y(),E=e(n(),1),D=[`post`],O=20}));function Se(e){let t=!!e&&e.authorId>0,{preset:n,from:r,to:i,interval:a}=t?e.reportParams:h(!1,A),o=(0,k.useMemo)(()=>({preset:n,from:r,to:i,interval:a}),[n,r,i,a]),s=(0,k.useMemo)(()=>({from:r,to:i,interval:a}),[r,i,a]),c=ye(s,!t),l=be(e?.authorId??0,s,t),u=t?l:c,{topRow:d,content:f}=u,p=Number(d?.id??0)||0,m=ie({postId:p,fields:[`views`,`like_count`,`post`]}),g=m.data,_=g?.post?.ID,v=g&&(_===void 0||_===p)?g:void 0,ee=p>0&&!v&&!m.isError,te=u.isLoading||p>0&&(m.isLoading||ee),ne=u.isFetching||m.isFetching;return{post:d?{id:p,title:f?.title||String(d.label??``),url:f?.url||d.link||``,date:f?.date||(typeof d.date==`string`?d.date:``),imageUrl:f?.imageUrl??``,imageAlt:f?.imageAlt??``,views:v?.views,likeCount:v?.like_count,commentCount:v?.post?.comment_count}:null,range:o,isLoading:te,isFetching:ne,isError:u.isError,error:u.error,refetch:()=>{u.refetch(),p>0&&m.refetch()}}}var k,A,Ce=t((()=>{y(),m(),k=e(n(),1),xe(),A=p}));function we({authorScoped:e}){let{reportParams:t}=d(),n=e?ee(t.author_id):0;return e&&!n?(0,M.jsx)(b,{isLoading:!1,isError:!1,isEmpty:!0,empty:{icon:o,description:r(`Open an author to see their most viewed post here.`,`jetpack-premium-analytics-pkg`)},children:null}):(0,M.jsx)(Te,{authorId:n})}function Te({authorId:e}){let{reportParams:t}=d(),{post:n,range:i,isLoading:a,isFetching:s,isError:u,error:f,refetch:p}=Se(e?{authorId:e,reportParams:t}:void 0),m=n?[{key:`views`,label:r(`Views`,`jetpack-premium-analytics-pkg`),value:n.views},{key:`likes`,label:r(`Likes`,`jetpack-premium-analytics-pkg`),value:n.likeCount},{key:`comments`,label:r(`Comments`,`jetpack-premium-analytics-pkg`),value:n.commentCount}]:[],h={...i,...c(e?`authors`:`posts`,e?void 0:`posts-pages`)};return(0,M.jsx)(b,{isLoading:a,isFetching:s,isError:u,isEmpty:!n,error:l(f,{retryDescription:r(`We couldn't load your most popular post. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:p}),empty:{icon:o,description:r(e?`No views recorded for this author’s posts in this period.`:`No post views in the last 12 months.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,M.jsx)(ae,{}),children:n&&(0,M.jsx)(ce,{title:n.title,url:n.url,postId:n.id,detailSearch:h,date:n.date,imageUrl:n.imageUrl,imageAlt:n.imageAlt,metrics:m})})}function j({attributes:e={}}){return(0,M.jsx)(u,{attributes:e,children:(0,M.jsx)(we,{authorScoped:e.authorScoped===!0})})}var M,Ee=t((()=>{y(),f(),le(),i(),s(),Ce(),M=a()})),N,De=t((()=>{s(),N={icon:o,attributes:[],example:{attributes:{}}}})),P,F,I,L,R,z,B,Oe=t((()=>{P=`jpa/popular-post`,F=`Most popular in the last year`,I=`Your most-viewed post of the last 12 months, with its all-time stats.`,L={content:`Your most-viewed post of the last 12 months, with its all-time views, likes, and comments.`},R=`stats`,z=`framed`,B={name:P,title:F,description:I,help:L,category:R,presentation:z}}));function V(){return(0,U.jsx)(j,{attributes:{reportParams:h()}})}function H(e){return(0,U.jsx)(de,{...e,widgetType:pe(B,N),renderModule:W,renderComponent:j,attributes:{reportParams:h(!0)}})}var U,W,ke,G,K,q,J,Y,X,Z,Q,$;t((()=>{y(),se(),_e(),ue(),ve(),fe(),me(),he(),Ee(),De(),Oe(),U=a(),oe(),ge(),W=`storybook/popular-post`,ke={title:`Packages/Premium Analytics/Widgets/PopularPost`,component:j,tags:[`autodocs`],parameters:{docs:{description:{component:"The \"Most popular in the last year\" widget shows the site's most-viewed post of the last 12 months, with its publish date and its all-time views, likes, and comments. The window is the widget's own — the dashboard date range does not change which post wins — and it only picks the winner: every tile comes from the all-time `stats/post` response, so the three cannot measure different periods. There is no `WithComparison` story: the card shows no period-over-period delta, so the dashboard story below carries the comparison report params instead."}}}},G={render:V,decorators:[C,x]},K={render:V,tags:[`!autodocs`],decorators:[C,x],beforeEach:()=>(T(`stats/top-posts`,`loading`),()=>T(`stats/top-posts`,null))},q={render:V,tags:[`!autodocs`],decorators:[C,x],beforeEach:()=>(T(`stats/top-posts`,`error`),()=>T(`stats/top-posts`,null))},J={render:V,tags:[`!autodocs`],decorators:[C,x],beforeEach:()=>(T(`stats/top-posts`,`error-retryable`),()=>T(`stats/top-posts`,null))},Y={render:V,tags:[`!autodocs`],decorators:[C,x],beforeEach:()=>(T(`stats/top-posts`,`empty`),()=>T(`stats/top-posts`,null))},X={render:e=>(0,U.jsx)(H,{...e}),args:{...w,widgetWidth:2,widgetHeight:2},argTypes:{...S}},Z={render:e=>(0,U.jsx)(H,{...e}),args:{...w,widgetWidth:2,widgetHeight:1},argTypes:{...S}},Q={render:e=>(0,U.jsx)(H,{...e}),args:{...w,widgetWidth:1,widgetHeight:1},argTypes:{...S}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
