import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Fn as i,n as a}from"./build-module-DoJYX5DX.js";import{G as o,W as s,Z as c,q as l}from"./report-metric-ci9FaX7m.js";import{t as u,y as d}from"./src-Ddlvl-_o.js";import{ft as f,ur as p,xt as m}from"./chart-tooltip-DhFNGd_B.js";import{C as h,D as g,E as _,S as ee,T as te,b as v,t as y,w as b,x}from"./src-D3XXi1TL.js";import{t as S}from"./sales-by-device-widget-BMf-Wu_c.js";function ne(){return(0,w.jsx)(S,{filter:f,emptyStateText:t(`No booking data in this period.`,`jetpack-premium-analytics-pkg`),errorText:t(`We couldn't load booking data by device. Please try again in a moment.`,`jetpack-premium-analytics-pkg`)})}function C({attributes:e={},setError:t}){return(0,w.jsx)(c,{attributes:e,setError:t,options:{from:`/`},children:(0,w.jsx)(ne,{})})}var w,T=e((()=>{y(),n(),w=r()})),E,D=e((()=>{a(),E={icon:i}})),O,k,A,j,M,N,P,F=e((()=>{O=`jpa/bookings-by-device`,k=`Bookings by device`,A=`See which devices your customers are using to make bookings in your store.`,j={content:`See which devices your customers are using to make bookings in your store.`},M=`bookings`,N=`framed`,P={name:O,title:k,description:A,help:j,category:M,presentation:N}}));function I(e=!1,t=W){return{reportParams:p(e,t)}}function L({withComparison:e,preset:t}){let n=!!e,r=t??W;return!n&&r===W?`getDefaultQueryParams()`:n&&r===W?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function R(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<BookingsByDeviceRender
\tattributes={ {
\t\treportParams: ${L(e)},
\t} }
/>`}function z({withComparison:e,preset:t}){return(0,H.jsx)(C,{attributes:I(e,t)})}function B(e){return(0,H.jsx)(C,{attributes:I(!1,e)})}function V({withComparison:e,preset:t,...n}){return(0,H.jsx)(te,{...n,widgetType:ee(P,E),renderModule:U,renderComponent:C,attributes:I(e,t)})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{m(),u(),_(),h(),v(),s(),T(),D(),F(),H=r(),o(),U=`storybook/bookings-by-device`,W=`last-30-days`,G=d,K={title:`Packages/Premium Analytics/Widgets/BookingsByDevice`,component:C,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:G,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`Dashboard widget that displays which devices customers use to make bookings.`}}}},q={render:z,args:{preset:W,withComparison:!1},decorators:[x],parameters:{docs:{source:{transform:(e,t)=>R(t.args)}}}},J={render:z,args:{preset:W,withComparison:!0},decorators:[x],parameters:{docs:{source:{transform:(e,t)=>R(t.args)}}}},Y={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(l(`order-attribution-by-product/device/summary`,`loading`),()=>l(`order-attribution-by-product/device/summary`,null))},X={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(l(`order-attribution-by-product/device/summary`,`error`),()=>l(`order-attribution-by-product/device/summary`,null))},Z={render:()=>B(`last-365-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(l(`order-attribution-by-product/device/summary`,`empty`),()=>l(`order-attribution-by-product/device/summary`,null))},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...b,preset:W,withComparison:!0},argTypes:{...g,preset:{control:`select`,options:G,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
