import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as ee,t as i}from"./build-module-CbwHEf9N.js";import{Cc as te,_c as a,n as o}from"./build-module-CDRs4YxF.js";import{ln as s,t as c}from"./src-NeV_lg2z.js";import{E as l,G as u,J as ne,S as re,q as ie,tt as ae,w as oe}from"./report-metric-CG4McNXT.js";import{Gt as d,N as se,t as f}from"./src-Boe-c6TP.js";import{at as p,w as ce,x as le}from"./chart-tooltip-DEV3Aqbv.js";import{r as ue,t as m}from"./leaderboard-skeleton-CEZ8h0Q-.js";import{t as h}from"./widget-state-BsgP3UWI.js";import{C as g,D as _,E as v,O as y,S as b,T as x,b as de,k as S,t as fe,w as pe,x as C}from"./src-D-0P4cBO.js";var w,T,E,D=e((()=>{w=`_root_jzzhc_1`,T=`_content_jzzhc_9`,E={root:w,content:T}}));function O({max:e}){let{rows:n,isLoading:r,isFetching:i,isError:a,error:o,refetch:c}=se({group:`posts`,max:e}),u=(0,ee.useMemo)(()=>{let e=Math.max(...n.map(e=>e.value),0);return n.map(t=>({id:t.id,label:(0,A.jsx)(re,{id:t.postId,label:t.label,link:t.link}),currentValue:t.value,currentShare:p(t.value,e)}))},[n]);return(0,A.jsxs)(s,{className:E.root,children:[(0,A.jsx)(`div`,{className:E.content,children:(0,A.jsx)(h,{isLoading:r,isFetching:i,isError:a,isEmpty:n.length===0,error:le(o,{retryDescription:t(`We couldn't load commented posts. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}),empty:{icon:te,description:t(`None of your posts or pages have comments yet.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,A.jsx)(m,{rows:e}),children:(0,A.jsx)(ue,{data:u,withOverlayLabel:!0,showLegend:!1,dataFormat:j})})}),(0,A.jsx)(l,{children:(0,A.jsx)(oe,{report:`comments`,section:`posts`,ariaLabel:t(`See the commented posts report`,`jetpack-premium-analytics-pkg`)})})]})}function k({attributes:e={}}){return(0,A.jsx)(ae,{attributes:e,children:(0,A.jsx)(O,{max:ce(e.max,M)})})}var A,j,M,N=e((()=>{f(),fe(),i(),n(),o(),c(),D(),A=r(),j={type:`number`,options:{useMultipliers:!0,decimals:0}},M=10})),P,F=e((()=>{n(),o(),P={icon:a,attributes:[{id:`max`,label:t(`Number of results`,`jetpack-premium-analytics-pkg`),type:`integer`}],example:{attributes:{max:10}}}})),I,L,R,z,B,V,H,me=e((()=>{I=`jpa/most-commented-posts`,L=`Top commented posts`,R=`The posts and pages that receive the most comments.`,z={content:`Your posts and pages, ranked by the number of comments they have received.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},B=`stats`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function U(){return(0,W.jsx)(k,{attributes:{reportParams:d()}})}function he(e){return(0,W.jsx)(x,{...e,widgetType:b(H,P),renderModule:G,renderComponent:k,attributes:{reportParams:d(!0)}})}var W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),v(),g(),y(),de(),ie(),N(),F(),me(),W=r(),ne(),G=`storybook/most-commented-posts`,K={title:`Packages/Premium Analytics/Widgets/MostCommentedPosts`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:`The "Top commented posts" widget. Ranks the posts and pages that receive the most comments, linking each row to the published post. One half of the Jetpack Stats Comments module; "Top commented authors" covers the other.`}}}},q={render:U,decorators:[C,S]},J={render:U,tags:[`!autodocs`],decorators:[C,S],beforeEach:u(`loading`)},Y={render:U,tags:[`!autodocs`],decorators:[C,S],beforeEach:u(`error`)},X={render:U,tags:[`!autodocs`],decorators:[C,S],beforeEach:u(`error-retryable`)},Z={render:U,tags:[`!autodocs`],decorators:[C,S],beforeEach:u(`empty`)},Q={render:e=>(0,W.jsx)(he,{...e}),args:{...pe},argTypes:{..._},decorators:[S]},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
