import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{c as o,n as s}from"./build-module-CDRs4YxF.js";import{E as c,J as l,Q as u,V as ee,Y as d,nt as f,ot as te,v as p,w as m,z as h}from"./report-metric-DvbymNiD.js";import{$ as g,Dt as _,_r as v,b as ne,et as re,nt as ie,pn as ae,v as oe,y as se}from"./chart-tooltip-JHv3HFje.js";import{t as y}from"./leaderboard-chart-98BYhS9Q.js";import{t as ce}from"./widget-state-DIziXein.js";import{C as le,D as ue,E as de,O as fe,S as pe,T as me,b as he,k as b,t as x,w as ge,x as S}from"./src-B1MCLR9S.js";function _e(e=[]){return e.map(e=>{let t=Number(e.id);return{...Number.isInteger(t)&&t>0?{id:t}:{},key:se(e),label:ne(e),link:e.link,plays:e.plays,previousPlays:e.previousPlays}})}var ve=t((()=>{x()})),C,w,T,E,D,O,ye=t((()=>{C=`_labelLink_w5lmg_1`,w=`_labelText_w5lmg_2`,T=`_internalLink_w5lmg_3`,E=`_root_w5lmg_28`,D=`_content_w5lmg_36`,O={labelLink:C,labelText:w,internalLink:T,root:E,content:D}})),k,A=t((()=>{i(),s(),k={icon:o,attributes:[{id:`max`,label:r(`Maximum videos`,`jetpack-premium-analytics-pkg`),type:`integer`}],example:{attributes:{max:7}}}}));function be(e,t){return(0,N.jsx)(p,{id:e.id,label:e.label,link:e.link,search:t,classNames:{internal:O.internalLink,external:O.labelLink,plain:O.labelText},title:e.label})}function xe(e,t){let n=re(e.map(e=>e.plays),e.map(e=>e.previousPlays));return e.map(e=>({id:e.key,label:be(e,t),currentValue:e.plays,currentShare:g(e.plays,n),previousValue:e.previousPlays,previousShare:e.previousPlays===void 0?void 0:g(e.previousPlays,n),delta:e.previousPlays===void 0?void 0:ie(e.plays,e.previousPlays)}))}function Se({max:e}){let{reportParams:t}=te(),{primary:n,comparisonRows:i,hasComparison:a,isLoading:s,isFetching:c,hasData:l,isError:u,refetch:d}=ae((0,M.useMemo)(()=>({...t,max:e}),[t,e]),{maxRows:e}),f=(s||n.isPending)&&!l,p=(0,M.useMemo)(()=>_e(i?.rows??[]),[i]),m=(0,M.useMemo)(()=>ee(t),[t]),h=(0,M.useMemo)(()=>xe(p,m),[p,m]);return(0,N.jsx)(ce,{isLoading:f,isFetching:c,isError:p.length===0&&u,isEmpty:p.length===0,error:{description:r(`We couldn't load video plays. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:d}]},empty:{icon:o,description:r(`No VideoPress plays in this period.`,`jetpack-premium-analytics-pkg`)},children:(0,N.jsx)(y,{data:h,withComparison:a,withOverlayLabel:!0,showLegend:!1,dataFormat:{type:`number`,options:{useMultipliers:!0,decimals:0}}})})}function j({attributes:e={},setError:t}){return(0,N.jsx)(f,{attributes:e,setError:t,children:(0,N.jsxs)(`div`,{className:O.root,children:[(0,N.jsx)(`div`,{className:O.content,children:(0,N.jsx)(Se,{max:oe(e.max,7)})}),(0,N.jsx)(c,{children:(0,N.jsx)(m,{report:`videos`})})]})})}var M,N,Ce=t((()=>{_(),h(),x(),i(),s(),M=e(n(),1),ve(),ye(),A(),N=a()})),P,F,I,L,R,z,B,we=t((()=>{P=`jpa/videopress`,F=`Top videos`,I=`Your most played VideoPress videos, sourced from Jetpack Stats.`,L={content:`The published videos your visitors watched most often, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},R=`stats`,z=`framed`,B={name:P,title:F,description:I,help:L,category:R,presentation:z}}));function V({withComparison:e}){return(0,W.jsx)(j,{attributes:{max:7,reportParams:v(e)}})}function H(e){return(0,W.jsx)(j,{attributes:{max:7,reportParams:v(!1,e)}})}function U({withComparison:e,...t}){return(0,W.jsx)(me,{...t,widgetType:pe(B,k),renderModule:G,renderComponent:j,attributes:{max:7,reportParams:v(e)}})}var W,G,K,q,J,Y,X,Z,Q,$;t((()=>{_(),l(),de(),fe(),le(),he(),Ce(),A(),we(),W=a(),d(),G=`storybook/videopress`,K={title:`Packages/Premium Analytics/Widgets/VideoPress`,component:j,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`}},parameters:{docs:{description:{component:"Dashboard widget showing the site's most played VideoPress videos as a leaderboard, with internal video-detail links and optional period-over-period comparison. It is sourced from the Jetpack Stats `video-plays` module via `useStatsVideoPlays`; in Storybook the data is served by `registerReportMocks`."}}}},q={render:V,args:{withComparison:!1},decorators:[S,b]},J={render:V,args:{withComparison:!0},decorators:[S,b]},Y={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[S,b],beforeEach:()=>(u(`stats/video-plays`,`loading`),()=>u(`stats/video-plays`,null))},X={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[S,b],beforeEach:()=>(u(`stats/video-plays`,`error`),()=>u(`stats/video-plays`,null))},Z={render:()=>H(`last-365-days`),tags:[`!autodocs`],decorators:[S,b],beforeEach:()=>(u(`stats/video-plays`,`empty`),()=>u(`stats/video-plays`,null))},Q={render:e=>(0,W.jsx)(U,{...e}),args:{...ge,withComparison:!0},argTypes:{...ue,withComparison:{control:`boolean`}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
