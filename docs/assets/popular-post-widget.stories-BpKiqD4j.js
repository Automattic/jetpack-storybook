import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{C as o,t as s}from"./build-module-CR6EsQjA.js";import{g as c}from"./hooks-Z4m2bnkQ.js";import{f as l,t as u}from"./src-w7bX7ZHn.js";import{ft as ee,i as te,mt as ne,ot as re,qt as d,t as f}from"./src-BK45tVAX.js";import{M as p}from"./chart-tooltip-yE1gEYUz.js";import{t as m}from"./post-highlight-card-skeleton-CcS_hcsp.js";import{G as h,K as g,g as _}from"./report-metric-BqHnydhq.js";import{t as v}from"./widget-state-5nI0lhOP.js";import{C as y,D as b,E as ie,O as ae,S as oe,T as se,b as ce,k as x,t as le,w as S,x as C}from"./src-CXMSeTj9.js";import{n as ue,t as de}from"./register-stats-mocks-COEHV_eo.js";import{n as w,t as T}from"./force-stats-mock-state-CLkh0YFj.js";function fe(){let{preset:e,from:t,to:n,interval:r}=d(!1,k),i=(0,E.useMemo)(()=>({preset:e,from:t,to:n,interval:r}),[e,t,n,r]),a=re((0,E.useMemo)(()=>({from:t,to:n,interval:r,max:O}),[t,n,r]),{maxRows:1,postTypes:D}),o=a.comparisonRows?.rows[0],s=Number(o?.id??0)||0,c=ne(te(s)),l=ee({postId:s,fields:[`views`,`like_count`,`post`]}),u=l.data,f=u?.post?.ID,p=u&&(f===void 0||f===s)?u:void 0,m=s>0&&!p&&!l.isError,h=a.isLoading||s>0&&(c.isLoading||l.isLoading||m),g=a.isFetching||c.isFetching||l.isFetching,_=a.isError,v=()=>{a.refetch(),s>0&&(c.refetch(),l.refetch())},y=c.data??null;return{post:o?{id:s,title:y?.title||String(o.label??``),url:y?.url||o.link||``,date:y?.date||(typeof o.date==`string`?o.date:``),imageUrl:y?.imageUrl??``,imageAlt:y?.imageAlt??``,views:p?.views,likeCount:p?.like_count,commentCount:p?.post?.comment_count}:null,range:i,isLoading:h,isFetching:g,isError:_,error:a.error,refetch:v}}var E,D,O,k,pe=t((()=>{f(),u(),E=e(n(),1),D=[`post`],O=20,k=l}));function me(){let{post:e,range:t,isLoading:n,isFetching:i,isError:a,error:s,refetch:c}=fe(),l=e?[{key:`views`,label:r(`Views`,`jetpack-premium-analytics-pkg`),value:e.views},{key:`likes`,label:r(`Likes`,`jetpack-premium-analytics-pkg`),value:e.likeCount},{key:`comments`,label:r(`Comments`,`jetpack-premium-analytics-pkg`),value:e.commentCount}]:[];return(0,j.jsx)(v,{isLoading:n,isFetching:i,isError:a,isEmpty:!e,error:p(s,{retryDescription:r(`We couldn't load your most popular post. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}),empty:{icon:o,description:r(`No post views in the last 12 months.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,j.jsx)(m,{}),children:e&&(0,j.jsx)(_,{title:e.title,url:e.url,postId:e.id,detailSearch:t,date:e.date,imageUrl:e.imageUrl,imageAlt:e.imageAlt,metrics:l})})}function A({attributes:e={}}){return(0,j.jsx)(c,{attributes:e,children:(0,j.jsx)(me,{})})}var j,he=t((()=>{le(),i(),s(),pe(),j=a()})),M,ge=t((()=>{s(),M={icon:o,attributes:[],example:{attributes:{}}}})),N,P,F,I,L,R,z,_e=t((()=>{N=`jpa/popular-post`,P=`Most popular post in the last 12 months`,F=`Your most-viewed post of the last 12 months, with its all-time stats.`,I={content:`Your most viewed post of the last 12 months, with its all-time views, likes, and comments.`},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function B(){return(0,H.jsx)(A,{attributes:{reportParams:d()}})}function V(e){return(0,H.jsx)(se,{...e,widgetType:oe(z,M),renderModule:U,renderComponent:A,attributes:{reportParams:d(!0)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{f(),h(),de(),y(),w(),ie(),ae(),ce(),he(),ge(),_e(),H=a(),g(),ue(),U=`storybook/popular-post`,W={title:`Packages/Premium Analytics/Widgets/PopularPost`,component:A,tags:[`autodocs`],parameters:{docs:{description:{component:"The \"Most popular post in the last 12 months\" widget shows the site's most-viewed post of the last 12 months, with its publish date and its all-time views, likes, and comments. The window is the widget's own — the dashboard date range does not change which post wins — and it only picks the winner: every tile comes from the all-time `stats/post` response, so the three cannot measure different periods. There is no `WithComparison` story: the card shows no period-over-period delta, so the dashboard story below carries the comparison report params instead."}}}},G={render:B,decorators:[C,x]},K={render:B,tags:[`!autodocs`],decorators:[C,x],beforeEach:()=>(T(`stats/top-posts`,`loading`),()=>T(`stats/top-posts`,null))},q={render:B,tags:[`!autodocs`],decorators:[C,x],beforeEach:()=>(T(`stats/top-posts`,`error`),()=>T(`stats/top-posts`,null))},J={render:B,tags:[`!autodocs`],decorators:[C,x],beforeEach:()=>(T(`stats/top-posts`,`error-retryable`),()=>T(`stats/top-posts`,null))},Y={render:B,tags:[`!autodocs`],decorators:[C,x],beforeEach:()=>(T(`stats/top-posts`,`empty`),()=>T(`stats/top-posts`,null))},X={render:e=>(0,H.jsx)(V,{...e}),args:{...S,widgetWidth:2,widgetHeight:2},argTypes:{...b}},Z={render:e=>(0,H.jsx)(V,{...e}),args:{...S,widgetWidth:2,widgetHeight:1},argTypes:{...b}},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...S,widgetWidth:1,widgetHeight:1},argTypes:{...b}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
