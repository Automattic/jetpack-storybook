import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{M as i,Zt as a,mt as o,n as s,ut as c}from"./build-module-DmVuor49.js";import{W as l,t as u}from"./build-module-Oq2YRM6F.js";import{d as ee,t as te}from"./src-B3le4dug.js";import{Jt as ne,Tr as re,cr as d,yt as f}from"./chart-tooltip-BtX3Jjce.js";import{t as ie}from"./metric-tile-grid-DQv78W8I.js";import{F as p,M as m,N as h,z as g}from"./report-metric-CWPPaMwH.js";import{t as _}from"./widget-state-CE3oTs97.js";import{C as v,S as y,T as b,b as x,t as ae,w as S,x as C}from"./src-BAp3Kd5h.js";import{i as oe,t as w}from"./src-wxObwIP2.js";var T,E,D,O=e((()=>{T=`_root_1qhg5_2`,E=`_placeholder_1qhg5_11`,D={root:T,placeholder:E}})),k,A,j,M=e((()=>{n(),s(),w(),k=[{id:`total`,label:t(`Total subscribers`,`jetpack-premium-analytics`)},{id:`paid`,label:t(`Paid subscribers`,`jetpack-premium-analytics`)},{id:`free`,label:t(`Free subscribers`,`jetpack-premium-analytics`)},{id:`social`,label:t(`Social followers`,`jetpack-premium-analytics`)}],A=k.map(e=>e.id),j={name:`jpa/subscriber-highlights`,title:t(`Subscriber highlights`,`jetpack-premium-analytics`),help:{content:t(`A summary of your subscribers — total, paid, free, and social followers.`,`jetpack-premium-analytics`)},icon:c,attributes:[{id:`metrics`,label:t(`Metrics`,`jetpack-premium-analytics`),type:`array`,relevance:`high`,Edit:oe,elements:k.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:A}}}}));function N({metrics:e=A}){let{data:n,isLoading:r,isFetching:i,isError:a,refetch:o}=ne(),s=new Set(e),c=!!n&&Object.values(n).some(e=>e!==void 0),u=k.filter(({id:e})=>s.has(e)).map(({id:e,label:t})=>({key:e,label:t,icon:L[e].icon,value:L[e].count(n)}));return(0,F.jsx)(`div`,{className:D.root,children:(0,F.jsx)(_,{isLoading:r,isFetching:i,isError:a&&!c,isEmpty:!c,error:{description:t(`We couldn't load subscriber highlights. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:o}]},empty:{icon:ee,description:t(`No subscriber counts available yet.`,`jetpack-premium-analytics`)},children:u.length===0?(0,F.jsx)(l,{className:D.placeholder,children:t(`Select at least one metric to display.`,`jetpack-premium-analytics`)}):(0,F.jsx)(ie,{tiles:u,dataFormat:I})})})}function P({attributes:e={}}){return(0,F.jsx)(g,{attributes:e,children:(0,F.jsx)(N,{metrics:e.metrics})})}var F,I,L,R=e((()=>{f(),te(),ae(),n(),s(),u(),O(),M(),F=r(),I={type:`number`,options:{useMultipliers:!0,decimals:0}},L={total:{icon:c,count:e=>e?.total_subscribers??0},paid:{icon:o,count:e=>e?.paid_subscribers??0},free:{icon:a,count:e=>e?.email_subscribers??0},social:{icon:i,count:e=>e?.social_followers??0}}}));function z({metrics:e}){return(0,H.jsx)(P,{attributes:{reportParams:d(),metrics:e}})}function B(){re.removeQueries({queryKey:[`stats`,`subscribers-counts`]})}function V({metrics:e,...t}){return(0,H.jsx)(v,{...t,widgetType:W,renderModule:U,renderComponent:P,attributes:{reportParams:d(!0),metrics:e}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),S(),x(),m(),R(),M(),H=r(),h(),U=`storybook/subscriber-highlights`,W={name:j.name,title:j.title,icon:j.icon,attributes:j.attributes,example:j.example},G={metrics:{control:`check`,options:A}},K={metrics:A},q={title:`Packages/Premium Analytics/Widgets/SubscriberHighlights`,component:P,tags:[`autodocs`],argTypes:{...G},parameters:{docs:{description:{component:"The \"Subscriber highlights\" widget. Shows current subscriber totals — total, paid, free, and social followers — as a grid of metric tiles. Which tiles appear is controlled by the `metrics` attribute (`relevance: 'high'`), exposed inline in the widget header and in the settings drawer. Data comes from the designated `useStatsSubscribersCounts` hook; in Storybook it is served by `registerReportMocks()` (the `subscribers/counts` handler). The counts module has no comparison period, so the tiles show bare counts."}}}},J={render:z,args:{...K},decorators:[C]},Y={render:z,args:{...K},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(B(),p(`subscribers/counts`,`loading`),()=>{p(`subscribers/counts`,null),B()})},X={render:z,args:{...K},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(B(),p(`subscribers/counts`,`error`),()=>{p(`subscribers/counts`,null),B()})},Z={render:z,args:{...K},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(B(),p(`subscribers/counts`,`empty`),()=>{p(`subscribers/counts`,null),B()})},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...y,widgetWidth:1,widgetHeight:1,...K},argTypes:{...b,...G}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
