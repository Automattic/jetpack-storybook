import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Nn as i,n as a}from"./build-module-DmVuor49.js";import{c as o,t as s}from"./src-DN9VFS2M.js";import{dt as c,er as l}from"./chart-tooltip-Cp0t5VrC.js";import{M as u,P as d,R as f,j as p}from"./report-metric-CT0V0PjD.js";import{C as m,S as h,T as g,_,b as v,t as y,w as b,x}from"./src-BJoM39-b.js";function S({attributes:e={},setError:n}){return(0,C.jsx)(f,{attributes:e,setError:n,options:{from:`/`},children:(0,C.jsx)(_,{metricKey:`avg_items`,emptyStateText:t(`No orders in this period.`,`jetpack-premium-analytics`),errorText:t(`We couldn't load average items per order. Please try again in a moment.`,`jetpack-premium-analytics`)})})}var C,w=e((()=>{y(),n(),C=r()})),T,E=e((()=>{n(),a(),T={name:`jpa/average-items-per-order`,title:t(`Average items per order`,`jetpack-premium-analytics`),help:{content:t(`Show the average number of products per order over a set period of time.`,`jetpack-premium-analytics`)},icon:i}}));function D(e=!1,t=F){return{reportParams:l(e,t)}}function O({withComparison:e,preset:t}){let n=!!e,r=t??F;return!n&&r===F?`getDefaultQueryParams()`:n&&r===F?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function k(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<AverageItemsPerOrderRender
\tattributes={ {
\t\treportParams: ${O(e)},
\t} }
/>`}function A({withComparison:e,preset:t}){return(0,N.jsx)(S,{attributes:D(e,t)})}function j(e){return(0,N.jsx)(S,{attributes:D(!1,e)})}function M({withComparison:e,preset:t,...n}){return(0,N.jsx)(m,{...n,widgetType:T,renderModule:P,renderComponent:S,attributes:D(e,t)})}var N,P,F,I,L,R,z,B,V,H,U,W;e((()=>{c(),s(),b(),v(),p(),w(),E(),N=r(),u(),P=`storybook/average-items-per-order`,F=`last-30-days`,I=o,L={title:`Packages/Premium Analytics/Widgets/AverageItemsPerOrder`,component:S,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:I,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`The "Average items per order" widget. Fetches the orders report and displays the average number of items per order with optional period-over-period comparison and a sparkline.`}}}},R={render:A,args:{preset:F,withComparison:!1},decorators:[x],parameters:{docs:{source:{transform:(e,t)=>k(t.args)}}}},z={render:A,args:{preset:F,withComparison:!0},decorators:[x],parameters:{docs:{source:{transform:(e,t)=>k(t.args)}}}},B={render:()=>j(`last-90-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(d(`orders/by-date`,`loading`),()=>d(`orders/by-date`,null))},V={render:()=>j(`last-7-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(d(`orders/by-date`,`error`),()=>d(`orders/by-date`,null))},H={render:()=>j(`last-365-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(d(`orders/by-date`,`empty`),()=>d(`orders/by-date`,null))},U={render:e=>(0,N.jsx)(M,{...e}),args:{...h,preset:F,withComparison:!0},argTypes:{...g,preset:{control:`select`,options:I,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
