import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-2QZQpBH2.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{Tn as o,t as s}from"./build-module-2iv4IIRq.js";import{C as c,Zt as l,nt as u,t as d}from"./date-fns-D_SPQh_w.js";import{B as f,Et as p,H as m,K as h,L as g,R as _,U as ee,W as te,dt as ne,m as re,pt as ie}from"./hooks-BKiCUZkU.js";import{m as v,p as ae,t as oe,u as se}from"./src-CJGEmgc4.js";import{R as ce,r as le,tn as ue}from"./date-period-dropdown-D4R70JTy.js";import{a as de}from"./metric-sparkline-skeleton-Que2AUYm.js";import{t as fe}from"./monthly-heatmap-DGGIAHGN.js";import{c as y,i as pe,r as me}from"./register-report-mocks-BEpCi-EW.js";import{t as he}from"./widget-state-oY2LJGRS.js";import{t as b}from"./src-CNKIafZC.js";import{a as ge,c as _e,d as ve,i as ye,l as be,n as xe,o as Se,r as x,s as Ce,u as we}from"./with-widget-canvas-bvfwGRxT.js";function Te(e,t,n){let r=n&&S(e,n)?n.day:1,i=S(e,C(t))?t.getDate():new Date(e.year,e.month+1,0).getDate();return Math.max(i-r+1,1)}function Ee(e,t,n,r){let i=new Map;for(let{month:t,views:n}of e){let e=h(t);i.set(e,(i.get(e)??0)+n)}let a=[...i.entries()].filter(([,e])=>e>0);if(a.length===0)return[];let o=Math.min(...a.map(([e])=>e)),s=Math.max(h(C(n)),...a.map(([e])=>e)),c=Math.floor(o/12),l=Math.floor(s/12),u=r&&h(r)===o?r:void 0,d=[];for(let e=l;e>=c;e--){let r=0,a=0,c=Array.from({length:12},(c,l)=>{let d={year:e,month:l},f=h(d);if(f<o||f>s)return null;let p=i.get(f)??0,m=Te(d,n,u);return r+=p,a+=m,t===`average`?Math.round(p/m):p});d.push({year:e,months:c,total:t===`average`?Math.round(r/a):r})}return d}var S,C,De=t((()=>{b(),S=(e,t)=>e.year===t.year&&e.month===t.month,C=e=>({year:e.getFullYear(),month:e.getMonth()})}));function Oe(e){let t=c(e);return l(t)?{year:t.getFullYear(),month:t.getMonth()}:null}function ke(e){let t=u(ae(),E),{primary:n,isLoading:r,isFetching:i,isError:a,error:o,refetch:s}=ce((0,w.useMemo)(()=>({from:T,to:t,interval:`month`,period:`month`,stat_fields:`views`}),[t])),l=(0,w.useMemo)(()=>(n.data?.data??[]).flatMap(e=>{let t=Oe(e.time_interval);return t?[{month:t,views:Number(e.views??0)}]:[]}),[n.data]),d=(0,w.useMemo)(()=>l.find(({views:e})=>e>0)?.month,[l]),p=ce((0,w.useMemo)(()=>{let e=d?new Date(d.year,d.month,1):void 0,n=d?new Date(d.year,d.month+1,0):void 0,r=n?u(n,E):t;return{from:e?u(e,E):t,to:r<t?r:t,interval:`day`,period:`day`,stat_fields:`views`}},[d,t]),{enabled:!!d}),m=(0,w.useMemo)(()=>se((p.primary.data?.data??[]).find(e=>Number(e.views??0)>0)?.time_interval),[p.primary.data]),{rows:h,lifeStartsAt:g}=(0,w.useMemo)(()=>{let n=m&&{year:m.getFullYear(),month:m.getMonth(),day:m.getDate()},r=Ee(l,e,c(t),n);return{rows:r,lifeStartsAt:f(r,m,v())}},[l,e,t,m]),_=e===`average`&&!!d&&p.isLoading&&!p.primary.isFetched;return{rows:h,lifeStartsAt:g,isLoading:r||_,isFetching:i||p.isFetching,isError:a,error:o,refetch:s}}var w,T,E,Ae=t((()=>{le(),oe(),b(),d(),w=e(n(),1),De(),T=`2005-01-01`,E=`yyyy-MM-dd`}));function je({metric:e}){let{rows:t,lifeStartsAt:n,isLoading:i,isFetching:a,isError:s,error:c,refetch:l}=ke(e),u=ie(),d=v(),f=(0,O.useCallback)(({year:e,month:t})=>{let r={lifeStartsAt:n,timeZone:d},i=t===void 0?_(e,r):g({year:e,month:t},r);i?.from&&i.to&&u(A,{from:i.from,to:i.to})},[n,d,u]),h=s&&t.length===0;return(0,k.jsx)(he,{isLoading:i,isFetching:a,isError:h,isEmpty:t.length===0,error:h?p(c,{retryDescription:r(`We couldn't load your views. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:l}):null,empty:{icon:o,description:r(`No views yet.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,k.jsx)(de,{}),children:(0,k.jsx)(fe,{rows:t,...m(e),onSelect:f})})}function D({attributes:e={}}){return(0,k.jsx)(re,{attributes:e,children:(0,k.jsx)(je,{metric:te(e.metric)})})}var O,k,A,Me=t((()=>{oe(),ne(),b(),i(),s(),O=e(n(),1),Ae(),k=a(),A=`traffic`})),j,Ne=t((()=>{b(),s(),j={icon:o,attributes:[ee()],example:{attributes:{metric:`total`}}}})),M,N,P,F,I,L,R,Pe=t((()=>{M=`jpa/views-over-years`,N=`Views over years`,P=`Every month of views across the whole site, one row per year.`,F={content:`Every month of your site's views, shaded by how it compares to the rest, with each year's total beside it. Always the full history: the year above doesn't narrow it. Pick a month to read the Traffic tab over it. Daily average divides a month's views by its days: the first month starts on its first day with views, and the current month stops at today.`},I=`stats`,L=`framed`,R={name:M,title:N,description:P,help:F,category:I,presentation:L}}));function z({metric:e},t=!1){return{metric:e,reportParams:ue(t)}}function B(e){return(0,V.jsx)(D,{attributes:z(e)})}function Fe({metric:e,...t}){return(0,V.jsx)(Ce,{...t,widgetType:ye(R,j),renderModule:H,renderComponent:D,attributes:z({metric:e},!0)})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{le(),me(),_e(),ge(),we(),xe(),Me(),Ne(),Pe(),V=a(),pe(),H=`storybook/views-over-years`,U=`stats/visits`,W={control:`radio`,options:[`total`,`average`],description:"The `metric` attribute: the month's views, or its views per day."},G={title:`Packages/Premium Analytics/Widgets/ViewsOverYears`,component:D,tags:[`autodocs`],decorators:[ve],argTypes:{metric:W},parameters:{docs:{description:{component:"The \"Views over years\" widget: every month of the site's views, one row per year closed by a Totals column outside the colour scale, as total views or views per day. The `metric` attribute has `relevance: 'high'`, so the framed host renders its select in the header; the close-up stories set it as an arg. It always covers the site's whole history, whatever year the Insights tab shows, and picking a month opens the Traffic tab over that month."}}}},K={render:B,args:{metric:`total`},decorators:[x]},q={render:B,args:{metric:`average`},decorators:[x]},J={render:B,args:{metric:`total`},tags:[`!autodocs`],decorators:[x],beforeEach:()=>(y(U,`loading`),()=>y(U,null))},Y={render:B,args:{metric:`total`},tags:[`!autodocs`],decorators:[x],beforeEach:()=>(y(U,`error`),()=>y(U,null))},X={render:B,args:{metric:`total`},tags:[`!autodocs`],decorators:[x],beforeEach:()=>(y(U,`error-retryable`),()=>y(U,null))},Z={render:B,args:{metric:`total`},tags:[`!autodocs`],decorators:[x],beforeEach:()=>(y(U,`empty`),()=>y(U,null))},Q={render:e=>(0,V.jsx)(Fe,{...e}),args:{...Se,widgetWidth:3,widgetHeight:2,metric:`total`},argTypes:{...be,metric:W}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
