import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-ntpUVwMh.js";import{i as r,n as i,r as a,t as o}from"./blocks-CQA7X54h.js";import{t as s}from"./mdx-react-shim-CLOqNOei.js";import{Start as c,t as l}from"./glyph.stories-9SYK_ZNK.js";import{Animation as u,BrokenLine as d,ComparisonMulti as f,ComparisonSingle as p,CurveTypes as m,DateStringFormats as h,Default as g,ErrorStates as _,GradientCustomColors as v,GradientFilled as y,GradientTransparent as b,SingleSeries as x,SmartFormatting as S,WithCompositionLegend as C,WithDefaultHiddenSeries as w,WithPointerEvents as T,Zoomable as E,n as D,t as O}from"./index.stories-B53hTTy2.js";function k(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(i,{title:`JS Packages/Charts Library/Charts/Line Chart`,of:O}),`
...
`,(0,j.jsxs)(t.li,{children:[(0,j.jsx)(t.strong,{children:(0,j.jsx)(t.code,{children:`smoothing`})}),`: Catmull-Rom smoothing, on by default. Ignored when `,(0,j.jsx)(t.code,{children:`curveType`}),` is set`]}),`
...
`,(0,j.jsxs)(t.p,{children:[`The built-in tooltip names the bucket at its own granularity, down to the hour on
hourly data. A custom `,(0,j.jsx)(t.code,{children:`renderTooltip`}),` is handed the same classification as
`,(0,j.jsx)(t.code,{children:`bucketInfo`}),`, so it can label the bucket the way the chart's own axis does. See
`,(0,j.jsx)(t.a,{href:`?path=/docs/js-packages-charts-library-global-context--docs`,children:`Date Bucket Classification`}),`.`]}),`
`,(0,j.jsx)(a,{language:`jsx`,code:`<LineChart
	data={data}
	withTooltips={true}
...
/>`}),`
`,(0,j.jsxs)(t.p,{children:[`Tooltips render inside the chart's own wrapper, not in a `,(0,j.jsx)(t.code,{children:`document.body`}),` portal, so they stack with the page like any other element and a sticky or fixed header paints over them. `,(0,j.jsx)(t.code,{children:`detectBounds`}),` flips the box to the side of the anchor that overflows less, measured against both the wrapper and the nearest ancestor that clips its overflow (`,(0,j.jsx)(t.code,{children:`overflow: hidden`}),`, `,(0,j.jsx)(t.code,{children:`clip`}),`, `,(0,j.jsx)(t.code,{children:`auto`}),` or `,(0,j.jsx)(t.code,{children:`scroll`}),`), so it stays inside the chart whenever it fits there; then it clamps the box inside that ancestor, or inside the viewport when nothing clips. A box larger than the wrapper may reach past it into that ancestor, where siblings later in the DOM can paint over it. Only an ancestor smaller than the box itself can still cut it off.`]}),`
...
`,(0,j.jsx)(t.p,{children:`Line Charts integrate seamlessly with the chart theming system. The default theme has neutral styling, and is automatically applied to all charts unless a custom theme is provided.`}),`
...
`,(0,j.jsxs)(t.p,{children:[`Every other color works the same way — declare its catalog role. The closest declaration inside the provider tree wins, so scope the rule to one dashboard, or to `,(0,j.jsx)(t.code,{children:`.a8c-charts-scope`}),` to move every chart on the page:`]}),`
