import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DQ5lAs4a.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{N as i,t as a}from"./build-module-DMs68Vfd.js";import{En as o,On as s,Ts as c,ii as ee,n as l,oi as te,rl as ne,ua as re}from"./build-module-Bt8gOW8e.js";import{O as ie,S as u,d as ae,k as d,s as f,tn as p}from"./hooks-vVT9DHIc.js";import{R as oe,t as se}from"./build-module-BAze1CUO.js";import{t as ce}from"./metric-tile-grid-Bl_A01kS.js";import{i as m,n as h,t as g}from"./register-report-mocks-DsVqLJR9.js";import{t as _}from"./widget-state-DP8d8ymJ.js";import{S as v,b as y,t as b,x,y as S}from"./src-BnRzOHF6.js";var C,w,T,le=e((()=>{C=`_root_1bdlz_2`,w=`_content_1bdlz_14`,T={root:C,content:w}}));function ue(e,t){let n=Number(e[t]);return Number.isFinite(n)?n:0}function de(e,t){let n=Number(e[t]);return Number.isFinite(n)&&n!==0?n/100:null}function fe(e){return!!e&&M.some(t=>{let n=e[t.key];return n!=null&&Number.isFinite(Number(n))})}function pe(e,t){let n=[];for(let r of M){if(!r.views.includes(t))continue;let i=r.kind===`rate`?de(e,r.key):ue(e,r.key);r.hideWhenZero&&!i||n.push({key:r.key,icon:r.icon,label:r.label(),value:i,dataFormat:r.kind===`rate`?j:A})}return n}function E(e){let t=typeof e==`number`?e:Number.parseInt(e??``,10);return Number.isInteger(t)&&t>0?t:0}function D({metric:e}){let{reportParams:t}=ae(),n=E(t.post_id),r=n>0,a=d(n,`rate`,{enabled:r&&e===`opens`}),o=ie(n,`rate`,{enabled:r&&e===`clicks`}),s=e===`clicks`?o:a,c=s.data?.summary;return(0,k.jsx)(N,{metrics:(0,i.useMemo)(()=>fe(c)?pe(c,e):void 0,[c,e]),hasSelection:r,isLoading:s.isLoading,isFetching:s.isFetching,isError:s.isError,onRetry:s.refetch})}function O({attributes:e={}}){return(0,k.jsx)(f,{attributes:e,children:(0,k.jsx)(D,{metric:e.metric===`clicks`?`clicks`:`opens`})})}var k,A,j,M,N,P=e((()=>{u(),b(),a(),n(),l(),se(),le(),k=r(),A={type:`number`,options:{useMultipliers:!0,decimals:0}},j={type:`percentage`,options:{decimals:1,signDisplay:`never`}},M=[{key:`total_sends`,icon:o,label:()=>t(`Total emails sent`,`jetpack-premium-analytics`),kind:`count`,views:[`opens`]},{key:`unique_opens`,icon:te,label:()=>t(`Unique opens`,`jetpack-premium-analytics`),kind:`count`,views:[`opens`],hideWhenZero:!0},{key:`total_opens`,icon:s,label:()=>t(`Total opens`,`jetpack-premium-analytics`),kind:`count`,views:[`opens`,`clicks`]},{key:`opens_rate`,icon:ee,label:()=>t(`Open rate`,`jetpack-premium-analytics`),kind:`rate`,views:[`opens`]},{key:`total_clicks`,icon:re,label:()=>t(`Total clicks`,`jetpack-premium-analytics`),kind:`count`,views:[`clicks`]},{key:`clicks_rate`,icon:ne,label:()=>t(`Click rate`,`jetpack-premium-analytics`),kind:`rate`,views:[`clicks`]}],N=({metrics:e,hasSelection:n=!1,isLoading:r=!1,isFetching:i=!1,isError:a=!1,onRetry:o})=>(0,k.jsx)(oe,{className:T.root,children:(0,k.jsx)(`div`,{className:T.content,children:(0,k.jsx)(_,{isLoading:r,isFetching:i,isError:a,isEmpty:!e||e.length===0,error:{description:t(`We couldn't load this email's stats. Please try again in a moment.`,`jetpack-premium-analytics`),actions:o?[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:o}]:void 0},empty:{icon:c,description:t(n?`No stats are available for this email yet.`:`Select an email to see its stats.`,`jetpack-premium-analytics`)},children:(0,k.jsx)(ce,{tiles:e??[]})})})})})),F,I=e((()=>{n(),l(),F={name:`jpa/email-top-row`,title:t(`Email top row`,`jetpack-premium-analytics`),icon:c,help:{content:t(`Headline stats for a single email. The Opens view shows total sends, unique opens, total opens, and open rate; the Clicks view shows total opens, total clicks, and click rate. Rates are measured against total sends. Figures are all-time and are not affected by the dashboard date range.`,`jetpack-premium-analytics`)},attributes:[{id:`metric`,label:t(`View by`,`jetpack-premium-analytics`),type:`text`,elements:[{label:t(`Opens`,`jetpack-premium-analytics`),value:`opens`},{label:t(`Clicks`,`jetpack-premium-analytics`),value:`clicks`}],relevance:`high`}],example:{attributes:{metric:`opens`}}}}));function L({metric:e,withComparison:t},n=V){return(0,z.jsx)(O,{attributes:{metric:e,reportParams:{...p(t),post_id:n}}})}function R({metric:e,withComparison:t,...n}){return(0,z.jsx)(y,{...n,widgetType:F,renderModule:B,renderComponent:O,attributes:{metric:e,reportParams:{...p(t),post_id:V}}})}var z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{u(),x(),g(),P(),I(),z=r(),h(),B=`storybook/email-top-row`,V=2e3,H=`stats/opens/emails`,U=e=>(0,z.jsx)(`div`,{style:{width:`100%`,height:`300px`},children:(0,z.jsx)(e,{})}),W={title:`Packages/Premium Analytics/Widgets/EmailTopRow`,component:O,tags:[`autodocs`],argTypes:{metric:{control:`inline-radio`,options:[`opens`,`clicks`]},withComparison:{control:`boolean`}},parameters:{docs:{description:{component:'The "Email top row" widget. Shows a single email\'s all-time headline totals as a row of metric tiles, switching between the Opens view (total sends, unique opens, total opens, open rate) and the Clicks view (total opens, total clicks, click rate) via the `metric` attribute. The email is selected by the host through `reportParams.post_id`. Data comes from the per-post `stats/<opens|clicks>/emails/<postId>/rate` breakdown, which is all-time and returns no comparison rows, so the widget ignores the dashboard date range and never shows period-over-period deltas.'}}}},G={render:e=>L(e),args:{metric:`opens`,withComparison:!1},decorators:[U]},K={render:e=>L(e),args:{metric:`clicks`,withComparison:!1},decorators:[U]},q={render:e=>L(e),args:{metric:`opens`,withComparison:!0},decorators:[U]},J={render:e=>L(e,2001),tags:[`!autodocs`],args:{metric:`opens`,withComparison:!1},decorators:[U],beforeEach:()=>(m(H,`loading`),()=>m(H,null))},Y={render:e=>L(e,2002),tags:[`!autodocs`],args:{metric:`opens`,withComparison:!1},decorators:[U],beforeEach:()=>(m(H,`error`),()=>m(H,null))},X={render:e=>L(e,2003),tags:[`!autodocs`],args:{metric:`opens`,withComparison:!1},decorators:[U],beforeEach:()=>(m(H,`empty`),()=>m(H,null))},Z={render:({metric:e,withComparison:t})=>(0,z.jsx)(O,{attributes:{metric:e,reportParams:p(t)}}),args:{metric:`opens`,withComparison:!1},decorators:[U]},Q={render:e=>(0,z.jsx)(R,{...e}),args:{...S,metric:`opens`,withComparison:!0},argTypes:{...v,metric:{control:`inline-radio`,options:[`opens`,`clicks`]},withComparison:{control:`boolean`}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
