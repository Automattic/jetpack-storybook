import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-yGZutq_9.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Ac as ee,Gu as i,Nu as a,Ur as o,t as s}from"./build-module-zwSmKorH.js";import{bt as c}from"./build-module-CpMuGSvV.js";import{Zt as l,g as u,mt as te}from"./hooks-D9-5bKhf.js";import{t as ne}from"./src-CTwqGtHG.js";import{G as re,en as d,i as f}from"./date-filters-panel-DXxSsBcd.js";import"./constants-B1kGztHF.js";import{r as ie,t as ae}from"./leaderboard-skeleton-BS2d84lc.js";import{i as p,r as m,t as h}from"./register-report-mocks-Bek115LU.js";import{S as oe,b as se,j as ce}from"./report-metric-Cwl9tNr_.js";import{t as g}from"./widget-state-DoDeK2hZ.js";import{t as _}from"./src-DmKbijpS.js";import{a as v,c as y,d as b,i as x,l as S,n as C,o as le,r as w,s as ue,u as de}from"./with-widget-canvas-BjVB14N8.js";var T,E,D,O=e((()=>{T=`_root_19tfr_1`,E=`_content_19tfr_9`,D={root:T,content:E}}));function k(){let{rows:e,isLoading:n,isFetching:r,isError:a,error:o,refetch:s}=re({group:`authors`,max:10}),u=(0,i.useMemo)(()=>{let t=Math.max(...e.map(e=>e.value),0);return e.map(e=>({id:e.id,...ce({label:e.label,media:{kind:`avatar`,url:e.avatarUrl,name:e.label},action:e.link?{kind:`link`,href:e.link}:{kind:`static`}}),currentValue:e.value,currentShare:l(e.value,t)}))},[e]);return(0,j.jsxs)(c,{className:D.root,children:[(0,j.jsx)(`div`,{className:D.content,children:(0,j.jsx)(g,{isLoading:n,isFetching:r,isError:a,isEmpty:e.length===0,error:te(o,{retryDescription:t(`We couldn't load comment authors. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:s}),empty:{icon:ee,description:t(`No one has commented on your site yet.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,j.jsx)(ae,{rows:10}),children:(0,j.jsx)(ie,{data:u,withOverlayLabel:!0,showLegend:!1,dataFormat:M})})}),(0,j.jsx)(oe,{children:(0,j.jsx)(se,{report:`comments`,section:`authors`,ariaLabel:t(`See the comment authors report`,`jetpack-premium-analytics-pkg`)})})]})}function A({attributes:e={}}){return(0,j.jsx)(u,{attributes:e,children:(0,j.jsx)(k,{})})}var j,M,N=e((()=>{f(),_(),a(),n(),s(),ne(),O(),j=r(),M={type:`number`,options:{useMultipliers:!0,decimals:0}}})),P,F=e((()=>{s(),P={icon:o,attributes:[],example:{attributes:{}}}})),I,L,R,z,B,V,H,fe=e((()=>{I=`jpa/most-commented-authors`,L=`All-time most commented authors`,R=`The people who comment the most on your site.`,z={content:`The people who left the most comments on your site.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},B=`stats`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function U(){return(0,W.jsx)(A,{attributes:{reportParams:d()}})}function pe(e){return(0,W.jsx)(ue,{...e,widgetType:x(H,P),renderModule:G,renderComponent:A,attributes:{reportParams:d(!0)}})}var W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),y(),v(),de(),C(),m(),N(),F(),fe(),W=r(),p(),G=`storybook/most-commented-authors`,K={title:`Packages/Premium Analytics/Widgets/MostCommentedAuthors`,component:A,tags:[`autodocs`],parameters:{docs:{description:{component:`The "All-time most commented authors" widget. Ranks the people who comment most on the site by comment count, linking each guest commenter to the comment management screen filtered to them. One half of the Jetpack Stats Comments module; "All-time most commented posts" covers the other.`}}}},q={render:U,decorators:[w,b]},J={render:U,tags:[`!autodocs`],decorators:[w,b],beforeEach:h(`loading`)},Y={render:U,tags:[`!autodocs`],decorators:[w,b],beforeEach:h(`error`)},X={render:U,tags:[`!autodocs`],decorators:[w,b],beforeEach:h(`error-retryable`)},Z={render:U,tags:[`!autodocs`],decorators:[w,b],beforeEach:h(`empty`)},Q={render:e=>(0,W.jsx)(pe,{...e}),args:{...le},argTypes:{...S},decorators:[b]},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
