import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-yGZutq_9.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{fl as i,t as a}from"./build-module-zwSmKorH.js";import{ln as o,y as s}from"./wp-date-settings-6z62F9JS.js";import{rt as c,t as l}from"./src-CZluB9Zn.js";import{en as u,i as d}from"./date-filters-panel-CWAeuQqT.js";import{J as f,Z as p,q as m}from"./report-metric-D09KsmYD.js";import{t as h}from"./sales-by-device-widget-D5Z6Gb1d.js";import{C as g,D as _,E as ee,S as te,T as v,b as y,t as b,w as x,x as S}from"./src-ZL9zdFHx.js";function ne(){return(0,w.jsx)(h,{filter:o,emptyStateText:t(`No booking data in this period.`,`jetpack-premium-analytics-pkg`),errorText:t(`We couldn't load booking data by device. Please try again in a moment.`,`jetpack-premium-analytics-pkg`)})}function C({attributes:e={},setError:t}){return(0,w.jsx)(s,{attributes:e,setError:t,options:{from:`/`},children:(0,w.jsx)(ne,{})})}var w,T=e((()=>{b(),n(),w=r()})),E,D=e((()=>{a(),E={icon:i}})),O,k,A,j,M,N,P,F=e((()=>{O=`jpa/bookings-by-device`,k=`Bookings by device`,A=`See which devices your customers are using to make bookings in your store.`,j={content:`See which devices your customers are using to make bookings in your store.`},M=`bookings`,N=`framed`,P={name:O,title:k,description:A,help:j,category:M,presentation:N}}));function I(e=!1,t=W){return{reportParams:u(e,t)}}function L({withComparison:e,preset:t}){let n=!!e,r=t??W;return!n&&r===W?`getDefaultQueryParams()`:n&&r===W?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function R(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<BookingsByDeviceRender
\tattributes={ {
\t\treportParams: ${L(e)},
\t} }
/>`}function z({withComparison:e,preset:t}){return(0,H.jsx)(C,{attributes:I(e,t)})}function B(e){return(0,H.jsx)(C,{attributes:I(!1,e)})}function V({withComparison:e,preset:t,...n}){return(0,H.jsx)(v,{...n,widgetType:te(P,E),renderModule:U,renderComponent:C,attributes:I(e,t)})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{d(),l(),ee(),g(),y(),m(),T(),D(),F(),H=r(),f(),U=`storybook/bookings-by-device`,W=`last-30-days`,G=c,K={title:`Packages/Premium Analytics/Widgets/BookingsByDevice`,component:C,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:G,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`Dashboard widget that displays which devices customers use to make bookings.`}}}},q={render:z,args:{preset:W,withComparison:!1},decorators:[S],parameters:{docs:{source:{transform:(e,t)=>R(t.args)}}}},J={render:z,args:{preset:W,withComparison:!0},decorators:[S],parameters:{docs:{source:{transform:(e,t)=>R(t.args)}}}},Y={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(p(`order-attribution-by-product/device/summary`,`loading`),()=>p(`order-attribution-by-product/device/summary`,null))},X={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(p(`order-attribution-by-product/device/summary`,`error`),()=>p(`order-attribution-by-product/device/summary`,null))},Z={render:()=>B(`last-365-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(p(`order-attribution-by-product/device/summary`,`empty`),()=>p(`order-attribution-by-product/device/summary`,null))},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...x,preset:W,withComparison:!0},argTypes:{..._,preset:{control:`select`,options:G,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
