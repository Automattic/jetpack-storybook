import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-yGZutq_9.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{fl as ee,t as i}from"./build-module-zwSmKorH.js";import{g as a}from"./hooks-BZX5E4cH.js";import{n as o,r as s}from"./line-chart-C7ljkoZN.js";import{rt as c,t as l}from"./src-B477hvom.js";import{$t as u,r as d}from"./date-period-dropdown-B5gQ2ZJd.js";import{i as f,r as te,s as p}from"./register-report-mocks-CQAghYV8.js";import{_ as ne,t as m}from"./src-P7FTmKGL.js";import{a as h,c as g,i as _,l as v,n as y,o as b,r as x,s as re}from"./with-widget-canvas-Sci0Y6OC.js";function S({attributes:e={},setError:n}){return(0,C.jsx)(a,{attributes:e,setError:n,options:{from:`/`},children:(0,C.jsx)(ne,{metricKey:`total_sales`,seriesLabel:t(`Total sales`,`jetpack-premium-analytics-pkg`),emptyStateText:t(`No sales in this period.`,`jetpack-premium-analytics-pkg`),errorText:t(`We couldn't load total sales. Please try again in a moment.`,`jetpack-premium-analytics-pkg`)})})}var C,w=e((()=>{m(),n(),C=r()})),T,E=e((()=>{i(),T={icon:ee}})),D,O,k,A,j,M,N,P=e((()=>{D=`jpa/total-sales-over-time`,O=`Total sales over time`,k=`Track total sales including all orders and transactions.`,A={content:`Track total sales including all orders and transactions.`},j=`store`,M=`framed`,N={name:D,title:O,description:k,help:A,category:j,presentation:M}}));function F(e=!1,t=W){return{reportParams:u(e,t)}}function I({withComparison:e,preset:t}){let n=!!e,r=t??W;return!n&&r===W?`getDefaultQueryParams()`:n&&r===W?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function L(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
