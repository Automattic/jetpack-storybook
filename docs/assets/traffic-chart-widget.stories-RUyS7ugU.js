import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as i,t as a}from"./build-module-CbwHEf9N.js";import{n as o,w as s}from"./build-module-CDRs4YxF.js";import{$ as c,G as l,K as u,Y as d,rt as f}from"./report-metric-Sk5XBdwW.js";import{M as p,t as m}from"./src-BKLK-O8P.js";import{E as h,Gt as g,t as _}from"./src-DhfPwnvy.js";import{a as v,h as ee,o as te,p as ne}from"./chart-tooltip-yp4I9rk5.js";import{r as re,t as ie}from"./metric-tabs-chart-skeleton-DVPHOGUN.js";import{t as ae}from"./widget-state-BmTVykPR.js";import{C as oe,D as se,E as ce,S as le,T as ue,b as de,t as y,w as fe,x as b}from"./src-BUBDApXo.js";var pe,x,me=e((()=>{pe=`_root_sp1nf_1`,x={root:pe}})),S,C,w=e((()=>{n(),o(),y(),S=[{id:`views`,label:t(`Views`,`jetpack-premium-analytics-pkg`)},{id:`visitors`,label:t(`Visitors`,`jetpack-premium-analytics-pkg`)},{id:`comments`,label:t(`Comments`,`jetpack-premium-analytics-pkg`)},{id:`likes`,label:t(`Likes`,`jetpack-premium-analytics-pkg`)}],C={icon:s,attributes:[te([`auto`,`day`,`week`,`month`]),v()],example:{attributes:{granularity:`auto`,chartType:`line`}}}}));function T(e,t,n){return{...e,stat_fields:t,period:n}}function he(e,t){let n=(0,i.useMemo)(()=>T(e,`views,visitors`,t),[e,t]),r=(0,i.useMemo)(()=>T(e,`likes,comments`,t),[e,t]),a=h(n),o=h(r),s=a.primary.data,c=a.comparison.data,l=a.hasComparison,u=o.primary.data,d=o.comparison.data,f=o.hasComparison,p=(0,i.useMemo)(()=>S.map(e=>{let t=e.id===`views`||e.id===`visitors`;return ne({primary:t?s:u,comparison:t?c:d,hasComparison:t?l:f,field:e.id,label:e.label})}),[s,c,l,u,d,f]),{refetch:m}=a,{refetch:g}=o,_=(0,i.useCallback)(()=>{m(),g()},[m,g]),v=a.isError&&!s?.data?.length||o.isError&&!u?.data?.length;return{metrics:p,isLoading:a.isLoading||o.isLoading,isFetching:a.isFetching||o.isFetching,isError:v,refetch:_}}var ge=e((()=>{_(),a(),w(),y()}));function _e({granularity:e,chartType:n}){let{reportParams:r}=f(),{metrics:i,isLoading:a,isFetching:o,isError:s,refetch:c}=he(r,e===`auto`?ee(r.interval,k):e),l=t(`Traffic metric`,`jetpack-premium-analytics-pkg`);return(0,D.jsx)(`div`,{className:x.root,children:(0,D.jsx)(ae,{isLoading:a,isFetching:o,isError:s,isEmpty:i.every(e=>e.current.length===0),error:{description:t(`We couldn't load traffic data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:c}]},empty:{icon:p,description:t(`No traffic data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,D.jsx)(ie,{}),children:(0,D.jsx)(re,{metrics:i,dataFormat:O,chartType:n,groupLabel:l})})})}function E({attributes:e={},setError:t}){return(0,D.jsx)(c,{attributes:e,setError:t,options:{from:`/`},children:(0,D.jsx)(_e,{granularity:e.granularity??`auto`,chartType:e.chartType})})}var D,O,k,ve=e((()=>{y(),m(),n(),me(),ge(),D=r(),O={type:`number`,options:{useMultipliers:!0,decimals:0}},k=[`day`,`week`,`month`]})),A,j,M,N,P,F,I,ye=e((()=>{A=`jpa/traffic-chart`,j=`Traffic summary`,M=`Compare views, visitors, likes, and comments over the selected period, with the previous period overlaid for comparison.`,N={content:`A summary of your site's views, visitors, likes, and comments.`},P=`traffic`,F=`framed`,I={name:A,title:j,description:M,help:N,category:P,presentation:F}}));function L({withComparison:e,chartType:t}){return(0,z.jsx)(E,{attributes:{reportParams:g(e),chartType:t}})}function R(e){return(0,z.jsx)(E,{attributes:{reportParams:g(!1,e)}})}function be({withComparison:e,chartType:t,...n}){return(0,z.jsx)(ue,{...n,widgetType:V,renderModule:B,renderComponent:E,attributes:{reportParams:g(e),chartType:t}})}var z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{_(),ce(),oe(),de(),l(),ve(),w(),ye(),z=r(),u(),B=`storybook/traffic-chart`,V=le(I,C),H={chartType:{control:`inline-radio`,options:[`line`,`bar`]}},U={chartType:`line`},W={title:`Packages/Premium Analytics/Widgets/TrafficChart`,component:E,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`},...H},parameters:{docs:{description:{component:'Traffic over the selected period as selectable metric tabs — Views, Visitors, Likes, and Comments — over a comparative chart. The date range and comparison come from the dashboard controls; the "Group by" control is the `granularity` attribute and the "Chart type" control is the `chartType` attribute (both `relevance: \'high\'`), exposed by the widget host; which metric is plotted is the chart\'s own tab selection. When comparison is on, each tab shows its period-over-period delta and the previous period is overlaid — as a same-colour dashed line for `line`, or as the translucent shadow bar behind each bar for `bar`. Views/visitors and likes/comments are fetched as two parallel requests (mirroring Calypso) to keep latency down. Data comes from the `useStatsVisits` hook; in Storybook it is served by `registerReportMocks`.'}}}},G={render:L,args:{withComparison:!1,...U},decorators:[b]},K={render:L,args:{withComparison:!0,...U},decorators:[b]},q={render:L,args:{withComparison:!1,...U,chartType:`bar`},decorators:[b]},J={render:L,args:{withComparison:!0,...U,chartType:`bar`},decorators:[b]},Y={render:()=>R(`last-90-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(d(`stats/visits`,`loading`),()=>d(`stats/visits`,null))},X={render:()=>R(`last-7-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(d(`stats/visits`,`error`),()=>d(`stats/visits`,null))},Z={render:()=>R(`last-365-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(d(`stats/visits`,`empty`),()=>d(`stats/visits`,null))},Q={render:e=>(0,z.jsx)(be,{...e}),args:{...fe,withComparison:!0,...U},argTypes:{...se,withComparison:{control:`boolean`},...H}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
