import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-CpMj75l6.js";import{i as r,n as i,r as a,t as o}from"./blocks-D56Fm8eo.js";import{t as s}from"./mdx-react-shim-DknOGywi.js";import{Animation as c,CustomRenderProps as l,Default as u,EmptyData as d,FixedDimensions as f,HighConversion as p,Loading as m,NegativeChange as h,WithoutChangeIndicator as g,WithoutTooltips as _,n as v,t as y}from"./index.stories-Ca7UET-6.js";function b(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(i,{title:`JS Packages/Charts Library/Charts/Conversion Funnel Chart`,of:y}),`
...
`]}),`
`,(0,S.jsx)(a,{language:`tsx`,code:`import { ConversionFunnelChart } from '@automattic/charts';
...
`,(0,S.jsx)(o,{of:u}),`
`,(0,S.jsx)(a,{language:`tsx`,code:`<ConversionFunnelChart
	mainRate={10.3}
	changeIndicator="+2%"
...
`,(0,S.jsx)(t.p,{children:`Conversion Funnel Charts integrate seamlessly with the chart theming system. The default theme has neutral colors and styling, and is automatically applied to all charts unless a custom theme is provided.`}),`
`,(0,S.jsxs)(t.p,{children:[(0,S.jsx)(t.strong,{children:`Step colors come from the palette custom properties, not the theme object.`}),` Set as many of the five slots as you need; an unset slot is skipped, and charts generates accessible colors beyond whatever you set:`]}),`
`,(0,S.jsx)(a,{language:`css`,code:`.a8c-charts-scope {
	--a8c-charts-color-series-1: #FF6B6B;
	--a8c-charts-color-series-2: #4ECDC4;
	--a8c-charts-color-series-3: #45B7D1;
}`}),`
`,(0,S.jsxs)(t.p,{children:[`Every other color works the same way — declare its catalog role. The closest declaration inside the provider tree wins, so scope the rule to one dashboard, or to `,(0,S.jsx)(t.code,{children:`.a8c-charts-scope`}),` to move every chart on the page:`]}),`
`,(0,S.jsx)(a,{language:`css`,code:`.my-dashboard {
	/* The plate behind each step: */
	--a8c-charts-color-surface-secondary: #f0f0f0;
	/* The step-to-step change figures: */
...
`,(0,S.jsx)(o,{of:f}),`
`,(0,S.jsx)(a,{language:`tsx`,code:`{/* Fixed height */}
<ConversionFunnelChart
	mainRate={10.3}
	changeIndicator="+2%"
	steps={funnelData}
...
`,(0,S.jsx)(a,{language:`tsx`,code:`const ecommerceFunnel = [
...
`,(0,S.jsx)(a,{language:`tsx`,code:`const saasFunnel = [
