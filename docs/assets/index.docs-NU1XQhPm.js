import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-Bl-wt6oH.js";import{i as r,n as i,r as a,t as o}from"./blocks-DZC1wdyY.js";import{t as s}from"./mdx-react-shim-D91qv4VJ.js";import{Start as c,t as l}from"./glyph.stories-sXL4qKPx.js";import{Animation as u,BrokenLine as d,ComparisonMulti as f,ComparisonSingle as p,CurveTypes as m,DateStringFormats as h,Default as g,ErrorStates as _,GradientCustomColors as v,GradientFilled as y,GradientTransparent as b,SingleSeries as x,SmartFormatting as S,WithCompositionLegend as C,WithDefaultHiddenSeries as w,WithPointerEvents as T,Zoomable as E,n as D,t as O}from"./index.stories-BRkKLhz7.js";function k(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(i,{title:`JS Packages/Charts Library/Charts/Line Chart`,of:O}),`
...
`,(0,j.jsx)(a,{language:`jsx`,code:`<LineChart
	...
	zoomable={true}
/>`}),`
`,(0,j.jsx)(t.p,{children:`Zoom behaviour:`}),`
`,(0,j.jsxs)(t.ul,{children:[`
...
`,(0,j.jsxs)(t.p,{children:[`Use `,(0,j.jsx)(t.code,{children:`defaultHiddenSeries`}),` to hide selected series initially while keeping them available through an interactive legend. The first defined list is used; later values for the same `,(0,j.jsx)(t.code,{children:`chartId`}),` are ignored. User changes persist until the chart remounts or its ID changes.`]}),`
`,(0,j.jsx)(o,{of:w}),`
`,(0,j.jsx)(t.h2,{id:`theming-integration`,children:`Theming Integration`}),`
`,(0,j.jsxs)(t.p,{children:[`Line Charts integrate seamlessly with the chart theming system. The default theme has neutral colors and styling, and is automatically applied to all charts unless a custom theme is provided. A custom theme can be provided by wrapping your chart in `,(0,j.jsx)(t.code,{children:`GlobalChartsProvider`}),` and passing a custom theme object with the properties you want to override to the `,(0,j.jsx)(t.code,{children:`theme`}),` prop:`]}),`
