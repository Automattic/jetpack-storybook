import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{n as i,o as a}from"./build-module-DmVuor49.js";import{H as o,J as s,Q as ee,V as c,W as l}from"./report-metric-yaX04v1a.js";import{R as te,t as ne,u as re}from"./build-module-CKtN81-S.js";import{Et as ie,kr as ae,ur as u,xt as d}from"./chart-tooltip-DMwJdbCr.js";import{t as oe}from"./chart-empty-state-BGfldJYo.js";import{t as f}from"./widget-state-C11sRIqb.js";import{r as p}from"./src-nsbfeGQP.js";import{C as se,D as ce,E as m,S as le,T as h,b as g,t as _,w as v,x as y}from"./src-eORpN2M4.js";var b,x,S,C,w,T,E=e((()=>{b=`_root_p2q2t_1`,x=`_content_p2q2t_11`,S=`_list_p2q2t_24`,C=`_item_p2q2t_32`,w=`_link_p2q2t_41`,T={root:b,content:x,list:S,item:C,link:w}}));function D({pages:e}){return(0,k.jsx)(`ul`,{className:T.list,children:e.map((e,t)=>{let n=p(e.link);return(0,k.jsx)(`li`,{className:T.item,children:n?(0,k.jsx)(re,{className:T.link,href:n,variant:`unstyled`,openInNewTab:!0,title:e.label,children:e.label}):(0,k.jsx)(`span`,{className:T.link,title:e.label,children:e.label})},`${t}-${e.link}`)})})}function ue(){let{reportParams:e}=ee(),n=ae(e.post_id),{data:r,isLoading:i,isFetching:o,isError:s,refetch:c}=ie(n),l;if(n<=0)l=(0,k.jsx)(oe,{icon:a,text:t(`Select a video to see where it is embedded across your site.`,`jetpack-premium-analytics-pkg`)});else{let e=r?.pages??[];l=(0,k.jsx)(f,{isLoading:i,isFetching:o,isError:e.length===0&&s,isEmpty:e.length===0,error:{description:t(`We couldn't load video embeds. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:()=>void c()}]},empty:{icon:a,description:t(`This video has not been embedded on any pages yet.`,`jetpack-premium-analytics-pkg`)},children:(0,k.jsx)(D,{pages:e})})}return(0,k.jsx)(te,{className:T.root,children:(0,k.jsx)(`div`,{className:T.content,children:l})})}function O({attributes:e={}}){return(0,k.jsx)(s,{attributes:e,children:(0,k.jsx)(ue,{})})}var k,de=e((()=>{d(),_(),n(),i(),ne(),E(),k=r()})),A,fe=e((()=>{i(),A={icon:a}})),j,M,N,P,F,I,L,R=e((()=>{j=`jpa/video-detail-embeds`,M=`Video embeds`,N=`Pages where the selected video is embedded, sourced from Jetpack Stats.`,P={content:`Lists every page on your site where the selected video is embedded, so you can see where it is being watched.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},F=`stats`,I=`framed`,L={name:j,title:M,description:N,help:P,category:F,presentation:I}}));function z(e,t=!1){return{...u(t,e),post_id:G}}function B(){return(0,H.jsx)(O,{attributes:{reportParams:z()}})}function V(e){return(0,H.jsx)(O,{attributes:{reportParams:z(e)}})}function pe(e){return(0,H.jsx)(h,{...e,widgetType:le(L,A),renderModule:U,renderComponent:O,attributes:{reportParams:z(void 0,!0)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{d(),c(),m(),se(),g(),de(),fe(),R(),H=r(),o(),U=`storybook/video-detail-embeds`,W=`stats/video/`,G=105,K={title:`Packages/Premium Analytics/Widgets/VideoDetailEmbeds`,component:O,tags:[`autodocs`],parameters:{docs:{description:{component:"Dashboard widget listing the pages where a single video is embedded, sourced from the Jetpack Stats `stats/video/%d` module via `useStatsSingleVideo`. The widget is scoped to one video through the host-composed `reportParams.post_id`; without one it prompts to select a video. In Storybook the data is served by `registerReportMocks`."}}}},q={render:B,decorators:[y]},J={render:()=>(0,H.jsx)(O,{attributes:{reportParams:u(!1)}}),decorators:[y]},Y={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(l(W,`loading`),()=>l(W,null))},X={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(l(W,`error`),()=>l(W,null))},Z={render:()=>V(`last-365-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(l(W,`empty`),()=>l(W,null))},Q={render:e=>(0,H.jsx)(pe,{...e}),args:{...v},argTypes:{...ce}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
