import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{$i as r,Dl as i,Hf as a,If as o,Jm as s,Lh as c,Qm as l,Vn as u,Xm as d,Ym as f,Zm as p,br as m,ds as h,kt as g,nf as _,t as v,yd as y}from"./iframe-vdNUgRdq.js";var b,x,S,C,w,T,E=e((()=>{b=`_label_13cbv_1`,x=`_disabled_13cbv_22`,S=`_large_13cbv_27`,C=`_input_13cbv_7`,w=`_loader_13cbv_64`,T={label:b,"input-wrapper":`_input-wrapper_13cbv_7`,disabled:x,large:S,"is-textarea":`_is-textarea_13cbv_31`,input:C,"with-icon":`_with-icon_13cbv_50`,"icon-wrapper":`_icon-wrapper_13cbv_53`,"clear-icon":`_clear-icon_13cbv_61`,loader:w}})),D,O,k,A,j,M=e((()=>{v(),m(),o(),p(),h(),d(),D=t(c()),E(),O=s(),k=({className:e,disabled:t=!1,loading:n=!1,icon:i=null,endAdornment:a=null,onChange:o,onEnter:s,size:c=`small`,...l})=>{let u=(0,D.useCallback)(e=>{o?.(e.currentTarget.value)},[o]),d=(0,D.useCallback)(e=>{s!=null&&[`Enter`,`NumpadEnter`].includes(e.code)&&s(e.currentTarget.value)},[s]),p={className:f(T.input,{[T[`with-icon`]]:i!=null}),onChange:u,onKeyUp:d,disabled:t,"aria-disabled":t},m=l?.type===`textarea`;return(0,O.jsx)(`div`,{className:f(e,T[`input-wrapper`],{[T.disabled]:t,[T.large]:c===`large`,[T[`is-textarea`]]:m}),children:m?(0,O.jsx)(`textarea`,{...l,...p}):(0,O.jsxs)(O.Fragment,{children:[n||i?(0,O.jsx)(`div`,{className:f(T[`icon-wrapper`],{[T.loader]:n}),children:n?(0,O.jsx)(r,{}):i}):null,(0,O.jsx)(`input`,{...l,...p,value:l.value}),a]})})},A=({name:e,label:t,className:n,size:r=`small`,...i})=>t?(0,O.jsxs)(`div`,{className:n,children:[(0,O.jsx)(u,{component:`label`,variant:r===`small`?`body-small`:`body`,htmlFor:e,mb:1,className:T.label,children:t}),(0,O.jsx)(k,{name:e,size:r,...i})]}):(0,O.jsx)(k,{className:n,size:r,...i}),j=({placeholder:e=l(`Search your library`,`jetpack-videopress-pkg`),onSearch:t,wait:n=500,...r})=>{let i=a(t,n),o=(0,D.useCallback)(e=>{r.onEnter?.(e),t(e)},[r.onEnter,t]),s=(0,D.useCallback)(e=>{r.onChange?.(e),i(e)},[r.onChange]),c=(0,D.useCallback)(()=>{r.onChange?.(``),t(``)},[r.onChange]);return(0,O.jsx)(A,{...r,icon:(0,O.jsx)(g,{size:24}),placeholder:e,type:`text`,onEnter:o,onChange:s,endAdornment:(0,O.jsx)(O.Fragment,{children:!!r.value&&(0,O.jsx)(`div`,{className:f(T[`icon-wrapper`]),children:(0,O.jsx)(_,{icon:y,onClick:c,className:f(T[`clear-icon`])})})})})}})),N=n({Default:()=>V,Search:()=>K,TextArea:()=>W,WithIcon:()=>H,WithLabel:()=>U,__namedExportsOrder:()=>q,default:()=>L}),P,F,I,L,R,z,B,V,H,U,W,G,K,q,J=e((()=>{h(),P=t(c()),M(),F=s(),{action:I}=__STORYBOOK_MODULE_ACTIONS__,L={title:`Packages/VideoPress/Input`,component:A,argTypes:{size:{options:[`small`,`large`],control:{type:`radio`}},type:{options:[`text`,`textarea`,`number`,`url`,`email`,`password`,`tel`,`search`],control:{type:`select`}}}},R=e=>{I(`onEnter`)(e)},z={placeholder:`Placeholder text`,disabled:!1,loading:!1,size:`small`,type:`text`,label:``},B=e=>{let[t,n]=(0,P.useState)(``),r=e=>{n(e)};return(0,F.jsx)(A,{...e,value:t,onChange:r,onEnter:R})},V=B.bind({}),V.args=z,H=B.bind({}),H.args={...z,icon:(0,F.jsx)(_,{icon:i,size:24})},U=B.bind({}),U.args={...z,label:`My Label`},W=B.bind({}),W.args={...z,type:`textarea`},G=e=>{let[t,n]=(0,P.useState)(``),r=e=>{n(e),I(`onChange`)(e)};return(0,F.jsx)(j,{...e,value:t,onChange:r,onEnter:R})},K=G.bind({}),K.args={disabled:!1,loading:!1,onEnter:I(`onEnter`),onChange:I(`onChange`),onSearch:I(`onSearch`),wait:500},V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`args => {
