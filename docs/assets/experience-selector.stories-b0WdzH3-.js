import{n as e}from"./chunk-zsgVPwQN.js";import{Dc as t,Ec as n,Sc as r,Tc as i,aa as a,fc as o,ns as s,ov as c,rv as l,sv as u}from"./iframe-CSHIvfSs.js";import{c as d,i as f,l as p,n as m,o as h,r as g,s as _,t as v}from"./experience-option-Dv5o2Bmz.js";var y=e((()=>{}));function b(){let{isUpdating:e,supportsOnlyClassicSearch:t,isWpcom:n,blockOverlayEnabled:i}=r(e=>({isUpdating:e(_).isUpdatingJetpackSettings(),supportsOnlyClassicSearch:e(_).supportsOnlyClassicSearch(),isWpcom:e(_).isWpcom(),blockOverlayEnabled:e(_).isBlockOverlayEnabled()}),[]),a=f.filter(e=>!(e===g.OFF&&n||e===g.OVERLAY_BLOCKS&&!i)),o=n=>e||t&&(n===g.EMBEDDED||n===g.OVERLAY||n===g.OVERLAY_BLOCKS);return(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`h2`,{id:`jp-search-experience-selector-heading`,className:`jp-search-experience-selector__heading`,children:u(`Select a search experience for your visitors`,`jetpack-search-pkg`)}),(0,x.jsx)(`div`,{className:`jp-search-experience-selector`,children:(0,x.jsx)(`fieldset`,{className:`jp-search-experience-selector__fieldset`,"aria-labelledby":`jp-search-experience-selector-heading`,children:(0,x.jsx)(s,{columns:[1,2],gap:6,children:a.map(e=>(0,x.jsx)(v,{experience:e,disabled:o(e)},e))})})})]})}var x,S=e((()=>{a(),o(),c(),d(),h(),m(),y(),x=l(),b.__docgenInfo={description:`Top-level dashboard control: a fieldset of cards. Inactive cards behave
