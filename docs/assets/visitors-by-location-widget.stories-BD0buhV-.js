import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{Ot as n,n as r}from"./build-module-DmVuor49.js";import{c as i,t as a}from"./src-DN9VFS2M.js";import{cr as o,xr as s,yt as c}from"./chart-tooltip-IIg8-AHc.js";import{I as l,L as u,U as d,z as f}from"./report-metric-DRXf-DAE.js";import{C as p,D as m,E as h,S as g,T as _,b as v,t as y,w as b,y as x}from"./src-CuVZPnoK.js";import{t as S}from"./visitors-by-location-widget-D4a73FwH.js";function C({attributes:e={},setError:t}){return(0,w.jsx)(d,{attributes:e,setError:t,options:{from:`/`},children:(0,w.jsx)(S,{})})}var w,ee=e((()=>{y(),w=t()})),T,E=e((()=>{r(),T={icon:n}})),D,O,k,A,j,M,N,P=e((()=>{D=`jpa/visitors-by-location`,O=`Visitors by location`,k=`See where your store visitors are located geographically.`,A={content:`See where your store visitors are located geographically.`},j=`visitors`,M=`framed`,N={name:D,title:O,description:k,help:A,category:j,presentation:M}}));function F(e=!1,t=U){return{reportParams:o(e,t)}}function I({withComparison:e,preset:t}){let n=!!e,r=t??U;return!n&&r===U?`getDefaultQueryParams()`:n&&r===U?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function L(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
