import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n,u as r}from"./build-module-2QZQpBH2.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{A as a,t as o}from"./build-module-DrryaqBL.js";import{Ot as s,n as c}from"./build-module-DoJYX5DX.js";import{A as ee,E as te,G as l,S as u,W as d,Z as f,tt as ne,w as p}from"./report-metric-BSNNRPgL.js";import{t as re}from"./geo-chart-DgJu_8SM.js";import{B as ie,t as m}from"./src-9LSLqTC1.js";import{S as ae,t as oe}from"./src-CtuUAdXm.js";import{r as se}from"./hooks-Bb776u8J.js";import{J as ce,O as le,X as ue,ln as h,q as g,ur as _,xt as v}from"./chart-tooltip-BRZ2PClR.js";import{t as de}from"./leaderboard-chart-DhGcDyhH.js";import{C as fe,D as y,E as pe,O as b,S as x,T as S,b as C,k as w,t as T,w as E,x as D}from"./src-BE9SVcov.js";import{t as me}from"./widget-state-CFIUT-OU.js";import{n as he,t as O}from"./src-B9TbHIqV.js";import{n as k,t as A}from"./register-stats-mocks-D7-EkRu0.js";import{n as j,t as M}from"./force-stats-mock-state-DUWncukU.js";var N,P,F,I,L,R,ge,_e,ve,z,ye=e((()=>{N=`_root_erick_1`,P=`_backLink_erick_9`,F=`_content_erick_17`,I=`_bodyHeader_erick_25`,L=`_stateArea_erick_32`,R=`_chartArea_erick_38`,ge=`_leaderboardPanel_erick_48`,_e=`_leaderboard_erick_48`,ve=`_geoChart_erick_64`,z={root:N,backLink:P,content:F,bodyHeader:I,stateArea:L,chartArea:R,leaderboardPanel:ge,leaderboard:_e,geoChart:ve}}));function be(e){if(!e.countryCode)return null;let t=typeof e.label==`string`?e.label:String(e.label),n=e.countryFull??e.countryCode;return{key:`${e.countryCode}:${t}`,label:t,countryCode:e.countryCode,countryFull:n,value:e.views,previousValue:e.previousViews,region:e.region??``}}function xe({reportParams:e,max:t,geoMode:n=`country`,countryFilter:r}){let{primary:i,comparison:a,comparisonRows:o,hasComparison:s,isLoading:c,isFetching:ee,hasData:te,isError:l,refetch:u}=h({...e,geoMode:n,max:t,...r?{filter_by_country:r}:{}},{maxRows:t}),d=i.isPlaceholderData||a.isPlaceholderData,f=(o?.rows??[]).map(be).filter(e=>e!==null);return{data:f,hasComparison:s,isLoading:c,isFetching:ee,hasData:te,isError:f.length===0&&l,isPlaceholderData:d,refetch:u}}var Se=e((()=>{v()}));function Ce(e){return e.toUpperCase()===`TW`?`Taiwan`:e.toUpperCase()}function we({max:e,geoGranularity:n}){let{reportParams:i}=ne(),[o,s]=(0,a.useState)(()=>new Set(H)),{drillDownItem:c,drillDown:l,resetDrillDown:u}=se();(0,a.useEffect)(()=>{n===`city`&&u()},[u,n]);let d=n===`country`?c:void 0,f=n===`country`&&d?`region`:n,{data:p,hasComparison:m,isLoading:oe,isFetching:h,isError:_,isPlaceholderData:v,refetch:fe}=xe({reportParams:i,max:e,geoMode:f,countryFilter:f===`region`?d?.code:void 0}),[y,pe]=(0,a.useState)({geoMode:f,selectedCountry:d});(0,a.useEffect)(()=>{v||pe({geoMode:f,selectedCountry:d})},[d,f,v]);let b=v?y.geoMode:f,x=v?y.selectedCountry:d,S=x?.code.toUpperCase(),C=b===`region`&&!!S&&!o.has(S),w=b===`region`&&!!x&&!C,T=w?x:void 0,E=b===`city`,D=(0,a.useMemo)(()=>{let e=new Map;return E?(p.forEach(t=>{let n=t.countryCode.toUpperCase(),r=e.get(n);e.set(n,{countryFull:t.countryFull,value:(r?.value??0)+t.value})}),Array.from(e.entries())):[]},[p,E]),he=(0,a.useCallback)(e=>{let t=`${e.message??``} ${e.detailedMessage??``}`,n=!!S&&C,r=!!S&&H.has(S);!n&&!r&&!t.includes(Te)||(e.id&&typeof window<`u`&&window.google?.visualization?.errors?.removeError?.(e.id),n&&(H.add(S),s(e=>{if(e.has(S))return e;let t=new Set(e);return t.add(S),t})))},[S,C]),O=(0,a.useMemo)(()=>{let e=[t(b===`region`&&!w?`Location`:`Country`,`jetpack-premium-analytics-pkg`),t(`Views`,`jetpack-premium-analytics-pkg`)];if(T){let t=T.code.toUpperCase(),n=p.filter(e=>e.countryCode.toUpperCase()===t).reduce((e,t)=>e+t.value,0);return[e,[{v:Ce(t),f:T.name},n]]}return E?[e,...D.map(([e,t])=>[{v:Ce(e),f:t.countryFull},t.value])]:[e,...p.map(e=>[e.label,e.value])]},[D,p,T,b,E,w]),k=(0,a.useMemo)(()=>{let e=ce(p.map(e=>e.value),m?p.map(e=>e.previousValue):[]);return p.map(n=>{let i=le(n.countryCode),a=n.previousValue,o=n.countryCode;return{id:n.key,...ee({label:n.label,media:{kind:`flag`,url:i??void 0,country:n.countryFull},action:b===`country`&&o?{kind:`drillDown`,onClick:()=>l({code:o,name:n.countryFull}),ariaLabel:r(t(`View regions in %s`,`jetpack-premium-analytics-pkg`),n.countryFull)}:{kind:`static`}}),currentValue:n.value,previousValue:a,currentShare:g(n.value,e),previousShare:m&&a!==void 0?g(a,e):void 0,delta:m&&a!==void 0?ue(n.value,a):void 0}})},[p,b,m,l]),A=x?(0,V.jsx)(te,{label:t(`All Locations`,`jetpack-premium-analytics-pkg`),ariaLabel:t(`View all locations`,`jetpack-premium-analytics-pkg`),onClick:u,className:z.backLink}):null,j=A?(0,V.jsx)(ie,{direction:`row`,align:`center`,className:z.bodyHeader,children:A}):null;return(0,V.jsxs)(`div`,{className:z.content,children:[j,(0,V.jsx)(`div`,{className:z.stateArea,children:(0,V.jsx)(me,{isLoading:oe,isFetching:h,isError:_,isEmpty:p.length===0,error:{description:t(`We couldn't load location data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:fe}]},empty:{icon:ae,description:t(`No location data in this period.`,`jetpack-premium-analytics-pkg`)},children:(0,V.jsxs)(`div`,{className:z.chartArea,children:[(0,V.jsx)(`div`,{className:z.leaderboardPanel,children:(0,V.jsx)(de,{data:k,withOverlayLabel:!0,withComparison:m,showLegend:!1,dataFormat:{type:`number`,options:{useMultipliers:!0,decimals:0}},className:z.leaderboard})}),(0,V.jsx)(`div`,{className:z.geoChart,children:(0,V.jsx)(re,{data:O,resizeDebounceTime:100,region:C?x?.code??`world`:`world`,resolution:C?`provinces`:`countries`,onError:he})})]})})})]})}function B({attributes:e={}}){let t=e?.max??10,n=e?.geoGranularity??`country`;return(0,V.jsx)(f,{attributes:e,children:(0,V.jsxs)(`div`,{className:z.root,children:[(0,V.jsx)(we,{max:t,geoGranularity:n}),(0,V.jsx)(p,{children:(0,V.jsx)(u,{report:`locations`,section:n===`city`?`cities`:`countries`})})]})})}var V,Te,H,Ee=e((()=>{T(),oe(),o(),n(),m(),ye(),Se(),V=i(),Te=`Requested map does not exist`,H=new Set})),De,Oe=e((()=>{n(),c(),O(),De={icon:s,attributes:[{id:`max`,label:t(`Number of results`,`jetpack-premium-analytics-pkg`),type:`integer`},{id:`geoGranularity`,label:t(`View by`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:he,elements:[{label:t(`Countries`,`jetpack-premium-analytics-pkg`),value:`country`},{label:t(`Cities`,`jetpack-premium-analytics-pkg`),value:`city`}],relevance:`high`}],example:{attributes:{max:10,geoGranularity:`country`}}}})),ke,Ae,je,Me,Ne,Pe,Fe,Ie=e((()=>{ke=`jpa/locations`,Ae=`Top locations`,je=`Where your visitors are viewing from — by country, region, or city.`,Me={content:`The countries, regions, and cities where your visitors came from, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},Ne=`stats`,Pe=`framed`,Fe={name:ke,title:Ae,description:je,help:Me,category:Ne,presentation:Pe}}));function Le({withComparison:e,geoGranularity:t}){return{geoGranularity:t,max:10,reportParams:_(e)}}function U(e){return(0,G.jsx)(B,{attributes:Le(e)})}function W(e){return(0,G.jsx)(B,{attributes:{geoGranularity:`country`,max:10,reportParams:_(!1,e)}})}function Re(e){return(0,G.jsx)(B,{...e})}function ze({withComparison:e,geoGranularity:t,...n}){return(0,G.jsx)(S,{...n,widgetType:Ve,renderModule:Be,renderComponent:Re,attributes:Le({withComparison:e,geoGranularity:t})})}var G,Be,Ve,K,q,J,Y,X,Z,Q,$,He;e((()=>{v(),pe(),fe(),b(),C(),d(),A(),j(),Ee(),Oe(),Ie(),G=i(),l(),k(),Be=`storybook/locations`,Ve=x(Fe,De),K={title:`Packages/Premium Analytics/Widgets/Locations`,component:B,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},geoGranularity:{control:`radio`,options:[`country`,`city`],description:`The "View by" toolbar attribute rendered by the widget host.`}},parameters:{docs:{description:{component:"The \"Locations\" widget. Shows visitor views by country or city, with country drill-down into regions, using the global dashboard date range. The Countries/Cities view is the `geoGranularity` attribute (`relevance: 'high'`), exposed as a control by the widget host."}}}},q={render:U,args:{withComparison:!1,geoGranularity:`country`},decorators:[D,w]},J={render:U,args:{withComparison:!0,geoGranularity:`country`},decorators:[D,w]},Y={render:U,args:{withComparison:!1,geoGranularity:`city`},decorators:[D,w]},X={render:()=>W(`last-90-days`),tags:[`!autodocs`],decorators:[D,w],beforeEach:()=>(M(`stats/location-views`,`loading`),()=>M(`stats/location-views`,null))},Z={render:()=>W(`last-7-days`),tags:[`!autodocs`],decorators:[D,w],beforeEach:()=>(M(`stats/location-views`,`error`),()=>M(`stats/location-views`,null))},Q={render:()=>W(`last-365-days`),tags:[`!autodocs`],decorators:[D,w],beforeEach:()=>(M(`stats/location-views`,`empty`),()=>M(`stats/location-views`,null))},$={render:e=>(0,G.jsx)(ze,{...e}),args:{...E,widgetWidth:2,widgetHeight:1,withComparison:!0,geoGranularity:`country`},argTypes:{...y,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},geoGranularity:{control:`radio`,options:[`country`,`city`],description:`The "View by" toolbar attribute rendered by the widget host.`}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
