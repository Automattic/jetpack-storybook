...
`}}},z=g.bind({}),z.args={...u,showLegend:!0,legendCollapseGroups:!1,smoothing:!1,data:[{...o[0],label:`Views`,group:`views`},{...o[1],label:`Views — previous`,group:`views`,options:{type:`comparison`}}]},z.parameters={docs:{description:{story:'A primary series paired with a `type: "comparison"` previous-period series sharing the same `group`. `legend.collapseGroups` is off here, the default, so each series keeps its own legend item; turn the `legendCollapseGroups` control on to fold the pair into a single **Views** item.'}}},B=g.bind({}),B.args={...u,showLegend:!0,legendInteractive:!0,legendCollapseGroups:!0,rescaleYOnVisibilityChange:!1,smoothing:!1,data:[{...o[0],label:`Views`,group:`views`},{...o[1],label:`Views — previous`,group:`views`,options:{type:`comparison`}},{...o[2],label:`Visitors`,group:`visitors`},{...o[3],label:`Visitors — previous`,group:`visitors`,options:{type:`comparison`}}]},B.parameters={docs:{description:{story:'Two groups (`views` and `visitors`), each a primary series plus its `type: "comparison"` overlay. With `legend.collapseGroups` each group is a single legend item, and because `legend.interactive` is also on, clicking one toggles both its current and previous-period series at once. The value axis stays fixed as series are toggled. Turn the `legendCollapseGroups` control off to get one item per series, each toggling alone.'}}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`args => {
  ...
  return <LineChart {...chartProps} {...dimensions} data={data} legend={legend} withTooltipCrosshairs={crosshairConfig} />;
}`,...B.parameters?.docs?.source}}},V=[`Default`,`Zoomable`,`FixedDimensions`,`AspectRatio`,`SingleSeries`,`ManySeries`,`Animation`,`WithLegend`,`WithCompositionLegend`,`GradientFilled`,`GradientCustomColors`,`GradientTransparent`,`ErrorStates`,`WithoutSmoothing`,`WithPointerEvents`,`CurveTypes`,`SmartFormatting`,`BrokenLine`,`TimeAxisTickFormats`,`DateStringFormats`,`ComparisonSingle`,`ComparisonMulti`]}));H();export{C as Animation,b as AspectRatio,F as BrokenLine,B as ComparisonMulti,z as ComparisonSingle,M as CurveTypes,R as DateStringFormats,_ as Default,k as ErrorStates,y as FixedDimensions,D as GradientCustomColors,E as GradientFilled,O as GradientTransparent,S as ManySeries,x as SingleSeries,N as SmartFormatting,L as TimeAxisTickFormats,T as WithCompositionLegend,w as WithLegend,j as WithPointerEvents,A as WithoutSmoothing,v as Zoomable,V as __namedExportsOrder,h as default,H as n,p as t};