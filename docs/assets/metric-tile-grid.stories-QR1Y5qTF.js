import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{Tr as n,Vt as r,_i as i,gc as a,t as o}from"./build-module-CR6EsQjA.js";import{i as s,n as c,r as l,t as u}from"./metric-tile-grid-skeleton-D2_61Zo4.js";var d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E;e((()=>{o(),s(),c(),d=t(),f={type:`number`,options:{useMultipliers:!0,decimals:0}},p=[{key:`posts`,icon:n,label:`Posts`,value:12},{key:`words`,icon:i,label:`Words`,value:34567},{key:`likes`,icon:r,label:`Likes`,value:891},{key:`comments`,icon:a,label:`Comments`,value:42}],m=(e,t)=>function(n){return(0,d.jsx)(`div`,{style:{width:e,height:t,border:`1px solid var(--wpds-color-stroke-surface-neutral-weak)`,borderRadius:`var(--wpds-border-radius-md)`,background:`var(--wpds-color-background-surface-neutral)`,padding:`var(--wpds-dimension-padding-lg)`,boxSizing:`border-box`,display:`flex`,flexDirection:`column`,overflow:`hidden`},children:(0,d.jsx)(n,{})})},h={title:`Packages/Premium Analytics/Widgets Toolkit/Components/MetricTileGrid`,component:l,tags:[`autodocs`],parameters:{docs:{description:{component:`Responsive grid of metric tiles that follows the widget cell size and picks its own layout — no column count needed. A narrow cell renders compact rows (icon and label on the left, value on the right); a wide but short cell spreads the tiles across a single row; a wide and tall cell uses a balanced two-column grid of large centered tiles, the last one taking the whole row when the tile count is odd.`}}}},g={args:{tiles:p,dataFormat:f},decorators:[m(`100%`,`480px`)]},_={args:{tiles:p,dataFormat:f},decorators:[m(`360px`,`480px`)]},v={args:{tiles:p,dataFormat:f},decorators:[m(`100%`,`220px`)]},y={args:{tiles:p,dataFormat:f},decorators:[m(`1026px`,`280px`)]},b={args:{tiles:p.slice(0,3),dataFormat:f},decorators:[m(`100%`,`480px`)]},x={args:{dataFormat:f,tiles:[{key:`views`,icon:n,label:`Views`,value:18400,previousValue:16100},{key:`visitors`,icon:r,label:`Visitors`,value:12100,previousValue:10800,note:`Sum of daily visitors — a returning visitor is counted once per day.`},{key:`likes`,icon:r,label:`Likes`,value:842,previousValue:905},{key:`comments`,icon:a,label:`Comments`,value:296,previousValue:null}]},decorators:[m(`100%`,`320px`)]},S={args:{tiles:[{key:`openRate`,icon:n,label:`Open rate`,value:null,dataFormat:{type:`percentage`,options:{decimals:1}}},{key:`clickRate`,icon:r,label:`Click rate`,value:.381,dataFormat:{type:`percentage`,options:{decimals:1}}}]},decorators:[m(`100%`,`320px`)]},C={render:e=>(0,d.jsx)(u,{...e}),args:{tiles:4},decorators:[m(`100%`,`480px`)]},w={render:e=>(0,d.jsx)(u,{...e}),args:{tiles:4},decorators:[m(`360px`,`320px`)]},T={render:e=>(0,d.jsx)(u,{...e}),args:{tiles:4},decorators:[m(`720px`,`140px`)]},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  args: {
    tiles: TILES,
...
tile. This mirrors the wide dashboard-cell case.`,...y.parameters?.docs?.description}}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  ...
  decorators: [makeCanvas('100%', '480px')]
}`,...b.parameters?.docs?.source},description:{story:`Three tiles in a tall cell: an odd count still balances, because the trailing
tile takes the last row rather than leaving half of it empty.`,...b.parameters?.docs?.description}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
    dataFormat: COUNT_FORMAT,
    tiles: [{
      key: 'views',
