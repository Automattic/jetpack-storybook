import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-B4ONLoAz.js";import{i as r,n as i,r as a,t as o}from"./blocks-CBloGn9A.js";import{t as s}from"./mdx-react-shim-BqhL27Jd.js";import{Animation as c,CompositionAPI as l,CustomLabelColors as u,Default as d,ErrorStates as f,WithCompositionLegend as p,WithSize as m,WithTooltips as h,n as g,t as _}from"./index.stories-BiGu6wrH.js";function v(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(i,{title:`JS Packages/Charts Library/Charts/Pie Chart`,of:_}),`
...
`,(0,b.jsx)(a,{language:`jsx`,code:`import { PieChart } from '@automattic/charts';
...
`,(0,b.jsx)(o,{of:d}),`
`,(0,b.jsx)(a,{language:`jsx`,code:`<PieChart
	data={[
...
`,(0,b.jsx)(a,{language:`jsx`,code:`<PieChart data={ data } size={ 400 }>
...
`,(0,b.jsx)(o,{of:p}),`
`,(0,b.jsx)(a,{language:`jsx`,code:`<PieChart size={ 400 } data={ data }>
	<PieChart.Legend />
</PieChart>`}),`
...
`,(0,b.jsx)(t.p,{children:`Override the palette by providing color values in data:`}),`
`,(0,b.jsx)(a,{language:`jsx`,code:`const dataWithColors = [
	{
		label: 'MacOS',
		value: 30000,
		valueDisplay: '30K',
...
`,(0,b.jsx)(o,{of:u}),`
`,(0,b.jsx)(t.p,{children:`Label colors are CSS custom properties, set anywhere inside the provider tree:`}),`
`,(0,b.jsx)(a,{language:`css`,code:`.my-pie-chart {
--a8c-charts-color-label-inverse: #FFFFFF;
--a8c-charts-color-label-background: rgba(0, 0, 0, 0.8);
}`}),`
`,(0,b.jsx)(t.p,{children:(0,b.jsx)(t.strong,{children:`Label Color Roles:`})}),`
`,(0,b.jsxs)(t.ul,{children:[`
`,(0,b.jsxs)(t.li,{children:[(0,b.jsx)(t.strong,{children:(0,b.jsx)(t.code,{children:`--a8c-charts-color-label-inverse`})}),` - Label text on a filled surface: a pie segment here, a heatmap cell elsewhere.`]}),`
`,(0,b.jsxs)(t.li,{children:[(0,b.jsx)(t.strong,{children:(0,b.jsx)(t.code,{children:`--a8c-charts-color-label-background`})}),` - The plate behind a label. Defaults to `,(0,b.jsx)(t.code,{children:`transparent`}),`, so the label reads straight off the segment. Set any color to get a rounded rectangle behind each label; a semi-transparent one (`,(0,b.jsx)(t.code,{children:`rgba()`}),`) keeps the segment color visible through it.`]}),`
`]}),`
`,(0,b.jsx)(t.p,{children:(0,b.jsx)(t.strong,{children:`Best Practices:`})}),`
`,(0,b.jsxs)(t.ul,{children:[`
`,(0,b.jsx)(t.li,{children:`Use high contrast between the label text and its plate for optimal readability`}),`
...
`,(0,b.jsxs)(t.li,{children:[`Set `,(0,b.jsx)(t.code,{children:`--a8c-charts-color-label-background`}),` when segment colors are too varied or bright for consistent text visibility`]}),`
...
`,(0,b.jsx)(t.p,{children:`Pie Charts integrate seamlessly with the chart theming system. The default theme has neutral styling, and is automatically applied to all charts unless a custom theme is provided.`}),`
`,(0,b.jsxs)(t.p,{children:[(0,b.jsx)(t.strong,{children:`Segment colors come from the palette custom properties, not the theme object.`}),` Set as many of the five slots as you need; an unset slot is skipped, and charts generates accessible colors beyond whatever you set:`]}),`
`,(0,b.jsx)(a,{language:`css`,code:`.a8c-charts-scope {
	--a8c-charts-color-series-1: #FF6B6B;
	--a8c-charts-color-series-2: #4ECDC4;
	--a8c-charts-color-series-3: #45B7D1;
}`}),`
`,(0,b.jsxs)(t.p,{children:[`Every other color works the same way — declare its catalog role. The closest declaration inside the provider tree wins, so scope the rule to one dashboard, or to `,(0,b.jsx)(t.code,{children:`.a8c-charts-scope`}),` to move every chart on the page:`]}),`
`,(0,b.jsx)(a,{language:`css`,code:`.my-dashboard {
...
`,(0,b.jsx)(a,{language:`jsx`,code:`// Fill parent container (default) - parent needs explicit height
...
`,(0,b.jsx)(o,{of:m}),`
`,(0,b.jsx)(a,{language:`jsx`,code:`// Constrained pie diameter (container still fills parent)
...
`]}),`
`,(0,b.jsxs)(t.p,{children:[(0,b.jsx)(t.strong,{children:`Note`}),`: The animation plays once when the chart initially renders and does not repeat.`]})]})}function y(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,b.jsx)(t,{...e,children:(0,b.jsx)(v,{...e})}):v(e)}var b;e((()=>{b=t(),s(),r(),g()}))();export{y as default};