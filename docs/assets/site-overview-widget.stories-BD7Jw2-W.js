import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-yGZutq_9.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{Dn as o,Mo as s,Vt as c,bc as l,di as u,t as d}from"./build-module-zwSmKorH.js";import{Ot as ee}from"./build-module-Bfi49zLB.js";import{C as te,V as f,W as p,y as m}from"./wp-date-settings-C2FTLsmo.js";import{t as h}from"./src-CtHpFxZD.js";import{n as ne,t as re}from"./src-BU3pOi4N.js";import{P as ie,en as g,i as _}from"./date-filters-panel-BsEkk73S.js";import{r as ae,t as oe}from"./metric-tile-grid-skeleton-B9N95GyX.js";import{G as se,K as ce,Y as v}from"./report-metric-v_eEwWT1.js";import{t as le}from"./widget-state-B81G7oW6.js";import{C as ue,D as de,E as fe,S as pe,T as me,b as he,t as ge,w as _e,x as y}from"./src-BwQjruTt.js";var b,x,S,ve=t((()=>{b=`_root_4wv3p_5`,x=`_state_4wv3p_10`,S={root:b,state:x}})),C,w,T,E=t((()=>{i(),d(),f(),C=[{id:`views`,label:r(`Views`,`jetpack-premium-analytics-pkg`)},{id:`visitors`,label:r(`Visitors`,`jetpack-premium-analytics-pkg`)},{id:`comments`,label:r(`Comments`,`jetpack-premium-analytics-pkg`)},{id:`likes`,label:r(`Likes`,`jetpack-premium-analytics-pkg`)}],w=C.map(e=>e.id),T={icon:s,attributes:[{id:`metrics`,label:r(`Metrics`,`jetpack-premium-analytics-pkg`),type:`array`,relevance:`high`,Edit:p,elements:C.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:w}}}}));function ye({metricIds:e=w}){let{reportParams:t}=te(),{primary:n,comparison:i,hasComparison:a,isLoading:o,isFetching:c,isError:l,refetch:u}=ie(t),d=n.data,f=i.data,p=(0,O.useMemo)(()=>{let t=new Set(e);return C.filter(e=>t.has(e.id))},[e]);if(p.length===0)return(0,k.jsx)(`div`,{className:S.root,children:(0,k.jsx)(`div`,{className:S.state,children:(0,k.jsx)(ee,{children:r(`Select at least one metric to display.`,`jetpack-premium-analytics-pkg`)})})});let m=!d||p.every(({id:e})=>j[e].value(d)===0),h=p.map(({id:e,label:t})=>{let{icon:n,note:r,value:i}=j[e],o=d?i(d):0;return{key:e,icon:n,label:t,value:o,previousValue:a&&f?i(f):null,note:r,valueTitle:ne(o,`number`,{decimals:0})}});return(0,k.jsx)(`div`,{className:S.root,children:(0,k.jsx)(le,{isLoading:o||n.isPending,isFetching:c,isError:!d&&l,isEmpty:m,error:{description:r(`We couldn't load the site overview. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:u}]},empty:{icon:s,description:r(`No stats recorded for this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,k.jsx)(oe,{tiles:p.length}),children:(0,k.jsx)(ae,{tiles:h,dataFormat:A})})})}function D({attributes:e={}}){return(0,k.jsx)(m,{attributes:e,children:(0,k.jsx)(ye,{metricIds:e.metrics})})}var O,k,A,j,be=t((()=>{_(),re(),ge(),i(),d(),h(),O=e(n(),1),ve(),E(),k=a(),A={type:`number`,options:{useMultipliers:!0,decimals:0}},j={views:{icon:o,value:e=>e.views},visitors:{icon:u,value:e=>e.visitors,note:r(`Sum of daily visitors — a returning visitor is counted once per day, not once for the whole period.`,`jetpack-premium-analytics-pkg`)},likes:{icon:c,value:e=>e.likes},comments:{icon:l,value:e=>e.comments}}})),M,N,P,F,I,L,R,xe=t((()=>{M=`jpa/site-overview`,N=`Site overview`,P=`Views, visitors, likes, and comments for the selected period, with period-over-period change.`,F={content:`A summary of your site's views, visitors, likes, and comments, with period-over-period change.`},I=`stats`,L=`framed`,R={name:M,title:N,description:P,help:F,category:I,presentation:L}}));function z({withComparison:e,metrics:t}){return(0,V.jsx)(D,{attributes:{reportParams:g(e),metrics:t}})}function B(e){return(0,V.jsx)(D,{attributes:{reportParams:g(!1,e),...G}})}function Se({withComparison:e,metrics:t,...n}){return(0,V.jsx)(me,{...n,widgetType:U,renderModule:H,renderComponent:D,attributes:{reportParams:g(e),metrics:t}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{_(),se(),fe(),ue(),he(),be(),E(),xe(),V=a(),ce(),H=`storybook/site-overview`,U=pe(R,T),W={metrics:{control:`check`,options:w,description:`Metric tiles to show in the widget body.`}},G={metrics:w},K={title:`Packages/Premium Analytics/Widgets/SiteOverview`,component:D,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`},...W},parameters:{docs:{description:{component:"The \"Site overview\" widget. Shows the selected period's headline traffic and engagement — views, visitors, likes, and comments — as metric tiles, sourced from the Jetpack Stats `summary` endpoint. Which tiles appear is controlled by the `metrics` attribute (`relevance: 'high'`), exposed inline in the widget header and in the settings drawer. This module has genuine period-over-period comparison data, so the `WithComparison` story shows a change indicator on each tile."}}}},q={render:z,args:{withComparison:!1,...G},decorators:[y]},J={render:z,args:{withComparison:!0,...G},decorators:[y]},Y={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(v(`stats/summary`,`loading`),()=>v(`stats/summary`,null))},X={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(v(`stats/summary`,`error`),()=>v(`stats/summary`,null))},Z={render:()=>B(`last-365-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(v(`stats/summary`,`empty`),()=>v(`stats/summary`,null))},Q={render:e=>(0,V.jsx)(Se,{...e}),args:{..._e,withComparison:!0,...G},argTypes:{...de,withComparison:{control:`boolean`},...W}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
