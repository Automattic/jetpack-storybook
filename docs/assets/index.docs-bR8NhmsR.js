import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-CvbxQqBW.js";import{i as r,n as i,r as a,t as o}from"./blocks-DrPH8rgO.js";import{t as s}from"./mdx-react-shim-edR9kUHt.js";import{AspectRatio as c,Calendar as l,Compact as u,Default as d,ErrorStates as f,FixedDimensions as p,LargeValues as m,WithCompositionLegend as h,n as g,t as _}from"./index.stories-D5_K5R1q.js";function v(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(i,{title:`JS Packages/Charts Library/Charts/Heatmap Chart`,of:_}),`
...
`,(0,b.jsxs)(t.p,{children:[`By default the chart fills its parent container's dimensions, reflowing fluidly as the container resizes. The parent must have an explicit height, or you can set `,(0,b.jsx)(t.code,{children:`aspectRatio`}),` to derive the height from the available width. When neither is provided, the chart falls back to a minimum height so it stays usable rather than collapsing:`]}),`
...
`,(0,b.jsxs)(t.li,{children:[(0,b.jsx)(t.strong,{children:`In-cell text contrast`}),`: when values are shown, each cell chooses light or dark text from the luminance of its blended fill rather than the raw value, so the number stays legible across the whole scale and with any primary color.`]}),`
