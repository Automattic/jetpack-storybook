import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n,u as r}from"./build-module-2QZQpBH2.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{Ui as a,Uu as o,ju as s,t as c}from"./build-module-2iv4IIRq.js";import{$ as l,Q as u,b as d,bt as ee,g as f,in as te,on as ne,r as re,rn as ie}from"./hooks-B4xWNSo3.js";import{b as ae,t as p}from"./src-C-E2d-Lb.js";import{$t as m,k as h,r as g}from"./date-period-dropdown-DFFxSAbH.js";import"./constants-B1kGztHF.js";import{r as oe,t as se}from"./leaderboard-skeleton-hY4uHM0-.js";import{i as _,r as v}from"./register-report-mocks-Ddv1-acm.js";import{E as ce,F as le,N as ue,S as de,b as fe,w as pe}from"./report-metric-zEiCd1G1.js";import{t as me}from"./widget-state-CHDb_lmp.js";import{t as y}from"./src-CWyhsZxW.js";import{a as b,c as x,d as S,i as he,l as ge,n as _e,o as ve,r as C,s as ye,u as be}from"./with-widget-canvas-B0lPgXMt.js";import{n as xe,t as Se}from"./register-stats-mocks-ChMBOls8.js";import{n as Ce,t as w}from"./force-stats-mock-state-De2lCh7D.js";var T,E,D,O,we=e((()=>{T=`_root_xmjm2_1`,E=`_content_xmjm2_9`,D=`_backLink_xmjm2_16`,O={root:T,content:E,backLink:D}}));function k(e){return typeof e.label==`string`?e.label:String(e.label)}function Te(e){return{postId:e.id,label:k(e),value:e.value,previousValue:e.previousValue,href:e.href}}function Ee(e){return{label:k(e),value:e.value,previousValue:e.previousValue,children:e.children?.map(Te),childrenHaveComparison:e.childrenHaveComparison}}function De({reportParams:e,utmParam:t,max:n}){let{comparisonRows:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:l}=h({...e,utmParam:t,max:n},{maxRows:n}),u=(r?.rows??[]).map(Ee),d=u.length===0&&s;return{data:u,hasComparison:i,isLoading:a,isFetching:o,isError:d,error:d?c:null,refetch:l}}var Oe=e((()=>{g()}));function ke(e){switch(e){case`utm_source,utm_medium`:return`source-medium`;case`utm_campaign,utm_source,utm_medium`:return`campaign-source-medium`;case`utm_source`:return`source`;case`utm_medium`:return`medium`;case`utm_campaign`:return`campaign`}}function Ae({utmDimension:e,showReportLink:n}){let{reportParams:i}=d(),{drillDownItem:a,drillDown:s,resetDrillDown:c}=re();(0,o.useEffect)(()=>{c()},[c,e]);let{data:l,hasComparison:u,isLoading:f,isFetching:p,isError:m,error:h,refetch:g}=De({reportParams:i,utmParam:e,max:10}),_=(0,o.useMemo)(()=>l.find(e=>e.label===a)??null,[l,a]),v=!!_?.children?.length,y=(0,o.useMemo)(()=>v?_?.children??[]:l,[l,v,_]),b=v?!!_?.childrenHaveComparison:u;(0,o.useEffect)(()=>{a&&!v&&!f&&!p&&!m&&c()},[a,v,f,p,m,c]);let x=(0,o.useMemo)(()=>{let e=te(y.map(e=>e.value),b?y.map(e=>e.previousValue):[]);return y.map((n,i)=>{let a=n.previousValue,o=`postId`in n?n:null,c=!v&&`children`in n&&!!n.children?.length;return{id:`${i}-${n.label}`,...o?{label:(0,j.jsx)(fe,{id:o.postId,label:o.label,link:o.href})}:ue({label:n.label,media:{kind:`none`},action:le({hasChildren:c,drillDown:{onClick:()=>s(n.label),ariaLabel:r(t(`View posts for %s`,`jetpack-premium-analytics-pkg`),n.label)}})}),currentValue:n.value,currentShare:ie(n.value,e),previousValue:a,previousShare:b&&a!==void 0?ie(a,e):void 0,delta:b&&a!==void 0?ne(n.value,a):void 0}})},[y,v,s,b]);return(0,j.jsxs)(j.Fragment,{children:[v?(0,j.jsx)(ce,{label:t(`All UTM insights`,`jetpack-premium-analytics-pkg`),ariaLabel:t(`View all UTM insights`,`jetpack-premium-analytics-pkg`),onClick:c,className:O.backLink}):null,(0,j.jsx)(`div`,{className:O.content,children:(0,j.jsx)(me,{isLoading:f,isFetching:p,isError:m,isEmpty:l.length===0,error:ee(h,{retryDescription:t(`We couldn't load UTM data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:g}),empty:{icon:ae,description:t(`No UTM data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,j.jsx)(se,{rows:10}),children:(0,j.jsx)(oe,{data:x,withComparison:b,withOverlayLabel:!0,showLegend:!1,dataFormat:M})})}),n&&(0,j.jsx)(pe,{children:(0,j.jsx)(de,{report:`utm`,section:ke(e)})})]})}function A({attributes:e={}}){let t=e.utmDimension??N,n=e.showReportLink??!0;return(0,j.jsx)(f,{attributes:e,children:(0,j.jsx)(`div`,{className:O.root,children:(0,j.jsx)(Ae,{utmDimension:t,showReportLink:n})})})}var j,M,N,je=e((()=>{s(),n(),y(),p(),we(),Oe(),j=i(),M={type:`number`,options:{useMultipliers:!0,decimals:0}},N=`utm_source,utm_medium`})),P,Me=e((()=>{n(),c(),u(),P={icon:a,attributes:[{id:`utmDimension`,label:t(`UTM parameter`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:l,elements:[{label:t(`Source / Medium`,`jetpack-premium-analytics-pkg`),value:`utm_source,utm_medium`},{label:t(`Campaign / Source / Medium`,`jetpack-premium-analytics-pkg`),value:`utm_campaign,utm_source,utm_medium`},{label:t(`Source`,`jetpack-premium-analytics-pkg`),value:`utm_source`},{label:t(`Medium`,`jetpack-premium-analytics-pkg`),value:`utm_medium`},{label:t(`Campaign`,`jetpack-premium-analytics-pkg`),value:`utm_campaign`}],relevance:`high`}],example:{attributes:{utmDimension:`utm_source,utm_medium`}}}})),F,I,L,R,z,B,V,Ne=e((()=>{F=`jpa/utm-insights`,I=`Top UTM`,L=`Traffic breakdown by UTM parameters — source, medium, campaign, and combinations.`,R={content:`Your top UTM campaigns, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},z=`traffic`,B=`framed`,V={name:F,title:I,description:L,help:R,category:z,presentation:B}}));function H(e){return(0,U.jsx)(A,{attributes:{utmDimension:`utm_source,utm_medium`,reportParams:m(!1,e)}})}function Pe({withComparison:e,...t}){return(0,U.jsx)(ye,{...t,widgetType:Ie,renderModule:Fe,renderComponent:A,attributes:{utmDimension:`utm_source,utm_medium`,reportParams:m(e)}})}var U,Fe,Ie,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{g(),x(),be(),b(),_e(),v(),Se(),Ce(),je(),Me(),Ne(),U=i(),_(),xe(),Fe=`storybook/utm-insights`,Ie=he(V,P),W={title:`Packages/Premium Analytics/Widgets/UtmInsights`,component:A,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params and deltas.`}},parameters:{docs:{description:{component:`The "UTM Insights" widget. Shows traffic breakdown by UTM parameter as a ranked leaderboard. The active dimension (Source/Medium, Campaign, etc.) is switched via a dropdown in the widget header and persisted per widget instance.`}}}},G={render:({withComparison:e})=>(0,U.jsx)(A,{attributes:{utmDimension:`utm_source,utm_medium`,reportParams:m(e)}}),args:{withComparison:!1},decorators:[C,S]},K={render:({withComparison:e})=>(0,U.jsx)(A,{attributes:{utmDimension:`utm_source,utm_medium`,reportParams:m(e)}}),args:{withComparison:!0},decorators:[C,S]},q={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/utm`,`loading`),()=>w(`stats/utm`,null))},J={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/utm`,`error`),()=>w(`stats/utm`,null))},Y={render:()=>H(`last-12-months`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/utm`,`error-retryable`),()=>w(`stats/utm`,null))},X={render:()=>H(`last-year`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/utm`,`empty`),()=>w(`stats/utm`,null))},Z={render:({withComparison:e})=>(0,U.jsx)(A,{attributes:{utmDimension:`utm_campaign`,reportParams:m(e)}}),args:{withComparison:!1},decorators:[C,S]},Q={render:e=>(0,U.jsx)(Pe,{...e}),args:{...ve,withComparison:!1},argTypes:{...ge,withComparison:{control:`boolean`,description:`Include previous-period comparison report params and deltas.`}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
  render: ({
    withComparison
