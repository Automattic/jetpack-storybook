import{i as e}from"./preload-helper-usAeo7Bx.js";import{i as t,r as n,t as r}from"./build-module-BJJZlniO2.js";var i,a=e((()=>{i=`// node_modules/comctx/core/dist/index.js
...
`}));function o(){if(d===void 0){let e=new Blob([i],{type:`application/javascript`});f=URL.createObjectURL(e),u=new Worker(f,{type:`module`}),d=t(u)}return d}async function s(e,t,n,r,i){return o().convertGifToVideo(e,t,n,r,i)}async function c(e){return o().cancelOperations(e)}function l(){d&&(n(d),d=void 0,u=void 0),f&&=(URL.revokeObjectURL(f),void 0)}var u,d,f;e((()=>{r(),a()}))();export{c as cancelGifToVideoOperations,s as convertGifToVideo,l as terminateVideoConversionWorker};