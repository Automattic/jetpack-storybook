import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{n,sl as r}from"./build-module-Bb7IR3OP.js";import{$ as i,K as a,Y as o,q as s}from"./report-metric-BAUfAG3E.js";import{t as c,x as l}from"./src-B-_HxovR.js";import{Ct as u,pr as d}from"./chart-tooltip-BikeUN0i.js";import{C as f,D as p,E as m,S as h,T as g,b as _,f as v,t as y,w as b,x}from"./src-v76cCQiE.js";function S({attributes:e={},setError:t}){return(0,C.jsx)(i,{attributes:e,setError:t,options:{from:`/`},children:(0,C.jsx)(v,{view:`campaign`})})}var C,w=e((()=>{y(),C=t()})),T,E=e((()=>{n(),T={icon:r}})),D,O,k,A,j,M,N,P=e((()=>{D=`jpa/sales-by-utm-campaign`,O=`Sales by UTM campaign`,k=`Shows the top UTM campaigns by order revenue over the selected time period.`,A={content:`See which marketing campaigns are driving sales in your store.`},j=`store`,M=`framed`,N={name:D,title:O,description:k,help:A,category:j,presentation:M}}));function F(e=!1,t=U){return{reportParams:d(e,t)}}function I({withComparison:e,preset:t}){let n=!!e,r=t??U;return!n&&r===U?`getDefaultQueryParams()`:n&&r===U?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function L(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
