import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{A as i,t as a}from"./build-module-DrryaqBL.js";import{Zt as o,n as s}from"./build-module-DmVuor49.js";import{D as ee,H as c,J as l,S as te,V as u,W as d}from"./report-metric-IiZe2Pt3.js";import{n as ne,t as f}from"./with-chart-theme-Cz1jXeXL.js";import{Ot as re,q as ie,xt as ae}from"./chart-tooltip-CDjNzS2Z.js";import{t as oe}from"./leaderboard-chart-CmKA29-l.js";import{t as se}from"./widget-state-kGSg2tB2.js";import{C as p,D as ce,E as le,O as m,S as h,T as g,b as ue,k as _,t as de,w as fe,x as v}from"./src-CUxuHBSk.js";import{n as pe,t as y}from"./src-CGhhaeNz.js";var b,x,S,C,w,T,me=e((()=>{b=`_root_1dep2_1`,x=`_widget_1dep2_12`,S=`_body_1dep2_22`,C=`_leaderboard_1dep2_30`,w=`_label_1dep2_40`,T={root:b,widget:x,body:S,leaderboard:C,label:w}}));function he(e,t){let n=e=>t===`opens`?e.opensRate:e.clicksRate,r=Math.max(...e.map(n),0);return e.map(e=>{let t=n(e);return{id:String(e.id),label:(0,D.jsx)(`span`,{className:T.label,title:e.label,children:e.label}),currentValue:t/100,currentShare:ie(t,r),previousValue:0,previousShare:0,delta:0}})}function ge(e,t){return(e?.data?.[0]?.items??[]).slice(0,t>0?t:void 0).map((e,t)=>({id:e.id??t,label:String(e.label??``),opensRate:e.opens_rate,clicksRate:e.clicks_rate}))}function _e({attributes:e}){let n=e?.max??10,r=e?.metric??`opens`,{data:a,isLoading:s,isFetching:c,isError:l,refetch:u}=re({quantity:n>0?Math.min(n,30):30}),d=(0,i.useMemo)(()=>ge(a,n),[a,n]);return(0,D.jsxs)(`div`,{className:T.widget,children:[(0,D.jsx)(`div`,{className:T.body,children:(0,D.jsx)(se,{isLoading:s,isFetching:c,isError:d.length===0&&l,isEmpty:d.length===0,error:{description:t(`We couldn't load email stats. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:u}]},empty:{icon:o,description:t(`Your latest emails will appear here once you send a newsletter.`,`jetpack-premium-analytics-pkg`)},children:(0,D.jsx)(O,{rows:d,metric:r})})}),(0,D.jsx)(ee,{children:(0,D.jsx)(te,{report:`emails`})})]})}function E({attributes:e={}}){return(0,D.jsx)(l,{attributes:e,children:(0,D.jsx)(_e,{attributes:e})})}var D,O,ve=e((()=>{ae(),de(),a(),n(),s(),me(),D=r(),O=({rows:e=[],metric:t=`opens`})=>{let n=(0,i.useMemo)(()=>he(e,t),[e,t]);return(0,D.jsx)(`div`,{className:T.root,children:(0,D.jsx)(oe,{className:T.leaderboard,data:n,withComparison:!1,withOverlayLabel:!0,showLegend:!1,dataFormat:{type:`percentage`,options:{decimals:2,signDisplay:`never`}}})})}})),k,ye=e((()=>{n(),s(),y(),k={icon:o,attributes:[{id:`max`,label:t(`Number of results`,`jetpack-premium-analytics-pkg`),type:`integer`},{id:`metric`,label:t(`View by`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:pe,elements:[{label:t(`Open rate`,`jetpack-premium-analytics-pkg`),value:`opens`},{label:t(`Click rate`,`jetpack-premium-analytics-pkg`),value:`clicks`}],relevance:`high`}],example:{attributes:{max:10,metric:`opens`}}}})),A,j,M,N,P,F,I,be=e((()=>{A=`jpa/stats-emails`,j=`Latest emails sent`,M=`Open and click rates for your latest emails.`,N={content:`Your most recently sent emails, including their open and click rates.`},P=`stats`,F=`framed`,I={name:A,title:j,description:M,help:N,category:P,presentation:F}}));function L(e){return(0,R.jsx)(E,{attributes:{max:e,metric:`opens`}})}function xe(e){return(0,R.jsx)(g,{...e,widgetType:h(I,k),renderModule:z,renderComponent:E,attributes:{max:6,metric:`opens`}})}var R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{u(),f(),le(),m(),p(),ue(),ve(),ye(),be(),R=r(),c(),z=`storybook/emails`,B={title:`Packages/Premium Analytics/Widgets/Emails`,component:O,tags:[`autodocs`],parameters:{docs:{description:{component:"The \"Emails\" widget. Lists the most recently sent emails with their open or click rate, rendered as a leaderboard. The displayed rate is the `metric` attribute (`relevance: 'high'`), exposed as a control by the widget host. The close-up stories drive the presentational `EmailsLeaderboard` with fixtures; `WidgetDashboardWithWidget` mounts the real dashboard with the data-connected widget (fed by a mocked `stats/emails/summary` response)."}}},decorators:[ne]},V=[{id:1,label:`4 Ways to Make Your Website Stand Out`,opensRate:38.1,clicksRate:3.81},{id:2,label:`Develop Locally on Linux with WordPress.com`,opensRate:41.2,clicksRate:5.98},{id:3,label:`10 Brand-New WordPress.com Themes for 2026`,opensRate:35.7,clicksRate:7.12},{id:4,label:`WordPress.com Is Now Available in More Languages`,opensRate:52.4,clicksRate:8.93},{id:5,label:`WordCamp Europe 2026: What to Expect`,opensRate:47.9,clicksRate:10.25},{id:6,label:`Click, Comment, Done: A Better Way to Collaborate`,opensRate:44.3,clicksRate:10.38}],H=[{id:1,label:`An exhaustively long, keyword-stuffed subject line that almost certainly needs to be truncated before it overflows the row`,opensRate:22.5,clicksRate:4.1},{id:2,label:`Your monthly digest: billing, new features, and what is coming next`,opensRate:33.8,clicksRate:6.7}],U={args:{rows:V},decorators:[v]},W={args:{rows:V,metric:`clicks`},decorators:[v]},G={render:()=>L(7),tags:[`!autodocs`],decorators:[v,_],beforeEach:()=>(d(`stats/emails/summary`,`loading`),()=>d(`stats/emails/summary`,null))},K={render:()=>L(8),tags:[`!autodocs`],decorators:[v,_],beforeEach:()=>(d(`stats/emails/summary`,`error`),()=>d(`stats/emails/summary`,null))},q={render:()=>L(9),tags:[`!autodocs`],decorators:[v,_],beforeEach:()=>(d(`stats/emails/summary`,`empty`),()=>d(`stats/emails/summary`,null))},J={args:{rows:H},decorators:[v]},Y=(e,t=`auto`)=>n=>(0,R.jsx)(`div`,{style:{width:e,height:t,border:`1px dashed #ccc`,borderRadius:`8px`,containerType:`inline-size`,containerName:`widget`},children:(0,R.jsx)(n,{})}),X={args:{rows:V},decorators:[Y(`448px`)]},Z={args:{rows:V},decorators:[Y(`576px`)]},Q={render:e=>(0,R.jsx)(xe,{...e}),args:{...fe},argTypes:{...ce}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  args: {
    rows: mockRows
  },
