import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as i,t as a}from"./build-module-CbwHEf9N.js";import{js as o,n as s}from"./build-module-CDRs4YxF.js";import{b as ee,g as c}from"./hooks-BGTJp5sH.js";import{M as te,t as l}from"./src-B64ifip5.js";import{p as u,t as d}from"./src-DBzYcJQe.js";import{nn as f,o as ne,qt as p,s as re,t as m,tn as ie,vn as ae}from"./src-BPUHTRMa.js";import{n as h,t as g}from"./with-chart-theme-Ct-wzy6E.js";import{C as oe,u as _,w as se}from"./chart-tooltip-DnYNQjDW.js";import{r as ce,t as le}from"./metric-tabs-chart-skeleton-CS_Qv4m1.js";import{G as ue,J as v,W as de}from"./report-metric-DHBJ3BIx.js";import{t as fe}from"./widget-state-Dk9JPLyn.js";import{C as pe,D as me,E as he,S as ge,T as _e,b as ve,t as y,w as ye,x as b}from"./src-CyvOXfF3.js";import{n as be,t as xe}from"./preset-for-story-interval-BwTVfBDz.js";var x,S,Se=e((()=>{x=`_root_1p0hj_1`,S={root:x}}));function Ce(e){return t(e===`clicks`?`Total clicks`:`Total opens`,`jetpack-premium-analytics-pkg`)}function we({metric:e,chartType:n}){let{reportParams:r}=ee(),a=ae(r.post_id),o=a>0,s=se(r.interval,ie),c=re(a,r,{enabled:o&&e===`opens`}),l=ne(a,r,{enabled:o&&e===`clicks`}),u=e===`clicks`?l:c,d=(0,i.useCallback)(()=>{u.refetch()},[u]),p=u.data,m=E[e],h=(0,i.useMemo)(()=>{if(p)return s===`day`?p:f(p,s,e=>{let t=Number(e[m]??0);return{value:t,[m]:t}})},[p,s,m]),g=(0,i.useMemo)(()=>{let t=(h?.data??[]).map(e=>({date:oe(e.date_start),value:Number(e[m]??0)}));return[{key:m,label:Ce(e),value:t.reduce((e,t)=>e+t.value,0),current:t}]},[h,m,e]),_=(h?.data?.length??0)>0;return(0,w.jsx)(`div`,{className:S.root,children:(0,w.jsx)(fe,{isLoading:u.isLoading,isFetching:u.isFetching,isError:u.isError,isEmpty:!o||!_,error:{description:t(`We couldn't load this email's timeline. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:d}]},empty:{icon:te,description:t(o?`No activity for this email in this period.`:`Open an email report to see its timeline here.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,w.jsx)(le,{}),children:(0,w.jsx)(ce,{metrics:g,dataFormat:T,chartType:n,pointsAreWallClocks:!0})})})}function C({attributes:e={}}){return(0,w.jsx)(c,{attributes:e,children:(0,w.jsx)(we,{metric:e.metric??`opens`,chartType:e.chartType===`bar`?`bar`:`line`})})}var w,T,E,Te=e((()=>{m(),l(),y(),a(),n(),Se(),w=r(),T={type:`number`,options:{useMultipliers:!0,decimals:0}},E={opens:`opens_count`,clicks:`clicks_count`}})),D,Ee=e((()=>{s(),y(),D={icon:o,attributes:[_()],example:{attributes:{metric:`opens`,chartType:`line`}}}})),O,k,A,j,M,N,P,De=e((()=>{O=`jpa/email-time-series`,k=`Email performance`,A=`A single email's opens or clicks over time since it was sent.`,j={content:`How a single email performed over time: opens or clicks per day since it was sent, following the dashboard date range. Weekly and monthly grouping aggregate the daily buckets.`},M=`stats`,N=`framed`,P={name:O,title:k,description:A,help:j,category:M,presentation:N}}));function F({metric:e,interval:t,chartType:n},r=!1){return{reportParams:{...p(r,be(t)),interval:t,post_id:B},metric:e,chartType:n}}function I(e){return(0,R.jsx)(C,{attributes:F(e)})}function L(e){return(0,R.jsx)(C,{attributes:{reportParams:{...p(!1),interval:`day`,post_id:e},metric:`opens`}})}function Oe({metric:e,interval:t,chartType:n,...r}){return(0,R.jsx)(_e,{...r,widgetType:ge(P,D),renderModule:z,renderComponent:C,attributes:F({metric:e,interval:t,chartType:n},!0)})}var R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{m(),d(),de(),g(),he(),pe(),xe(),ve(),Te(),Ee(),De(),R=r(),ue(),z=`storybook/email-time-series`,B=1234,V=[`opens`,`clicks`],H=[`day`,`week`,`month`],U={title:`Packages/Premium Analytics/Widgets/EmailTimeSeries`,component:C,tags:[`autodocs`],argTypes:{metric:{control:`select`,options:V},interval:{control:`select`,options:H},chartType:{control:`radio`,options:[`line`,`bar`]}},parameters:{docs:{description:{component:`The "Email performance" widget. Draws a single sent email's opens or clicks per day as a line chart, spanning the dashboard date range — the chart section of the legacy email detail page. The bucket size follows the page's chart interval control: an hourly window (the last-24-hours preset) draws the hourly buckets directly, while weekly and monthly grouping aggregate the daily buckets client-side because the endpoint only reports hourly/daily. Scoped to one email via a mocked \`reportParams.post_id\`. The post detail page has no comparison control, so comparison report params are ignored.`}}},decorators:[h]},W={render:I,args:{metric:`opens`,interval:`day`,chartType:`line`},decorators:[b]},G={render:I,args:{metric:`clicks`,interval:`day`,chartType:`line`},decorators:[b]},K={render:I,args:{metric:`opens`,interval:`week`,chartType:`line`},decorators:[b]},q={render:({metric:e,chartType:t})=>(0,R.jsx)(C,{attributes:{reportParams:{...p(!1,u),post_id:B},metric:e,chartType:t}}),args:{metric:`opens`,chartType:`line`},parameters:{controls:{exclude:[`interval`]}},decorators:[b]},J={render:()=>L(5701),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(v(`stats/opens/emails`,`loading`),()=>v(`stats/opens/emails`,null))},Y={render:()=>L(5702),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(v(`stats/opens/emails`,`error`),()=>v(`stats/opens/emails`,null))},X={render:()=>L(5703),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(v(`stats/opens/emails`,`empty`),()=>v(`stats/opens/emails`,null))},Z={render:()=>(0,R.jsx)(C,{attributes:{reportParams:p(!1),metric:`opens`}}),decorators:[b]},Q={render:e=>(0,R.jsx)(Oe,{...e}),args:{...ye,metric:`opens`,interval:`day`,chartType:`line`},argTypes:{...me,metric:{control:`select`,options:V},interval:{control:`select`,options:H},chartType:{control:`radio`,options:[`line`,`bar`]}}},W.parameters={...W.parameters,docs:{...W.parameters?.docs,source:{originalSource:`{
