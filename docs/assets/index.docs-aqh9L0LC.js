import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-CKNXumJc.js";import{i as r,n as i,r as a,t as o}from"./blocks-BJPYOLg4.js";import{t as s}from"./mdx-react-shim-DM8q9fRn.js";import{Animation as c,AspectRatio as l,CurveTypes as u,Default as d,ErrorStates as f,PercentageStack as p,SingleSeries as m,Streamgraph as h,Unstacked as g,WithCompositionLegend as _,WithDefaultHiddenSeries as v,Zoomable as y,n as b,t as x}from"./index2.stories-Cf6ab1i1.js";function S(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(i,{title:`JS Packages/Charts Library/Charts/Area Chart`,of:x}),`
...
`,(0,w.jsxs)(t.li,{children:[(0,w.jsx)(t.strong,{children:`Escape`}),`: Close a keyboard-opened tooltip and return focus to the chart`]}),`
`,(0,w.jsx)(t.li,{children:`All series colors can be overridden through the palette custom properties; do not rely on color alone to distinguish series.`}),`
