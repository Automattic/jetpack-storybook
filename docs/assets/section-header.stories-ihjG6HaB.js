import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{t as i,yr as a}from"./build-module-2iv4IIRq.js";import{a as o,c as s,u as c}from"./build-module-D_uWNNNl.js";import{En as l,Et as u,u as d}from"./build-module-CfSFqaK72.js";import{t as f}from"./src-CwA7-RO2.js";import{W as p,i as m,t as h}from"./src-BNPYbbO9.js";import{n as g,r as _,t as v}from"./story-interval-options-C59XhMNq.js";import{r as y,t as b}from"./date-filters-panel-DA6B7MYY.js";import{t as x}from"./date-interval-dropdown-LAwFo66z.js";import{t as S}from"./date-year-filter-CqVcmQ4c.js";import{i as C,n as w,r as T,t as E}from"./section-header-B_o_Kr16.js";function D(){let e=m(`last-30-days`,F);return{presetId:`last-30-days`,range:{from:e?.from,to:e?.to}}}function O(e,t){return e.range.from!==t.range.from||e.range.to!==t.range.to||e.presetId!==t.presetId}function k(){let e=D(),[t,n]=(0,N.useState)(e),[r,i]=(0,N.useState)(e),a=(0,N.useRef)(r);a.current=r;let[o,s]=(0,N.useState)(void 0),[c,l]=(0,N.useState)(void 0),u=(0,N.useCallback)((e,t)=>{let n={range:e??a.current.range,presetId:t??a.current.presetId};a.current=n,i(n)},[]),d=(0,N.useCallback)(()=>{n(a.current)},[]),f=(0,N.useCallback)(()=>{a.current=t,i(t)},[t]),p=(0,N.useCallback)((e,t)=>{s(t)},[]),m=v(r.presetId);return(0,P.jsx)(b,{range:r.range,appliedPresetId:t.presetId,appliedRange:t.range,comparisonPresetId:o,withIntervalControl:!0,interval:_(c,m),intervalOptions:m,onChange:u,onComparisonChange:p,onIntervalChange:l,onApply:d,onCancel:f,canApply:O(r,t),timeZone:F})}function A({containerElement:e}){let[t,n]=(0,N.useState)(p),[r,i]=(0,N.useState)(void 0),a=v(t);return(0,P.jsxs)(u,{direction:`row`,align:`center`,gap:`sm`,children:[(0,P.jsx)(S,{value:t,onSelect:(e,t)=>n(t),timeZone:F,containerElement:e}),(0,P.jsx)(x,{options:a,value:_(r,a),onChange:i})]})}function j({title:e,pinned:t}){return(0,P.jsx)(E,{title:e,pinned:t,children:(0,P.jsx)(k,{})})}function M({title:e}){let[t,n]=(0,N.useState)(null);return(0,P.jsx)(E,{ref:n,title:e,children:(0,P.jsx)(A,{containerElement:t})})}var N,P,F,I,L,R,z,B,V,H,U,W,G,K;t((()=>{h(),f(),s(),i(),N=e(n(),1),C(),y(),g(),T(),w(),P=r(),F=`America/New_York`,I={title:`Packages/Premium Analytics/UI/SectionHeader`,component:E,tags:[`autodocs`],parameters:{docs:{description:{component:`Header for an analytics surface: a **title** names the section, and the date controls sit beside it on the same row.
