import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{jn as o,t as s}from"./build-module-CR6EsQjA.js";import{b as c,g as l}from"./hooks-D19y4jDt.js";import{An as ee,N as u,Sn as d,Zt as f,t as p}from"./src-CXH18irA.js";import{t as te,u as m}from"./src-CgxX3tCx.js";import{A as h}from"./chart-tooltip-pHqRyAI_.js";import{G as ne,J as g,K as re,V as _,Y as v}from"./report-metric-C9G1FcBt.js";import{t as ie}from"./widget-state-Ch8gvJPj.js";import{C as ae,D as oe,E as se,S as ce,T as le,b as y,t as b,w as ue,x}from"./src-BnSstmZC.js";var S,C,de=t((()=>{S=`_root_1j6if_1`,C={root:S}}));function w(e){let t=e.reduce((e,t)=>!e||t.total>e.total?t:e,void 0);return t&&t.total>0?t:void 0}function T(){let{reportParams:e}=c(),{primary:t,isLoading:n,isFetching:r,isError:i,error:a,refetch:o}=u((0,E.useMemo)(()=>d({...e}),[e])),s=t.data,l=(0,E.useMemo)(()=>s?s.buckets.map(({hour:e,views:t})=>({hour:e,total:t,average:t/s.days})):[],[s]);return{buckets:l,peak:(0,E.useMemo)(()=>{let e=w(l);return e&&{...e,label:m(e.hour)}},[l]),isLoading:n,isFetching:r,isError:i,error:a,refetch:o}}var E,D=t((()=>{p(),te(),b(),E=e(n(),1)}));function O(){let{buckets:e,peak:t,isLoading:n,isFetching:i,isError:a,error:s,refetch:c}=T(),l=(0,A.useMemo)(()=>e.map(e=>e.average),[e]),u=a&&(!t||s instanceof ee),d=t&&t.average<10&&!Number.isInteger(t.average)?1:0;return(0,j.jsx)(`div`,{className:C.root,children:(0,j.jsx)(ie,{isLoading:n,isFetching:i,isError:u,isEmpty:!t,error:u?h(s,{retryDescription:r(`We couldn't load your popular hours. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}):null,empty:{icon:o,description:r(`No views in this period.`,`jetpack-premium-analytics-pkg`)},children:(0,j.jsx)(_,{label:t?.label??``,value:t?.average??0,points:l,valueDecimals:d,valueUnit:`views-per-day`})})})}function k({attributes:e={},setError:t}){return(0,j.jsx)(l,{attributes:e,setError:t,children:(0,j.jsx)(O,{})})}var A,j,fe=t((()=>{p(),b(),i(),s(),A=e(n(),1),de(),D(),j=a()})),M,pe=t((()=>{s(),M={icon:o}})),N,P,F,I,L,R,z,me=t((()=>{N=`jpa/popular-hours`,P=`Popular hours`,F=`The hour of the day that draws the most views, with the distribution across the day.`,I={content:`The hours of the day when your site received the most views on average. Ranges longer than a year show the most recent 12 months.`,links:[{label:`Learn more`,href:`https://wordpress.com/support/stats/learn-insights-about-your-website/`}]},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function he(){return(0,V.jsx)(k,{attributes:{reportParams:f(!1)}})}function B(e){return(0,V.jsx)(k,{attributes:{reportParams:f(!1,e)}})}function ge(e){return(0,V.jsx)(le,{...e,widgetType:U,renderModule:H,renderComponent:k,attributes:{reportParams:f(!0)}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{p(),ne(),se(),ae(),y(),fe(),pe(),me(),V=a(),re(),H=`storybook/popular-hours`,U=ce(z,M),W={title:`Packages/Premium Analytics/Widgets/PopularHours`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:"The \"Popular hours\" card: the busiest hour of the day for the selected range, as a site-format hour label and its mean daily views, over an area chart of the whole day's distribution. Data comes from `stats/views-by/hour-of-day`, which folds the range into 24 buckets in the site's own timezone; `stats/insights` also reports an hours map, but keyed in UTC while its `highest_hour` is offset-applied, so its chart and headline disagree. Because the endpoint rejects ranges longer than 366 days, the client limits `all time` and long custom ranges to the most recent 12 months. There is no WithComparison story — the widget strips comparison from its request and renders no delta, so it would be identical to Default."}}}},G={render:he,decorators:[x]},K={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(v(`stats/views-by/hour-of-day`,`loading`),()=>v(`stats/views-by/hour-of-day`,null))},q={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(v(`stats/views-by/hour-of-day`,`error`),()=>v(`stats/views-by/hour-of-day`,null))},J={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(v(`stats/views-by/hour-of-day`,`error-retryable`),()=>v(`stats/views-by/hour-of-day`,null))},Y={render:()=>B(`last-30-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(g(`stats/views-by/hour-of-day`,{date:`2026-01-01`,start_date:`2025-12-03`,days:30,dimension:`day-of-week`,fields:[`period`,`views`],data:[[`Mon`,100]]}),()=>g(`stats/views-by/hour-of-day`,null))},X={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(g(`stats/views-by/hour-of-day`,{date:`2026-01-01`,start_date:`2025-01-01`,days:366,dimension:`hour-of-day`,fields:[`period`,`views`],data:[[`7`,4],[`19`,18]]}),()=>g(`stats/views-by/hour-of-day`,null))},Z={render:()=>B(`last-year`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(v(`stats/views-by/hour-of-day`,`empty`),()=>v(`stats/views-by/hour-of-day`,null))},Q={render:e=>(0,V.jsx)(ge,{...e}),args:{...ue},argTypes:{...oe}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
