import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Tn as i,Uu as a,Vt as o,ju as s,t as c,ul as l,vc as u}from"./build-module-2iv4IIRq.js";import{b as ee,g as d,yt as f}from"./hooks-CSn2Cx1Z.js";import{M as te,t as p}from"./src-C-E2d-Lb.js";import{en as m,jn as h,r as g,yt as _}from"./date-period-dropdown-CjEm5p6n.js";import{r as ne,t as re}from"./metric-tile-grid-skeleton-COle4T2R.js";import{i as v,r as ie,s as y}from"./register-report-mocks-QCDNKeCB.js";import{t as b}from"./widget-state-BCBNOH4M.js";import{t as x}from"./src-DC1L-Pvy.js";import{a as ae,c as oe,i as se,l as ce,n as le,o as S,r as C,s as ue}from"./with-widget-canvas-BnVliKFs.js";var w,T,de=e((()=>{w=`_root_owpvf_1`,T={root:w}}));function E(e,t,n){let r=0;for(let i of e)i.date>=t&&i.date<=n&&(r+=i.views);return r}function fe(e,t){let{data:n,isLoading:r,isFetching:i,isError:o,refetch:s}=_({postId:e,fields:[`data`,`like_count`,`post`]});return{...(0,a.useMemo)(()=>{let e=n?.data??[],r=f(t.from),i=f(t.to),a=f(t.compare_from),o=f(t.compare_to),s=t.comp===`1`,c=r&&i?E(e,r,i):e.reduce((e,t)=>e+t.views,0),l;return s&&(l=a&&o?E(e,a,o):null),{views:c,viewsPrevious:l,comments:n?.post?.comment_count??0,likes:n?.like_count??0,hasComparison:s}},[n,t.comp,t.from,t.to,t.compare_from,t.compare_to]),isLoading:r,isFetching:i,isError:o,hasData:!!n,refetch:s}}var pe=e((()=>{g(),x(),s()}));function me(){let{reportParams:e}=ee(),n=h(e.post_id),{views:r,viewsPrevious:s,comments:c,likes:l,hasComparison:d,isLoading:f,isFetching:p,isError:m,hasData:g,refetch:_}=fe(n,e),v=(0,a.useMemo)(()=>[{key:`views`,label:t(`Views`,`jetpack-premium-analytics-pkg`),icon:i,value:r,previousValue:s,note:t(`Views in the selected date range.`,`jetpack-premium-analytics-pkg`)},{key:`likes`,label:t(`Likes`,`jetpack-premium-analytics-pkg`),icon:o,value:l,previousValue:d?null:void 0,note:A()},{key:`comments`,label:t(`Comments`,`jetpack-premium-analytics-pkg`),icon:u,value:c,previousValue:d?null:void 0,note:A()}],[r,s,c,l,d]);return(0,O.jsx)(`div`,{className:T.root,children:(0,O.jsx)(b,{isLoading:f,isFetching:p,isError:!g&&m,isEmpty:n<=0,error:{description:t(`We couldn't load this post's highlights. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:_}]},empty:{icon:te,description:t(`Open a post or page report to see its highlights here.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,O.jsx)(re,{tiles:v.length}),children:(0,O.jsx)(ne,{tiles:v,dataFormat:k})})})}function D({attributes:e={}}){return(0,O.jsx)(d,{attributes:e,children:(0,O.jsx)(me,{})})}var O,k,A,he=e((()=>{g(),p(),x(),s(),n(),c(),de(),pe(),O=r(),k={type:`number`,options:{useMultipliers:!0,decimals:0}},A=()=>t(`All-time total — this metric has no per-post history.`,`jetpack-premium-analytics-pkg`)})),j,ge=e((()=>{c(),j={icon:l,attributes:[],example:{attributes:{}}}})),M,N,P,F,I,L,R,_e=e((()=>{M=`jpa/post-detail-highlights`,N=`Post highlights`,P=`Views, comments, and likes for the post or page being viewed.`,F={content:`Views, comments, and likes for the post or page being viewed.`},I=`stats`,L=`framed`,R={name:M,title:N,description:P,help:F,category:I,presentation:L}}));function z({withComparison:e,hasPostScope:t}){return{reportParams:{...m(e),...t?{post_id:H}:{}}}}function B(e){return(0,V.jsx)(D,{attributes:z(e)})}function ve({withComparison:e,hasPostScope:t,...n}){return(0,V.jsx)(ue,{...n,widgetType:se(R,j),renderModule:U,renderComponent:D,attributes:z({withComparison:e,hasPostScope:t})})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{g(),ie(),oe(),ae(),le(),he(),ge(),_e(),V=r(),v(),H=779,U=`storybook/post-detail-highlights`,W=`stats/post/${H}`,G={title:`Packages/Premium Analytics/Widgets/PostDetailHighlights`,component:D,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}},parameters:{docs:{description:{component:`The "Post highlights" widget: the scoped post's views, comments, and likes as metric tiles — the post detail Traffic view's highlights card. Views is period-scoped and carries a delta when comparison is on; comments and likes are lifetime totals with no per-post history, so their tiles show a note instead of a delta. Without a post scope the widget renders a scopeless empty state.`}}}},K={render:B,args:{withComparison:!1,hasPostScope:!0},decorators:[C]},q={render:B,args:{withComparison:!0,hasPostScope:!0},decorators:[C]},J={render:B,args:{withComparison:!1,hasPostScope:!1},decorators:[C]},Y={render:B,args:{withComparison:!1,hasPostScope:!0},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(y(W,`loading`),()=>y(W,null))},X={render:B,args:{withComparison:!1,hasPostScope:!0},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(y(W,`error`),()=>y(W,null))},Z={render:B,args:{withComparison:!1,hasPostScope:!0},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(y(W,`empty`),()=>y(W,null))},Q={render:e=>(0,V.jsx)(ve,{...e}),args:{...S,widgetWidth:3,widgetHeight:1,withComparison:!0,hasPostScope:!0},argTypes:{...ce,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
