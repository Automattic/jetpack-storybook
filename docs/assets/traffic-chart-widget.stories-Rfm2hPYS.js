import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{A as i,t as a}from"./build-module-DrryaqBL.js";import{Fn as o,n as s}from"./build-module-DoJYX5DX.js";import{$ as ee,G as c,H as l,U as u,Y as d}from"./report-metric-B88CITdf.js";import{A as f,t as p}from"./src-B3le4dug.js";import{Kt as m,a as h,r as te,ur as g,xt as _}from"./chart-tooltip-DYeL-Ebj.js";import{t as v}from"./metric-tabs-chart-CCtCoFX8.js";import{t as y}from"./widget-state-D2kmnSNs.js";import{C as b,D as x,E as ne,S as re,T as ie,b as ae,t as S,w as oe,x as C}from"./src-DuJJqcEZ.js";import{i as se,n as ce,t as le}from"./src-CV-dL0bh.js";var ue,de,w,fe=e((()=>{ue=`_root_t6a9k_1`,de=`_emptyState_t6a9k_10`,w={root:ue,emptyState:de}})),T,E,D,O=e((()=>{n(),s(),le(),T=[{id:`views`,label:t(`Views`,`jetpack-premium-analytics-pkg`)},{id:`visitors`,label:t(`Visitors`,`jetpack-premium-analytics-pkg`)},{id:`likes`,label:t(`Likes`,`jetpack-premium-analytics-pkg`)},{id:`comments`,label:t(`Comments`,`jetpack-premium-analytics-pkg`)}],E=T.map(e=>e.id),D={icon:o,attributes:[{id:`granularity`,label:t(`Group by`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:ce,elements:[{label:t(`Auto`,`jetpack-premium-analytics-pkg`),value:`auto`},{label:t(`By days`,`jetpack-premium-analytics-pkg`),value:`day`},{label:t(`By weeks`,`jetpack-premium-analytics-pkg`),value:`week`},{label:t(`By months`,`jetpack-premium-analytics-pkg`),value:`month`}],relevance:`high`},{id:`metrics`,label:t(`Metrics`,`jetpack-premium-analytics-pkg`),type:`array`,relevance:`high`,Edit:se,elements:T.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{granularity:`auto`,metrics:E}}}}));function k(e,t,n){return{...e,stat_fields:t,period:n}}function pe(e,t,n=E){let r=(0,i.useMemo)(()=>new Set(n),[n]),a=r.has(`views`)||r.has(`visitors`),o=r.has(`likes`)||r.has(`comments`),s=(0,i.useMemo)(()=>k(e,`views,visitors`,t),[e,t]),ee=(0,i.useMemo)(()=>k(e,`likes,comments`,t),[e,t]),c=m(s,{enabled:a}),l=m(ee,{enabled:o}),u=c.primary.data,d=c.comparison.data,f=c.hasComparison,p=l.primary.data,h=l.comparison.data,g=l.hasComparison,_=(0,i.useMemo)(()=>T.filter(e=>r.has(e.id)).map(e=>{let t=e.id===`views`||e.id===`visitors`;return te({primary:t?u:p,comparison:t?d:h,hasComparison:t?f:g,field:e.id,label:e.label})}),[r,u,d,f,p,h,g]),{refetch:v}=c,{refetch:y}=l,b=(0,i.useCallback)(()=>{v(),y()},[v,y]),x=c.isError&&!u?.data?.length||l.isError&&!p?.data?.length;return{metrics:_,isLoading:c.isLoading||l.isLoading,isFetching:c.isFetching||l.isFetching,isError:x,refetch:b}}var me=e((()=>{_(),a(),O(),S()}));function he({granularity:e,metrics:n}){let{reportParams:r}=ee(),{metrics:i,isLoading:a,isFetching:o,isError:s,refetch:c}=pe(r,e===`auto`?h(r.interval,N):e,n),l=t(`Traffic metric`,`jetpack-premium-analytics-pkg`);return i.length?(0,j.jsx)(`div`,{className:w.root,children:(0,j.jsx)(y,{isLoading:a,isError:s,isEmpty:i.every(e=>e.current.length===0),error:{description:t(`We couldn't load traffic data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:c}]},empty:{icon:f,description:t(`No traffic data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,j.jsx)(v,{metrics:i,dataFormat:M,loading:!0,groupLabel:l}),children:(0,j.jsx)(v,{metrics:i,dataFormat:M,loading:o,groupLabel:l})})}):(0,j.jsx)(`div`,{className:w.emptyState,children:t(`No metric selected. Please select a metric from the metrics list.`,`jetpack-premium-analytics-pkg`)})}function A({attributes:e={},setError:t}){return(0,j.jsx)(d,{attributes:e,setError:t,options:{from:`/`},children:(0,j.jsx)(he,{granularity:e.granularity??`auto`,metrics:e.metrics})})}var j,M,N,ge=e((()=>{S(),p(),n(),fe(),me(),j=r(),M={type:`number`,options:{useMultipliers:!0,decimals:0}},N=[`day`,`week`,`month`]})),P,F,_e,I,L,R,z,ve=e((()=>{P=`jpa/traffic-chart`,F=`Summary`,_e=`Compare views, visitors, likes, and comments over the selected period, with the previous period overlaid for comparison.`,I={content:`A summary of your site's views, visitors, likes, and comments.`},L=`traffic`,R=`framed`,z={name:P,title:F,description:_e,help:I,category:L,presentation:R}}));function B({withComparison:e,metrics:t}){return(0,H.jsx)(A,{attributes:{reportParams:g(e),metrics:t}})}function V(e){return(0,H.jsx)(A,{attributes:{reportParams:g(!1,e)}})}function ye({withComparison:e,metrics:t,...n}){return(0,H.jsx)(ie,{...n,widgetType:W,renderModule:U,renderComponent:A,attributes:{reportParams:g(e),metrics:t}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$,be;e((()=>{_(),ne(),b(),ae(),l(),ge(),O(),ve(),H=r(),u(),U=`storybook/traffic-chart`,W=re(z,D),G={metrics:{control:`check`,options:E}},K={metrics:E},q={title:`Packages/Premium Analytics/Widgets/TrafficChart`,component:A,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`},...G},parameters:{docs:{description:{component:"Traffic over the selected period as selectable metric tabs — Views, Visitors, Likes, and Comments — over a comparative line chart. The date range and comparison come from the dashboard controls; the \"Group by\" control is the `granularity` attribute and the tab selection is the `metrics` attribute (both `relevance: 'high'`), exposed by the widget host. When comparison is on the previous period is overlaid as a same-colour dashed line and each tab shows its period-over-period delta. Views/visitors and likes/comments are fetched as two parallel requests (mirroring Calypso) to keep latency down; a pair's request is skipped while neither of its metrics is selected. Data comes from the `useStatsVisits` hook; in Storybook it is served by `registerReportMocks`."}}}},J={render:B,args:{withComparison:!1,...K},decorators:[C]},Y={render:B,args:{withComparison:!0,...K},decorators:[C]},X={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(c(`stats/visits`,`loading`),()=>c(`stats/visits`,null))},Z={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(c(`stats/visits`,`error`),()=>c(`stats/visits`,null))},Q={render:()=>V(`last-365-days`),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(c(`stats/visits`,`empty`),()=>c(`stats/visits`,null))},$={render:e=>(0,H.jsx)(ye,{...e}),args:{...oe,withComparison:!0,...K},argTypes:{...x,withComparison:{control:`boolean`},...G}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
