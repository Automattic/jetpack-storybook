import{i as e}from"./preload-helper-usAeo7Bx.js";import{c as t,n,t as r}from"./build-module-Da_5_6n_.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{A as a,t as o}from"./build-module-DrryaqBL.js";import{Mt as s,n as c}from"./build-module-DmVuor49.js";import{r as l}from"./hooks-BzjiFeg5.js";import{G as u,K as d,cr as f,hn as ee,yt as p}from"./chart-tooltip-sTMsgHbZ.js";import{t as m}from"./leaderboard-chart-BPTqMFhB.js";import{E as h,M as g,N as _,U as te,b as ne,g as v,v as y,w as b,z as x}from"./report-metric-D5hry_ac.js";import{t as re}from"./widget-state-CSKYcGm6.js";import{C as ie,D as ae,E as oe,O as se,S as ce,T as le,b as ue,k as S,t as de,w as fe,x as C}from"./src-7Fe8UaL9.js";import{n as pe,t as me}from"./register-stats-mocks-D_Ft4UVJ.js";import{n as he,t as w}from"./force-stats-mock-state-BybZpunD.js";var T,E,D,O,ge=e((()=>{T=`_placeholder_1d6co_1`,E=`_root_1d6co_9`,D=`_content_1d6co_18`,O={placeholder:T,root:E,content:D}}));function _e(e){return typeof e.label==`string`&&e.label?e.label:e.link??``}function k(e){return{label:_e(e),value:e.views,previousValue:e.previousValue,...e.link?{href:e.link}:{},icon:e.icon,children:e.children?.map(k),...e.childrenHaveComparison?{childrenHaveComparison:!0}:{}}}function ve(e,r,i){let a=Math.max(...e.map(e=>e.value),1),o=Math.max(...e.map(e=>e.previousValue??0),1);return e.map((e,s)=>{let c=e.previousValue,l=!!e.children?.length;return{id:`${s}-${e.href??e.label}`,...b({label:e.label,media:{kind:`favicon`,url:e.icon??void 0},action:h({href:e.href,hasChildren:l,drillDown:i?{onClick:()=>i(e),ariaLabel:t(n(`View clicked links for %s`,`jetpack-premium-analytics`),e.label)}:void 0})}),currentValue:e.value,currentShare:u(e.value,a),previousValue:c,previousShare:r&&c!==void 0?u(c,o):void 0,delta:r&&c!==void 0?d(e.value,c):void 0}})}function ye({rows:e=[],withComparison:t=!1,onDrillDown:n}){return(0,j.jsx)(m,{data:ve(e,t,n),withComparison:t,withOverlayLabel:!0,showLegend:!1,dataFormat:M})}function be({max:e}){let{reportParams:t}=te(),{drillDownItem:r,drillDown:i,resetDrillDown:o}=l(),{comparisonRows:c,hasComparison:u,isLoading:d,isFetching:f,isError:p,refetch:m}=ee({...t,max:e},{maxRows:e}),h=(0,a.useMemo)(()=>(c?.rows??[]).map(k),[c]),g=(0,a.useMemo)(()=>h.find(e=>e.label===r)??null,[h,r]),_=!!g?.children?.length,v=_?g.children??[]:h,y=_?!!g?.childrenHaveComparison:u;(0,a.useEffect)(()=>{r&&!_&&!d&&!f&&!p&&o()},[r,_,d,f,p,o]);let b=(0,a.useCallback)(e=>{i(e.label)},[i]),x=_?(0,j.jsx)(ne,{label:n(`All Clicks`,`jetpack-premium-analytics`),ariaLabel:n(`View all clicks`,`jetpack-premium-analytics`),onClick:o}):null;return(0,j.jsxs)(`div`,{className:O.content,children:[x,(0,j.jsx)(re,{isLoading:d,isFetching:f,isError:h.length===0&&p,isEmpty:v.length===0,error:{description:n(`We couldn't load clicks. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:n(`Retry`,`jetpack-premium-analytics`),onClick:m}]},empty:{icon:s,description:n(`No clicks in this period.`,`jetpack-premium-analytics`)},children:(0,j.jsx)(ye,{rows:v,withComparison:y,onDrillDown:_?void 0:b})})]})}function A({attributes:e={}}){let t=e?.max??10;return(0,j.jsx)(x,{attributes:e,children:(0,j.jsxs)(`div`,{className:O.root,children:[(0,j.jsx)(be,{max:t}),(0,j.jsx)(y,{children:(0,j.jsx)(v,{report:`clicks`})})]})})}var j,M,xe=e((()=>{p(),de(),o(),r(),c(),ge(),j=i(),M={type:`number`,options:{useMultipliers:!0,decimals:0}}})),N,Se=e((()=>{r(),c(),N={icon:s,attributes:[{id:`max`,label:n(`Number of results`,`jetpack-premium-analytics`),type:`integer`}],example:{attributes:{max:10}}}})),P,F,I,L,R,z,B,Ce=e((()=>{P=`jpa/clicks`,F=`Clicks`,I=`Most clicked external links on your site.`,L={content:`The external links your visitors clicked most often, sorted by clicks.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},R=`traffic`,z=`framed`,B={name:P,title:F,description:I,help:L,category:R,presentation:z}}));function V({withComparison:e}){return(0,U.jsx)(A,{attributes:{max:10,reportParams:f(e)}})}function H(e){return(0,U.jsx)(A,{attributes:{max:10,reportParams:f(!1,e)}})}function we({withComparison:e,...t}){return(0,U.jsx)(le,{...t,widgetType:G,renderModule:W,renderComponent:A,attributes:{max:10,reportParams:f(e)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{p(),g(),me(),he(),oe(),se(),ie(),ue(),xe(),Se(),Ce(),U=i(),_(),pe(),W=`storybook/clicks`,G=ce(B,N),K={title:`Packages/Premium Analytics/Widgets/Clicks`,component:A,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`The "Clicks" widget. Shows the most-clicked external domains as a ranked leaderboard, using the global dashboard date range. Top-level rows drill down into clicked destination URLs when available.`}}}},q={render:V,args:{withComparison:!1},decorators:[C,S]},J={render:V,args:{withComparison:!0},decorators:[C,S]},Y={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/clicks`,`loading`),()=>w(`stats/clicks`,null))},X={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/clicks`,`error`),()=>w(`stats/clicks`,null))},Z={render:()=>H(`last-365-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/clicks`,`empty`),()=>w(`stats/clicks`,null))},Q={render:e=>(0,U.jsx)(we,{...e}),args:{...fe,withComparison:!0},argTypes:{...ae,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
