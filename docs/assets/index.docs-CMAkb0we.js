import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-Pg3RRsmR.js";import{i as r,n as i,r as a,t as o}from"./blocks-3rsb31vA.js";import{t as s}from"./mdx-react-shim-Ch7qQ0dN.js";import{AspectRatio as c,Calendar as l,Compact as u,Default as d,ErrorStates as f,FixedDimensions as p,LargeValues as m,MaximumCellSize as h,MinimumCellSize as g,WithCompositionLegend as _,n as v,t as y}from"./index.stories-DnARXo-b.js";function b(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(i,{title:`JS Packages/Charts Library/Charts/Heatmap Chart`,of:y}),`
...
`,(0,S.jsxs)(t.li,{children:[(0,S.jsx)(t.strong,{children:(0,S.jsx)(t.code,{children:`primaryColor`})}),`: color the scale interpolates toward at the highest value. Defaults to the first series palette color, `,(0,S.jsx)(t.code,{children:`--a8c-charts-color-series-1`})]}),`
...
`,(0,S.jsxs)(t.p,{children:[`The heatmap resolves its full-intensity color in this order: the `,(0,S.jsx)(t.code,{children:`primaryColor`}),` prop wins, then the first series palette color (`,(0,S.jsx)(t.code,{children:`--a8c-charts-color-series-1`}),`). The resolved color is fed to CSS `,(0,S.jsx)(t.code,{children:`color-mix`}),`, which derives the lighter shades for lower values.`]}),`
`,(0,S.jsx)(t.p,{children:`Use the prop for one chart, or move the palette slot in CSS to change every chart at once.`}),`
