...
`,(0,c.jsxs)(t.table,{children:[(0,c.jsx)(t.thead,{children:(0,c.jsxs)(t.tr,{children:[(0,c.jsx)(t.th,{children:`Member`}),(0,c.jsx)(t.th,{children:`Note`})]})}),(0,c.jsx)(t.tbody,{children:(0,c.jsxs)(t.tr,{children:[(0,c.jsx)(t.td,{children:(0,c.jsx)(t.code,{children:`isColorPaletteResolved`})}),(0,c.jsxs)(t.td,{children:[(0,c.jsx)(t.code,{children:`false`}),` until the color cache has resolved from the DOM and painted. Use it to defer transitions that would otherwise interpolate from a fallback color.`]})]})})]}),`
