import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{gi as i,js as a,n as o,ui as s,vn as c}from"./build-module-CDRs4YxF.js";import{Tn as ee,t as l}from"./src-DTW6Avdq.js";import{$ as te,G as ne,K as re,Y as u}from"./report-metric-CfF6QW2f.js";import{p as ie,t as ae}from"./src-BKLK-O8P.js";import{M as oe,dn as se,qt as d,t as f}from"./src-DXQx-HLd.js";import{c as p,d as m}from"./chart-tooltip-DPvHn5um.js";import{r as ce,t as le}from"./metric-tile-grid-skeleton-CWB-Eana.js";import{t as ue}from"./widget-state-BcvJNT8Q.js";import{C as h,D as de,E as g,S as _,T as v,b as fe,t as pe,w as me,x as y}from"./src-CS4QJABu.js";var b,x,S,C=e((()=>{b=`_root_1qhg5_2`,x=`_placeholder_1qhg5_11`,S={root:b,placeholder:x}})),w,T,E,D=e((()=>{n(),o(),p(),w=[{id:`total`,label:t(`Total subscribers`,`jetpack-premium-analytics-pkg`)},{id:`paid`,label:t(`Paid subscribers`,`jetpack-premium-analytics-pkg`)},{id:`free`,label:t(`Free subscribers`,`jetpack-premium-analytics-pkg`)},{id:`social`,label:t(`Social followers`,`jetpack-premium-analytics-pkg`)}],T=w.map(e=>e.id),E={icon:s,attributes:[{id:`metrics`,label:t(`Metrics`,`jetpack-premium-analytics-pkg`),type:`array`,relevance:`high`,Edit:m,elements:w.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:T}}}}));function he({metrics:e=T}){let{data:n,isLoading:r,isFetching:i,isError:a,refetch:o}=oe(),s=new Set(e),c=!!n&&Object.values(n).some(e=>e!==void 0),l=w.filter(({id:e})=>s.has(e)).map(({id:e,label:t})=>({key:e,label:t,icon:j[e].icon,value:j[e].count(n)}));return(0,k.jsx)(`div`,{className:S.root,children:(0,k.jsx)(ue,{isLoading:r,isFetching:i,isError:a&&!c,isEmpty:!c,error:{description:t(`We couldn't load subscriber highlights. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:o}]},empty:{icon:ie,description:t(`No subscriber counts available yet.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,k.jsx)(le,{tiles:l.length}),children:l.length===0?(0,k.jsx)(ee,{className:S.placeholder,children:t(`Select at least one metric to display.`,`jetpack-premium-analytics-pkg`)}):(0,k.jsx)(ce,{tiles:l,dataFormat:A})})})}function O({attributes:e={}}){return(0,k.jsx)(te,{attributes:e,children:(0,k.jsx)(he,{metrics:e.metrics})})}var k,A,j,M=e((()=>{f(),ae(),pe(),n(),o(),l(),C(),D(),k=r(),A={type:`number`,options:{useMultipliers:!0,decimals:0}},j={total:{icon:s,count:e=>e?.total_subscribers??0},paid:{icon:i,count:e=>e?.paid_subscribers??0},free:{icon:a,count:e=>e?.email_subscribers??0},social:{icon:c,count:e=>e?.social_followers??0}}})),N,P,F,I,L,R,z,ge=e((()=>{N=`jpa/subscriber-highlights`,P=`Subscriber highlights`,F=`Your subscriber totals at a glance — total, paid, free, and social followers.`,I={content:`A summary of your subscribers — total, paid, free, and social followers.`},L=`subscribers`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function B({metrics:e}){return(0,H.jsx)(O,{attributes:{reportParams:d(),metrics:e}})}function V(){se.removeQueries({queryKey:[`stats`,`subscribers-counts`]})}function _e({metrics:e,...t}){return(0,H.jsx)(v,{...t,widgetType:W,renderModule:U,renderComponent:O,attributes:{reportParams:d(!0),metrics:e}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),g(),h(),fe(),ne(),M(),D(),ge(),H=r(),re(),U=`storybook/subscriber-highlights`,W=_(z,E),G={metrics:{control:`check`,options:T}},K={metrics:T},q={title:`Packages/Premium Analytics/Widgets/SubscriberHighlights`,component:O,tags:[`autodocs`],argTypes:{...G},parameters:{docs:{description:{component:"The \"Subscriber highlights\" widget. Shows current subscriber totals — total, paid, free, and social followers — as a grid of metric tiles. Which tiles appear is controlled by the `metrics` attribute (`relevance: 'high'`), exposed inline in the widget header and in the settings drawer. Data comes from the designated `useStatsSubscribersCounts` hook; in Storybook it is served by `registerReportMocks()` (the `subscribers/counts` handler). The counts module has no comparison period, so the tiles show bare counts."}}}},J={render:B,args:{...K},decorators:[y]},Y={render:B,args:{...K},tags:[`!autodocs`],decorators:[y],beforeEach:()=>(V(),u(`subscribers/counts`,`loading`),()=>{u(`subscribers/counts`,null),V()})},X={render:B,args:{...K},tags:[`!autodocs`],decorators:[y],beforeEach:()=>(V(),u(`subscribers/counts`,`error`),()=>{u(`subscribers/counts`,null),V()})},Z={render:B,args:{...K},tags:[`!autodocs`],decorators:[y],beforeEach:()=>(V(),u(`subscribers/counts`,`empty`),()=>{u(`subscribers/counts`,null),V()})},Q={render:e=>(0,H.jsx)(_e,{...e}),args:{...me,widgetWidth:1,widgetHeight:1,...K},argTypes:{...de,...G}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
