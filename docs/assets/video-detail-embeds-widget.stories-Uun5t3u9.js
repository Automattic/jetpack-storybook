import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{n as i,o as a}from"./build-module-DoJYX5DX.js";import{$ as ee,G as o,H as s,U as c,Y as l}from"./report-metric-B88CITdf.js";import{R as te,t as ne,u as re}from"./build-module-OKEcXh_B.js";import{Et as ie,kr as u,ur as d,xt as f}from"./chart-tooltip-DYeL-Ebj.js";import{t as p}from"./chart-empty-state-DGzeBdNY.js";import{t as m}from"./widget-state-D2kmnSNs.js";import{r as h}from"./src-Dp-oMZrx.js";import{C as g,D as _,E as v,S as ae,T as oe,b as se,t as ce,w as y,x as b}from"./src-DuJJqcEZ.js";var x,S,C,w,T,E,le=e((()=>{x=`_root_p2q2t_1`,S=`_content_p2q2t_11`,C=`_list_p2q2t_24`,w=`_item_p2q2t_32`,T=`_link_p2q2t_41`,E={root:x,content:S,list:C,item:w,link:T}}));function ue({pages:e}){return(0,k.jsx)(`ul`,{className:E.list,children:e.map((e,t)=>{let n=h(e.link);return(0,k.jsx)(`li`,{className:E.item,children:n?(0,k.jsx)(re,{className:E.link,href:n,variant:`unstyled`,openInNewTab:!0,title:e.label,children:e.label}):(0,k.jsx)(`span`,{className:E.link,title:e.label,children:e.label})},`${t}-${e.link}`)})})}function D(){let{reportParams:e}=ee(),n=u(e.post_id),{data:r,isLoading:i,isFetching:o,isError:s,refetch:c}=ie(n),l;if(n<=0)l=(0,k.jsx)(p,{icon:a,text:t(`Select a video to see where it is embedded across your site.`,`jetpack-premium-analytics-pkg`)});else{let e=r?.pages??[];l=(0,k.jsx)(m,{isLoading:i,isFetching:o,isError:e.length===0&&s,isEmpty:e.length===0,error:{description:t(`We couldn't load video embeds. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:()=>void c()}]},empty:{icon:a,description:t(`This video has not been embedded on any pages yet.`,`jetpack-premium-analytics-pkg`)},children:(0,k.jsx)(ue,{pages:e})})}return(0,k.jsx)(te,{className:E.root,children:(0,k.jsx)(`div`,{className:E.content,children:l})})}function O({attributes:e={}}){return(0,k.jsx)(l,{attributes:e,children:(0,k.jsx)(D,{})})}var k,de=e((()=>{f(),ce(),n(),i(),ne(),le(),k=r()})),A,fe=e((()=>{i(),A={icon:a}})),j,M,N,P,F,I,L,R=e((()=>{j=`jpa/video-detail-embeds`,M=`Video embeds`,N=`Pages where the selected video is embedded, sourced from Jetpack Stats.`,P={content:`Lists every page on your site where the selected video is embedded, so you can see where it is being watched.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},F=`stats`,I=`framed`,L={name:j,title:M,description:N,help:P,category:F,presentation:I}}));function z(e,t=!1){return{...d(t,e),post_id:G}}function B(){return(0,H.jsx)(O,{attributes:{reportParams:z()}})}function V(e){return(0,H.jsx)(O,{attributes:{reportParams:z(e)}})}function pe(e){return(0,H.jsx)(oe,{...e,widgetType:ae(L,A),renderModule:U,renderComponent:O,attributes:{reportParams:z(void 0,!0)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),s(),v(),g(),se(),de(),fe(),R(),H=r(),c(),U=`storybook/video-detail-embeds`,W=`stats/video/`,G=105,K={title:`Packages/Premium Analytics/Widgets/VideoDetailEmbeds`,component:O,tags:[`autodocs`],parameters:{docs:{description:{component:"Dashboard widget listing the pages where a single video is embedded, sourced from the Jetpack Stats `stats/video/%d` module via `useStatsSingleVideo`. The widget is scoped to one video through the host-composed `reportParams.post_id`; without one it prompts to select a video. In Storybook the data is served by `registerReportMocks`."}}}},q={render:B,decorators:[b]},J={render:()=>(0,H.jsx)(O,{attributes:{reportParams:d(!1)}}),decorators:[b]},Y={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(o(W,`loading`),()=>o(W,null))},X={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(o(W,`error`),()=>o(W,null))},Z={render:()=>V(`last-365-days`),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(o(W,`empty`),()=>o(W,null))},Q={render:e=>(0,H.jsx)(pe,{...e}),args:{...y},argTypes:{..._}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
