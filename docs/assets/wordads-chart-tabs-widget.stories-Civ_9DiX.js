import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DQ5lAs4a.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{N as i,t as a}from"./build-module-DMs68Vfd.js";import{n as o,rl as s}from"./build-module-Bt8gOW8e.js";import{P as c,T as l,d as u,ln as d,on as f,s as p,yn as m}from"./hooks-9BL1g4a6.js";import{t as h,v as g}from"./src-CT5b53ej.js";import{t as ee}from"./metric-tabs-chart-CohkhzYl.js";import{i as _,n as te,t as v}from"./register-report-mocks-C_N-d0uN.js";import{t as ne}from"./widget-state-BPXWTMgP.js";import{S as re,b as ie,t as ae,x as oe,y as se}from"./src-BnOGyYfp.js";import{n as ce,t as le}from"./src-BIoci1og.js";var y,b,x,S=e((()=>{n(),y={type:`currency`,options:{decimals:2}},b=[{id:`impressions`,label:t(`Ads Served`,`jetpack-premium-analytics`)},{id:`cpm`,label:t(`Average CPM`,`jetpack-premium-analytics`),dataFormat:y},{id:`revenue`,label:t(`Revenue`,`jetpack-premium-analytics`),dataFormat:y}],x=b.map(e=>e.id)})),C,w,ue=e((()=>{C=`_root_dimrf_1`,w={root:C}}));function T(e,t){return Number(e?.summary?.[t]??0)}function E(e,t){return(e?.data??[]).map(e=>({date:m(e.date_start),value:Number(e[t]??0)}))}function D(e,t,n,r,i,a){let o=n?E(t,r):void 0,s=!!o?.length;return{key:r,label:i,value:T(e,r),previousValue:s?T(t,r):void 0,current:E(e,r),previous:s?o:void 0,dataFormat:a}}function O(e,t){return{...e,period:t}}function k(e,t,n=x){let{primary:r,comparison:a,hasComparison:o,isLoading:s,isFetching:l,isError:u,refetch:f}=c((0,i.useMemo)(()=>O(e,t),[e,t])),p=r.data,m=a.data,h=(0,i.useMemo)(()=>p&&m?d(m,p.data.length):m,[p,m]),g=(0,i.useMemo)(()=>{let e=new Set(n);return b.filter(t=>e.has(t.id))},[n]);return{metrics:(0,i.useMemo)(()=>g.map(e=>D(p,h,o,e.id,e.label,e.dataFormat)),[g,p,h,o]),isLoading:s,isFetching:l,isError:u,isEmpty:p!==void 0&&!p.data?.length,refetch:f}}var A=e((()=>{l(),a(),S()}));function j(e){switch(e){case`week`:return`week`;case`month`:case`quarter`:return`month`;case`year`:return`year`;default:return`day`}}function de({granularity:e,metricIds:n}){let{reportParams:r}=u(),{metrics:i,isLoading:a,isFetching:o,isError:s,isEmpty:c,refetch:l}=k(r,e===`auto`?j(r.interval):e,n),d=i.length===0;return(0,N.jsx)(`div`,{className:w.root,children:(0,N.jsx)(ne,{isLoading:d?!1:a,isFetching:d?!1:o,isError:d?!1:s,isEmpty:d||c,error:{description:t(`We couldn't load WordAds data. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:l}]},empty:{icon:g,description:t(d?`Select at least one metric to display.`:`No WordAds data in this period.`,`jetpack-premium-analytics`)},children:(0,N.jsx)(ee,{metrics:i,dataFormat:P,groupLabel:t(`WordAds metric`,`jetpack-premium-analytics`)})})})}function M({attributes:e={}}){return(0,N.jsx)(p,{attributes:e,options:{from:`/`},children:(0,N.jsx)(de,{granularity:e.granularity??`auto`,metricIds:e.metrics})})}var N,P,F=e((()=>{h(),ae(),n(),ue(),A(),N=r(),P={type:`number`,options:{useMultipliers:!0,decimals:0}}})),I,L=e((()=>{n(),o(),le(),S(),I={name:`jpa/wordads-chart-tabs`,title:t(`WordAds`,`jetpack-premium-analytics`),help:{content:t(`Compare ads served, average CPM, and revenue over the selected period, with the previous period overlaid for comparison.`,`jetpack-premium-analytics`)},icon:s,attributes:[{id:`granularity`,label:t(`Group by`,`jetpack-premium-analytics`),type:`text`,elements:[{label:t(`Auto`,`jetpack-premium-analytics`),value:`auto`},{label:t(`By days`,`jetpack-premium-analytics`),value:`day`},{label:t(`By weeks`,`jetpack-premium-analytics`),value:`week`},{label:t(`By months`,`jetpack-premium-analytics`),value:`month`},{label:t(`By years`,`jetpack-premium-analytics`),value:`year`}],relevance:`high`},{id:`metrics`,label:t(`Metrics`,`jetpack-premium-analytics`),type:`array`,relevance:`high`,Edit:ce,elements:b.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{granularity:`auto`,metrics:x}}}}));function R({withComparison:e,metrics:t}){return(0,V.jsx)(M,{attributes:{reportParams:f(e),metrics:t}})}function z(e){return(0,V.jsx)(M,{attributes:{reportParams:f(!1,e)}})}function B({withComparison:e,metrics:t,...n}){return(0,V.jsx)(ie,{...n,widgetType:I,renderModule:H,renderComponent:M,attributes:{reportParams:f(e),metrics:t}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{l(),oe(),v(),S(),F(),L(),V=r(),te(),H=`storybook/wordads-chart-tabs`,U={metrics:{control:`check`,options:x}},W={metrics:x},G=e=>(0,V.jsx)(`div`,{style:{width:`100%`,height:`360px`},children:(0,V.jsx)(e,{})}),K={title:`Packages/Premium Analytics/Widgets/WordAdsChartTabs`,component:M,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`},...U},parameters:{docs:{description:{component:"WordAds performance over the selected period as selectable metric tabs — Ads Served, Average CPM, and Revenue, matching the Calypso WordAds page's tabs — over a comparative line chart. Ads Served is a count; CPM and revenue are currency (WordAds pays USD). The date range and comparison come from the dashboard controls; the \"Group by\" control is the `granularity` attribute and the visible tabs are the `metrics` attribute (both `relevance: 'high'`), exposed by the widget host. WordAds stats are computed nightly, so a range ending today is clamped to end at yesterday. When comparison is on the previous period is overlaid as a same-colour dashed line and each tab shows its period-over-period delta. Data comes from the `useStatsWordAdsStats` hook (the `wordads` proxy prefix); in Storybook it is served by `registerReportMocks`. Requires WordAds to be active on the site for live data."}}}},q={render:R,args:{withComparison:!1,...W},decorators:[G]},J={render:R,args:{withComparison:!0,...W},decorators:[G]},Y={render:()=>z(`last-90-days`),tags:[`!autodocs`],decorators:[G],beforeEach:()=>(_(`wordads/stats`,`loading`),()=>_(`wordads/stats`,null))},X={render:()=>z(`last-7-days`),tags:[`!autodocs`],decorators:[G],beforeEach:()=>(_(`wordads/stats`,`error`),()=>_(`wordads/stats`,null))},Z={render:()=>z(`last-365-days`),tags:[`!autodocs`],decorators:[G],beforeEach:()=>(_(`wordads/stats`,`empty`),()=>_(`wordads/stats`,null))},Q={render:e=>(0,V.jsx)(B,{...e}),args:{...se,withComparison:!0,...W},argTypes:{...re,withComparison:{control:`boolean`},...U}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
