import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{ll as n,n as r}from"./build-module-CDRs4YxF.js";import{K as i,X as a,et as o,q as s}from"./report-metric-Ca_kXAW3.js";import{t as c,x as l}from"./src-HOdOyzOs.js";import{Tt as u,hr as d}from"./chart-tooltip-BQsM5vre.js";import{C as f,D as p,E as m,S as h,T as g,b as _,t as v,u as y,w as b,x}from"./src-C9i3aD_R.js";function S({attributes:e={},setError:t}){return(0,C.jsx)(o,{attributes:e,setError:t,options:{from:`/`},children:(0,C.jsx)(y,{})})}var C,w=e((()=>{v(),C=t()})),T,E=e((()=>{r(),T={icon:n}})),D,O,k,A,j,M,N,P=e((()=>{D=`jpa/bookings-by-status`,O=`Bookings by status`,k=`Number of bookings by status over the selected time period.`,A={content:`Number of bookings by status over the selected time period.`},j=`bookings`,M=`framed`,N={name:D,title:O,description:k,help:A,category:j,presentation:M}}));function F(e=!1,t=U){return{reportParams:d(e,t)}}function I({withComparison:e,preset:t}){let n=!!e,r=t??U;return!n&&r===U?`getDefaultQueryParams()`:n&&r===U?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function L(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<BookingsByStatusRender
\tattributes={ {
\t\treportParams: ${I(e)},
\t} }
/>`}function R({withComparison:e,preset:t}){return(0,V.jsx)(S,{attributes:F(e,t)})}function z(e){return(0,V.jsx)(S,{attributes:F(!1,e)})}function B({withComparison:e,preset:t,...n}){return(0,V.jsx)(g,{...n,widgetType:h(N,T),renderModule:H,renderComponent:S,attributes:{reportParams:d(e,t)}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q;e((()=>{u(),c(),m(),f(),_(),i(),w(),E(),P(),V=t(),s(),H=`storybook/bookings-by-status`,U=`last-30-days`,W=l,G={title:`Packages/Premium Analytics/Widgets/BookingsByStatus`,component:S,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:W,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`Dashboard widget that displays the bookings status breakdown for the selected period.`}}}},K={render:R,args:{preset:U,withComparison:!1},decorators:[x],parameters:{docs:{source:{code:L({withComparison:!1,preset:U})}}}},q={render:R,args:{preset:U,withComparison:!0},decorators:[x],parameters:{docs:{source:{code:L({withComparison:!0,preset:U})}}}},J={render:()=>z(`last-90-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(a(`bookings/by-date`,`loading`),()=>a(`bookings/by-date`,null))},Y={render:()=>z(`last-7-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(a(`bookings/by-date`,`error`),()=>a(`bookings/by-date`,null))},X={render:()=>z(`last-365-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(a(`bookings/by-date`,`empty`),()=>a(`bookings/by-date`,null))},Z={render:e=>(0,V.jsx)(B,{...e}),args:{...b,preset:U,withComparison:!0},argTypes:{...p,preset:{control:`select`,options:W},withComparison:{control:`boolean`}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
