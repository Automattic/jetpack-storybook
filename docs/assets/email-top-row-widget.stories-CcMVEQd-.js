import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{A as i,t as a}from"./build-module-DrryaqBL.js";import{I as o,Mt as s,Nn as c,P as l,Zt as u,ct as d,n as f,ut as ee}from"./build-module-DmVuor49.js";import{R as te,t as ne}from"./build-module-DGTOWfwN.js";import{Dr as re,Ot as ie,cr as p,kt as m,yt as h}from"./chart-tooltip-BYQNoyrS.js";import{t as g}from"./metric-tile-grid-CAJHYIV7.js";import{F as ae,G as oe,L as _,P as se,V as ce}from"./report-metric-DdoNsTp9.js";import{t as le}from"./widget-state-D8NAbhUM.js";import{C as ue,D as v,E as de,S as y,T as b,b as fe,t as pe,w as x,x as S}from"./src-DYmXais9.js";import{n as me,t as he}from"./src-DK7jKR9N.js";var C,w,T,ge=e((()=>{C=`_root_cqnu4_2`,w=`_content_cqnu4_14`,T={root:C,content:w}}));function _e(e,t){let n=Number(e[t]);return Number.isFinite(n)?n:0}function ve(e,t){let n=Number(e[t]);return Number.isFinite(n)&&n!==0?n:null}function ye(e){return!!e&&A.some(t=>{let n=e[t.key];return n!=null&&Number.isFinite(Number(n))})}function be(e,t){let n=[];for(let r of A){if(!r.views.includes(t))continue;let i=r.kind===`rate`?ve(e,r.key):_e(e,r.key);r.hideWhenZero&&!i||n.push({key:r.key,icon:r.icon,label:r.label(),value:i,dataFormat:r.kind===`rate`?k:O})}return n}function xe({metric:e}){let{reportParams:t}=oe(),n=re(t.post_id),r=n>0,a=m(n,`rate`,{enabled:r}),o=ie(n,`rate`,{enabled:r&&e===`clicks`}),s=e===`clicks`?[a,o]:[a],c=a.data?.summary,l=o.data?.summary,u=s.every(e=>e.data!==void 0),d=(0,i.useMemo)(()=>{if(!u)return;let t=e===`clicks`&&c&&l?{...c,...l}:c;return ye(t)?be(t,e):void 0},[u,c,l,e]),f=(0,i.useCallback)(()=>{a.refetch(),e===`clicks`&&o.refetch()},[o,e,a]);return(0,D.jsx)(j,{metrics:d,hasSelection:r,isLoading:s.some(e=>e.isLoading),isFetching:s.some(e=>e.isFetching),isError:s.some(e=>e.isError&&e.data===void 0),onRetry:f})}function E({attributes:e={}}){return(0,D.jsx)(ce,{attributes:e,children:(0,D.jsx)(xe,{metric:e.metric===`clicks`?`clicks`:`opens`})})}var D,O,k,A,j,Se=e((()=>{h(),pe(),a(),n(),f(),ne(),ge(),D=r(),O={type:`number`,options:{useMultipliers:!0,decimals:0}},k={type:`percentage`,options:{decimals:1,signDisplay:`never`}},A=[{key:`total_sends`,icon:l,label:()=>t(`Emails sent`,`jetpack-premium-analytics`),kind:`count`,views:[`opens`]},{key:`unique_opens`,icon:ee,label:()=>t(`Unique opens`,`jetpack-premium-analytics`),kind:`count`,views:[`opens`],hideWhenZero:!0},{key:`total_opens`,icon:o,label:()=>t(`Total opens`,`jetpack-premium-analytics`),kind:`count`,views:[`opens`,`clicks`]},{key:`opens_rate`,icon:d,label:()=>t(`Open rate`,`jetpack-premium-analytics`),kind:`rate`,views:[`opens`]},{key:`total_clicks`,icon:s,label:()=>t(`Total clicks`,`jetpack-premium-analytics`),kind:`count`,views:[`clicks`]},{key:`clicks_rate`,icon:c,label:()=>t(`Click rate`,`jetpack-premium-analytics`),kind:`rate`,views:[`clicks`]}],j=({metrics:e,hasSelection:n=!1,isLoading:r=!1,isFetching:i=!1,isError:a=!1,onRetry:o})=>(0,D.jsx)(te,{className:T.root,children:(0,D.jsx)(`div`,{className:T.content,children:(0,D.jsx)(le,{isLoading:r,isFetching:i,isError:a,isEmpty:!e||e.length===0,error:{description:t(`We couldn't load this email's stats. Please try again in a moment.`,`jetpack-premium-analytics`),actions:o?[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:o}]:void 0},empty:{icon:u,description:t(n?`No stats are available for this email yet.`:`Select an email to see its stats.`,`jetpack-premium-analytics`)},children:(0,D.jsx)(g,{tiles:e??[]})})})})})),M,Ce=e((()=>{n(),f(),he(),M={icon:u,attributes:[{id:`metric`,label:t(`View by`,`jetpack-premium-analytics`),type:`text`,Edit:me,elements:[{label:t(`Opens`,`jetpack-premium-analytics`),value:`opens`},{label:t(`Clicks`,`jetpack-premium-analytics`),value:`clicks`}]}],example:{attributes:{metric:`opens`}}}})),N,P,F,I,L,R,z,we=e((()=>{N=`jpa/email-top-row`,P=`Email highlights`,F=`Headline open and click totals for a single email, split into Opens and Clicks views.`,I={content:`Headline stats for a single email. The Opens view shows total sends, unique opens, total opens, and open rate; the Clicks view shows total sends, unique opens, total clicks, and click rate. Rates are measured against total sends. Figures are all-time and are not affected by the dashboard date range.`},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function B({metric:e},t=U){return(0,V.jsx)(E,{attributes:{metric:e,reportParams:{...p(),post_id:t}}})}function Te({metric:e,...t}){return(0,V.jsx)(b,{...t,widgetType:y(z,M),renderModule:H,renderComponent:E,attributes:{metric:e,reportParams:{...p(!0),post_id:U}}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{h(),de(),se(),ue(),fe(),Se(),Ce(),we(),V=r(),ae(),H=`storybook/email-top-row`,U=2e3,W=`stats/opens/emails`,G={title:`Packages/Premium Analytics/Widgets/EmailTopRow`,component:E,tags:[`autodocs`],argTypes:{metric:{control:`inline-radio`,options:[`opens`,`clicks`]}},parameters:{docs:{description:{component:'The "Email top row" widget. Shows a single email\'s all-time headline totals as a row of metric tiles, switching between the Opens view (total sends, unique opens, total opens, open rate) and the Clicks view (total sends, unique opens, total clicks, click rate) via the `metric` attribute. The email is selected by the host through `reportParams.post_id`. Clicks combines the per-post opens and clicks rate summaries; both endpoints are all-time and return no comparison rows, so the widget ignores the dashboard date range and never shows period-over-period deltas.'}}}},K={render:e=>B(e),args:{metric:`opens`},decorators:[S]},q={render:e=>B(e),args:{metric:`clicks`},decorators:[S]},J={render:e=>B(e,2001),tags:[`!autodocs`],args:{metric:`opens`},decorators:[S],beforeEach:()=>(_(W,`loading`),()=>_(W,null))},Y={render:e=>B(e,2002),tags:[`!autodocs`],args:{metric:`opens`},decorators:[S],beforeEach:()=>(_(W,`error`),()=>_(W,null))},X={render:e=>B(e,2003),tags:[`!autodocs`],args:{metric:`opens`},decorators:[S],beforeEach:()=>(_(W,`empty`),()=>_(W,null))},Z={render:({metric:e})=>(0,V.jsx)(E,{attributes:{metric:e,reportParams:p()}}),args:{metric:`opens`},decorators:[S]},Q={render:e=>(0,V.jsx)(Te,{...e}),args:{...x,metric:`opens`},argTypes:{...v,metric:{control:`inline-radio`,options:[`opens`,`clicks`]}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
