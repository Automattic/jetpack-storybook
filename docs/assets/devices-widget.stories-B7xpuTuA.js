import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{t as i,zi as a}from"./build-module-2iv4IIRq.js";import{Ot as o,Rt as s,m as c,u as l,v as u}from"./hooks-D2-uOzcc.js";import{T as d,t as f}from"./src-C-E2d-Lb.js";import{n as p,t as m}from"./src-D7xPirJb.js";import{$t as h,t as g,w as ee}from"./src-0ge7d6kt.js";import"./constants-B1kGztHF.js";import{t as te}from"./donut-chart-skeleton-Bqy7YGT5.js";import{t as ne}from"./semi-circle-chart-DguPaGjR.js";import{i as re,r as ie}from"./register-report-mocks-DAHzORiq.js";import{L as ae}from"./report-metric--Et_iyvv.js";import{t as oe}from"./widget-state-BlFCjv4l.js";import{t as _}from"./src-Ddik3icB.js";import{a as se,d as ce,f as le,i as ue,n as de,p as fe,r as v,u as y}from"./with-widget-canvas-q45aoI9y.js";import{n as pe,t as me}from"./register-stats-mocks-BZi9sgqC.js";import{n as he,t as b}from"./force-stats-mock-state-DzBZCkRi.js";var x,S,C,w,T,ge=e((()=>{x=`_root_1ego9_1`,S=`_content_1ego9_9`,C=`_chartWrap_1ego9_16`,w=`_chartShell_1ego9_24`,T={root:x,content:S,chartWrap:C,chartShell:w}}));function _e(e){let t=typeof e.label==`string`?e.label:String(e.label);return{label:t,displayLabel:s(t,E),percentage:e.value,previousPercentage:e.previousValue}}function ve({reportParams:e,max:t,deviceProperty:n=`screensize`}){let{comparisonRows:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:l}=ee({...e,deviceProperty:n},{maxRows:t}),u=(r?.rows??[]).map(_e),d=u.length===0&&s;return{data:u,hasComparison:i,isLoading:a,isFetching:o,isError:d,error:d?c:null,refetch:l}}var E,ye=e((()=>{n(),g(),_(),E={desktop:t(`Desktop`,`jetpack-premium-analytics-pkg`),mobile:t(`Mobile`,`jetpack-premium-analytics-pkg`),tablet:t(`Tablet`,`jetpack-premium-analytics-pkg`),phone:t(`Phone`,`jetpack-premium-analytics-pkg`),unknown:t(`Unknown`,`jetpack-premium-analytics-pkg`)}}));function D(e){return e/100}function be(){let{reportParams:e}=u(),{data:n,hasComparison:r,isLoading:i,isFetching:a,isError:s,error:c,refetch:f}=ve({reportParams:e,max:10,deviceProperty:`screensize`}),m=n.map(e=>({label:e.displayLabel,value:D(e.percentage)})),h=l(m),g=n.map(e=>({label:e.displayLabel,value:D(e.percentage),displayValue:p(D(e.percentage),A.type,A.options),comparison:r&&e.previousPercentage!==void 0?D(e.previousPercentage):void 0})).map((e,t)=>({...e,color:h[t]?.color}));return(0,k.jsx)(`div`,{className:T.content,children:(0,k.jsx)(oe,{isLoading:i,isFetching:a,isError:s,isEmpty:n.length===0,error:o(c,{retryDescription:t(`We couldn't load device data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:f}),empty:{icon:d,description:t(`No device data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,k.jsx)(te,{}),children:(0,k.jsx)(`div`,{className:T.chartWrap,children:(0,k.jsxs)(`div`,{className:T.chartShell,children:[(0,k.jsx)(ne,{chartData:m,styles:h,showLegend:!1,showMetric:!1,withTooltips:!0,dataFormat:A}),(0,k.jsx)(ae,{items:g,withComparison:r})]})})})})}function O({attributes:e={}}){return(0,k.jsx)(c,{attributes:e,children:(0,k.jsx)(`div`,{className:T.root,children:(0,k.jsx)(be,{})})})}var k,A,xe=e((()=>{m(),f(),n(),_(),ge(),ye(),k=r(),A={type:`percentage`,options:{decimals:1,signDisplay:`auto`}}})),j,M=e((()=>{i(),j={icon:a,attributes:[],example:{attributes:{}}}})),N,P,F,I,L,R,z,Se=e((()=>{N=`jpa/devices`,P=`Devices`,F=`Top device types and screen sizes for your visitors.`,I={content:`A breakdown of the device types your visitors used, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},L=`traffic`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function B({withComparison:e}){return(0,H.jsx)(O,{attributes:{reportParams:h(e)}})}function V(e){return(0,H.jsx)(O,{attributes:{reportParams:h(!1,e)}})}function Ce(e){return(0,H.jsx)(O,{...e})}function we({withComparison:e,...t}){return(0,H.jsx)(ce,{...t,widgetType:W,renderModule:U,renderComponent:Ce,attributes:{reportParams:h(e)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{g(),le(),se(),de(),ie(),me(),he(),xe(),M(),Se(),H=r(),re(),pe(),U=`storybook/devices`,W=ue(z,j),G={title:`Packages/Premium Analytics/Widgets/Devices`,component:O,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`The "Devices" widget. Shows screen size breakdown (Desktop / Mobile / Tablet) as a semi-circle chart, using the global dashboard date range.`}}}},K={render:B,args:{withComparison:!1},decorators:[v]},q={render:B,args:{withComparison:!0},decorators:[v]},J={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>(b(`stats/devices/screensize`,`loading`),()=>b(`stats/devices/screensize`,null))},Y={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>(b(`stats/devices/screensize`,`error`),()=>b(`stats/devices/screensize`,null))},X={render:()=>V(`last-12-months`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>(b(`stats/devices/screensize`,`error-retryable`),()=>b(`stats/devices/screensize`,null))},Z={render:()=>V(`last-year`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>(b(`stats/devices/screensize`,`empty`),()=>b(`stats/devices/screensize`,null))},Q={render:e=>(0,H.jsx)(we,{...e}),args:{...y,withComparison:!0},argTypes:{...fe,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
