import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{f as ee,n as r,t as i}from"./build-module-yGZutq_9.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{C as o,Dn as te,t as s}from"./build-module-zwSmKorH.js";import{X as ne,t as c}from"./date-fns-CeH7Uo-X.js";import{C as re,Mn as l,Nn as ie,W as u,c as d,mt as f,y as p}from"./wp-date-settings-D7Dw_ehg.js";import{i as ae}from"./heatmap-chart-DtlzPRyx.js";import{p as oe,t as m,u as h}from"./src-B477hvom.js";import{s as g,t as _}from"./src-MiHNqkzm.js";import{R as se,Tn as ce,en as v,i as y}from"./date-filters-panel-CL3qn31G.js";import{t as le}from"./adaptive-calendar-heatmap-D7skH7FF.js";import{r as b}from"./metric-sparkline-skeleton-CP_k4S5G.js";import{i as x,o as ue}from"./monthly-heatmap-DfI7liGX.js";import{U as S,W as C,q as w}from"./report-metric-d8Y1xs7h.js";import{t as de}from"./widget-state-DGU3O5nt.js";import{C as fe,D as pe,E as me,S as he,T as ge,b as _e,t as ve,w as ye,x as T}from"./src-BdLKHinb.js";function be({value:e,cellLabel:t}){return(0,O.jsx)(x,{value:e,cellLabel:t,emptyLabel:r(`No views`,`jetpack-premium-analytics-pkg`),formatValue:u})}function xe(){let{reportParams:e}=re(),t=ie(d()),n=ne(oe(),`yyyy-MM-dd`),i=(0,D.useMemo)(()=>l(e,{maxDays:t},n),[e,t,n]),a=(0,D.useMemo)(()=>l(e,{},n),[e,n]).startDate<i.startDate,{primary:o,isLoading:s,isFetching:c,isError:u,error:p,refetch:m}=se((0,D.useMemo)(()=>ce({...e,from:i.startDate,to:i.endDate,period:`day`,stat_fields:`views`}),[e,i])),_=o.data,v=(0,D.useMemo)(()=>new Map((_?.data??[]).map(e=>{let t=Number(e.views??0);return[String(e.time_interval),t>0?t:null]})),[_]),y=(_?.data??[]).some(e=>{let t=String(e.time_interval);return Number(e.views??0)>0&&t>=i.startDate&&t<=i.endDate}),x=h(i.startDate),S=h(i.endDate),C=a&&x&&S?ee(r(`No views between %1$s and %2$s.`,`jetpack-premium-analytics-pkg`),g(x,`compact`),g(S,`compact`)):r(`No views in this period.`,`jetpack-premium-analytics-pkg`);return(0,O.jsx)(le,{valueByDay:v,period:i,children:(e,t)=>(0,O.jsx)(de,{isLoading:s,isFetching:c,isError:u&&!y,isEmpty:!y,error:f(p,{retryDescription:r(`We couldn't load your traffic activity. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:m}),empty:{icon:te,description:C},renderLoading:(0,O.jsx)(b,{}),children:(0,O.jsx)(ue,{pager:t,children:(0,O.jsx)(ae,{...e,primaryColor:`var(--wp-admin-theme-color, #3858e9)`,withTooltips:!0,renderTooltip:be})})})})}function E({attributes:e={}}){return(0,O.jsx)(p,{attributes:e,children:(0,O.jsx)(xe,{})})}var D,O,k=t((()=>{y(),m(),_(),ve(),i(),s(),c(),D=e(n(),1),O=a()})),A,j=t((()=>{s(),A={icon:o}})),M,N,P,F,I,L,R,Se=t((()=>{M=`jpa/traffic-views-activity`,N=`Traffic views activity`,P=`Daily views across the whole site, as a calendar heatmap.`,F={content:`Your daily views, shown as a heatmap to help you spot busy days and quieter stretches.`},I=`stats`,L=`framed`,R={name:M,title:N,description:P,help:F,category:I,presentation:L}}));function z(e=G){return(0,H.jsx)(E,{attributes:{reportParams:v(!1,e)}})}function B(e){return w(U,e),()=>{w(U,null)}}function V(e){return(0,H.jsx)(ge,{...e,widgetType:he(R,A),renderModule:W,renderComponent:E,attributes:{reportParams:v(!0,G)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{y(),S(),fe(),me(),_e(),k(),j(),Se(),H=a(),C(),U=`stats/visits`,W=`storybook/traffic-views-activity`,G=`last-365-days`,K={title:`Packages/Premium Analytics/Widgets/TrafficViewsActivity`,component:E,tags:[`autodocs`],parameters:{docs:{description:{component:`The "Traffic views activity" widget shows daily site views as a calendar heatmap. Days without views are blank, and older weeks are hidden when space is limited.`}}}},q={render:()=>z(),decorators:[T]},J={render:()=>z(`last-90-days`),tags:[`!autodocs`],decorators:[T],beforeEach:()=>B(`loading`)},Y={render:()=>z(`last-7-days`),tags:[`!autodocs`],decorators:[T],beforeEach:()=>B(`error`)},X={render:()=>z(`last-30-days`),tags:[`!autodocs`],decorators:[T],beforeEach:()=>B(`error-retryable`)},Z={render:()=>z(`today`),tags:[`!autodocs`],decorators:[T],beforeEach:()=>B(`empty`)},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...ye,widgetWidth:3,widgetHeight:1,rowHeight:200},argTypes:{...pe}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
