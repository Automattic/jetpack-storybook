import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n,u as r}from"./build-module-2QZQpBH2.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{A as a,t as o}from"./build-module-DrryaqBL.js";import{f as s,n as c}from"./build-module-DoJYX5DX.js";import{E as ee,G as l,S as u,W as d,Z as te,b as ne,tt as re,w as ie}from"./report-metric-BSNNRPgL.js";import{K as ae,t as f}from"./src-9LSLqTC1.js";import{t as p,v as oe}from"./src-CtuUAdXm.js";import{r as se}from"./hooks-Bb776u8J.js";import{Bt as m,J as ce,X as le,d as ue,q as h,ur as g,xt as _}from"./chart-tooltip-BRZ2PClR.js";import{t as de}from"./leaderboard-chart-DhGcDyhH.js";import{C as v,D as y,E as b,O as x,S as fe,T as pe,b as me,k as S,t as he,w as ge,x as C}from"./src-BE9SVcov.js";import{t as _e}from"./widget-state-CFIUT-OU.js";import{n as ve,t as ye}from"./src-B9TbHIqV.js";import{n as be,t as xe}from"./register-stats-mocks-D7-EkRu0.js";import{n as Se,t as w}from"./force-stats-mock-state-DUWncukU.js";var T,E,D,O,k,A,j,Ce=e((()=>{T=`_root_sv0g9_1`,E=`_content_sv0g9_9`,D=`_backLink_sv0g9_17`,O=`_itemLabel_sv0g9_25`,k=`_itemLabelInset_sv0g9_37`,A=`_itemLabelText_sv0g9_41`,j={root:T,content:E,backLink:D,itemLabel:O,itemLabelInset:k,itemLabelText:A}}));function M(e){return typeof e.label==`string`?e.label:String(e.label)}function we(e){return{postId:e.id,label:M(e),value:e.value,previousValue:e.previousValue,href:e.href}}function Te(e){return{label:M(e),value:e.value,previousValue:e.previousValue,children:e.children?.map(we),childrenHaveComparison:e.childrenHaveComparison}}function Ee({reportParams:e,utmParam:t,max:n}){let{comparisonRows:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:ee}=m({...e,utmParam:t,max:n},{maxRows:n}),l=(r?.rows??[]).map(Te),u=l.length===0&&s;return{data:l,hasComparison:i,isLoading:a,isFetching:o,isError:u,error:u?c:null,refetch:ee}}var De=e((()=>{_()}));function Oe(e){switch(e){case`utm_source,utm_medium`:return`source-medium`;case`utm_campaign,utm_source,utm_medium`:return`campaign-source-medium`;case`utm_source`:return`source`;case`utm_medium`:return`medium`;case`utm_campaign`:return`campaign`}}function ke({utmDimension:e,max:n,showReportLink:i}){let{reportParams:o}=re(),{drillDownItem:s,drillDown:c,resetDrillDown:l}=se();(0,a.useEffect)(()=>{l()},[l,e]);let{data:d,hasComparison:te,isLoading:f,isFetching:p,isError:m,error:g,refetch:_}=Ee({reportParams:o,utmParam:e,max:n}),v=(0,a.useMemo)(()=>d.find(e=>e.label===s)??null,[d,s]),y=!!v?.children?.length,b=(0,a.useMemo)(()=>y?v?.children??[]:d,[d,y,v]),x=y?!!v?.childrenHaveComparison:te;(0,a.useEffect)(()=>{s&&!y&&!f&&!p&&!m&&l()},[s,y,f,p,m,l]);let fe=(0,a.useMemo)(()=>{let e=ce(b.map(e=>e.value),x?b.map(e=>e.previousValue):[]);return b.map((n,i)=>{let a=n.previousValue,o=`postId`in n?n:null;return{id:`${i}-${n.label}`,label:o?(0,P.jsx)(ne,{id:o.postId,label:o.label,link:o.href,variant:`overlay`,className:j.itemLabelInset}):(0,P.jsx)(`span`,{className:j.itemLabel,children:(0,P.jsx)(ae,{className:j.itemLabelText,children:n.label})}),currentValue:n.value,currentShare:h(n.value,e),previousValue:a,previousShare:x&&a!==void 0?h(a,e):void 0,delta:x&&a!==void 0?le(n.value,a):void 0,...!y&&`children`in n&&n.children?.length&&{onClick:()=>c(n.label),ariaLabel:r(t(`View posts for %s`,`jetpack-premium-analytics-pkg`),n.label)}}})},[b,y,c,x]);return(0,P.jsxs)(P.Fragment,{children:[y?(0,P.jsx)(ee,{label:t(`All UTM Insights`,`jetpack-premium-analytics-pkg`),ariaLabel:t(`View all UTM insights`,`jetpack-premium-analytics-pkg`),onClick:l,className:j.backLink}):null,(0,P.jsx)(`div`,{className:j.content,children:(0,P.jsx)(_e,{isLoading:f,isFetching:p,isError:m,isEmpty:d.length===0,error:ue(g,{retryDescription:t(`We couldn't load UTM data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:_}),empty:{icon:oe,description:t(`No UTM data in this period.`,`jetpack-premium-analytics-pkg`)},children:(0,P.jsx)(de,{data:fe,withComparison:x,withOverlayLabel:!0,showLegend:!1,dataFormat:F})})}),i&&(0,P.jsx)(ie,{children:(0,P.jsx)(u,{report:`utm`,section:Oe(e)})})]})}function N({attributes:e={}}){let t=e.utmDimension??I,n=e.max??10,r=e.showReportLink??!0;return(0,P.jsx)(te,{attributes:e,children:(0,P.jsx)(`div`,{className:j.root,children:(0,P.jsx)(ke,{utmDimension:t,max:n,showReportLink:r})})})}var P,F,I,Ae=e((()=>{o(),n(),f(),he(),p(),Ce(),De(),P=i(),F={type:`number`,options:{useMultipliers:!0,decimals:0}},I=`utm_source,utm_medium`})),L,je=e((()=>{n(),c(),ye(),L={icon:s,attributes:[{id:`utmDimension`,label:t(`UTM parameter`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:ve,elements:[{label:t(`Source / Medium`,`jetpack-premium-analytics-pkg`),value:`utm_source,utm_medium`},{label:t(`Campaign / Source / Medium`,`jetpack-premium-analytics-pkg`),value:`utm_campaign,utm_source,utm_medium`},{label:t(`Source`,`jetpack-premium-analytics-pkg`),value:`utm_source`},{label:t(`Medium`,`jetpack-premium-analytics-pkg`),value:`utm_medium`},{label:t(`Campaign`,`jetpack-premium-analytics-pkg`),value:`utm_campaign`}],relevance:`high`},{id:`max`,label:t(`Number of results`,`jetpack-premium-analytics-pkg`),type:`integer`}],example:{attributes:{utmDimension:`utm_source,utm_medium`,max:10}}}})),R,z,B,V,Me,Ne,Pe,Fe=e((()=>{R=`jpa/utm-insights`,z=`Top UTM`,B=`Traffic breakdown by UTM parameters — source, medium, campaign, and combinations.`,V={content:`Your top UTM campaigns, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},Me=`traffic`,Ne=`framed`,Pe={name:R,title:z,description:B,help:V,category:Me,presentation:Ne}}));function H(e){return(0,U.jsx)(N,{attributes:{utmDimension:`utm_source,utm_medium`,max:10,reportParams:g(!1,e)}})}function Ie({withComparison:e,...t}){return(0,U.jsx)(pe,{...t,widgetType:Le,renderModule:W,renderComponent:N,attributes:{utmDimension:`utm_source,utm_medium`,max:10,reportParams:g(e)}})}var U,W,Le,Re,G,K,q,J,Y,X,Z,Q,$;e((()=>{_(),b(),x(),v(),me(),d(),xe(),Se(),Ae(),je(),Fe(),U=i(),l(),be(),W=`storybook/utm-insights`,Le=fe(Pe,L),Re={title:`Packages/Premium Analytics/Widgets/UtmInsights`,component:N,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params and deltas.`}},parameters:{docs:{description:{component:`The "UTM Insights" widget. Shows traffic breakdown by UTM parameter as a ranked leaderboard. The active dimension (Source/Medium, Campaign, etc.) is switched via a dropdown in the widget header and persisted per widget instance.`}}}},G={render:({withComparison:e})=>(0,U.jsx)(N,{attributes:{utmDimension:`utm_source,utm_medium`,max:10,reportParams:g(e)}}),args:{withComparison:!1},decorators:[C,S]},K={render:({withComparison:e})=>(0,U.jsx)(N,{attributes:{utmDimension:`utm_source,utm_medium`,max:10,reportParams:g(e)}}),args:{withComparison:!0},decorators:[C,S]},q={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/utm`,`loading`),()=>w(`stats/utm`,null))},J={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/utm`,`error`),()=>w(`stats/utm`,null))},Y={render:()=>H(`last-12-months`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/utm`,`error-retryable`),()=>w(`stats/utm`,null))},X={render:()=>H(`last-365-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/utm`,`empty`),()=>w(`stats/utm`,null))},Z={render:({withComparison:e})=>(0,U.jsx)(N,{attributes:{utmDimension:`utm_campaign`,max:10,reportParams:g(e)}}),args:{withComparison:!1},decorators:[C,S]},Q={render:e=>(0,U.jsx)(Ie,{...e}),args:{...ge,withComparison:!1},argTypes:{...y,withComparison:{control:`boolean`,description:`Include previous-period comparison report params and deltas.`}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
  render: ({
    withComparison
