import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-2QZQpBH2.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{Sl as o,t as s}from"./build-module-2iv4IIRq.js";import{X as c,t as l}from"./date-fns-I6jayRk5.js";import{m as ee,v as te}from"./hooks-DWWWq212.js";import{t as ne,x as u}from"./src-C-E2d-Lb.js";import{S as re,b as ie,t as ae}from"./src-BNPYbbO9.js";import{l as oe,t as se}from"./src-D5G88KHc.js";import{$t as d,I as f,On as ce,t as p}from"./src-CUmH3sTN.js";import{B as le}from"./helpers-Dbmd4FKa.js";import{t as ue}from"./metric-sparkline-skeleton-BruXraPK.js";import{c as m,i as h,r as g}from"./register-report-mocks-BW28HUEP.js";import{z as _}from"./report-metric-DEas32kQ.js";import{t as de}from"./widget-state-DtrFKpS2.js";import{t as v}from"./src-COQnGA-f.js";import{a as fe,d as pe,f as me,i as he,n as ge,p as _e,r as y,u as ve}from"./with-widget-canvas-dF4iMX2D.js";var b,x,ye=t((()=>{b=`_root_1j6if_1`,x={root:b}}));function be(e){return oe(e)}function xe(e){let t=ie(e.date_start??e.time_interval??e.period);return t?re(t,C):null}function Se(e){let t=e.views??e.value;return typeof t==`number`?t:Number(t??0)||0}function Ce(e){let t=Array.from({length:7},()=>({total:0,occurrences:0}));return e.forEach(e=>{let n=xe(e);if(!n)return;let r=(c(n)+6)%7;t[r].total+=Se(e),t[r].occurrences+=1}),t.map(({total:e,occurrences:t},n)=>({weekday:n,label:be(n),total:e,occurrences:t,average:t?e/t:0}))}function S(e){return e.filter(e=>e.occurrences>0&&e.total>0).reduce((e,t)=>!e||t.average>e.average?t:e,void 0)}var C,w=t((()=>{ae(),se(),l(),C=`yyyy-MM-dd`}));function T(){let{reportParams:e}=te(),{primary:t,isLoading:n,isFetching:r,isError:i,error:a,refetch:o}=f((0,E.useMemo)(()=>ce({...e,stat_fields:O,period:D}),[e])),s=t.data,c=(0,E.useMemo)(()=>Ce(s?.data??[]),[s]);return{buckets:c,peak:(0,E.useMemo)(()=>S(c),[c]),isLoading:n,isFetching:r,isError:i,error:a,refetch:o}}var E,D,O,k=t((()=>{p(),v(),E=e(n(),1),w(),D=`day`,O=`views,visitors`}));function A(){let{buckets:e,peak:t,isLoading:n,isFetching:i,isError:a,error:o,refetch:s}=T(),c=(0,M.useMemo)(()=>e.map(e=>e.average),[e]),l=a&&!t;return(0,N.jsx)(`div`,{className:x.root,children:(0,N.jsx)(de,{isLoading:n,isFetching:i,isError:l,isEmpty:!t,error:l?le(o,{retryDescription:r(`We couldn't load your popular days. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:s}):null,empty:{icon:u,description:r(`No views in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,N.jsx)(ue,{withHeadlineCount:!0}),children:(0,N.jsx)(_,{label:t?.label??``,value:t?.average??0,points:c})})})}function j({attributes:e={},setError:t}){return(0,N.jsx)(ee,{attributes:e,setError:t,children:(0,N.jsx)(A,{})})}var M,N,we=t((()=>{ne(),v(),i(),M=e(n(),1),ye(),k(),N=a()})),P,Te=t((()=>{s(),P={icon:o}})),F,I,L,R,z,B,V,Ee=t((()=>{F=`jpa/popular-days`,I=`Popular days`,L=`The day of the week that draws the most views, with the distribution across the week.`,R={content:`The days of the week when your site received the most views on average.`,links:[{label:`Learn more`,href:`https://wordpress.com/support/stats/learn-insights-about-your-website/`}]},z=`stats`,B=`framed`,V={name:F,title:I,description:L,help:R,category:z,presentation:B}}));function De(){return(0,U.jsx)(j,{attributes:{reportParams:d(!1)}})}function H(e){return(0,U.jsx)(j,{attributes:{reportParams:d(!1,e)}})}function Oe(e){return(0,U.jsx)(pe,{...e,widgetType:G,renderModule:W,renderComponent:j,attributes:{reportParams:d(!0)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{p(),g(),me(),fe(),ge(),we(),Te(),Ee(),U=a(),h(),W=`storybook/popular-days`,G=he(V,P),K={title:`Packages/Premium Analytics/Widgets/PopularDays`,component:j,tags:[`autodocs`],parameters:{docs:{description:{component:'The "Popular days" card: the busiest day of the week for the selected range, as the weekday name and its mean views, over an area chart of the whole week\'s distribution. Both figures are means per occurrence of that weekday, not totals — a user-selected range rarely spans a whole number of weeks, so totals would let a weekday win on having occurred one extra time. Data comes from `stats/visits` at daily granularity, folded into seven buckets client-side; `stats/insights` also reports weekday views but over a window fixed at ten weeks, so it cannot follow the date picker. There is no WithComparison story — the widget strips comparison from its request and renders no delta, so it would be identical to Default.'}}}},q={render:De,decorators:[y]},J={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(`stats/visits`,`loading`),()=>m(`stats/visits`,null))},Y={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(`stats/visits`,`error`),()=>m(`stats/visits`,null))},X={render:()=>H(`last-12-months`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(`stats/visits`,`error-retryable`),()=>m(`stats/visits`,null))},Z={render:()=>H(`last-year`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(`stats/visits`,`empty`),()=>m(`stats/visits`,null))},Q={render:e=>(0,U.jsx)(Oe,{...e}),args:{...ve},argTypes:{..._e}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
