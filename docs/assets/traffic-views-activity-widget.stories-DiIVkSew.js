import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{f as r,n as i,t as a}from"./build-module-yGZutq_9.js";import{t as o}from"./jsx-runtime-D2pHJD-r.js";import{C as s,Dn as ee,t as c}from"./build-module-zwSmKorH.js";import{X as te,t as l}from"./date-fns-D7Rx6aVe.js";import{C as ne,I as u,Tn as d,c as re,ot as ie,wn as f,y as p}from"./wp-date-settings-nAEnkgRe.js";import{n as ae}from"./heatmap-chart-Bkq67pmB.js";import{p as m,t as h}from"./src-BSTlOsjj.js";import{s as g,t as _}from"./src-96RytICS.js";import{R as v,Tn as oe,en as y,i as b}from"./date-filters-panel-DQm8KWou.js";import{t as x}from"./adaptive-calendar-heatmap-L8mmB6uI.js";import{r as se}from"./metric-sparkline-skeleton-l7-MwZwA.js";import{D as S,G as C,K as w,Y as T,k as ce}from"./report-metric-C0gPsEFt.js";import{t as le}from"./widget-state-Be-KuRhP.js";import{C as ue,D as de,E as fe,S as pe,T as me,b as he,t as ge,w as _e,x as E}from"./src-CmRx6M5w.js";function ve({value:e,cellLabel:t}){return(0,k.jsx)(S,{value:e,cellLabel:t,emptyLabel:i(`No views`,`jetpack-premium-analytics-pkg`),formatValue:u})}function ye(){let{reportParams:e}=ne(),t=d(re()),n=te(new Date,`yyyy-MM-dd`),a=(0,O.useMemo)(()=>f(e,{maxDays:t},n),[e,t,n]),o=(0,O.useMemo)(()=>f(e,{},n),[e,n]).startDate<a.startDate,{primary:s,isLoading:c,isFetching:l,isError:u,error:p,refetch:h}=v((0,O.useMemo)(()=>oe({...e,from:a.startDate,to:a.endDate,period:`day`,stat_fields:`views`}),[e,a])),_=s.data,y=(0,O.useMemo)(()=>new Map((_?.data??[]).map(e=>{let t=Number(e.views??0);return[String(e.time_interval),t>0?t:null]})),[_]),b=(_?.data??[]).some(e=>{let t=String(e.time_interval);return Number(e.views??0)>0&&t>=a.startDate&&t<=a.endDate}),S=m(a.startDate),C=m(a.endDate),w=o&&S&&C?r(i(`No views between %1$s and %2$s.`,`jetpack-premium-analytics-pkg`),g(S,`compact`),g(C,`compact`)):i(`No views in this period.`,`jetpack-premium-analytics-pkg`);return(0,k.jsx)(x,{valueByDay:y,period:a,children:(e,t)=>(0,k.jsx)(le,{isLoading:c,isFetching:l,isError:u&&!b,isEmpty:!b,error:ie(p,{retryDescription:i(`We couldn't load your traffic activity. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:h}),empty:{icon:ee,description:w},renderLoading:(0,k.jsx)(se,{}),children:(0,k.jsx)(ce,{pager:t,children:(0,k.jsx)(ae,{...e,primaryColor:`var(--wp-admin-theme-color, #3858e9)`,withTooltips:!0,renderTooltip:ve})})})})}function D({attributes:e={}}){return(0,k.jsx)(p,{attributes:e,children:(0,k.jsx)(ye,{})})}var O,k,A=t((()=>{b(),h(),_(),ge(),a(),c(),l(),O=e(n(),1),k=o()})),j,M=t((()=>{c(),j={icon:s}})),N,P,F,I,L,R,z,be=t((()=>{N=`jpa/traffic-views-activity`,P=`Traffic views activity`,F=`Daily views across the whole site, as a calendar heatmap.`,I={content:`Your daily views, shown as a heatmap to help you spot busy days and quieter stretches.`},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function B(e=G){return(0,H.jsx)(D,{attributes:{reportParams:y(!1,e)}})}function V(e){return T(U,e),()=>{T(U,null)}}function xe(e){return(0,H.jsx)(me,{...e,widgetType:pe(z,j),renderModule:W,renderComponent:D,attributes:{reportParams:y(!0,G)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{b(),C(),ue(),fe(),he(),A(),M(),be(),H=o(),w(),U=`stats/visits`,W=`storybook/traffic-views-activity`,G=`last-365-days`,K={title:`Packages/Premium Analytics/Widgets/TrafficViewsActivity`,component:D,tags:[`autodocs`],parameters:{docs:{description:{component:`The "Traffic views activity" widget shows daily site views as a calendar heatmap. Days without views are blank, and older weeks are hidden when space is limited.`}}}},q={render:()=>B(),decorators:[E]},J={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[E],beforeEach:()=>V(`loading`)},Y={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[E],beforeEach:()=>V(`error`)},X={render:()=>B(`last-30-days`),tags:[`!autodocs`],decorators:[E],beforeEach:()=>V(`error-retryable`)},Z={render:()=>B(`today`),tags:[`!autodocs`],decorators:[E],beforeEach:()=>V(`empty`)},Q={render:e=>(0,H.jsx)(xe,{...e}),args:{..._e,widgetWidth:4,widgetHeight:1,rowHeight:200},argTypes:{...de}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
