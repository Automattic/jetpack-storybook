import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-yGZutq_9.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{jn as o,t as s}from"./build-module-zwSmKorH.js";import{C as c,st as l,y as u}from"./wp-date-settings-Cs4sGCVo.js";import{c as d,t as f}from"./src-Bcj4rJXt.js";import{I as ee,Nn as p,Tn as te,en as m,i as h}from"./date-filters-panel-CJI9tmQE.js";import{G as ne,J as g,K as re,V as ie,Y as _}from"./report-metric-pMA5JCJ3.js";import{t as ae}from"./widget-state-B1jagvAT.js";import{C as v,D as oe,E as y,S as se,T as ce,b as le,t as b,w as ue,x}from"./src-CAv-UGJM.js";var S,C,w=t((()=>{S=`_root_1j6if_1`,C={root:S}}));function T(e){let t=e.reduce((e,t)=>!e||t.total>e.total?t:e,void 0);return t&&t.total>0?t:void 0}function E(){let{reportParams:e}=c(),{primary:t,isLoading:n,isFetching:r,isError:i,error:a,refetch:o}=ee((0,D.useMemo)(()=>te({...e}),[e])),s=t.data,l=(0,D.useMemo)(()=>s?s.buckets.map(({hour:e,views:t})=>({hour:e,total:t,average:t/s.days})):[],[s]);return{buckets:l,peak:(0,D.useMemo)(()=>{let e=T(l);return e&&{...e,label:d(e.hour)}},[l]),isLoading:n,isFetching:r,isError:i,error:a,refetch:o}}var D,O=t((()=>{h(),f(),b(),D=e(n(),1)}));function de(){let{buckets:e,peak:t,isLoading:n,isFetching:i,isError:a,error:s,refetch:c}=E(),u=(0,A.useMemo)(()=>e.map(e=>e.average),[e]),d=a&&(!t||s instanceof p),f=t&&t.average<10&&!Number.isInteger(t.average)?1:0;return(0,j.jsx)(`div`,{className:C.root,children:(0,j.jsx)(ae,{isLoading:n,isFetching:i,isError:d,isEmpty:!t,error:d?l(s,{retryDescription:r(`We couldn't load your popular hours. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}):null,empty:{icon:o,description:r(`No views in this period.`,`jetpack-premium-analytics-pkg`)},children:(0,j.jsx)(ie,{label:t?.label??``,value:t?.average??0,points:u,valueDecimals:f,valueUnit:`views-per-day`})})})}function k({attributes:e={},setError:t}){return(0,j.jsx)(u,{attributes:e,setError:t,children:(0,j.jsx)(de,{})})}var A,j,fe=t((()=>{h(),b(),i(),s(),A=e(n(),1),w(),O(),j=a()})),M,pe=t((()=>{s(),M={icon:o}})),N,P,F,I,L,R,z,me=t((()=>{N=`jpa/popular-hours`,P=`Popular hours`,F=`The hour of the day that draws the most views, with the distribution across the day.`,I={content:`The hours of the day when your site received the most views on average. Ranges longer than a year show the most recent 12 months.`,links:[{label:`Learn more`,href:`https://wordpress.com/support/stats/learn-insights-about-your-website/`}]},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function he(){return(0,V.jsx)(k,{attributes:{reportParams:m(!1)}})}function B(e){return(0,V.jsx)(k,{attributes:{reportParams:m(!1,e)}})}function ge(e){return(0,V.jsx)(ce,{...e,widgetType:U,renderModule:H,renderComponent:k,attributes:{reportParams:m(!0)}})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{h(),ne(),y(),v(),le(),fe(),pe(),me(),V=a(),re(),H=`storybook/popular-hours`,U=se(z,M),W={title:`Packages/Premium Analytics/Widgets/PopularHours`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:"The \"Popular hours\" card: the busiest hour of the day for the selected range, as a site-format hour label and its mean daily views, over an area chart of the whole day's distribution. Data comes from `stats/views-by/hour-of-day`, which folds the range into 24 buckets in the site's own timezone; `stats/insights` also reports an hours map, but keyed in UTC while its `highest_hour` is offset-applied, so its chart and headline disagree. Because the endpoint rejects ranges longer than 366 days, the client limits `all time` and long custom ranges to the most recent 12 months. There is no WithComparison story — the widget strips comparison from its request and renders no delta, so it would be identical to Default."}}}},G={render:he,decorators:[x]},K={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(_(`stats/views-by/hour-of-day`,`loading`),()=>_(`stats/views-by/hour-of-day`,null))},q={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(_(`stats/views-by/hour-of-day`,`error`),()=>_(`stats/views-by/hour-of-day`,null))},J={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(_(`stats/views-by/hour-of-day`,`error-retryable`),()=>_(`stats/views-by/hour-of-day`,null))},Y={render:()=>B(`last-30-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(g(`stats/views-by/hour-of-day`,{date:`2026-01-01`,start_date:`2025-12-03`,days:30,dimension:`day-of-week`,fields:[`period`,`views`],data:[[`Mon`,100]]}),()=>g(`stats/views-by/hour-of-day`,null))},X={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(g(`stats/views-by/hour-of-day`,{date:`2026-01-01`,start_date:`2025-01-01`,days:366,dimension:`hour-of-day`,fields:[`period`,`views`],data:[[`7`,4],[`19`,18]]}),()=>g(`stats/views-by/hour-of-day`,null))},Z={render:()=>B(`last-year`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(_(`stats/views-by/hour-of-day`,`empty`),()=>_(`stats/views-by/hour-of-day`,null))},Q={render:e=>(0,V.jsx)(ge,{...e}),args:{...ue},argTypes:{...oe}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
