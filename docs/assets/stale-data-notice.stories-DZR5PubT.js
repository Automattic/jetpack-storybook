import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{f as r,n as i,t as a}from"./build-module-yGZutq_9.js";import{t as o}from"./jsx-runtime-D2pHJD-r.js";import{A as s,E as c,O as l,w as u}from"./build-module-Cb539diK.js";import{t as d}from"./src-DyecqeLL.js";import{D as f,t as p}from"./src-B5nbkiw8.js";function m(e){let[t,n]=(0,g.useState)(()=>Date.now());return(0,g.useEffect)(()=>{let e=setInterval(()=>n(Date.now()),v);return()=>clearInterval(e)},[]),t-e}function h({updatedAt:e,onRetry:t,isRetrying:n=!1,className:a}){let o=m(e),d=o<v?i(`Couldn't refresh. Showing data from less than a minute ago.`,`jetpack-premium-analytics-pkg`):r(i(`Couldn't refresh. Showing data from %s.`,`jetpack-premium-analytics-pkg`),f(new Date(e).toISOString(),new Date(e+o)));return(0,_.jsxs)(s,{intent:`warning`,className:a,spokenMessage:i(`Couldn't refresh. The numbers on screen may be out of date.`,`jetpack-premium-analytics-pkg`),children:[(0,_.jsx)(l,{children:d}),t&&(0,_.jsx)(c,{children:(0,_.jsx)(u,{variant:`outline`,onClick:t,disabled:n,loading:n,children:i(`Retry`,`jetpack-premium-analytics-pkg`)})})]})}var g,_,v,y=t((()=>{p(),d(),a(),g=e(n(),1),_=o(),v=60*1e3})),b,x,S,C,w,T,E;t((()=>{y(),b={title:`Packages/Premium Analytics/UI/StaleDataNotice`,component:h,tags:[`autodocs`],parameters:{docs:{description:{component:`Shown when a refresh failed while the data it was replacing is still on screen. The numbers stay: they are older than the reader asked for, not wrong — so this states their age instead of replacing them with an error.
