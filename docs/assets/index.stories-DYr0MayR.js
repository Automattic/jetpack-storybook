import{n as e,r as t}from"./chunk-zsgVPwQN.js";import{px as n}from"./iframe-BfgWixbs.js";import{C as r,h as i,k as a,t as o,v as s,y as c}from"./providers-DPWqRA3g.js";import{c as l,r as u,s as d,t as f}from"./chart-decorator-iM_bstjs.js";import{n as p,r as m,t as h}from"./legend-config-B-kNliUM.js";import{g,i as _,t as v,v as y,x as b}from"./sample-data-aNf8uISY.js";import{t as x}from"./stories-DADiRnqY.js";import{r as S,t as C}from"./build-module-83aEqQfZ.js";import{n as w,r as T}from"./leaderboard-chart-C5UkSdFV.js";var E=t({AdvancedFormatting:()=>K,Animation:()=>F,AspectRatio:()=>j,CurrencyFormatting:()=>H,CustomColors:()=>I,CustomLabel:()=>G,Default:()=>k,EmptyData:()=>R,EmptyDataWithChildren:()=>z,FixedDimensions:()=>A,LargeValues:()=>B,Loading:()=>P,NegativeGrowth:()=>V,NumberFormatting:()=>U,OverlayLabelWithImage:()=>J,SmallDataset:()=>L,WithCompositionLegend:()=>Z,WithLegend:()=>Y,WithLegendLabels:()=>X,WithOverlayLabel:()=>N,WithoutComparison:()=>M,__namedExportsOrder:()=>Q,default:()=>O}),D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=e((()=>{C(),o(),x(),p(),c(),T(),D=n(),O={title:`JS Packages/Charts Library/Charts/Leaderboard Chart`,component:w,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{data:{control:`object`,description:`Array of leaderboard entries to display`,table:{type:{summary:`LeaderboardEntry[]`}}},withComparison:{control:`boolean`,description:`Whether to show comparison data (previous period bars and delta values)`,table:{defaultValue:{summary:`false`}}},primaryColor:{control:`color`,description:`Primary color for current period bars`,table:{defaultValue:{summary:s.leaderboardChart.primaryColor}}},secondaryColor:{control:`color`,description:`Secondary color for comparison period bars`,table:{defaultValue:{summary:s.leaderboardChart.secondaryColor}}},valueFormatter:{control:!1,description:`Custom formatter function for values`,table:{type:{summary:`(value: number) => string`},defaultValue:{summary:`formatMetricValue with compact notation`}}},deltaFormatter:{control:!1,description:`Custom formatter function for delta values`,table:{type:{summary:`(value: number) => string`},defaultValue:{summary:`formatMetricValue as percentage`}}},loading:{control:`boolean`,description:`Whether the chart is in loading state`,table:{defaultValue:{summary:`false`}}},className:{control:`text`,description:`Additional CSS class name for the chart container`,table:{type:{summary:`string`}}},style:{control:`object`,description:`Custom styling for the chart container`,table:{type:{summary:`React.CSSProperties`}}},withOverlayLabel:{control:`boolean`,description:`Whether to overlay the label on top of the bar`,table:{defaultValue:{summary:`false`}}},legendLabels:{control:`object`,description:`Custom labels for legend items`,table:{category:`Legend`,type:{summary:`{ primary?: string; comparison?: string }`},defaultValue:{summary:`undefined`}}},...u,...m,...l},args:{primaryColor:void 0,secondaryColor:void 0,themeName:`default`,showLegend:!1,legendPosition:`bottom`,legendAlignment:`center`,legendOrientation:`horizontal`,legendShape:`circle`,withOverlayLabel:!1},decorators:[f],render:e=>{let t=h(e);return(0,D.jsx)(w,{...e,legend:t})}},k={args:{...d,data:b,withComparison:!0,loading:!1}},A={args:{...k.args,width:300,height:400}},j={args:{...k.args,aspectRatio:.4}},M={args:{data:b,withComparison:!1,loading:!1}},N={args:{data:b,withOverlayLabel:!0}},P={args:{data:b,withComparison:!0,loading:!0}},F={args:{...k.args,animation:!0}},I={args:{data:b,withComparison:!0,loading:!1,primaryColor:`red`,secondaryColor:`green`}},L={args:{data:y,withComparison:!0,loading:!1}},R={args:{data:[],withComparison:!0,loading:!1}},z={args:{data:[],withComparison:!0,loading:!1},render:e=>(0,D.jsx)(w,{...e,children:(0,D.jsx)(S,{direction:`row`,gap:`xs`,align:`center`,justify:`center`,children:`Child element`})})},B={args:{data:g,withComparison:!0,loading:!1}},V={args:{data:_,withComparison:!0,loading:!1}},H={args:{data:b,withComparison:!0,loading:!1,valueFormatter:e=>a(e,`currency`,{useMultipliers:!0,decimals:1}),deltaFormatter:e=>a(e/100,`average`,{decimals:0})}},U={args:{data:b,withComparison:!0,loading:!1,valueFormatter:e=>a(e,`number`,{useMultipliers:!1,decimals:0}),deltaFormatter:e=>a(e/100,`average`,{decimals:1})}},W=({label:e,imageColor:t,style:n={}})=>(0,D.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`,...n},children:[(0,D.jsx)(`img`,{src:`data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='50' height='50'><rect width='50' height='50' fill='${encodeURIComponent(t)}'/></svg>`,alt:`icon`,style:{width:`28px`,height:`28px`,verticalAlign:`middle`,borderRadius:`4px`}}),(0,D.jsx)(`span`,{style:{fontSize:`13px`},children:e})]}),G={args:{data:v.map(e=>({...e,label:(0,D.jsx)(W,{label:e.label,imageColor:e.imageColor})})),withComparison:!1,loading:!1}},K={args:{data:g,withComparison:!0,loading:!1,valueFormatter:e=>e>=1e6?a(e,`currency`,{useMultipliers:!0,decimals:1}):a(e,`currency`,{useMultipliers:!1,decimals:0}),deltaFormatter:e=>a(e/100,`average`,{decimals:1,signDisplay:`always`})}},q=e=>{let{getElementStyles:t}=i(),{color:n}=t({index:0,overrideColor:e.primaryColor}),a=r(n,.08);return(0,D.jsx)(w,{...e,primaryColor:a})},J={args:{data:v.map(e=>({...e,label:(0,D.jsx)(W,{label:e.label,imageColor:e.imageColor,style:{padding:`6px`}})})),withComparison:!0,withOverlayLabel:!0,loading:!1,style:{"--a8c--charts--leaderboard--bar--border-radius":`4px`}},render:e=>(0,D.jsx)(q,{...e})},Y={args:{data:b,withComparison:!0,loading:!1,showLegend:!0},parameters:{docs:{description:{story:"Props-based legend using `showLegend` and the `legend` config object. Use Storybook controls to adjust legend position, alignment, orientation, shape, and interactivity."}}}},X={args:{data:b,withComparison:!0,loading:!1,showLegend:!0,legendLabels:{primary:`Aug 11-Sep 9, 2025`,comparison:`Jul 11-Aug 11, 2025`}},parameters:{docs:{description:{story:"Props-based legend using `showLegend`, the `legend` config object, and the `legendLabels` prop to customize primary and comparison labels. Other legend options (position, alignment, orientation, shape, interactivity) can be adjusted via Storybook controls."}}}},Z={render:e=>{let t=h(e);return(0,D.jsx)(w,{...e,legend:{interactive:t?.interactive},chartId:`composition-leaderboard-chart`,children:(0,D.jsx)(w.Legend,{...t,shapeStyles:{width:8,height:8,...t?.shapeStyles}})})},args:{data:b,withComparison:!0,loading:!1},parameters:{docs:{description:{story:"Composition API using `<LeaderboardChart.Legend />` as a child component for explicit legend placement and configuration. This is the recommended approach for flexible legend positioning."}}}},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  args: {
    ...sharedThemeArgs,
    data: sampleData,
    withComparison: true,
