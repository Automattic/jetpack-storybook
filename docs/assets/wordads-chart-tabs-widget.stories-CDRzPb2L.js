import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as i,t as a}from"./build-module-CbwHEf9N.js";import{ll as o,n as s}from"./build-module-CDRs4YxF.js";import{$ as c,G as l,K as u,Y as d,rt as f}from"./report-metric-BQq61pmH.js";import{b as ee,t as te}from"./src-BKLK-O8P.js";import{Gt as p,Jt as ne,m,t as h}from"./src-DKUSXTG7.js";import{c as re,h as g,l as ie,p as ae}from"./chart-tooltip-z4mZVY6D.js";import{r as oe,t as se}from"./metric-tabs-chart-skeleton-CJVPF2-g.js";import{t as ce}from"./widget-state-D9UHPG4g.js";import{C as le,D as _,E as ue,S as v,T as y,b as de,t as b,w as x,x as S}from"./src-BLf2EwWu.js";var C,w,T=e((()=>{C=`_root_sp1nf_1`,w={root:C}})),E,D,fe=e((()=>{n(),E={type:`currency`,options:{decimals:2}},D=[{id:`impressions`,label:t(`Ads Served`,`jetpack-premium-analytics-pkg`)},{id:`cpm`,label:t(`Average CPM`,`jetpack-premium-analytics-pkg`),dataFormat:E},{id:`revenue`,label:t(`Revenue`,`jetpack-premium-analytics-pkg`),dataFormat:E}]}));function pe(e,t){return{...e,period:t}}function me(e,t){let{primary:n,comparison:r,hasComparison:a,isLoading:o,isFetching:s,isError:c,refetch:l}=m((0,i.useMemo)(()=>pe(e,t),[e,t])),u=n.data,d=r.data,f=(0,i.useMemo)(()=>u&&d?ne(d,u.data.length):d,[u,d]);return{metrics:(0,i.useMemo)(()=>D.map(e=>ae({primary:u,comparison:f,hasComparison:a,field:e.id,label:e.label,dataFormat:e.dataFormat})),[u,f,a]),isLoading:o,isFetching:s,isError:c&&!u?.data?.length,isEmpty:u!==void 0&&!u.data?.length,refetch:l}}var he=e((()=>{h(),a(),fe(),b()}));function ge({granularity:e}){let{reportParams:n}=f(),{metrics:r,isLoading:i,isFetching:a,isError:o,isEmpty:s,refetch:c}=me(n,e===`auto`?g(n.interval,j):e);return(0,k.jsx)(`div`,{className:w.root,children:(0,k.jsx)(ce,{isLoading:i,isFetching:a,isError:o,isEmpty:s,error:{description:t(`We couldn't load WordAds data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:c}]},empty:{icon:ee,description:t(`No WordAds data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,k.jsx)(se,{}),children:(0,k.jsx)(oe,{metrics:r,dataFormat:A,groupLabel:t(`WordAds metric`,`jetpack-premium-analytics-pkg`)})})})}function O({attributes:e={}}){return(0,k.jsx)(c,{attributes:e,options:{from:`/`},children:(0,k.jsx)(ge,{granularity:e.granularity??`auto`})})}var k,A,j,M=e((()=>{te(),b(),n(),T(),he(),k=r(),A={type:`number`,options:{useMultipliers:!0,decimals:0}},j=[`day`,`week`,`month`,`year`]})),N,P=e((()=>{n(),s(),re(),N={icon:o,attributes:[{id:`granularity`,label:t(`Group by`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:ie,elements:[{label:t(`Auto`,`jetpack-premium-analytics-pkg`),value:`auto`},{label:t(`By days`,`jetpack-premium-analytics-pkg`),value:`day`},{label:t(`By weeks`,`jetpack-premium-analytics-pkg`),value:`week`},{label:t(`By months`,`jetpack-premium-analytics-pkg`),value:`month`},{label:t(`By years`,`jetpack-premium-analytics-pkg`),value:`year`}],relevance:`high`}],example:{attributes:{granularity:`auto`}}}})),F,I,L,R,z,B,V,_e=e((()=>{F=`jpa/wordads-chart-tabs`,I=`WordAds`,L=`Compare ads served, average CPM, and revenue over the selected period, with the previous period overlaid for comparison.`,R={content:`Compare ads served, average CPM, and revenue over the selected period, with the previous period overlaid for comparison.`},z=`stats`,B=`framed`,V={name:F,title:I,description:L,help:R,category:z,presentation:B}}));function H({withComparison:e}){return(0,W.jsx)(O,{attributes:{reportParams:p(e)}})}function U(e){return(0,W.jsx)(O,{attributes:{reportParams:p(!1,e)}})}function ve({withComparison:e,...t}){return(0,W.jsx)(y,{...t,widgetType:v(V,N),renderModule:G,renderComponent:O,attributes:{reportParams:p(e)}})}var W,G,K,q,J,Y,X,Z,Q,$;e((()=>{h(),ue(),l(),le(),de(),M(),P(),_e(),W=r(),u(),G=`storybook/wordads-chart-tabs`,K={title:`Packages/Premium Analytics/Widgets/WordAdsChartTabs`,component:O,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`}},parameters:{docs:{description:{component:"WordAds performance over the selected period as selectable metric tabs — Ads Served, Average CPM, and Revenue, matching the Calypso WordAds page's tabs — over a comparative line chart. Ads Served is a count; CPM and revenue are currency (WordAds pays USD). The date range and comparison come from the dashboard controls; the \"Group by\" control is the `granularity` attribute (`relevance: 'high'`), exposed by the widget host; which metric is plotted is the chart's own tab selection. WordAds stats are computed nightly, so a range ending today is clamped to end at yesterday. When comparison is on the previous period is overlaid as a same-colour dashed line and each tab shows its period-over-period delta. Data comes from the `useStatsWordAdsStats` hook (the `wordads` proxy prefix); in Storybook it is served by `registerReportMocks`. Requires WordAds to be active on the site for live data."}}}},q={render:H,args:{withComparison:!1},decorators:[S]},J={render:H,args:{withComparison:!0},decorators:[S]},Y={render:()=>U(`last-90-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(d(`wordads/stats`,`loading`),()=>d(`wordads/stats`,null))},X={render:()=>U(`last-7-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(d(`wordads/stats`,`error`),()=>d(`wordads/stats`,null))},Z={render:()=>U(`last-365-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(d(`wordads/stats`,`empty`),()=>d(`wordads/stats`,null))},Q={render:e=>(0,W.jsx)(ve,{...e}),args:{...x,withComparison:!0},argTypes:{..._,withComparison:{control:`boolean`}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
