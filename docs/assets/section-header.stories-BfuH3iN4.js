import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{a as i,c as a,u as o}from"./build-module-D_uWNNNl.js";import{Bt as s}from"./build-module-D5hqcG7F.js";import{t as c}from"./src-jtpFQrta.js";import{i as l,t as u,u as d}from"./src-BGYku0wI.js";import{n as f,r as p,t as m}from"./story-interval-options-C59XhMNq.js";import{r as h,t as g}from"./date-filters-panel-zpyKMbB3.js";import{t as _}from"./date-interval-dropdown-Bv80l55G.js";import{t as v}from"./date-year-filter-DVItv7Vd.js";import{i as y,n as b,r as x,t as S}from"./section-header-CFxyKyG7.js";function C(){let e=l(`last-30-days`,j);return{presetId:`last-30-days`,range:{from:e?.from,to:e?.to}}}function w(e,t){return e.range.from!==t.range.from||e.range.to!==t.range.to||e.presetId!==t.presetId}function T(){let e=C(),[t,n]=(0,k.useState)(e),[r,i]=(0,k.useState)(e),a=(0,k.useRef)(r);a.current=r;let[o,s]=(0,k.useState)(void 0),[c,l]=(0,k.useState)(void 0),u=(0,k.useCallback)((e,t)=>{let n={range:e??a.current.range,presetId:t??a.current.presetId};a.current=n,i(n)},[]),d=(0,k.useCallback)(()=>{n(a.current)},[]),f=(0,k.useCallback)(()=>{a.current=t,i(t)},[t]),h=(0,k.useCallback)((e,t)=>{s(t)},[]),_=m(r.presetId);return(0,A.jsx)(g,{range:r.range,appliedPresetId:t.presetId,appliedRange:t.range,comparisonPresetId:o,withIntervalControl:!0,interval:p(c,_),intervalOptions:_,onChange:u,onComparisonChange:h,onIntervalChange:l,onApply:d,onCancel:f,canApply:w(r,t),timeZone:j})}function E({containerElement:e}){let[t,n]=(0,k.useState)(d),[r,i]=(0,k.useState)(void 0),a=m(t);return(0,A.jsxs)(s,{direction:`row`,align:`center`,gap:`sm`,children:[(0,A.jsx)(v,{value:t,onSelect:(e,t)=>n(t),timeZone:j,containerElement:e}),(0,A.jsx)(_,{options:a,value:p(r,a),onChange:i})]})}function D({title:e,condenseOnScroll:t}){return(0,A.jsx)(S,{title:e,condenseOnScroll:t,children:(0,A.jsx)(T,{})})}function O({title:e}){let[t,n]=(0,k.useState)(null);return(0,A.jsx)(`div`,{ref:n,children:(0,A.jsx)(S,{title:e,children:(0,A.jsx)(E,{containerElement:t})})})}var k,A,j,M,N,P,F,I,L,R,z,B,V;t((()=>{u(),c(),a(),k=e(n(),1),y(),h(),f(),x(),b(),A=r(),j=`America/New_York`,M={title:`Packages/Premium Analytics/UI/SectionHeader`,component:S,tags:[`autodocs`],parameters:{docs:{description:{component:`Header for an analytics surface: a **title** names the section, and the date controls sit beside it on the same row.
