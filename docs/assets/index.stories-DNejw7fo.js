import{a as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./jsx-runtime-D2pHJD-r.js";import{Ua as r,Va as i}from"./iframe-BT00G2xa.js";import{c as a,r as o,s,t as c}from"./chart-decorator-DBebvTaZ.js";import{L as l,R as u}from"./chart-scope-C4bJ8Fqr.js";import{c as d,z as f}from"./build-module-CNajBwCP.js";import{O as p,k as m}from"./catalog-pointers-DtSizgEM.js";import{S as h,_ as g}from"./sample-data-D3PJ9Amq.js";import{t as _}from"./stories-DwSe_hke.js";import{n as v,t as y}from"./bar-list-chart-CQCC6yxU.js";var b=e({Animation:()=>D,AspectRatio:()=>T,CustomLabelComponent:()=>k,CustomValueComponent:()=>A,Default:()=>C,FixedDimensions:()=>w,MultiSeries:()=>E,__namedExportsOrder:()=>j,default:()=>S}),x,S,C,w,T,E,D,O,k,A,j,M=t((()=>{r(),p(),l(),d(),_(),v(),x=n(),S={title:`JS Packages/Charts Library/Charts/Bar List Chart`,component:y,parameters:{layout:`centered`},decorators:[c],argTypes:{...o,...a}},C={args:{...s,withTooltips:!0,data:h}},w={args:{...C.args,width:600,height:300}},T={args:{...C.args,aspectRatio:.3}},E={args:{...C.args,data:g}},D={args:{...C.args,animation:!0}},O=e=>{let{getElementStyles:t}=f(),n=t({index:1}).color;return(0,x.jsx)(y,{...e,options:{...e.options,labelComponent:({textProps:e,x:t,y:r,label:i,formatter:a})=>(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(m,{cx:t+6,cy:r,r:8,fill:n}),(0,x.jsx)(u,{...e,textAnchor:`start`,x:t+24,y:r,fontWeight:500,children:a(i)})]})}})},k={args:{...C.args,data:h,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{xScale:{},yScale:{}}},render:e=>(0,x.jsx)(O,{...e})},A={args:{...C.args,data:g,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{xScale:{},yScale:{},valueComponent:({textProps:e,x:t,y:n,value:r,formatter:i,data:a,index:o})=>{let s=a[0].data[o].value,c=a[1].data[o].value,l=c===0?0:((s-c)/c*100).toFixed(0);return(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(u,{...e,textAnchor:`end`,x:t,y:n,dx:-50,fontWeight:500,children:i(r)}),(0,x.jsx)(u,{...e,textAnchor:`end`,x:t,y:n,dx:-10,fill:`#008A20`,fontWeight:500,children:`${Number(l)>0?`+`:``}${l}%`})]})},valueFormatter:e=>`$${i(e)}`}}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
    ...sharedThemeArgs,
    withTooltips: true,
    data: salesByProduct
