import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DQ5lAs4a.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{N as i,t as a}from"./build-module-DMs68Vfd.js";import{En as o,On as s,Ts as c,ii as l,n as u,oi as ee,rl as te,ua as ne}from"./build-module-Bt8gOW8e.js";import{R as re,t as ie}from"./build-module-BAze1CUO.js";import{Kn as d,_t as f,gt as p,ut as m}from"./chart-tooltip-ClIvRUzH.js";import{t as h}from"./metric-tile-grid-Cx0v-Z8I.js";import{E as g,S as _}from"./report-metric-C9QRZwAo.js";import{i as v,n as y,t as ae}from"./register-report-mocks-CEOd2Lr0.js";import{t as oe}from"./widget-state-CkRqQWXE.js";import{S as se,b as ce,t as le,x as ue,y as b}from"./src-DeeVzTNc.js";var x,S,C,w=e((()=>{x=`_root_1bdlz_2`,S=`_content_1bdlz_14`,C={root:x,content:S}}));function T(e,t){let n=Number(e[t]);return Number.isFinite(n)?n:0}function E(e,t){let n=Number(e[t]);return Number.isFinite(n)&&n!==0?n/100:null}function D(e){return!!e&&M.some(t=>{let n=e[t.key];return n!=null&&Number.isFinite(Number(n))})}function de(e,t){let n=[];for(let r of M){if(!r.views.includes(t))continue;let i=r.kind===`rate`?E(e,r.key):T(e,r.key);r.hideWhenZero&&!i||n.push({key:r.key,icon:r.icon,label:r.label(),value:i,dataFormat:r.kind===`rate`?j:A})}return n}function fe(e){let t=typeof e==`number`?e:Number.parseInt(e??``,10);return Number.isInteger(t)&&t>0?t:0}function pe({metric:e}){let{reportParams:t}=g(),n=fe(t.post_id),r=n>0,a=f(n,`rate`,{enabled:r&&e===`opens`}),o=p(n,`rate`,{enabled:r&&e===`clicks`}),s=e===`clicks`?o:a,c=s.data?.summary,l=(0,i.useMemo)(()=>D(c)?de(c,e):void 0,[c,e]);return(0,k.jsx)(N,{metrics:l,hasSelection:r,isLoading:s.isLoading,isFetching:s.isFetching,isError:s.isError&&!l,onRetry:s.refetch})}function O({attributes:e={}}){return(0,k.jsx)(_,{attributes:e,children:(0,k.jsx)(pe,{metric:e.metric===`clicks`?`clicks`:`opens`})})}var k,A,j,M,N,P=e((()=>{m(),le(),a(),n(),u(),ie(),w(),k=r(),A={type:`number`,options:{useMultipliers:!0,decimals:0}},j={type:`percentage`,options:{decimals:1,signDisplay:`never`}},M=[{key:`total_sends`,icon:o,label:()=>t(`Total emails sent`,`jetpack-premium-analytics`),kind:`count`,views:[`opens`]},{key:`unique_opens`,icon:ee,label:()=>t(`Unique opens`,`jetpack-premium-analytics`),kind:`count`,views:[`opens`],hideWhenZero:!0},{key:`total_opens`,icon:s,label:()=>t(`Total opens`,`jetpack-premium-analytics`),kind:`count`,views:[`opens`,`clicks`]},{key:`opens_rate`,icon:l,label:()=>t(`Open rate`,`jetpack-premium-analytics`),kind:`rate`,views:[`opens`]},{key:`total_clicks`,icon:ne,label:()=>t(`Total clicks`,`jetpack-premium-analytics`),kind:`count`,views:[`clicks`]},{key:`clicks_rate`,icon:te,label:()=>t(`Click rate`,`jetpack-premium-analytics`),kind:`rate`,views:[`clicks`]}],N=({metrics:e,hasSelection:n=!1,isLoading:r=!1,isFetching:i=!1,isError:a=!1,onRetry:o})=>(0,k.jsx)(re,{className:C.root,children:(0,k.jsx)(`div`,{className:C.content,children:(0,k.jsx)(oe,{isLoading:r,isFetching:i,isError:a,isEmpty:!e||e.length===0,error:{description:t(`We couldn't load this email's stats. Please try again in a moment.`,`jetpack-premium-analytics`),actions:o?[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:o}]:void 0},empty:{icon:c,description:t(n?`No stats are available for this email yet.`:`Select an email to see its stats.`,`jetpack-premium-analytics`)},children:(0,k.jsx)(h,{tiles:e??[]})})})})})),F,I=e((()=>{n(),u(),F={name:`jpa/email-top-row`,title:t(`Email top row`,`jetpack-premium-analytics`),icon:c,help:{content:t(`Headline stats for a single email. The Opens view shows total sends, unique opens, total opens, and open rate; the Clicks view shows total opens, total clicks, and click rate. Rates are measured against total sends. Figures are all-time and are not affected by the dashboard date range.`,`jetpack-premium-analytics`)},attributes:[{id:`metric`,label:t(`View by`,`jetpack-premium-analytics`),type:`text`,elements:[{label:t(`Opens`,`jetpack-premium-analytics`),value:`opens`},{label:t(`Clicks`,`jetpack-premium-analytics`),value:`clicks`}],relevance:`high`}],example:{attributes:{metric:`opens`}}}}));function L({metric:e,withComparison:t},n=V){return(0,z.jsx)(O,{attributes:{metric:e,reportParams:{...d(t),post_id:n}}})}function R({metric:e,withComparison:t,...n}){return(0,z.jsx)(ce,{...n,widgetType:F,renderModule:B,renderComponent:O,attributes:{metric:e,reportParams:{...d(t),post_id:V}}})}var z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{m(),ue(),ae(),P(),I(),z=r(),y(),B=`storybook/email-top-row`,V=2e3,H=`stats/opens/emails`,U=e=>(0,z.jsx)(`div`,{style:{width:`100%`,height:`300px`},children:(0,z.jsx)(e,{})}),W={title:`Packages/Premium Analytics/Widgets/EmailTopRow`,component:O,tags:[`autodocs`],argTypes:{metric:{control:`inline-radio`,options:[`opens`,`clicks`]},withComparison:{control:`boolean`}},parameters:{docs:{description:{component:'The "Email top row" widget. Shows a single email\'s all-time headline totals as a row of metric tiles, switching between the Opens view (total sends, unique opens, total opens, open rate) and the Clicks view (total opens, total clicks, click rate) via the `metric` attribute. The email is selected by the host through `reportParams.post_id`. Data comes from the per-post `stats/<opens|clicks>/emails/<postId>/rate` breakdown, which is all-time and returns no comparison rows, so the widget ignores the dashboard date range and never shows period-over-period deltas.'}}}},G={render:e=>L(e),args:{metric:`opens`,withComparison:!1},decorators:[U]},K={render:e=>L(e),args:{metric:`clicks`,withComparison:!1},decorators:[U]},q={render:e=>L(e),args:{metric:`opens`,withComparison:!0},decorators:[U]},J={render:e=>L(e,2001),tags:[`!autodocs`],args:{metric:`opens`,withComparison:!1},decorators:[U],beforeEach:()=>(v(H,`loading`),()=>v(H,null))},Y={render:e=>L(e,2002),tags:[`!autodocs`],args:{metric:`opens`,withComparison:!1},decorators:[U],beforeEach:()=>(v(H,`error`),()=>v(H,null))},X={render:e=>L(e,2003),tags:[`!autodocs`],args:{metric:`opens`,withComparison:!1},decorators:[U],beforeEach:()=>(v(H,`empty`),()=>v(H,null))},Z={render:({metric:e,withComparison:t})=>(0,z.jsx)(O,{attributes:{metric:e,reportParams:d(t)}}),args:{metric:`opens`,withComparison:!1},decorators:[U]},Q={render:e=>(0,z.jsx)(R,{...e}),args:{...b,metric:`opens`,withComparison:!0},argTypes:{...se,metric:{control:`inline-radio`,options:[`opens`,`clicks`]},withComparison:{control:`boolean`}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
