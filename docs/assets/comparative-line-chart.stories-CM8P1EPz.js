...
Drag the container edges to see the chart adapt to different widths.`,...j.parameters?.docs?.description}}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
  decorators: [Story => <div style={{
    width: '100%',
    height: '120px'
  }}>
...
}`,...M.parameters?.docs?.source},description:{story:`Sparkline: how the chart degrades on a tile too short for a y axis.
The dates stay readable at both ends; the chart reserves room for them.`,...M.parameters?.docs?.description}}},N=[`Default`,`WithComparison`,`MultipleSeries`,`WithStylesInSeries`,`WeeklyIntervalsAlignment`,`EmptyState`,`EmptyDataNumber`,`Resizable`,`Sparkline`]}))();export{h as Default,k as EmptyDataNumber,O as EmptyState,b as MultipleSeries,j as Resizable,M as Sparkline,E as WeeklyIntervalsAlignment,_ as WithComparison,S as WithStylesInSeries,N as __namedExportsOrder,u as default};