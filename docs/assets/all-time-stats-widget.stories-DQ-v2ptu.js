import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-Da_5_6n_.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{I as o,an as s,et as c,f as l,n as u,ut as ee}from"./build-module-DmVuor49.js";import{Tr as d,cr as f,jn as te,u as ne,yt as p}from"./chart-tooltip-C_Y00_tm.js";import{t as re}from"./metric-tile-grid-DVCx90qM.js";import{F as ie,L as m,P as h,V as g}from"./report-metric-g5-n2BXz.js";import{t as ae}from"./widget-state-DH8_FpDV.js";import{C as oe,D as se,E as ce,S as le,T as ue,b as _,t as de,w as fe,x as v}from"./src-Dw1m72HI.js";import{i as y,t as b}from"./src-D8RJDeDL.js";var x,S,pe=t((()=>{x=`_root_15bqk_2`,S={root:x}})),C,w,T,E=t((()=>{i(),u(),b(),C=[{id:`views`,label:r(`Views`,`jetpack-premium-analytics`)},{id:`visitors`,label:r(`Visitors`,`jetpack-premium-analytics`)},{id:`posts`,label:r(`Posts`,`jetpack-premium-analytics`)},{id:`comments`,label:r(`Comments`,`jetpack-premium-analytics`)}],w=C.map(e=>e.id),T={icon:l,attributes:[{id:`metrics`,label:r(`Metrics`,`jetpack-premium-analytics`),type:`array`,relevance:`high`,Edit:y,elements:C.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:w}}}}));function D({metrics:e=w}){let{data:t,isLoading:n,isFetching:i,isError:a,refetch:o}=te(),s=t?.stats,c=(0,k.useMemo)(()=>{let t=new Set(e);return C.filter(e=>t.has(e.id))},[e]),u=(0,k.useMemo)(()=>c.flatMap(({id:e,label:t})=>{let n=ne(s,e);return n===void 0?[]:[{key:e,label:t,icon:M[e].icon,value:n}]}),[c,s]);return(0,A.jsx)(`div`,{className:S.root,children:(0,A.jsx)(ae,{isLoading:n,isFetching:i,isError:u.length===0&&a,isEmpty:u.length===0,error:{description:r(`We couldn't load all-time stats. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:r(`Retry`,`jetpack-premium-analytics`),onClick:o}]},empty:{icon:l,description:c.length===0?r(`Select at least one metric to display.`,`jetpack-premium-analytics`):r(`No stats recorded yet.`,`jetpack-premium-analytics`)},children:(0,A.jsx)(re,{tiles:u,dataFormat:j})})})}function O({attributes:e={}}){return(0,A.jsx)(g,{attributes:e,children:(0,A.jsx)(D,{metrics:e.metrics})})}var k,A,j,M,me=t((()=>{p(),de(),i(),u(),k=e(n(),1),pe(),E(),A=a(),j={type:`number`,options:{decimals:0}},M={views:{icon:o},visitors:{icon:ee},posts:{icon:c},comments:{icon:s}}})),N,P,F,I,L,R,z,he=t((()=>{N=`jpa/all-time-stats`,P=`All-time stats`,F=`Lifetime totals for your site — views, visitors, posts, and comments.`,I={content:`Lifetime totals for your site — views, visitors, posts, and comments.`},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function ge({metrics:e}){return(0,H.jsx)(O,{attributes:{reportParams:f(),metrics:e}})}function B(e){return(0,H.jsx)(O,{attributes:{reportParams:f(!1,e)}})}function V(e){return m(`proxy/v1.1/stats`,e),d.removeQueries({queryKey:[`stats`,`site`]}),()=>{m(`proxy/v1.1/stats`,null),d.removeQueries({queryKey:[`stats`,`site`]})}}function _e({metrics:e,...t}){return(0,H.jsx)(ue,{...t,widgetType:W,renderModule:U,renderComponent:O,attributes:{reportParams:f(!0),metrics:e}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{p(),h(),ce(),oe(),_(),me(),E(),he(),H=a(),ie(),U=`storybook/all-time-stats`,W=le(z,T),G={metrics:{control:`check`,options:w}},K={metrics:w},q={title:`Packages/Premium Analytics/Widgets/AllTimeStats`,component:O,tags:[`autodocs`],argTypes:{...G},parameters:{docs:{description:{component:"The \"All-time stats\" widget. Shows lifetime totals for the site — views, visitors, posts, and comments — as a responsive grid of metric tiles, sourced from the Jetpack Stats site-summary endpoint. Which tiles appear is controlled by the `metrics` attribute (`relevance: 'high'`), exposed inline in the widget header and in the settings drawer. This module has no comparison period, so the values render as bare numbers."}}}},J={render:ge,args:{...K},decorators:[v]},Y={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>V(`loading`)},X={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>V(`error`)},Z={render:()=>B(`last-365-days`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>V(`empty`)},Q={render:e=>(0,H.jsx)(_e,{...e}),args:{...fe,...K},argTypes:{...se,...G}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
