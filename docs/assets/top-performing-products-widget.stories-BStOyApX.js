import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{n,sl as r}from"./build-module-Bb7IR3OP.js";import{$ as ee,K as i,q as a}from"./report-metric-BAUfAG3E.js";import{n as o,t as s}from"./build-module-z2TigWH5.js";import{t as c,x as l}from"./src-B-_HxovR.js";import{Ct as u,pr as d}from"./chart-tooltip-BikeUN0i.js";import{C as f,D as p,E as te,S as ne,T as m,b as re,c as ie,t as ae,w as oe,x as h}from"./src-v76cCQiE.js";import{n as g,t as _}from"./force-stats-mock-state-BiRM8CkC.js";function v({attributes:e={},setError:t}){return(0,y.jsx)(ee,{attributes:e,setError:t,options:{from:`/`},children:(0,y.jsx)(ie,{limit:5})})}var y,b=e((()=>{ae(),y=t()})),x,S=e((()=>{n(),x={icon:r}})),C,w,T,E,D,O,k,se=e((()=>{C=`jpa/top-performing-products`,w=`Top performing products`,T=`Shows the top products by net revenue over the selected time period.`,E={content:`Your best-selling products by revenue over the selected time period.`},D=`store`,O=`framed`,k={name:C,title:w,description:T,help:E,category:D,presentation:O}}));function ce(e){let t=e.reduce((e,t)=>({total_orders:e.total_orders+Number(t.orders_count),total_quantity:e.total_quantity+Number(t.total_quantity),total_revenue:e.total_revenue+Number(t.product_net_revenue)}),{total_orders:0,total_quantity:0,total_revenue:0});return{data:e,summary:{total_orders:String(t.total_orders),total_products:String(e.length),total_quantity:String(t.total_quantity),total_revenue:t.total_revenue.toFixed(2)}}}function A(e){V||(V=!0,s.use(async(t,n)=>{let r=t.path??t.url??``;return r.startsWith(R)?ce(e):r.startsWith(z)?e.map(e=>({id:Number(e.product_id),name:e.product_name,images:[]})):n(t)}))}function j(e=!1,t=U){return{reportParams:d(e,t)}}function M({withComparison:e,preset:t}){let n=!!e,r=t??U;return!n&&r===U?`getDefaultQueryParams()`:n&&r===U?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function N(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
