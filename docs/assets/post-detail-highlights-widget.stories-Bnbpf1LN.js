import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{A as i,t as a}from"./build-module-DrryaqBL.js";import{I as o,O as s,an as c,n as l}from"./build-module-DmVuor49.js";import{A as u,t as d}from"./src-B3le4dug.js";import{Dn as f,Dr as p,c as m,cr as h,yt as g}from"./chart-tooltip-BtX3Jjce.js";import{t as _}from"./metric-tile-grid-DQv78W8I.js";import{M as v,N as y,U as b,z as x}from"./report-metric-CWPPaMwH.js";import{t as S}from"./widget-state-CE3oTs97.js";import{C as ee,S as te,T as C,b as w,t as T,w as E,x as D}from"./src-BAp3Kd5h.js";var O,k,A=e((()=>{O=`_root_12rzq_1`,k={root:O}}));function j(e,t,n){let r=0;for(let i of e)i.date>=t&&i.date<=n&&(r+=i.views);return r}function M(e,t){let{data:n,isLoading:r,isFetching:a,isError:o,refetch:s}=f({postId:e,fields:[`data`,`like_count`,`post`]});return{...(0,i.useMemo)(()=>{let e=n?.data??[],r=m(t.from),i=m(t.to),a=m(t.compare_from),o=m(t.compare_to),s=t.comp===`1`,c=r&&i?j(e,r,i):e.reduce((e,t)=>e+t.views,0),l;return s&&(l=a&&o?j(e,a,o):null),{views:c,viewsPrevious:l,comments:Number(n?.post?.comment_count)||0,likes:n?.like_count??0,hasComparison:s}},[n,t.comp,t.from,t.to,t.compare_from,t.compare_to]),isLoading:r,isFetching:a,isError:o,hasData:!!n,refetch:s}}var N=e((()=>{g(),T(),a()}));function P(){let{reportParams:e}=b(),n=p(e.post_id),{views:r,viewsPrevious:a,comments:l,likes:d,hasComparison:f,isLoading:m,isFetching:h,isError:g,hasData:v,refetch:y}=M(n,e),x=(0,i.useMemo)(()=>[{key:`views`,label:t(`Views`,`jetpack-premium-analytics`),icon:o,value:r,previousValue:a,note:t(`Views in the selected date range.`,`jetpack-premium-analytics`)},{key:`likes`,label:t(`Likes`,`jetpack-premium-analytics`),icon:s,value:d,previousValue:f?null:void 0,note:R()},{key:`comments`,label:t(`Comments`,`jetpack-premium-analytics`),icon:c,value:l,previousValue:f?null:void 0,note:R()}],[r,a,l,d,f]);return(0,I.jsx)(`div`,{className:k.root,children:(0,I.jsx)(S,{isLoading:m&&!v,isFetching:h,isError:!v&&g,isEmpty:n<=0,error:{description:t(`We couldn't load this post's highlights. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:y}]},empty:{icon:u,description:t(`Open a post or page report to see its highlights here.`,`jetpack-premium-analytics`)},children:(0,I.jsx)(_,{tiles:x,dataFormat:L})})})}function F({attributes:e={}}){return(0,I.jsx)(x,{attributes:e,children:(0,I.jsx)(P,{})})}var I,L,R,z=e((()=>{g(),d(),T(),a(),n(),l(),A(),N(),I=r(),L={type:`number`,options:{useMultipliers:!0,decimals:0}},R=()=>t(`All-time total — this metric has no per-post history.`,`jetpack-premium-analytics`)})),B,V=e((()=>{n(),l(),B={name:`jpa/post-detail-highlights`,title:t(`Post highlights`,`jetpack-premium-analytics`),help:{content:t(`Views, comments, and likes for the post or page being viewed.`,`jetpack-premium-analytics`)},icon:s,attributes:[],example:{attributes:{}}}}));function H({withComparison:e,hasPostScope:t}){return{reportParams:{...h(e),...t?{post_id:K}:{}}}}function U(e){return(0,G.jsx)(F,{attributes:H(e)})}function W({withComparison:e,hasPostScope:t,...n}){return(0,G.jsx)(ee,{...n,widgetType:{...B,presentation:`framed`},renderModule:q,renderComponent:F,attributes:H({withComparison:e,hasPostScope:t})})}var G,K,q,J,Y,X,Z,Q,$;e((()=>{g(),v(),E(),w(),z(),V(),G=r(),y(),K=779,q=`storybook/post-detail-highlights`,J={title:`Packages/Premium Analytics/Widgets/PostDetailHighlights`,component:F,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}},parameters:{docs:{description:{component:`The "Post highlights" widget: the scoped post's views, comments, and likes as metric tiles — the post detail Traffic view's highlights card. Views is period-scoped and carries a delta when comparison is on; comments and likes are lifetime totals with no per-post history, so their tiles show a note instead of a delta. Without a post scope the widget renders a scopeless empty state.`}}}},Y={render:U,args:{withComparison:!1,hasPostScope:!0},decorators:[D]},X={render:U,args:{withComparison:!0,hasPostScope:!0},decorators:[D]},Z={render:U,args:{withComparison:!1,hasPostScope:!1},decorators:[D]},Q={render:e=>(0,G.jsx)(W,{...e}),args:{...te,widgetWidth:4,widgetHeight:1,withComparison:!0,hasPostScope:!0},argTypes:{...C,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}}},Y.parameters={...Y.parameters,docs:{...Y.parameters?.docs,source:{originalSource:`{
