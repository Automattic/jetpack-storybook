...
\t\treportParams: ${A(e)},
\t} }
/>`}function M({withComparison:e,preset:t}){return L(),(0,F.jsx)(w,{attributes:k(e,t)})}function N(e){return L(),(0,F.jsx)(w,{attributes:k(!1,e)})}function P({withComparison:e,preset:t,...n}){return L(),(0,F.jsx)(g,{...n,widgetType:D,renderModule:I,renderComponent:w,attributes:{reportParams:d(e,t)}})}var F,I,L,R,z,B,V,H,U,W,G,K,q;e((()=>{u(),l(),S(),b(),h(),s(),E(),O(),F=r(),p(),I=`storybook/total-sales-over-time`,L=()=>o.Legend,R=`last-30-days`,z=c,B={title:`Packages/Premium Analytics/Widgets/TotalSalesOverTime`,component:w,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:z,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`Dashboard widget that displays total sales over time for the selected period.`}}}},V={render:M,args:{preset:R,withComparison:!1},decorators:[C],parameters:{docs:{source:{transform:(e,t)=>j(t.args)}}}},H={render:M,args:{preset:R,withComparison:!0},decorators:[C],parameters:{docs:{source:{transform:(e,t)=>j(t.args)}}}},U={render:()=>N(`last-90-days`),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(f(`orders/by-date`,`loading`),()=>f(`orders/by-date`,null))},W={render:()=>N(`last-7-days`),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(f(`orders/by-date`,`error`),()=>f(`orders/by-date`,null))},G={render:()=>N(`last-365-days`),tags:[`!autodocs`],decorators:[C],beforeEach:()=>(f(`orders/by-date`,`empty`),()=>f(`orders/by-date`,null))},K={render:e=>(0,F.jsx)(P,{...e}),args:{..._,preset:R,withComparison:!0},argTypes:{...v,preset:{control:`select`,options:z,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
