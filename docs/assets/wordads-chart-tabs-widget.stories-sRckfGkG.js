import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Uu as i,ju as a,t as o,ul as s}from"./build-module-2iv4IIRq.js";import{$ as c,ct as l,m as ee,ot as te,tt as u,v as ne,vt as re}from"./hooks-dNLTgJT3.js";import{b as ie,t as ae}from"./src-C-E2d-Lb.js";import{J as d,K as oe,X as se,t as ce}from"./src-CJGEmgc4.js";import{bn as le,i as ue,r as f,tn as p,w as de}from"./date-period-dropdown-Cqf-rUWL.js";import{r as fe,t as pe}from"./metric-tabs-chart-skeleton-B0EjSR-v.js";import{c as m,i as me,r as h}from"./register-report-mocks-DtBZuojW.js";import{t as he}from"./widget-state-D2xrzzvz.js";import{t as g}from"./src-BX0QnOQ5.js";import{a as ge,c as _e,i as _,l as v,n as ve,o as ye,r as y,s as be}from"./with-widget-canvas-TkRcCiew.js";import{n as xe,r as Se,t as Ce}from"./with-site-time-zone-ngtW_VDw.js";var b,x=e((()=>{ce(),b={presetIds:[se,d,oe],periods:[`day`,`week`,`month`]}})),S,C=e((()=>{u(),x(),S=te(b)})),w,T,E=e((()=>{w=`_root_sp1nf_1`,T={root:w}})),D,O,k=e((()=>{n(),D={type:`currency`},O=[{id:`impressions`,label:t(`Ads Served`,`jetpack-premium-analytics-pkg`)},{id:`cpm`,label:t(`Average CPM`,`jetpack-premium-analytics-pkg`),dataFormat:D},{id:`revenue`,label:t(`Revenue`,`jetpack-premium-analytics-pkg`),dataFormat:D}]}));function A(e,t){let{primary:n,timezone:r,isLoading:a,isFetching:o,isError:s,refetch:c}=de((0,i.useMemo)(()=>({...e,period:t}),[e,t])),l=n.data;return{metrics:(0,i.useMemo)(()=>O.map(e=>re({primary:l,comparison:void 0,hasComparison:!1,field:e.id,label:e.label,dataFormat:e.dataFormat,zone:r})),[l,r]),isLoading:a,isFetching:o,isError:s&&!l?.data?.length,isEmpty:l!==void 0&&!l.data?.length,refetch:c}}var we=e((()=>{f(),a(),k(),g()}));function Te({chartType:e}){let{reportParams:n}=ne(),{metrics:r,isLoading:i,isFetching:a,isError:o,isEmpty:s,refetch:c}=A(n,ue({...n,interval:void 0},b.periods));return(0,M.jsx)(`div`,{className:T.root,children:(0,M.jsx)(he,{isLoading:i,isFetching:a,isError:o,isEmpty:s,error:{description:t(`We couldn't load WordAds data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:c}]},empty:{icon:ie,description:t(`No WordAds data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,M.jsx)(pe,{}),children:(0,M.jsx)(fe,{metrics:r,dataFormat:N,chartType:e,groupLabel:t(`WordAds metric`,`jetpack-premium-analytics-pkg`),tooltipMetrics:`all`})})})}function j({attributes:e={}}){let t=e.reportParams??S;return(0,M.jsx)(le,{offersComparison:!1,children:(0,M.jsx)(ee,{attributes:{...e,reportParams:t},children:(0,M.jsx)(Te,{chartType:e.chartType})})})}var M,N,Ee=e((()=>{f(),ae(),g(),n(),C(),x(),E(),we(),M=r(),N={type:`number`,options:{useMultipliers:!0,decimals:0}}})),P,De=e((()=>{u(),g(),o(),C(),x(),P={icon:s,attributes:[l({grain:b,offersComparison:!1}),c()],example:{attributes:{reportParams:S,chartType:`line`}}}})),F,I,L,R,z,B,V,Oe=e((()=>{F=`jpa/wordads-chart-tabs`,I=`WordAds`,L=`Track ads served, average CPM, and revenue over the selected period.`,R={content:`Track ads served, average CPM, and revenue over the selected period.`},z=`stats`,B=`framed`,V={name:F,title:I,description:L,help:R,category:z,presentation:B}}));function H(e){return({chartType:t})=>(0,U.jsx)(j,{attributes:{reportParams:p(!1,e),chartType:t}})}function ke({chartType:e,...t}){return(0,U.jsx)(be,{...t,widgetType:_(V,P),renderModule:W,renderComponent:j,attributes:{reportParams:p(!1),chartType:e}})}var U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{_e(),f(),h(),ge(),ve(),Ce(),Ee(),De(),Oe(),U=r(),me(),W=`storybook/wordads-chart-tabs`,G={chartType:{control:`inline-radio`,options:[`line`,`bar`]}},K={title:`Packages/Premium Analytics/Widgets/WordAdsChartTabs`,component:j,tags:[`autodocs`],decorators:[Se],argTypes:{...xe,...G},args:{chartType:`line`},parameters:{docs:{description:{component:"WordAds performance over the selected period as selectable metric tabs (Ads Served, Average CPM, and Revenue, matching the Calypso WordAds page's tabs) over a line or bar chart. Ads Served is a count; CPM and revenue are currency (WordAds pays USD). The widget hosts its own date range control in its header, saved onto the widget instance; the bucket size follows the selected window. The \"Chart type\" control is the `chartType` attribute (`relevance: 'high'`), exposed by the widget host; which metric is plotted is the chart's own tab selection. WordAds stats are computed nightly, so the last bucket of a range ending today stays empty until that run lands; only a range ending in the future is clamped back to today. Data comes from the `useStatsWordAdsStats` hook (the `wordads` proxy prefix); in Storybook it is served by `registerReportMocks`. Requires WordAds to be active on the site for live data."}}}},q={render:H(`last-30-days`),decorators:[y]},J={render:H(`last-30-days`),args:{chartType:`bar`},decorators:[y]},Y={render:H(`last-90-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(`wordads/stats`,`loading`),()=>m(`wordads/stats`,null))},X={render:H(`last-7-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(`wordads/stats`,`error`),()=>m(`wordads/stats`,null))},Z={render:H(`last-365-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(m(`wordads/stats`,`empty`),()=>m(`wordads/stats`,null))},Q={render:e=>(0,U.jsx)(ke,{...e}),args:{...ye,chartType:`line`},argTypes:{...v,...G}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
