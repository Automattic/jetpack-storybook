import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{t as n,ul as r}from"./build-module-2iv4IIRq.js";import{g as i}from"./hooks-BCeaDlTw.js";import{rt as a,t as o}from"./src-D1E5MwTJ.js";import{en as s,r as c}from"./date-period-dropdown-BOuPhU2o.js";import{i as l,r as u,s as d}from"./register-report-mocks-WqT1Td4z.js";import{f,t as p}from"./src-B9pks8pR.js";import{a as m,c as h,i as g,l as _,n as v,o as y,r as b,s as x}from"./with-widget-canvas-Dh2Gt0sQ.js";function S({attributes:e={},setError:t}){return(0,C.jsx)(i,{attributes:e,setError:t,options:{from:`/`},children:(0,C.jsx)(f,{view:`source`})})}var C,w=e((()=>{p(),C=t()})),T,E=e((()=>{n(),T={icon:r}})),D,O,k,A,j,M,N,P=e((()=>{D=`jpa/sales-by-utm-source`,O=`Sales by UTM source`,k=`Shows the top UTM sources by order revenue over the selected time period.`,A={content:`See which referral sources are driving sales in your store.`},j=`store`,M=`framed`,N={name:D,title:O,description:k,help:A,category:j,presentation:M}}));function F(e=!1,t=U){return{reportParams:s(e,t)}}function I({withComparison:e,preset:t}){let n=!!e,r=t??U;return!n&&r===U?`getDefaultQueryParams()`:n&&r===U?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function L(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
