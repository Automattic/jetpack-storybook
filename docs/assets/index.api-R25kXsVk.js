...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.code,{children:`seriesLabels`})}),` (optional): The series labels this item controls. Auto-derived items set it to just the item's own series, unless `,(0,c.jsx)(t.code,{children:`legend.collapseGroups`}),` is on, in which case a group collapses to one item carrying every series it toggles (primary first). An interactive legend toggles all of these together`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.code,{children:`interactive`})}),` (optional): Set to `,(0,c.jsx)(t.code,{children:`false`}),` to keep this item static inside an interactive legend. It renders without a button role, ignores clicks, and never dims; the `,(0,c.jsx)(t.code,{children:`comparisonItem`}),` option uses this for the "Comparison period" item`]}),`
`]}),`
