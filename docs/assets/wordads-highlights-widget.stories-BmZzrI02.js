import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Ui as i,Zn as a,hi as o,k as s,t as c}from"./build-module-CR6EsQjA.js";import{g as l}from"./hooks-B_Hub6A2.js";import{b as ee,t as te}from"./src-CldFJNXL.js";import{Zt as u,b as d,t as f}from"./src-C-qi8TNx.js";import{f as ne,h as re}from"./chart-tooltip-BQc707fX.js";import{r as ie,t as ae}from"./metric-tile-grid-skeleton-DhjoDiOi.js";import{G as oe,K as se,W as p}from"./report-metric-CbUly8bW.js";import{t as ce}from"./widget-state-DzStcuj2.js";import{C as m,D as le,E as h,S as g,T as _,b as v,t as y,w as b,x}from"./src-5FQbctcN.js";var S,C,w=e((()=>{S=`_root_15bqk_2`,C={root:S}})),T,E,D,O=e((()=>{ne(),n(),c(),T=[{id:`earnings`,label:t(`Earnings`,`jetpack-premium-analytics-pkg`)},{id:`paid`,label:t(`Paid`,`jetpack-premium-analytics-pkg`)},{id:`outstanding`,label:t(`Outstanding amount`,`jetpack-premium-analytics-pkg`)}],E=T.map(e=>e.id),D={icon:i,attributes:[{id:`metrics`,label:t(`Metrics`,`jetpack-premium-analytics-pkg`),type:`array`,relevance:`high`,Edit:re,elements:T.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:E}}}}));function ue({metrics:e=E}){let n=new Set(e),r=T.some(({id:e})=>n.has(e)),{data:i,isLoading:a,isFetching:o,isError:s,refetch:c}=d(void 0,{enabled:r}),l=T.filter(({id:e})=>n.has(e)).map(({id:e,label:t})=>({key:e,label:t,icon:M[e].icon,value:M[e].value(i)}));return(0,A.jsx)(`div`,{className:C.root,children:(0,A.jsx)(ce,{isLoading:a,isFetching:o,isError:s,isEmpty:!r,error:{description:t(`We couldn't load WordAds earnings. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:()=>{c()}}]},empty:{icon:ee,description:t(`Select at least one metric to display.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,A.jsx)(ae,{tiles:l.length}),children:(0,A.jsx)(ie,{tiles:l,dataFormat:j,currencyCode:`USD`})})})}function k({attributes:e={}}){return(0,A.jsx)(l,{attributes:e,children:(0,A.jsx)(ue,{metrics:e.metrics})})}var A,j,M,de=e((()=>{f(),te(),y(),n(),c(),w(),O(),A=r(),j={type:`currency`,options:{decimals:2}},M={earnings:{icon:o,value:e=>e?.total_earnings??0},paid:{icon:a,value:e=>e?e.total_earnings-e.total_amount_owed:0},outstanding:{icon:s,value:e=>e?.total_amount_owed??0}}})),N,P,F,I,L,R,z,B=e((()=>{N=`jpa/wordads-highlights`,P=`WordAds highlights`,F=`Your WordAds earnings at a glance — total earnings, amount paid, and outstanding balance.`,I={content:`Payment is made once your outstanding balance reaches $100, approximately 45 days after the end of the month in which it was earned.`},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function V({metrics:e}){return(0,H.jsx)(k,{attributes:{reportParams:u(),metrics:e}})}function fe({metrics:e,...t}){return(0,H.jsx)(_,{...t,widgetType:W,renderModule:U,renderComponent:k,attributes:{reportParams:u(!0),metrics:e}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),h(),m(),v(),oe(),de(),O(),B(),H=r(),se(),U=`storybook/wordads-highlights`,W=g(z,D),G={metrics:{control:`check`,options:E}},K={metrics:E},q={title:`Packages/Premium Analytics/Widgets/WordAdsHighlights`,component:k,tags:[`autodocs`],argTypes:{...G},parameters:{docs:{description:{component:'The "WordAds highlights" widget. Shows all-time WordAds payouts — total earnings, amount paid, and outstanding balance — as a grid of currency tiles (paid = earnings − outstanding). Ported from the Calypso WordAds "Totals" section. Which cards appear is controlled by the `metrics` attribute (`relevance: \'high\'`), exposed inline in the widget header and in the settings drawer. Data comes from the designated `useStatsWordAdsEarnings` hook; in Storybook it is served by `registerReportMocks()` (the `wordads/earnings` handler). The earnings module has no comparison period, so the tiles show bare amounts.'}}}},J={render:V,args:{...K},decorators:[x]},Y={render:V,args:{...K},tags:[`!autodocs`],decorators:[x],beforeEach:p(`loading`)},X={render:V,args:{...K},tags:[`!autodocs`],decorators:[x],beforeEach:p(`error`)},Z={render:V,args:{metrics:[]},decorators:[x]},Q={render:e=>(0,H.jsx)(fe,{...e}),args:{...b,widgetWidth:1,widgetHeight:1,...K},argTypes:{...le,...G}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
