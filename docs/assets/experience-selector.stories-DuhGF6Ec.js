import{n as e}from"./chunk-zsgVPwQN.js";import{Bc as t,My as n,Ny as r,Va as i,cu as a,ky as o,ou as s,ql as c,ru as l,su as u}from"./iframe-DY8K1qQG.js";import{c as d,i as f,l as p,n as m,o as h,r as g,s as _,t as v}from"./experience-option-BPqh1QIr.js";var y=e((()=>{}));function b(){let{isUpdating:e,supportsOnlyClassicSearch:n,isWpcom:i,blockOverlayEnabled:a}=l(e=>({isUpdating:e(_).isUpdatingJetpackSettings(),supportsOnlyClassicSearch:e(_).supportsOnlyClassicSearch(),isWpcom:e(_).isWpcom(),blockOverlayEnabled:e(_).isBlockOverlayEnabled()}),[]),o=f.filter(e=>!(e===g.OFF&&i||e===g.OVERLAY_BLOCKS&&!a)),s=t=>e||n&&(t===g.EMBEDDED||t===g.OVERLAY||t===g.OVERLAY_BLOCKS);return(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`h2`,{id:`jp-search-experience-selector-heading`,className:`jp-search-experience-selector__heading`,children:r(`Select a search experience for your visitors`,`jetpack-search-pkg`)}),(0,x.jsx)(`div`,{className:`jp-search-experience-selector`,children:(0,x.jsx)(`fieldset`,{className:`jp-search-experience-selector__fieldset`,"aria-labelledby":`jp-search-experience-selector-heading`,children:(0,x.jsx)(t,{columns:[1,2],gap:6,children:o.map(e=>(0,x.jsx)(v,{experience:e,disabled:s(e)},e))})})})]})}var x,S=e((()=>{i(),c(),n(),d(),h(),m(),y(),x=o(),b.__docgenInfo={description:`Top-level dashboard control: a fieldset of cards. Inactive cards behave
