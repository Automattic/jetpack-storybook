import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{n,r}from"./abbreviated-value-Drb-ekXx.js";var i,a,o,s,c,l;e((()=>{r(),i=t(),a={title:`Packages/Premium Analytics/Widgets Toolkit/Components/AbbreviatedValue`,component:n,tags:[`autodocs`]},o={args:{value:18432,dataFormat:{type:`number`,options:{useMultipliers:!0}}}},s={args:{value:432,dataFormat:{type:`number`,options:{useMultipliers:!0}}}},c={render:()=>(0,i.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`},children:[999,1234,54321,99950,234567,1234567,123456789].map(e=>(0,i.jsx)(n,{value:e,dataFormat:{type:`number`,options:{useMultipliers:!0}}},e))})},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    value: 18432,
    dataFormat: {
      type: 'number',
...
}`,...c.parameters?.docs?.source},description:{story:`The compact rule across magnitudes: full below 1,000, one decimal while the
mantissa has two digits, none from three.`,...c.parameters?.docs?.description}}},l=[`Compact`,`Plain`,`Scale`]}))();export{o as Compact,s as Plain,c as Scale,l as __namedExportsOrder,a as default};