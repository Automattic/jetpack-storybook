import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{Qi as n,n as r}from"./build-module-CDRs4YxF.js";import{$ as i,K as ee,Y as a,q as o}from"./report-metric-4jWKJgzb.js";import{t as s,x as c}from"./src-DhTT1cTw.js";import{Dr as l,Tt as u,hr as d}from"./chart-tooltip-D4zjxNqE.js";import{t as f}from"./visitors-by-location-widget-C47KUYQc.js";import{C as p,D as m,E as h,S as g,T as _,b as v,t as y,w as b,y as x}from"./src-Csln2ZSb.js";function S({attributes:e={},setError:t}){return(0,C.jsx)(i,{attributes:e,setError:t,options:{from:`/`},children:(0,C.jsx)(f,{})})}var C,w=e((()=>{y(),C=t()})),T,E=e((()=>{r(),T={icon:n}})),D,O,k,A,j,M,N,P=e((()=>{D=`jpa/visitors-by-location`,O=`Visitors by location`,k=`See where your store visitors are located geographically.`,A={content:`See where your store visitors are located geographically.`},j=`visitors`,M=`framed`,N={name:D,title:O,description:k,help:A,category:j,presentation:M}}));function F(e=!1,t=U){return{reportParams:d(e,t)}}function I({withComparison:e,preset:t}){let n=!!e,r=t??U;return!n&&r===U?`getDefaultQueryParams()`:n&&r===U?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function L(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<VisitorsByLocationRender
\tattributes={ {
\t\treportParams: ${I(e)},
\t} }
/>`}function R({withComparison:e,preset:t}){return(0,V.jsx)(S,{attributes:F(e,t)})}function z(e){return(0,V.jsx)(S,{attributes:F(!1,e)})}function B({withComparison:e,preset:t,...n}){return(0,V.jsx)(l,{children:(0,V.jsx)(_,{...n,widgetType:g(N,T),renderModule:H,renderComponent:S,attributes:F(e,t)})})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{u(),s(),h(),p(),v(),ee(),w(),E(),P(),V=t(),o(),H=`storybook/visitors-by-location`,U=`last-30-days`,W=c,G=e=>(0,V.jsx)(l,{children:(0,V.jsx)(x,{children:(0,V.jsx)(e,{})})}),K={title:`Packages/Premium Analytics/Widgets/VisitorsByLocation`,component:S,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:W,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`The "Visitors by location" widget. Fetches the visitors report and displays where store visitors are located geographically.`}}}},q={render:R,args:{preset:U,withComparison:!1},decorators:[G],parameters:{docs:{source:{transform:(e,t)=>L(t.args)}}}},J={render:R,args:{preset:U,withComparison:!0},decorators:[G],parameters:{docs:{source:{transform:(e,t)=>L(t.args)}}}},Y={render:()=>z(`last-90-days`),tags:[`!autodocs`],decorators:[G],beforeEach:()=>(a(`sessions/by-location`,`loading`),()=>a(`sessions/by-location`,null))},X={render:()=>z(`last-7-days`),tags:[`!autodocs`],decorators:[G],beforeEach:()=>(a(`sessions/by-location`,`error`),()=>a(`sessions/by-location`,null))},Z={render:()=>z(`last-365-days`),tags:[`!autodocs`],decorators:[G],beforeEach:()=>(a(`sessions/by-location`,`empty`),()=>a(`sessions/by-location`,null))},Q={render:e=>(0,V.jsx)(B,{...e}),args:{...b,preset:U,withComparison:!0},argTypes:{...m,preset:{control:`select`,options:W,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
