import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-Czf1q4o4.js";import{i as r,n as i,r as a,t as o}from"./blocks-DDGV76BW.js";import{t as s}from"./mdx-react-shim-By3OR1Rd.js";import{Start as c,t as l}from"./glyph.stories-DV-S5vkY.js";import{Animation as u,BrokenLine as d,Comparison as f,CurveTypes as p,DateStringFormats as m,Default as h,ErrorStates as g,GradientCustomColors as _,GradientFilled as v,GradientTransparent as y,SingleSeries as b,SmartFormatting as x,WithCompositionLegend as S,WithPointerEvents as C,n as w,t as T}from"./index.stories-DCYwh4-z.js";function E(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,O.jsxs)(O.Fragment,{children:[(0,O.jsx)(i,{title:`JS Packages/Charts Library/Charts/Line Chart`,of:T}),`
...
`,(0,O.jsx)(a,{language:`jsx`,code:`import { LineChart } from '@automattic/charts';
...
`,(0,O.jsx)(o,{of:b}),`
`,(0,O.jsx)(a,{language:`jsx`,code:`<LineChart
	data={[
		{
			label: 'Temperature',
			data: [
...
`,(0,O.jsxs)(t.li,{children:[(0,O.jsx)(t.strong,{children:(0,O.jsx)(t.code,{children:`aspectRatio`})}),`: Height-to-width ratio (e.g. `,(0,O.jsx)(t.code,{children:`0.5`}),`) for responsive charts; the chart is contained within its parent on both axes. When omitted, fills the parent container's height`]}),`
...
`,(0,O.jsx)(a,{language:`jsx`,code:`// Theme configuration example
const customTheme = {
	lineChart: {
		lineStyles: {
			comparison: {
...
`,(0,O.jsx)(o,{of:_}),`
`,(0,O.jsx)(a,{language:`jsx`,code:`const data = [
	{
		label: 'Revenue',
		data: chartData,
		options: {
...
`,(0,O.jsx)(o,{of:m}),`
`,(0,O.jsx)(a,{language:`jsx`,code:`// Date objects
...
`,(0,O.jsx)(a,{language:`jsx`,code:`<LineChart data={data}>
	<LineChart.AnnotationsOverlay>
		<LineChart.Annotation
...
`,(0,O.jsx)(a,{language:`tsx`,code:`import { GlobalChartsProvider, LineChart, type ChartTheme } from '@automattic/charts';
...
`,(0,O.jsx)(a,{language:`jsx`,code:`// Fill parent container (default) - parent needs explicit height
...
`,(0,O.jsx)(o,{of:u}),`
`,(0,O.jsx)(a,{language:`tsx`,code:`<LineChart
	data={ data }
	width={ 800 }
	height={ 400 }
	animation={ true }
...
`]})]})}function D(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,O.jsx)(t,{...e,children:(0,O.jsx)(E,{...e})}):E(e)}var O;e((()=>{O=t(),s(),r(),w(),l()}))();export{D as default};