import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n,u as r}from"./build-module-2QZQpBH2.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{Gi as a,Gu as o,Nu as s,t as c}from"./build-module-zwSmKorH.js";import{b as l,g as u,r as d}from"./hooks-9PWh__9i.js";import{b as ee,t as f}from"./src-DFNM1k7F.js";import{D as p,Zt as m,t as h}from"./src-DOrTEoKe.js";import"./constants-B1kGztHF.js";import{A as te,f as ne,gt as re,mt as ie,p as ae,pt as oe}from"./chart-tooltip-D2kxHGd3.js";import{r as se,t as ce}from"./leaderboard-skeleton-CFlstDda.js";import{F as le,G as g,K as _,N as ue,S as de,b as fe,v as pe,w as me}from"./report-metric-CaluDlNe.js";import{t as he}from"./widget-state-Ba0pg5Fh.js";import{C as v,D as y,E as b,O as ge,S as _e,T as ve,b as ye,k as x,t as be,w as xe,x as S}from"./src-Cvmrr9ge.js";import{n as Se,t as Ce}from"./register-stats-mocks-D6yrbmPh.js";import{n as we,t as C}from"./force-stats-mock-state-CtpesPHZ.js";var w,T,E,D,Te=e((()=>{w=`_root_xmjm2_1`,T=`_content_xmjm2_9`,E=`_backLink_xmjm2_16`,D={root:w,content:T,backLink:E}}));function O(e){return typeof e.label==`string`?e.label:String(e.label)}function Ee(e){return{postId:e.id,label:O(e),value:e.value,previousValue:e.previousValue,href:e.href}}function De(e){return{label:O(e),value:e.value,previousValue:e.previousValue,children:e.children?.map(Ee),childrenHaveComparison:e.childrenHaveComparison}}function Oe({reportParams:e,utmParam:t,max:n}){let{comparisonRows:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:l}=p({...e,utmParam:t,max:n},{maxRows:n}),u=(r?.rows??[]).map(De),d=u.length===0&&s;return{data:u,hasComparison:i,isLoading:a,isFetching:o,isError:d,error:d?c:null,refetch:l}}var ke=e((()=>{h()}));function Ae(e){switch(e){case`utm_source,utm_medium`:return`source-medium`;case`utm_campaign,utm_source,utm_medium`:return`campaign-source-medium`;case`utm_source`:return`source`;case`utm_medium`:return`medium`;case`utm_campaign`:return`campaign`}}function je({utmDimension:e,showReportLink:n}){let{reportParams:i}=l(),{drillDownItem:a,drillDown:s,resetDrillDown:c}=d();(0,o.useEffect)(()=>{c()},[c,e]);let{data:u,hasComparison:f,isLoading:p,isFetching:m,isError:h,error:ne,refetch:ae}=Oe({reportParams:i,utmParam:e,max:10}),g=(0,o.useMemo)(()=>u.find(e=>e.label===a)??null,[u,a]),_=!!g?.children?.length,v=(0,o.useMemo)(()=>_?g?.children??[]:u,[u,_,g]),y=_?!!g?.childrenHaveComparison:f;(0,o.useEffect)(()=>{a&&!_&&!p&&!m&&!h&&c()},[a,_,p,m,h,c]);let b=(0,o.useMemo)(()=>{let e=ie(v.map(e=>e.value),y?v.map(e=>e.previousValue):[]);return v.map((n,i)=>{let a=n.previousValue,o=`postId`in n?n:null,c=!_&&`children`in n&&!!n.children?.length;return{id:`${i}-${n.label}`,...o?{label:(0,A.jsx)(pe,{id:o.postId,label:o.label,link:o.href})}:ue({label:n.label,media:{kind:`none`},action:le({hasChildren:c,drillDown:{onClick:()=>s(n.label),ariaLabel:r(t(`View posts for %s`,`jetpack-premium-analytics-pkg`),n.label)}})}),currentValue:n.value,currentShare:oe(n.value,e),previousValue:a,previousShare:y&&a!==void 0?oe(a,e):void 0,delta:y&&a!==void 0?re(n.value,a):void 0}})},[v,_,s,y]);return(0,A.jsxs)(A.Fragment,{children:[_?(0,A.jsx)(me,{label:t(`All UTM insights`,`jetpack-premium-analytics-pkg`),ariaLabel:t(`View all UTM insights`,`jetpack-premium-analytics-pkg`),onClick:c,className:D.backLink}):null,(0,A.jsx)(`div`,{className:D.content,children:(0,A.jsx)(he,{isLoading:p,isFetching:m,isError:h,isEmpty:u.length===0,error:te(ne,{retryDescription:t(`We couldn't load UTM data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:ae}),empty:{icon:ee,description:t(`No UTM data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,A.jsx)(ce,{rows:10}),children:(0,A.jsx)(se,{data:b,withComparison:y,withOverlayLabel:!0,showLegend:!1,dataFormat:j})})}),n&&(0,A.jsx)(de,{children:(0,A.jsx)(fe,{report:`utm`,section:Ae(e)})})]})}function k({attributes:e={}}){let t=e.utmDimension??M,n=e.showReportLink??!0;return(0,A.jsx)(u,{attributes:e,children:(0,A.jsx)(`div`,{className:D.root,children:(0,A.jsx)(je,{utmDimension:t,showReportLink:n})})})}var A,j,M,Me=e((()=>{s(),n(),be(),f(),Te(),ke(),A=i(),j={type:`number`,options:{useMultipliers:!0,decimals:0}},M=`utm_source,utm_medium`})),N,Ne=e((()=>{n(),c(),ne(),N={icon:a,attributes:[{id:`utmDimension`,label:t(`UTM parameter`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:ae,elements:[{label:t(`Source / Medium`,`jetpack-premium-analytics-pkg`),value:`utm_source,utm_medium`},{label:t(`Campaign / Source / Medium`,`jetpack-premium-analytics-pkg`),value:`utm_campaign,utm_source,utm_medium`},{label:t(`Source`,`jetpack-premium-analytics-pkg`),value:`utm_source`},{label:t(`Medium`,`jetpack-premium-analytics-pkg`),value:`utm_medium`},{label:t(`Campaign`,`jetpack-premium-analytics-pkg`),value:`utm_campaign`}],relevance:`high`}],example:{attributes:{utmDimension:`utm_source,utm_medium`}}}})),P,F,I,L,R,z,B,Pe=e((()=>{P=`jpa/utm-insights`,F=`Top UTM`,I=`Traffic breakdown by UTM parameters — source, medium, campaign, and combinations.`,L={content:`Your top UTM campaigns, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},R=`traffic`,z=`framed`,B={name:P,title:F,description:I,help:L,category:R,presentation:z}}));function V(e){return(0,H.jsx)(k,{attributes:{utmDimension:`utm_source,utm_medium`,reportParams:m(!1,e)}})}function Fe({withComparison:e,...t}){return(0,H.jsx)(ve,{...t,widgetType:W,renderModule:U,renderComponent:k,attributes:{utmDimension:`utm_source,utm_medium`,reportParams:m(e)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$,Ie;e((()=>{h(),b(),ge(),v(),ye(),g(),Ce(),we(),Me(),Ne(),Pe(),H=i(),_(),Se(),U=`storybook/utm-insights`,W=_e(B,N),G={title:`Packages/Premium Analytics/Widgets/UtmInsights`,component:k,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params and deltas.`}},parameters:{docs:{description:{component:`The "UTM Insights" widget. Shows traffic breakdown by UTM parameter as a ranked leaderboard. The active dimension (Source/Medium, Campaign, etc.) is switched via a dropdown in the widget header and persisted per widget instance.`}}}},K={render:({withComparison:e})=>(0,H.jsx)(k,{attributes:{utmDimension:`utm_source,utm_medium`,reportParams:m(e)}}),args:{withComparison:!1},decorators:[S,x]},q={render:({withComparison:e})=>(0,H.jsx)(k,{attributes:{utmDimension:`utm_source,utm_medium`,reportParams:m(e)}}),args:{withComparison:!0},decorators:[S,x]},J={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[S,x],beforeEach:()=>(C(`stats/utm`,`loading`),()=>C(`stats/utm`,null))},Y={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[S,x],beforeEach:()=>(C(`stats/utm`,`error`),()=>C(`stats/utm`,null))},X={render:()=>V(`last-12-months`),tags:[`!autodocs`],decorators:[S,x],beforeEach:()=>(C(`stats/utm`,`error-retryable`),()=>C(`stats/utm`,null))},Z={render:()=>V(`last-year`),tags:[`!autodocs`],decorators:[S,x],beforeEach:()=>(C(`stats/utm`,`empty`),()=>C(`stats/utm`,null))},Q={render:({withComparison:e})=>(0,H.jsx)(k,{attributes:{utmDimension:`utm_campaign`,reportParams:m(e)}}),args:{withComparison:!1},decorators:[S,x]},$={render:e=>(0,H.jsx)(Fe,{...e}),args:{...xe,withComparison:!1},argTypes:{...y,withComparison:{control:`boolean`,description:`Include previous-period comparison report params and deltas.`}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
  render: ({
    withComparison
