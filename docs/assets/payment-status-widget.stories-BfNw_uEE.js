import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-Da_5_6n_.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{hn as o,n as s}from"./build-module-Dj4HXO1h.js";import{a as c,it as l,l as ee,r as te,st as u,u as d,xt as f}from"./hooks-CPR62mqL.js";import{S as p,t as m}from"./build-module-CrVt8dot.js";import{i as h,t as g}from"./src-B1Xti2od.js";import{l as _,t as v}from"./src-BlU2m1VV.js";import{R as y,h as b}from"./chart-tooltip-lWr2ZkB0.js";import{t as ne}from"./donut-chart-Cjqqkr_Z.js";import{i as x}from"./metric-tabs-chart-DGfgTRjc.js";import{n as S,t as C}from"./register-report-mocks-Cl_ODg0T.js";import{i as w,n as T,r as E,t as D}from"./widget-dashboard-with-widget-DG249V1A.js";import{t as O}from"./src-B-SE7CgW.js";var k,A,j=t((()=>{k=`_container_18scw_1`,A={container:k}}));function re(){let{reportParams:e}=ee(),{primary:t,comparison:n,hasComparison:r,isLoading:i,isFetching:a,hasData:o,isError:s,error:c,refetch:u}=l({...e,filters:y}),d=i&&!o,m=a&&o,{chartData:g,total:_,comparisonTotal:v,legendData:S}=(0,M.useMemo)(()=>b(t.data,n.data),[t.data,n.data]),C=f(g);return te(s,c,u)?null:d?(0,N.jsx)(x,{}):(0,N.jsxs)(N.Fragment,{children:[(0,N.jsx)(p,{className:A.container,direction:`column`,align:`center`,justify:`center`,children:(0,N.jsx)(ne,{chartData:g,value:_,styles:C,comparisonValue:r?v:null,legendData:S,showLegend:!0,dataFormat:{type:`currency`,options:{useMultipliers:!0,decimals:1}},maxSize:null,emptyStateIcon:h,withTooltips:!0})}),m&&(0,N.jsx)(x,{})]})}var M,N,ie=t((()=>{d(),g(),O(),m(),M=e(n(),1),j(),N=a()}));function P({attributes:e={},setError:t}){return(0,F.jsx)(c,{attributes:e,setError:t,options:{from:`/`},children:(0,F.jsx)(re,{})})}var F,I=t((()=>{O(),ie(),F=a()})),L,R=t((()=>{i(),s(),L={name:`jpa/payment-status`,title:r(`Payment status`,`jetpack-premium-analytics`),description:r(`Shows the breakdown of paid vs unpaid order revenue over the selected time period.`,`jetpack-premium-analytics`),icon:o}}));function z(e=!1,t=K){return{reportParams:u(e,t)}}function B({withComparison:e,preset:t}){let n=!!e,r=t??K;return!n&&r===K?`getDefaultQueryParams()`:n&&r===K?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function V(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
