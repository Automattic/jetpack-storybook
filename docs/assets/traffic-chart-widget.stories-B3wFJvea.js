import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-2QZQpBH2.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{C as o,Uu as s,ju as c,t as l}from"./build-module-2iv4IIRq.js";import{Q as u,b as d,dt as f,g as p,gt as m,st as h}from"./hooks-DMvMF82z.js";import{M as g,t as _}from"./src-C-E2d-Lb.js";import{$t as v,L as y,a as ee,r as b}from"./date-period-dropdown-B2m_Zps5.js";import{r as x,t as te}from"./metric-tabs-chart-skeleton-CuKIQ3Pf.js";import{i as S,r as ne,s as C}from"./register-report-mocks-DJvsDrEY.js";import{t as re}from"./widget-state-BjdeynAz.js";import{t as w}from"./src-B1aUa2q-.js";import{a as ie,c as ae,d as oe,i as se,l as ce,n as le,o as ue,r as T,s as de,u as fe}from"./with-widget-canvas-CHVw9kKN.js";import{n as pe,r as me,t as he}from"./with-site-time-zone-ngtW_VDw.js";var ge,_e,ve=t((()=>{ge=`_root_sp1nf_1`,_e={root:ge}})),E,D,O,k=t((()=>{i(),l(),w(),E=[`hour`,`day`,`week`,`month`],D=[{id:`views`,label:r(`Views`,`jetpack-premium-analytics-pkg`),counterpartId:`visitors`},{id:`visitors`,label:r(`Visitors`,`jetpack-premium-analytics-pkg`),counterpartId:`views`},{id:`comments`,label:r(`Comments`,`jetpack-premium-analytics-pkg`)},{id:`likes`,label:r(`Likes`,`jetpack-premium-analytics-pkg`)}],O={icon:o,attributes:[u()],example:{attributes:{chartType:`line`}}}}));function A(e,t,n){return{...e,stat_fields:t,period:n}}function ye(e,t){let n=t===`hour`,i=(0,s.useCallback)(e=>!n||j.has(e),[n]),a=(0,s.useMemo)(()=>A(e,n?`views`:`views,visitors`,t),[e,t,n]),o=(0,s.useMemo)(()=>A(e,`likes,comments`,t),[e,t]),c=y(a),l=y(o,{enabled:!n}),u=c.primary.data,d=c.comparison.data,f=c.hasComparison,p=c.timezone,h=l.primary.data,g=l.comparison.data,_=l.hasComparison,v=l.timezone,ee=(0,s.useMemo)(()=>D.map(e=>{let t=e.id===`views`||e.id===`visitors`;return{...m({primary:t?u:h,comparison:t?d:g,hasComparison:t?f:_,field:e.id,label:e.label,zone:t?p:v}),counterpartKey:`counterpartId`in e?e.counterpartId:void 0,...i(e.id)?{}:{unavailable:r(`Hourly data isn't available for this metric.`,`jetpack-premium-analytics-pkg`)}}}),[i,u,d,f,p,h,g,_,v]),{refetch:b}=c,{refetch:x}=l,te=(0,s.useCallback)(()=>{b(),x()},[b,x]),S=c.isError&&!u?.data?.length||l.isError&&!h?.data?.length;return{metrics:ee,isLoading:c.isLoading||l.isLoading,isFetching:c.isFetching||l.isFetching,isError:S,refetch:te}}var j,be=t((()=>{b(),c(),i(),k(),w(),j=new Set([`views`])}));function xe({chartType:e}){let{reportParams:t}=d(),n=ee(t.interval,E),{drillDown:i}=f(),a=(0,N.useCallback)(e=>i(e,n),[i,n]),{metrics:o,isLoading:s,isFetching:c,isError:l,refetch:u}=ye(t,n),p=r(`Traffic metric`,`jetpack-premium-analytics-pkg`),m=o.filter(e=>!e.unavailable);return(0,P.jsx)(`div`,{className:_e.root,children:(0,P.jsx)(re,{isLoading:s,isFetching:c,isError:l,isEmpty:m.length>0&&m.every(e=>e.current.length===0),error:{description:r(`We couldn't load traffic data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:u}]},empty:{icon:g,description:r(`No traffic data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,P.jsx)(te,{}),children:(0,P.jsx)(x,{metrics:o,dataFormat:F,chartType:e,groupLabel:p,tickResolution:n,onDatumClick:a})})})}function M({attributes:e={},setError:t}){return(0,P.jsx)(p,{attributes:e,setError:t,options:{from:`/`},children:(0,P.jsx)(xe,{chartType:e.chartType})})}var N,P,F,Se=t((()=>{w(),_(),h(),i(),N=e(n(),1),ve(),be(),k(),P=a(),F={type:`number`,options:{useMultipliers:!0,decimals:0}}})),I,L,Ce,we,Te,Ee,De,Oe=t((()=>{I=`jpa/traffic-chart`,L=`Traffic summary`,Ce=`Compare views, visitors, likes, and comments over the selected period, with the previous period overlaid for comparison.`,we={content:`A summary of your site's views, visitors, likes, and comments. The Visitors total is a per-period sum, not a unique count.`},Te=`traffic`,Ee=`framed`,De={name:I,title:L,description:Ce,help:we,category:Te,presentation:Ee}}));function R({withComparison:e,chartType:t}){return(0,B.jsx)(M,{attributes:{reportParams:v(e),chartType:t}})}function z(e){return(0,B.jsx)(M,{attributes:{reportParams:v(!1,e)}})}function ke({withComparison:e,chartType:t,...n}){return(0,B.jsx)(de,{...n,widgetType:H,renderModule:V,renderComponent:M,attributes:{reportParams:v(e),chartType:t}})}var B,V,H,U,W,Ae,G,K,q,J,Y,X,Z,Q,$,je;t((()=>{b(),ae(),ie(),fe(),le(),he(),ne(),Se(),k(),Oe(),B=a(),S(),V=`storybook/traffic-chart`,H=se(De,O),U={chartType:{control:`inline-radio`,options:[`line`,`bar`]}},W={chartType:`line`},Ae={title:`Packages/Premium Analytics/Widgets/TrafficChart`,component:M,tags:[`autodocs`],decorators:[oe,me],argTypes:{...pe,withComparison:{control:`boolean`},...U},parameters:{docs:{description:{component:"Traffic over the selected period as selectable metric tabs — Views, Visitors, Likes, and Comments — over a comparative chart. The date range, comparison, and bucket size come from the dashboard controls: the bucket is whatever the page's interval control resolves to, clamped to one the chart can draw. \"Chart type\" is the `chartType` attribute (`relevance: 'high'`, so the host renders it in the widget header). Which metric is plotted is the chart's own tab selection. When comparison is on, each tab shows its period-over-period delta and the previous period is overlaid — as a same-colour dashed line for `line`, or as the translucent shadow bar behind each bar for `bar`. Views/visitors and likes/comments are fetched as two parallel requests (mirroring Calypso) to keep latency down; the likes and comments request is skipped at the hourly grain, which cannot fill either. Data comes from the `useStatsVisits` hook; in Storybook it is served by `registerReportMocks`."}}}},G={render:R,args:{withComparison:!1,...W},decorators:[T]},K={render:R,args:{withComparison:!0,...W},decorators:[T]},q={render:R,args:{withComparison:!1,...W,chartType:`bar`},decorators:[T]},J={render:R,args:{withComparison:!0,...W,chartType:`bar`},decorators:[T]},Y={render:e=>(0,B.jsx)(de,{...e,widgetType:H,renderModule:V,renderComponent:M,attributes:{reportParams:v(!1,`last-24-hours`)}}),args:{...ue},argTypes:{...ce}},X={render:()=>z(`last-90-days`),tags:[`!autodocs`],decorators:[T],beforeEach:()=>(C(`stats/visits`,`loading`),()=>C(`stats/visits`,null))},Z={render:()=>z(`last-7-days`),tags:[`!autodocs`],decorators:[T],beforeEach:()=>(C(`stats/visits`,`error`),()=>C(`stats/visits`,null))},Q={render:()=>z(`last-365-days`),tags:[`!autodocs`],decorators:[T],beforeEach:()=>(C(`stats/visits`,`empty`),()=>C(`stats/visits`,null))},$={render:e=>(0,B.jsx)(ke,{...e}),args:{...ue,withComparison:!0,...W},argTypes:{...ce,withComparison:{control:`boolean`},...U}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
