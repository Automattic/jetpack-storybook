import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DQ5lAs4a.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{Rt as o,n as s}from"./build-module-_6UNQmiR.js";import{Ot as c,a as ee,d as te,gt as ne,jt as l,p as u,s as d,ut as re,vt as ie}from"./hooks-Kzn9kLCz.js";import{n as f,r as p}from"./line-chart-DViN4CS2.js";import{l as m,t as h}from"./src-nQqIBmxK.js";import{Z as ae,it as g,ot as oe}from"./chart-tooltip-DaoSoE7s.js";import{n as se}from"./widget-loading-overlay-D21I_rx2.js";import{t as ce}from"./metric-tabs-chart-C9Jk2h4k.js";import{n as _,t as v}from"./register-report-mocks-DvVEXWI5.js";import{i as y,n as b,r as x,t as le}from"./widget-dashboard-with-widget-DhV0AmFi.js";import{t as S}from"./src-DAPBkFG1.js";import{n as C,t as w}from"./src-C1ZRi4sr.js";var T,E,D=t((()=>{i(),T=[{id:`net-sales`,label:r(`Net sales`,`jetpack-premium-analytics`),description:r(`Monitor your total revenue — after any discounts, returns, or adjustments — over a set period of time.`,`jetpack-premium-analytics`),metricType:`general`,metricKey:`orders_value_net`},{id:`orders`,label:r(`Orders`,`jetpack-premium-analytics`),description:r(`See a breakdown of when orders are placed to identify peak selling periods.`,`jetpack-premium-analytics`),metricType:`general`,metricKey:`orders_no`},{id:`bookings`,label:r(`Bookings`,`jetpack-premium-analytics`),description:r(`See a breakdown of when bookings are placed to identify peak selling periods.`,`jetpack-premium-analytics`),metricType:`booking`,metricKey:`orders_no`},{id:`visitors`,label:r(`Visitors`,`jetpack-premium-analytics`),description:r(`Track website visitor trends and monitor traffic patterns over time.`,`jetpack-premium-analytics`),metricType:`visitors`,metricKey:`visitors`},{id:`conversion-rate`,label:r(`Store conversion rate`,`jetpack-premium-analytics`),description:r(`Track your store's conversion funnel from sessions to completed orders.`,`jetpack-premium-analytics`),metricType:`conversion`,metricKey:`conversion_rate`},{id:`customers`,label:r(`Customers`,`jetpack-premium-analytics`),description:r(`Track the total number of customers (new and returning) who placed orders during the selected time period.`,`jetpack-premium-analytics`),metricType:`customers`,metricKey:`customers`}],E=T.map(e=>e.id)})),O,k,A,ue=t((()=>{O=`_widgetRoot_142ux_1`,k=`_emptyState_142ux_5`,A={widgetRoot:O,emptyState:k}}));function de(){return{summary:{date_start:``,date_end:``,total_sales:0,orders_no:0,avg_items:0,average_order_value:0,orders_value_net:0,orders_value_gross:0,product_net_revenue:0,profit_margin:0,cogs_amount:0,coupons:0,refunds:0,paid_orders_count:0,paid_net_sales:0,unpaid_orders_count:0,unpaid_net_sales:0},data:[]}}function j(){return{summary:{date_start:``,date_end:``,active_sessions:0,visitors:0},data:[]}}function M(){return{summary:{date_start:``,date_end:``,active_sessions:0,visitors:0,with_cart_addition:0,reached_checkout:0,completed_checkout:0,conversion_rate:0},data:[],steps:[],overallRate:0}}function N(){return{summary:{total_net_sales:0,total_gross_sales:0,total_discounts:0,total_refunds:0,total_orders:0,total_average_order_value:0,total_avg_items_per_order:0,total_customers:0,new_customers:0,returning_customers:0,new_customer_sales:0,new_customer_gross_sales:0,new_customer_discounts:0,new_customer_refunds:0,new_customer_orders:0,new_customer_avg_order_value:0,new_customer_avg_items_per_order:0,returning_customer_sales:0,returning_customer_gross_sales:0,returning_customer_discounts:0,returning_customer_refunds:0,returning_customer_orders:0,returning_customer_avg_order_value:0,returning_customer_avg_items_per_order:0,date_start:``,date_end:``,customers:0},data:[]}}function fe(e,t){if(e.metricType===`visitors`)return g({primary:t.visitors.primary.data??j(),comparison:t.visitors.comparison.data??j(),metricKey:e.metricKey,emptyDataFallback:`empty-array`});if(e.metricType===`conversion`)return g({primary:t.conversion.primary.data??M(),comparison:t.conversion.comparison.data??M(),metricKey:e.metricKey,emptyDataFallback:`empty-array`});if(e.metricType===`customers`)return g({primary:t.customers.primary.data??N(),comparison:t.customers.comparison.data??N(),metricKey:e.metricKey,emptyDataFallback:`empty-array`});let n=e.metricType===`booking`?t.booking:t.general;return g({primary:n.primary.data??de(),comparison:n.comparison.data??de(),metricKey:e.metricKey,emptyDataFallback:`empty-array`})}function pe({metricIds:e=E}){let{reportParams:t}=te(),n=(0,F.useMemo)(()=>{let t=new Set(e);return T.filter(e=>t.has(e.id))},[e]),i=(0,F.useMemo)(()=>new Set(n.map(e=>e.metricType)),[n]),a=c(t,{enabled:i.has(`general`)}),{primary:o,comparison:s}=a,l=c({...t,filters:[ae]},{enabled:i.has(`booking`)}),{primary:u,comparison:d}=l,f=re(t,{enabled:i.has(`visitors`)}),{primary:p,comparison:m}=f,h=ne(t,{enabled:i.has(`conversion`)}),{primary:g,comparison:_}=h,v=ie(t,{enabled:i.has(`customers`)}),{primary:y,comparison:b}=v,x=(0,F.useMemo)(()=>[i.has(`general`)?a:null,i.has(`booking`)?l:null,i.has(`visitors`)?f:null,i.has(`conversion`)?h:null,i.has(`customers`)?v:null].filter(e=>e!==null),[i,a,l,f,h,v]),le=ee(x.some(e=>e.isError),x.map(e=>e.error).find(Boolean)??null,(0,F.useCallback)(()=>Promise.all(x.map(e=>e.refetch())),[x])),S=(0,F.useMemo)(()=>n.map(e=>{let[t,n]=e.metricType===`booking`?[u.data?.summary??{},d.data?.summary??{}]:e.metricType===`visitors`?[p.data?.summary??{},m.data?.summary??{}]:e.metricType===`conversion`?[g.data?.summary??{},_.data?.summary??{}]:e.metricType===`customers`?[y.data?.summary??{},b.data?.summary??{}]:[o.data?.summary??{},s.data?.summary??{}];return{...e,primary:Number(t[e.metricKey]??0),comparison:n[e.metricKey]===void 0?null:Number(n[e.metricKey])}}),[n,u.data,d.data,p.data,m.data,g.data,_.data,y.data,b.data,o.data,s.data]),C=(0,F.useMemo)(()=>({general:{primary:o,comparison:s},booking:{primary:u,comparison:d},visitors:{primary:p,comparison:m},conversion:{primary:g,comparison:_},customers:{primary:y,comparison:b}}),[o,s,u,d,p,m,g,_,y,b]),w=(0,F.useMemo)(()=>S.map(e=>{let t=fe(e,C);return{key:e.id,label:e.label,value:e.primary,previousValue:e.comparison,current:t[0]?.data??[],previous:t[1]?.data,dataFormat:oe(e.metricKey),description:e.description}}),[S,C]);if(le)return null;if(x.some(e=>e.isLoading&&!e.hasData))return(0,I.jsx)(se,{});if(!w.length)return(0,I.jsx)(`div`,{className:A.emptyState,children:r(`No metric selected. Please select a metric from the metrics list.`,`jetpack-premium-analytics`)});let D=x.some(e=>e.isFetching&&e.hasData);return(0,I.jsx)(`div`,{className:A.widgetRoot,children:(0,I.jsx)(ce,{metrics:w,dataFormat:L,loading:D,groupLabel:r(`Store metric`,`jetpack-premium-analytics`)})})}function P({attributes:e={},setError:t}){return(0,I.jsx)(d,{attributes:e,setError:t,options:{from:`/`},children:(0,I.jsx)(pe,{metricIds:e.metrics})})}var F,I,L,me=t((()=>{u(),S(),i(),F=e(n(),1),D(),ue(),I=a(),L={type:`number`,options:{useMultipliers:!0,decimals:0}}})),R,he=t((()=>{i(),s(),w(),D(),R={name:`jpa/store-performance`,title:r(`Store performance`,`jetpack-premium-analytics`),description:r(`Shows key store performance metrics at a glance.`,`jetpack-premium-analytics`),icon:o,attributes:[{id:`metrics`,label:r(`Metrics`,`jetpack-premium-analytics`),type:`array`,relevance:`high`,Edit:C,elements:T.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:E}}}}));function z({withComparison:e=!1,preset:t=G,metrics:n=E}){return{reportParams:l(e,t),metrics:n}}function ge({withComparison:e,preset:t}){let n=!!e,r=t??G;return!n&&r===G?`getDefaultQueryParams()`:n&&r===G?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function B(e=E){return`[ ${e.map(e=>`'${e}'`).join(`, `)} ]`}function V(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
