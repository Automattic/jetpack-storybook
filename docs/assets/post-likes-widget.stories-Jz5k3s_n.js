import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-yGZutq_9.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Gu as ee,Nu as i,Vt as a,t as o}from"./build-module-zwSmKorH.js";import{C as te,y as s}from"./wp-date-settings-B2uHin7m.js";import{M as ne,t as c}from"./src-DFNM1k7F.js";import{k as re,t as l}from"./src-D_gpVFWl.js";import{Dn as ie,en as u,ht as ae,i as d}from"./date-filters-panel-C3p3_SsN.js";import{J as f,Z as p,q as m}from"./report-metric-CNhC6kJO.js";import{t as h}from"./widget-state-BWepXjAB.js";import{r as g,t as oe}from"./subscriber-list-skeleton-Bcv_JeL9.js";import{C as se,D as ce,E as _,S as v,T as y,b,t as x,w as S,x as C}from"./src-CigIhRo_.js";var w,T,le=e((()=>{w=`_root_6wdsv_2`,T={root:w}}));function ue(){let{reportParams:e}=te(),n=ie(e.post_id),{data:r,isLoading:i,isFetching:a,isError:o,refetch:s}=ae({postId:n,number:O}),c=(0,ee.useMemo)(()=>(r?.likes??[]).map(e=>({id:e.ID,name:e.name||e.login,avatarUrl:e.avatar_URL,href:e.login?`https://wordpress.com/reader/users/${e.login}`:void 0,secondaryText:re(e.date_liked)})),[r]),l=r?.found??0,u=n<=0||!!r&&c.length===0;return(0,D.jsx)(`div`,{className:T.root,children:(0,D.jsx)(h,{isLoading:i,isFetching:a,isError:!r&&o,isEmpty:u,renderLoading:(0,D.jsx)(oe,{rows:O}),error:{description:t(`We couldn't load these likes. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:s}]},empty:{icon:ne,description:t(n<=0?`Open a post or page report to see its likes here.`:`There are no likes yet.`,`jetpack-premium-analytics-pkg`)},children:(0,D.jsx)(g,{items:c,moreCount:Math.max(0,l-c.length)})})})}function E({attributes:e={}}){return(0,D.jsx)(s,{attributes:e,children:(0,D.jsx)(ue,{})})}var D,O,de=e((()=>{d(),l(),c(),x(),i(),n(),le(),D=r(),O=10})),k,A=e((()=>{o(),k={icon:a,attributes:[],example:{attributes:{}}}})),j,M,N,P,F,I,L,R=e((()=>{j=`jpa/post-likes`,M=`Latest likes`,N=`The people who liked the post or page being viewed.`,P={content:`The people who liked the post or page being viewed.`},F=`stats`,I=`framed`,L={name:j,title:M,description:N,help:P,category:F,presentation:I}}));function z({hasPostScope:e}){return{reportParams:{...u(!1),...e?{post_id:U}:{}}}}function B(e){return(0,H.jsx)(E,{attributes:z(e)})}function V({hasPostScope:e,...t}){return(0,H.jsx)(y,{...t,widgetType:v(L,k),renderModule:W,renderComponent:E,attributes:z({hasPostScope:e})})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{d(),m(),_(),se(),b(),de(),A(),R(),H=r(),f(),U=779,W=`storybook/post-likes`,G=`posts/${U}/likes`,K={title:`Packages/Premium Analytics/Widgets/PostLikes`,component:E,tags:[`autodocs`],argTypes:{hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}},parameters:{docs:{description:{component:`The "Latest likes" widget: the scoped post's likers as an avatar roster with an "N more" footer — the post detail Traffic view's likes card. Each row carries the like's relative time. Without a post scope the widget renders a scopeless empty state.`}}}},q={render:B,args:{hasPostScope:!0},decorators:[C]},J={render:B,args:{hasPostScope:!1},decorators:[C]},Y={render:B,args:{hasPostScope:!0},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(p(G,`loading`),()=>p(G,null))},X={render:B,args:{hasPostScope:!0},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(p(G,`error`),()=>p(G,null))},Z={render:B,args:{hasPostScope:!0},tags:[`!autodocs`],decorators:[C],beforeEach:()=>(p(G,`empty`),()=>p(G,null))},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...S,widgetWidth:1,widgetHeight:2,hasPostScope:!0},argTypes:{...ce,hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
