import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-CQqCWvwC.js";import{i as r,n as i,r as a,t as o}from"./blocks-GWUG2RmM.js";import{t as s}from"./mdx-react-shim-C6TrRFEn.js";import{Animation as c,Dashboard as l,Default as u,EmptyData as d,Responsive as f,SinglePoint as p,TwoPoints as m,n as h,t as g}from"./index.stories-HUpMXt1r.js";function _(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(i,{title:`JS Packages/Charts Library/Charts/Sparkline`,of:g}),`
...
`,(0,y.jsx)(a,{language:`jsx`,code:`import { Sparkline } from '@automattic/charts';
...
`,(0,y.jsx)(o,{of:u}),`
`,(0,y.jsx)(a,{language:`jsx`,code:`<Sparkline
	data={[10, 15, 12, 18, 22, 25, 23, 28]}
	width={120}
	height={48}
	color="#4CAF50"
...
`,(0,y.jsxs)(t.li,{children:[(0,y.jsx)(t.strong,{children:(0,y.jsx)(t.code,{children:`aspectRatio`})}),`: Height-to-width ratio (e.g. `,(0,y.jsx)(t.code,{children:`0.3`}),`) for responsive charts; the chart is contained within its parent on both axes. When omitted, fills the parent container's height`]}),`
...
`,(0,y.jsxs)(t.ul,{children:[`
`,(0,y.jsxs)(t.li,{children:[(0,y.jsx)(t.strong,{children:(0,y.jsx)(t.code,{children:`color`})}),`: Color for the line stroke (defaults to `,(0,y.jsx)(t.code,{children:`--a8c-charts-color-series-1`}),`)`]}),`
...
`,(0,y.jsx)(a,{language:`jsx`,code:`import { LineChart } from '@automattic/charts';
...
`,(0,y.jsx)(o,{of:l}),`
`,(0,y.jsx)(a,{language:`jsx`,code:`const metrics = [
...
`,(0,y.jsx)(a,{language:`jsx`,code:`// Positive trend
...
`,(0,y.jsx)(a,{language:`jsx`,code:`// No gradient fill
...
`,(0,y.jsx)(t.p,{children:`Sparklines integrate seamlessly with the chart theming system. The default theme has neutral styling, and is automatically applied to all charts unless a custom theme is provided.`}),`
`,(0,y.jsxs)(t.p,{children:[(0,y.jsx)(t.strong,{children:`The line color comes from the first palette custom property, not the theme object.`}),` Use the `,(0,y.jsx)(t.code,{children:`color`}),` prop to override a single sparkline:`]}),`
`,(0,y.jsx)(a,{language:`css`,code:`.a8c-charts-scope {
	--a8c-charts-color-series-1: #FF6B6B;
}`}),`
`,(0,y.jsxs)(t.p,{children:[`Everything else is set by wrapping your chart in `,(0,y.jsx)(t.code,{children:`GlobalChartsProvider`}),` and passing a theme object with the properties you want to override to the `,(0,y.jsx)(t.code,{children:`theme`}),` prop:`]}),`
`,(0,y.jsx)(a,{language:`tsx`,code:`import { GlobalChartsProvider, Sparkline, type ChartTheme } from '@automattic/charts';

const customTheme: Partial< ChartTheme > = {
	sparkline: { strokeWidth: 2 },
};
...
`,(0,y.jsx)(o,{of:f}),`
`,(0,y.jsx)(a,{language:`jsx`,code:`// Fill parent container (default) - parent needs explicit height
...
`,(0,y.jsx)(o,{of:c}),`
`,(0,y.jsx)(a,{language:`tsx`,code:`<Sparkline
	data={ [10, 15, 12, 18, 22, 25, 23, 28] }
	width={ 120 }
	height={ 48 }
	color="#4CAF50"
...
`,(0,y.jsx)(a,{language:`css`,code:`.sparkline--empty {
...
`,(0,y.jsx)(a,{language:`jsx`,code:`<div role="img" aria-label="Momentum trending upward, current value 28">
	<span>Momentum</span>
	<span>28</span>
...
`]})]})}function v(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,y.jsx)(t,{...e,children:(0,y.jsx)(_,{...e})}):_(e)}var y;e((()=>{y=t(),s(),r(),h()}))();export{v as default};