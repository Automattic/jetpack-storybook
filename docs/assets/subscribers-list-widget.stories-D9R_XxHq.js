import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{li as o,t as s}from"./build-module-CR6EsQjA.js";import{g as c}from"./hooks-BH-MyYLK.js";import{p as l,t as u}from"./src-CldFJNXL.js";import{q as d,t as f}from"./src-B97zWi3i.js";import{B as p,sn as m,t as ee}from"./src-aE6SqV9M.js";import"./constants-B1kGztHF.js";import{G as te,K as h,Y as g}from"./report-metric-CvizUAM3.js";import{t as _}from"./widget-state-BOMCDePe.js";import{r as ne,t as v}from"./subscriber-list-skeleton-CYSaBMqF.js";import{C as y,D as b,E as x,S,T as C,b as w,t as T,w as E,x as D}from"./src-pimIQy-s.js";function O(e){return m(e).map((e,t)=>({id:e.subscription_id??`row-${t}`,name:e.label,avatarUrl:e.icon,href:e.link,secondaryText:d(e.date_subscribed)}))}function k(){let{data:e,isLoading:t,isFetching:n,isError:i,refetch:a}=p({type:`all`,max:10}),o=e,s=(0,j.useMemo)(()=>O(o),[o]),c=Number(o?.summary?.total??0),u=Math.max(c-s.length,0);return(0,M.jsx)(_,{isLoading:t,isFetching:n,isError:s.length===0&&i,isEmpty:s.length===0,renderLoading:(0,M.jsx)(v,{rows:10}),error:{description:r(`We couldn't load subscribers. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:a}]},empty:{icon:l,description:r(`No subscribers yet.`,`jetpack-premium-analytics-pkg`)},children:(0,M.jsx)(N,{items:s,moreCount:u})})}function A({attributes:e={}}){return(0,M.jsx)(c,{attributes:e,children:(0,M.jsx)(k,{})})}var j,M,N,P=t((()=>{ee(),f(),u(),T(),i(),j=e(n(),1),M=a(),N=({items:e=[],moreCount:t=0})=>(0,M.jsx)(ne,{items:e,moreCount:t})})),F,I=t((()=>{s(),F={icon:o,attributes:[],example:{attributes:{}}}})),L,R,z,B,V,H,U,W=t((()=>{L=`jpa/subscribers-list`,R=`Latest subscribers`,z=`Your most recent subscribers.`,B={content:`Your most recent subscribers.`},V=`subscribers`,H=`framed`,U={name:L,title:R,description:z,help:B,category:V,presentation:H}})),G,K,q,J,Y,X,Z,Q,$;t((()=>{x(),y(),w(),te(),P(),I(),W(),G=a(),h(),K=`storybook/subscribers-list`,q={title:`Packages/Premium Analytics/Widgets/SubscribersList`,component:A,tags:[`autodocs`],parameters:{docs:{description:{component:'Dashboard widget listing the most recent subscribers (avatar + name + relative "since" time) with an "N more" footer. Data comes from the designated `useStatsFollowers` hook; in Storybook it is served by `registerReportMocks`.'}}}},J={render:()=>(0,G.jsx)(A,{attributes:{}}),decorators:[D]},Y={render:()=>(0,G.jsx)(A,{attributes:{}}),tags:[`!autodocs`],decorators:[D],beforeEach:()=>(g(`stats/followers`,`loading`),()=>g(`stats/followers`,null))},X={render:()=>(0,G.jsx)(A,{attributes:{}}),tags:[`!autodocs`],decorators:[D],beforeEach:()=>(g(`stats/followers`,`error`),()=>g(`stats/followers`,null))},Z={render:()=>(0,G.jsx)(A,{attributes:{}}),tags:[`!autodocs`],decorators:[D],beforeEach:()=>(g(`stats/followers`,`empty`),()=>g(`stats/followers`,null))},Q={render:e=>(0,G.jsx)(C,{...e,widgetType:S(U,F),renderModule:K,renderComponent:A,attributes:{}}),args:{...E},argTypes:{...b}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
