import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{t as n,ul as r}from"./build-module-2iv4IIRq.js";import{m as i}from"./hooks-BiR584UK.js";import{n as a,t as o}from"./build-module-CtolMbUq.js";import{rt as s,t as c}from"./src-CJGEmgc4.js";import{r as l,tn as u}from"./date-period-dropdown-CqAKI-XK.js";import{i as d,r as f}from"./register-report-mocks-CbBR8hcQ.js";import{o as p,t as m}from"./src-C-waaVCI.js";import{a as ee,c as te,i as ne,l as re,n as ie,o as ae,r as h,s as g}from"./with-widget-canvas-BtuJorLO.js";import{n as _,t as v}from"./force-stats-mock-state-CvDhHFc1.js";function y({attributes:e={},setError:t}){return(0,b.jsx)(i,{attributes:e,setError:t,options:{from:`/`},children:(0,b.jsx)(p,{limit:5})})}var b,x=e((()=>{m(),b=t()})),S,C=e((()=>{n(),S={icon:r}})),w,T,E,D,O,k,A,oe=e((()=>{w=`jpa/top-performing-bookings`,T=`Top performing bookings`,E=`Shows the top booking products by net revenue over the selected time period.`,D={content:`Your best-selling bookings by revenue over the selected time period.`},O=`bookings`,k=`framed`,A={name:w,title:T,description:E,help:D,category:O,presentation:k}}));function se(e){let t=e.reduce((e,t)=>({total_orders:e.total_orders+Number(t.orders_count),total_quantity:e.total_quantity+Number(t.total_quantity),total_revenue:e.total_revenue+Number(t.product_net_revenue)}),{total_orders:0,total_quantity:0,total_revenue:0});return{data:e,summary:{total_orders:String(t.total_orders),total_products:String(e.length),total_quantity:String(t.total_quantity),total_revenue:t.total_revenue.toFixed(2)}}}function j(e){H||(H=!0,o.use(async(t,n)=>{let r=t.path??t.url??``;return r.startsWith(z)?se(e):r.startsWith(B)?e.map(e=>({id:Number(e.product_id),name:e.product_name,images:[]})):n(t)}))}function M(e=!1,t=W){return{reportParams:u(e,t)}}function N({withComparison:e,preset:t}){let n=!!e,r=t??W;return!n&&r===W?`getDefaultQueryParams()`:n&&r===W?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function P(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<TopPerformingBookingsRender
\tattributes={ {
\t\treportParams: ${N(e)},
\t} }
/>`}function F({withComparison:e,preset:t}){return(0,R.jsx)(y,{attributes:M(e,t)})}function I(e){return(0,R.jsx)(y,{attributes:M(!1,e)})}function L({withComparison:e,preset:t,...n}){return(0,R.jsx)(g,{...n,widgetType:ne(A,S),renderModule:U,renderComponent:y,attributes:{reportParams:u(e,t)}})}var R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{a(),l(),c(),f(),te(),ee(),ie(),_(),x(),C(),oe(),R=t(),d(),z=`/jetpack-premium-analytics/v1/proxy/v2/analytics/reports/products`,B=`/wc/v3/products`,V=[{product_id:`801`,product_name:`City tasting tour`,product_net_revenue:`18640.00`,product_gross_revenue:`21320.00`,product_type:`booking`,orders_count:`84`,sku:`BOOK-CITY`,total_quantity:`112`,stock_status:`instock`},{product_id:`802`,product_name:`Private lesson`,product_net_revenue:`14220.00`,product_gross_revenue:`15960.00`,product_type:`bookable-service`,orders_count:`61`,sku:`BOOK-LESSON`,total_quantity:`73`,stock_status:`instock`},{product_id:`803`,product_name:`Weekend retreat`,product_net_revenue:`9350.00`,product_gross_revenue:`10450.00`,product_type:`bookable-event`,orders_count:`38`,sku:`BOOK-RETREAT`,total_quantity:`46`,stock_status:`instock`},{product_id:`804`,product_name:`Strategy session`,product_net_revenue:`5125.00`,product_gross_revenue:`5900.00`,product_type:`booking`,orders_count:`22`,sku:`BOOK-STRATEGY`,total_quantity:`27`,stock_status:`instock`}],H=!1,j(V),U=`storybook/top-performing-bookings`,W=`last-30-days`,G=s,K={title:`Packages/Premium Analytics/Widgets/TopPerformingBookings`,component:y,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:G,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`Dashboard widget that displays top booking products by net revenue for the selected period.`}}}},q={render:F,args:{preset:W,withComparison:!1},decorators:[h],parameters:{docs:{source:{transform:(e,t)=>P(t.args)}}}},J={render:F,args:{preset:W,withComparison:!0},decorators:[h],parameters:{docs:{source:{transform:(e,t)=>P(t.args)}}}},Y={render:()=>I(`last-90-days`),tags:[`!autodocs`],decorators:[h],beforeEach:()=>(v(`reports/products`,`loading`),()=>v(`reports/products`,null))},X={render:()=>I(`last-7-days`),tags:[`!autodocs`],decorators:[h],beforeEach:()=>(v(`reports/products`,`error`),()=>v(`reports/products`,null))},Z={render:()=>I(`last-365-days`),tags:[`!autodocs`],decorators:[h],beforeEach:()=>(v(`reports/products`,`empty`),()=>v(`reports/products`,null))},Q={render:e=>(0,R.jsx)(L,{...e}),args:{...ae,preset:W,withComparison:!0},argTypes:{...re,preset:{control:`select`,options:G,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
