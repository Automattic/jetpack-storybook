import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Oc as ee,Uu as i,Vr as a,ju as o,t as s}from"./build-module-2iv4IIRq.js";import{Et as c}from"./build-module-l8c-_EUg2.js";import{m as l}from"./hooks-Bj06gF3B.js";import{t as te}from"./src-B6SacL9q.js";import{$t as u,W as d,t as f}from"./src-Bv1gHDfD.js";import{Dt as ne,V as re}from"./helpers-BNVgdtD4.js";import"./constants-B1kGztHF.js";import{r as ie,t as ae}from"./leaderboard-skeleton-C9X6eecY.js";import{i as oe,r as p,t as m}from"./register-report-mocks-DykcCpN8.js";import{S as se,j as ce,v as le}from"./report-metric-DdC8tSih.js";import{t as h}from"./widget-state-Cq9rbSLC.js";import{t as g}from"./src-DrCgTKe-.js";import{a as _,d as v,f as y,h as b,i as x,m as S,n as C,p as ue,r as w,u as de}from"./with-widget-canvas-GcuJjnSQ.js";var T,E,D,O=e((()=>{T=`_root_19tfr_1`,E=`_content_19tfr_9`,D={root:T,content:E}}));function k(){let{rows:e,isLoading:n,isFetching:r,isError:a,error:o,refetch:s}=d({group:`authors`,max:10}),l=(0,i.useMemo)(()=>{let t=Math.max(...e.map(e=>e.value),0);return e.map(e=>({id:e.id,...ce({label:e.label,media:{kind:`avatar`,url:e.avatarUrl,name:e.label},action:e.link?{kind:`link`,href:e.link}:{kind:`static`}}),currentValue:e.value,currentShare:ne(e.value,t)}))},[e]);return(0,j.jsxs)(c,{className:D.root,children:[(0,j.jsx)(`div`,{className:D.content,children:(0,j.jsx)(h,{isLoading:n,isFetching:r,isError:a,isEmpty:e.length===0,error:re(o,{retryDescription:t(`We couldn't load comment authors. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:s}),empty:{icon:ee,description:t(`No one has commented on your site yet.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,j.jsx)(ae,{rows:10}),children:(0,j.jsx)(ie,{data:l,withOverlayLabel:!0,showLegend:!1,dataFormat:M})})}),(0,j.jsx)(se,{children:(0,j.jsx)(le,{report:`comments`,section:`authors`,ariaLabel:t(`See the comment authors report`,`jetpack-premium-analytics-pkg`)})})]})}function A({attributes:e={}}){return(0,j.jsx)(l,{attributes:e,children:(0,j.jsx)(k,{})})}var j,M,N=e((()=>{f(),g(),o(),n(),s(),te(),O(),j=r(),M={type:`number`,options:{useMultipliers:!0,decimals:0}}})),P,F=e((()=>{s(),P={icon:a,attributes:[],example:{attributes:{}}}})),I,L,R,z,B,V,H,fe=e((()=>{I=`jpa/most-commented-authors`,L=`All-time most commented authors`,R=`The people who comment the most on your site.`,z={content:`The people who left the most comments on your site.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},B=`stats`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function U(){return(0,W.jsx)(A,{attributes:{reportParams:u()}})}function pe(e){return(0,W.jsx)(v,{...e,widgetType:x(H,P),renderModule:G,renderComponent:A,attributes:{reportParams:u(!0)}})}var W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),y(),_(),S(),C(),p(),N(),F(),fe(),W=r(),oe(),G=`storybook/most-commented-authors`,K={title:`Packages/Premium Analytics/Widgets/MostCommentedAuthors`,component:A,tags:[`autodocs`],parameters:{docs:{description:{component:`The "All-time most commented authors" widget. Ranks the people who comment most on the site by comment count, linking each guest commenter to the comment management screen filtered to them. One half of the Jetpack Stats Comments module; "All-time most commented posts" covers the other.`}}}},q={render:U,decorators:[w,b]},J={render:U,tags:[`!autodocs`],decorators:[w,b],beforeEach:m(`loading`)},Y={render:U,tags:[`!autodocs`],decorators:[w,b],beforeEach:m(`error`)},X={render:U,tags:[`!autodocs`],decorators:[w,b],beforeEach:m(`error-retryable`)},Z={render:U,tags:[`!autodocs`],decorators:[w,b],beforeEach:m(`empty`)},Q={render:e=>(0,W.jsx)(pe,{...e}),args:{...de},argTypes:{...ue},decorators:[b]},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
