import{i as e}from"./preload-helper-usAeo7Bx.js";import{c as t,n,t as r}from"./build-module-Da_5_6n_.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{A as a,t as o}from"./build-module-DrryaqBL.js";import{n as s,zt as c}from"./build-module-DmVuor49.js";import{r as l}from"./hooks-DgWkXQKD.js";import{t as u,u as d}from"./build-module-C8n0V-nn.js";import{L as f,S as p,Yn as m,an as h,ut as g}from"./chart-tooltip-BO4eUTeI.js";import{t as _}from"./leaderboard-chart-Cf12XmBI.js";import{C as v,N as ee,S as y,c as b,f as te,g as x,k as S,u as ne}from"./report-metric-CuUBMyYt.js";import{t as re}from"./widget-state-DRmNccM4.js";import{C,S as w,b as T,t as ie,w as E,x as ae,y as oe}from"./src-DpsQ7-x8.js";import{n as se,r as D}from"./with-widget-canvas-Dz43KNHY.js";import{n as ce,t as le}from"./register-stats-mocks-BGqQ-ahm.js";import{n as ue,t as O}from"./force-stats-mock-state-C1BU0jV1.js";var k,A,j,M,N,P,F,de=e((()=>{k=`_labelIcon_1b48y_1`,A=`_labelLink_1b48y_9`,j=`_labelText_1b48y_10`,M=`_placeholder_1b48y_31`,N=`_root_1b48y_39`,P=`_content_1b48y_48`,F={labelIcon:k,labelLink:A,labelText:j,placeholder:M,root:N,content:P}}));function I(e){return{label:e.label,value:e.views,previousValue:e.previousValue,href:e.link??void 0,icon:e.icon,children:e.children?.map(I),...e.childrenHaveComparison?{childrenHaveComparison:!0}:{}}}function fe(e,r,i){let a=Math.max(...e.map(e=>e.value),1),o=Math.max(...e.map(e=>e.previousValue??0),1);return e.map((e,s)=>{let c=e.previousValue,l=r&&c!==void 0,u=!!e.children?.length,m=!!e.href&&!u,h=(0,R.jsx)(x,{label:e.label,imageUrl:e.icon??void 0,imageAlt:``,imageFallback:`hidden`,imageClassName:F.labelIcon});return{id:`${s}-${e.href??e.label}`,label:m?(0,R.jsx)(d,{className:F.labelLink,href:e.href,variant:`unstyled`,openInNewTab:!0,title:e.label,children:h}):(0,R.jsx)(`span`,{className:F.labelText,title:e.label,children:h}),currentValue:e.value,currentShare:e.value/a*100,previousValue:c,previousShare:l?p(c,o):void 0,delta:l?f(e.value,c):void 0,...u&&i&&{onClick:()=>i(e),ariaLabel:t(n(`View referrers for %s`,`jetpack-premium-analytics`),e.label)}}})}function pe({rows:e=[],withComparison:t=!1,onDrillDown:n}){return(0,R.jsx)(_,{data:fe(e,t,n),withComparison:t,withOverlayLabel:!0,showLegend:!1,dataFormat:z})}function me({max:e}){let{reportParams:r}=ee(),{comparisonRows:i,hasComparison:o,isLoading:s,isFetching:u,isError:d,refetch:f}=h({...r,max:e},{maxRows:e}),p=(0,a.useMemo)(()=>(i?.rows??[]).map(I),[i]),{drillDownItem:m,drillDown:g,resetDrillDown:_}=l(),v=(0,a.useMemo)(()=>{let e=[],t=p;for(let n of m??[]){let r=t.find(e=>e.label===n);if(!r?.children?.length)break;e.push(r),t=r.children}return e},[p,m]);(0,a.useEffect)(()=>{!m?.length||s||u||d||v.length===m.length||(v.length?g(v.map(e=>e.label)):_())},[m,v,s,u,d,g,_]);let y=v.length?v[v.length-1]:null,b=y?y.children??[]:p,x=y?!!y.childrenHaveComparison:o,S=(0,a.useCallback)(e=>{g([...m??[],e.label])},[m,g]),ne=(0,a.useCallback)(()=>{let e=v.slice(0,-1).map(e=>e.label);e.length?g(e):_()},[v,g,_]),C=v.length>1?v[v.length-2].label:null,w=C??n(`All referrers`,`jetpack-premium-analytics`),T=C?t(n(`Back to %s`,`jetpack-premium-analytics`),C):n(`View all referrers`,`jetpack-premium-analytics`);return(0,R.jsxs)(`div`,{className:F.content,children:[v.length>0&&(0,R.jsx)(te,{label:w,ariaLabel:T,onClick:ne}),(0,R.jsx)(re,{isLoading:s,isFetching:u,isError:p.length===0&&d,isEmpty:p.length===0,error:{description:n(`We couldn't load referrers. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:n(`Retry`,`jetpack-premium-analytics`),onClick:f}]},empty:{icon:c,description:n(`No referrers in this period.`,`jetpack-premium-analytics`)},children:(0,R.jsx)(pe,{rows:b,withComparison:x,onDrillDown:S})})]})}function L({attributes:e={}}){let t=e?.max??10;return(0,R.jsx)(S,{attributes:e,children:(0,R.jsxs)(`div`,{className:F.root,children:[(0,R.jsx)(me,{max:t}),(0,R.jsx)(ne,{children:(0,R.jsx)(b,{report:`referrers`})})]})})}var R,z,he=e((()=>{g(),ie(),o(),r(),s(),u(),de(),R=i(),z={type:`number`,options:{useMultipliers:!0,decimals:0}}})),B,ge=e((()=>{r(),s(),B={name:`jpa/referrers`,title:n(`Referrers`,`jetpack-premium-analytics`),help:{content:n(`Websites referring visitors sorted by most clicked. Learn about where your audience comes from.`,`jetpack-premium-analytics`)},icon:c,attributes:[{id:`max`,label:n(`Number of results`,`jetpack-premium-analytics`),type:`integer`}],example:{attributes:{max:10}}}}));function V({withComparison:e}){return(0,U.jsx)(L,{attributes:{max:10,reportParams:m(e)}})}function H(e){return(0,U.jsx)(L,{attributes:{max:10,reportParams:m(!1,e)}})}function _e({withComparison:e,...t}){return(0,U.jsx)(T,{...t,widgetType:G,renderModule:W,renderComponent:L,attributes:{max:10,reportParams:m(e)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{g(),y(),le(),ue(),ae(),C(),se(),he(),ge(),U=i(),v(),ce(),W=`storybook/referrers`,G={name:B.name,title:B.title,icon:B.icon,presentation:`framed`},K={title:`Packages/Premium Analytics/Widgets/Referrers`,component:L,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`The "Referrers" widget. Shows the websites and search engines referring visitors to the site as a ranked leaderboard, using the global dashboard date range. Referrer groups drill down into their sources and domains; URL-backed leaf rows (no children) render as outbound links that open in a new tab, while rows that drill down remain buttons.`}}}},q={render:V,args:{withComparison:!1},decorators:[D,E]},J={render:V,args:{withComparison:!0},decorators:[D,E]},Y={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[D,E],beforeEach:()=>(O(`stats/referrers`,`loading`),()=>O(`stats/referrers`,null))},X={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[D,E],beforeEach:()=>(O(`stats/referrers`,`error`),()=>O(`stats/referrers`,null))},Z={render:()=>H(`last-365-days`),tags:[`!autodocs`],decorators:[D,E],beforeEach:()=>(O(`stats/referrers`,`empty`),()=>O(`stats/referrers`,null))},Q={render:e=>(0,U.jsx)(_e,{...e}),args:{...oe,withComparison:!0},argTypes:{...w,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
