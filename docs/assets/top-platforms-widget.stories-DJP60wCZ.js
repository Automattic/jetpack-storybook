import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Ks as i,t as a}from"./build-module-2iv4IIRq.js";import{m as o,v as s}from"./hooks-M2wN2jRy.js";import{T as c,t as l}from"./src-C-E2d-Lb.js";import{$t as u,t as d,w as f}from"./src-B-SWS_4e.js";import{B as ee,Dt as te,Et as p,X as m,kt as ne}from"./helpers-DCdx1Z97.js";import"./constants-B1kGztHF.js";import{r as re,t as ie}from"./leaderboard-skeleton-CPrRaVTb.js";import{i as ae,r as h}from"./register-report-mocks-COSAA4Je.js";import{j as g}from"./report-metric-DSv6zkh0.js";import{t as oe}from"./widget-state-m8dGN2II.js";import{t as _}from"./src-BfLvKiHi.js";import{a as se,d as ce,f as le,i as ue,n as v,p as de,r as y,u as fe}from"./with-widget-canvas-BXVb8S8T.js";import{n as pe,t as me}from"./register-stats-mocks-DoyMsYCl.js";import{n as he,t as b}from"./force-stats-mock-state-COJVoMvo.js";var x,S,C,ge=e((()=>{x=`_root_19tfr_1`,S=`_content_19tfr_9`,C={root:x,content:S}}));function _e(e,t){let n=String(e.label??``);return{key:n,label:m(n,t===`browser`?w:T),views:e.value,previousViews:e.previousValue}}function ve({reportParams:e,max:t,deviceProperty:n}){let{comparisonRows:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:l}=f({...e,deviceProperty:n},{maxRows:t}),u=(r?.rows??[]).map(e=>_e(e,n)),d=u.length===0&&s;return{data:u,hasComparison:i,isLoading:a,isFetching:o,isError:d,error:d?c:null,refetch:l}}var w,T,ye=e((()=>{n(),d(),_(),w={chrome:t(`Chrome`,`jetpack-premium-analytics-pkg`),safari:t(`Safari`,`jetpack-premium-analytics-pkg`),firefox:t(`Firefox`,`jetpack-premium-analytics-pkg`),edge:t(`Edge`,`jetpack-premium-analytics-pkg`),opera:t(`Opera`,`jetpack-premium-analytics-pkg`),samsung:t(`Samsung Internet`,`jetpack-premium-analytics-pkg`),ie:t(`IE`,`jetpack-premium-analytics-pkg`),yandex:t(`Yandex`,`jetpack-premium-analytics-pkg`),miui:t(`Mi Browser`,`jetpack-premium-analytics-pkg`),other:t(`Other`,`jetpack-premium-analytics-pkg`)},T={windows:t(`Windows`,`jetpack-premium-analytics-pkg`),mac:t(`macOS`,`jetpack-premium-analytics-pkg`),android:t(`Android`,`jetpack-premium-analytics-pkg`),linux:t(`Linux`,`jetpack-premium-analytics-pkg`),ios:t(`iOS`,`jetpack-premium-analytics-pkg`),ipad:t(`iPad`,`jetpack-premium-analytics-pkg`),iphone:t(`iPhone`,`jetpack-premium-analytics-pkg`),ipados:t(`iPadOS`,`jetpack-premium-analytics-pkg`),macos:t(`macOS`,`jetpack-premium-analytics-pkg`),chrome:t(`Chrome OS`,`jetpack-premium-analytics-pkg`),android_tablet:t(`Android Tablet`,`jetpack-premium-analytics-pkg`),other:t(`Other`,`jetpack-premium-analytics-pkg`)}}));function be({platformDimension:e}){let{reportParams:n}=s(),{data:r,hasComparison:i,isLoading:a,isFetching:o,isError:l,error:u,refetch:d}=ve({reportParams:n,max:10,deviceProperty:e}),f=te(r.map(e=>e.views),i?r.map(e=>e.previousViews):[]),m=r.map((e,t)=>{let n=e.previousViews;return{id:`${t}-${e.key}`,...g({label:e.label,media:{kind:`none`},action:{kind:`static`}}),currentValue:e.views,currentShare:p(e.views,f),previousValue:n,previousShare:i&&n!==void 0?p(n,f):void 0,delta:i&&n!==void 0?ne(e.views,n):void 0}});return(0,D.jsx)(`div`,{className:C.content,children:(0,D.jsx)(oe,{isLoading:a,isFetching:o,isError:l,isEmpty:r.length===0,error:ee(u,{retryDescription:t(`We couldn't load platform data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:d}),empty:{icon:c,description:t(`No platform data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,D.jsx)(ie,{rows:10}),children:(0,D.jsx)(re,{data:m,withComparison:i,withOverlayLabel:!0,showLegend:!1,dataFormat:O})})})}function E({attributes:e}){let t=e?.platformDimension??`browser`;return(0,D.jsx)(o,{attributes:e,children:(0,D.jsx)(`div`,{className:C.root,children:(0,D.jsx)(be,{platformDimension:t})})})}var D,O,xe=e((()=>{l(),n(),_(),ge(),ye(),D=r(),O={type:`number`,options:{useMultipliers:!0,decimals:0}}})),k,A=e((()=>{n(),a(),k={icon:i,attributes:[{id:`platformDimension`,label:t(`View by`,`jetpack-premium-analytics-pkg`),type:`jpa/select`,elements:[{label:t(`Browser`,`jetpack-premium-analytics-pkg`),value:`browser`},{label:t(`OS`,`jetpack-premium-analytics-pkg`),value:`platform`}],relevance:`high`}],example:{attributes:{platformDimension:`browser`}}}})),j,M,N,P,F,I,L,Se=e((()=>{j=`jpa/top-platforms`,M=`Top platforms`,N=`Top browsers and operating systems your visitors use.`,P={content:`A breakdown of the operating systems and browsers your visitors used, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},F=`traffic`,I=`framed`,L={name:j,title:M,description:N,help:P,category:F,presentation:I}}));function R({withComparison:e,platformDimension:t}){return{platformDimension:t,reportParams:u(e)}}function z(e){return(0,V.jsx)(E,{attributes:R(e)})}function B(e){return(0,V.jsx)(E,{attributes:{platformDimension:`browser`,reportParams:u(!1,e)}})}function Ce(e){return(0,V.jsx)(E,{...e})}function we({withComparison:e,platformDimension:t,...n}){return(0,V.jsx)(ce,{...n,widgetType:U,renderModule:H,renderComponent:Ce,attributes:R({withComparison:e,platformDimension:t})})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{d(),le(),se(),v(),h(),me(),he(),xe(),A(),Se(),V=r(),ae(),pe(),H=`storybook/top-platforms`,U=ue(L,k),W={title:`Packages/Premium Analytics/Widgets/TopPlatforms`,component:E,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},platformDimension:{control:`radio`,options:[`browser`,`platform`],description:`The "View by" toolbar attribute rendered by the widget host.`}},parameters:{docs:{description:{component:"The \"Top Platforms\" widget. Shows browser and OS breakdown as a ranked leaderboard. The active dimension is the `platformDimension` attribute (`relevance: 'high'`), exposed as a control by the widget host."}}}},G={render:z,args:{withComparison:!1,platformDimension:`browser`},decorators:[y]},K={render:z,args:{withComparison:!0,platformDimension:`browser`},decorators:[y]},q={render:z,args:{withComparison:!1,platformDimension:`platform`},decorators:[y]},J={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(b(`stats/devices`,`loading`),()=>b(`stats/devices`,null))},Y={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(b(`stats/devices`,`error`),()=>b(`stats/devices`,null))},X={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(b(`stats/devices`,`error-retryable`),()=>b(`stats/devices`,null))},Z={render:()=>B(`last-year`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(b(`stats/devices`,`empty`),()=>b(`stats/devices`,null))},Q={render:e=>(0,V.jsx)(we,{...e}),args:{...fe,withComparison:!0,platformDimension:`browser`},argTypes:{...de,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},platformDimension:{control:`radio`,options:[`browser`,`platform`],description:`The "View by" toolbar attribute rendered by the widget host.`}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
