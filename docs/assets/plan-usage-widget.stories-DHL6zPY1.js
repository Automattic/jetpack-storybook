import{i as e}from"./preload-helper-usAeo7Bx.js";import{f as t,n,r,t as i}from"./build-module-yGZutq_9.js";import{n as a,t as o}from"./clsx-SUvPW2lx.js";import{t as s}from"./jsx-runtime-D2pHJD-r.js";import{Nu as c,Uu as ee,li as l,t as u}from"./build-module-zwSmKorH.js";import{Mt as d,R as te,bt as f}from"./build-module-CpMuGSvV.js";import{g as ne}from"./hooks-BZX5E4cH.js";import{Qa as p,Ya as re}from"./iframe-S4v-AmGV.js";import{t as ie}from"./src-DnczwPoE.js";import{n as m,t as ae}from"./src-BdoOmzzN.js";import{$t as h,Tn as g,X as oe,r as _}from"./date-period-dropdown-B5gQ2ZJd.js";import{c as se,i as ce,o as v,r as y,s as b,u as le}from"./register-report-mocks-CQAghYV8.js";import{t as ue}from"./widget-state-CiovfCCp.js";import{t as de}from"./src-P7FTmKGL.js";import{a as fe,c as pe,i as me,l as he,n as ge,o as _e,r as x,s as ve}from"./with-widget-canvas-Sci0Y6OC.js";var S,C,w,T,E,D,O,ye=e((()=>{S=`_root_1i6zp_1`,C=`_progress_1i6zp_9`,w=`_progressMeter_1i6zp_24`,T=`_isOverLimit_1i6zp_46`,E=`_progressLabel_1i6zp_55`,D=`_note_1i6zp_61`,O={root:S,progress:C,progressMeter:w,isOverLimit:T,progressLabel:E,note:D}}));function be(e){return n(e>=2?`You've surpassed your limit for two consecutive periods already.`:`You've surpassed your limit the past month.`,`jetpack-premium-analytics-pkg`)}function xe(){let e=p()?.site,t=e?.wpcom?.blog_id;return!e?.admin_url||!t?void 0:`${e.admin_url}admin.php?page=stats#!/stats/purchase/${t}?from=jetpack-premium-analytics&productType=commercial&redirect_uri=admin.php%3Fpage%3Djetpack-premium-analytics-wp-admin`}function Se({limit:e,usage:i,daysToReset:a,overLimitMonths:s}){let c=i??0,l=c>=e,u=xe();return(0,A.jsxs)(f,{className:O.root,direction:`column`,align:`stretch`,justify:`safe center`,gap:`md`,children:[(0,A.jsxs)(`div`,{className:o(O.progress,l&&O.isOverLimit),children:[(0,A.jsx)(`progress`,{className:O.progressMeter,value:Math.min(c,e),max:e,"aria-label":n(`Plan usage`,`jetpack-premium-analytics-pkg`)}),(0,A.jsx)(d,{className:O.progressLabel,variant:`body-sm`,children:t(n(`%1$s / %2$s views`,`jetpack-premium-analytics-pkg`),m(c,`number`,{decimals:0}),m(e,`number`,{decimals:0}))}),a!==void 0&&(0,A.jsx)(d,{className:O.progressLabel,variant:`body-sm`,children:t(r(`Restarts in %d day`,`Restarts in %d days`,a,`jetpack-premium-analytics-pkg`),a)})]}),(!!s||u)&&(0,A.jsxs)(d,{className:O.note,variant:`body-sm`,children:[s?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`strong`,{children:be(s)}),` `]}):null,u&&ee(n(`Do you want to increase your views limit? <a>Upgrade now</a>`,`jetpack-premium-analytics-pkg`),{a:(0,A.jsx)(te,{href:u})})]})]})}function Ce(){let{data:e,isLoading:t,isFetching:r,isError:i,refetch:a}=oe(),o=e?.views_limit,s=typeof o==`number`&&o>0,c=p()?.site?.host===`vip`;return(0,A.jsx)(ue,{isLoading:t,isFetching:r,isError:!e&&i,isEmpty:!s,error:{description:n(`We couldn't load plan usage. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:n(`Retry`,`jetpack-premium-analytics-pkg`),onClick:a}]},empty:{icon:l,description:n(`Plan usage isn't available for your current plan.`,`jetpack-premium-analytics-pkg`)},children:s&&(0,A.jsx)(Se,{limit:o,usage:e?.current_usage?.views_count,daysToReset:e?.current_usage?.days_to_reset,overLimitMonths:c?null:e?.over_limit_months})})}function k({attributes:e={}}){return(0,A.jsx)(ne,{attributes:e,children:(0,A.jsx)(Ce,{})})}var A,we=e((()=>{re(),_(),ae(),de(),c(),i(),u(),ie(),a(),ye(),A=s()})),j,Te=e((()=>{u(),j={icon:l,attributes:[],example:{attributes:{}}}})),M,N,P,F,I,L,R,Ee=e((()=>{M=`jpa/plan-usage`,N=`Plan usage`,P=`How your billable views compare to your plan's monthly limit.`,F={content:`Billable views are your total views minus your two highest-traffic days each billing cycle, so big spikes won't count against your limit. You'll only need to upgrade if you exceed your limit for three cycles in a row.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/free-or-paid/`}]},I=`stats`,L=`framed`,R={name:M,title:N,description:P,help:F,category:I,presentation:L}}));function z(e){return()=>(b(`jetpack-stats/usage`,e),g.removeQueries({queryKey:[`stats-app`,`plan-usage`]}),()=>{b(`jetpack-stats/usage`,null),g.removeQueries({queryKey:[`stats-app`,`plan-usage`]})})}function B({vip:e}){return()=>(v(`jetpack-stats/usage`,le),e&&(window.JetpackScriptData.site.host=`vip`),g.removeQueries({queryKey:[`stats-app`,`plan-usage`]}),()=>{v(`jetpack-stats/usage`,null),e&&delete window.JetpackScriptData.site.host,g.removeQueries({queryKey:[`stats-app`,`plan-usage`]})})}function V(){return(0,U.jsx)(k,{attributes:{reportParams:h()}})}function H(e){return(0,U.jsx)(ve,{...e,widgetType:me(R,j),renderModule:W,renderComponent:k,attributes:{reportParams:h(!0)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{_(),se(),y(),pe(),fe(),ge(),we(),Te(),Ee(),U=s(),ce(),window.JetpackScriptData={...window.JetpackScriptData,site:{...window.JetpackScriptData?.site,admin_url:`https://example.com/wp-admin/`,wpcom:{blog_id:123456789}}},W=`storybook/plan-usage`,G={title:`Packages/Premium Analytics/Widgets/PlanUsage`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:`The "Plan usage" widget. Shows billable views used in the current billing cycle against the plan's limit as a horizontal usage meter — figures and days-until-reset inside the bar, an upgrade note below it — following the Stats "Plan usage" section. The usage endpoint is a point-in-time reading with no date range or comparison period.`}}}},K={render:V,decorators:[x]},q={render:V,tags:[`!autodocs`],decorators:[x],beforeEach:z(`loading`)},J={render:V,tags:[`!autodocs`],decorators:[x],beforeEach:z(`error`)},Y={render:V,tags:[`!autodocs`],decorators:[x],beforeEach:z(`empty`)},X={render:V,tags:[`!autodocs`],decorators:[x],beforeEach:B({vip:!1})},Z={render:V,tags:[`!autodocs`],decorators:[x],beforeEach:B({vip:!0})},Q={render:e=>(0,U.jsx)(H,{...e}),args:{..._e},argTypes:{...he}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
