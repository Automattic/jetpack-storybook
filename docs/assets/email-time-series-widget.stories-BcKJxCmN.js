import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as i,t as a}from"./build-module-CbwHEf9N.js";import{js as o,n as s}from"./build-module-CDRs4YxF.js";import{K as c,X as l,et as u,it as ee,q as d}from"./report-metric-Ca_kXAW3.js";import{A as te,t as f}from"./src-Cvyt29m2.js";import{s as ne}from"./hooks-DiID8J5B.js";import{n as p,t as m}from"./with-chart-theme-CCn8USpE.js";import{Dt as re,Nr as ie,Ot as ae,Tt as h,hr as g,xr as oe}from"./chart-tooltip-BQsM5vre.js";import{t as se}from"./comparative-line-chart-BULAhUML.js";import{t as ce}from"./widget-state-CXHVbl5s.js";import{a as le}from"./report-records-table-jGPzqn0V.js";import{C as ue,D as de,E as fe,S as pe,T as me,b as he,t as ge,w as _e,x as _}from"./src-C9i3aD_R.js";import{n as v,t as ve}from"./src-CTnjs8Hu.js";var y,b,x,ye=e((()=>{y=`_root_gxrb3_3`,b=`_chart_gxrb3_12`,x={root:y,chart:b}}));function be(e){return t(e===`clicks`?`Total clicks`:`Total opens`,`jetpack-premium-analytics-pkg`)}function xe({metric:e,granularity:n}){let{reportParams:r}=ee(),a=ie(r.post_id),o=a>0,s=ae(a,r,{enabled:o&&e===`opens`}),c=re(a,r,{enabled:o&&e===`clicks`}),l=e===`clicks`?c:s,u=(0,i.useCallback)(()=>{l.refetch()},[l]),d=l.data,f=T[e],p=(0,i.useMemo)(()=>{if(d)return n===`day`?d:oe(d,n,e=>{let t=Number(e[f]??0);return{value:t,[f]:t}})},[d,n,f]),m=(0,i.useMemo)(()=>p?le({primary:p,metrics:[{key:f,label:be(e)}]}):[],[p,f,e]),h=ne(m),g=(p?.data?.length??0)>0;return(0,C.jsx)(`div`,{className:x.root,children:(0,C.jsx)(ce,{isLoading:l.isLoading,isFetching:l.isFetching,isError:l.isError,isEmpty:!o||!g,error:{description:t(`We couldn't load this email's timeline. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:u}]},empty:{icon:te,description:t(o?`No activity for this email in this period.`:`Open an email report to see its timeline here.`,`jetpack-premium-analytics-pkg`)},children:(0,C.jsx)(se,{className:x.chart,series:m,styles:h,dataFormat:w})})})}function S({attributes:e={}}){return(0,C.jsx)(u,{attributes:e,children:(0,C.jsx)(xe,{metric:e.metric??`opens`,granularity:e.granularity??`day`})})}var C,w,T,E=e((()=>{h(),f(),ge(),a(),n(),ye(),C=r(),w={type:`number`,options:{useMultipliers:!0,decimals:0}},T={opens:`opens_count`,clicks:`clicks_count`}})),D,Se=e((()=>{n(),s(),ve(),D={icon:o,attributes:[{id:`metric`,label:t(`Metric`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:v,elements:[{label:t(`Opens`,`jetpack-premium-analytics-pkg`),value:`opens`},{label:t(`Clicks`,`jetpack-premium-analytics-pkg`),value:`clicks`}]},{id:`granularity`,label:t(`Group by`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:v,elements:[{label:t(`By days`,`jetpack-premium-analytics-pkg`),value:`day`},{label:t(`By weeks`,`jetpack-premium-analytics-pkg`),value:`week`},{label:t(`By months`,`jetpack-premium-analytics-pkg`),value:`month`}],relevance:`high`}],example:{attributes:{metric:`opens`,granularity:`day`}}}})),O,k,A,j,M,N,P,Ce=e((()=>{O=`jpa/email-time-series`,k=`Email performance`,A=`A single email's opens or clicks over time since it was sent.`,j={content:`How a single email performed over time: opens or clicks per day since it was sent, following the dashboard date range. Weekly and monthly grouping aggregate the daily buckets.`},M=`stats`,N=`framed`,P={name:O,title:k,description:A,help:j,category:M,presentation:N}}));function F(e){return D.attributes.find(t=>t.id===e)?.elements?.map(e=>e.value)??[]}function I({metric:e,granularity:t},n=!1){return{reportParams:{...g(n),post_id:V},metric:e,granularity:t}}function L(e){return(0,z.jsx)(S,{attributes:I(e)})}function R(e){return(0,z.jsx)(S,{attributes:{reportParams:{...g(!1),post_id:e},metric:`opens`,granularity:`day`}})}function we({metric:e,granularity:t,...n}){return(0,z.jsx)(me,{...n,widgetType:pe(P,D),renderModule:B,renderComponent:S,attributes:I({metric:e,granularity:t},!0)})}var z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{h(),c(),m(),fe(),ue(),he(),E(),Se(),Ce(),z=r(),d(),B=`storybook/email-time-series`,V=1234,H=F(`metric`),U=F(`granularity`),W={title:`Packages/Premium Analytics/Widgets/EmailTimeSeries`,component:S,tags:[`autodocs`],argTypes:{metric:{control:`select`,options:H},granularity:{control:`select`,options:U}},parameters:{docs:{description:{component:"The \"Email performance\" widget. Draws a single sent email's opens or clicks per day as a line chart, spanning the dashboard date range — the chart section of the legacy email detail page. The `granularity` attribute (`relevance: 'high'`) is exposed as a control by the widget host; weekly grouping aggregates the daily buckets client-side because the endpoint only reports hourly/daily. Scoped to one email via a mocked `reportParams.post_id`. The post detail page has no comparison control, so comparison report params are ignored."}}},decorators:[p]},G={render:L,args:{metric:`opens`,granularity:`day`},decorators:[_]},K={render:L,args:{metric:`clicks`,granularity:`day`},decorators:[_]},q={render:L,args:{metric:`opens`,granularity:`week`},decorators:[_]},J={render:()=>R(5701),tags:[`!autodocs`],decorators:[_],beforeEach:()=>(l(`stats/opens/emails`,`loading`),()=>l(`stats/opens/emails`,null))},Y={render:()=>R(5702),tags:[`!autodocs`],decorators:[_],beforeEach:()=>(l(`stats/opens/emails`,`error`),()=>l(`stats/opens/emails`,null))},X={render:()=>R(5703),tags:[`!autodocs`],decorators:[_],beforeEach:()=>(l(`stats/opens/emails`,`empty`),()=>l(`stats/opens/emails`,null))},Z={render:()=>(0,z.jsx)(S,{attributes:{reportParams:g(!1),metric:`opens`}}),decorators:[_]},Q={render:e=>(0,z.jsx)(we,{...e}),args:{..._e,metric:`opens`,granularity:`day`},argTypes:{...de,metric:{control:`select`,options:H},granularity:{control:`select`,options:U}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
