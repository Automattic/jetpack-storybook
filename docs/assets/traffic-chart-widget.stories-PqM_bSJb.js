import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-2QZQpBH2.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{C as o,Uu as s,ju as c,t as l}from"./build-module-2iv4IIRq.js";import{C as u,m as d,v as f,y as p}from"./hooks-Bj06gF3B.js";import{M as m,t as h}from"./src-C-E2d-Lb.js";import{$t as g,I as ee,r as _,t as v}from"./src-Bv1gHDfD.js";import{F as te,j as y}from"./helpers-BNVgdtD4.js";import{r as b,t as x}from"./metric-tabs-chart-skeleton-C4HlviPP.js";import{c as S,i as ne,r as re}from"./register-report-mocks-DykcCpN8.js";import{t as ie}from"./widget-state-Cq9rbSLC.js";import{t as C}from"./src-DrCgTKe-.js";import{a as ae,d as oe,f as se,h as ce,i as le,m as ue,n as de,p as fe,r as w,u as pe}from"./with-widget-canvas-GcuJjnSQ.js";import{n as me,r as he,t as ge}from"./with-site-time-zone-ngtW_VDw.js";var _e,ve,ye=t((()=>{_e=`_root_sp1nf_1`,ve={root:_e}})),T,E,D,O=t((()=>{i(),l(),C(),T=[`hour`,`day`,`week`,`month`],E=[{id:`views`,label:r(`Views`,`jetpack-premium-analytics-pkg`),counterpartId:`visitors`},{id:`visitors`,label:r(`Visitors`,`jetpack-premium-analytics-pkg`),counterpartId:`views`},{id:`comments`,label:r(`Comments`,`jetpack-premium-analytics-pkg`)},{id:`likes`,label:r(`Likes`,`jetpack-premium-analytics-pkg`)}],D={icon:o,attributes:[y()],example:{attributes:{chartType:`line`}}}}));function k(e,t,n){return{...e,stat_fields:t,period:n}}function be(e,t){let n=t===`hour`,i=(0,s.useCallback)(e=>!n||A.has(e),[n]),a=(0,s.useMemo)(()=>k(e,n?`views`:`views,visitors`,t),[e,t,n]),o=(0,s.useMemo)(()=>k(e,`likes,comments`,t),[e,t]),c=ee(a),l=ee(o,{enabled:!n}),u=c.primary.data,d=c.comparison.data,f=c.hasComparison,p=c.timezone,m=l.primary.data,h=l.comparison.data,g=l.hasComparison,_=l.timezone,v=(0,s.useMemo)(()=>E.map(e=>{let t=e.id===`views`||e.id===`visitors`;return{...te({primary:t?u:m,comparison:t?d:h,hasComparison:t?f:g,field:e.id,label:e.label,zone:t?p:_}),counterpartKey:`counterpartId`in e?e.counterpartId:void 0,...i(e.id)?{}:{unavailable:r(`Hourly data isn't available for this metric.`,`jetpack-premium-analytics-pkg`)}}}),[i,u,d,f,p,m,h,g,_]),{refetch:y}=c,{refetch:b}=l,x=(0,s.useCallback)(()=>{y(),b()},[y,b]),S=c.isError&&!u?.data?.length||l.isError&&!m?.data?.length;return{metrics:v,isLoading:c.isLoading||l.isLoading,isFetching:c.isFetching||l.isFetching,isError:S,refetch:x}}var A,xe=t((()=>{v(),c(),i(),O(),C(),A=new Set([`views`])}));function Se({chartType:e}){let{reportParams:t}=f(),n=_(t.interval,T),{drillDown:i}=u(),a=(0,M.useCallback)(e=>i(e,n),[i,n]),{metrics:o,isLoading:s,isFetching:c,isError:l,refetch:d}=be(t,n),p=r(`Traffic metric`,`jetpack-premium-analytics-pkg`),h=o.filter(e=>!e.unavailable);return(0,N.jsx)(`div`,{className:ve.root,children:(0,N.jsx)(ie,{isLoading:s,isFetching:c,isError:l,isEmpty:h.length>0&&h.every(e=>e.current.length===0),error:{description:r(`We couldn't load traffic data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:d}]},empty:{icon:m,description:r(`No traffic data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,N.jsx)(x,{}),children:(0,N.jsx)(b,{metrics:o,dataFormat:P,chartType:e,groupLabel:p,tickResolution:n,onDatumClick:a})})})}function j({attributes:e={},setError:t}){return(0,N.jsx)(d,{attributes:e,setError:t,options:{from:`/`},children:(0,N.jsx)(Se,{chartType:e.chartType})})}var M,N,P,Ce=t((()=>{C(),h(),p(),i(),M=e(n(),1),ye(),xe(),O(),N=a(),P={type:`number`,options:{useMultipliers:!0,decimals:0}}})),F,I,L,we,Te,Ee,De,Oe=t((()=>{F=`jpa/traffic-chart`,I=`Traffic summary`,L=`Compare views, visitors, likes, and comments over the selected period, with the previous period overlaid for comparison.`,we={content:`A summary of your site's views, visitors, likes, and comments. The Visitors total is a per-period sum, not a unique count.`},Te=`traffic`,Ee=`framed`,De={name:F,title:I,description:L,help:we,category:Te,presentation:Ee}}));function R({withComparison:e,chartType:t}){return(0,B.jsx)(j,{attributes:{reportParams:g(e),chartType:t}})}function z(e){return(0,B.jsx)(j,{attributes:{reportParams:g(!1,e)}})}function ke({withComparison:e,chartType:t,...n}){return(0,B.jsx)(oe,{...n,widgetType:H,renderModule:V,renderComponent:j,attributes:{reportParams:g(e),chartType:t}})}var B,V,H,U,W,Ae,G,K,q,J,Y,X,Z,Q,$,je;t((()=>{v(),se(),ae(),ue(),de(),ge(),re(),Ce(),O(),Oe(),B=a(),ne(),V=`storybook/traffic-chart`,H=le(De,D),U={chartType:{control:`inline-radio`,options:[`line`,`bar`]}},W={chartType:`line`},Ae={title:`Packages/Premium Analytics/Widgets/TrafficChart`,component:j,tags:[`autodocs`],decorators:[ce,he],argTypes:{...me,withComparison:{control:`boolean`},...U},parameters:{docs:{description:{component:"Traffic over the selected period as selectable metric tabs — Views, Visitors, Likes, and Comments — over a comparative chart. The date range, comparison, and bucket size come from the dashboard controls: the bucket is whatever the page's interval control resolves to, clamped to one the chart can draw. \"Chart type\" is the `chartType` attribute (`relevance: 'high'`, so the host renders it in the widget header). Which metric is plotted is the chart's own tab selection. When comparison is on, each tab shows its period-over-period delta and the previous period is overlaid — as a same-colour dashed line for `line`, or as the translucent shadow bar behind each bar for `bar`. Views/visitors and likes/comments are fetched as two parallel requests (mirroring Calypso) to keep latency down; the likes and comments request is skipped at the hourly grain, which cannot fill either. Data comes from the `useStatsVisits` hook; in Storybook it is served by `registerReportMocks`."}}}},G={render:R,args:{withComparison:!1,...W},decorators:[w]},K={render:R,args:{withComparison:!0,...W},decorators:[w]},q={render:R,args:{withComparison:!1,...W,chartType:`bar`},decorators:[w]},J={render:R,args:{withComparison:!0,...W,chartType:`bar`},decorators:[w]},Y={render:e=>(0,B.jsx)(oe,{...e,widgetType:H,renderModule:V,renderComponent:j,attributes:{reportParams:g(!1,`last-24-hours`)}}),args:{...pe},argTypes:{...fe}},X={render:()=>z(`last-90-days`),tags:[`!autodocs`],decorators:[w],beforeEach:()=>(S(`stats/visits`,`loading`),()=>S(`stats/visits`,null))},Z={render:()=>z(`last-7-days`),tags:[`!autodocs`],decorators:[w],beforeEach:()=>(S(`stats/visits`,`error`),()=>S(`stats/visits`,null))},Q={render:()=>z(`last-365-days`),tags:[`!autodocs`],decorators:[w],beforeEach:()=>(S(`stats/visits`,`empty`),()=>S(`stats/visits`,null))},$={render:e=>(0,B.jsx)(ke,{...e}),args:{...pe,withComparison:!0,...W},argTypes:{...fe,withComparison:{control:`boolean`},...U}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
