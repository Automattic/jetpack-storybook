import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{Ah as r,Hn as i,Mh as a,Oh as o,Wn as s,jh as c,kh as l,pg as u}from"./iframe-BYpzgPGT.js";import{A as d,_ as f,a as ee,d as te,f as ne,g as p,h as re,i as m,m as ie,n as ae,p as oe,r as se,t as ce,y as le}from"./providers-tshyWj0i.js";import{T as ue,d as de,f as fe,n as pe,p as me,r as he,s as ge,t as h}from"./esm-ClxYHSxC.js";import{a as _e,c as ve,d as ye,f as be,i as xe,l as Se,o as Ce,s as g,u as we}from"./line-chart-DOlXAFzW.js";import{c as Te,n as Ee,o as De,r as Oe,s as ke,t as Ae}from"./chart-decorator-qnFHuHeE.js";import{n as je,r as Me,t as Ne}from"./legend-config-tJy46Dt1.js";import{n as Pe,t as _}from"./tooltip-config-DU_WVmuX.js";import{b as Fe,c as Ie,y as v}from"./sample-data-BfcHm5eo.js";import{t as Le}from"./stories-Dfy3mPpa.js";import{c as Re,d as y,i as ze,l as Be,n as Ve,p as He,r as Ue,s as We,t as Ge}from"./chart-layout-vH70pwXb.js";import{n as Ke,r as qe,t as Je}from"./tooltip-Jv4QU_Tg.js";import{n as Ye,t as Xe}from"./svg-empty-state-BNCglcTh.js";import{n as b,t as x}from"./with-responsive-BAmCGEjB.js";import{t as Ze}from"./line-chart-C3Km0kn_.js";var Qe,S,$e=e((()=>{Qe=`_rise_sezj1_1`,S={"area-chart":`_area-chart_sezj1_1`,"area-chart--animated":`_area-chart--animated_sezj1_4`,rise:Qe}})),et,tt=e((()=>{c(),et=e=>!e?.length||e.some(e=>!e.data?.length)?a(`No data available`,`jetpack-charts`):e.some(e=>e.data.some(e=>isNaN(e.value)||e.value===null||e.value===void 0||`date`in e&&e.date&&isNaN(e.date.getTime())))?a(`Invalid data`,`jetpack-charts`):null})),C,w,nt,rt,it=e((()=>{h(),C=t(u(),1),w=o(),nt=({chartRef:e,width:t,height:n,margin:r})=>{let i=(0,C.useContext)(ue);return(0,C.useImperativeHandle)(e,()=>({getScales:()=>!i?.xScale||!i?.yScale?null:{xScale:i.xScale,yScale:i.yScale},getChartDimensions:()=>({width:t,height:n,margin:r||{}})}),[i,t,n,r]),null},rt=({visibleSeries:e,stacked:t,stackOffset:n,getElementStyles:r,strokeColor:i})=>{let a=(0,C.useContext)(ue),o=(0,C.useContext)(de),s=a?.xScale,c=a?.yScale,l=o?.tooltipOpen,u=o?.tooltipData?.nearestDatum?.datum;if(!l||!s||!c||!u||!u.date||t&&n!==`none`)return null;let d=Number(s(u.date));if(!Number.isFinite(d))return null;let f=u.date.getTime(),ee=0,te=[];for(let{series:n,index:a}of e){let e=n.data.find(e=>e.date?.getTime()===f),o=e?.value??0;if(t&&(ee+=o),!e||e.value==null)continue;let s=Number(c(t?ee:o));if(!Number.isFinite(s))continue;let{color:l}=r({data:n,index:a});te.push((0,w.jsx)(`circle`,{cx:d,cy:s,r:4,fill:l,stroke:i,strokeWidth:1.5,paintOrder:`fill`,"data-testid":`area-chart-hover-glyph-${a}`},n.label||a))}return te.length===0?null:(0,w.jsx)(`g`,{pointerEvents:`none`,className:`area-chart__hover-glyphs`,children:te})}})),at=e((()=>{tt(),it()})),T,E,D,O,k,ot=e((()=>{s(),h(),c(),r(),T=t(u(),1),We(),Je(),m(),ce(),le(),Ze(),Ue(),Ge(),y(),Xe(),be(),x(),g(),$e(),at(),E=o(),D=(0,T.forwardRef)(({data:e,chartId:t,width:n,height:r,className:o,margin:s,withTooltips:c=!0,withTooltipCrosshairs:u,showLegend:d=!1,legend:f={},stacked:p=!0,stackOffset:m=`none`,smoothing:ce=!0,curveType:le,fillOpacity:ue,withStroke:de,renderTooltip:h=xe,animation:be,options:g={},onPointerDown:Te,onPointerUp:Ee,onPointerMove:De,onPointerOut:Oe,zoomable:ke=!1,rescaleYOnLegendToggle:Ae=!0,children:je,gridVisibility:Me,gap:Ne=`md`},Pe)=>{let _=f.interactive??!1,Fe=f.shape??`rect`,Ie=f.position??`bottom`,v=ae(),Le=oe(e),y=ie(t),Ue=(0,T.useRef)(null),[We,Ge]=(0,T.useState)(void 0),[Je,Xe]=(0,T.useState)(!1),b=(0,T.useRef)(null),x=ve({enabled:ke,chartRef:b,userHandlers:{onPointerDown:Te,onPointerMove:De,onPointerUp:Ee}}),{legendChildren:Ze,nonLegendChildren:Qe}=ze(je,`AreaChart`),[$e,tt]=(0,T.useState)(),C=(0,T.useCallback)(e=>{tt(e>0?e:r)},[r]);(0,T.useImperativeHandle)(Pe,()=>({getScales:()=>b.current?.getScales()||null,getChartDimensions:()=>b.current?.getChartDimensions()||{width:0,height:0,margin:{}}}),[b]);let w=ne(e),{getElementStyles:it,isSeriesVisible:at}=re(),D=(0,T.useMemo)(()=>!y||!_?w.map((e,t)=>({series:e,index:t,isVisible:!0})):w.map((e,t)=>({series:e,index:t,isVisible:at(y,e.label)})),[w,y,at,_]),O=(0,T.useMemo)(()=>D.every(({isVisible:e})=>!e),[D]),{tooltipRef:k,onChartFocus:ot,onChartBlur:st,onChartKeyDown:A}=qe({selectedIndex:We,setSelectedIndex:Ge,isNavigating:Je,setIsNavigating:Xe,chartRef:Ue,totalPoints:w[0]?.data.length||0}),ct=(0,T.useMemo)(()=>{if(Ae||!_||!w.length||!w[0].data.length||p&&m!==`none`)return;if(p){let e=Math.max(...w.map(e=>e.data.length)),t=0,n=0;for(let r=0;r<e;r++){let e=0,i=0;for(let t of w){let n=Number(t.data[r]?.value);Number.isNaN(n)||(n>=0?e+=n:i+=n)}e>t&&(t=e),i<n&&(n=i)}return[n,t]}let e=-1/0,t=1/0;for(let n of w)for(let r of n.data){let n=Number(r?.value);Number.isNaN(n)||(n>e&&(e=n),n<t&&(t=n))}if(e!==-1/0)return[Math.min(0,t),e]},[w,p,m,_,Ae]),j=(0,T.useMemo)(()=>{let e=g?.axis?.x?.tickFormat||we(w);return{axis:{x:{orientation:`bottom`,numTicks:ye(w,n,e),tickFormat:e,display:!0,...g?.axis?.x},y:{orientation:`left`,numTicks:4,tickFormat:i,display:!0,...g?.axis?.y}},xScale:{type:`time`,...g?.xScale,...x.domain?{domain:x.domain}:{}},yScale:{type:`linear`,nice:!0,zero:p,...ct?{domain:ct}:{},...g?.yScale}}},[g,w,n,p,ct,x.domain]),M=te(r,j,w,Le),N=et(w),P=!N;se({chartId:y,legendItems:Re(w,(0,T.useMemo)(()=>({withGlyph:!1,glyphSize:0}),[]),Fe),chartType:`area`,isDataValid:P,metadata:(0,T.useMemo)(()=>({stacked:p,stackOffset:m,smoothing:ce,curveType:le}),[p,m,ce,le])});let F=ee(),I=!!be&&!F,L={xAccessor:e=>e?.date,yAccessor:e=>e?.value},R=(0,T.useCallback)(()=>0,[]),z=(0,T.useMemo)(()=>new Set(D.filter(e=>e.isVisible).map(e=>e.series.label)),[D]),B=(0,T.useCallback)(e=>{if(!_)return h(e);let t=e?.tooltipData?.datumByKey;if(!t)return h(e);let n=Object.fromEntries(Object.entries(t).filter(([e])=>z.has(e)));if(Object.keys(n).length===0)return null;let r=e?.tooltipData?.nearestDatum,i=r&&z.has(r.key)?r:{...Object.values(n)[0],distance:r?.distance??0};return h({...e,tooltipData:{...e.tooltipData,datumByKey:n,nearestDatum:i}})},[h,_,z]),V=ue??(p?.85:.4),H=de??!p;if(N)return(0,E.jsx)(`div`,{className:l(`area-chart`,S[`area-chart`]),children:N});let U=d&&(0,E.jsx)(Be,{orientation:f.orientation??`horizontal`,alignment:f.alignment??`center`,position:Ie,labelStyles:f.labelStyles,itemClassName:f.itemClassName,itemStyles:f.itemStyles,shapeStyles:f.shapeStyles,className:S[`area-chart__legend`],shape:Fe,chartId:y,interactive:_}),W=D.filter(({isVisible:e})=>e),G=Se(le,ce),K=({series:e,index:t,isVisible:n})=>{let{color:r,lineStyles:i}=it({data:e,index:t});return(0,E.jsx)(he,{dataKey:e?.label,data:e.data,xAccessor:L.xAccessor,yAccessor:n||!_?L.yAccessor:R,fill:r,fillOpacity:V,...p?{}:{renderLine:H,curve:G},lineProps:{stroke:r,...i},"data-testid":`area-chart-series-${t}`},e?.label||t)};return(0,E.jsx)(He.Provider,{value:{chartId:y,chartRef:b,chartWidth:n,chartHeight:$e||0},children:(0,E.jsx)(Ve,{legendPosition:Ie,legendElement:U,legendChildren:Ze,gap:Ne,className:l(`area-chart`,S[`area-chart`],{[S[`area-chart--animated`]]:I},o),style:{width:n,height:r},"data-testid":`area-chart`,trailingContent:Qe,onContentHeightChange:C,children:({contentHeight:e})=>{let t=e>0?e:r;return(0,E.jsx)(`div`,{role:`grid`,"aria-label":a(`Area chart`,`jetpack-charts`),tabIndex:0,onKeyDown:A,onFocus:ot,onBlur:st,children:t>0&&(0,E.jsxs)(`div`,{ref:Ue,style:{position:`relative`},children:[ke&&x.domain&&(0,E.jsx)(_e,{onClick:x.reset}),(0,E.jsxs)(ge,{theme:Le,width:n,height:t,margin:{...M,...s},xScale:j.xScale,yScale:j.yScale,onPointerDown:x.handlers.onPointerDown,onPointerUp:x.handlers.onPointerUp,onPointerMove:x.handlers.onPointerMove,onPointerOut:Oe,pointerEventsDataKey:`nearest`,children:[Me!==`none`&&(0,E.jsx)(fe,{columns:!1,numTicks:4}),j.axis.x.display&&(0,E.jsx)(me,{...j.axis.x}),j.axis.y.display&&(0,E.jsx)(me,{...j.axis.y}),O?(0,E.jsx)(Ye,{x:n/2,y:t/2,width:n,height:t,children:a(`All series are hidden. Click legend items to show data.`,`jetpack-charts`)}):null,!O&&p&&(0,E.jsx)(pe,{curve:G,offset:m,renderLine:H,children:D.map(K)}),!O&&!p&&D.map(K),c&&(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(Ke,{detectBounds:!0,snapTooltipToDatumX:!0,snapTooltipToDatumY:!p,renderTooltip:B,showVerticalCrosshair:u?.showVertical,showHorizontalCrosshair:u?.showHorizontal,selectedIndex:We,tooltipRef:k,keyboardFocusedClassName:S[`area-chart__tooltip--keyboard-focused`],series:w}),(0,E.jsx)(rt,{visibleSeries:W,stacked:p,stackOffset:m,getElementStyles:it,strokeColor:v.backgroundColor})]}),(0,E.jsx)(nt,{chartRef:b,width:n,height:r||t,margin:s}),ke&&(0,E.jsx)(Ce,{drag:x.drag})]})]})})}})})}),O=(0,T.forwardRef)((e,t)=>(0,T.useContext)(p)?(0,E.jsx)(D,{...e,ref:t}):(0,E.jsx)(f,{children:(0,E.jsx)(D,{...e,ref:t})})),O.displayName=`AreaChart`,d(O,{Legend:Be}),k=d(b(O),{Legend:Be})})),st,A,ct=e((()=>{Ee(),je(),Ie(),De(),_(),ot(),st={title:`JS Packages/Charts Library/Charts/Area Chart`,component:k,parameters:{layout:`centered`},decorators:[Ae],argTypes:{...Me,...Te,...Oe,...Pe,data:{control:{type:`object`},description:`Array of series data to display in the chart`,table:{category:`Data`}}}},A={...ke,data:v.slice(0,4),stacked:!0,stackOffset:`none`,smoothing:!0,maxWidth:1200,resizeDebounceTime:300,options:{axis:{x:{orientation:`bottom`},y:{orientation:`left`}}},withTooltips:!0}})),j=n({Animation:()=>U,AspectRatio:()=>H,CurveTypes:()=>K,CustomTooltip:()=>Z,Default:()=>F,ErrorStates:()=>q,FillOpacity:()=>J,FixedDimensions:()=>V,GridVisibility:()=>X,LinearLines:()=>z,MismatchedXDomains:()=>$,NegativeValues:()=>Q,PercentageStack:()=>L,RescaleYOnLegendToggle:()=>W,SingleSeries:()=>B,Streamgraph:()=>R,Unstacked:()=>I,WithCompositionLegend:()=>G,WithStroke:()=>Y,__namedExportsOrder:()=>lt,default:()=>N}),M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,lt,ut=e((()=>{Le(),ot(),ct(),M=o(),N={...st,title:`JS Packages/Charts Library/Charts/Area Chart`,component:st.component,argTypes:{...st.argTypes,seriesCount:{control:{type:`radio`},options:[`single`,`multiple`,`many`],description:`Number of data series`,table:{category:`Data`}},dimensionMode:{control:{type:`radio`},options:[`responsive`,`fixed`],description:`Chart sizing mode`,table:{category:`Dimensions`}},stacked:{control:`boolean`,description:`Stack series on top of each other`,table:{category:`Visual Style`}},stackOffset:{control:{type:`radio`},options:[`none`,`expand`,`wiggle`,`silhouette`],description:`Stack offset strategy (only applies when stacked is true)`,table:{category:`Visual Style`}},smoothing:{control:`boolean`,description:`Enable curve smoothing`,table:{category:`Visual Style`}},curveType:{control:{type:`radio`},options:[`linear`,`smooth`,`monotone`],description:`Curve interpolation type`,table:{category:`Visual Style`}},fillOpacity:{control:{type:`range`,min:0,max:1,step:.05},description:`Fill opacity for the areas (0–1)`,table:{category:`Visual Style`}},withStroke:{control:`boolean`,description:`Render a stroke (line) on top of each area`,table:{category:`Visual Style`}}}},P=e=>{let{seriesCount:t,dimensionMode:n,crosshairMode:r,withTooltipCrosshairs:i,...a}=e,o=Ne(e),s=a.data||A.data;t===`single`?s=[v[0]]:t===`multiple`?s=v.slice(0,4):t===`many`&&(s=v);let c={};n===`fixed`&&(c={width:800,height:400});let l;return r===`vertical`?l={showVertical:!0}:r===`horizontal`?l={showHorizontal:!0}:r===`both`&&(l={showVertical:!0,showHorizontal:!0}),(0,M.jsx)(k,{...a,...c,data:s,legend:o,withTooltipCrosshairs:l})},F=P.bind({}),F.args={...A,showLegend:!0,zoomable:!0},I=P.bind({}),I.args={...A,stacked:!1,showLegend:!0},I.parameters={docs:{description:{story:"When `stacked={ false }`, series are rendered as overlapping filled areas. Use `fillOpacity` to control transparency so overlapping series remain visible."}}},L=P.bind({}),L.args={...A,stacked:!0,stackOffset:`expand`,showLegend:!0},L.parameters={docs:{description:{story:'`stackOffset="expand"` produces a 100% stacked area chart — each x-position is normalised to 1.0, useful for showing relative composition over time.'}}},R=P.bind({}),R.args={...A,stacked:!0,stackOffset:`wiggle`,showLegend:!0,smoothing:!0},R.parameters={docs:{description:{story:'`stackOffset="wiggle"` produces a streamgraph layout. Each series flows around a central baseline, minimising weighted change in slope.'}}},z=P.bind({}),z.args={...A,curveType:`linear`,smoothing:!1,showLegend:!0},z.parameters={docs:{description:{story:'Stacked area chart with straight (linear) edges between data points. Use `curveType="linear"` (or `smoothing={ false }`) when you want a precise, unsmoothed visualisation.'}}},B=P.bind({}),B.args={...A,data:[Fe[0]]},V=P.bind({}),V.args={...A,width:600,height:300,showLegend:!0},H=P.bind({}),H.args={...A,aspectRatio:.3,showLegend:!0},U=P.bind({}),U.args={...A,animation:!0,showLegend:!0,legendInteractive:!0},W={name:`Y-axis rescales when legends toggle (default)`,render:e=>(0,M.jsxs)(`div`,{style:{display:`grid`,gap:`2rem`,gridTemplateColumns:`repeat(2, 1fr)`},children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h4`,{children:`rescaleYOnLegendToggle: true (default)`}),(0,M.jsx)(k,{...e,rescaleYOnLegendToggle:!0})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h4`,{children:`rescaleYOnLegendToggle: false (pinned)`}),(0,M.jsx)(k,{...e,rescaleYOnLegendToggle:!1})]})]}),args:{...A,showLegend:!0,legend:{interactive:!0},width:480,height:280},parameters:{docs:{description:{story:`Click legend items to toggle series. The left chart rescales the Y axis to the visible series; the right chart pins the Y axis to the full data extent so the baseline stays put.`}}}},G={render:e=>{let t=Ne(e);return(0,M.jsx)(k,{...F.args,...e,legend:{interactive:t?.interactive},chartId:`composition-area-chart`,children:(0,M.jsx)(k.Legend,{...t})})},args:{...F.args},parameters:{docs:{description:{story:"Composition API using `<AreaChart.Legend />` as a child component for explicit legend placement and configuration."}}}},K={render:()=>{let e=v.slice(0,3);return(0,M.jsxs)(`div`,{style:{display:`grid`,gap:`2rem`,gridTemplateColumns:`repeat(3, 1fr)`},children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Linear`}),(0,M.jsx)(k,{width:300,height:200,data:e,curveType:`linear`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Smooth (Catmull-Rom)`}),(0,M.jsx)(k,{width:300,height:200,data:e,curveType:`smooth`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Monotone X`}),(0,M.jsx)(k,{width:300,height:200,data:e,curveType:`monotone`})]})]})},parameters:{docs:{description:{story:"The three available curve types. `linear` connects points with straight lines; `smooth` uses Catmull-Rom interpolation; `monotone` prevents overshooting on steep changes."}}}},q={render:()=>(0,M.jsxs)(`div`,{style:{display:`grid`,gap:`2rem`,gridTemplateColumns:`repeat(2, 1fr)`},children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Empty Data`}),(0,M.jsx)(k,{width:300,height:200,data:[]})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Invalid Date Values`}),(0,M.jsx)(k,{width:300,height:200,data:[{label:`Invalid Dates`,data:[{date:new Date(`invalid`),value:10},{date:new Date(`2024-01-02`),value:20}]}]})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Invalid Values`}),(0,M.jsx)(k,{width:300,height:200,data:[{label:`Invalid Values`,data:[{date:new Date(`2024-01-01`),value:NaN},{date:new Date(`2024-01-02`),value:null}]}]})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Single Data Point`}),(0,M.jsx)(k,{width:300,height:200,data:[{label:`Single Point`,data:[{date:new Date(`2024-01-01`),value:100}]}]})]})]}),parameters:{docs:{description:{story:`How the area chart handles common edge cases.`}}}},J=P.bind({}),J.args={...A,fillOpacity:.5,showLegend:!0},J.parameters={docs:{description:{story:"Use `fillOpacity` to control how transparent the bands are. Defaults: `0.85` for stacked, `0.4` for unstacked."}}},Y=P.bind({}),Y.args={...A,withStroke:!0,showLegend:!0},Y.parameters={docs:{description:{story:"`withStroke={ true }` renders a stroke on top of each band. By default, stroke is off in stacked mode and on in unstacked mode."}}},X={render:()=>{let e=v.slice(0,3);return(0,M.jsxs)(`div`,{style:{display:`grid`,gap:`2rem`,gridTemplateColumns:`repeat(2, 1fr)`},children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Default grid`}),(0,M.jsx)(k,{width:400,height:240,data:e})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`gridVisibility="none"`}),(0,M.jsx)(k,{width:400,height:240,data:e,gridVisibility:`none`})]})]})},parameters:{docs:{description:{story:'`gridVisibility` controls grid rendering. Use `"none"` for compact / inline visualisations like sparkline-style cards.'}}}},Z=P.bind({}),Z.args={...A,showLegend:!0,renderTooltip:({tooltipData:e})=>{let t=e?.nearestDatum?.datum;if(!t)return null;let n=Object.entries(e?.datumByKey||{}).map(([e,t])=>({key:e,value:t.datum.value})),r=n.reduce((e,t)=>e+(t.value??0),0);return(0,M.jsxs)(`div`,{style:{padding:8,minWidth:160},children:[(0,M.jsx)(`div`,{style:{fontWeight:600,marginBottom:6},children:t.date?.toLocaleDateString()}),n.map(e=>(0,M.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,M.jsx)(`span`,{children:e.key}),(0,M.jsx)(`strong`,{children:e.value})]},e.key)),(0,M.jsx)(`hr`,{style:{margin:`6px 0`,opacity:.3}}),(0,M.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,M.jsx)(`span`,{children:`Total`}),(0,M.jsx)(`strong`,{children:r})]})]})}},Z.parameters={docs:{description:{story:"`renderTooltip` lets you render any React content inside the tooltip portal. The portal background is theme-driven; do not override it in custom content."}}},Q=P.bind({}),Q.args={...A,showLegend:!0,stacked:!0,stackOffset:`none`,data:[{label:`Inflows`,data:[{date:new Date(`2024-01-01`),value:30},{date:new Date(`2024-02-01`),value:35},{date:new Date(`2024-03-01`),value:50},{date:new Date(`2024-04-01`),value:42},{date:new Date(`2024-05-01`),value:60}]},{label:`Outflows`,data:[{date:new Date(`2024-01-01`),value:-15},{date:new Date(`2024-02-01`),value:-20},{date:new Date(`2024-03-01`),value:-10},{date:new Date(`2024-04-01`),value:-25},{date:new Date(`2024-05-01`),value:-18}]}]},Q.parameters={docs:{description:{story:'Mixed positive/negative values with `stackOffset="none"`. Hover glyphs follow the running total, matching where d3-stack draws the band edges.'}}},$=P.bind({}),$.args={...A,showLegend:!0,data:[{label:`Daily`,data:[{date:new Date(`2024-01-01`),value:10},{date:new Date(`2024-01-02`),value:12},{date:new Date(`2024-01-03`),value:14},{date:new Date(`2024-01-04`),value:16},{date:new Date(`2024-01-05`),value:18}]},{label:`Sparse`,data:[{date:new Date(`2024-01-02`),value:5},{date:new Date(`2024-01-03`),value:8},{date:new Date(`2024-01-04`),value:6}]}]},$.parameters={docs:{description:{story:`Series with non-matching x-domains. d3-stack treats missing values as zero; the hover-glyph overlay matches that convention so subsequent series glyphs stay on the correct stacked edge.`}}},F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`args => {
  ...
  return <AreaChart {...chartProps} {...dimensions} data={data} legend={legend} withTooltipCrosshairs={crosshairConfig} />;
}`,...$.parameters?.docs?.source}}},lt=[`Default`,`Unstacked`,`PercentageStack`,`Streamgraph`,`LinearLines`,`SingleSeries`,`FixedDimensions`,`AspectRatio`,`Animation`,`RescaleYOnLegendToggle`,`WithCompositionLegend`,`CurveTypes`,`ErrorStates`,`FillOpacity`,`WithStroke`,`GridVisibility`,`CustomTooltip`,`NegativeValues`,`MismatchedXDomains`]}));ut();export{U as Animation,H as AspectRatio,K as CurveTypes,Z as CustomTooltip,F as Default,q as ErrorStates,J as FillOpacity,V as FixedDimensions,X as GridVisibility,z as LinearLines,$ as MismatchedXDomains,Q as NegativeValues,L as PercentageStack,W as RescaleYOnLegendToggle,B as SingleSeries,R as Streamgraph,I as Unstacked,G as WithCompositionLegend,Y as WithStroke,lt as __namedExportsOrder,N as default,ut as n,j as t};