import{n as e}from"./chunk-zsgVPwQN.js";import{Vn as t,Wn as n,kh as r}from"./iframe-DMJfqbFe.js";import{c as i,n as a,o,r as s,s as c,t as l}from"./chart-decorator-D34dWHdz.js";import{n as u,r as d}from"./legend-config-tJy46Dt1.js";import{c as f,h as p}from"./sample-data-BfcHm5eo.js";import{n as m,t as h}from"./pie-semi-circle-chart-LjNbt07L.js";var g,_,v,y,b,x,S,C,w,T,E,D,O;e((()=>{n(),a(),u(),f(),o(),h(),g=r(),_={Windows:`🪟`,MacOS:`🍎`,Linux:`🐧`,Other:`🖥️`},v=e=>_[e]||`📊`,y={title:`JS Packages/Charts Library/Charts/Pie Semi Circle Chart/Tooltips`,component:m,parameters:{layout:`centered`},decorators:[l],argTypes:{...s,...i,...d,width:{control:{type:`range`,min:100,max:1e3,step:10}},thickness:{control:{type:`range`,min:0,max:1,step:.01}}}},b=e=>(0,g.jsx)(m,{...e}),x={...c,data:p,withTooltips:!0,label:`OS Usage`,note:`Q4 2023`},S=b.bind({}),S.args={...x},S.parameters={docs:{description:{story:`Default semi-circle pie chart with tooltips enabled using the built-in BaseTooltip component.`}}},C=b.bind({}),C.args={...x,withTooltips:!1},C.parameters={docs:{description:{story:`Semi-circle pie chart with tooltips disabled.`}}},w=b.bind({}),w.args={...x,renderTooltip:({tooltipData:e})=>(0,g.jsxs)(`div`,{style:{backgroundColor:`#1a1a2e`,color:`#eaeaea`,padding:`12px 16px`,borderRadius:`8px`,boxShadow:`0 4px 12px rgba(0, 0, 0, 0.3)`,minWidth:`150px`},children:[(0,g.jsx)(`div`,{style:{fontSize:`16px`,fontWeight:`bold`,marginBottom:`8px`,borderBottom:`1px solid #333`,paddingBottom:`8px`},children:e.label}),(0,g.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`4px`},children:[(0,g.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,g.jsx)(`span`,{style:{color:`#888`},children:`Value:`}),(0,g.jsx)(`span`,{style:{fontWeight:`bold`},children:t(e.value)})]}),(0,g.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,g.jsx)(`span`,{style:{color:`#888`},children:`Percentage:`}),(0,g.jsxs)(`span`,{style:{fontWeight:`bold`,color:`#4ade80`},children:[e.percentage,`%`]})]})]})]})},w.parameters={docs:{description:{story:`Custom tooltip rendering using the \`renderTooltip\` prop. This example demonstrates a dark-themed tooltip with styled layout.
