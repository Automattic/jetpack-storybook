import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Uu as ee,ju as i,t as a,vc as o,wc as te}from"./build-module-2iv4IIRq.js";import{Et as s}from"./build-module-l8c-_EUg2.js";import{Ot as c,m as l,mn as ne}from"./hooks-D2-uOzcc.js";import{t as re}from"./src-Dg9rrzZN.js";import{$t as u,W as ie,t as d}from"./src-0ge7d6kt.js";import"./constants-B1kGztHF.js";import{r as ae,t as oe}from"./leaderboard-skeleton-CDMNyzgV.js";import{i as f,r as p,t as m}from"./register-report-mocks-DAHzORiq.js";import{S as h,g as se,v as ce}from"./report-metric--Et_iyvv.js";import{t as g}from"./widget-state-BlFCjv4l.js";import{t as _}from"./src-Ddik3icB.js";import{a as v,d as y,f as b,h as x,i as S,m as C,n as le,p as ue,r as w,u as de}from"./with-widget-canvas-q45aoI9y.js";var T,E,D,O=e((()=>{T=`_root_19tfr_1`,E=`_content_19tfr_9`,D={root:T,content:E}}));function k(){let{rows:e,isLoading:n,isFetching:r,isError:i,error:a,refetch:o}=ie({group:`posts`,max:10}),l=(0,ee.useMemo)(()=>{let t=Math.max(...e.map(e=>e.value),0);return e.map(e=>({id:e.id,label:(0,j.jsx)(se,{id:e.postId,label:e.label,link:e.link,origin:{report:`comments`,section:`posts`}}),currentValue:e.value,currentShare:ne(e.value,t)}))},[e]);return(0,j.jsxs)(s,{className:D.root,children:[(0,j.jsx)(`div`,{className:D.content,children:(0,j.jsx)(g,{isLoading:n,isFetching:r,isError:i,isEmpty:e.length===0,error:c(a,{retryDescription:t(`We couldn't load commented posts. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:o}),empty:{icon:te,description:t(`None of your posts or pages have comments yet.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,j.jsx)(oe,{rows:10}),children:(0,j.jsx)(ae,{data:l,withOverlayLabel:!0,showLegend:!1,dataFormat:M})})}),(0,j.jsx)(h,{children:(0,j.jsx)(ce,{report:`comments`,section:`posts`,ariaLabel:t(`See the commented posts report`,`jetpack-premium-analytics-pkg`)})})]})}function A({attributes:e={}}){return(0,j.jsx)(l,{attributes:e,children:(0,j.jsx)(k,{})})}var j,M,N=e((()=>{d(),_(),i(),n(),a(),re(),O(),j=r(),M={type:`number`,options:{useMultipliers:!0,decimals:0}}})),P,F=e((()=>{a(),P={icon:o,attributes:[],example:{attributes:{}}}})),I,L,R,z,B,V,H,fe=e((()=>{I=`jpa/most-commented-posts`,L=`All-time most commented posts`,R=`The posts and pages that receive the most comments.`,z={content:`The posts and pages that received the most comments.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},B=`stats`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function U(){return(0,W.jsx)(A,{attributes:{reportParams:u()}})}function pe(e){return(0,W.jsx)(y,{...e,widgetType:S(H,P),renderModule:G,renderComponent:A,attributes:{reportParams:u(!0)}})}var W,G,K,q,J,Y,X,Z,Q,$;e((()=>{d(),b(),v(),C(),le(),p(),N(),F(),fe(),W=r(),f(),G=`storybook/most-commented-posts`,K={title:`Packages/Premium Analytics/Widgets/MostCommentedPosts`,component:A,tags:[`autodocs`],parameters:{docs:{description:{component:`The "All-time most commented posts" widget. Ranks the posts and pages that receive the most comments, linking each row to the published post. One half of the Jetpack Stats Comments module; "All-time most commented authors" covers the other.`}}}},q={render:U,decorators:[w,x]},J={render:U,tags:[`!autodocs`],decorators:[w,x],beforeEach:m(`loading`)},Y={render:U,tags:[`!autodocs`],decorators:[w,x],beforeEach:m(`error`)},X={render:U,tags:[`!autodocs`],decorators:[w,x],beforeEach:m(`error-retryable`)},Z={render:U,tags:[`!autodocs`],decorators:[w,x],beforeEach:m(`empty`)},Q={render:e=>(0,W.jsx)(pe,{...e}),args:{...de},argTypes:{...ue},decorators:[x]},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
