import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{n as o,ui as s}from"./build-module-CDRs4YxF.js";import{K as c,X as l,et as u,g as d,q as f}from"./report-metric-Ca_kXAW3.js";import{d as p,t as m}from"./src-Cvyt29m2.js";import{H as h,t as g}from"./src-HOdOyzOs.js";import{Cr as ee,Tt as te,an as _}from"./chart-tooltip-BQsM5vre.js";import{t as v}from"./widget-state-CXHVbl5s.js";import{C as y,D as b,E as x,S,T as ne,b as C,t as w,w as T,x as E}from"./src-C9i3aD_R.js";function D(e){return ee(e).map((e,t)=>({id:e.subscription_id??`row-${t}`,name:e.label,avatarUrl:e.icon,href:e.link,secondaryText:h(e.date_subscribed)}))}function O({attributes:e}){let{data:t,isLoading:n,isFetching:i,isError:a,refetch:o}=_({type:`all`,max:e?.max&&e.max>0?e.max:6}),s=t,c=(0,A.useMemo)(()=>D(s),[s]),l=Number(s?.summary?.total??0),u=Math.max(l-c.length,0);return(0,j.jsx)(v,{isLoading:n,isFetching:i,isError:c.length===0&&a,isEmpty:c.length===0,error:{description:r(`We couldn't load subscribers. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:o}]},empty:{icon:p,description:r(`No subscribers yet.`,`jetpack-premium-analytics-pkg`)},children:(0,j.jsx)(M,{items:c,moreCount:u})})}function k({attributes:e={}}){return(0,j.jsx)(u,{attributes:e,children:(0,j.jsx)(O,{attributes:e})})}var A,j,M,N=t((()=>{te(),g(),m(),w(),i(),A=e(n(),1),j=a(),M=({items:e=[],moreCount:t=0})=>(0,j.jsx)(`div`,{children:(0,j.jsx)(d,{items:e,moreCount:t})})})),P,F=t((()=>{i(),o(),P={icon:s,attributes:[{id:`max`,label:r(`Number of results`,`jetpack-premium-analytics-pkg`),type:`integer`}],example:{attributes:{max:6}}}})),I,L,R,z,B,V,H,U=t((()=>{I=`jpa/subscribers-list`,L=`Latest subscribers`,R=`Your most recent subscribers.`,z={content:`Your most recent subscribers.`},B=`subscribers`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function W(e){return(0,G.jsx)(k,{attributes:{max:e}})}var G,K,q,J,Y,X,Z,Q,$;t((()=>{x(),y(),C(),c(),N(),F(),U(),G=a(),f(),K=`storybook/subscribers-list`,q={title:`Packages/Premium Analytics/Widgets/SubscribersList`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:'Dashboard widget listing the most recent subscribers (avatar + name + relative "since" time) with an "N more" footer. Data comes from the designated `useStatsFollowers` hook; in Storybook it is served by `registerReportMocks`.'}}}},J={render:()=>(0,G.jsx)(k,{attributes:{max:6}}),decorators:[E]},Y={render:()=>W(5),tags:[`!autodocs`],decorators:[E],beforeEach:()=>(l(`stats/followers`,`loading`),()=>l(`stats/followers`,null))},X={render:()=>W(7),tags:[`!autodocs`],decorators:[E],beforeEach:()=>(l(`stats/followers`,`error`),()=>l(`stats/followers`,null))},Z={render:()=>W(8),tags:[`!autodocs`],decorators:[E],beforeEach:()=>(l(`stats/followers`,`empty`),()=>l(`stats/followers`,null))},Q={render:e=>(0,G.jsx)(ne,{...e,widgetType:S(H,P),renderModule:K,renderComponent:k,attributes:{max:6}}),args:{...T},argTypes:{...b}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
