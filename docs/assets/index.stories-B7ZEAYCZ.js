import{n as e,o as t}from"./chunk-zsgVPwQN.js";import{Ar as n,Mh as r,Mm as i,Qm as a,Xm as o,Zm as s,dm as c,fi as l,qm as u,uh as d}from"./iframe-CG9UaxFr.js";import{a as f,t as p}from"./shared-extension-utils-CymvLKt5.js";var m,h=e((()=>{m={"message-box-control":`_message-box-control_pregs_90`}}));function g({label:e=b(),placeholder:t=y(),message:n=``,onChange:r,disabled:i,maxLength:o,analyticsData:s=null}){let{recordEvent:c}=f(),u=(0,_.useRef)(!0),p=o-n.length;return(0,v.jsx)(l,{value:n,label:e,onChange:(0,_.useCallback)(e=>{r(e),u.current&&=(c(`jetpack_social_custom_message_changed`,s),!1)},[s,u,r,c]),disabled:i,maxLength:o,placeholder:t,rows:4,help:d(a(`%d character remaining`,`%d characters remaining`,p,`jetpack-publicize-pkg`),p),__nextHasNoMarginBottom:!0,className:m[`message-box-control`]})}var _,v,y,b,x=e((()=>{p(),n(),o(),_=t(r()),h(),v=u(),y=()=>s(`Write a custom message for your social audience here. This message will override your social post content.`,`jetpack-publicize-pkg`),b=()=>s(`Message`,`jetpack-publicize-pkg`)})),S,C,w,T,E,D,O,k,A;e((()=>{c(),x(),S=u(),C={title:`Packages/Publicize/Message Box Control`,component:g,argTypes:{onChange:{action:`changed`},maxLength:{control:{type:`number`,min:10,max:500}},disabled:{control:`boolean`},analyticsData:{control:`object`},label:{control:`text`},placeholder:{control:`text`}}},w=e=>{let[t,n]=(0,i.useState)(e.message);return(0,S.jsx)(g,{message:t,onChange:(0,i.useCallback)(t=>{n(t),e.onChange(t)},[e]),disabled:e.disabled,maxLength:e.maxLength,analyticsData:e.analyticsData,label:e.label,placeholder:e.placeholder})},T={message:`Check out my latest blog post!`,maxLength:280,disabled:!1,analyticsData:{location:`storybook`}},E=w.bind({}),E.args=T,D=w.bind({}),D.args={...T,message:``},O=w.bind({}),O.args={...T,disabled:!0},k=w.bind({}),k.args={...T,message:``,label:`Custom Social Message`,placeholder:`Type your personalized social media post here...`},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`(args: MessageBoxControlProps) => {
