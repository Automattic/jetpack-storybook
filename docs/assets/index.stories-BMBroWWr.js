import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{Ah as r,Hn as i,Mh as a,Nh as o,Wn as s,jh as c,kh as l,mg as u}from"./iframe-DMJfqbFe.js";import{A as ee,_ as d,a as te,d as ne,f as re,g as f,h as ie,i as p,m as ae,n as oe,p as se,r as ce,t as le,y as ue}from"./providers-d6nT8pAp.js";import{T as de,d as fe,f as pe,n as me,p as he,r as ge,s as _e,t as m}from"./esm-sW2__4Yf.js";import{a as ve,c as ye,d as be,f as xe,i as Se,l as Ce,o as we,p as h,s as Te,u as Ee}from"./line-chart-CiM3N9-l.js";import{c as De,n as Oe,o as ke,r as Ae,s as je,t as Me}from"./chart-decorator-D34dWHdz.js";import{n as Ne,r as Pe,t as Fe}from"./legend-config-tJy46Dt1.js";import{n as Ie,t as g}from"./tooltip-config-DU_WVmuX.js";import{b as Le,c as Re,y as _}from"./sample-data-BfcHm5eo.js";import{t as ze}from"./stories-DCPyb4lt.js";import{c as Be,d as v,i as Ve,l as He,n as Ue,p as We,r as Ge,s as Ke,t as qe}from"./chart-layout-DxKW3drX.js";import{n as Je,r as Ye,t as Xe}from"./tooltip-BGPZJQmq.js";import{n as Ze,t as Qe}from"./svg-empty-state-C1oA9zOG.js";import{n as y,t as b}from"./with-responsive-D7O2XQ7E.js";import{t as $e}from"./line-chart-Ck1Gksz6.js";var et,x,tt=e((()=>{et=`_rise_sezj1_1`,x={"area-chart":`_area-chart_sezj1_1`,"area-chart--animated":`_area-chart--animated_sezj1_4`,rise:et}})),nt,rt=e((()=>{a(),nt=e=>!e?.length||e.some(e=>!e.data?.length)?o(`No data available`,`jetpack-charts`):e.some(e=>e.data.some(e=>isNaN(e.value)||e.value===null||e.value===void 0||`date`in e&&e.date&&isNaN(e.date.getTime())))?o(`Invalid data`,`jetpack-charts`):null})),S,C,it,at,ot=e((()=>{m(),S=t(u(),1),C=l(),it=({chartRef:e,width:t,height:n,margin:r})=>{let i=(0,S.useContext)(de);return(0,S.useImperativeHandle)(e,()=>({getScales:()=>!i?.xScale||!i?.yScale?null:{xScale:i.xScale,yScale:i.yScale},getChartDimensions:()=>({width:t,height:n,margin:r||{}})}),[i,t,n,r]),null},at=({visibleSeries:e,stacked:t,stackOffset:n,getElementStyles:r,strokeColor:i})=>{let a=(0,S.useContext)(de),o=(0,S.useContext)(fe),s=a?.xScale,c=a?.yScale,l=o?.tooltipOpen,u=o?.tooltipData?.nearestDatum?.datum;if(!l||!s||!c||!u||!u.date||t&&n!==`none`)return null;let ee=Number(s(u.date));if(!Number.isFinite(ee))return null;let d=u.date.getTime(),te=0,ne=[];for(let{series:n,index:a}of e){let e=n.data.find(e=>e.date?.getTime()===d),o=e?.value??0;if(t&&(te+=o),!e||e.value==null)continue;let s=Number(c(t?te:o));if(!Number.isFinite(s))continue;let{color:l}=r({data:n,index:a});ne.push((0,C.jsx)(`circle`,{cx:ee,cy:s,r:4,fill:l,stroke:i,strokeWidth:1.5,paintOrder:`fill`,"data-testid":`area-chart-hover-glyph-${a}`},n.label||a))}return ne.length===0?null:(0,C.jsx)(`g`,{pointerEvents:`none`,className:`area-chart__hover-glyphs`,children:ne})}})),st=e((()=>{rt(),ot()})),w,T,E,D,O,ct=e((()=>{s(),m(),a(),c(),w=t(u(),1),Ke(),Xe(),p(),le(),ue(),$e(),Ge(),qe(),v(),Qe(),h(),b(),ye(),tt(),st(),T=l(),E=(0,w.forwardRef)(({data:e,chartId:t,width:n,height:a,className:s,margin:c,withTooltips:l=!0,withTooltipCrosshairs:u,showLegend:ee=!1,legend:d={},stacked:f=!0,stackOffset:p=`none`,smoothing:le=!0,curveType:ue,fillOpacity:de,withStroke:fe,renderTooltip:m=Se,animation:ye,options:h={},onPointerDown:De,onPointerUp:Oe,onPointerMove:ke,onPointerOut:Ae,zoomable:je=!1,rescaleYOnLegendToggle:Me=!0,children:Ne,gridVisibility:Pe,gap:Fe=`md`},Ie)=>{let g=d.interactive??!1,Le=d.shape??`rect`,Re=d.position??`bottom`,_=oe(),ze=se(e),v=ae(t),Ge=(0,w.useRef)(null),[Ke,qe]=(0,w.useState)(void 0),[Xe,Qe]=(0,w.useState)(!1),y=(0,w.useRef)(null),b=Ce({enabled:je,chartRef:y,userHandlers:{onPointerDown:De,onPointerMove:ke,onPointerUp:Oe}}),{legendChildren:$e,nonLegendChildren:et}=Ve(Ne,`AreaChart`),[tt,rt]=(0,w.useState)(),S=(0,w.useCallback)(e=>{rt(e>0?e:a)},[a]);(0,w.useImperativeHandle)(Ie,()=>({getScales:()=>y.current?.getScales()||null,getChartDimensions:()=>y.current?.getChartDimensions()||{width:0,height:0,margin:{}}}),[y]);let C=re(e),{getElementStyles:ot,isSeriesVisible:st}=ie(),E=(0,w.useMemo)(()=>!v||!g?C.map((e,t)=>({series:e,index:t,isVisible:!0})):C.map((e,t)=>({series:e,index:t,isVisible:st(v,e.label)})),[C,v,st,g]),D=(0,w.useMemo)(()=>E.every(({isVisible:e})=>!e),[E]),{tooltipRef:O,onChartFocus:ct,onChartBlur:k,onChartKeyDown:A}=Ye({selectedIndex:Ke,setSelectedIndex:qe,isNavigating:Xe,setIsNavigating:Qe,chartRef:Ge,totalPoints:C[0]?.data.length||0}),lt=(0,w.useMemo)(()=>{if(Me||!g||!C.length||!C[0].data.length||f&&p!==`none`)return;if(f){let e=Math.max(...C.map(e=>e.data.length)),t=0,n=0;for(let r=0;r<e;r++){let e=0,i=0;for(let t of C){let n=Number(t.data[r]?.value);Number.isNaN(n)||(n>=0?e+=n:i+=n)}e>t&&(t=e),i<n&&(n=i)}return[n,t]}let e=-1/0,t=1/0;for(let n of C)for(let r of n.data){let n=Number(r?.value);Number.isNaN(n)||(n>e&&(e=n),n<t&&(t=n))}if(e!==-1/0)return[Math.min(0,t),e]},[C,f,p,g,Me]),j=(0,w.useMemo)(()=>{let e=h?.axis?.x?.tickFormat||be(C);return{axis:{x:{orientation:`bottom`,numTicks:xe(C,n,e),tickFormat:e,display:!0,...h?.axis?.x},y:{orientation:`left`,numTicks:4,tickFormat:i,display:!0,...h?.axis?.y}},xScale:{type:`time`,...h?.xScale,...b.domain?{domain:b.domain}:{}},yScale:{type:`linear`,nice:!0,zero:f,...lt?{domain:lt}:{},...h?.yScale}}},[h,C,n,f,lt,b.domain]),M=ne(a,j,C,ze),N=nt(C),P=!N;ce({chartId:v,legendItems:Be(C,(0,w.useMemo)(()=>({withGlyph:!1,glyphSize:0}),[]),Le),chartType:`area`,isDataValid:P,metadata:(0,w.useMemo)(()=>({stacked:f,stackOffset:p,smoothing:le,curveType:ue}),[f,p,le,ue])});let F=te(),I=!!ye&&!F,L={xAccessor:e=>e?.date,yAccessor:e=>e?.value},R=(0,w.useCallback)(()=>0,[]),z=(0,w.useMemo)(()=>new Set(E.filter(e=>e.isVisible).map(e=>e.series.label)),[E]),B=(0,w.useCallback)(e=>{if(!g)return m(e);let t=e?.tooltipData?.datumByKey;if(!t)return m(e);let n=Object.fromEntries(Object.entries(t).filter(([e])=>z.has(e)));if(Object.keys(n).length===0)return null;let r=e?.tooltipData?.nearestDatum,i=r&&z.has(r.key)?r:{...Object.values(n)[0],distance:r?.distance??0};return m({...e,tooltipData:{...e.tooltipData,datumByKey:n,nearestDatum:i}})},[m,g,z]),V=de??(f?.85:.4),H=fe??!f;if(N)return(0,T.jsx)(`div`,{className:r(`area-chart`,x[`area-chart`]),children:N});let U=ee&&(0,T.jsx)(He,{orientation:d.orientation??`horizontal`,alignment:d.alignment??`center`,position:Re,labelStyles:d.labelStyles,itemClassName:d.itemClassName,itemStyles:d.itemStyles,shapeStyles:d.shapeStyles,className:x[`area-chart__legend`],shape:Le,chartId:v,interactive:g}),W=E.filter(({isVisible:e})=>e),G=Ee(ue,le),K=({series:e,index:t,isVisible:n})=>{let{color:r,lineStyles:i}=ot({data:e,index:t});return(0,T.jsx)(ge,{dataKey:e?.label,data:e.data,xAccessor:L.xAccessor,yAccessor:n||!g?L.yAccessor:R,fill:r,fillOpacity:V,...f?{}:{renderLine:H,curve:G},lineProps:{stroke:r,...i},"data-testid":`area-chart-series-${t}`},e?.label||t)};return(0,T.jsx)(We.Provider,{value:{chartId:v,chartRef:y,chartWidth:n,chartHeight:tt||0},children:(0,T.jsx)(Ue,{legendPosition:Re,legendElement:U,legendChildren:$e,gap:Fe,className:r(`area-chart`,x[`area-chart`],{[x[`area-chart--animated`]]:I},s),style:{width:n,height:a},"data-testid":`area-chart`,trailingContent:et,onContentHeightChange:S,children:({contentHeight:e})=>{let t=e>0?e:a;return(0,T.jsx)(`div`,{role:`grid`,"aria-label":o(`Area chart`,`jetpack-charts`),tabIndex:0,onKeyDown:A,onFocus:ct,onBlur:k,children:t>0&&(0,T.jsxs)(`div`,{ref:Ge,style:{position:`relative`},children:[je&&b.domain&&(0,T.jsx)(we,{onClick:b.reset}),(0,T.jsxs)(_e,{theme:ze,width:n,height:t,margin:{...M,...c},xScale:j.xScale,yScale:j.yScale,onPointerDown:b.handlers.onPointerDown,onPointerUp:b.handlers.onPointerUp,onPointerMove:b.handlers.onPointerMove,onPointerOut:Ae,pointerEventsDataKey:`nearest`,children:[Pe!==`none`&&(0,T.jsx)(pe,{columns:!1,numTicks:4}),j.axis.x.display&&(0,T.jsx)(he,{...j.axis.x}),j.axis.y.display&&(0,T.jsx)(he,{...j.axis.y}),D?(0,T.jsx)(Ze,{x:n/2,y:t/2,width:n,height:t,children:o(`All series are hidden. Click legend items to show data.`,`jetpack-charts`)}):null,(0,T.jsxs)(ve,{active:je,chartId:v,children:[!D&&f&&(0,T.jsx)(me,{curve:G,offset:p,renderLine:H,children:E.map(K)}),!D&&!f&&E.map(K)]}),l&&(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(Je,{detectBounds:!0,snapTooltipToDatumX:!0,snapTooltipToDatumY:!f,renderTooltip:B,showVerticalCrosshair:u?.showVertical,showHorizontalCrosshair:u?.showHorizontal,selectedIndex:Ke,tooltipRef:O,keyboardFocusedClassName:x[`area-chart__tooltip--keyboard-focused`],series:C}),(0,T.jsx)(at,{visibleSeries:W,stacked:f,stackOffset:p,getElementStyles:ot,strokeColor:_.backgroundColor})]}),(0,T.jsx)(it,{chartRef:y,width:n,height:a||t,margin:c}),je&&(0,T.jsx)(Te,{drag:b.drag})]})]})})}})})}),D=(0,w.forwardRef)((e,t)=>(0,w.useContext)(f)?(0,T.jsx)(E,{...e,ref:t}):(0,T.jsx)(d,{children:(0,T.jsx)(E,{...e,ref:t})})),D.displayName=`AreaChart`,ee(D,{Legend:He}),O=ee(y(D),{Legend:He})})),k,A,lt=e((()=>{Oe(),Ne(),Re(),ke(),g(),ct(),k={title:`JS Packages/Charts Library/Charts/Area Chart`,component:O,parameters:{layout:`centered`},decorators:[Me],argTypes:{...Pe,...De,...Ae,...Ie,data:{control:{type:`object`},description:`Array of series data to display in the chart`,table:{category:`Data`}}}},A={...je,data:_.slice(0,4),stacked:!0,stackOffset:`none`,smoothing:!0,maxWidth:1200,resizeDebounceTime:300,options:{axis:{x:{orientation:`bottom`},y:{orientation:`left`}}},withTooltips:!0}})),j=n({Animation:()=>U,AspectRatio:()=>H,CurveTypes:()=>K,CustomTooltip:()=>Z,Default:()=>F,ErrorStates:()=>q,FillOpacity:()=>J,FixedDimensions:()=>V,GridVisibility:()=>X,LinearLines:()=>z,MismatchedXDomains:()=>$,NegativeValues:()=>Q,PercentageStack:()=>L,RescaleYOnLegendToggle:()=>W,SingleSeries:()=>B,Streamgraph:()=>R,Unstacked:()=>I,WithCompositionLegend:()=>G,WithStroke:()=>Y,__namedExportsOrder:()=>ut,default:()=>N}),M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,ut,dt=e((()=>{ze(),ct(),lt(),M=l(),N={...k,title:`JS Packages/Charts Library/Charts/Area Chart`,component:k.component,argTypes:{...k.argTypes,seriesCount:{control:{type:`radio`},options:[`single`,`multiple`,`many`],description:`Number of data series`,table:{category:`Data`}},dimensionMode:{control:{type:`radio`},options:[`responsive`,`fixed`],description:`Chart sizing mode`,table:{category:`Dimensions`}},stacked:{control:`boolean`,description:`Stack series on top of each other`,table:{category:`Visual Style`}},stackOffset:{control:{type:`radio`},options:[`none`,`expand`,`wiggle`,`silhouette`],description:`Stack offset strategy (only applies when stacked is true)`,table:{category:`Visual Style`}},smoothing:{control:`boolean`,description:`Enable curve smoothing`,table:{category:`Visual Style`}},curveType:{control:{type:`radio`},options:[`linear`,`smooth`,`monotone`],description:`Curve interpolation type`,table:{category:`Visual Style`}},fillOpacity:{control:{type:`range`,min:0,max:1,step:.05},description:`Fill opacity for the areas (0–1)`,table:{category:`Visual Style`}},withStroke:{control:`boolean`,description:`Render a stroke (line) on top of each area`,table:{category:`Visual Style`}}}},P=e=>{let{seriesCount:t,dimensionMode:n,crosshairMode:r,withTooltipCrosshairs:i,...a}=e,o=Fe(e),s=a.data||A.data;t===`single`?s=[_[0]]:t===`multiple`?s=_.slice(0,4):t===`many`&&(s=_);let c={};n===`fixed`&&(c={width:800,height:400});let l;return r===`vertical`?l={showVertical:!0}:r===`horizontal`?l={showHorizontal:!0}:r===`both`&&(l={showVertical:!0,showHorizontal:!0}),(0,M.jsx)(O,{...a,...c,data:s,legend:o,withTooltipCrosshairs:l})},F=P.bind({}),F.args={...A,showLegend:!0,zoomable:!0},I=P.bind({}),I.args={...A,stacked:!1,showLegend:!0},I.parameters={docs:{description:{story:"When `stacked={ false }`, series are rendered as overlapping filled areas. Use `fillOpacity` to control transparency so overlapping series remain visible."}}},L=P.bind({}),L.args={...A,stacked:!0,stackOffset:`expand`,showLegend:!0},L.parameters={docs:{description:{story:'`stackOffset="expand"` produces a 100% stacked area chart — each x-position is normalised to 1.0, useful for showing relative composition over time.'}}},R=P.bind({}),R.args={...A,stacked:!0,stackOffset:`wiggle`,showLegend:!0,smoothing:!0},R.parameters={docs:{description:{story:'`stackOffset="wiggle"` produces a streamgraph layout. Each series flows around a central baseline, minimising weighted change in slope.'}}},z=P.bind({}),z.args={...A,curveType:`linear`,smoothing:!1,showLegend:!0},z.parameters={docs:{description:{story:'Stacked area chart with straight (linear) edges between data points. Use `curveType="linear"` (or `smoothing={ false }`) when you want a precise, unsmoothed visualisation.'}}},B=P.bind({}),B.args={...A,data:[Le[0]]},V=P.bind({}),V.args={...A,width:600,height:300,showLegend:!0},H=P.bind({}),H.args={...A,aspectRatio:.3,showLegend:!0},U=P.bind({}),U.args={...A,animation:!0,showLegend:!0,legendInteractive:!0},W={name:`Y-axis rescales when legends toggle (default)`,render:e=>(0,M.jsxs)(`div`,{style:{display:`grid`,gap:`2rem`,gridTemplateColumns:`repeat(2, 1fr)`},children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h4`,{children:`rescaleYOnLegendToggle: true (default)`}),(0,M.jsx)(O,{...e,rescaleYOnLegendToggle:!0})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h4`,{children:`rescaleYOnLegendToggle: false (pinned)`}),(0,M.jsx)(O,{...e,rescaleYOnLegendToggle:!1})]})]}),args:{...A,showLegend:!0,legend:{interactive:!0},width:480,height:280},parameters:{docs:{description:{story:`Click legend items to toggle series. The left chart rescales the Y axis to the visible series; the right chart pins the Y axis to the full data extent so the baseline stays put.`}}}},G={render:e=>{let t=Fe(e);return(0,M.jsx)(O,{...F.args,...e,legend:{interactive:t?.interactive},chartId:`composition-area-chart`,children:(0,M.jsx)(O.Legend,{...t})})},args:{...F.args},parameters:{docs:{description:{story:"Composition API using `<AreaChart.Legend />` as a child component for explicit legend placement and configuration."}}}},K={render:()=>{let e=_.slice(0,3);return(0,M.jsxs)(`div`,{style:{display:`grid`,gap:`2rem`,gridTemplateColumns:`repeat(3, 1fr)`},children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Linear`}),(0,M.jsx)(O,{width:300,height:200,data:e,curveType:`linear`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Smooth (Catmull-Rom)`}),(0,M.jsx)(O,{width:300,height:200,data:e,curveType:`smooth`})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Monotone X`}),(0,M.jsx)(O,{width:300,height:200,data:e,curveType:`monotone`})]})]})},parameters:{docs:{description:{story:"The three available curve types. `linear` connects points with straight lines; `smooth` uses Catmull-Rom interpolation; `monotone` prevents overshooting on steep changes."}}}},q={render:()=>(0,M.jsxs)(`div`,{style:{display:`grid`,gap:`2rem`,gridTemplateColumns:`repeat(2, 1fr)`},children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Empty Data`}),(0,M.jsx)(O,{width:300,height:200,data:[]})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Invalid Date Values`}),(0,M.jsx)(O,{width:300,height:200,data:[{label:`Invalid Dates`,data:[{date:new Date(`invalid`),value:10},{date:new Date(`2024-01-02`),value:20}]}]})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Invalid Values`}),(0,M.jsx)(O,{width:300,height:200,data:[{label:`Invalid Values`,data:[{date:new Date(`2024-01-01`),value:NaN},{date:new Date(`2024-01-02`),value:null}]}]})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Single Data Point`}),(0,M.jsx)(O,{width:300,height:200,data:[{label:`Single Point`,data:[{date:new Date(`2024-01-01`),value:100}]}]})]})]}),parameters:{docs:{description:{story:`How the area chart handles common edge cases.`}}}},J=P.bind({}),J.args={...A,fillOpacity:.5,showLegend:!0},J.parameters={docs:{description:{story:"Use `fillOpacity` to control how transparent the bands are. Defaults: `0.85` for stacked, `0.4` for unstacked."}}},Y=P.bind({}),Y.args={...A,withStroke:!0,showLegend:!0},Y.parameters={docs:{description:{story:"`withStroke={ true }` renders a stroke on top of each band. By default, stroke is off in stacked mode and on in unstacked mode."}}},X={render:()=>{let e=_.slice(0,3);return(0,M.jsxs)(`div`,{style:{display:`grid`,gap:`2rem`,gridTemplateColumns:`repeat(2, 1fr)`},children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`Default grid`}),(0,M.jsx)(O,{width:400,height:240,data:e})]}),(0,M.jsxs)(`div`,{children:[(0,M.jsx)(`h3`,{children:`gridVisibility="none"`}),(0,M.jsx)(O,{width:400,height:240,data:e,gridVisibility:`none`})]})]})},parameters:{docs:{description:{story:'`gridVisibility` controls grid rendering. Use `"none"` for compact / inline visualisations like sparkline-style cards.'}}}},Z=P.bind({}),Z.args={...A,showLegend:!0,renderTooltip:({tooltipData:e})=>{let t=e?.nearestDatum?.datum;if(!t)return null;let n=Object.entries(e?.datumByKey||{}).map(([e,t])=>({key:e,value:t.datum.value})),r=n.reduce((e,t)=>e+(t.value??0),0);return(0,M.jsxs)(`div`,{style:{padding:8,minWidth:160},children:[(0,M.jsx)(`div`,{style:{fontWeight:600,marginBottom:6},children:t.date?.toLocaleDateString()}),n.map(e=>(0,M.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,M.jsx)(`span`,{children:e.key}),(0,M.jsx)(`strong`,{children:e.value})]},e.key)),(0,M.jsx)(`hr`,{style:{margin:`6px 0`,opacity:.3}}),(0,M.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,M.jsx)(`span`,{children:`Total`}),(0,M.jsx)(`strong`,{children:r})]})]})}},Z.parameters={docs:{description:{story:"`renderTooltip` lets you render any React content inside the tooltip portal. The portal background is theme-driven; do not override it in custom content."}}},Q=P.bind({}),Q.args={...A,showLegend:!0,stacked:!0,stackOffset:`none`,data:[{label:`Inflows`,data:[{date:new Date(`2024-01-01`),value:30},{date:new Date(`2024-02-01`),value:35},{date:new Date(`2024-03-01`),value:50},{date:new Date(`2024-04-01`),value:42},{date:new Date(`2024-05-01`),value:60}]},{label:`Outflows`,data:[{date:new Date(`2024-01-01`),value:-15},{date:new Date(`2024-02-01`),value:-20},{date:new Date(`2024-03-01`),value:-10},{date:new Date(`2024-04-01`),value:-25},{date:new Date(`2024-05-01`),value:-18}]}]},Q.parameters={docs:{description:{story:'Mixed positive/negative values with `stackOffset="none"`. Hover glyphs follow the running total, matching where d3-stack draws the band edges.'}}},$=P.bind({}),$.args={...A,showLegend:!0,data:[{label:`Daily`,data:[{date:new Date(`2024-01-01`),value:10},{date:new Date(`2024-01-02`),value:12},{date:new Date(`2024-01-03`),value:14},{date:new Date(`2024-01-04`),value:16},{date:new Date(`2024-01-05`),value:18}]},{label:`Sparse`,data:[{date:new Date(`2024-01-02`),value:5},{date:new Date(`2024-01-03`),value:8},{date:new Date(`2024-01-04`),value:6}]}]},$.parameters={docs:{description:{story:`Series with non-matching x-domains. d3-stack treats missing values as zero; the hover-glyph overlay matches that convention so subsequent series glyphs stay on the correct stacked edge.`}}},F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`args => {
