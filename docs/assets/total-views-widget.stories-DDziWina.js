import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-DyKOxfM8.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{On as o,n as s}from"./build-module-CDRs4YxF.js";import{Tr as ee,sn as te,t as c}from"./src-BSLPjMFP.js";import{K as l,X as u,et as d,it as ne,q as f}from"./report-metric-Ca_kXAW3.js";import{n as re}from"./sparkline-DcZ1-6wt.js";import{n as p,t as m}from"./src-BZevBsj7.js";import{Tt as h,Xt as ie,hr as g,i as ae,p as oe}from"./chart-tooltip-BQsM5vre.js";import{t as se}from"./widget-state-CXHVbl5s.js";import{C as ce,D as _,E as v,S as le,T as ue,b as de,t as y,w as b,x}from"./src-C9i3aD_R.js";var S,C,w,T,E=t((()=>{S=`_root_lau5r_1`,C=`_body_lau5r_9`,w=`_chart_lau5r_21`,T={root:S,body:C,chart:w}}));function D(){let{reportParams:e}=ne(),{primary:t,isLoading:n,isFetching:i,isError:a,error:s,refetch:c}=ie((0,k.useMemo)(()=>ae({...e,stat_fields:`views,visitors`,period:j}),[e])),l=t.data,u=Number(l?.summary?.views??0),d=p(u,`number`,N),f=p(u,`number`,u>=1e3?M:N),m=(0,k.useMemo)(()=>(l?.data??[]).map(e=>Number(e.views??0)),[l]);return(0,A.jsx)(`div`,{className:T.root,children:(0,A.jsx)(se,{isLoading:n,isFetching:i,isError:a&&m.length===0,isEmpty:m.length===0,error:oe(s,{retryDescription:r(`We couldn't load your views. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}),empty:{icon:o,description:r(`No views in this period.`,`jetpack-premium-analytics-pkg`)},children:(0,A.jsxs)(`div`,{className:T.body,children:[(0,A.jsx)(ee,{variant:`heading-2xl`,title:d,children:f===d?f:(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`span`,{"aria-hidden":`true`,children:f}),(0,A.jsx)(te,{children:d})]})}),(0,A.jsx)(`div`,{className:T.chart,children:(0,A.jsx)(re,{data:m,maxWidth:1/0})})]})})})}function O({attributes:e={},setError:t}){return(0,A.jsx)(d,{attributes:e,setError:t,children:(0,A.jsx)(D,{})})}var k,A,j,M,N,fe=t((()=>{h(),c(),m(),y(),i(),s(),k=e(n(),1),E(),A=a(),j=`day`,M={useMultipliers:!0,decimals:1},N={decimals:0}})),P,pe=t((()=>{s(),P={icon:o}})),F,I,L,R,z,B,V,me=t((()=>{F=`jpa/total-views`,I=`Total views`,L=`Total views for the selected period, with the trend over time.`,R={content:`The total number of times your content was viewed.`,links:[{label:`Learn more`,href:`https://wordpress.com/support/stats/#views`}]},z=`stats`,B=`framed`,V={name:F,title:I,description:L,help:R,category:z,presentation:B}}));function he(){return(0,U.jsx)(O,{attributes:{reportParams:g(!1)}})}function H(e){return(0,U.jsx)(O,{attributes:{reportParams:g(!1,e)}})}function ge(e){return(0,U.jsx)(ue,{...e,widgetType:G,renderModule:W,renderComponent:O,attributes:{reportParams:g(!1)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{h(),l(),v(),ce(),de(),fe(),pe(),me(),U=a(),f(),W=`storybook/total-views`,G=le(V,P),K={title:`Packages/Premium Analytics/Widgets/TotalViews`,component:O,tags:[`autodocs`],parameters:{docs:{description:{component:`The "Total views" card: the selected period's view total as a large figure over an area sparkline of the trend. There is no WithComparison story — the widget strips comparison from its request and renders no delta, so it would be identical to Default.`}}}},q={render:he,decorators:[x]},J={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(u(`stats/visits`,`loading`),()=>u(`stats/visits`,null))},Y={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(u(`stats/visits`,`error`),()=>u(`stats/visits`,null))},X={render:()=>H(`last-12-months`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(u(`stats/visits`,`error-retryable`),()=>u(`stats/visits`,null))},Z={render:()=>H(`last-year`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(u(`stats/visits`,`empty`),()=>u(`stats/visits`,null))},Q={render:e=>(0,U.jsx)(ge,{...e}),args:{...b},argTypes:{..._}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
