import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{Nn as n,n as r}from"./build-module-DmVuor49.js";import{n as i,t as a}from"./build-module-BPJwEiIO.js";import{c as o,t as s}from"./src-DN9VFS2M.js";import{cr as c,yt as l}from"./chart-tooltip-uAa_MJ2w.js";import{F as u,P as d,V as f}from"./report-metric-BOiH0bgT.js";import{C as p,D as m,E as ee,S as te,T as ne,b as re,o as ie,t as ae,w as h,x as g}from"./src-OKsa0p6O.js";import{n as _,t as v}from"./force-stats-mock-state-DgRdXJf3.js";function y({attributes:e={},setError:t}){return(0,b.jsx)(f,{attributes:e,setError:t,options:{from:`/`},children:(0,b.jsx)(ie,{limit:5})})}var b,x=e((()=>{ae(),b=t()})),S,C=e((()=>{r(),S={icon:n}})),w,T,E,D,O,k,A,oe=e((()=>{w=`jpa/top-performing-bookings`,T=`Top performing bookings`,E=`Shows the top booking products by net revenue over the selected time period.`,D={content:`Your best-selling bookings by revenue over the selected time period.`},O=`store`,k=`framed`,A={name:w,title:T,description:E,help:D,category:O,presentation:k}}));function se(e){let t=e.reduce((e,t)=>({total_orders:e.total_orders+Number(t.orders_count),total_quantity:e.total_quantity+Number(t.total_quantity),total_revenue:e.total_revenue+Number(t.product_net_revenue)}),{total_orders:0,total_quantity:0,total_revenue:0});return{data:e,summary:{total_orders:String(t.total_orders),total_products:String(e.length),total_quantity:String(t.total_quantity),total_revenue:t.total_revenue.toFixed(2)}}}function j(e){H||(H=!0,a.use(async(t,n)=>{let r=t.path??t.url??``;return r.startsWith(z)?se(e):r.startsWith(B)?e.map(e=>({id:Number(e.product_id),name:e.product_name,images:[]})):n(t)}))}function M(e=!1,t=W){return{reportParams:c(e,t)}}function N({withComparison:e,preset:t}){let n=!!e,r=t??W;return!n&&r===W?`getDefaultQueryParams()`:n&&r===W?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function P(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
