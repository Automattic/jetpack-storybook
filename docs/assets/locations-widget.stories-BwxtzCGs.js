import{i as e}from"./preload-helper-usAeo7Bx.js";import{f as t,n,r,t as i}from"./build-module-yGZutq_9.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{$i as o,Gu as s,Nu as c,t as l}from"./build-module-zwSmKorH.js";import{gt as ee}from"./build-module-BQz6tjEN.js";import{B as u,C as te,Kt as ne,Ut as re,V as d,Wt as ie,o as ae,wt as oe,y as f}from"./wp-date-settings-b_6QlwyT.js";import{t as p}from"./src-bsXcD7Lb.js";import{t as se}from"./geo-chart-BQOvgQx1.js";import{t as ce}from"./types-BRp4aAtL.js";import{t as m,w as le}from"./src-DFNM1k7F.js";import{n as ue,t as de}from"./src-DlAreFly.js";import{en as h,i as g,tt as _}from"./date-filters-panel-CkyemcRR.js";import"./constants-B1kGztHF.js";import{r as fe}from"./leaderboard-skeleton-DvxkFENC.js";import{G as v,K as y,N as pe,S as b,b as me,w as he}from"./report-metric-Cj-C79CI.js";import{t as ge}from"./widget-state-Bq3Zw4nz.js";import{C as _e,D as ve,E as x,O as ye,S as be,T as xe,b as Se,k as S,t as Ce,w as we,x as C}from"./src-D8zPOCmi.js";import{n as Te,t as Ee}from"./register-stats-mocks-OAUq91QB.js";import{n as De,t as w}from"./force-stats-mock-state-OCDlUraj.js";var T,E,D,O,k,A,j,M,N,P,Oe=e((()=>{T=`_root_mw6wj_1`,E=`_backLink_mw6wj_9`,D=`_content_mw6wj_17`,O=`_bodyHeader_mw6wj_24`,k=`_stateArea_mw6wj_31`,A=`_chartArea_mw6wj_36`,j=`_leaderboardPanel_mw6wj_46`,M=`_leaderboard_mw6wj_46`,N=`_geoChart_mw6wj_62`,P={root:T,backLink:E,content:D,bodyHeader:O,stateArea:k,chartArea:A,leaderboardPanel:j,leaderboard:M,geoChart:N}}));function ke(e){if(!e.countryCode)return null;let t=typeof e.label==`string`?e.label:String(e.label),n=e.countryFull??e.countryCode;return{key:`${e.countryCode}:${t}`,label:t,countryCode:e.countryCode,countryFull:n,value:e.views,previousValue:e.previousViews,region:e.region??``}}function Ae({reportParams:e,max:t,geoMode:n=`country`,countryFilter:r}){let{comparisonRows:i,hasComparison:a,isLoading:o,isFetching:s,hasData:c,isError:l,refetch:ee}=_({...e,geoMode:n,max:t,...r?{filter_by_country:r}:{}},{maxRows:t}),u=(i?.rows??[]).map(ke).filter(e=>e!==null);return{data:u,hasComparison:a,isLoading:o,isFetching:s,hasData:c,isError:u.length===0&&l,refetch:ee}}var je=e((()=>{g()}));function F(e){return e.toUpperCase()===`TW`?`Taiwan`:e.toUpperCase()}function Me(e){let n=e.locations.slice(0,Fe),i=n.map(e=>`${e.label}: ${ue(e.value)}`),a=e.locations.length-n.length;return a>0&&i.push(t(r(`…and %d more location`,`…and %d more locations`,a,`jetpack-premium-analytics-pkg`),a)),i.join(`<br />`)}function Ne({geoGranularity:e}){let{reportParams:r}=te(),[i,a]=(0,s.useState)(()=>new Set(R)),{drillDownItem:o,drillDown:c,resetDrillDown:l}=ae();(0,s.useEffect)(()=>{e!==`country`&&l()},[l,e]);let u=e===`country`?o:void 0,d=e===`country`&&u?`region`:e,{data:f,hasComparison:p,isLoading:m,isFetching:ue,isError:de,refetch:h}=Ae({reportParams:r,max:10,geoMode:d,countryFilter:u?.code}),g=u?.code.toUpperCase(),_=d===`region`&&!!g&&!i.has(g),v=d===`region`&&u&&!_?u:void 0,y=d===`city`||d===`region`&&!u,b=(0,s.useMemo)(()=>{let e=new Map;return y?(f.forEach(t=>{let n=t.countryCode.toUpperCase(),r=e.get(n);e.set(n,{countryFull:t.countryFull,value:(r?.value??0)+t.value,locations:[...r?.locations??[],t]})}),Array.from(e.entries())):[]},[f,y]),me=(0,s.useCallback)(e=>{let t=`${e.message??``} ${e.detailedMessage??``}`,n=!!g&&_,r=!!g&&R.has(g);!n&&!r&&!t.includes(Pe)||(e.id&&typeof window<`u`&&window.google?.visualization?.errors?.removeError?.(e.id),n&&(R.add(g),a(e=>{if(e.has(g))return e;let t=new Set(e);return t.add(g),t})))},[g,_]),_e=(0,s.useMemo)(()=>{let e=[n(_?`Location`:`Country`,`jetpack-premium-analytics-pkg`),n(`Views`,`jetpack-premium-analytics-pkg`)];if(v){let t=v.code.toUpperCase(),n=f.filter(e=>e.countryCode.toUpperCase()===t).reduce((e,t)=>e+t.value,0);return[e,[{v:F(t),f:v.name},n]]}if(y){let t=d===`region`;return[t?[...e,{type:`string`,role:ce.tooltip,p:{html:!0}}]:e,...b.map(([e,n])=>{let r=[{v:F(e),f:n.countryFull},n.value];return t?[...r,Me(n)]:r})]}return[e,...f.map(e=>[e.label,e.value])]},[b,f,v,d,y,_]),ve=(0,s.useMemo)(()=>{let e=ie(f.map(e=>e.value),p?f.map(e=>e.previousValue):[]);return f.map(r=>{let i=oe(r.countryCode),a=r.previousValue,o=r.countryCode;return{id:r.key,...pe({label:r.label,media:{kind:`flag`,url:i??void 0,country:r.countryFull},action:d===`country`&&o?{kind:`drillDown`,onClick:()=>c({code:o,name:r.countryFull}),ariaLabel:t(n(`View regions in %s`,`jetpack-premium-analytics-pkg`),r.countryFull)}:{kind:`static`}}),currentValue:r.value,previousValue:a,currentShare:re(r.value,e),previousShare:p&&a!==void 0?re(a,e):void 0,delta:p&&a!==void 0?ne(r.value,a):void 0}})},[f,d,p,c]),x=u?(0,L.jsx)(he,{label:n(`All locations`,`jetpack-premium-analytics-pkg`),ariaLabel:n(`View all locations`,`jetpack-premium-analytics-pkg`),onClick:l,className:P.backLink}):null,ye=x?(0,L.jsx)(ee,{direction:`row`,align:`center`,className:P.bodyHeader,children:x}):null;return(0,L.jsxs)(`div`,{className:P.content,children:[ye,(0,L.jsx)(`div`,{className:P.stateArea,children:(0,L.jsx)(ge,{isLoading:m,isFetching:ue,isError:de,isEmpty:f.length===0,error:{description:n(`We couldn't load location data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:n(`Retry`,`jetpack-premium-analytics-pkg`),onClick:h}]},empty:{icon:le,description:n(`No location data in this period.`,`jetpack-premium-analytics-pkg`)},children:(0,L.jsxs)(`div`,{className:P.chartArea,children:[(0,L.jsx)(`div`,{className:P.leaderboardPanel,children:(0,L.jsx)(fe,{data:ve,withOverlayLabel:!0,withComparison:p,showLegend:!1,dataFormat:{type:`number`,options:{useMultipliers:!0,decimals:0}},className:P.leaderboard})}),(0,L.jsx)(`div`,{className:P.geoChart,children:(0,L.jsx)(se,{data:_e,resizeDebounceTime:100,region:_?u?.code??`world`:`world`,resolution:_?`provinces`:`countries`,onError:me})})]})})})]})}function I({attributes:e={}}){let t=e?.geoGranularity??B,n=Object.prototype.hasOwnProperty.call(z,t)?t:B;return(0,L.jsx)(f,{attributes:e,children:(0,L.jsxs)(`div`,{className:P.root,children:[(0,L.jsx)(Ne,{geoGranularity:n}),(0,L.jsx)(b,{children:(0,L.jsx)(me,{report:`locations`,section:z[n]})})]})})}var L,Pe,R,z,B,Fe,Ie=e((()=>{Ce(),de(),m(),c(),i(),p(),Oe(),je(),L=a(),Pe=`Requested map does not exist`,R=new Set,z={country:`countries`,region:`regions`,city:`cities`},B=`country`,Fe=10})),Le,Re=e((()=>{i(),l(),u(),Le={icon:o,attributes:[{id:`geoGranularity`,label:n(`View by`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:d,elements:[{label:n(`Countries`,`jetpack-premium-analytics-pkg`),value:`country`},{label:n(`Regions`,`jetpack-premium-analytics-pkg`),value:`region`},{label:n(`Cities`,`jetpack-premium-analytics-pkg`),value:`city`}],relevance:`high`}],example:{attributes:{geoGranularity:`country`}}}})),ze,Be,Ve,He,Ue,We,Ge,Ke=e((()=>{ze=`jpa/locations`,Be=`Top locations`,Ve=`Where your visitors are viewing from — by country, region, or city.`,He={content:`The countries, regions, and cities where your visitors came from, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},Ue=`stats`,We=`framed`,Ge={name:ze,title:Be,description:Ve,help:He,category:Ue,presentation:We}}));function qe({withComparison:e,geoGranularity:t}){return{geoGranularity:t,reportParams:h(e)}}function V(e){return(0,U.jsx)(I,{attributes:qe(e)})}function H(e){return(0,U.jsx)(I,{attributes:{geoGranularity:`country`,reportParams:h(!1,e)}})}function Je(e){return(0,U.jsx)(I,{...e})}function Ye({withComparison:e,geoGranularity:t,...n}){return(0,U.jsx)(xe,{...n,widgetType:W,renderModule:Xe,renderComponent:Je,attributes:qe({withComparison:e,geoGranularity:t})})}var U,Xe,W,Ze,G,K,q,J,Y,X,Z,Q,$;e((()=>{g(),x(),_e(),ye(),Se(),v(),Ee(),De(),Ie(),Re(),Ke(),U=a(),y(),Te(),Xe=`storybook/locations`,W=be(Ge,Le),Ze={title:`Packages/Premium Analytics/Widgets/Locations`,component:I,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},geoGranularity:{control:`radio`,options:[`country`,`region`,`city`],description:`The "View by" toolbar attribute rendered by the widget host.`}},parameters:{docs:{description:{component:"The \"Locations\" widget. Shows visitor views by country, region, or city, with country drill-down into regions, using the global dashboard date range. The Countries/Regions/Cities view is the `geoGranularity` attribute (`relevance: 'high'`), exposed as a control by the widget host."}}}},G={render:V,args:{withComparison:!1,geoGranularity:`country`},decorators:[C,S]},K={render:V,args:{withComparison:!0,geoGranularity:`country`},decorators:[C,S]},q={render:V,args:{withComparison:!1,geoGranularity:`region`},decorators:[C,S]},J={render:V,args:{withComparison:!1,geoGranularity:`city`},decorators:[C,S]},Y={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/location-views`,`loading`),()=>w(`stats/location-views`,null))},X={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/location-views`,`error`),()=>w(`stats/location-views`,null))},Z={render:()=>H(`last-365-days`),tags:[`!autodocs`],decorators:[C,S],beforeEach:()=>(w(`stats/location-views`,`empty`),()=>w(`stats/location-views`,null))},Q={render:e=>(0,U.jsx)(Ye,{...e}),args:{...we,widgetWidth:2,widgetHeight:1,withComparison:!0,geoGranularity:`country`},argTypes:{...ve,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},geoGranularity:{control:`radio`,options:[`country`,`region`,`city`],description:`The "View by" toolbar attribute rendered by the widget host.`}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
