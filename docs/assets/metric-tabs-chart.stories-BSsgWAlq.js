...
}`,...C.parameters?.docs?.source},description:{story:'`tooltipMetrics="all"`: hovering reads out every metric at that date, not only\nthe drawn one, as the WordAds chart does with ads served, CPM and revenue.',...C.parameters?.docs?.description}}},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
...
}`,...E.parameters?.docs?.source},description:{story:`On a short tile the chart degrades to a sparkline — dropping its axis, grid,
and legend — instead of squashing its labels, while the metric cards stay.`,...E.parameters?.docs?.description}}},D=[`Default`,`SingleMetric`,`Bars`,`PairedMetrics`,`PairedMetricsAsBars`,`AllMetricsInTooltip`,`Skeleton`,`SkeletonShortTile`,`Compact`]}))();export{C as AllMetricsInTooltip,b as Bars,E as Compact,v as Default,x as PairedMetrics,S as PairedMetricsAsBars,y as SingleMetric,w as Skeleton,T as SkeletonShortTile,D as __namedExportsOrder,_ as default};