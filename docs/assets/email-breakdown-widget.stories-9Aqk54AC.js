import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n,u as r}from"./build-module-DQ5lAs4a.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{N as a,t as o}from"./build-module-DMs68Vfd.js";import{Ts as s,n as c}from"./build-module-Bt8gOW8e.js";import{Bt as l,Wt as u,b as ee,d,p as f,s as p,y as m}from"./hooks-Cw-H66ea.js";import{t as h,u as g}from"./build-module-BAze1CUO.js";import{n as _,t as te}from"./with-chart-theme-CY4J_8zT.js";import{_ as ne}from"./chart-tooltip-7cDeUVQH.js";import{t as re}from"./leaderboard-chart-C-5XAZ-c.js";import{i as v,n as ie,t as ae}from"./register-report-mocks-BPl_Kj4W.js";import{l as y}from"./report-metric-sv8iUpzH.js";import{t as b}from"./widget-state-D4P9dT61.js";import{i as oe,n as se,r as ce,t as le}from"./widget-dashboard-with-widget-BY2z4b5b.js";import{t as ue}from"./src-C0QqKDKI.js";var x,S,C,w,T,E,D,de=e((()=>{x=`_root_ssfjg_1`,S=`_leaderboard_ssfjg_10`,C=`_label_ssfjg_19`,w=`_flag_ssfjg_33`,T=`_labelText_ssfjg_40`,E=`_labelLink_ssfjg_52`,D={root:x,leaderboard:S,label:C,flag:w,labelText:T,labelLink:E}}));function O(e){return(e?.data?.[0]?.items??[]).map(e=>({label:String(e.label??``),value:e.value,countryCode:e.countryCode,countryFull:e.countryFull?String(e.countryFull):void 0,link:e.link}))}function fe({postId:e,view:t,metric:n,max:r}){let i=t===`links`,o=i?`country`:k[t],s=ee(e,o,{enabled:!i&&n===`opens`}),c=m(e,o,{enabled:!i&&n===`clicks`}),l=m(e,`link`,{enabled:i}),d=m(e,`user-content-link`,{enabled:i}),f=n===`clicks`?c:s,p=i?[l,d]:[f],h=l.data,g=d.data,_=f.data;return{rows:(0,a.useMemo)(()=>(i?[...O(h).filter(e=>!e.link),...O(g).filter(e=>!!e.link)].sort(u):O(_)).slice(0,r>0?r:void 0).map((e,t)=>({...e,id:t})),[i,h,g,_,r]),isLoading:p.some(e=>e.isLoading),isFetching:p.some(e=>e.isFetching),isError:p.some(e=>e.isError&&e.data===void 0),refetch:()=>p.forEach(e=>e.refetch())}}var k,pe=e((()=>{f(),o(),k={countries:`country`,devices:`device`,clients:`client`}}));function me(e){if(!e)return null;try{let{protocol:t}=new URL(e);return t===`http:`||t===`https:`?e:null}catch{return null}}function he(e,n){let i=Math.max(...e.map(e=>e.value),0);return e.map(e=>{let a;if(n===`countries`){let n=e.countryCode?ne(e.countryCode):null;a=(0,j.jsx)(`div`,{className:D.label,children:(0,j.jsx)(y,{label:e.label,imageUrl:n??void 0,imageAlt:r(t(`Flag of %s`,`jetpack-premium-analytics`),e.countryFull??e.label),imageClassName:D.flag})})}else if(n===`links`){let t=me(e.link);a=t?(0,j.jsx)(g,{className:D.labelLink,href:t,variant:`unstyled`,openInNewTab:!0,title:e.label,children:e.label}):(0,j.jsx)(`span`,{className:D.labelText,title:e.label,children:e.label})}else a=(0,j.jsx)(`span`,{className:D.labelText,title:e.label,children:e.label});return{id:String(e.id),label:a,currentValue:e.value,currentShare:i>0?e.value/i*100:0,previousValue:0,previousShare:0,delta:0}})}function ge(e){switch(e){case`devices`:return t(`No device data for this email yet.`,`jetpack-premium-analytics`);case`clients`:return t(`No email client data for this email yet.`,`jetpack-premium-analytics`);case`links`:return t(`No link clicks for this email yet.`,`jetpack-premium-analytics`);default:return t(`No country data for this email yet.`,`jetpack-premium-analytics`)}}function _e(e){let t=typeof e==`number`?e:Number.parseInt(e??``,10);return Number.isInteger(t)&&t>0?t:0}function ve({view:e,metric:t,max:n}){let{reportParams:r}=d(),i=_e(r.post_id),{rows:a,isLoading:o,isFetching:s,isError:c,refetch:l}=fe({postId:i,view:e,metric:t,max:n});return(0,j.jsx)(N,{rows:a,view:e,isLoading:o,isFetching:s,isError:c,hasEmail:i>0,onRetry:l})}function A({attributes:e={}}){return(0,j.jsx)(p,{attributes:e,children:(0,j.jsx)(ve,{view:e.view??`countries`,metric:e.metric??`opens`,max:e.max??10})})}var j,M,N,P=e((()=>{ue(),o(),n(),c(),h(),de(),pe(),j=i(),M={type:`number`,options:{useMultipliers:!0,decimals:0}},N=({rows:e=[],view:n=`countries`,isLoading:r=!1,isFetching:i=!1,isError:o=!1,hasEmail:c=!0,onRetry:l})=>{let u=(0,a.useMemo)(()=>he(e,n),[e,n]);return(0,j.jsx)(`div`,{className:D.root,children:(0,j.jsx)(b,{isLoading:r,isFetching:i,isError:o,isEmpty:e.length===0,error:{description:t(`We couldn't load this email's breakdown. Please try again in a moment.`,`jetpack-premium-analytics`),actions:l?[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:l}]:void 0},empty:{icon:s,description:c?ge(n):t(`Select an email to see its breakdown.`,`jetpack-premium-analytics`)},children:(0,j.jsx)(re,{className:D.leaderboard,data:u,withComparison:!1,withOverlayLabel:!0,showLegend:!1,dataFormat:M})})})}})),F,ye=e((()=>{n(),c(),F={name:`jpa/email-breakdown`,title:t(`Email breakdown`,`jetpack-premium-analytics`),icon:s,attributes:[{id:`view`,label:t(`Break down by`,`jetpack-premium-analytics`),type:`text`,elements:[{label:t(`Countries`,`jetpack-premium-analytics`),value:`countries`},{label:t(`Devices`,`jetpack-premium-analytics`),value:`devices`},{label:t(`Email clients`,`jetpack-premium-analytics`),value:`clients`},{label:t(`Links`,`jetpack-premium-analytics`),value:`links`}],relevance:`high`},{id:`metric`,label:t(`Metric`,`jetpack-premium-analytics`),type:`text`,elements:[{label:t(`Opens`,`jetpack-premium-analytics`),value:`opens`},{label:t(`Clicks`,`jetpack-premium-analytics`),value:`clicks`}],isVisible:({view:e})=>e!==`links`},{id:`max`,label:t(`Number of results`,`jetpack-premium-analytics`),type:`integer`}],example:{attributes:{view:`countries`,metric:`opens`,max:10}}}}));function I(e){return F.attributes.find(t=>t.id===e)?.elements?.map(e=>e.value)??[]}function L({withComparison:e,view:t,metric:n}){return(0,z.jsx)(A,{attributes:{reportParams:{...l(e),post_id:V},view:t,metric:n}})}function R(e){return(0,z.jsx)(A,{attributes:{reportParams:{...l(!1),post_id:e},view:`countries`,metric:`opens`}})}function be({withComparison:e,view:t,metric:n,...r}){return(0,z.jsx)(se,{...r,widgetType:{...F,presentation:`framed`},renderModule:B,renderComponent:A,attributes:{reportParams:{...l(e),post_id:V},view:t,metric:n}})}var z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),ae(),te(),ce(),P(),ye(),z=i(),ie(),B=`storybook/email-breakdown`,V=1234,H=I(`view`),U=I(`metric`),W=e=>(0,z.jsx)(`div`,{style:{width:`100%`,height:`320px`},children:(0,z.jsx)(e,{})}),G={title:`Packages/Premium Analytics/Widgets/EmailBreakdown`,component:A,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`},view:{control:`select`,options:H},metric:{control:`select`,options:U}},parameters:{docs:{description:{component:"The \"Email breakdown\" widget. Breaks a single sent email down by countries, devices, email clients, or clicked links, rendered as a leaderboard. The `view` attribute (`relevance: 'high'`) is exposed as a control by the widget host; the `metric` attribute picks the opens or clicks breakdown for the dimension views, while `links` always reads the clicks breakdown (merging internal link types with clicked user-content links, like the Calypso links module). Scoped to one email via a mocked `reportParams.post_id`. These endpoints have no comparison period, so the widget renders without deltas even when the date picker injects comparison params."}}},decorators:[_]},K={render:L,args:{withComparison:!1,view:`countries`,metric:`opens`},decorators:[W]},q={render:L,args:{withComparison:!0,view:`countries`,metric:`opens`},decorators:[W]},J={render:()=>R(5601),tags:[`!autodocs`],decorators:[W],beforeEach:()=>(v(`stats/opens/emails`,`loading`),()=>v(`stats/opens/emails`,null))},Y={render:()=>R(5602),tags:[`!autodocs`],decorators:[W],beforeEach:()=>(v(`stats/opens/emails`,`error`),()=>v(`stats/opens/emails`,null))},X={render:()=>R(5603),tags:[`!autodocs`],decorators:[W],beforeEach:()=>(v(`stats/opens/emails`,`empty`),()=>v(`stats/opens/emails`,null))},Z={render:()=>(0,z.jsx)(A,{attributes:{reportParams:l(!1),view:`countries`}}),decorators:[W]},Q={render:e=>(0,z.jsx)(be,{...e}),args:{...le,withComparison:!0,view:`countries`,metric:`opens`},argTypes:{...oe,withComparison:{control:`boolean`},view:{control:`select`,options:H},metric:{control:`select`,options:U}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
