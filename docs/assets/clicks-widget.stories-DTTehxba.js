import{i as e}from"./preload-helper-usAeo7Bx.js";import{f as t,n,t as r}from"./build-module-yGZutq_9.js";import{t as i}from"./jsx-runtime-D2pHJD-r.js";import{Gu as a,Nu as o,_a as s,t as c}from"./build-module-zwSmKorH.js";import{Qt as l,Zt as u,b as ee,en as d,g as f,r as te}from"./hooks-D9-5bKhf.js";import{en as p,i as m,lt as ne}from"./date-filters-panel-DXxSsBcd.js";import{r as h}from"./src-Dw7EfA5h.js";import"./constants-B1kGztHF.js";import{r as g,t as re}from"./leaderboard-skeleton-BS2d84lc.js";import{i as _,r as v}from"./register-report-mocks-Bek115LU.js";import{N as y,S as ie,b as ae,j as oe,w as se}from"./report-metric-Cwl9tNr_.js";import{t as ce}from"./widget-state-DoDeK2hZ.js";import{t as le}from"./src-DmKbijpS.js";import{a as ue,c as de,d as b,i as fe,l as pe,n as me,o as he,r as x,s as ge,u as _e}from"./with-widget-canvas-BjVB14N8.js";import{n as ve,t as ye}from"./register-stats-mocks-BEWpdkXB.js";import{n as be,t as S}from"./force-stats-mock-state-CDB682wm.js";var C,w,T,E,xe=e((()=>{C=`_placeholder_1oate_1`,w=`_root_1oate_9`,T=`_content_1oate_18`,E={placeholder:C,root:w,content:T}}));function Se(e){return typeof e.label==`string`&&e.label?e.label:e.link??``}function D(e){let t=h(e.link);return{label:Se(e),value:e.views,previousValue:e.previousValue,...t?{href:t}:{},icon:e.icon,children:e.children?.map(D),...e.childrenHaveComparison?{childrenHaveComparison:!0}:{}}}function Ce(e,r,i){let a=l(e.map(e=>e.value),r?e.map(e=>e.previousValue):[]);return e.map((e,o)=>{let s=e.previousValue,c=!!e.children?.length;return{id:`${o}-${e.href??e.label}`,...oe({label:e.label,media:{kind:`favicon`,url:e.icon??void 0},action:y({href:e.href,hasChildren:c,drillDown:i?{onClick:()=>i(e),ariaLabel:t(n(`View clicked links for %s`,`jetpack-premium-analytics-pkg`),e.label)}:void 0})}),currentValue:e.value,currentShare:u(e.value,a),previousValue:s,previousShare:r&&s!==void 0?u(s,a):void 0,delta:r&&s!==void 0?d(e.value,s):void 0}})}function O({rows:e=[],withComparison:t=!1,onDrillDown:n}){return(0,j.jsx)(g,{data:Ce(e,t,n),withComparison:t,withOverlayLabel:!0,showLegend:!1,dataFormat:M})}function k(){let{reportParams:e}=ee(),{drillDownItem:t,drillDown:r,resetDrillDown:i}=te(),{comparisonRows:o,hasComparison:c,isLoading:l,isFetching:u,isError:d,refetch:f}=ne({...e,max:10},{maxRows:10}),p=(0,a.useMemo)(()=>(o?.rows??[]).map(D),[o]),m=(0,a.useMemo)(()=>p.find(e=>e.label===t)??null,[p,t]),h=!!m?.children?.length,g=h?m.children??[]:p,_=h?!!m?.childrenHaveComparison:c;(0,a.useEffect)(()=>{t&&!h&&!l&&!u&&!d&&i()},[t,h,l,u,d,i]);let v=(0,a.useCallback)(e=>{r(e.label)},[r]),y=h?(0,j.jsx)(se,{label:n(`All clicks`,`jetpack-premium-analytics-pkg`),ariaLabel:n(`View all clicks`,`jetpack-premium-analytics-pkg`),onClick:i}):null;return(0,j.jsxs)(`div`,{className:E.content,children:[y,(0,j.jsx)(ce,{isLoading:l,isFetching:u,isError:p.length===0&&d,isEmpty:g.length===0,error:{description:n(`We couldn't load clicks. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:n(`Retry`,`jetpack-premium-analytics-pkg`),onClick:f}]},empty:{icon:s,description:n(`No clicks in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,j.jsx)(re,{rows:10}),children:(0,j.jsx)(O,{rows:g,withComparison:_,onDrillDown:h?void 0:v})})]})}function A({attributes:e={}}){return(0,j.jsx)(f,{attributes:e,children:(0,j.jsxs)(`div`,{className:E.root,children:[(0,j.jsx)(k,{}),(0,j.jsx)(ie,{children:(0,j.jsx)(ae,{report:`clicks`})})]})})}var j,M,we=e((()=>{m(),le(),o(),r(),c(),xe(),j=i(),M={type:`number`,options:{useMultipliers:!0,decimals:0}}})),N,Te=e((()=>{c(),N={icon:s,attributes:[],example:{attributes:{}}}})),P,F,I,L,R,z,B,Ee=e((()=>{P=`jpa/clicks`,F=`Top links clicked`,I=`Most clicked external links on your site.`,L={content:`The external links your visitors clicked most often, sorted by clicks.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},R=`traffic`,z=`framed`,B={name:P,title:F,description:I,help:L,category:R,presentation:z}}));function V({withComparison:e}){return(0,U.jsx)(A,{attributes:{reportParams:p(e)}})}function H(e){return(0,U.jsx)(A,{attributes:{reportParams:p(!1,e)}})}function De({withComparison:e,...t}){return(0,U.jsx)(ge,{...t,widgetType:G,renderModule:W,renderComponent:A,attributes:{reportParams:p(e)}})}var U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{m(),v(),ye(),be(),de(),_e(),ue(),me(),we(),Te(),Ee(),U=i(),_(),ve(),W=`storybook/clicks`,G=fe(B,N),K={title:`Packages/Premium Analytics/Widgets/Clicks`,component:A,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`The "Clicks" widget. Shows the most-clicked external domains as a ranked leaderboard, using the global dashboard date range. Top-level rows drill down into clicked destination URLs when available.`}}}},q={render:V,args:{withComparison:!1},decorators:[x,b]},J={render:V,args:{withComparison:!0},decorators:[x,b]},Y={render:()=>H(`last-90-days`),tags:[`!autodocs`],decorators:[x,b],beforeEach:()=>(S(`stats/clicks`,`loading`),()=>S(`stats/clicks`,null))},X={render:()=>H(`last-7-days`),tags:[`!autodocs`],decorators:[x,b],beforeEach:()=>(S(`stats/clicks`,`error`),()=>S(`stats/clicks`,null))},Z={render:()=>H(`last-365-days`),tags:[`!autodocs`],decorators:[x,b],beforeEach:()=>(S(`stats/clicks`,`empty`),()=>S(`stats/clicks`,null))},Q={render:e=>(0,U.jsx)(De,{...e}),args:{...he,withComparison:!0},argTypes:{...pe,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
