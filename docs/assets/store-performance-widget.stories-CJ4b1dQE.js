import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-Da_5_6n_.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{n as o,w as ee}from"./build-module-DmVuor49.js";import{n as s,r as c}from"./line-chart-BiHLUQU3.js";import{c as l,t as u}from"./src-DN9VFS2M.js";import{Vn as te,Yn as ne,_t as d,ar as re,qn as ie,ur as f,ut as ae,xt as p,yt as oe}from"./chart-tooltip-BS0AHuyV.js";import{t as m}from"./metric-tabs-chart-BlR6TMkz.js";import{I as h,L as g,U as _,q as se,z as v}from"./report-metric-CypFTt88.js";import{t as ce}from"./widget-state-DnMIufY4.js";import{C as y,D as b,E as x,S,T as le,b as C,t as w,w as T,x as E}from"./src-DxVm3OnV.js";import{i as ue,t as de}from"./src-4y6VNgNE.js";var D,O,k=t((()=>{i(),D=[{id:`net-sales`,label:r(`Net sales`,`jetpack-premium-analytics`),description:r(`Monitor your total revenue — after any discounts, returns, or adjustments — over a set period of time.`,`jetpack-premium-analytics`),metricType:`general`,metricKey:`orders_value_net`},{id:`orders`,label:r(`Orders`,`jetpack-premium-analytics`),description:r(`See a breakdown of when orders are placed to identify peak selling periods.`,`jetpack-premium-analytics`),metricType:`general`,metricKey:`orders_no`},{id:`bookings`,label:r(`Bookings`,`jetpack-premium-analytics`),description:r(`See a breakdown of when bookings are placed to identify peak selling periods.`,`jetpack-premium-analytics`),metricType:`booking`,metricKey:`orders_no`},{id:`visitors`,label:r(`Visitors`,`jetpack-premium-analytics`),description:r(`Track website visitor trends and monitor traffic patterns over time.`,`jetpack-premium-analytics`),metricType:`visitors`,metricKey:`visitors`},{id:`conversion-rate`,label:r(`Store conversion rate`,`jetpack-premium-analytics`),description:r(`Track your store's conversion funnel from sessions to completed orders.`,`jetpack-premium-analytics`),metricType:`conversion`,metricKey:`conversion_rate`},{id:`customers`,label:r(`Customers`,`jetpack-premium-analytics`),description:r(`Track the total number of customers (new and returning) who placed orders during the selected time period.`,`jetpack-premium-analytics`),metricType:`customers`,metricKey:`customers`}],O=D.map(e=>e.id)})),fe,pe,me=t((()=>{fe=`_widgetRoot_8wi56_1`,pe={widgetRoot:fe}}));function he(){return{summary:{date_start:``,date_end:``,total_sales:0,orders_no:0,avg_items:0,average_order_value:0,orders_value_net:0,orders_value_gross:0,product_net_revenue:0,profit_margin:0,cogs_amount:0,coupons:0,refunds:0,paid_orders_count:0,paid_net_sales:0,unpaid_orders_count:0,unpaid_net_sales:0},data:[]}}function ge(){return{summary:{date_start:``,date_end:``,active_sessions:0,visitors:0},data:[]}}function _e(){return{summary:{date_start:``,date_end:``,active_sessions:0,visitors:0,with_cart_addition:0,reached_checkout:0,completed_checkout:0,conversion_rate:0},data:[],steps:[],overallRate:0}}function A(){return{summary:{total_net_sales:0,total_gross_sales:0,total_discounts:0,total_refunds:0,total_orders:0,total_average_order_value:0,total_avg_items_per_order:0,total_customers:0,new_customers:0,returning_customers:0,new_customer_sales:0,new_customer_gross_sales:0,new_customer_discounts:0,new_customer_refunds:0,new_customer_orders:0,new_customer_avg_order_value:0,new_customer_avg_items_per_order:0,returning_customer_sales:0,returning_customer_gross_sales:0,returning_customer_discounts:0,returning_customer_refunds:0,returning_customer_orders:0,returning_customer_avg_order_value:0,returning_customer_avg_items_per_order:0,date_start:``,date_end:``,customers:0},data:[]}}function ve(e,t){if(e.metricType===`visitors`)return d({primary:t.visitors.primary.data??ge(),comparison:t.visitors.comparison.data??ge(),metricKey:e.metricKey,emptyDataFallback:`empty-array`});if(e.metricType===`conversion`)return d({primary:t.conversion.primary.data??_e(),comparison:t.conversion.comparison.data??_e(),metricKey:e.metricKey,emptyDataFallback:`empty-array`});if(e.metricType===`customers`)return d({primary:t.customers.primary.data??A(),comparison:t.customers.comparison.data??A(),metricKey:e.metricKey,emptyDataFallback:`empty-array`});let n=e.metricType===`booking`?t.booking:t.general;return d({primary:n.primary.data??he(),comparison:n.comparison.data??he(),metricKey:e.metricKey,emptyDataFallback:`empty-array`})}function ye({metricIds:e=O}){let{reportParams:t}=se(),n=(0,M.useMemo)(()=>{let t=new Set(e);return D.filter(e=>t.has(e.id))},[e]),i=(0,M.useMemo)(()=>new Set(n.map(e=>e.metricType)),[n]),a=re(t,{enabled:i.has(`general`)}),{primary:o,comparison:s}=a,c=re({...t,filters:[ae]},{enabled:i.has(`booking`)}),{primary:l,comparison:u}=c,d=te(t,{enabled:i.has(`visitors`)}),{primary:f,comparison:p}=d,h=ie(t,{enabled:i.has(`conversion`)}),{primary:g,comparison:_}=h,v=ne(t,{enabled:i.has(`customers`)}),{primary:y,comparison:b}=v,x=(0,M.useMemo)(()=>[i.has(`general`)?a:null,i.has(`booking`)?c:null,i.has(`visitors`)?d:null,i.has(`conversion`)?h:null,i.has(`customers`)?v:null].filter(e=>e!==null),[i,a,c,d,h,v]),S=x.some(e=>e.isError&&!e.hasData),le=(0,M.useCallback)(()=>Promise.all(x.map(e=>e.refetch())),[x]),C=(0,M.useMemo)(()=>n.map(e=>{let[t,n]=e.metricType===`booking`?[l.data?.summary??{},u.data?.summary??{}]:e.metricType===`visitors`?[f.data?.summary??{},p.data?.summary??{}]:e.metricType===`conversion`?[g.data?.summary??{},_.data?.summary??{}]:e.metricType===`customers`?[y.data?.summary??{},b.data?.summary??{}]:[o.data?.summary??{},s.data?.summary??{}];return{...e,primary:Number(t[e.metricKey]??0),comparison:n[e.metricKey]===void 0?null:Number(n[e.metricKey])}}),[n,l.data,u.data,f.data,p.data,g.data,_.data,y.data,b.data,o.data,s.data]),w=(0,M.useMemo)(()=>({general:{primary:o,comparison:s},booking:{primary:l,comparison:u},visitors:{primary:f,comparison:p},conversion:{primary:g,comparison:_},customers:{primary:y,comparison:b}}),[o,s,l,u,f,p,g,_,y,b]),T=(0,M.useMemo)(()=>C.map(e=>{let t=ve(e,w);return{key:e.id,label:e.label,value:e.primary,previousValue:e.comparison,current:t[0]?.data??[],previous:t[1]?.data,dataFormat:oe(e.metricKey),description:e.description}}),[C,w]),E=x.some(e=>e.isLoading&&!e.hasData),ue=x.some(e=>e.isFetching);return(0,N.jsx)(`div`,{className:pe.widgetRoot,children:(0,N.jsx)(ce,{isLoading:E,isError:S,isEmpty:!T.length,error:{description:r(`We couldn't load store performance data. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:r(`Retry`,`jetpack-premium-analytics`),onClick:le}]},empty:{icon:ee,description:r(`No metric selected. Please select a metric from the metrics list.`,`jetpack-premium-analytics`)},renderLoading:(0,N.jsx)(m,{metrics:T,dataFormat:P,loading:!0,groupLabel:r(`Store metric`,`jetpack-premium-analytics`)}),children:(0,N.jsx)(m,{metrics:T,dataFormat:P,loading:ue,groupLabel:r(`Store metric`,`jetpack-premium-analytics`)})})})}function j({attributes:e={}}){return(0,N.jsx)(_,{attributes:e,options:{from:`/`},children:(0,N.jsx)(ye,{metricIds:e.metrics})})}var M,N,P,be=t((()=>{p(),w(),i(),o(),M=e(n(),1),k(),me(),N=a(),P={type:`number`,options:{useMultipliers:!0,decimals:0}}})),F,xe=t((()=>{i(),o(),de(),k(),F={icon:ee,attributes:[{id:`metrics`,label:r(`Metrics`,`jetpack-premium-analytics`),type:`array`,relevance:`high`,Edit:ue,elements:D.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:O}}}})),I,L,R,z,Se,Ce,we=t((()=>{I=`jpa/store-performance`,L=`Store performance`,R=`Shows key store performance metrics at a glance.`,z={content:`Shows key store performance metrics at a glance.`},Se=`store`,Ce={name:I,title:L,description:R,help:z,category:Se}}));function B({withComparison:e=!1,preset:t=W,metrics:n=O}){return{reportParams:f(e,t),metrics:n}}function Te({withComparison:e,preset:t}){let n=!!e,r=t??W;return!n&&r===W?`getDefaultQueryParams()`:n&&r===W?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function Ee(e=O){return`[ ${e.map(e=>`'${e}'`).join(`, `)} ]`}function De(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
