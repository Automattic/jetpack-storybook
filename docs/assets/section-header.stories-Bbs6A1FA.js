...
}`,...D.parameters?.docs?.source},description:{story:`The same header in a box too narrow for two halves: the title and the
...
shows it at any window size.`,...D.parameters?.docs?.description}}},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  args: {
    title: 'Site traffic',
...
}`,...O.parameters?.docs?.source},description:{story:`The left half on its own: nothing in the controls slot.`,...O.parameters?.docs?.description}}},k=[`Default`,`YearSurface`,`Stacked`,`WithoutControls`]}))();export{T as Default,D as Stacked,O as WithoutControls,E as YearSurface,k as __namedExportsOrder,C as default};