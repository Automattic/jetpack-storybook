import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Ms as i,Uu as a,ju as o,t as s}from"./build-module-2iv4IIRq.js";import{m as c,v as ee}from"./hooks-Bj06gF3B.js";import{M as te,t as l}from"./src-C-E2d-Lb.js";import{g as ne,q as u,t as d}from"./src-CJGEmgc4.js";import{$t as f,Mn as re,cn as ie,d as ae,f as oe,ln as se,r as ce,t as p}from"./src-Bv1gHDfD.js";import{j as m}from"./helpers-BNVgdtD4.js";import{n as h,t as g}from"./with-chart-theme-nQQTTTKi.js";import{r as le,t as ue}from"./metric-tabs-chart-skeleton-C4HlviPP.js";import{c as _,i as de,r as fe}from"./register-report-mocks-DykcCpN8.js";import{t as pe}from"./widget-state-Cq9rbSLC.js";import{t as v}from"./src-DrCgTKe-.js";import{a as me,d as he,f as ge,i as _e,n as ve,p as ye,r as y,u as be}from"./with-widget-canvas-GcuJjnSQ.js";import{n as xe,t as Se}from"./preset-for-story-interval-BNlf8FMF.js";import{n as Ce,r as we,t as Te}from"./with-site-time-zone-ngtW_VDw.js";var b,x,Ee=e((()=>{b=`_root_3q2cr_1`,x={root:b}}));function De(e){return t(e===`clicks`?`Clicks`:`Opens`,`jetpack-premium-analytics-pkg`)}function Oe({metric:e,chartType:n}){let{reportParams:r}=ee(),i=re(r.post_id),o=i>0,s=ce(r.interval,ie),c=oe(i,r,{enabled:o&&e===`opens`}),l=ae(i,r,{enabled:o&&e===`clicks`}),u=e===`clicks`?l:c,d=(0,a.useCallback)(()=>{u.refetch()},[u]),f=u.data,p=T[e],m=(0,a.useMemo)(()=>{if(f)return s===`day`?f:se(f,s,e=>{let t=Number(e[p]??0);return{value:t,[p]:t}})},[f,s,p]),h=(0,a.useMemo)(()=>{let t=(m?.data??[]).flatMap(e=>{let t=ne(e.date_start,u.timezone);return t?[{date:t,value:Number(e[p]??0)}]:[]});return[{key:p,label:De(e),value:t.reduce((e,t)=>e+t.value,0),current:t}]},[m,p,e,u.timezone]),g=(m?.data?.length??0)>0;return(0,C.jsx)(`div`,{className:x.root,children:(0,C.jsx)(pe,{isLoading:u.isLoading,isFetching:u.isFetching,isError:u.isError,isEmpty:!o||!g,error:{description:t(`We couldn't load this email's timeline. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:d}]},empty:{icon:te,description:t(o?`No activity for this email in this period.`:`Open an email report to see its timeline here.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,C.jsx)(ue,{}),children:(0,C.jsx)(le,{metrics:h,dataFormat:w,chartType:n})})})}function S({attributes:e={}}){return(0,C.jsx)(c,{attributes:e,children:(0,C.jsx)(Oe,{metric:e.metric??`opens`,chartType:e.chartType===`bar`?`bar`:`line`})})}var C,w,T,ke=e((()=>{p(),d(),l(),v(),o(),n(),Ee(),C=r(),w={type:`number`,options:{useMultipliers:!0,decimals:0}},T={opens:`opens_count`,clicks:`clicks_count`}})),E,D=e((()=>{s(),v(),E={icon:i,attributes:[m()],example:{attributes:{metric:`opens`,chartType:`line`}}}})),O,k,A,j,M,N,P,Ae=e((()=>{O=`jpa/email-time-series`,k=`Email performance`,A=`A single email's opens or clicks over time since it was sent.`,j={content:`How a single email performed over time: opens or clicks per day over the window the page reports — on the post detail page, the first 30 days after the send.`},M=`stats`,N=`framed`,P={name:O,title:k,description:A,help:j,category:M,presentation:N}}));function F({metric:e,interval:t,chartType:n},r=!1){return{reportParams:{...f(r,xe(t)),interval:t,post_id:B},metric:e,chartType:n}}function I(e){return(0,R.jsx)(S,{attributes:F(e)})}function L(e){return(0,R.jsx)(S,{attributes:{reportParams:{...f(!1),interval:`day`,post_id:e},metric:`opens`}})}function je({metric:e,interval:t,chartType:n,...r}){return(0,R.jsx)(he,{...r,widgetType:_e(P,E),renderModule:z,renderComponent:S,attributes:F({metric:e,interval:t,chartType:n},!0)})}var R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{p(),d(),fe(),g(),ge(),me(),Se(),ve(),Te(),ke(),D(),Ae(),R=r(),de(),z=`storybook/email-time-series`,B=1234,V=[`opens`,`clicks`],H=[`day`,`week`,`month`],U={title:`Packages/Premium Analytics/Widgets/EmailTimeSeries`,component:S,tags:[`autodocs`],argTypes:{...Ce,metric:{control:`select`,options:V},interval:{control:`select`,options:H},chartType:{control:`radio`,options:[`line`,`bar`]}},parameters:{docs:{description:{component:`The "Email performance" widget. Draws a single sent email's opens or clicks per day as a line chart, spanning the dashboard date range — the chart section of the legacy email detail page. The bucket size follows the page's chart interval control: an hourly window (the last-24-hours preset) draws the hourly buckets directly, while weekly and monthly grouping aggregate the daily buckets client-side because the endpoint only reports hourly/daily. Scoped to one email via a mocked \`reportParams.post_id\`. The post detail page has no comparison control, so comparison report params are ignored.`}}},decorators:[h,we]},W={render:I,args:{metric:`opens`,interval:`day`,chartType:`line`},decorators:[y]},G={render:I,args:{metric:`clicks`,interval:`day`,chartType:`line`},decorators:[y]},K={render:I,args:{metric:`opens`,interval:`week`,chartType:`line`},decorators:[y]},q={render:({metric:e,chartType:t})=>(0,R.jsx)(S,{attributes:{reportParams:{...f(!1,u),post_id:B},metric:e,chartType:t}}),args:{metric:`opens`,chartType:`line`},parameters:{controls:{exclude:[`interval`]}},decorators:[y]},J={render:()=>L(5701),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(_(`stats/opens/emails`,`loading`),()=>_(`stats/opens/emails`,null))},Y={render:()=>L(5702),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(_(`stats/opens/emails`,`error`),()=>_(`stats/opens/emails`,null))},X={render:()=>L(5703),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(_(`stats/opens/emails`,`empty`),()=>_(`stats/opens/emails`,null))},Z={render:()=>(0,R.jsx)(S,{attributes:{reportParams:f(!1),metric:`opens`}}),decorators:[y]},Q={render:e=>(0,R.jsx)(je,{...e}),args:{...be,metric:`opens`,interval:`day`,chartType:`line`},argTypes:{...ye,metric:{control:`select`,options:V},interval:{control:`select`,options:H},chartType:{control:`radio`,options:[`line`,`bar`]}}},W.parameters={...W.parameters,docs:{...W.parameters?.docs,source:{originalSource:`{
