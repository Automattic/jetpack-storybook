import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as i,t as a}from"./build-module-CbwHEf9N.js";import{js as o,n as s}from"./build-module-CDRs4YxF.js";import{J as c,Z as l,at as ee,q as u,tt as d}from"./report-metric-BgKZWvum.js";import{M as te,t as f}from"./src-BKLK-O8P.js";import{n as p,t as m}from"./with-chart-theme-CJ8x8OES.js";import{Cr as h,Ft as ne,It as g,Nt as _,Ur as re,a as ie,kr as ae,o as oe}from"./chart-tooltip-B9iJDoi7.js";import{r as se,t as ce}from"./metric-tabs-chart-skeleton-qv-oBj_0.js";import{t as le}from"./widget-state-CvagFpCy.js";import{a as ue}from"./report-records-table-DP4z9daP.js";import{C as de,D as fe,E as pe,S as me,T as he,b as v,t as y,w as ge,x as b}from"./src-CcIm-rkN.js";var x,S,_e=e((()=>{x=`_root_1p0hj_1`,S={root:x}}));function C(e){return t(e===`clicks`?`Total clicks`:`Total opens`,`jetpack-premium-analytics-pkg`)}function ve({metric:e,granularity:n,chartType:r}){let{reportParams:a}=ee(),o=re(a.post_id),s=o>0,c=g(o,a,{enabled:s&&e===`opens`}),l=ne(o,a,{enabled:s&&e===`clicks`}),u=e===`clicks`?l:c,d=(0,i.useCallback)(()=>{u.refetch()},[u]),f=u.data,p=D[e],m=(0,i.useMemo)(()=>{if(f)return n===`day`?f:ae(f,n,e=>{let t=Number(e[p]??0);return{value:t,[p]:t}})},[f,n,p]),h=(0,i.useMemo)(()=>{let t=m?ue({primary:m,metrics:[{key:p,label:C(e)}]})[0]?.data??[]:[];return[{key:p,label:C(e),value:t.reduce((e,t)=>e+t.value,0),current:t}]},[m,p,e]),_=(m?.data?.length??0)>0;return(0,T.jsx)(`div`,{className:S.root,children:(0,T.jsx)(le,{isLoading:u.isLoading,isFetching:u.isFetching,isError:u.isError,isEmpty:!s||!_,error:{description:t(`We couldn't load this email's timeline. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:d}]},empty:{icon:te,description:t(s?`No activity for this email in this period.`:`Open an email report to see its timeline here.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,T.jsx)(ce,{}),children:(0,T.jsx)(se,{metrics:h,dataFormat:E,chartType:r})})})}function w({attributes:e={}}){return(0,T.jsx)(d,{attributes:e,children:(0,T.jsx)(ve,{metric:e.metric??`opens`,granularity:e.granularity??`day`,chartType:e.chartType===`bar`?`bar`:`line`})})}var T,E,D,ye=e((()=>{_(),f(),y(),a(),n(),_e(),T=r(),E={type:`number`,options:{useMultipliers:!0,decimals:0}},D={opens:`opens_count`,clicks:`clicks_count`}})),O,be=e((()=>{s(),y(),O={icon:o,attributes:[oe([`day`,`week`,`month`]),ie()],example:{attributes:{metric:`opens`,granularity:`day`,chartType:`line`}}}})),k,A,j,M,N,P,F,xe=e((()=>{k=`jpa/email-time-series`,A=`Email performance`,j=`A single email's opens or clicks over time since it was sent.`,M={content:`How a single email performed over time: opens or clicks per day since it was sent, following the dashboard date range. Weekly and monthly grouping aggregate the daily buckets.`},N=`stats`,P=`framed`,F={name:k,title:A,description:j,help:M,category:N,presentation:P}}));function Se(e){return O.attributes.find(t=>t.id===e)?.elements?.map(e=>e.value)??[]}function I({metric:e,granularity:t,chartType:n},r=!1){return{reportParams:{...h(r),post_id:V},metric:e,granularity:t,chartType:n}}function L(e){return(0,z.jsx)(w,{attributes:I(e)})}function R(e){return(0,z.jsx)(w,{attributes:{reportParams:{...h(!1),post_id:e},metric:`opens`,granularity:`day`}})}function Ce({metric:e,granularity:t,chartType:n,...r}){return(0,z.jsx)(he,{...r,widgetType:me(F,O),renderModule:B,renderComponent:w,attributes:I({metric:e,granularity:t,chartType:n},!0)})}var z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{_(),u(),m(),pe(),de(),v(),ye(),be(),xe(),z=r(),c(),B=`storybook/email-time-series`,V=1234,H=[`opens`,`clicks`],U=Se(`granularity`),W={title:`Packages/Premium Analytics/Widgets/EmailTimeSeries`,component:w,tags:[`autodocs`],argTypes:{metric:{control:`select`,options:H},granularity:{control:`select`,options:U},chartType:{control:`radio`,options:[`line`,`bar`]}},parameters:{docs:{description:{component:"The \"Email performance\" widget. Draws a single sent email's opens or clicks per day as a line chart, spanning the dashboard date range — the chart section of the legacy email detail page. The `granularity` attribute (`relevance: 'high'`) is exposed as a control by the widget host; weekly grouping aggregates the daily buckets client-side because the endpoint only reports hourly/daily. Scoped to one email via a mocked `reportParams.post_id`. The post detail page has no comparison control, so comparison report params are ignored."}}},decorators:[p]},G={render:L,args:{metric:`opens`,granularity:`day`,chartType:`line`},decorators:[b]},K={render:L,args:{metric:`clicks`,granularity:`day`,chartType:`line`},decorators:[b]},q={render:L,args:{metric:`opens`,granularity:`week`,chartType:`line`},decorators:[b]},J={render:()=>R(5701),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(l(`stats/opens/emails`,`loading`),()=>l(`stats/opens/emails`,null))},Y={render:()=>R(5702),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(l(`stats/opens/emails`,`error`),()=>l(`stats/opens/emails`,null))},X={render:()=>R(5703),tags:[`!autodocs`],decorators:[b],beforeEach:()=>(l(`stats/opens/emails`,`empty`),()=>l(`stats/opens/emails`,null))},Z={render:()=>(0,z.jsx)(w,{attributes:{reportParams:h(!1),metric:`opens`}}),decorators:[b]},Q={render:e=>(0,z.jsx)(Ce,{...e}),args:{...ge,metric:`opens`,granularity:`day`,chartType:`line`},argTypes:{...fe,metric:{control:`select`,options:H},granularity:{control:`select`,options:U},chartType:{control:`radio`,options:[`line`,`bar`]}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
