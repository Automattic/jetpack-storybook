import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{t as i,zi as a}from"./build-module-2iv4IIRq.js";import{Mt as o,St as s,b as c,f as l,g as u}from"./hooks-CWyb3wkb.js";import{T as d,t as f}from"./src-C-E2d-Lb.js";import{n as p,t as m}from"./src-D6PvPlIZ.js";import{E as h,r as g,tn as _}from"./date-period-dropdown-DhgyTlgZ.js";import"./constants-B1kGztHF.js";import{t as ee}from"./donut-chart-skeleton-cNgXi7TV.js";import{t as te}from"./semi-circle-chart-gQtR3-lO.js";import{i as ne,r as re}from"./register-report-mocks-cvRPOVwg.js";import{F as ie}from"./report-metric-uW8qgqaY.js";import{t as ae}from"./widget-state-SUJQG2JI.js";import{t as v}from"./src-D8yCyUlC.js";import{a as oe,c as se,i as ce,l as le,n as ue,o as de,r as y,s as fe}from"./with-widget-canvas-C3kVqfyG.js";import{n as pe,t as me}from"./register-stats-mocks-CtbofPZO.js";import{n as he,t as b}from"./force-stats-mock-state-O353B4LH.js";var x,S,C,w,T,ge=e((()=>{x=`_root_1ego9_1`,S=`_content_1ego9_9`,C=`_chartWrap_1ego9_16`,w=`_chartShell_1ego9_24`,T={root:x,content:S,chartWrap:C,chartShell:w}}));function _e(e){let t=typeof e.label==`string`?e.label:String(e.label);return{label:t,displayLabel:o(t,E),percentage:e.value,previousPercentage:e.previousValue}}function ve({reportParams:e,max:t,deviceProperty:n=`screensize`}){let{comparisonRows:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:l}=h({...e,deviceProperty:n},{maxRows:t}),u=(r?.rows??[]).map(_e),d=u.length===0&&s;return{data:u,hasComparison:i,isLoading:a,isFetching:o,isError:d,error:d?c:null,refetch:l}}var E,ye=e((()=>{n(),g(),v(),E={desktop:t(`Desktop`,`jetpack-premium-analytics-pkg`),mobile:t(`Mobile`,`jetpack-premium-analytics-pkg`),tablet:t(`Tablet`,`jetpack-premium-analytics-pkg`),phone:t(`Phone`,`jetpack-premium-analytics-pkg`),unknown:t(`Unknown`,`jetpack-premium-analytics-pkg`)}}));function D(e){return e/100}function be(){let{reportParams:e}=c(),{data:n,hasComparison:r,isLoading:i,isFetching:a,isError:o,error:u,refetch:f}=ve({reportParams:e,max:10,deviceProperty:`screensize`}),m=n.map(e=>({label:e.displayLabel,value:D(e.percentage)})),h=l(m),g=n.map(e=>({label:e.displayLabel,value:D(e.percentage),displayValue:p(D(e.percentage),A.type,A.options),comparison:r&&e.previousPercentage!==void 0?D(e.previousPercentage):void 0})).map((e,t)=>({...e,color:h[t]?.color}));return(0,k.jsx)(`div`,{className:T.content,children:(0,k.jsx)(ae,{isLoading:i,isFetching:a,isError:o,isEmpty:n.length===0,error:s(u,{retryDescription:t(`We couldn't load device data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:f}),empty:{icon:d,description:t(`No device data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,k.jsx)(ee,{}),children:(0,k.jsx)(`div`,{className:T.chartWrap,children:(0,k.jsxs)(`div`,{className:T.chartShell,children:[(0,k.jsx)(te,{chartData:m,styles:h,showLegend:!1,showMetric:!1,withTooltips:!0,dataFormat:A}),(0,k.jsx)(ie,{items:g,withComparison:r})]})})})})}function O({attributes:e={}}){return(0,k.jsx)(u,{attributes:e,children:(0,k.jsx)(`div`,{className:T.root,children:(0,k.jsx)(be,{})})})}var k,A,xe=e((()=>{m(),f(),n(),v(),ge(),ye(),k=r(),A={type:`percentage`,options:{decimals:1,signDisplay:`auto`}}})),j,M=e((()=>{i(),j={icon:a,attributes:[],example:{attributes:{}}}})),N,P,F,I,L,R,z,Se=e((()=>{N=`jpa/devices`,P=`Devices`,F=`Top device types and screen sizes for your visitors.`,I={content:`A breakdown of the device types your visitors used, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},L=`traffic`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function B({withComparison:e}){return(0,H.jsx)(O,{attributes:{reportParams:_(e)}})}function V(e){return(0,H.jsx)(O,{attributes:{reportParams:_(!1,e)}})}function Ce(e){return(0,H.jsx)(O,{...e})}function we({withComparison:e,...t}){return(0,H.jsx)(fe,{...t,widgetType:W,renderModule:U,renderComponent:Ce,attributes:{reportParams:_(e)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{g(),se(),oe(),ue(),re(),me(),he(),xe(),M(),Se(),H=r(),ne(),pe(),U=`storybook/devices`,W=ce(z,j),G={title:`Packages/Premium Analytics/Widgets/Devices`,component:O,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`The "Devices" widget. Shows screen size breakdown (Desktop / Mobile / Tablet) as a semi-circle chart, using the global dashboard date range.`}}}},K={render:B,args:{withComparison:!1},decorators:[y]},q={render:B,args:{withComparison:!0},decorators:[y]},J={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(b(`stats/devices/screensize`,`loading`),()=>b(`stats/devices/screensize`,null))},Y={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(b(`stats/devices/screensize`,`error`),()=>b(`stats/devices/screensize`,null))},X={render:()=>V(`last-12-months`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(b(`stats/devices/screensize`,`error-retryable`),()=>b(`stats/devices/screensize`,null))},Z={render:()=>V(`last-year`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(b(`stats/devices/screensize`,`empty`),()=>b(`stats/devices/screensize`,null))},Q={render:e=>(0,H.jsx)(we,{...e}),args:{...de,withComparison:!0},argTypes:{...le,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
