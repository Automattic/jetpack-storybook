import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-yGZutq_9.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{di as o,t as s}from"./build-module-zwSmKorH.js";import{g as c}from"./hooks-JLZZ4ZCt.js";import{Qa as l,no as u,oo as d}from"./iframe-B87wey_6.js";import{p as f,t as ee}from"./src-DFNM1k7F.js";import{k as te,t as ne}from"./src-B477hvom.js";import{fn as re,i as ie,q as p}from"./date-filters-panel-DkacDMMB.js";import"./constants-B1kGztHF.js";import{i as m,r as ae,s as h}from"./register-report-mocks-Dhb8Obq5.js";import{t as g}from"./widget-state-CTLubzoL.js";import{r as _,t as v}from"./subscriber-list-skeleton-C7UQIWn4.js";import{t as y}from"./src-CK-uL4th.js";import{a as b,c as x,i as S,l as C,n as w,o as T,r as E,s as oe}from"./with-widget-canvas-DzUGKdyr.js";function D(){let e=u()?.suffix;return e?`${d()?`https://wordpress.com`:`https://cloud.jetpack.com`}/subscribers/${e}`:null}function O(e){let t=re(e),n=D();return t.map((e,t)=>({id:e.subscription_id??`row-${t}`,name:e.label,avatarUrl:e.icon,href:n&&e.subscription_id?`${n}/${e.subscription_id}`:null,secondaryText:te(e.date_subscribed)}))}function k(){let{data:e,isLoading:t,isFetching:n,isError:i,refetch:a}=p({type:`all`,max:10}),o=e,s=(0,j.useMemo)(()=>O(o),[o]),c=Number(o?.summary?.total??0),l=Math.max(c-s.length,0);return(0,M.jsx)(g,{isLoading:t,isFetching:n,isError:s.length===0&&i,isEmpty:s.length===0,renderLoading:(0,M.jsx)(v,{rows:10}),error:{description:r(`We couldn't load subscribers. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:r(`Retry`,`jetpack-premium-analytics-pkg`),onClick:a}]},empty:{icon:f,description:r(`No subscribers yet.`,`jetpack-premium-analytics-pkg`)},children:(0,M.jsx)(N,{items:s,moreCount:l})})}function A({attributes:e={}}){return(0,M.jsx)(c,{attributes:e,children:(0,M.jsx)(k,{})})}var j,M,N,P=t((()=>{l(),ie(),ne(),ee(),y(),i(),j=e(n(),1),M=a(),N=({items:e=[],moreCount:t=0})=>(0,M.jsx)(_,{items:e,moreCount:t})})),F,I=t((()=>{s(),F={icon:o,attributes:[],example:{attributes:{}}}})),L,R,z,B,V,H,U,W=t((()=>{L=`jpa/subscribers-list`,R=`Latest subscribers`,z=`Your most recent subscribers.`,B={content:`Your most recent subscribers.`},V=`subscribers`,H=`framed`,U={name:L,title:R,description:z,help:B,category:V,presentation:H}})),G,K,q,J,Y,X,Z,Q,$;t((()=>{x(),b(),w(),ae(),P(),I(),W(),G=a(),m(),window.JetpackScriptData={...window.JetpackScriptData,site:{...window.JetpackScriptData?.site,suffix:`example.com`}},K=`storybook/subscribers-list`,q={title:`Packages/Premium Analytics/Widgets/SubscribersList`,component:A,tags:[`autodocs`],parameters:{docs:{description:{component:'Dashboard widget listing the most recent subscribers (avatar + name + relative "since" time) with an "N more" footer. Data comes from the designated `useStatsFollowers` hook; in Storybook it is served by `registerReportMocks`.'}}}},J={render:()=>(0,G.jsx)(A,{attributes:{}}),decorators:[E]},Y={render:()=>(0,G.jsx)(A,{attributes:{}}),tags:[`!autodocs`],decorators:[E],beforeEach:()=>(h(`stats/followers`,`loading`),()=>h(`stats/followers`,null))},X={render:()=>(0,G.jsx)(A,{attributes:{}}),tags:[`!autodocs`],decorators:[E],beforeEach:()=>(h(`stats/followers`,`error`),()=>h(`stats/followers`,null))},Z={render:()=>(0,G.jsx)(A,{attributes:{}}),tags:[`!autodocs`],decorators:[E],beforeEach:()=>(h(`stats/followers`,`empty`),()=>h(`stats/followers`,null))},Q={render:e=>(0,G.jsx)(oe,{...e,widgetType:S(U,F),renderModule:K,renderComponent:A,attributes:{}}),args:{...T},argTypes:{...C}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
