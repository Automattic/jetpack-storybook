import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Nn as i,n as a}from"./build-module-DmVuor49.js";import{R as o,W as s,t as c}from"./build-module-CtDSPJRs.js";import{C as l,t as u}from"./src-B3le4dug.js";import{Ct as d,J as ee,Rt as f,S as p,X as te,d as ne,fr as m,q as h}from"./chart-tooltip-C7xuMDGJ.js";import{t as re}from"./leaderboard-chart-uQCgSg9i.js";import{I as g,L as ie,U as ae,q as oe}from"./report-metric-BZ9kIhv4.js";import{t as _}from"./widget-state-ByVOZ3dT.js";import{C as se,D as ce,E as le,S as ue,T as de,b as fe,t as v,w as pe,x as y}from"./src-D8PMckt8.js";import{n as me,t as he}from"./src-ByGMP9Mc.js";import{n as ge,t as _e}from"./register-stats-mocks-CrMo-Sgj.js";import{n as ve,t as b}from"./force-stats-mock-state-goN0SNgG.js";var x,S,C,w,ye=e((()=>{x=`_root_al0b4_1`,S=`_content_al0b4_9`,C=`_itemLabel_al0b4_17`,w={root:x,content:S,itemLabel:C}}));function be(e,t){let n=String(e.label??``);return{key:n,label:p(n,t===`browser`?T:E),views:e.value,previousViews:e.previousValue}}function xe({reportParams:e,max:t,deviceProperty:n}){let{comparisonRows:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:l}=f({...e,deviceProperty:n},{maxRows:t}),u=(r?.rows??[]).map(e=>be(e,n)),d=u.length===0&&s;return{data:u,hasComparison:i,isLoading:a,isFetching:o,isError:d,error:d?c:null,refetch:l}}var T,E,Se=e((()=>{n(),d(),v(),T={chrome:t(`Chrome`,`jetpack-premium-analytics`),safari:t(`Safari`,`jetpack-premium-analytics`),firefox:t(`Firefox`,`jetpack-premium-analytics`),edge:t(`Edge`,`jetpack-premium-analytics`),opera:t(`Opera`,`jetpack-premium-analytics`),samsung:t(`Samsung Internet`,`jetpack-premium-analytics`),ie:t(`IE`,`jetpack-premium-analytics`),yandex:t(`Yandex`,`jetpack-premium-analytics`),miui:t(`Mi Browser`,`jetpack-premium-analytics`),other:t(`Other`,`jetpack-premium-analytics`)},E={windows:t(`Windows`,`jetpack-premium-analytics`),mac:t(`macOS`,`jetpack-premium-analytics`),android:t(`Android`,`jetpack-premium-analytics`),linux:t(`Linux`,`jetpack-premium-analytics`),ios:t(`iOS`,`jetpack-premium-analytics`),ipad:t(`iPad`,`jetpack-premium-analytics`),iphone:t(`iPhone`,`jetpack-premium-analytics`),ipados:t(`iPadOS`,`jetpack-premium-analytics`),macos:t(`macOS`,`jetpack-premium-analytics`),chrome:t(`Chrome OS`,`jetpack-premium-analytics`),android_tablet:t(`Android Tablet`,`jetpack-premium-analytics`),other:t(`Other`,`jetpack-premium-analytics`)}}));function Ce({max:e,platformDimension:n}){let{reportParams:r}=oe(),{data:i,hasComparison:a,isLoading:c,isFetching:u,isError:d,error:f,refetch:p}=xe({reportParams:r,max:e,deviceProperty:n}),m=ee(i.map(e=>e.views),a?i.map(e=>e.previousViews):[]),g=i.map((e,t)=>{let n=e.previousViews;return{id:`${t}-${e.key}`,label:(0,O.jsx)(o,{align:`center`,className:w.itemLabel,children:(0,O.jsx)(s,{children:e.label})}),currentValue:e.views,currentShare:h(e.views,m),previousValue:n,previousShare:a&&n!==void 0?h(n,m):void 0,delta:a&&n!==void 0?te(e.views,n):void 0}});return(0,O.jsx)(`div`,{className:w.content,children:(0,O.jsx)(_,{isLoading:c,isFetching:u,isError:d,isEmpty:i.length===0,error:ne(f,{retryDescription:t(`We couldn't load platform data. Please try again in a moment.`,`jetpack-premium-analytics`),onRetry:p}),empty:{icon:l,description:t(`No platform data in this period.`,`jetpack-premium-analytics`)},children:(0,O.jsx)(re,{data:g,withComparison:a,withOverlayLabel:!0,showLegend:!1,dataFormat:k})})})}function D({attributes:e}){let t=e?.max??10,n=e?.platformDimension??`browser`;return(0,O.jsx)(ae,{attributes:e,children:(0,O.jsx)(`div`,{className:w.root,children:(0,O.jsx)(Ce,{max:t,platformDimension:n})})})}var O,k,we=e((()=>{u(),n(),c(),v(),ye(),Se(),O=r(),k={type:`number`,options:{useMultipliers:!0,decimals:0}}})),A,Te=e((()=>{n(),a(),he(),A={icon:i,attributes:[{id:`max`,label:t(`Number of results`,`jetpack-premium-analytics`),type:`integer`},{id:`platformDimension`,label:t(`View by`,`jetpack-premium-analytics`),type:`text`,Edit:me,elements:[{label:t(`Browser`,`jetpack-premium-analytics`),value:`browser`},{label:t(`OS`,`jetpack-premium-analytics`),value:`platform`}],relevance:`high`}],example:{attributes:{max:10,platformDimension:`browser`}}}})),j,M,N,P,F,I,L,Ee=e((()=>{j=`jpa/top-platforms`,M=`Top Platforms`,N=`Top browsers and operating systems your visitors use.`,P={content:`A breakdown of the operating systems and browsers your visitors used, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},F=`traffic`,I=`framed`,L={name:j,title:M,description:N,help:P,category:F,presentation:I}}));function R({withComparison:e,platformDimension:t}){return{max:10,platformDimension:t,reportParams:m(e)}}function z(e){return(0,V.jsx)(D,{attributes:R(e)})}function B(e){return(0,V.jsx)(D,{attributes:{max:10,platformDimension:`browser`,reportParams:m(!1,e)}})}function De(e){return(0,V.jsx)(D,{...e})}function Oe({withComparison:e,platformDimension:t,...n}){return(0,V.jsx)(de,{...n,widgetType:U,renderModule:H,renderComponent:De,attributes:R({withComparison:e,platformDimension:t})})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{d(),le(),se(),fe(),g(),_e(),ve(),we(),Te(),Ee(),V=r(),ie(),ge(),H=`storybook/top-platforms`,U=ue(L,A),W={title:`Packages/Premium Analytics/Widgets/TopPlatforms`,component:D,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},platformDimension:{control:`radio`,options:[`browser`,`platform`],description:`The "View by" toolbar attribute rendered by the widget host.`}},parameters:{docs:{description:{component:"The \"Top Platforms\" widget. Shows browser and OS breakdown as a ranked leaderboard. The active dimension is the `platformDimension` attribute (`relevance: 'high'`), exposed as a control by the widget host."}}}},G={render:z,args:{withComparison:!1,platformDimension:`browser`},decorators:[y]},K={render:z,args:{withComparison:!0,platformDimension:`browser`},decorators:[y]},q={render:z,args:{withComparison:!1,platformDimension:`platform`},decorators:[y]},J={render:()=>B(`last-90-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(b(`stats/devices`,`loading`),()=>b(`stats/devices`,null))},Y={render:()=>B(`last-7-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(b(`stats/devices`,`error`),()=>b(`stats/devices`,null))},X={render:()=>B(`last-12-months`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(b(`stats/devices`,`error-retryable`),()=>b(`stats/devices`,null))},Z={render:()=>B(`last-365-days`),tags:[`!autodocs`],decorators:[y],beforeEach:()=>(b(`stats/devices`,`empty`),()=>b(`stats/devices`,null))},Q={render:e=>(0,V.jsx)(Oe,{...e}),args:{...pe,withComparison:!0,platformDimension:`browser`},argTypes:{...ce,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`},platformDimension:{control:`radio`,options:[`browser`,`platform`],description:`The "View by" toolbar attribute rendered by the widget host.`}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
