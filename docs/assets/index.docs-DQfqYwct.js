import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-CQqCWvwC.js";import{i as r,n as i,r as a,t as o}from"./blocks-GWUG2RmM.js";import{t as s}from"./mdx-react-shim-C6TrRFEn.js";import{Default as c,n as l,t as u}from"./index.stories-DFtyImZY.js";import{Complex as d,FormattedValues as f,HTML as p,PlainText as m,t as h}from"./tooltip.stories-CchuQJ0_.js";function g(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(i,{title:`JS Packages/Charts Library/Charts/Geo Chart`,of:u}),`
...
`,(0,v.jsxs)(t.ul,{children:[`
`,(0,v.jsxs)(t.li,{children:[(0,v.jsx)(t.strong,{children:`No data`}),`: Countries without values use `,(0,v.jsx)(t.code,{children:`--a8c-charts-color-surface-secondary`}),` (`,(0,v.jsx)(t.code,{children:`datalessRegionColor`}),`)`]}),`
`,(0,v.jsxs)(t.li,{children:[(0,v.jsx)(t.strong,{children:`Low values`}),`: Displayed with lighter colors`]}),`
`,(0,v.jsxs)(t.li,{children:[(0,v.jsx)(t.strong,{children:`High values`}),`: Displayed with the full first palette color`]}),`
`]}),`
`,(0,v.jsxs)(t.p,{children:[`The color scale is configured via Google Charts' `,(0,v.jsx)(t.code,{children:`colorAxis`}),` option, from `,(0,v.jsx)(t.code,{children:`--a8c-charts-color-series-1`}),` and a lightened version of it.`]}),`
...
`,(0,v.jsx)(t.p,{children:`Geo Charts integrate seamlessly with the chart theming system. The default theme has neutral styling, and is automatically applied to all charts unless a custom theme is provided.`}),`
`,(0,v.jsx)(t.p,{children:(0,v.jsx)(t.strong,{children:`The color axis range comes from the first palette custom property, not the theme object:`})}),`
`,(0,v.jsx)(a,{language:`css`,code:`.a8c-charts-scope {
	--a8c-charts-color-series-1: #FF6B6B;
}`}),`
`,(0,v.jsxs)(t.p,{children:[`Every other color works the same way — declare its catalog role. The closest declaration inside the provider tree wins, so scope the rule to one dashboard, or to `,(0,v.jsx)(t.code,{children:`.a8c-charts-scope`}),` to move every chart on the page:`]}),`
`,(0,v.jsx)(a,{language:`css`,code:`.my-dashboard {
	/* Behind the map: */
	--a8c-charts-color-background: #f5f5f5;
	/* Countries with no data: */
	--a8c-charts-color-surface-secondary: #e0e0e0;
}`}),`
`,(0,v.jsxs)(t.p,{children:[`Google Charts takes a resolved hex rather than a `,(0,v.jsx)(t.code,{children:`var()`}),` chain, so `,(0,v.jsx)(t.code,{children:`GeoChart`}),` reads both roles at render and does not repaint on a theme change until it re-renders. Every other chart follows the cascade live.`]}),`
