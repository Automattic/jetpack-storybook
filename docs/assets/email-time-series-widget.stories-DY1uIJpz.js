import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as i,t as a}from"./build-module-CbwHEf9N.js";import{js as o,n as s}from"./build-module-CDRs4YxF.js";import{b as ee,g as c}from"./hooks-BPjrSlDf.js";import{M as te,t as l}from"./src-BubuPiv_.js";import{i as ne,nn as re,qt as u,r as d,t as f,tn as ie,vn as ae}from"./src-CJaWYg77.js";import{n as p,t as m}from"./with-chart-theme-DAJ_YoNw.js";import{a as h,w as oe,x as se}from"./chart-tooltip-Cx0xn_jQ.js";import{r as ce,t as le}from"./metric-tabs-chart-skeleton-DBuqwJ39.js";import{K as g,X as _,q as ue}from"./report-metric-BqjsaAo0.js";import{t as de}from"./widget-state-BK1sWm_H.js";import{C as fe,D as pe,E as v,S as me,T as he,b as y,t as b,w as ge,x}from"./src-D4NxAger.js";import{n as _e,t as ve}from"./preset-for-story-interval-wEaC09Ey.js";var S,C,ye=e((()=>{S=`_root_1p0hj_1`,C={root:S}}));function be(e){return t(e===`clicks`?`Total clicks`:`Total opens`,`jetpack-premium-analytics-pkg`)}function xe({metric:e,chartType:n}){let{reportParams:r}=ee(),a=ae(r.post_id),o=a>0,s=oe(r.interval,ie),c=ne(a,r,{enabled:o&&e===`opens`}),l=d(a,r,{enabled:o&&e===`clicks`}),u=e===`clicks`?l:c,f=(0,i.useCallback)(()=>{u.refetch()},[u]),p=u.data,m=D[e],h=(0,i.useMemo)(()=>{if(p)return s===`day`?p:re(p,s,e=>{let t=Number(e[m]??0);return{value:t,[m]:t}})},[p,s,m]),g=(0,i.useMemo)(()=>{let t=(h?.data??[]).map(e=>({date:se(e.date_start),value:Number(e[m]??0)}));return[{key:m,label:be(e),value:t.reduce((e,t)=>e+t.value,0),current:t}]},[h,m,e]),_=(h?.data?.length??0)>0;return(0,T.jsx)(`div`,{className:C.root,children:(0,T.jsx)(de,{isLoading:u.isLoading,isFetching:u.isFetching,isError:u.isError,isEmpty:!o||!_,error:{description:t(`We couldn't load this email's timeline. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:f}]},empty:{icon:te,description:t(o?`No activity for this email in this period.`:`Open an email report to see its timeline here.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,T.jsx)(le,{}),children:(0,T.jsx)(ce,{metrics:g,dataFormat:E,chartType:n,pointsAreWallClocks:!0})})})}function w({attributes:e={}}){return(0,T.jsx)(c,{attributes:e,children:(0,T.jsx)(xe,{metric:e.metric??`opens`,chartType:e.chartType===`bar`?`bar`:`line`})})}var T,E,D,Se=e((()=>{f(),l(),b(),a(),n(),ye(),T=r(),E={type:`number`,options:{useMultipliers:!0,decimals:0}},D={opens:`opens_count`,clicks:`clicks_count`}})),O,Ce=e((()=>{s(),b(),O={icon:o,attributes:[h()],example:{attributes:{metric:`opens`,chartType:`line`}}}})),k,A,j,M,N,P,F,we=e((()=>{k=`jpa/email-time-series`,A=`Email performance`,j=`A single email's opens or clicks over time since it was sent.`,M={content:`How a single email performed over time: opens or clicks per day since it was sent, following the dashboard date range. Weekly and monthly grouping aggregate the daily buckets.`},N=`stats`,P=`framed`,F={name:k,title:A,description:j,help:M,category:N,presentation:P}}));function I({metric:e,interval:t,chartType:n},r=!1){return{reportParams:{...u(r,_e(t)),interval:t,post_id:V},metric:e,chartType:n}}function L(e){return(0,z.jsx)(w,{attributes:I(e)})}function R(e){return(0,z.jsx)(w,{attributes:{reportParams:{...u(!1),interval:`day`,post_id:e},metric:`opens`}})}function Te({metric:e,interval:t,chartType:n,...r}){return(0,z.jsx)(he,{...r,widgetType:me(F,O),renderModule:B,renderComponent:w,attributes:I({metric:e,interval:t,chartType:n},!0)})}var z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),g(),m(),v(),fe(),ve(),y(),Se(),Ce(),we(),z=r(),ue(),B=`storybook/email-time-series`,V=1234,H=[`opens`,`clicks`],U=[`day`,`week`,`month`],W={title:`Packages/Premium Analytics/Widgets/EmailTimeSeries`,component:w,tags:[`autodocs`],argTypes:{metric:{control:`select`,options:H},interval:{control:`select`,options:U},chartType:{control:`radio`,options:[`line`,`bar`]}},parameters:{docs:{description:{component:`The "Email performance" widget. Draws a single sent email's opens or clicks per day as a line chart, spanning the dashboard date range — the chart section of the legacy email detail page. The bucket size follows the page's chart interval control; weekly and monthly grouping aggregate the daily buckets client-side because the endpoint only reports hourly/daily. Scoped to one email via a mocked \`reportParams.post_id\`. The post detail page has no comparison control, so comparison report params are ignored.`}}},decorators:[p]},G={render:L,args:{metric:`opens`,interval:`day`,chartType:`line`},decorators:[x]},K={render:L,args:{metric:`clicks`,interval:`day`,chartType:`line`},decorators:[x]},q={render:L,args:{metric:`opens`,interval:`week`,chartType:`line`},decorators:[x]},J={render:()=>R(5701),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(_(`stats/opens/emails`,`loading`),()=>_(`stats/opens/emails`,null))},Y={render:()=>R(5702),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(_(`stats/opens/emails`,`error`),()=>_(`stats/opens/emails`,null))},X={render:()=>R(5703),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(_(`stats/opens/emails`,`empty`),()=>_(`stats/opens/emails`,null))},Z={render:()=>(0,z.jsx)(w,{attributes:{reportParams:u(!1),metric:`opens`}}),decorators:[x]},Q={render:e=>(0,z.jsx)(Te,{...e}),args:{...ge,metric:`opens`,interval:`day`,chartType:`line`},argTypes:{...pe,metric:{control:`select`,options:H},interval:{control:`select`,options:U},chartType:{control:`radio`,options:[`line`,`bar`]}}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
