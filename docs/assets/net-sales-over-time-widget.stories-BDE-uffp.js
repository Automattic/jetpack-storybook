import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{n as i,sl as a}from"./build-module-Bb7IR3OP.js";import{$ as o,K as s,Y as c,q as l}from"./report-metric-B_pCRF_u.js";import{n as u,r as d}from"./line-chart-B-eKUSKr.js";import{t as ee,x as te}from"./src-B-_HxovR.js";import{dr as ne,xt as f}from"./chart-tooltip-C3qsgfTj.js";import{C as p,D as m,E as re,S as h,T as g,_,b as v,t as y,w as b,x}from"./src-BavSEOPJ.js";function S({attributes:e={},setError:n}){return(0,C.jsx)(o,{attributes:e,setError:n,options:{from:`/`},children:(0,C.jsx)(_,{metricKey:`orders_value_net`,emptyStateText:t(`No sales in this period.`,`jetpack-premium-analytics-pkg`),errorText:t(`We couldn't load net sales. Please try again in a moment.`,`jetpack-premium-analytics-pkg`)})})}var C,w=e((()=>{y(),n(),C=r()})),T,E=e((()=>{i(),T={icon:a}})),D,O,k,A,j,M,N,P=e((()=>{D=`jpa/net-sales-over-time`,O=`Net sales over time`,k=`Monitor your total revenue after discounts, returns, or adjustments over a set period of time.`,A={content:`Monitor your total revenue — after any discounts, returns, or adjustments — over a set period of time.`},j=`orders`,M=`framed`,N={name:D,title:O,description:k,help:A,category:j,presentation:M}}));function F(e=!1,t=U){return{reportParams:ne(e,t)}}function I({withComparison:e,preset:t}){let n=!!e,r=t??U;return!n&&r===U?`getDefaultQueryParams()`:n&&r===U?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function L(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<NetSalesOverTimeRender
\tattributes={ {
\t\treportParams: ${I(e)},
\t} }
/>`}function R({withComparison:e,preset:t}){return G(),(0,V.jsx)(S,{attributes:F(e,t)})}function z(e){return G(),(0,V.jsx)(S,{attributes:F(!1,e)})}function B({withComparison:e,preset:t,...n}){return G(),(0,V.jsx)(g,{...n,widgetType:h(N,T),renderModule:H,renderComponent:S,attributes:F(e,t)})}var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{f(),ee(),re(),p(),v(),d(),s(),w(),E(),P(),V=r(),l(),H=`storybook/net-sales-over-time`,U=`last-30-days`,W=te,G=()=>u.Legend,K={title:`Packages/Premium Analytics/Widgets/NetSalesOverTime`,component:S,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:W,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`The "Net sales over time" widget. Fetches the orders report and displays net sales for the selected period with optional period-over-period comparison and a line chart.`}}}},q={render:R,args:{preset:U,withComparison:!1},decorators:[x],parameters:{docs:{source:{transform:(e,t)=>L(t.args)}}}},J={render:R,args:{preset:U,withComparison:!0},decorators:[x],parameters:{docs:{source:{transform:(e,t)=>L(t.args)}}}},Y={render:()=>z(`last-90-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(c(`orders/by-date`,`loading`),()=>c(`orders/by-date`,null))},X={render:()=>z(`last-7-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(c(`orders/by-date`,`error`),()=>c(`orders/by-date`,null))},Z={render:()=>z(`last-365-days`),tags:[`!autodocs`],decorators:[x],beforeEach:()=>(c(`orders/by-date`,`empty`),()=>c(`orders/by-date`,null))},Q={render:e=>(0,V.jsx)(B,{...e}),args:{...b,preset:U,withComparison:!0},argTypes:{...m,preset:{control:`select`,options:W,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
