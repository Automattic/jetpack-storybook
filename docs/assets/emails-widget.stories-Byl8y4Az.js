import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-yGZutq_9.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Gu as i,Nu as a,Ps as o,t as s}from"./build-module-zwSmKorH.js";import{B as c,V as l,_ as u,y as d}from"./wp-date-settings-ax8zy8F2.js";import{n as ee,t as te}from"./src-96RytICS.js";import{en as f,i as p,v as ne}from"./date-filters-panel-lhYvONgN.js";import"./constants-B1kGztHF.js";import{t as re}from"./leaderboard-skeleton-62EA_h6C.js";import{t as ie}from"./metric-list-C-2TwLSG.js";import{G as ae,I as oe,K as se,S as ce,Y as m,b as le}from"./report-metric-Cy_uY6-D.js";import{t as ue}from"./widget-state-DsZNE4y_.js";import{C as de,D as fe,E as h,O as pe,S as g,T as me,b as he,k as _,t as v,w as ge,x as y}from"./src-CQCD0nxF.js";var b,x,S,C,_e=e((()=>{b=`_widget_1veb5_3`,x=`_body_1veb5_11`,S=`_list_1veb5_18`,C={widget:b,body:x,list:S}}));function ve(e,t){return(e?.data?.[0]?.items??[]).slice(0,t>0?t:void 0).map((e,t)=>({id:e.id??t,postId:e.id,link:typeof e.link==`string`?e.link:null,label:String(e.label??``),opensRate:e.opens_rate,clicksRate:e.clicks_rate}))}function ye({attributes:e}){let n=e?.metric??`opens`,{data:r,isLoading:a,isFetching:s,isError:c,refetch:l}=ne({quantity:10}),u=(0,i.useMemo)(()=>ve(r,10),[r]);return(0,T.jsxs)(`div`,{className:C.widget,children:[(0,T.jsx)(`div`,{className:C.body,children:(0,T.jsx)(ue,{isLoading:a,isFetching:s,isError:u.length===0&&c,isEmpty:u.length===0,error:{description:t(`We couldn't load email stats. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:l}]},empty:{icon:o,description:t(`Your latest emails will appear here once you send a newsletter.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,T.jsx)(re,{rows:10}),children:(0,T.jsx)(D,{rows:u,metric:n})})}),(0,T.jsx)(ce,{children:(0,T.jsx)(le,{report:`emails`})})]})}function w({attributes:e={}}){return(0,T.jsx)(d,{attributes:e,children:(0,T.jsx)(ye,{attributes:e})})}var T,E,D,be=e((()=>{p(),te(),v(),a(),n(),s(),_e(),T=r(),E={opens:`email-opens`,clicks:`email-clicks`},D=({rows:e=[],metric:t=`opens`})=>{let n=u(E[t]),r=e.map(e=>{let r=t===`clicks`?e.clicksRate:e.opensRate;return{id:e.id,label:(0,T.jsx)(oe,{id:e.postId,label:e.label,link:e.link,search:n,title:e.label}),value:ee(r/100,`percentage`,{decimals:2,signDisplay:`never`})}});return(0,T.jsx)(ie,{className:C.list,items:r})}})),O,xe=e((()=>{n(),s(),c(),O={icon:o,attributes:[{id:`metric`,label:t(`View by`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:l,elements:[{label:t(`By open rate`,`jetpack-premium-analytics-pkg`),value:`opens`},{label:t(`By click rate`,`jetpack-premium-analytics-pkg`),value:`clicks`}],relevance:`high`}],example:{attributes:{metric:`opens`}}}})),k,A,j,M,N,P,F,Se=e((()=>{k=`jpa/stats-emails`,A=`Latest emails sent`,j=`Open and click rates for your latest emails.`,M={content:`Your most recently sent emails, including their open and click rates.`},N=`stats`,P=`framed`,F={name:k,title:A,description:j,help:M,category:N,presentation:P}}));function I(){return(0,L.jsx)(w,{attributes:{metric:`opens`}})}function Ce(e){return(0,L.jsx)(me,{...e,widgetType:g(F,O),renderModule:R,renderComponent:w,attributes:{metric:`opens`}})}var L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{p(),v(),ae(),h(),pe(),de(),he(),be(),xe(),Se(),L=r(),se(),R=`storybook/emails`,z={title:`Packages/Premium Analytics/Widgets/Emails`,component:D,tags:[`autodocs`],parameters:{docs:{description:{component:`Lists the latest emails with their open or click rate. Close-up stories use fixtures; the dashboard story uses a mocked report.`}}}},B=[{id:1,postId:1,link:`https://example.com/stand-out/`,label:`4 Ways to Make Your Website Stand Out`,opensRate:38.1,clicksRate:3.81},{id:2,postId:2,link:`https://example.com/develop-locally/`,label:`Develop Locally on Linux with WordPress.com`,opensRate:41.2,clicksRate:5.98},{id:3,postId:3,link:`https://example.com/new-themes/`,label:`10 Brand-New WordPress.com Themes for 2026`,opensRate:35.7,clicksRate:7.12},{id:4,postId:4,link:`https://example.com/languages/`,label:`WordPress.com Is Now Available in More Languages`,opensRate:52.4,clicksRate:8.93},{id:5,postId:5,link:`https://example.com/wordcamp-europe/`,label:`WordCamp Europe 2026: What to Expect`,opensRate:47.9,clicksRate:10.25},{id:6,postId:6,link:`https://example.com/collaborate/`,label:`Click, Comment, Done: A Better Way to Collaborate`,opensRate:44.3,clicksRate:10.38}],V=[{id:1,postId:1,link:`https://example.com/long-subject/`,label:`An exhaustively long, keyword-stuffed subject line that almost certainly needs to be truncated before it overflows the row`,opensRate:22.5,clicksRate:4.1},{id:2,postId:2,link:`https://example.com/monthly-digest/`,label:`Your monthly digest: billing, new features, and what is coming next`,opensRate:33.8,clicksRate:6.7}],H=e=>(0,L.jsx)(d,{attributes:{reportParams:f()},children:(0,L.jsx)(e,{})}),U={args:{rows:B},decorators:[y,H,_]},W={args:{rows:B,metric:`clicks`},decorators:[y,H,_]},G={render:I,tags:[`!autodocs`],decorators:[y,_],beforeEach:()=>(m(`stats/emails/summary`,`loading`),()=>m(`stats/emails/summary`,null))},K={render:I,tags:[`!autodocs`],decorators:[y,_],beforeEach:()=>(m(`stats/emails/summary`,`error`),()=>m(`stats/emails/summary`,null))},q={render:I,tags:[`!autodocs`],decorators:[y,_],beforeEach:()=>(m(`stats/emails/summary`,`empty`),()=>m(`stats/emails/summary`,null))},J={args:{rows:V},decorators:[y,H,_]},Y=(e,t=`auto`)=>n=>(0,L.jsx)(`div`,{style:{width:e,height:t,border:`1px dashed #ccc`,borderRadius:`8px`,containerType:`inline-size`,containerName:`widget`},children:(0,L.jsx)(n,{})}),X={args:{rows:B},decorators:[Y(`448px`),H,_]},Z={args:{rows:B},decorators:[Y(`576px`),H,_]},Q={render:e=>(0,L.jsx)(Ce,{...e}),args:{...ge},argTypes:{...fe}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  args: {
    rows: mockRows
  },
