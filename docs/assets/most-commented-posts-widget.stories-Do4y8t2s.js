import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as ee,t as i}from"./build-module-CbwHEf9N.js";import{Cc as a,_c as o,n as s}from"./build-module-CDRs4YxF.js";import{lr as c,t as l}from"./src-Cj2yZD02.js";import{$ as u,E as te,K as ne,S as d,W as f,q as re,w as ie}from"./report-metric-DtkHkW5i.js";import{Ct as p,Y as ae,g as oe,p as m,pr as h,tn as se}from"./chart-tooltip-DRpnI8PA.js";import{t as ce}from"./leaderboard-chart-CeddhB1L.js";import{C as le,D as g,E as _,O as v,S as y,T as b,b as x,k as S,t as C,w,x as T}from"./src-CUWChwKq.js";import{t as ue}from"./widget-state-C2ZQVK4C.js";var E,D,O,de=e((()=>{E=`_root_1hs5m_1`,D=`_content_1hs5m_11`,O={root:E,content:D}}));function fe({max:e}){let{rows:n,isLoading:r,isFetching:i,isError:o,error:s,refetch:l}=se({group:`posts`,max:e}),u=(0,ee.useMemo)(()=>{let e=Math.max(...n.map(e=>e.value),0);return n.map(t=>({id:t.id,label:(0,A.jsx)(d,{id:t.postId,label:t.label,link:t.link}),currentValue:t.value,currentShare:ae(t.value,e)}))},[n]);return(0,A.jsxs)(c,{className:O.root,children:[(0,A.jsx)(`div`,{className:O.content,children:(0,A.jsx)(ue,{isLoading:r,isFetching:i,isError:o,isEmpty:n.length===0,error:m(s,{retryDescription:t(`We couldn't load commented posts. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:l}),empty:{icon:a,description:t(`None of your posts or pages have comments yet.`,`jetpack-premium-analytics-pkg`)},children:(0,A.jsx)(ce,{data:u,withOverlayLabel:!0,showLegend:!1,dataFormat:j})})}),(0,A.jsx)(te,{children:(0,A.jsx)(ie,{report:`comments`,section:`posts`,ariaLabel:t(`See the commented posts report`,`jetpack-premium-analytics-pkg`)})})]})}function k({attributes:e={}}){return(0,A.jsx)(u,{attributes:e,children:(0,A.jsx)(fe,{max:oe(e.max,M)})})}var A,j,M,N=e((()=>{p(),C(),i(),n(),s(),l(),de(),A=r(),j={type:`number`,options:{useMultipliers:!0,decimals:0}},M=10})),P,F=e((()=>{n(),s(),P={icon:o,attributes:[{id:`max`,label:t(`Number of results`,`jetpack-premium-analytics-pkg`),type:`integer`}],example:{attributes:{max:10}}}})),I,L,R,z,B,V,H,pe=e((()=>{I=`jpa/most-commented-posts`,L=`Top commented posts`,R=`The posts and pages that receive the most comments.`,z={content:`Your posts and pages, ranked by the number of comments they have received.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},B=`stats`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function U(){return(0,W.jsx)(k,{attributes:{reportParams:h()}})}function me(e){return(0,W.jsx)(b,{...e,widgetType:y(H,P),renderModule:G,renderComponent:k,attributes:{reportParams:h(!0)}})}var W,G,K,q,J,Y,X,Z,Q,$;e((()=>{p(),_(),le(),v(),x(),ne(),N(),F(),pe(),W=r(),re(),G=`storybook/most-commented-posts`,K={title:`Packages/Premium Analytics/Widgets/MostCommentedPosts`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:`The "Top commented posts" widget. Ranks the posts and pages that receive the most comments, linking each row to the published post. One half of the Jetpack Stats Comments module; "Top commented authors" covers the other.`}}}},q={render:U,decorators:[T,S]},J={render:U,tags:[`!autodocs`],decorators:[T,S],beforeEach:f(`loading`)},Y={render:U,tags:[`!autodocs`],decorators:[T,S],beforeEach:f(`error`)},X={render:U,tags:[`!autodocs`],decorators:[T,S],beforeEach:f(`error-retryable`)},Z={render:U,tags:[`!autodocs`],decorators:[T,S],beforeEach:f(`empty`)},Q={render:e=>(0,W.jsx)(me,{...e}),args:{...w},argTypes:{...g},decorators:[S]},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
