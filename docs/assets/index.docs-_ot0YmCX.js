import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-fc4y4gwJ.js";import{i as r,n as i,r as a,t as o}from"./blocks-ChAGWkSV.js";import{t as s}from"./mdx-react-shim-DLqIiLmH.js";import{AdvancedFormatting as c,Animation as l,CurrencyFormatting as u,CustomColors as d,CustomLabel as f,Default as p,EmptyData as m,EmptyDataWithChildren as h,Interactive as g,LargeValues as _,Loading as v,NegativeGrowth as y,NumberFormatting as b,OverlayLabelWithImage as x,SmallDataset as S,WithCompositionLegend as C,WithLegendLabels as w,WithOverlayLabel as T,WithoutComparison as E,n as D,t as O}from"./index.stories-CMgpek2k.js";function k(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(i,{title:`JS Packages/Charts Library/Charts/Leaderboard Chart`,of:O}),`
...
`,(0,j.jsxs)(t.li,{children:[(0,j.jsx)(t.strong,{children:(0,j.jsx)(t.code,{children:`aspectRatio`})}),`: Height-to-width ratio (e.g. `,(0,j.jsx)(t.code,{children:`0.4`}),`) for responsive charts; the chart is contained within its parent on both axes. When omitted, fills the parent container's height`]}),`
...
`,(0,j.jsxs)(t.p,{children:[`By default, leaderboard charts `,(0,j.jsx)(t.strong,{children:`fill their parent container's dimensions`}),`. The parent must have an explicit height, or the chart must receive an `,(0,j.jsx)(t.code,{children:`aspectRatio`}),`:`]}),`
`,(0,j.jsx)(a,{language:`tsx`,code:`// Fill parent container (default) - parent needs explicit height
