import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Bi as i,n as a}from"./build-module-CDRs4YxF.js";import{$ as o,G as s,K as c,rt as l,z as u}from"./report-metric-CZGk3pJU.js";import{T as d,t as f}from"./src-BKLK-O8P.js";import{Gt as p,g as m,t as h}from"./src-DCbi8ow8.js";import{n as ee,t as te}from"./src-CsA_y1X9.js";import{f as ne}from"./hooks-DKyvbkrh.js";import{M as re,x as ie}from"./chart-tooltip-mdsQYAXX.js";import{t as ae}from"./donut-chart-skeleton-DjmnlKSA.js";import{t as oe}from"./semi-circle-chart-hen4Awgv.js";import{t as se}from"./widget-state-CEIPGY-o.js";import{C as ce,D as le,E as g,S as ue,T as de,b as fe,t as _,w as pe,x as v}from"./src-BenUPZSz.js";import{n as y,t as me}from"./register-stats-mocks-DvTirN9o.js";import{n as he,t as b}from"./force-stats-mock-state-BccjPGiq.js";var x,S,C,w,T,ge=e((()=>{x=`_root_8laf6_1`,S=`_content_8laf6_9`,C=`_chartWrap_8laf6_17`,w=`_chartShell_8laf6_25`,T={root:x,content:S,chartWrap:C,chartShell:w}}));function _e(e){let t=typeof e.label==`string`?e.label:String(e.label);return{label:t,displayLabel:re(t,E),percentage:e.value,previousPercentage:e.previousValue}}function ve({reportParams:e,max:t,deviceProperty:n=`screensize`}){let{comparisonRows:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:l}=m({...e,deviceProperty:n},{maxRows:t}),u=(r?.rows??[]).map(_e),d=u.length===0&&s;return{data:u,hasComparison:i,isLoading:a,isFetching:o,isError:d,error:d?c:null,refetch:l}}var E,ye=e((()=>{n(),h(),_(),E={desktop:t(`Desktop`,`jetpack-premium-analytics-pkg`),mobile:t(`Mobile`,`jetpack-premium-analytics-pkg`),tablet:t(`Tablet`,`jetpack-premium-analytics-pkg`),phone:t(`Phone`,`jetpack-premium-analytics-pkg`),unknown:t(`Unknown`,`jetpack-premium-analytics-pkg`)}}));function D(e){return e/100}function be({max:e}){let{reportParams:n}=l(),{data:r,hasComparison:i,isLoading:a,isFetching:o,isError:s,error:c,refetch:f}=ve({reportParams:n,max:e,deviceProperty:`screensize`}),p=r.map(e=>({label:e.displayLabel,value:D(e.percentage)})),m=ne(p),h=r.map(e=>({label:e.displayLabel,value:D(e.percentage),displayValue:ee(D(e.percentage),A.type,A.options),comparison:i&&e.previousPercentage!==void 0?D(e.previousPercentage):void 0})).map((e,t)=>({...e,color:m[t]?.color}));return(0,k.jsx)(`div`,{className:T.content,children:(0,k.jsx)(se,{isLoading:a,isFetching:o,isError:s,isEmpty:r.length===0,error:ie(c,{retryDescription:t(`We couldn't load device data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:f}),empty:{icon:d,description:t(`No device data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,k.jsx)(ae,{}),children:(0,k.jsx)(`div`,{className:T.chartWrap,children:(0,k.jsxs)(`div`,{className:T.chartShell,children:[(0,k.jsx)(oe,{chartData:p,styles:m,showLegend:!1,showMetric:!1,withTooltips:!0,dataFormat:A}),(0,k.jsx)(u,{items:h,withComparison:i})]})})})})}function O({attributes:e={}}){let t=e?.max??5;return(0,k.jsx)(o,{attributes:e,children:(0,k.jsx)(`div`,{className:T.root,children:(0,k.jsx)(be,{max:t})})})}var k,A,j=e((()=>{te(),f(),n(),_(),ge(),ye(),k=r(),A={type:`percentage`,options:{decimals:1,signDisplay:`auto`}}})),M,xe=e((()=>{n(),a(),M={icon:i,attributes:[{id:`max`,label:t(`Number of results`,`jetpack-premium-analytics-pkg`),type:`integer`}],example:{attributes:{max:5}}}})),N,P,F,I,L,R,z,Se=e((()=>{N=`jpa/devices`,P=`Devices`,F=`Top device types and screen sizes for your visitors.`,I={content:`A breakdown of the device types your visitors used, sorted by views.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},L=`traffic`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function B({withComparison:e}){return(0,H.jsx)(O,{attributes:{max:5,reportParams:p(e)}})}function V(e){return(0,H.jsx)(O,{attributes:{max:5,reportParams:p(!1,e)}})}function Ce(e){return(0,H.jsx)(O,{...e})}function we({withComparison:e,...t}){return(0,H.jsx)(de,{...t,widgetType:W,renderModule:U,renderComponent:Ce,attributes:{max:5,reportParams:p(e)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{h(),g(),ce(),fe(),s(),me(),he(),j(),xe(),Se(),H=r(),c(),y(),U=`storybook/devices`,W=ue(z,M),G={title:`Packages/Premium Analytics/Widgets/Devices`,component:O,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`The "Devices" widget. Shows screen size breakdown (Desktop / Mobile / Tablet) as a semi-circle chart, using the global dashboard date range.`}}}},K={render:B,args:{withComparison:!1},decorators:[v]},q={render:B,args:{withComparison:!0},decorators:[v]},J={render:()=>V(`last-90-days`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>(b(`stats/devices/screensize`,`loading`),()=>b(`stats/devices/screensize`,null))},Y={render:()=>V(`last-7-days`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>(b(`stats/devices/screensize`,`error`),()=>b(`stats/devices/screensize`,null))},X={render:()=>V(`last-12-months`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>(b(`stats/devices/screensize`,`error-retryable`),()=>b(`stats/devices/screensize`,null))},Z={render:()=>V(`last-year`),tags:[`!autodocs`],decorators:[v],beforeEach:()=>(b(`stats/devices/screensize`,`empty`),()=>b(`stats/devices/screensize`,null))},Q={render:e=>(0,H.jsx)(we,{...e}),args:{...pe,withComparison:!0},argTypes:{...le,withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
