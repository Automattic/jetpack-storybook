import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-D-fdyp_a.js";import{i as r,n as i,r as a,t as o}from"./blocks-Dujyf_WO.js";import{t as s}from"./mdx-react-shim-BGrAAvxF.js";import{Default as c,HostLocaleAndTimeZoneFormatDates as l,WithColorOverrides as u,n as d,t as f}from"./index.stories-BB2p4wuW.js";function p(e){let t={a:`a`,code:`code`,em:`em`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...n(),...e.components};return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(i,{title:`JS Packages/Charts Library/Chart Context`,of:f}),`
...
`,(0,h.jsxs)(t.li,{children:[(0,h.jsx)(t.code,{children:`theme.colors[ N - 1 ]`}),`, which writes slot N from JS. `,(0,h.jsx)(t.strong,{children:`Deprecated`}),` — see below.`]}),`
...
`,(0,h.jsx)(a,{language:`tsx`,code:`// Deprecated: theme.colors writes the slots from JS.
...
`,(0,h.jsxs)(t.p,{children:[`The `,(0,h.jsx)(t.code,{children:`theme`}),` prop's matching color fields are deprecated and will be removed; `,(0,h.jsx)(t.code,{children:`TOKENS.md`}),` maps each one to the role that replaces it. What stays on `,(0,h.jsx)(t.code,{children:`theme`}),` is everything with no role behind it — `,(0,h.jsx)(t.code,{children:`tickLength`}),`, stroke widths, font weights, the heatmap's compact sizing, the annotation geometry:`]}),`
...
`,(0,h.jsxs)(t.p,{children:[`A field you leave out doesn't fall back to a separate JS default value — it falls through to the catalog default, because `,(0,h.jsx)(t.code,{children:`defaultTheme`}),` holds a `,(0,h.jsx)(t.code,{children:`--a8c-charts-*`}),` pointer for every color rather than a literal. Omitting a color is therefore how you opt into design-system theming, not how you opt out of theming.`]}),`
...
`,(0,h.jsx)(t.p,{children:`Three placements need care:`}),`
`,(0,h.jsxs)(t.ul,{children:[`
`,(0,h.jsxs)(t.li,{children:[`
`,(0,h.jsxs)(t.p,{children:[(0,h.jsx)(t.strong,{children:`A chart's own class is too deep to reach the SVG colors.`}),` Setting a role on the element a chart's `,(0,h.jsx)(t.code,{children:`className`}),` lands on — `,(0,h.jsx)(t.code,{children:`.line-chart { --a8c-charts-color-grid: … }`}),` — moves everything that chart paints in CSS, but not the gridlines, axis lines or tick labels: visx and Google Charts need concrete values, which are resolved in JS at the chart's scope element, an ancestor of the class you targeted. The result is a half-applied override, so scope this kind of rule to a wrapper `,(0,h.jsx)(t.strong,{children:`around`}),` the chart instead. Supporting it on the chart itself is tracked in CHARTS-255.`]}),`
`]}),`
`,(0,h.jsxs)(t.li,{children:[`
`,(0,h.jsxs)(t.p,{children:[(0,h.jsx)(t.strong,{children:`Tooltips rendered in a portal`}),` — those of `,(0,h.jsx)(t.code,{children:`PieChart`}),`, `,(0,h.jsx)(t.code,{children:`PieSemiCircleChart`}),`, `,(0,h.jsx)(t.code,{children:`HeatmapChart`}),` and `,(0,h.jsx)(t.code,{children:`ConversionFunnelChart`}),`, which position through `,(0,h.jsx)(t.code,{children:`@visx/tooltip`}),`'s `,(0,h.jsx)(t.code,{children:`useTooltipInPortal`}),` — sit outside the provider's DOM tree, so they re-declare the catalog on themselves and never see an override scoped to the provider or to an element inside it. They do carry the scope class, so the `,(0,h.jsx)(t.code,{children:`.a8c-charts-scope`}),` rule above reaches them.`]}),`
`]}),`
`,(0,h.jsxs)(t.li,{children:[`
...
`]}),`
`]}),`
`,(0,h.jsxs)(t.p,{children:[`The `,(0,h.jsx)(t.code,{children:`theme`}),` prop is a second, narrower override path. Five `,(0,h.jsx)(t.code,{children:`ChartTheme`}),` fields map to a catalog role, and setting one publishes it as that role's theme-layer variable (`,(0,h.jsx)(t.code,{children:`--a8c-charts-color-grid-theme`}),` for the grid) on the provider wrapper — so it also reaches the SVG- and Google-Charts-painted colors those tools can't read from `,(0,h.jsx)(t.code,{children:`theme`}),` directly:`]}),`
`,(0,h.jsxs)(t.table,{children:[(0,h.jsx)(t.thead,{children:(0,h.jsxs)(t.tr,{children:[(0,h.jsxs)(t.th,{children:[(0,h.jsx)(t.code,{children:`theme`}),` field`]}),(0,h.jsx)(t.th,{children:`Catalog role`})]})}),(0,h.jsxs)(t.tbody,{children:[(0,h.jsxs)(t.tr,{children:[(0,h.jsx)(t.td,{children:(0,h.jsx)(t.code,{children:`backgroundColor`})}),(0,h.jsx)(t.td,{children:(0,h.jsx)(t.code,{children:`--a8c-charts-color-background`})})]}),(0,h.jsxs)(t.tr,{children:[(0,h.jsx)(t.td,{children:(0,h.jsx)(t.code,{children:`gridStyles.stroke`})}),(0,h.jsx)(t.td,{children:(0,h.jsx)(t.code,{children:`--a8c-charts-color-grid`})})]}),(0,h.jsxs)(t.tr,{children:[(0,h.jsx)(t.td,{children:(0,h.jsx)(t.code,{children:`xAxisLineStyles.stroke`})}),(0,h.jsx)(t.td,{children:(0,h.jsx)(t.code,{children:`--a8c-charts-color-axis`})})]}),(0,h.jsxs)(t.tr,{children:[(0,h.jsx)(t.td,{children:(0,h.jsx)(t.code,{children:`xTickLineStyles.stroke`})}),(0,h.jsx)(t.td,{children:(0,h.jsx)(t.code,{children:`--a8c-charts-color-tick`})})]}),(0,h.jsxs)(t.tr,{children:[(0,h.jsx)(t.td,{children:(0,h.jsx)(t.code,{children:`svgLabelSmall.fill`})}),(0,h.jsx)(t.td,{children:(0,h.jsx)(t.code,{children:`--a8c-charts-color-label-axis`})})]})]})]}),`
`,(0,h.jsxs)(t.p,{children:[`Each field publishes a role read by exactly the elements that field already controlled, so a `,(0,h.jsx)(t.code,{children:`theme`}),` override never spreads further than the element class it names. Where the obvious role has wider readership, one side takes a role of its own: `,(0,h.jsx)(t.code,{children:`svgLabelSmall.fill`}),` writes the narrow `,(0,h.jsx)(t.code,{children:`--a8c-charts-color-label-axis`}),`, leaving legend labels, heatmap cell values, funnel labels and the line-chart tooltip on the broad `,(0,h.jsx)(t.code,{children:`--a8c-charts-color-label`}),`. Set the broad role in CSS to move them all together.`]}),`
`,(0,h.jsxs)(t.p,{children:[`A CSS declaration of the role wins over the `,(0,h.jsx)(t.code,{children:`theme`}),` prop wherever you set it, the provider wrapper included: the prop writes the theme layer, and a role declared in CSS never reads that layer.`]}),`
`,(0,h.jsxs)(t.p,{children:[`Publishing the value one layer out is what keeps the catalog default reachable. An override CSS cannot resolve — most often `,(0,h.jsx)(t.code,{children:`var(--wpds-…)`}),` with no fallback, when the design-system stylesheet isn't loaded — leaves the role resolving its own mapped token instead of taking every reader of that role down with it. A value that points at the role it would override is not published at all, since that would make the role depend on itself; the field falls back to the catalog default on both the CSS and SVG paths, so the two never disagree.`]}),`
...
`,(0,h.jsxs)(t.p,{children:[`Returns the element a chart's tokens resolve against — the wrapper the chart renders into, which is where an override set anywhere between the provider and that chart has landed. Pair it with `,(0,h.jsx)(t.code,{children:`normalizeColorToHex`}),` and `,(0,h.jsx)(t.code,{children:`resolveCssVariable`}),` when JS needs a `,(0,h.jsx)(t.em,{children:`resolved`}),` color rather than the token string: computing text contrast against `,(0,h.jsx)(t.code,{children:`theme.backgroundColor`}),`, for example, or feeding a color to Google Charts, which cannot read `,(0,h.jsx)(t.code,{children:`var()`}),`.`]}),`
...
`,(0,h.jsx)(t.h3,{id:`theme-color-considerations`,children:`Theme Color Considerations`}),`
`,(0,h.jsx)(t.p,{children:`When creating custom themes, ensure sufficient contrast between background and foreground colors to meet WCAG AA standards (4.5:1 for normal text, 3:1 for large text)`}),`
...
`,(0,h.jsxs)(t.li,{children:[(0,h.jsx)(t.strong,{children:`Hue range constraint`}),` - Generated colors stay within an expanded range (130%) of your theme's existing colors`]}),`
`,(0,h.jsxs)(t.li,{children:[(0,h.jsx)(t.strong,{children:`Wrap-around handling`}),` - Intelligently handles cases where theme colors span across the 0° hue boundary`]}),`
`]}),`
