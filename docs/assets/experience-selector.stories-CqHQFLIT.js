import{n as e}from"./chunk-zsgVPwQN.js";import{Al as t,Ba as n,Bl as r,Ec as i,Gl as a,Ul as o,Wl as s,fv as c,gv as l,hv as u}from"./iframe-l5abvtsG.js";import{c as d,i as f,l as p,n as m,o as h,r as g,s as _,t as v}from"./experience-option-ijZCmQ6R.js";var y=e((()=>{}));function b(){let{isUpdating:e,supportsOnlyClassicSearch:t,isWpcom:n,blockOverlayEnabled:a}=r(e=>({isUpdating:e(_).isUpdatingJetpackSettings(),supportsOnlyClassicSearch:e(_).supportsOnlyClassicSearch(),isWpcom:e(_).isWpcom(),blockOverlayEnabled:e(_).isBlockOverlayEnabled()}),[]),o=f.filter(e=>!(e===g.OFF&&n||e===g.OVERLAY_BLOCKS&&!a)),s=n=>e||t&&(n===g.EMBEDDED||n===g.OVERLAY||n===g.OVERLAY_BLOCKS);return(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`h2`,{id:`jp-search-experience-selector-heading`,className:`jp-search-experience-selector__heading`,children:l(`Select a search experience for your visitors`,`jetpack-search-pkg`)}),(0,x.jsx)(`div`,{className:`jp-search-experience-selector`,children:(0,x.jsx)(`fieldset`,{className:`jp-search-experience-selector__fieldset`,"aria-labelledby":`jp-search-experience-selector-heading`,children:(0,x.jsx)(i,{columns:[1,2],gap:6,children:o.map(e=>(0,x.jsx)(v,{experience:e,disabled:s(e)},e))})})})]})}var x,S=e((()=>{n(),t(),u(),d(),h(),m(),y(),x=c(),b.__docgenInfo={description:`Top-level dashboard control: a fieldset of cards. Inactive cards behave
