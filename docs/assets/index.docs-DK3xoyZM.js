import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-DBwT_ZUA.js";import{i as r,n as i,r as a}from"./blocks-D6zY7OVb.js";import{t as o}from"./mdx-react-shim-DPxuJ_g1.js";function s(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...n(),...e.components};return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(i,{title:`JS Packages/Charts Library/Introduction`}),`
...
`,(0,l.jsxs)(t.li,{children:[`✨ `,(0,l.jsx)(t.strong,{children:`Rich Chart Types`}),` - Bar charts, bar list charts, conversion funnel charts, donut charts, geo charts, heatmap charts, leaderboard visualizations, line charts, pie charts, and sparklines`]}),`
...
`,(0,l.jsx)(a,{language:`jsx`,code:`import { LineChart, GlobalChartsProvider } from '@automattic/charts';
...
`,(0,l.jsx)(a,{language:`jsx`,code:`// Add this import to your app's entry point if tokens aren't already available
...
`,(0,l.jsx)(t.h3,{id:`heatmap-chart`,children:(0,l.jsx)(t.a,{href:`./?path=/docs/js-packages-charts-library-charts-heatmap-chart--docs`,children:`Heatmap Chart`})}),`
`,(0,l.jsxs)(t.p,{children:[`Visualize values across a two-dimensional matrix of cells on a sequential color scale. Supports a compact mode for short widgets, column groups, and calendar layouts: a contribution graph via `,(0,l.jsx)(t.code,{children:`useCalendarHeatmapData`}),` and one calendar per month via `,(0,l.jsx)(t.code,{children:`useMonthCalendarHeatmapData`}),`.`]}),`
...
`,(0,l.jsxs)(t.p,{children:[`Use the `,(0,l.jsx)(t.code,{children:`GlobalChartsProvider`}),` component to apply consistent styling across all charts. Create custom themes by defining the properties you want to override, such as grid styling, typography and spacing.`]}),`
`,(0,l.jsxs)(t.p,{children:[`Colors are not theme-object properties. Chart colors use `,(0,l.jsx)(t.code,{children:`--a8c-charts-color-*`}),` custom properties set in CSS inside the provider tree; see `,(0,l.jsx)(t.a,{href:`./?path=/docs/js-packages-charts-library-global-context--docs`,children:`the token catalog`}),` and `,(0,l.jsx)(t.a,{href:`./?path=/docs/js-packages-charts-library-charts-bar-chart--docs#theming-integration`,children:`bar color configuration`}),` for overrides.`]}),`
...
`,(0,l.jsx)(a,{language:`jsx`,code:`// Chart fills parent container's width and height
...
`,(0,l.jsxs)(t.p,{children:[`For layouts where the container width varies but you want consistent proportions, pass the `,(0,l.jsx)(t.code,{children:`aspectRatio`}),` prop:`]}),`
`,(0,l.jsx)(a,{language:`jsx`,code:`// Height from width; contained if the parent is shorter
<div style={{ width: '100%' }}>
	<LineChart data={data} aspectRatio={0.5} />
</div>`}),`
`,(0,l.jsx)(t.p,{children:`The chart keeps this ratio, contained within its parent on both axes: it fills the available width and derives its height, but shrinks both axes to fit a shorter parent rather than overflowing. A taller parent leaves space below rather than stretching the chart.`}),`
...
`,(0,l.jsx)(a,{language:`jsx`,code:`import { LineChartUnresponsive } from '@automattic/charts';
...
`]}),`
`,(0,l.jsx)(t.p,{children:`Start exploring the components and examples in the sidebar to see the full capabilities of the Automattic Charts library!`})]})}function c(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,l.jsx)(t,{...e,children:(0,l.jsx)(s,{...e})}):s(e)}var l;e((()=>{l=t(),o(),r()}))();export{c as default};