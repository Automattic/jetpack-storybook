import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{Bn as r,Hn as i,cv as a,dv as o,fv as s,lv as c,qv as l,uv as u}from"./iframe-B2Km9nLl.js";import{A as d,_ as f,a as ee,d as p,f as te,g as m,h as ne,i as h,m as re,n as ie,p as ae,r as oe,t as g,y as se}from"./providers-xS9Y0ONj.js";import{T as ce,d as le,f as ue,n as de,p as fe,r as pe,s as me,t as _}from"./esm-DVNB2Z1N.js";import{a as he,c as ge,i as _e,o as ve,s as ye}from"./line-chart-D58toExW.js";import{c as v,n as be,o as xe,r as Se,s as Ce,t as we}from"./chart-decorator-BHprBeLk.js";import{n as Te,r as Ee,t as De}from"./legend-config-CMmYe-9-.js";import{n as y,t as Oe}from"./tooltip-config-PL8Zn6h3.js";import{b as ke,c as Ae,y as b}from"./sample-data-BajYV1Sh.js";import{t as x}from"./stories-FY-o0B0f.js";import{c as je,d as Me,i as Ne,l as Pe,n as Fe,p as Ie,r as Le,s as Re,t as ze}from"./chart-layout-uagiEq9c.js";import{n as Be,r as Ve,t as He}from"./tooltip-DVjnQCxI.js";import{n as Ue,t as S}from"./svg-empty-state-D4WyW-xo.js";import{n as We,t as Ge}from"./with-responsive-BwDPOFZN.js";import{t as Ke}from"./line-chart-Cgs3RX8g.js";var qe,C,Je=e((()=>{qe=`_rise_sezj1_1`,C={"area-chart":`_area-chart_sezj1_1`,"area-chart--animated":`_area-chart--animated_sezj1_4`,rise:qe}})),Ye,w=e((()=>{o(),Ye=e=>!e?.length||e.some(e=>!e.data?.length)?s(`No data available`,`jetpack-charts`):e.some(e=>e.data.some(e=>isNaN(e.value)||e.value===null||e.value===void 0||`date`in e&&e.date&&isNaN(e.date.getTime())))?s(`Invalid data`,`jetpack-charts`):null})),T,E,Xe,Ze,D=e((()=>{_(),T=t(l(),1),E=a(),Xe=({chartRef:e,width:t,height:n,margin:r})=>{let i=(0,T.useContext)(ce);return(0,T.useImperativeHandle)(e,()=>({getScales:()=>!i?.xScale||!i?.yScale?null:{xScale:i.xScale,yScale:i.yScale},getChartDimensions:()=>({width:t,height:n,margin:r||{}})}),[i,t,n,r]),null},Ze=({visibleSeries:e,stacked:t,stackOffset:n,getElementStyles:r,strokeColor:i})=>{let a=(0,T.useContext)(ce),o=(0,T.useContext)(le),s=a?.xScale,c=a?.yScale,l=o?.tooltipOpen,u=o?.tooltipData?.nearestDatum?.datum;if(!l||!s||!c||!u||!u.date||t&&n!==`none`)return null;let d=Number(s(u.date));if(!Number.isFinite(d))return null;let f=u.date.getTime(),ee=0,p=[];for(let{series:n,index:a}of e){let e=n.data.find(e=>e.date?.getTime()===f),o=e?.value??0;if(t&&(ee+=o),!e||e.value==null)continue;let s=Number(c(t?ee:o));if(!Number.isFinite(s))continue;let{color:l}=r({data:n,index:a});p.push((0,E.jsx)(`circle`,{cx:d,cy:s,r:4,fill:l,stroke:i,strokeWidth:1.5,paintOrder:`fill`,"data-testid":`area-chart-hover-glyph-${a}`},n.label||a))}return p.length===0?null:(0,E.jsx)(`g`,{pointerEvents:`none`,className:`area-chart__hover-glyphs`,children:p})}})),Qe=e((()=>{w(),D()})),O,k,$e,A,j,et=e((()=>{i(),_(),o(),u(),O=t(l(),1),Re(),He(),h(),g(),se(),Ke(),Le(),ze(),Me(),S(),ge(),Ge(),Je(),Qe(),k=a(),$e=(0,O.forwardRef)(({data:e,chartId:t,width:n,height:i,className:a,margin:o,withTooltips:l=!0,withTooltipCrosshairs:u,showLegend:d=!1,legend:f={},stacked:m=!0,stackOffset:h=`none`,smoothing:g=!0,curveType:se,fillOpacity:ce,withStroke:le,renderTooltip:_=_e,animation:ge,options:v={},onPointerDown:be,onPointerUp:xe,onPointerMove:Se,onPointerOut:Ce,children:we,gridVisibility:Te,gap:Ee=`md`},De)=>{let y=f.interactive??!1,Oe=f.shape??`rect`,ke=f.position??`bottom`,Ae=ie(),b=ae(e),x=re(t),Me=(0,O.useRef)(null),[Le,Re]=(0,O.useState)(void 0),[ze,He]=(0,O.useState)(!1),S=(0,O.useRef)(null),{legendChildren:We,nonLegendChildren:Ge}=Ne(we,`AreaChart`),[Ke,qe]=(0,O.useState)(),Je=(0,O.useCallback)(e=>{qe(e>0?e:i)},[i]);(0,O.useImperativeHandle)(De,()=>({getScales:()=>S.current?.getScales()||null,getChartDimensions:()=>S.current?.getChartDimensions()||{width:0,height:0,margin:{}}}),[S]);let w=te(e),{getElementStyles:T,isSeriesVisible:E}=ne(),D=(0,O.useMemo)(()=>!x||!y?w.map((e,t)=>({series:e,index:t,isVisible:!0})):w.map((e,t)=>({series:e,index:t,isVisible:E(x,e.label)})),[w,x,E,y]),Qe=(0,O.useMemo)(()=>D.every(({isVisible:e})=>!e),[D]),{tooltipRef:$e,onChartFocus:A,onChartBlur:j,onChartKeyDown:et}=Ve({selectedIndex:Le,setSelectedIndex:Re,isNavigating:ze,setIsNavigating:He,chartRef:Me,totalPoints:w[0]?.data.length||0}),M=(0,O.useMemo)(()=>{if(!y||!w.length||!w[0].data.length||m&&h!==`none`)return;if(m){let e=Math.max(...w.map(e=>e.data.length)),t=0,n=0;for(let r=0;r<e;r++){let e=0,i=0;for(let t of w){let n=Number(t.data[r]?.value);Number.isNaN(n)||(n>=0?e+=n:i+=n)}e>t&&(t=e),i<n&&(n=i)}return[n,t]}let e=-1/0,t=1/0;for(let n of w)for(let r of n.data){let n=Number(r?.value);Number.isNaN(n)||(n>e&&(e=n),n<t&&(t=n))}if(e!==-1/0)return[Math.min(0,t),e]},[w,m,h,y]),N=(0,O.useMemo)(()=>{let e=v?.axis?.x?.tickFormat||ve(w);return{axis:{x:{orientation:`bottom`,numTicks:ye(w,n,e),tickFormat:e,display:!0,...v?.axis?.x},y:{orientation:`left`,numTicks:4,tickFormat:r,display:!0,...v?.axis?.y}},xScale:{type:`time`,...v?.xScale},yScale:{type:`linear`,nice:!0,zero:m,...M?{domain:M}:{},...v?.yScale}}},[v,w,n,m,M]),tt=p(i,N,w,b),nt=Ye(w),P=!nt;oe({chartId:x,legendItems:je(w,(0,O.useMemo)(()=>({withGlyph:!1,glyphSize:0}),[]),Oe),chartType:`area`,isDataValid:P,metadata:(0,O.useMemo)(()=>({stacked:m,stackOffset:h,smoothing:g,curveType:se}),[m,h,g,se])});let rt=ee(),F=!!ge&&!rt,I={xAccessor:e=>e?.date,yAccessor:e=>e?.value},L=(0,O.useCallback)(()=>0,[]),R=(0,O.useMemo)(()=>new Set(D.filter(e=>e.isVisible).map(e=>e.series.label)),[D]),z=(0,O.useCallback)(e=>{if(!y)return _(e);let t=e?.tooltipData?.datumByKey;if(!t)return _(e);let n=Object.fromEntries(Object.entries(t).filter(([e])=>R.has(e)));if(Object.keys(n).length===0)return null;let r=e?.tooltipData?.nearestDatum,i=r&&R.has(r.key)?r:{...Object.values(n)[0],distance:r?.distance??0};return _({...e,tooltipData:{...e.tooltipData,datumByKey:n,nearestDatum:i}})},[_,y,R]),B=ce??(m?.85:.4),V=le??!m;if(nt)return(0,k.jsx)(`div`,{className:c(`area-chart`,C[`area-chart`]),children:nt});let H=d&&(0,k.jsx)(Pe,{orientation:f.orientation??`horizontal`,alignment:f.alignment??`center`,position:ke,labelStyles:f.labelStyles,itemClassName:f.itemClassName,itemStyles:f.itemStyles,shapeStyles:f.shapeStyles,className:C[`area-chart__legend`],shape:Oe,chartId:x,interactive:y}),U=D.filter(({isVisible:e})=>e),W=he(se,g),G=({series:e,index:t,isVisible:n})=>{let{color:r,lineStyles:i}=T({data:e,index:t});return(0,k.jsx)(pe,{dataKey:e?.label,data:e.data,xAccessor:I.xAccessor,yAccessor:n||!y?I.yAccessor:L,fill:r,fillOpacity:B,...m?{}:{renderLine:V,curve:W},lineProps:{stroke:r,...i},"data-testid":`area-chart-series-${t}`},e?.label||t)};return(0,k.jsx)(Ie.Provider,{value:{chartId:x,chartRef:S,chartWidth:n,chartHeight:Ke||0},children:(0,k.jsx)(Fe,{legendPosition:ke,legendElement:H,legendChildren:We,gap:Ee,className:c(`area-chart`,C[`area-chart`],{[C[`area-chart--animated`]]:F},a),style:{width:n,height:i},"data-testid":`area-chart`,trailingContent:Ge,onContentHeightChange:Je,children:({contentHeight:e})=>{let t=e>0?e:i;return(0,k.jsx)(`div`,{role:`grid`,"aria-label":s(`Area chart`,`jetpack-charts`),tabIndex:0,onKeyDown:et,onFocus:A,onBlur:j,children:t>0&&(0,k.jsx)(`div`,{ref:Me,children:(0,k.jsxs)(me,{theme:b,width:n,height:t,margin:{...tt,...o},xScale:N.xScale,yScale:N.yScale,onPointerDown:be,onPointerUp:xe,onPointerMove:Se,onPointerOut:Ce,pointerEventsDataKey:`nearest`,children:[Te!==`none`&&(0,k.jsx)(ue,{columns:!1,numTicks:4}),N.axis.x.display&&(0,k.jsx)(fe,{...N.axis.x}),N.axis.y.display&&(0,k.jsx)(fe,{...N.axis.y}),Qe?(0,k.jsx)(Ue,{x:n/2,y:t/2,width:n,height:t,children:s(`All series are hidden. Click legend items to show data.`,`jetpack-charts`)}):null,!Qe&&m&&(0,k.jsx)(de,{curve:W,offset:h,renderLine:V,children:D.map(G)}),!Qe&&!m&&D.map(G),l&&(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(Be,{detectBounds:!0,snapTooltipToDatumX:!0,snapTooltipToDatumY:!m,renderTooltip:z,showVerticalCrosshair:u?.showVertical,showHorizontalCrosshair:u?.showHorizontal,selectedIndex:Le,tooltipRef:$e,keyboardFocusedClassName:C[`area-chart__tooltip--keyboard-focused`],series:w}),(0,k.jsx)(Ze,{visibleSeries:U,stacked:m,stackOffset:h,getElementStyles:T,strokeColor:Ae.backgroundColor})]}),(0,k.jsx)(Xe,{chartRef:S,width:n,height:i||t,margin:o})]})})})}})})}),A=(0,O.forwardRef)((e,t)=>(0,O.useContext)(m)?(0,k.jsx)($e,{...e,ref:t}):(0,k.jsx)(f,{children:(0,k.jsx)($e,{...e,ref:t})})),A.displayName=`AreaChart`,d(A,{Legend:Pe}),j=d(We(A),{Legend:Pe})})),M,N,tt=e((()=>{be(),Te(),Ae(),xe(),Oe(),et(),M={title:`JS Packages/Charts Library/Charts/Area Chart`,component:j,parameters:{layout:`centered`},decorators:[we],argTypes:{...Ee,...v,...Se,...y,data:{control:{type:`object`},description:`Array of series data to display in the chart`,table:{category:`Data`}}}},N={...Ce,data:b.slice(0,4),stacked:!0,stackOffset:`none`,smoothing:!0,maxWidth:1200,resizeDebounceTime:300,options:{axis:{x:{orientation:`bottom`},y:{orientation:`left`}}},withTooltips:!0}})),nt=n({Animation:()=>W,AspectRatio:()=>U,CurveTypes:()=>K,CustomTooltip:()=>Z,Default:()=>I,ErrorStates:()=>q,FillOpacity:()=>J,FixedDimensions:()=>H,GridVisibility:()=>X,LinearLines:()=>B,MismatchedXDomains:()=>$,NegativeValues:()=>Q,PercentageStack:()=>R,SingleSeries:()=>V,Streamgraph:()=>z,Unstacked:()=>L,WithCompositionLegend:()=>G,WithStroke:()=>Y,__namedExportsOrder:()=>it,default:()=>rt}),P,rt,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$,it,at=e((()=>{x(),et(),tt(),P=a(),rt={...M,title:`JS Packages/Charts Library/Charts/Area Chart`,component:M.component,argTypes:{...M.argTypes,seriesCount:{control:{type:`radio`},options:[`single`,`multiple`,`many`],description:`Number of data series`,table:{category:`Data`}},dimensionMode:{control:{type:`radio`},options:[`responsive`,`fixed`],description:`Chart sizing mode`,table:{category:`Dimensions`}},stacked:{control:`boolean`,description:`Stack series on top of each other`,table:{category:`Visual Style`}},stackOffset:{control:{type:`radio`},options:[`none`,`expand`,`wiggle`,`silhouette`],description:`Stack offset strategy (only applies when stacked is true)`,table:{category:`Visual Style`}},smoothing:{control:`boolean`,description:`Enable curve smoothing`,table:{category:`Visual Style`}},curveType:{control:{type:`radio`},options:[`linear`,`smooth`,`monotone`],description:`Curve interpolation type`,table:{category:`Visual Style`}},fillOpacity:{control:{type:`range`,min:0,max:1,step:.05},description:`Fill opacity for the areas (0–1)`,table:{category:`Visual Style`}},withStroke:{control:`boolean`,description:`Render a stroke (line) on top of each area`,table:{category:`Visual Style`}}}},F=e=>{let{seriesCount:t,dimensionMode:n,crosshairMode:r,withTooltipCrosshairs:i,...a}=e,o=De(e),s=a.data||N.data;t===`single`?s=[b[0]]:t===`multiple`?s=b.slice(0,4):t===`many`&&(s=b);let c={};n===`fixed`&&(c={width:800,height:400});let l;return r===`vertical`?l={showVertical:!0}:r===`horizontal`?l={showHorizontal:!0}:r===`both`&&(l={showVertical:!0,showHorizontal:!0}),(0,P.jsx)(j,{...a,...c,data:s,legend:o,withTooltipCrosshairs:l})},I=F.bind({}),I.args={...N,showLegend:!0},L=F.bind({}),L.args={...N,stacked:!1,showLegend:!0},L.parameters={docs:{description:{story:"When `stacked={ false }`, series are rendered as overlapping filled areas. Use `fillOpacity` to control transparency so overlapping series remain visible."}}},R=F.bind({}),R.args={...N,stacked:!0,stackOffset:`expand`,showLegend:!0},R.parameters={docs:{description:{story:'`stackOffset="expand"` produces a 100% stacked area chart — each x-position is normalised to 1.0, useful for showing relative composition over time.'}}},z=F.bind({}),z.args={...N,stacked:!0,stackOffset:`wiggle`,showLegend:!0,smoothing:!0},z.parameters={docs:{description:{story:'`stackOffset="wiggle"` produces a streamgraph layout. Each series flows around a central baseline, minimising weighted change in slope.'}}},B=F.bind({}),B.args={...N,curveType:`linear`,smoothing:!1,showLegend:!0},B.parameters={docs:{description:{story:'Stacked area chart with straight (linear) edges between data points. Use `curveType="linear"` (or `smoothing={ false }`) when you want a precise, unsmoothed visualisation.'}}},V=F.bind({}),V.args={...N,data:[ke[0]]},H=F.bind({}),H.args={...N,width:600,height:300,showLegend:!0},U=F.bind({}),U.args={...N,aspectRatio:.3,showLegend:!0},W=F.bind({}),W.args={...N,animation:!0,showLegend:!0,legendInteractive:!0},G={render:e=>{let t=De(e);return(0,P.jsx)(j,{...I.args,...e,legend:{interactive:t?.interactive},chartId:`composition-area-chart`,children:(0,P.jsx)(j.Legend,{...t})})},args:{...I.args},parameters:{docs:{description:{story:"Composition API using `<AreaChart.Legend />` as a child component for explicit legend placement and configuration."}}}},K={render:()=>{let e=b.slice(0,3);return(0,P.jsxs)(`div`,{style:{display:`grid`,gap:`2rem`,gridTemplateColumns:`repeat(3, 1fr)`},children:[(0,P.jsxs)(`div`,{children:[(0,P.jsx)(`h3`,{children:`Linear`}),(0,P.jsx)(j,{width:300,height:200,data:e,curveType:`linear`})]}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(`h3`,{children:`Smooth (Catmull-Rom)`}),(0,P.jsx)(j,{width:300,height:200,data:e,curveType:`smooth`})]}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(`h3`,{children:`Monotone X`}),(0,P.jsx)(j,{width:300,height:200,data:e,curveType:`monotone`})]})]})},parameters:{docs:{description:{story:"The three available curve types. `linear` connects points with straight lines; `smooth` uses Catmull-Rom interpolation; `monotone` prevents overshooting on steep changes."}}}},q={render:()=>(0,P.jsxs)(`div`,{style:{display:`grid`,gap:`2rem`,gridTemplateColumns:`repeat(2, 1fr)`},children:[(0,P.jsxs)(`div`,{children:[(0,P.jsx)(`h3`,{children:`Empty Data`}),(0,P.jsx)(j,{width:300,height:200,data:[]})]}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(`h3`,{children:`Invalid Date Values`}),(0,P.jsx)(j,{width:300,height:200,data:[{label:`Invalid Dates`,data:[{date:new Date(`invalid`),value:10},{date:new Date(`2024-01-02`),value:20}]}]})]}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(`h3`,{children:`Invalid Values`}),(0,P.jsx)(j,{width:300,height:200,data:[{label:`Invalid Values`,data:[{date:new Date(`2024-01-01`),value:NaN},{date:new Date(`2024-01-02`),value:null}]}]})]}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(`h3`,{children:`Single Data Point`}),(0,P.jsx)(j,{width:300,height:200,data:[{label:`Single Point`,data:[{date:new Date(`2024-01-01`),value:100}]}]})]})]}),parameters:{docs:{description:{story:`How the area chart handles common edge cases.`}}}},J=F.bind({}),J.args={...N,fillOpacity:.5,showLegend:!0},J.parameters={docs:{description:{story:"Use `fillOpacity` to control how transparent the bands are. Defaults: `0.85` for stacked, `0.4` for unstacked."}}},Y=F.bind({}),Y.args={...N,withStroke:!0,showLegend:!0},Y.parameters={docs:{description:{story:"`withStroke={ true }` renders a stroke on top of each band. By default, stroke is off in stacked mode and on in unstacked mode."}}},X={render:()=>{let e=b.slice(0,3);return(0,P.jsxs)(`div`,{style:{display:`grid`,gap:`2rem`,gridTemplateColumns:`repeat(2, 1fr)`},children:[(0,P.jsxs)(`div`,{children:[(0,P.jsx)(`h3`,{children:`Default grid`}),(0,P.jsx)(j,{width:400,height:240,data:e})]}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(`h3`,{children:`gridVisibility="none"`}),(0,P.jsx)(j,{width:400,height:240,data:e,gridVisibility:`none`})]})]})},parameters:{docs:{description:{story:'`gridVisibility` controls grid rendering. Use `"none"` for compact / inline visualisations like sparkline-style cards.'}}}},Z=F.bind({}),Z.args={...N,showLegend:!0,renderTooltip:({tooltipData:e})=>{let t=e?.nearestDatum?.datum;if(!t)return null;let n=Object.entries(e?.datumByKey||{}).map(([e,t])=>({key:e,value:t.datum.value})),r=n.reduce((e,t)=>e+(t.value??0),0);return(0,P.jsxs)(`div`,{style:{padding:8,minWidth:160},children:[(0,P.jsx)(`div`,{style:{fontWeight:600,marginBottom:6},children:t.date?.toLocaleDateString()}),n.map(e=>(0,P.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,P.jsx)(`span`,{children:e.key}),(0,P.jsx)(`strong`,{children:e.value})]},e.key)),(0,P.jsx)(`hr`,{style:{margin:`6px 0`,opacity:.3}}),(0,P.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`},children:[(0,P.jsx)(`span`,{children:`Total`}),(0,P.jsx)(`strong`,{children:r})]})]})}},Z.parameters={docs:{description:{story:"`renderTooltip` lets you render any React content inside the tooltip portal. The portal background is theme-driven; do not override it in custom content."}}},Q=F.bind({}),Q.args={...N,showLegend:!0,stacked:!0,stackOffset:`none`,data:[{label:`Inflows`,data:[{date:new Date(`2024-01-01`),value:30},{date:new Date(`2024-02-01`),value:35},{date:new Date(`2024-03-01`),value:50},{date:new Date(`2024-04-01`),value:42},{date:new Date(`2024-05-01`),value:60}]},{label:`Outflows`,data:[{date:new Date(`2024-01-01`),value:-15},{date:new Date(`2024-02-01`),value:-20},{date:new Date(`2024-03-01`),value:-10},{date:new Date(`2024-04-01`),value:-25},{date:new Date(`2024-05-01`),value:-18}]}]},Q.parameters={docs:{description:{story:'Mixed positive/negative values with `stackOffset="none"`. Hover glyphs follow the running total, matching where d3-stack draws the band edges.'}}},$=F.bind({}),$.args={...N,showLegend:!0,data:[{label:`Daily`,data:[{date:new Date(`2024-01-01`),value:10},{date:new Date(`2024-01-02`),value:12},{date:new Date(`2024-01-03`),value:14},{date:new Date(`2024-01-04`),value:16},{date:new Date(`2024-01-05`),value:18}]},{label:`Sparse`,data:[{date:new Date(`2024-01-02`),value:5},{date:new Date(`2024-01-03`),value:8},{date:new Date(`2024-01-04`),value:6}]}]},$.parameters={docs:{description:{story:`Series with non-matching x-domains. d3-stack treats missing values as zero; the hover-glyph overlay matches that convention so subsequent series glyphs stay on the correct stacked edge.`}}},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`args => {
