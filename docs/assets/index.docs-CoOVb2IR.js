import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-DPHz32Th.js";import{i as r,n as i,r as a,t as o}from"./blocks-CEw27kd4.js";import{t as s}from"./mdx-react-shim-C_AFP89k.js";import{AlignmentOptions as c,CustomShape as l,DashboardExample as u,Default as d,InteractiveLegend as f,StandaloneLegendWithChartId as p,TextOverflow as m,Vertical as h,WithBarChart as g,WithLineChart as _,n as v,t as y}from"./index.stories-DRWL5KrV.js";function b(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,ol:`ol`,p:`p`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...n(),...e.components};return(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(i,{title:`JS Packages/Charts Library/Components/Legend`,of:y}),`
...
`,(0,S.jsx)(a,{language:`tsx`,code:`import { Legend, LineChart } from '@automattic/charts';
...
`,(0,S.jsx)(o,{of:d}),`
`,(0,S.jsx)(a,{language:`tsx`,code:`<Legend
	items={ [
...
`,(0,S.jsx)(o,{of:_}),`
`,(0,S.jsx)(a,{language:`tsx`,code:`import { LineChart } from '@automattic/charts';
...
`,(0,S.jsx)(o,{of:g}),`
`,(0,S.jsx)(a,{language:`tsx`,code:`import { BarChart } from '@automattic/charts';
...
`,(0,S.jsx)(o,{of:p}),`
`,(0,S.jsx)(a,{language:`tsx`,code:`<div>
...
`,(0,S.jsx)(a,{language:`tsx`,code:`<LineChart
	data={ data }
	chartId="sales-chart"
	showLegend={ true }
...
`,(0,S.jsx)(a,{language:`tsx`,code:`<GlobalChartsProvider>
	<LineChart
		chartId="sales-chart"
		data={ salesData }
		showLegend={ false }
...
`,(0,S.jsxs)(t.li,{children:[(0,S.jsx)(t.strong,{children:`Grouped series`}),` (`,(0,S.jsx)(t.code,{children:`legend.collapseGroups`}),`): Off by default, so every series gets its own item and toggles only itself. Turn it on and series sharing a `,(0,S.jsx)(t.code,{children:`group`}),` — typically a primary and its `,(0,S.jsx)(t.code,{children:`type: 'comparison'`}),` overlay — collapse into a single item labelled by the primary; toggling it shows or hides the whole group at once. Only available on charts built from `,(0,S.jsx)(t.code,{children:`SeriesData`}),` (line, bar, area); pie-style charts use `,(0,S.jsx)(t.code,{children:`group`}),` on their data points purely to coordinate colours, so the option is not offered there`]}),`
...
`,(0,S.jsx)(a,{language:`tsx`,code:`import { GlobalChartsProvider, LineChart } from '@automattic/charts';
...
`,(0,S.jsx)(a,{language:`tsx`,code:`const CustomGlyph = ( { color, size } ) => (
