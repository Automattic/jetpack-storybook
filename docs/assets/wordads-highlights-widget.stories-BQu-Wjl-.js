import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-Da_5_6n_.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{K as i,g as a,mt as o,n as s}from"./build-module-DmVuor49.js";import{t as c,v as l}from"./src-B3le4dug.js";import{$n as u,St as d,mr as f,ut as p}from"./chart-tooltip-C4NUtjXe.js";import{t as m}from"./metric-tile-grid-C4DPZwp_.js";import{D as h,T as g,j as ee,w as _}from"./report-metric-DerWADBf.js";import{t as v}from"./widget-state-B76seV2w.js";import{C as y,S as b,T as te,b as x,t as S,w as C,x as w}from"./src-0WK5HJj0.js";import{i as ne,t as T}from"./src-Dh4_FIP6.js";var E,D,O=e((()=>{E=`_root_15bqk_2`,D={root:E}})),k,A,j,M=e((()=>{T(),c(),n(),k=[{id:`earnings`,label:t(`Earnings`,`jetpack-premium-analytics`)},{id:`paid`,label:t(`Paid`,`jetpack-premium-analytics`)},{id:`outstanding`,label:t(`Outstanding amount`,`jetpack-premium-analytics`)}],A=k.map(e=>e.id),j={name:`jpa/wordads-highlights`,title:t(`WordAds highlights`,`jetpack-premium-analytics`),icon:l,help:{content:t(`Payment is made once your outstanding balance reaches $100, approximately 45 days after the end of the month in which it was earned.`,`jetpack-premium-analytics`)},attributes:[{id:`metrics`,label:t(`Metrics`,`jetpack-premium-analytics`),type:`array`,relevance:`high`,Edit:ne,elements:k.map(e=>({value:e.id,label:e.label}))}],example:{attributes:{metrics:A}}}}));function N({metrics:e=A}){let n=new Set(e),r=k.some(({id:e})=>n.has(e)),{data:i,isLoading:a,isFetching:o,isError:s,refetch:c}=d(void 0,{enabled:r}),u=k.filter(({id:e})=>n.has(e)).map(({id:e,label:t})=>({key:e,label:t,icon:L[e].icon,value:L[e].value(i)}));return(0,F.jsx)(`div`,{className:D.root,children:(0,F.jsx)(v,{isLoading:a,isFetching:o,isError:s,isEmpty:!r,error:{description:t(`We couldn't load WordAds earnings. Please try again in a moment.`,`jetpack-premium-analytics`),actions:[{label:t(`Retry`,`jetpack-premium-analytics`),onClick:()=>{c()}}]},empty:{icon:l,description:t(`Select at least one metric to display.`,`jetpack-premium-analytics`)},children:(0,F.jsx)(m,{tiles:u,dataFormat:I,currencyCode:`USD`})})})}function P({attributes:e={}}){return(0,F.jsx)(ee,{attributes:e,children:(0,F.jsx)(N,{metrics:e.metrics})})}var F,I,L,R=e((()=>{p(),c(),S(),n(),s(),O(),M(),F=r(),I={type:`currency`,options:{decimals:2}},L={earnings:{icon:o,value:e=>e?.total_earnings??0},paid:{icon:i,value:e=>e?e.total_earnings-e.total_amount_owed:0},outstanding:{icon:a,value:e=>e?.total_amount_owed??0}}}));function z({metrics:e}){return(0,H.jsx)(P,{attributes:{reportParams:u(),metrics:e}})}function B(){f.removeQueries({queryKey:[`stats`,`wordads-earnings`]})}function V({metrics:e,...t}){return(0,H.jsx)(y,{...t,widgetType:W,renderModule:U,renderComponent:P,attributes:{reportParams:u(!0),metrics:e}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{p(),C(),x(),_(),R(),M(),H=r(),g(),U=`storybook/wordads-highlights`,W={name:j.name,title:j.title,icon:j.icon,help:j.help,attributes:j.attributes,example:j.example},G={metrics:{control:`check`,options:A}},K={metrics:A},q={title:`Packages/Premium Analytics/Widgets/WordAdsHighlights`,component:P,tags:[`autodocs`],argTypes:{...G},parameters:{docs:{description:{component:'The "WordAds highlights" widget. Shows all-time WordAds payouts — total earnings, amount paid, and outstanding balance — as a grid of currency tiles (paid = earnings − outstanding). Ported from the Calypso WordAds "Totals" section. Which cards appear is controlled by the `metrics` attribute (`relevance: \'high\'`), exposed inline in the widget header and in the settings drawer. Data comes from the designated `useStatsWordAdsEarnings` hook; in Storybook it is served by `registerReportMocks()` (the `wordads/earnings` handler). The earnings module has no comparison period, so the tiles show bare amounts.'}}}},J={render:z,args:{...K},decorators:[w]},Y={render:z,args:{...K},tags:[`!autodocs`],decorators:[w],beforeEach:()=>(B(),h(`wordads/earnings`,`loading`),()=>{h(`wordads/earnings`,null),B()})},X={render:z,args:{...K},tags:[`!autodocs`],decorators:[w],beforeEach:()=>(B(),h(`wordads/earnings`,`error`),()=>{h(`wordads/earnings`,null),B()})},Z={render:z,args:{metrics:[]},decorators:[w]},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...b,widgetWidth:1,widgetHeight:1,...K},argTypes:{...te,...G}},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
