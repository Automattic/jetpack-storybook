import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Ms as i,Uu as ee,ju as a,t as o}from"./build-module-2iv4IIRq.js";import{X as s,Y as c,g as l,m as te}from"./hooks-COXxM0Y2.js";import{n as ne,t as re}from"./src-Bi98A3Lj.js";import{$t as ie,_ as ae,r as u}from"./date-period-dropdown-BIJTXKMo.js";import"./constants-B1kGztHF.js";import{t as oe}from"./leaderboard-skeleton-Cyp2X6xt.js";import{t as se}from"./metric-list-DFfTRlr8.js";import{i as ce,r as le,s as d}from"./register-report-mocks-BFpP2YOE.js";import{P as ue,S as de,b as f}from"./report-metric-BX6bVYVz.js";import{t as fe}from"./widget-state-DbEDZ13v.js";import{t as p}from"./src-DcRbvdro.js";import{a as pe,c as m,d as h,i as me,l as he,n as g,o as _,r as v,s as ge,u as _e}from"./with-widget-canvas-BzFCKwT0.js";var y,b,x,S,ve=e((()=>{y=`_widget_1veb5_3`,b=`_body_1veb5_11`,x=`_list_1veb5_18`,S={widget:y,body:b,list:x}}));function ye(e,t){return(e?.data?.[0]?.items??[]).slice(0,t>0?t:void 0).map((e,t)=>({id:e.id??t,postId:e.id,link:typeof e.link==`string`?e.link:null,label:String(e.label??``),opensRate:e.opens_rate,clicksRate:e.clicks_rate}))}function be({attributes:e}){let n=e?.metric??`opens`,{data:r,isLoading:a,isFetching:o,isError:s,refetch:c}=ae({quantity:10}),l=(0,ee.useMemo)(()=>ye(r,10),[r]);return(0,w.jsxs)(`div`,{className:S.widget,children:[(0,w.jsx)(`div`,{className:S.body,children:(0,w.jsx)(fe,{isLoading:a,isFetching:o,isError:l.length===0&&s,isEmpty:l.length===0,error:{description:t(`We couldn't load email stats. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:c}]},empty:{icon:i,description:t(`Your latest emails will appear here once you send a newsletter.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,w.jsx)(oe,{rows:10}),children:(0,w.jsx)(E,{rows:l,metric:n})})}),(0,w.jsx)(de,{children:(0,w.jsx)(f,{report:`emails`})})]})}function C({attributes:e={}}){return(0,w.jsx)(l,{attributes:e,children:(0,w.jsx)(be,{attributes:e})})}var w,T,E,xe=e((()=>{u(),re(),p(),a(),n(),o(),ve(),w=r(),T={opens:`email-opens`,clicks:`email-clicks`},E=({rows:e=[],metric:t=`opens`})=>{let n=te(T[t]),r=e.map(e=>{let r=t===`clicks`?e.clicksRate:e.opensRate;return{id:e.id,label:(0,w.jsx)(ue,{id:e.postId,label:e.label,link:e.link,search:n,title:e.label}),value:ne(r/100,`percentage`,{decimals:2,signDisplay:`never`})}});return(0,w.jsx)(se,{className:S.list,items:r})}})),D,O=e((()=>{n(),o(),c(),D={icon:i,attributes:[{id:`metric`,label:t(`View by`,`jetpack-premium-analytics-pkg`),type:`text`,Edit:s,elements:[{label:t(`By open rate`,`jetpack-premium-analytics-pkg`),value:`opens`},{label:t(`By click rate`,`jetpack-premium-analytics-pkg`),value:`clicks`}],relevance:`high`}],example:{attributes:{metric:`opens`}}}})),k,A,j,M,N,P,F,Se=e((()=>{k=`jpa/stats-emails`,A=`Latest emails sent`,j=`Open and click rates for your latest emails.`,M={content:`Your most recently sent emails, including their open and click rates.`},N=`stats`,P=`framed`,F={name:k,title:A,description:j,help:M,category:N,presentation:P}}));function I(){return(0,L.jsx)(C,{attributes:{metric:`opens`}})}function Ce(e){return(0,L.jsx)(ge,{...e,widgetType:me(F,D),renderModule:R,renderComponent:C,attributes:{metric:`opens`}})}var L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{u(),p(),le(),m(),_e(),pe(),g(),xe(),O(),Se(),L=r(),ce(),R=`storybook/emails`,z={title:`Packages/Premium Analytics/Widgets/Emails`,component:E,tags:[`autodocs`],parameters:{docs:{description:{component:`Lists the latest emails with their open or click rate. Close-up stories use fixtures; the dashboard story uses a mocked report.`}}}},B=[{id:1,postId:1,link:`https://example.com/stand-out/`,label:`4 Ways to Make Your Website Stand Out`,opensRate:38.1,clicksRate:3.81},{id:2,postId:2,link:`https://example.com/develop-locally/`,label:`Develop Locally on Linux with WordPress.com`,opensRate:41.2,clicksRate:5.98},{id:3,postId:3,link:`https://example.com/new-themes/`,label:`10 Brand-New WordPress.com Themes for 2026`,opensRate:35.7,clicksRate:7.12},{id:4,postId:4,link:`https://example.com/languages/`,label:`WordPress.com Is Now Available in More Languages`,opensRate:52.4,clicksRate:8.93},{id:5,postId:5,link:`https://example.com/wordcamp-europe/`,label:`WordCamp Europe 2026: What to Expect`,opensRate:47.9,clicksRate:10.25},{id:6,postId:6,link:`https://example.com/collaborate/`,label:`Click, Comment, Done: A Better Way to Collaborate`,opensRate:44.3,clicksRate:10.38}],V=[{id:1,postId:1,link:`https://example.com/long-subject/`,label:`An exhaustively long, keyword-stuffed subject line that almost certainly needs to be truncated before it overflows the row`,opensRate:22.5,clicksRate:4.1},{id:2,postId:2,link:`https://example.com/monthly-digest/`,label:`Your monthly digest: billing, new features, and what is coming next`,opensRate:33.8,clicksRate:6.7}],H=e=>(0,L.jsx)(l,{attributes:{reportParams:ie()},children:(0,L.jsx)(e,{})}),U={args:{rows:B},decorators:[v,H,h]},W={args:{rows:B,metric:`clicks`},decorators:[v,H,h]},G={render:I,tags:[`!autodocs`],decorators:[v,h],beforeEach:()=>(d(`stats/emails/summary`,`loading`),()=>d(`stats/emails/summary`,null))},K={render:I,tags:[`!autodocs`],decorators:[v,h],beforeEach:()=>(d(`stats/emails/summary`,`error`),()=>d(`stats/emails/summary`,null))},q={render:I,tags:[`!autodocs`],decorators:[v,h],beforeEach:()=>(d(`stats/emails/summary`,`empty`),()=>d(`stats/emails/summary`,null))},J={args:{rows:V},decorators:[v,H,h]},Y=(e,t=`auto`)=>n=>(0,L.jsx)(`div`,{style:{width:e,height:t,border:`1px dashed #ccc`,borderRadius:`8px`,containerType:`inline-size`,containerName:`widget`},children:(0,L.jsx)(n,{})}),X={args:{rows:B},decorators:[Y(`448px`),H,h]},Z={args:{rows:B},decorators:[Y(`576px`),H,h]},Q={render:e=>(0,L.jsx)(Ce,{...e}),args:{..._},argTypes:{...he}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  args: {
    rows: mockRows
  },
