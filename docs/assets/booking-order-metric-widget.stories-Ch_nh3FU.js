import{n as e}from"./chunk-zsgVPwQN.js";import{c as t,g as n,l as r,o as i,r as a,s as o,v as s}from"./hooks-CIDhyPPX.js";import{px as c}from"./iframe-DtJFNbbb.js";import{b as l,g as u,t as d}from"./helpers-DqE_pFxu.js";import{a as f,o as p}from"./widget-loading-overlay-D5Vx5Av7.js";import{i as m,t as h}from"./report-metric-v7vosgWn.js";function g({metricKey:e}){let{reportParams:r}=t();return(0,_.jsx)(h,{metricKey:e,data:n({...r,filters:[u]}),dataFormat:l(e)})}var _,v=e((()=>{r(),m(),a(),d(),_=c()})),y,b,x,S,C,w,T,E,D;e((()=>{r(),o(),f(),v(),y=c(),b={title:`Packages/Premium Analytics/Widgets Toolkit/Widgets/BookingOrderMetricWidget`,component:g,tags:[`autodocs`],parameters:{docs:{description:{component:`Displays booking order metrics over time with comparison support. Automatically filters data to show only booking product types (booking, bookable-event, bookable-service).`}}},decorators:[p(),e=>(0,y.jsx)(`div`,{style:{width:`100%`,height:`300px`},children:(0,y.jsx)(e,{})})]},x={args:{metricKey:`orders_no`}},S={args:{metricKey:`orders_no`},decorators:[e=>(0,y.jsx)(i.Provider,{value:{reportParams:s(!0)},children:(0,y.jsx)(e,{})})]},C=(e,t=`290px`)=>n=>(0,y.jsx)(i.Provider,{value:{reportParams:s(!0)},children:(0,y.jsx)(`div`,{style:{width:e,height:t,border:`1px dashed #ccc`,borderRadius:`8px`,padding:`16px`,background:`#fafafa`,containerType:`inline-size`,containerName:`widget`},children:(0,y.jsx)(n,{})})}),w={args:{metricKey:`orders_no`},decorators:[C(`256px`)]},T={args:{metricKey:`orders_no`},decorators:[C(`448px`)]},E={args:{metricKey:`orders_no`},decorators:[C(`576px`)]},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
    metricKey: 'orders_no'
  }
