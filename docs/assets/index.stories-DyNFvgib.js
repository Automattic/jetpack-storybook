import{a as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./jsx-runtime-D2pHJD-r.js";import{t as r,u as i}from"./build-module-9gS1SrIW.js";import{M as a,O as o,P as ee,Y as s,t as c,z as l}from"./providers-C1AedUiy.js";import{c as u,r as d,s as f,t as p}from"./chart-decorator-BaYTBUZb.js";import{n as m,r as h,t as g}from"./legend-config-DvuGdtSm.js";import{i as _,t as v,w as y,x as b,y as x}from"./sample-data-BwMYxnT1.js";import{t as S}from"./stories-3COZqgIC.js";import{n as C,r as te}from"./leaderboard-chart-DJwfHBlK.js";var ne=e({AdvancedFormatting:()=>K,Animation:()=>F,AspectRatio:()=>k,CurrencyFormatting:()=>H,CustomColors:()=>I,CustomLabel:()=>G,Default:()=>D,EmptyData:()=>R,EmptyDataWithChildren:()=>z,FixedDimensions:()=>O,Interactive:()=>P,LargeValues:()=>B,Loading:()=>M,NegativeGrowth:()=>V,NumberFormatting:()=>U,OverlayLabelWithImage:()=>J,SmallDataset:()=>L,WithCompositionLegend:()=>Z,WithLegend:()=>Y,WithLegendLabels:()=>X,WithOverlayLabel:()=>j,WithoutComparison:()=>A,__namedExportsOrder:()=>Q,default:()=>E}),w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=t((()=>{r(),c(),S(),m(),ee(),te(),w=n(),{action:T}=__STORYBOOK_MODULE_ACTIONS__,E={title:`JS Packages/Charts Library/Charts/Leaderboard Chart`,component:C,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{data:{control:`object`,description:`Array of leaderboard entries to display`,table:{type:{summary:`LeaderboardEntry[]`}}},withComparison:{control:`boolean`,description:`Whether to show comparison data (previous period bars and delta values)`,table:{defaultValue:{summary:`false`}}},primaryColor:{control:`color`,description:`Primary color for current period bars`,table:{defaultValue:{summary:a.leaderboardChart.primaryColor}}},secondaryColor:{control:`color`,description:`Secondary color for comparison period bars`,table:{defaultValue:{summary:a.leaderboardChart.secondaryColor}}},valueFormatter:{control:!1,description:`Custom formatter function for values`,table:{type:{summary:`(value: number) => string`},defaultValue:{summary:`formatMetricValue with compact notation`}}},deltaFormatter:{control:!1,description:`Custom formatter function for delta values`,table:{type:{summary:`(value: number) => string`},defaultValue:{summary:`formatMetricValue as percentage`}}},loading:{control:`boolean`,description:`Whether the chart is in loading state`,table:{defaultValue:{summary:`false`}}},className:{control:`text`,description:`Additional CSS class name for the chart container`,table:{type:{summary:`string`}}},style:{control:`object`,description:`Custom styling for the chart container`,table:{type:{summary:`React.CSSProperties`}}},withOverlayLabel:{control:`boolean`,description:`Whether to overlay the label on top of the bar`,table:{defaultValue:{summary:`false`}}},legendLabels:{control:`object`,description:`Custom labels for legend items`,table:{category:`Legend`,type:{summary:`{ primary?: string; comparison?: string }`},defaultValue:{summary:`undefined`}}},...d,...h,...u},args:{primaryColor:void 0,secondaryColor:void 0,themeName:`default`,showLegend:!1,legendPosition:`bottom`,legendAlignment:`center`,legendOrientation:`horizontal`,legendShape:`circle`,withOverlayLabel:!1},decorators:[p],render:e=>{let t=g(e);return(0,w.jsx)(C,{...e,legend:t})}},D={args:{...f,data:y,withComparison:!0,loading:!1}},O={args:{...D.args,width:300,height:400}},k={args:{...D.args,aspectRatio:.4}},A={args:{data:y,withComparison:!1,loading:!1}},j={args:{data:y,withOverlayLabel:!0}},M={args:{data:y,withComparison:!0,loading:!0}},N=T(`leaderboard-item-click`),P={args:{data:y.map(e=>({...e,label:(0,w.jsx)(`span`,{style:{display:`flex`,alignItems:`center`,minHeight:`40px`,padding:`0 6px`,fontSize:`13px`},children:e.label}),onClick:()=>N(e.id)})),withComparison:!0,withOverlayLabel:!0,style:{"--a8c--charts--leaderboard--bar--border-radius":`4px`}},render:e=>(0,w.jsx)(q,{...e}),parameters:{docs:{description:{story:"Rows with an `onClick` become interactive: the whole row is clickable and keyboard-focusable (Enter/Space), with a chevron revealed on hover/focus. The consumer supplies the action (e.g. drill-down)."}}}},F={args:{...D.args,animation:!0}},I={args:{data:y,withComparison:!0,loading:!1,primaryColor:`red`,secondaryColor:`green`}},L={args:{data:b,withComparison:!0,loading:!1}},R={args:{data:[],withComparison:!0,loading:!1}},z={args:{data:[],withComparison:!0,loading:!1},render:e=>(0,w.jsx)(C,{...e,children:(0,w.jsx)(i,{direction:`row`,gap:`xs`,align:`center`,justify:`center`,children:`Child element`})})},B={args:{data:x,withComparison:!0,loading:!1}},V={args:{data:_,withComparison:!0,loading:!1}},H={args:{data:y,withComparison:!0,loading:!1,valueFormatter:e=>s(e,`currency`,{useMultipliers:!0,decimals:1}),deltaFormatter:e=>s(e/100,`average`,{decimals:0})}},U={args:{data:y,withComparison:!0,loading:!1,valueFormatter:e=>s(e,`number`,{useMultipliers:!1,decimals:0}),deltaFormatter:e=>s(e/100,`average`,{decimals:1})}},W=({label:e,imageColor:t,style:n={}})=>(0,w.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`,...n},children:[(0,w.jsx)(`img`,{src:`data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='50' height='50'><rect width='50' height='50' fill='${encodeURIComponent(t)}'/></svg>`,alt:`icon`,style:{width:`28px`,height:`28px`,verticalAlign:`middle`,borderRadius:`4px`}}),(0,w.jsx)(`span`,{style:{fontSize:`13px`},children:e})]}),G={args:{data:v.map(e=>({...e,label:(0,w.jsx)(W,{label:e.label,imageColor:e.imageColor})})),withComparison:!1,loading:!1}},K={args:{data:x,withComparison:!0,loading:!1,valueFormatter:e=>e>=1e6?s(e,`currency`,{useMultipliers:!0,decimals:1}):s(e,`currency`,{useMultipliers:!1,decimals:0}),deltaFormatter:e=>s(e/100,`average`,{decimals:1,signDisplay:`always`})}},q=e=>{let{getElementStyles:t}=o(),{color:n}=t({index:0,overrideColor:e.primaryColor}),r=l(n,.08);return(0,w.jsx)(C,{...e,primaryColor:r})},J={args:{data:v.map(e=>({...e,label:(0,w.jsx)(W,{label:e.label,imageColor:e.imageColor,style:{padding:`6px`}})})),withComparison:!0,withOverlayLabel:!0,loading:!1,style:{"--a8c--charts--leaderboard--bar--border-radius":`4px`}},render:e=>(0,w.jsx)(q,{...e})},Y={args:{data:y,withComparison:!0,loading:!1,showLegend:!0},parameters:{docs:{description:{story:"Props-based legend using `showLegend` and the `legend` config object. Use Storybook controls to adjust legend position, alignment, orientation, shape, and interactivity."}}}},X={args:{data:y,withComparison:!0,loading:!1,showLegend:!0,legendLabels:{primary:`Aug 11-Sep 9, 2025`,comparison:`Jul 11-Aug 11, 2025`}},parameters:{docs:{description:{story:"Props-based legend using `showLegend`, the `legend` config object, and the `legendLabels` prop to customize primary and comparison labels. Other legend options (position, alignment, orientation, shape, interactivity) can be adjusted via Storybook controls."}}}},Z={render:e=>{let t=g(e);return(0,w.jsx)(C,{...e,legend:{interactive:t?.interactive},chartId:`composition-leaderboard-chart`,children:(0,w.jsx)(C.Legend,{...t,shapeStyles:{width:8,height:8,...t?.shapeStyles}})})},args:{data:y,withComparison:!0,loading:!1},parameters:{docs:{description:{story:"Composition API using `<LeaderboardChart.Legend />` as a child component for explicit legend placement and configuration. This is the recommended approach for flexible legend positioning."}}}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  args: {
    ...sharedThemeArgs,
    data: sampleData,
    withComparison: true,
