import{n as e,o as t}from"./chunk-zsgVPwQN.js";import{t as n}from"./react-Wx6hiPly.js";import{n as r,r as i,t as a,y as o}from"./build-module-D7R79iTm.js";import{t as s}from"./jsx-runtime-DgUv34OZ.js";import{t as c,w as l}from"./build-module-BmKx2ouS.js";import{t as u,w as d}from"./build-module-B8L92DX2.js";import{a as f,t as p}from"./shared-extension-utils-DW5Ca7Lr.js";var m,h=e((()=>{m={"message-box-control":`_message-box-control_pregs_90`}}));function g({label:e=b(),placeholder:t=y(),message:n=``,onChange:r,disabled:a,maxLength:s,analyticsData:c=null}){let{recordEvent:l}=f(),u=(0,_.useRef)(!0),p=s-n.length;return(0,v.jsx)(d,{value:n,label:e,onChange:(0,_.useCallback)(e=>{r(e),u.current&&=(l(`jetpack_social_custom_message_changed`,c),!1)},[c,u,r,l]),disabled:a,maxLength:s,placeholder:t,rows:4,help:o(i(`%d character remaining`,`%d characters remaining`,p,`jetpack-publicize-pkg`),p),__nextHasNoMarginBottom:!0,className:m[`message-box-control`]})}var _,v,y,b,x=e((()=>{p(),u(),a(),_=t(n()),h(),v=s(),y=()=>r(`Write a custom message for your social audience here. This message will override your social post content.`,`jetpack-publicize-pkg`),b=()=>r(`Message`,`jetpack-publicize-pkg`)})),S,C,w,T,E,D,O,k,A;e((()=>{c(),x(),S=s(),C={title:`Packages/Publicize/Message Box Control`,component:g,argTypes:{onChange:{action:`changed`},maxLength:{control:{type:`number`,min:10,max:500}},disabled:{control:`boolean`},analyticsData:{control:`object`},label:{control:`text`},placeholder:{control:`text`}}},w=e=>{let[t,n]=(0,l.useState)(e.message);return(0,S.jsx)(g,{message:t,onChange:(0,l.useCallback)(t=>{n(t),e.onChange(t)},[e]),disabled:e.disabled,maxLength:e.maxLength,analyticsData:e.analyticsData,label:e.label,placeholder:e.placeholder})},T={message:`Check out my latest blog post!`,maxLength:280,disabled:!1,analyticsData:{location:`storybook`}},E=w.bind({}),E.args=T,D=w.bind({}),D.args={...T,message:``},O=w.bind({}),O.args={...T,disabled:!0},k=w.bind({}),k.args={...T,message:``,label:`Custom Social Message`,placeholder:`Type your personalized social media post here...`},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`(args: MessageBoxControlProps) => {
