import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as i,t as a}from"./build-module-CbwHEf9N.js";import{n as o,ui as s}from"./build-module-CDRs4YxF.js";import{J as ee,Z as c,at as te,q as l,tt as ne}from"./report-metric-DGboxC5_.js";import{p as re,t as ie}from"./src-BKLK-O8P.js";import{Cr as u,Nt as d,a as ae,h as oe,ln as se,o as ce,qr as le}from"./chart-tooltip-B4z7ZybC.js";import{t as f}from"./metric-tabs-chart-Ca3zNxNw.js";import{t as ue}from"./widget-state-Dwhwd2v1.js";import{C as de,D as fe,E as pe,S as me,T as p,b as he,t as m,w as ge,x as h}from"./src-914kMeCc.js";var g,_,v,y=e((()=>{g=`_root_79bqb_1`,_=`_emptyState_79bqb_9`,v={root:g,emptyState:_}}));function b(e){return(e?.data??[]).map(e=>({date:le(e.date_start),subscribers:Number(e.subscribers??e.value??0),paid:Number(e.subscribers_paid??0)}))}function _e(e,t){let n=se((0,i.useMemo)(()=>({...e,period:t}),[e,t])),r=(0,i.useMemo)(()=>b(n.primary.data),[n.primary.data]);return{current:r,previous:(0,i.useMemo)(()=>b(n.comparison.data),[n.comparison.data]),hasPaid:r.some(e=>e.paid>0),isLoading:n.isLoading,isFetching:n.isFetching,isError:r.length===0&&n.isError,refetch:n.refetch}}var ve=e((()=>{d(),a()})),x,S,C=e((()=>{n(),o(),m(),x=[{id:`subscribers`,label:t(`Subscribers`,`jetpack-premium-analytics-pkg`)},{id:`paid`,label:t(`Paid subscribers`,`jetpack-premium-analytics-pkg`)}],S={icon:s,attributes:[ce([`auto`,`day`,`week`,`month`]),ae()],example:{attributes:{granularity:`auto`,chartType:`line`}}}}));function w(e,t){return e.length?t(e[e.length-1]):0}function ye(e){return x.filter(({id:t})=>t!==`paid`||e.hasPaid).map(({id:t,label:n})=>{let r=k[t];return{key:t,label:n,value:w(e.current,r),previousValue:e.previous.length?w(e.previous,r):void 0,current:e.current.map(e=>({date:e.date,value:r(e)})),previous:e.previous.length?e.previous.map(e=>({date:e.date,value:r(e)})):void 0}})}function be({granularity:e,chartType:n}){let{reportParams:r}=te(),a=_e(r,e===`auto`?oe(r.interval,O):e),o=(0,i.useMemo)(()=>ye(a),[a]),s=t(`Subscriber metric`,`jetpack-premium-analytics-pkg`);return(0,E.jsx)(`div`,{className:v.root,children:(0,E.jsx)(ue,{isLoading:a.isLoading,isError:a.current.length===0&&a.isError,isEmpty:a.current.length===0,error:{description:t(`We couldn't load subscriber data. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:a.refetch}]},empty:{icon:re,description:t(`No subscriber data in this period.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,E.jsx)(f,{metrics:o,dataFormat:D,chartType:n,loading:!0,groupLabel:s}),children:(0,E.jsx)(f,{metrics:o,dataFormat:D,chartType:n,loading:a.isFetching,groupLabel:s})})})}function T({attributes:e={},setError:t}){return(0,E.jsx)(ne,{attributes:e,setError:t,options:{from:`/`},children:(0,E.jsx)(be,{granularity:e.granularity??`auto`,chartType:e.chartType})})}var E,D,O,k,xe=e((()=>{m(),ie(),a(),n(),y(),ve(),C(),E=r(),D={type:`number`,options:{useMultipliers:!0,decimals:0}},O=[`day`,`week`,`month`],k={subscribers:e=>e.subscribers,paid:e=>e.paid}})),A,j,M,N,P,F,I,Se=e((()=>{A=`jpa/subscribers-chart`,j=`Subscribers summary`,M=`Track subscriber growth over time, with paid subscribers and the previous period overlaid for comparison.`,N={content:`A summary of the new subscribers you gained over time.`},P=`subscribers`,F=`framed`,I={name:A,title:j,description:M,help:N,category:P,presentation:F}}));function L({withComparison:e,chartType:t}){return(0,z.jsx)(T,{attributes:{reportParams:u(e),chartType:t}})}function R(e){return(0,z.jsx)(T,{attributes:{reportParams:u(!1,e)}})}function Ce({withComparison:e,chartType:t,...n}){return(0,z.jsx)(p,{...n,widgetType:V,renderModule:B,renderComponent:T,attributes:{reportParams:u(e),chartType:t}})}var z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{d(),pe(),de(),he(),l(),xe(),C(),Se(),z=r(),ee(),B=`storybook/subscribers-chart`,V=me(I,S),H={chartType:{control:`inline-radio`,options:[`line`,`bar`]}},U={chartType:`line`},W={title:`Packages/Premium Analytics/Widgets/SubscribersChart`,component:T,tags:[`autodocs`],argTypes:{withComparison:{control:`boolean`},...H},parameters:{docs:{description:{component:'Subscriber growth over time. The date range and previous-period comparison follow the dashboard picker; the "Group by" control is the `granularity` attribute and the "Chart type" control is the `chartType` attribute (both `relevance: \'high\'`), exposed by the widget host; which metric is plotted is the chart\'s own tab selection. When comparison is on, the previous period is overlaid as a same-colour dashed line and the headline shows the period-over-period delta. The Paid subscribers tab renders only when the site has paid subscribers. Data comes from `useStatsSubscribersReport`; in Storybook it is served by `registerReportMocks`.'}}}},G={render:L,args:{withComparison:!1,...U},decorators:[h]},K={render:L,args:{withComparison:!0,...U},decorators:[h]},q={render:L,args:{withComparison:!1,chartType:`bar`},decorators:[h]},J={render:L,args:{withComparison:!0,chartType:`bar`},decorators:[h]},Y={render:()=>R(`last-90-days`),tags:[`!autodocs`],decorators:[h],beforeEach:()=>(c(`stats/subscribers`,`loading`),()=>c(`stats/subscribers`,null))},X={render:()=>R(`last-7-days`),tags:[`!autodocs`],decorators:[h],beforeEach:()=>(c(`stats/subscribers`,`error`),()=>c(`stats/subscribers`,null))},Z={render:()=>R(`last-365-days`),tags:[`!autodocs`],decorators:[h],beforeEach:()=>(c(`stats/subscribers`,`empty`),()=>c(`stats/subscribers`,null))},Q={render:e=>(0,z.jsx)(Ce,{...e}),args:{...ge,withComparison:!0,...U},argTypes:{...fe,withComparison:{control:`boolean`},...H}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
