import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-D-aaYrLw.js";import{i as r,n as i,r as a,t as o}from"./blocks-B-S-_0lL.js";import{t as s}from"./mdx-react-shim-Dz-aBnFl.js";import{AspectRatio as c,Calendar as l,Compact as u,Default as d,ErrorStates as f,FixedDimensions as p,LargeValues as m,MaximumCellSize as h,MinimumCellSize as g,WithCompositionLegend as _,n as v,t as y}from"./index.stories-DZyKggTb.js";function b(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(i,{title:`JS Packages/Charts Library/Charts/Heatmap Chart`,of:y}),`
...
`,(0,S.jsxs)(t.li,{children:[(0,S.jsx)(t.strong,{children:(0,S.jsx)(t.code,{children:`primaryColor`})}),`: color the scale interpolates toward at the highest value (prop > `,(0,S.jsx)(t.code,{children:`heatmapChart.primaryColor`}),` > the first series palette color, `,(0,S.jsx)(t.code,{children:`--a8c-charts-color-series-1`}),`)`]}),`
...
`,(0,S.jsxs)(t.li,{children:[(0,S.jsx)(t.strong,{children:(0,S.jsx)(t.code,{children:`gridSpan`})}),` (`,(0,S.jsx)(t.code,{children:`{ start?: string; end?: string }`}),`, `,(0,S.jsx)(t.code,{children:`yyyy-MM-dd`}),` bounds): draw the grid over this span instead of the series' own, so a series too short to fill its container still does. Days inside the grid but outside the series become `,(0,S.jsx)(t.code,{children:`placeholder`}),` cells: faded empty slots that keep the grid continuous but report nothing to a pointer, the keyboard or a screen reader, since they stand for days that were never measured. A `,(0,S.jsx)(t.code,{children:`start`}),` is drawn from the beginning of its week, so the grid opens on a whole column. Bounds narrower than the series are ignored — the grid never drops a day that carries data.`]}),`
`]}),`
...
`,(0,S.jsxs)(t.p,{children:[`The heatmap resolves its full-intensity color in this order: the `,(0,S.jsx)(t.code,{children:`primaryColor`}),` prop wins, then `,(0,S.jsx)(t.code,{children:`heatmapChart.primaryColor`}),` from the active theme, then the first series palette color (`,(0,S.jsx)(t.code,{children:`--a8c-charts-color-series-1`}),`). The resolved color is fed to CSS `,(0,S.jsx)(t.code,{children:`color-mix`}),`, which derives the lighter shades for lower values.`]}),`
`,(0,S.jsxs)(t.p,{children:[`Use the prop for one chart, or move the palette slot in CSS to change every chart at once. `,(0,S.jsx)(t.code,{children:`heatmapChart.primaryColor`}),` is deprecated and does neither better.`]}),`
`,(0,S.jsx)(a,{language:`tsx`,code:`import { HeatmapChart } from '@automattic/charts';

// One chart:
<HeatmapChart data={ columns } rowLabels={ rowLabels } primaryColor="#c0392b" />`}),`
`,(0,S.jsx)(a,{language:`css`,code:`/* Every chart inside the provider tree: */
.my-dashboard {
	--a8c-charts-color-series-1: #c0392b;
}`}),`
`,(0,S.jsxs)(t.p,{children:[`Everything else — the cell gap, in-cell value size and the empty-cell color — comes from the `,(0,S.jsx)(t.code,{children:`--a8c-charts-*`}),` token catalog in CSS (the empty-cell color from `,(0,S.jsx)(t.code,{children:`--a8c-charts-color-track`}),`), so it tracks the active design system theme automatically through the catalog's own `,(0,S.jsx)(t.code,{children:`--wpds-*`}),` mapping. The corner radius can be overridden via `,(0,S.jsx)(t.code,{children:`--a8c-charts-border-radius-cell`}),`, which maps to a WPDS token (`,(0,S.jsx)(t.code,{children:`--wpds-border-radius-sm`}),`) by default. There are no per-instance props for these. What is left of the `,(0,S.jsx)(t.code,{children:`heatmapChart`}),` theme section is the compact sizing, which has no catalog role behind it and is not deprecated:`]}),`
