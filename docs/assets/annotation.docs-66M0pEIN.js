import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-D2pHJD-r.js";import{bt as n}from"./esm-B9u1y6o9.js";import{i as r,n as i,r as a,t as o}from"./blocks-BVJN52TP.js";import{t as s}from"./mdx-react-shim-C05-pijD.js";import{Colored as c,Custom as l,Default as u,Horizontal as d,Mixed as f,Vertical as p,n as m,t as h}from"./annotation.stories-CIGG_01n.js";function g(e){let t={a:`a`,code:`code`,em:`em`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(i,{title:`JS Packages/Charts Library/Charts/Line Chart/Annotations`,of:h}),`
...
`,(0,v.jsxs)(t.p,{children:[`Annotation colors are catalog roles, declared in CSS. Two roles cover all four: the label plate reads `,(0,v.jsx)(t.code,{children:`--a8c-charts-color-surface`}),`, and the anchor line, subject circle and connector all read `,(0,v.jsx)(t.code,{children:`--a8c-charts-color-annotation`}),`.`]}),`
`,(0,v.jsx)(a,{language:`css`,code:`.my-dashboard {
	--a8c-charts-color-surface: #f0f8ff;
	--a8c-charts-color-annotation: #0066cc;
}`}),`
`,(0,v.jsxs)(t.p,{children:[`The matching `,(0,v.jsx)(t.code,{children:`annotationStyles`}),` theme fields are deprecated. What stays there is the geometry beside each color — `,(0,v.jsx)(t.code,{children:`radius`}),`, the stroke widths and the label sizing — which has no role behind it:`]}),`
