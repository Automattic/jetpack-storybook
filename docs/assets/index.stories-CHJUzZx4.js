...
`}}},U=g.bind({}),U.args={...u,showLegend:!0,legendCollapseGroups:!1,smoothing:!1,data:[{...c[0],label:`Views`,group:`views`},{...c[1],label:`Views — previous`,group:`views`,options:{type:`comparison`}}]},U.parameters={docs:{description:{story:'A primary series paired with a `type: "comparison"` previous-period series sharing the same `group`. `legend.collapseGroups` is off here, the default, so each series keeps its own legend item; turn the `legendCollapseGroups` control on to fold the pair into a single **Views** item.'}}},W=g.bind({}),W.args={...u,showLegend:!0,legendInteractive:!0,legendCollapseGroups:!0,rescaleYOnVisibilityChange:!1,smoothing:!1,data:[{...c[0],label:`Views`,group:`views`},{...c[1],label:`Views — previous`,group:`views`,options:{type:`comparison`}},{...c[2],label:`Visitors`,group:`visitors`},{...c[3],label:`Visitors — previous`,group:`visitors`,options:{type:`comparison`}}]},W.parameters={docs:{description:{story:'Two groups (`views` and `visitors`), each a primary series plus its `type: "comparison"` overlay. With `legend.collapseGroups` each group is a single legend item, and because `legend.interactive` is also on, clicking one toggles both its current and previous-period series at once. The value axis stays fixed as series are toggled. Turn the `legendCollapseGroups` control off to get one item per series, each toggling alone.'}}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`args => {
