import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DyKOxfM8.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{_ as i,t as a}from"./build-module-CbwHEf9N.js";import{t as o,y as s}from"./build-module-BShXUI3N.js";import{$c as c,Yc as l,n as u,yl as d}from"./build-module-Bb7IR3OP.js";import{C as f,T as p,X as m,bt as h,ln as g,mn as _,ot as ee,t as v}from"./date-fns-B2pKki1V.js";import{lr as y,t as b,xr as x}from"./src-yJrCN2ih.js";import{G as S,W as C,Z as te,tt as ne}from"./report-metric-CYHfdN1i.js";import{n as re,o as ie}from"./heatmap-chart-CiJYIpKA.js";import{A as ae,t as oe}from"./src-q13B8HIT.js";import{c as se,kn as ce,kr as le,ur as ue,xt as w}from"./chart-tooltip-Cw816hJP.js";import{C as de,D as fe,E as pe,S as me,T as he,b as ge,t as T,w as _e,x as E}from"./src-DypA9rWg.js";import{t as ve}from"./widget-state-Dxlsu1FD.js";var D,O,k,A,j,M,ye=e((()=>{D=`_root_1uv97_4`,O=`_pager_1uv97_11`,k=`_body_1uv97_23`,A=`_content_1uv97_28`,j=`_heatmap_1uv97_44`,M={root:D,pager:O,body:k,content:A,heatmap:j}}));function be(e,t,n){let{data:r,isLoading:a,isFetching:o,isError:s,refetch:c}=ce({postId:e,fields:[`data`]}),[l,u]=(0,i.useState)(0);(0,i.useEffect)(()=>{u(0)},[t.from,t.to,n]);let d=se(t.from),v=se(t.to),{days:y,isPaged:b,canShowOlder:x}=(0,i.useMemo)(()=>{if(!d||!v||d>v)return{days:[],isPaged:!1,canShowOlder:!1};let e=r?.data??[],t=new Map(e.map(e=>[e.date,e.views])),i=g(f(d),{weekStartsOn:1}),a=ee(f(v),{weekStartsOn:1}),o=i<p(a,n-1),s=p(a,l*n),c=p(s,n-1);if(o&&c<i){c=i;let e=_(i,n-1);s=e<a?e:a}return{days:h({start:c,end:s}).map(e=>{let n=m(e,`yyyy-MM-dd`);return{dateString:n,value:(n>=d&&n<=v?t.get(n):void 0)||null}}),isPaged:o,canShowOlder:i<c}},[r,d,v,l,n]),S=(0,i.useCallback)(()=>{u(e=>x?e+1:e)},[x]),C=(0,i.useCallback)(()=>{u(e=>Math.max(0,e-1))},[]);return{days:y,isPaged:b,canShowOlder:x,canShowNewer:l>0,showOlder:S,showNewer:C,isLoading:a,isFetching:o,isError:s,hasData:!!r,refetch:c}}var xe=e((()=>{w(),a(),v(),T()}));function Se(e){return e?Math.max(I,Math.floor((e-F)/68)):L}function Ce(){let{reportParams:e}=ne(),n=le(e.post_id),[r,a]=(0,i.useState)(),o=s(e=>{let t=e[0]?.contentRect;if(t){let e=Math.round(t.width);a(t=>t===e?t:e)}}),{days:u,isPaged:d,canShowOlder:f,canShowNewer:p,showOlder:m,showNewer:h,isLoading:g,isFetching:_,isError:ee,hasData:v,refetch:b}=be(n,e,Se(r)*7),{data:S,rowLabels:C}=(0,i.useMemo)(()=>ie(u),[u]);return(0,P.jsx)(`div`,{ref:o,className:M.root,children:(0,P.jsx)(`div`,{className:M.body,children:(0,P.jsx)(ve,{isLoading:g&&!v,isFetching:_,isError:ee,isEmpty:n<=0||S.length===0,error:{description:t(`We couldn't load this traffic activity. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),actions:[{label:t(`Retry`,`jetpack-premium-analytics-pkg`),onClick:b}]},empty:{icon:ae,description:t(`Open a post or page report to see its traffic activity here.`,`jetpack-premium-analytics-pkg`)},children:(0,P.jsxs)(`div`,{className:M.content,children:[d&&(0,P.jsxs)(y,{align:`center`,justify:`flex-end`,gap:`sm`,className:M.pager,children:[(0,P.jsx)(x,{type:`button`,variant:`minimal`,tone:`neutral`,size:`small`,onClick:m,disabled:!f,"aria-label":t(`Older activity`,`jetpack-premium-analytics-pkg`),children:(0,P.jsx)(x.Icon,{icon:c,size:16})}),(0,P.jsx)(x,{type:`button`,variant:`minimal`,tone:`neutral`,size:`small`,onClick:h,disabled:!p,"aria-label":t(`Newer activity`,`jetpack-premium-analytics-pkg`),children:(0,P.jsx)(x.Icon,{icon:l,size:16})})]}),(0,P.jsx)(re,{data:S,rowLabels:C,primaryColor:`var(--wp-admin-theme-color, #3858e9)`,withTooltips:!0,maxCellWidth:64,maxCellHeight:42,className:M.heatmap})]})})})})}function N({attributes:e={}}){return(0,P.jsx)(te,{attributes:e,children:(0,P.jsx)(Ce,{})})}var P,F,I,L,we=e((()=>{w(),oe(),T(),o(),a(),n(),u(),b(),ye(),xe(),P=r(),F=48,I=4,L=16})),R,Te=e((()=>{u(),R={icon:d,attributes:[],example:{attributes:{}}}})),z,B,V,H,U,W,G,Ee=e((()=>{z=`jpa/post-traffic-activity`,B=`Traffic activity`,V=`Daily views for the post or page being viewed, as a calendar heatmap.`,H={content:`Daily views for the post or page being viewed, as a calendar heatmap.`},U=`stats`,W=`framed`,G={name:z,title:B,description:V,help:H,category:U,presentation:W}}));function De({hasPostScope:e,preset:t},n=!1){return{reportParams:{...ue(n,t),...e?{post_id:J}:{}}}}function K(e){return(0,q.jsx)(N,{attributes:De(e)})}function Oe({hasPostScope:e,preset:t,...n}){return(0,q.jsx)(he,{...n,widgetType:me(G,R),renderModule:ke,renderComponent:N,attributes:De({hasPostScope:e,preset:t},!0)})}var q,J,ke,Ae,Y,X,Z,Q,$;e((()=>{w(),C(),pe(),de(),ge(),we(),Te(),Ee(),q=r(),S(),J=779,ke=`storybook/post-traffic-activity`,Ae={title:`Packages/Premium Analytics/Widgets/PostTrafficActivity`,component:N,tags:[`autodocs`],argTypes:{hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."},preset:{control:`select`,options:[`last-30-days`,`last-365-days`],description:`Dashboard date range used to exercise single-page and paged layouts.`}},parameters:{docs:{description:{component:`The "Traffic activity" widget: the scoped post's daily views over the dashboard date range as a calendar heatmap — the post detail Traffic view's activity card, replacing the legacy months table. Days without traffic stay blank cells, per the design, while the grid stays complete. Without a post scope the widget renders a scopeless empty state.`}}}},Y={render:K,args:{hasPostScope:!0,preset:`last-30-days`},decorators:[E]},X={render:K,args:{hasPostScope:!0,preset:`last-365-days`},decorators:[E]},Z={render:K,args:{hasPostScope:!1,preset:`last-30-days`},decorators:[E]},Q={render:e=>(0,q.jsx)(Oe,{...e}),args:{..._e,widgetWidth:4,widgetHeight:2,hasPostScope:!0,preset:`last-30-days`},argTypes:{...fe,hasPostScope:{control:`boolean`,description:"Include the `post_id` report param the post detail page seeds from its URL."},preset:{control:`select`,options:[`last-30-days`,`last-365-days`],description:`Dashboard date range used to exercise single-page and paged layouts.`}}},Y.parameters={...Y.parameters,docs:{...Y.parameters?.docs,source:{originalSource:`{
