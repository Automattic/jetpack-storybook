import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-DVCOKQW8.js";import{n as r,t as i}from"./build-module-yGZutq_9.js";import{t as a}from"./jsx-runtime-D2pHJD-r.js";import{C as o,t as s}from"./build-module-zwSmKorH.js";import{g as c,mt as l}from"./hooks-D9-5bKhf.js";import{K as u,t as d}from"./src-B477hvom.js";import{d as ee,en as f,i as p,pt as te,xt as ne,yt as re}from"./date-filters-panel-DXxSsBcd.js";import{t as m}from"./post-highlight-card-skeleton-DZKmjqE3.js";import{i as h,r as g}from"./register-report-mocks-Bek115LU.js";import{g as _}from"./report-metric-Cwl9tNr_.js";import{t as v}from"./widget-state-DoDeK2hZ.js";import{t as y}from"./src-DmKbijpS.js";import{a as ie,c as ae,d as b,i as oe,l as x,n as se,o as S,r as C,s as ce,u as le}from"./with-widget-canvas-BjVB14N8.js";import{n as ue,t as de}from"./register-stats-mocks-BEWpdkXB.js";import{n as fe,t as w}from"./force-stats-mock-state-CDB682wm.js";function pe(){let{preset:e,from:t,to:n,interval:r}=f(!1,O),i=(0,T.useMemo)(()=>({preset:e,from:t,to:n,interval:r}),[e,t,n,r]),a=te((0,T.useMemo)(()=>({from:t,to:n,interval:r,max:D}),[t,n,r]),{maxRows:1,postTypes:E}),o=a.comparisonRows?.rows[0],s=Number(o?.id??0)||0,c=ne(ee(s)),l=re({postId:s,fields:[`views`,`like_count`,`post`]}),u=l.data,d=u?.post?.ID,p=u&&(d===void 0||d===s)?u:void 0,m=s>0&&!p&&!l.isError,h=a.isLoading||s>0&&(c.isLoading||l.isLoading||m),g=a.isFetching||c.isFetching||l.isFetching,_=a.isError,v=()=>{a.refetch(),s>0&&(c.refetch(),l.refetch())},y=c.data??null;return{post:o?{id:s,title:y?.title||String(o.label??``),url:y?.url||o.link||``,date:y?.date||(typeof o.date==`string`?o.date:``),imageUrl:y?.imageUrl??``,imageAlt:y?.imageAlt??``,views:p?.views,likeCount:p?.like_count,commentCount:p?.post?.comment_count}:null,range:i,isLoading:h,isFetching:g,isError:_,error:a.error,refetch:v}}var T,E,D,O,me=t((()=>{p(),d(),T=e(n(),1),E=[`post`],D=20,O=u}));function he(){let{post:e,range:t,isLoading:n,isFetching:i,isError:a,error:s,refetch:c}=pe(),u=e?[{key:`views`,label:r(`Views`,`jetpack-premium-analytics-pkg`),value:e.views},{key:`likes`,label:r(`Likes`,`jetpack-premium-analytics-pkg`),value:e.likeCount},{key:`comments`,label:r(`Comments`,`jetpack-premium-analytics-pkg`),value:e.commentCount}]:[];return(0,A.jsx)(v,{isLoading:n,isFetching:i,isError:a,isEmpty:!e,error:l(s,{retryDescription:r(`We couldn't load your most popular post. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:c}),empty:{icon:o,description:r(`No post views in the last 12 months.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,A.jsx)(m,{}),children:e&&(0,A.jsx)(_,{title:e.title,url:e.url,postId:e.id,detailSearch:t,date:e.date,imageUrl:e.imageUrl,imageAlt:e.imageAlt,metrics:u})})}function k({attributes:e={}}){return(0,A.jsx)(c,{attributes:e,children:(0,A.jsx)(he,{})})}var A,j=t((()=>{y(),i(),s(),me(),A=a()})),M,ge=t((()=>{s(),M={icon:o,attributes:[],example:{attributes:{}}}})),N,P,F,I,L,R,z,_e=t((()=>{N=`jpa/popular-post`,P=`Most popular in the last year`,F=`Your most-viewed post of the last 12 months, with its all-time stats.`,I={content:`Your most-viewed post of the last 12 months, with its all-time views, likes, and comments.`},L=`stats`,R=`framed`,z={name:N,title:P,description:F,help:I,category:L,presentation:R}}));function B(){return(0,H.jsx)(k,{attributes:{reportParams:f()}})}function V(e){return(0,H.jsx)(ce,{...e,widgetType:oe(z,M),renderModule:U,renderComponent:k,attributes:{reportParams:f(!0)}})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;t((()=>{p(),g(),de(),ie(),fe(),ae(),le(),se(),j(),ge(),_e(),H=a(),h(),ue(),U=`storybook/popular-post`,W={title:`Packages/Premium Analytics/Widgets/PopularPost`,component:k,tags:[`autodocs`],parameters:{docs:{description:{component:"The \"Most popular in the last year\" widget shows the site's most-viewed post of the last 12 months, with its publish date and its all-time views, likes, and comments. The window is the widget's own — the dashboard date range does not change which post wins — and it only picks the winner: every tile comes from the all-time `stats/post` response, so the three cannot measure different periods. There is no `WithComparison` story: the card shows no period-over-period delta, so the dashboard story below carries the comparison report params instead."}}}},G={render:B,decorators:[C,b]},K={render:B,tags:[`!autodocs`],decorators:[C,b],beforeEach:()=>(w(`stats/top-posts`,`loading`),()=>w(`stats/top-posts`,null))},q={render:B,tags:[`!autodocs`],decorators:[C,b],beforeEach:()=>(w(`stats/top-posts`,`error`),()=>w(`stats/top-posts`,null))},J={render:B,tags:[`!autodocs`],decorators:[C,b],beforeEach:()=>(w(`stats/top-posts`,`error-retryable`),()=>w(`stats/top-posts`,null))},Y={render:B,tags:[`!autodocs`],decorators:[C,b],beforeEach:()=>(w(`stats/top-posts`,`empty`),()=>w(`stats/top-posts`,null))},X={render:e=>(0,H.jsx)(V,{...e}),args:{...S,widgetWidth:2,widgetHeight:2},argTypes:{...x}},Z={render:e=>(0,H.jsx)(V,{...e}),args:{...S,widgetWidth:2,widgetHeight:1},argTypes:{...x}},Q={render:e=>(0,H.jsx)(V,{...e}),args:{...S,widgetWidth:1,widgetHeight:1},argTypes:{...x}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
