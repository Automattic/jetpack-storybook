import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-2QZQpBH2.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{Ec as ee,Gu as i,Nu as a,bc as o,t as s}from"./build-module-zwSmKorH.js";import{Bt as te}from"./build-module-D5hqcG7F.js";import{g as c}from"./hooks-Bdkur3yI.js";import{t as ne}from"./src-jtpFQrta.js";import{H as re,Zt as l,t as u}from"./src-DIpXiMbL.js";import"./constants-B1kGztHF.js";import{A as ie,pt as d}from"./chart-tooltip-CEk5SH_N.js";import{r as f,t as ae}from"./leaderboard-skeleton-Cd2ktSji.js";import{G as oe,K as se,S as p,U as m,b as h,v as g}from"./report-metric-BbMTDs3Q.js";import{t as _}from"./widget-state-BHh37Nb4.js";import{C as v,D as y,E as b,O as x,S,T as ce,b as le,k as C,t as ue,w as de,x as w}from"./src-BYJkp6c3.js";var T,E,D,O=e((()=>{T=`_root_19tfr_1`,E=`_content_19tfr_9`,D={root:T,content:E}}));function k(){let{rows:e,isLoading:n,isFetching:r,isError:a,error:o,refetch:s}=re({group:`posts`,max:10}),c=(0,i.useMemo)(()=>{let t=Math.max(...e.map(e=>e.value),0);return e.map(e=>({id:e.id,label:(0,j.jsx)(g,{id:e.postId,label:e.label,link:e.link}),currentValue:e.value,currentShare:d(e.value,t)}))},[e]);return(0,j.jsxs)(te,{className:D.root,children:[(0,j.jsx)(`div`,{className:D.content,children:(0,j.jsx)(_,{isLoading:n,isFetching:r,isError:a,isEmpty:e.length===0,error:ie(o,{retryDescription:t(`We couldn't load commented posts. Please try again in a moment.`,`jetpack-premium-analytics-pkg`),onRetry:s}),empty:{icon:ee,description:t(`None of your posts or pages have comments yet.`,`jetpack-premium-analytics-pkg`)},renderLoading:(0,j.jsx)(ae,{rows:10}),children:(0,j.jsx)(f,{data:c,withOverlayLabel:!0,showLegend:!1,dataFormat:M})})}),(0,j.jsx)(p,{children:(0,j.jsx)(h,{report:`comments`,section:`posts`,ariaLabel:t(`See the commented posts report`,`jetpack-premium-analytics-pkg`)})})]})}function A({attributes:e={}}){return(0,j.jsx)(c,{attributes:e,children:(0,j.jsx)(k,{})})}var j,M,N=e((()=>{u(),ue(),a(),n(),s(),ne(),O(),j=r(),M={type:`number`,options:{useMultipliers:!0,decimals:0}}})),P,F=e((()=>{s(),P={icon:o,attributes:[],example:{attributes:{}}}})),I,L,R,z,B,V,H,fe=e((()=>{I=`jpa/most-commented-posts`,L=`Top commented posts`,R=`The posts and pages that receive the most comments.`,z={content:`Your posts and pages, ranked by the number of comments they have received.`,links:[{label:`Learn more`,href:`https://jetpack.com/support/jetpack-stats/`}]},B=`stats`,V=`framed`,H={name:I,title:L,description:R,help:z,category:B,presentation:V}}));function U(){return(0,W.jsx)(A,{attributes:{reportParams:l()}})}function pe(e){return(0,W.jsx)(ce,{...e,widgetType:S(H,P),renderModule:G,renderComponent:A,attributes:{reportParams:l(!0)}})}var W,G,K,q,J,Y,X,Z,Q,$;e((()=>{u(),b(),v(),x(),le(),oe(),N(),F(),fe(),W=r(),se(),G=`storybook/most-commented-posts`,K={title:`Packages/Premium Analytics/Widgets/MostCommentedPosts`,component:A,tags:[`autodocs`],parameters:{docs:{description:{component:`The "Top commented posts" widget. Ranks the posts and pages that receive the most comments, linking each row to the published post. One half of the Jetpack Stats Comments module; "Top commented authors" covers the other.`}}}},q={render:U,decorators:[w,C]},J={render:U,tags:[`!autodocs`],decorators:[w,C],beforeEach:m(`loading`)},Y={render:U,tags:[`!autodocs`],decorators:[w,C],beforeEach:m(`error`)},X={render:U,tags:[`!autodocs`],decorators:[w,C],beforeEach:m(`error-retryable`)},Z={render:U,tags:[`!autodocs`],decorators:[w,C],beforeEach:m(`empty`)},Q={render:e=>(0,W.jsx)(pe,{...e}),args:{...de},argTypes:{...y},decorators:[C]},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
