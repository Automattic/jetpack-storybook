import{i as e}from"./preload-helper-usAeo7Bx.js";import{n as t,t as n}from"./build-module-DQ5lAs4a.js";import{t as r}from"./jsx-runtime-D2pHJD-r.js";import{al as i,n as a}from"./build-module-C6Ow06jV.js";import{n as o,t as s}from"./build-module-_BxIBdxS.js";import{l as c,t as l}from"./src-hyofVqDU.js";import{qn as u,ut as d}from"./chart-tooltip-Dc8Tt97r.js";import{C as f,S as p,k as m}from"./report-metric-B706NzWO.js";import{S as h,b as g,o as _,t as v,x as y,y as b}from"./src-CA3GnO6U.js";import{n as x,r as S}from"./with-widget-canvas-Dz43KNHY.js";import{n as C,t as w}from"./force-stats-mock-state-bHZEaAPv.js";function T({attributes:e={},setError:t}){return(0,E.jsx)(m,{attributes:e,setError:t,options:{from:`/`},children:(0,E.jsx)(_,{limit:5})})}var E,D=e((()=>{v(),E=r()})),O,k=e((()=>{n(),a(),O={name:`jpa/top-performing-bookings`,title:t(`Top performing bookings`,`jetpack-premium-analytics`),help:{content:t(`Your best-selling bookings by revenue over the selected time period.`,`jetpack-premium-analytics`)},icon:i}}));function A(e){let t=e.reduce((e,t)=>({total_orders:e.total_orders+Number(t.orders_count),total_quantity:e.total_quantity+Number(t.total_quantity),total_revenue:e.total_revenue+Number(t.product_net_revenue)}),{total_orders:0,total_quantity:0,total_revenue:0});return{data:e,summary:{total_orders:String(t.total_orders),total_products:String(e.length),total_quantity:String(t.total_quantity),total_revenue:t.total_revenue.toFixed(2)}}}function j(e){H||(H=!0,s.use(async(t,n)=>{let r=t.path??t.url??``;return r.startsWith(z)?A(e):r.startsWith(B)?e.map(e=>({id:Number(e.product_id),name:e.product_name,images:[]})):n(t)}))}function M(e=!1,t=W){return{reportParams:u(e,t)}}function N({withComparison:e,preset:t}){let n=!!e,r=t??W;return!n&&r===W?`getDefaultQueryParams()`:n&&r===W?`getDefaultQueryParams( true )`:`getDefaultQueryParams( ${n?`true`:`false`}, '${r}' )`}function P(e){return`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';

<TopPerformingBookingsRender
\tattributes={ {
\t\treportParams: ${N(e)},
\t} }
/>`}function F({withComparison:e,preset:t}){return(0,R.jsx)(T,{attributes:M(e,t)})}function I(e){return(0,R.jsx)(T,{attributes:M(!1,e)})}function L({withComparison:e,preset:t,...n}){return(0,R.jsx)(g,{...n,widgetType:O,renderModule:U,renderComponent:T,attributes:{reportParams:u(e,t)}})}var R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{o(),d(),l(),p(),y(),x(),C(),D(),k(),R=r(),f(),z=`/jetpack-premium-analytics/v1/proxy/v2/analytics/reports/products`,B=`/wc/v3/products`,V=[{product_id:`801`,product_name:`City tasting tour`,product_net_revenue:`18640.00`,product_gross_revenue:`21320.00`,product_type:`booking`,orders_count:`84`,sku:`BOOK-CITY`,total_quantity:`112`,stock_status:`instock`},{product_id:`802`,product_name:`Private lesson`,product_net_revenue:`14220.00`,product_gross_revenue:`15960.00`,product_type:`bookable-service`,orders_count:`61`,sku:`BOOK-LESSON`,total_quantity:`73`,stock_status:`instock`},{product_id:`803`,product_name:`Weekend retreat`,product_net_revenue:`9350.00`,product_gross_revenue:`10450.00`,product_type:`bookable-event`,orders_count:`38`,sku:`BOOK-RETREAT`,total_quantity:`46`,stock_status:`instock`},{product_id:`804`,product_name:`Strategy session`,product_net_revenue:`5125.00`,product_gross_revenue:`5900.00`,product_type:`booking`,orders_count:`22`,sku:`BOOK-STRATEGY`,total_quantity:`27`,stock_status:`instock`}],H=!1,j(V),U=`storybook/top-performing-bookings`,W=`last-30-days`,G=c,K={title:`Packages/Premium Analytics/Widgets/TopPerformingBookings`,component:T,tags:[`autodocs`],argTypes:{preset:{control:`select`,options:G,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{description:{component:`Dashboard widget that displays top booking products by net revenue for the selected period.`}}}},q={render:F,args:{preset:W,withComparison:!1},decorators:[S],parameters:{docs:{source:{transform:(e,t)=>P(t.args)}}}},J={render:F,args:{preset:W,withComparison:!0},decorators:[S],parameters:{docs:{source:{transform:(e,t)=>P(t.args)}}}},Y={render:()=>I(`last-90-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(w(`reports/products`,`loading`),()=>w(`reports/products`,null))},X={render:()=>I(`last-7-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(w(`reports/products`,`error`),()=>w(`reports/products`,null))},Z={render:()=>I(`last-365-days`),tags:[`!autodocs`],decorators:[S],beforeEach:()=>(w(`reports/products`,`empty`),()=>w(`reports/products`,null))},Q={render:e=>(0,R.jsx)(L,{...e}),args:{...b,preset:W,withComparison:!0},argTypes:{...h,preset:{control:`select`,options:G,description:`Date-range preset used to generate the widget report params.`},withComparison:{control:`boolean`,description:`Include previous-period comparison report params.`}},parameters:{docs:{source:{code:`import { getDefaultQueryParams } from '@jetpack-premium-analytics/data';
