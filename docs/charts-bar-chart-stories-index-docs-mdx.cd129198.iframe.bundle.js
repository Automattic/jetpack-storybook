(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[1954],{"../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.0.8_@test_ca37a3433c216fd610726ebbc5860d83/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive":(l=>{function a(r){var o=new Error("Cannot find module '"+r+"'");throw o.code="MODULE_NOT_FOUND",o}a.keys=()=>[],a.resolve=a,a.id="../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.0.8_@test_ca37a3433c216fd610726ebbc5860d83/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive",l.exports=a}),"../charts/src/charts/bar-chart/stories/index.docs.mdx":((l,a,r)=>{"use strict";r.r(a),r.d(a,{default:()=>h});var o=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),d=r("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.26_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),i=r("../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.0.8_@test_ca37a3433c216fd610726ebbc5860d83/node_modules/@storybook/addon-docs/dist/blocks.js"),t=r("../charts/src/charts/bar-chart/stories/index.stories.tsx");function c(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...(0,d.R)(),...s.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(i.W8,{title:"JS Packages/Charts Library/Charts/Bar Chart",of:t}),`
...
`,(0,e.jsxs)(n.p,{children:["For detailed information about component props, types, and method signatures, see the ",(0,e.jsx)(n.a,{href:"./?path=/docs/js-packages-charts-library-charts-bar-chart-api-reference--docs",children:"Bar Chart API Reference"}),"."]}),`
...
`,(0,e.jsx)(i.Hl,{of:t.SingleSeries}),`
...
`,(0,e.jsx)(i.Hl,{of:t.HorizontalBarChart}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<BarChart
	data={data}
...
`,(0,e.jsx)(i.Hl,{of:t.ManyDataSeries}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<BarChart
...
`,(0,e.jsx)(i.Hl,{of:t.WithPatterns}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<BarChart
	data={data}
	withPatterns={true}
	withTooltips={true}
...
`,(0,e.jsx)(i.Hl,{of:t.SmartFormatting}),`
...
`,(0,e.jsx)(i.Hl,{of:t.ZeroValueComparison}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<BarChart
	data={dataWithZeros}
	showZeroValues={true}
	withTooltips={true}
...
`,(0,e.jsx)(i.Hl,{of:t.WithInteractiveLegend}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<BarChart
	data={data}
	showLegend={true}
...
`,(0,e.jsx)(i.Hl,{of:t.CustomLegendPositioning}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<BarChart
	data={data}
	showLegend={true}
...
`,(0,e.jsx)(i.Hl,{of:t.WithCompositionLegend}),`
`,(0,e.jsx)(i.kL,{language:"jsx",code:`<BarChart
	data={data}
	withTooltips={true}
	gridVisibility="x"
...
`,(0,e.jsx)(i.Hl,{of:t.FixedDimensions}),`
...
`,(0,e.jsxs)(n.p,{children:["Bar Charts integrate seamlessly with the chart theming system. The default theme has neutral colors and styling, and is automatically applied to all charts unless a custom theme is provided. A custom theme can be provided by wrapping your chart in ",(0,e.jsx)(n.code,{children:"GlobalChartsProvider"})," and passing a custom theme object with the properties you want to override to the ",(0,e.jsx)(n.code,{children:"theme"})," prop:"]}),`
...
`,(0,e.jsx)(n.p,{children:"The Bar Chart component supports an optional entry animation that creates a smooth reveal effect when the chart first renders:"}),`
`,(0,e.jsx)(i.Hl,{of:t.Animation}),`
...
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:"Effect"}),": Creates a growing effect where bars scale from zero to their full size. Vertical bars rise from the bottom, while horizontal bars stretch from the left"]}),`
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:"Duration"}),": 1000ms (1 second) with ease-out timing"]}),`
`]}),`
`,(0,e.jsxs)(n.p,{children:[(0,e.jsx)(n.strong,{children:"Note"}),": The animation plays once when the chart initially renders and does not repeat."]})]})}function h(s={}){const{wrapper:n}={...(0,d.R)(),...s.components};return n?(0,e.jsx)(n,{...s,children:(0,e.jsx)(c,{...s})}):c(s)}})}]);
