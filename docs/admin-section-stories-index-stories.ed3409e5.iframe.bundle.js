...
`,P={_default:{startLoc:{col:17,line:13},endLoc:{col:2,line:41},startBody:{col:17,line:13},endBody:{col:2,line:41}},onlyBasic:{startLoc:{col:25,line:47},endLoc:{col:2,line:60},startBody:{col:25,line:47},endBody:{col:2,line:60}},onlyHero:{startLoc:{col:24,line:63},endLoc:{col:2,line:76},startBody:{col:24,line:63},endBody:{col:2,line:76}}};const A={parameters:{storySource:{source:`import AdminPage from '../../admin-page/index.js';
import Col from '../../layout/col/index.js';
import Container from '../../layout/container/index.js';
import AdminSection from '../basic/index.js';
import AdminSectionHero from '../hero/index.js';
