...
`,g={Default:{startLoc:{col:17,line:30},endLoc:{col:2,line:32},startBody:{col:17,line:30},endBody:{col:2,line:32}}};const S={parameters:{storySource:{source:`import React from 'react';
import DiffViewer from '../index.tsx';
