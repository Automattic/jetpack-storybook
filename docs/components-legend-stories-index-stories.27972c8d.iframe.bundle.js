...
}`,...u.parameters?.docs?.source}}}}),"../charts/src/stories/chart-decorator.tsx":((N,E,c)=>{c.d(E,{OI:()=>h,cg:()=>R,xo:()=>L});var C=c("../number-formatters/src/index.ts"),x=c("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),b=c("../charts/src/providers/chart-context/global-charts-provider.tsx"),d=c("../charts/src/stories/theme-config.tsx"),g=c("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const h=(f,O)=>{const v=O.args;return R(()=>(0,g.jsx)("div",{style:{resize:v.resize||"both",overflow:"auto",padding:"1rem",width:v.containerWidth||"800px",height:v.containerHeight,maxWidth:"1200px",border:"1px dashed #ccc",display:"inline-block"},children:(0,g.jsx)(f,{})}),O)},t=f=>/^#[0-9A-Fa-f]{3}$|^#[0-9A-Fa-f]{6}$/.test(f),o=({children:f,themeName:O="default",accentColor:v=d.Zs})=>{(0,x.useEffect)(()=>{typeof window<"u"&&window.navigator?.language&&(0,C.xS)(window.navigator.language)},[]);const y=d.yI[O],A=t(v)?v:d.Zs,n=O==="custom"?`custom-${A}`:O;return(0,g.jsxs)(g.Fragment,{children:[O==="custom"&&(0,g.jsx)("style",{children:`
						:root {
