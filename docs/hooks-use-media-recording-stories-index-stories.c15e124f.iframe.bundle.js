"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[9441],{"../ai-client/src/hooks/use-media-recording/stories/index.stories.tsx":(k,y,c)=>{c.r(y),c.d(y,{Default:()=>v,__namedExportsOrder:()=>V,default:()=>K});var u=c("../../../node_modules/.pnpm/@wordpress+components@29.3.0_@types+react@18.3.18_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/button/index.js"),n=c("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),_=c("../ai-client/src/components/audio-duration-display/index.tsx");const s="audio/mp4;codecs=mp4a",o="audio/mp4",i="audio/webm";function g({onDone:h}={}){const e=(0,n.useRef)(null),[p,d]=(0,n.useState)("inactive"),b=(0,n.useRef)(!1),l=(0,n.useRef)(0),[C,R]=(0,n.useState)(0),E=(0,n.useRef)(null),[W,M]=(0,n.useState)(null),D=(0,n.useRef)([]).current,[G,B]=(0,n.useState)(null),A=(0,n.useRef)(null);function T(){return MediaRecorder.isTypeSupported(s)?new Blob(D,{type:o}):new Blob(D,{type:i})}const H=(0,n.useCallback)(r=>{if(U(),!r)return e?.current?.start();r<100&&(r=100),l.current=Date.now(),e?.current?.start(r)},[]),Q=(0,n.useCallback)(()=>{b.current=!0,e?.current?.pause(),R(r=>r+Date.now()-l.current)},[]),X=(0,n.useCallback)(()=>{b.current=!1,e?.current?.resume(),l.current=Date.now()},[]),L=(0,n.useCallback)(()=>{e?.current?.stop(),p==="recording"&&R(r=>r+Date.now()-l.current)},[]),U=(0,n.useCallback)(()=>{D.length=0,M(null),B(null),R(0),b.current=!1,l.current=0},[]),w=(0,n.useCallback)(()=>{e?.current&&(e.current.removeEventListener("start",O),e.current.removeEventListener("stop",z),e.current.removeEventListener("pause",N),e.current.removeEventListener("resume",Y),e.current.removeEventListener("dataavailable",$),e.current=null)},[]),I=(0,n.useCallback)(()=>{if(d("inactive"),U(),w(),!navigator.mediaDevices?.getUserMedia)return;const r=new AudioContext;A.current=r.createAnalyser();const j={audio:!0};navigator.mediaDevices.getUserMedia(j).then(m=>{E.current=m,r.createMediaStreamSource(m).connect(A.current),MediaRecorder.isTypeSupported(s)?e.current=new MediaRecorder(m,{mimeType:s}):e.current=new MediaRecorder(m,{mimeType:i}),e.current.addEventListener("start",O),e.current.addEventListener("stop",z),e.current.addEventListener("pause",N),e.current.addEventListener("resume",Y),e.current.addEventListener("dataavailable",$)}).catch(m=>{throw m})},[]),Z=(0,n.useCallback)(r=>{L(),B(typeof r=="string"?r:r.message),d("error")},[]);function O(){d("recording")}function z(){const r=T();h?.(r),D.length=0}function N(){d("paused")}function Y(){d("recording")}function $(r){const{data:j}=r;j?.size&&(D.push(j),M(T()),b.current||R(m=>{const P=Date.now(),tt=P-l.current;return l.current=P,m+tt}))}function q(){E.current&&E.current.getTracks().forEach(j=>j.stop())}return(0,n.useEffect)(()=>(I(),()=>{q(),w()}),[]),{state:p,blob:W,error:G,duration:C,analyser:A.current,onError:Z,controls:{start:H,pause:Q,resume:X,stop:L,reset:I}}}var t=c("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),f=`/**
