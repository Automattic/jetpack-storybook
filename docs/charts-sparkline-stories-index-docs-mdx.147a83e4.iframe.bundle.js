...
Automatically respects user's prefers-reduced-motion system setting.`,name:"animation",required:!1,type:{name:"boolean"}},withGradientFill:{defaultValue:{value:"true"},description:"Whether to render the gradient fill beneath the line",name:"withGradientFill",required:!1,type:{name:"boolean"}},strokeWidth:{defaultValue:{value:"1"},description:"Line stroke width in pixels",name:"strokeWidth",required:!1,type:{name:"number"}},gradient:{defaultValue:null,description:`Gradient configuration for area fill
