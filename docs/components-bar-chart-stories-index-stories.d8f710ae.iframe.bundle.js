"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[1383],{"../charts/src/components/bar-chart/stories/index.stories.tsx":(_,p,n)=>{n.r(p),n.d(p,{CustomLegendPositioning:()=>w,Default:()=>r,ErrorStates:()=>g,FixedDimensions:()=>f,HorizontalBarChart:()=>D,ManyDataSeries:()=>a,SingleSeries:()=>u,SmartFormatting:()=>y,TimeSeries:()=>d,WithCompositionLegend:()=>v,WithLegend:()=>l,WithPatterns:()=>b,ZeroValueComparison:()=>S,__namedExportsOrder:()=>C,default:()=>o});var m=n("../charts/src/stories/legend-config.tsx"),h=n("../charts/src/components/line-chart/stories/large-values-sample.ts"),c=n("../charts/src/components/line-chart/stories/site-traffic-sample.ts"),i=n("../charts/src/components/bar-chart/bar-chart.tsx"),s=n("../charts/src/components/bar-chart/stories/sample-data.ts"),e=n("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const o={title:"JS Packages/Charts/Types/Bar Chart",component:i.A,parameters:{layout:"centered"},decorators:[T=>(0,e.jsx)("div",{style:{resize:"both",overflow:"auto",padding:"2rem",width:"800px",maxWidth:"1200px",border:"1px dashed #ccc",display:"inline-block"},children:(0,e.jsx)(T,{})})],argTypes:{maxWidth:{control:{type:"number",min:100,max:1200}},aspectRatio:{control:{type:"number",min:0,max:1}},resizeDebounceTime:{control:{type:"number",min:0,max:1e4}},...m.r}},r={args:{withTooltips:!0,data:[s.A[0],s.A[1],s.A[2]],gridVisibility:"x",maxWidth:1200,aspectRatio:.5,resizeDebounceTime:300}},u={args:{...r.args,data:[s.A[0]]},parameters:{docs:{description:{story:"Bar chart with a single data series."}}}},d={args:{...r.args,data:[{...c.A[0],label:"Data with dateString and date",data:[...c.A[0].data,{dateString:"2024-01-31",value:2230},{dateString:"2024-02-01",value:2580},{date:new Date("2024-02-02 00:00:00"),value:3500},{dateString:"2024-02-03 00:00:00",value:1500},{dateString:"2024-02-04",value:2500},{dateString:"2024-02-05 00:00",value:3e3}]}],options:{axis:{x:{tickFormat:T=>new Date(T).toLocaleDateString("en-US",{dateStyle:"short"})}}}},parameters:{docs:{description:{story:"Bar chart with a time series."}}}},a={args:{...r.args,data:s.A},parameters:{docs:{description:{story:"Bar chart with many data series."}}}},f={args:{...r.args,width:800,height:400,data:[s.A[0],s.A[1],s.A[2]]},parameters:{docs:{description:{story:"Bar chart with fixed dimensions that override the responsive behavior."}}}},b={args:{...r.args,withPatterns:!0,data:s.A.map(T=>({...T,data:T.data.filter(V=>parseInt(V.label)>=2016)}))}},g={render:()=>(0,e.jsxs)("div",{style:{display:"grid",gap:"20px"},children:[(0,e.jsxs)("div",{children:[(0,e.jsx)("h3",{children:"Empty Data"}),(0,e.jsx)("div",{style:{width:"400px",height:"300px"},children:(0,e.jsx)(i.A,{data:[]})})]}),(0,e.jsxs)("div",{children:[(0,e.jsx)("h3",{children:"Invalid Data"}),(0,e.jsx)("div",{style:{width:"400px",height:"300px"},children:(0,e.jsx)(i.A,{data:[{label:"Invalid Series",data:[{date:new Date("invalid"),value:10,label:"Invalid Date"},{date:new Date("2024-01-02"),value:null,label:"Null Value"}],options:{}}]})})]})]})};g.parameters={docs:{description:{story:"Examples of how the bar chart handles various error states including empty data and invalid data."}}};const y={args:{withTooltips:!0,data:h.A,gridVisibility:"x"}};y.parameters={docs:{description:{story:'Demonstrates the Smart Formatting feature (formatYTick) that automatically formats Y-axis tick labels based on the data range. Values \u22651B are formatted as "1.23B", \u22651M as "1.2M", \u22651K as "1k", and smaller values as "1,234". This example shows revenue in billions and users in millions.'}}};const l={args:{...r.args,showLegend:!0}},v={render:()=>(0,e.jsx)("div",{style:{width:"800px"},children:(0,e.jsx)(i.A,{data:[s.A[0],s.A[1],s.A[2]],withTooltips:!0,gridVisibility:"x",maxWidth:1200,aspectRatio:.5,children:(0,e.jsx)(i.A.Legend,{orientation:"horizontal",alignment:"center",position:"bottom"})})}),parameters:{docs:{description:{story:"Demonstrates using the composition API with `<BarChart.Legend />` as a child component. This provides the same functionality as the `showLegend` prop but allows for more flexible composition patterns."}}}},w={args:{withTooltips:!0,data:s.A.slice(0,3),gridVisibility:"x",maxWidth:1200,aspectRatio:.5,resizeDebounceTime:300,showLegend:!0,legendOrientation:"vertical",legendAlignment:"start",legendPosition:"top"},parameters:{docs:{description:{story:"Bar chart with top-left positioned vertical legend. This demonstrates non-default legend positioning to showcase different legend placement possibilities."}}}},D={args:{...r.args,data:[s.A[0],s.A[1],s.A[2]],orientation:"horizontal",gridVisibility:"none"}},x=[{group:"United States",label:"United States",data:[{label:"1896",value:0},{label:"1900",value:0},{label:"1904",value:2},{label:"1908",value:1},{label:"1912",value:3}]},{group:"Great Britain",label:"Great Britain",data:[{label:"1896",value:1},{label:"1900",value:0},{label:"1904",value:1},{label:"1908",value:10},{label:"1912",value:9}]},{group:"Japan",label:"Japan",data:[{label:"1896",value:2},{label:"1900",value:1},{label:"1904",value:2},{label:"1908",value:1},{label:"1912",value:2}]}],S={render:()=>(0,e.jsxs)("div",{style:{display:"grid",gap:"40px"},children:[(0,e.jsxs)("div",{children:[(0,e.jsx)("h3",{children:"Zero Value Display: Disabled (Default)"}),(0,e.jsx)("p",{style:{marginBottom:"20px",color:"#666"},children:"Zero values are not visually displayed. Bars with zero values have no height."}),(0,e.jsx)("div",{style:{width:"600px",height:"300px"},children:(0,e.jsx)(i.A,{data:x,showZeroValues:!1,withTooltips:!0,gridVisibility:"x"})})]}),(0,e.jsxs)("div",{children:[(0,e.jsx)("h3",{children:"Zero Value Display: Enabled"}),(0,e.jsx)("p",{style:{marginBottom:"20px",color:"#666"},children:"Zero values are visually displayed with minimum height bars. The tooltip still shows the actual value of 0, while the bar has a small visual height for better UX."}),(0,e.jsx)("div",{style:{width:"600px",height:"300px"},children:(0,e.jsx)(i.A,{data:x,showZeroValues:!0,withTooltips:!0,gridVisibility:"x"})})]})]}),parameters:{docs:{description:{story:"Comparison showing the difference between disabled and enabled zero value display modes. The feature preserves data integrity by keeping the original value for tooltips while providing visual feedback through minimum bar heights."}}}},C=["Default","SingleSeries","TimeSeries","ManyDataSeries","FixedDimensions","WithPatterns","ErrorStates","SmartFormatting","WithLegend","WithCompositionLegend","CustomLegendPositioning","HorizontalBarChart","ZeroValueComparison"];r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    withTooltips: true,
...
}`,...S.parameters?.docs?.source}}}},"../charts/src/components/line-chart/stories/large-values-sample.ts":(_,p,n)=>{n.d(p,{A:()=>h});const h=[{label:"Revenue (Billions)",data:[{date:new Date("2024-01-01"),value:12e8},{date:new Date("2024-02-01"),value:145e7},{date:new Date("2024-03-01"),value:168e7},{date:new Date("2024-04-01"),value:21e8},{date:new Date("2024-05-01"),value:235e7},{date:new Date("2024-06-01"),value:28e8}],options:{stroke:"#3858E9"}},{label:"Users (Millions)",data:[{date:new Date("2024-01-01"),value:45e6},{date:new Date("2024-02-01"),value:52e6},{date:new Date("2024-03-01"),value:48e6},{date:new Date("2024-04-01"),value:61e6},{date:new Date("2024-05-01"),value:75e6},{date:new Date("2024-06-01"),value:89e6}],options:{stroke:"#00BA37"}}]},"../charts/src/components/line-chart/stories/site-traffic-sample.ts":(_,p,n)=>{n.d(p,{A:()=>m});const m=[{label:"Views",options:{stroke:"#069e08"},data:[{date:new Date("2024-01-01"),value:2558},{date:new Date("2024-01-02"),value:3399},{date:new Date("2024-01-03"),value:2260},{date:new Date("2024-01-04"),value:2331},{date:new Date("2024-01-05"),value:3302},{date:new Date("2024-01-06"),value:1852},{date:new Date("2024-01-07"),value:2607},{date:new Date("2024-01-08"),value:2804},{date:new Date("2024-01-09"),value:3260},{date:new Date("2024-01-10"),value:2941},{date:new Date("2024-01-11"),value:2857},{date:new Date("2024-01-12"),value:3461},{date:new Date("2024-01-13"),value:1548},{date:new Date("2024-01-14"),value:2739},{date:new Date("2024-01-15"),value:3288},{date:new Date("2024-01-16"),value:2869},{date:new Date("2024-01-17"),value:2590},{date:new Date("2024-01-18"),value:2609},{date:new Date("2024-01-19"),value:2648},{date:new Date("2024-01-20"),value:1805},{date:new Date("2024-01-21"),value:2531},{date:new Date("2024-01-22"),value:3605},{date:new Date("2024-01-23"),value:2366},{date:new Date("2024-01-24"),value:2782},{date:new Date("2024-01-25"),value:2885},{date:new Date("2024-01-26"),value:2918},{date:new Date("2024-01-27"),value:2518},{date:new Date("2024-01-28"),value:2378},{date:new Date("2024-01-29"),value:2714},{date:new Date("2024-01-30"),value:3279}]},{label:"Visitors",options:{stroke:"rgb(230, 139, 40)"},data:[{date:new Date("2024-01-01"),value:2412},{date:new Date("2024-01-02"),value:1899},{date:new Date("2024-01-03"),value:2061},{date:new Date("2024-01-04"),value:1939},{date:new Date("2024-01-05"),value:1986},{date:new Date("2024-01-06"),value:1560},{date:new Date("2024-01-07"),value:1741},{date:new Date("2024-01-08"),value:2120},{date:new Date("2024-01-09"),value:1889},{date:new Date("2024-01-10"),value:1666},{date:new Date("2024-01-11"),value:2396},{date:new Date("2024-01-12"),value:2276},{date:new Date("2024-01-13"),value:1218},{date:new Date("2024-01-14"),value:1228},{date:new Date("2024-01-15"),value:1600},{date:new Date("2024-01-16"),value:1814},{date:new Date("2024-01-17"),value:1701},{date:new Date("2024-01-18"),value:1507},{date:new Date("2024-01-19"),value:1833},{date:new Date("2024-01-20"),value:1407},{date:new Date("2024-01-21"),value:965},{date:new Date("2024-01-22"),value:2288},{date:new Date("2024-01-23"),value:2135},{date:new Date("2024-01-24"),value:1824},{date:new Date("2024-01-25"),value:2219},{date:new Date("2024-01-26"),value:1918},{date:new Date("2024-01-27"),value:1101},{date:new Date("2024-01-28"),value:1695},{date:new Date("2024-01-29"),value:1615},{date:new Date("2024-01-30"),value:2056}]}]},"../charts/src/components/shared/use-chart-data-transform.ts":(_,p,n)=>{n.d(p,{E:()=>t});var m=n("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),h=n("../../../node_modules/.pnpm/date-fns@4.1.0/node_modules/date-fns/parseISO.js"),c=n("../../../node_modules/.pnpm/date-fns@4.1.0/node_modules/date-fns/isValid.js"),i=n("../../../node_modules/.pnpm/date-fns@4.1.0/node_modules/date-fns/parse.js");const s=o=>/T.*[Z]$|T.*[+-]\d{2}:?\d{2}$/.test(o),e=o=>{const r=o.trim();if(s(r)){const d=(0,h.H)(r);return(0,c.f)(d)?d:new Date(NaN)}const u=["yyyy-MM-dd","yyyy-MM-dd HH:mm:ss","yyyy-MM-dd HH:mm","yyyy-MM-dd'T'HH:mm:ss","yyyy-MM-dd'T'HH:mm:ss.SSS","yyyy-MM-dd'T'HH:mm"];for(const d of u){const a=(0,i.qg)(r,d,new Date);if((0,c.f)(a))return a}return new Date(NaN)},t=o=>(0,m.useMemo)(()=>{const r=o?.[0]?.data?.[0];return r&&("date"in r||"dateString"in r)?o.map(d=>({...d,data:d.data.map(a=>{let f;return"date"in a&&a.date?f=a.date:"dateString"in a&&a.dateString&&(f=e(a.dateString)),{...a,date:f}}).sort((a,f)=>!a.date||!f.date?0:a.date.getTime()-f.date.getTime())})):o},[o])},"../charts/src/components/shared/use-chart-margin.tsx":(_,p,n)=>{n.d(p,{a:()=>s});var m=n("../../../node_modules/.pnpm/@visx+scale@3.12.0/node_modules/@visx/scale/esm/createScale.js"),h=n("../../../node_modules/.pnpm/@visx+scale@3.12.0/node_modules/@visx/scale/esm/utils/getTicks.js"),c=n("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),i=n("../charts/src/components/shared/utils.ts");const s=(e,t,o,r,u=!1)=>{const d=(0,c.useMemo)(()=>{const a=o.flatMap(y=>y.data);if(u)return a.map(y=>y.label||t.axis?.y?.tickFormat(y.date.getTime(),0,[]));const f=Math.min(...a.map(y=>y.value)),b=Math.max(...a.map(y=>y.value)),g=(0,m.A)({...t.yScale,domain:[f,b],range:[e,0]});return(0,h.A)(g,t.axis?.y?.numTicks)},[t,o,e,u]);return(0,c.useMemo)(()=>{const a={top:10,right:20,bottom:20,left:20},f=40,b=t.axis?.y?.orientation,g=b==="right"?r.axisStyles.y.right:r.axisStyles.y.left,l=((0,i.S)(d,t.axis?.y?.tickFormat,g.axisLabel)??f)+(g?.tickLength??0);return b==="right"?a.right=l:a.left=l,t.axis?.x?.orientation==="top"&&(a.top=20,a.bottom=10),a},[t,r,d])}},"../charts/src/components/shared/utils.ts":(_,p,n)=>{n.d(p,{S:()=>h,n:()=>c});var m=n("../../../node_modules/.pnpm/@visx+text@3.12.0_react@18.3.1/node_modules/@visx/text/esm/util/getStringWidth.js");const h=(i,s,e)=>{const t=i.map(r=>s(r,0,[])),o=t.reduce((r,u)=>r.length>=u.length?r:u,t[0]);return(0,m.A)(o,e)},c=()=>typeof navigator<"u"&&navigator.userAgent?/^((?!chrome|android).)*safari/i.test(navigator.userAgent):!1},"../charts/src/components/tooltip/accessible-tooltip.tsx":(_,p,n)=>{n.d(p,{JZ:()=>e,OZ:()=>s});var m=n("../../../node_modules/.pnpm/@visx+xychart@3.12.0_@react-spring+web@9.7.5_react-dom@18.3.1_react@18.3.1__react@18.3._4b886f56cd4cf4d0010e6b97cb6a93f7/node_modules/@visx/xychart/esm/context/TooltipContext.js"),h=n("../../../node_modules/.pnpm/@visx+xychart@3.12.0_@react-spring+web@9.7.5_react-dom@18.3.1_react@18.3.1__react@18.3._4b886f56cd4cf4d0010e6b97cb6a93f7/node_modules/@visx/xychart/esm/components/Tooltip.js"),c=n("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),i=n("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const s=({renderTooltip:t,selectedIndex:o,tooltipRef:r,keyboardFocusedClassName:u,series:d=[],mode:a="group",...f})=>{const b=(0,c.useContext)(m.A),g=(0,c.useMemo)(()=>{if(a!=="individual")return[];if(d.length===0)return[];const l=Math.max(...d.map(w=>w.data.length)),v=[];for(let w=0;w<l;w++)for(let D=0;D<d.length;D++){const x=d[D];w<x.data.length&&v.push({datum:x.data[w],seriesLabel:x.label,seriesIndex:D,dataPointIndex:w})}return v},[d,a]);(0,c.useEffect)(()=>{if(o===void 0){b?.hideTooltip();return}if(a==="group")d.forEach((l,v)=>{if(o<l.data.length){const w=l.data[o];b?.showTooltip({datum:w,key:l.label,index:v})}});else if(a==="individual"&&o<g.length){const l=g[o];b?.showTooltip({datum:l.datum,key:l.seriesLabel,index:l.seriesIndex})}},[o,g,d]);const y=(0,c.useMemo)(()=>{if(t)return l=>{const v=t(l);return o!==void 0?(0,i.jsx)("div",{ref:r,tabIndex:-1,role:"tooltip","aria-atomic":"true",className:u,"data-testid":`chart-tooltip-${o}`,children:v},`chart-tooltip-${o}`):(0,i.jsx)("div",{role:"tooltip","aria-live":"polite",children:v})}},[t,o,r,u]);return(0,i.jsx)(h.A,{...f,renderTooltip:y})},e=({selectedIndex:t,setSelectedIndex:o,isNavigating:r,setIsNavigating:u,chartRef:d,totalPoints:a})=>{const f=(0,c.useCallback)(l=>{l&&t!==void 0&&l.focus()},[t]),b=(0,c.useCallback)(()=>{!r&&t!==void 0&&o(0)},[r,t,o]),g=(0,c.useCallback)(()=>{u(!1)},[u]),y=(0,c.useCallback)(l=>{if(a===0)return;if(l.key==="Tab"){d.current?.focus(),o(void 0),u(!1);return}const v=t===void 0?-1:t;if(v+1>=a&&["ArrowRight"].includes(l.key)){d.current?.focus(),o(void 0),u(!1);return}l.preventDefault(),["ArrowRight"].includes(l.key)?(u(!0),o((v+1)%a)):["ArrowLeft"].includes(l.key)?(u(!0),o((v-1+a)%a)):l.key==="Escape"&&(o(void 0),u(!1),d.current?.focus())},[a,t,o,u,d]);return{tooltipRef:f,onChartFocus:b,onChartBlur:g,onChartKeyDown:y}};try{s.displayName="AccessibleTooltip",s.__docgenInfo={description:"",displayName:"AccessibleTooltip",props:{renderTooltip:{defaultValue:null,description:"",name:"renderTooltip",required:!1,type:{name:"(params: RenderTooltipParams<DataPointDate>) => ReactNode"}},selectedIndex:{defaultValue:null,description:"",name:"selectedIndex",required:!1,type:{name:"number"}},tooltipRef:{defaultValue:null,description:"",name:"tooltipRef",required:!1,type:{name:"(element: HTMLDivElement) => void"}},keyboardFocusedClassName:{defaultValue:null,description:"",name:"keyboardFocusedClassName",required:!1,type:{name:"string"}},tooltipData:{defaultValue:null,description:`Flattened tooltip data prepared by parent component
...
passed to XYChart, or injected into this component.`,name:"resizeObserverPolyfill",required:!1,type:{name:"new (cb: ResizeObserverCallback) => ResizeObserver"}},className:{defaultValue:null,description:"Optional className to apply to the Tooltip in addition to `visx-tooltip`.",name:"className",required:!1,type:{name:"string"}},style:{defaultValue:null,description:"Styles to apply, unless `unstyled=true`.",name:"style",required:!1,type:{name:"React.CSSProperties"}},offsetLeft:{defaultValue:null,description:"Offset the `left` position of the Tooltip by this margin.",name:"offsetLeft",required:!1,type:{name:"number"}},offsetTop:{defaultValue:null,description:"Offset the `top` position of the Tooltip by this margin.",name:"offsetTop",required:!1,type:{name:"number"}},applyPositionStyle:{defaultValue:null,description:"Applies position: 'absolute' for tooltips to correctly position themselves\nwhen `unstyled=true`. In a future major release this will be the default behavior.",name:"applyPositionStyle",required:!1,type:{name:"boolean"}},unstyled:{defaultValue:null,description:"Whether to omit applying any style, except `left` / `top`.\nIn most cases if this is `true` a developer must do one of the following\nfor positioning to work correctly:\n- set `applyPositionStyle=true`\n- create a CSS selector like: `.visx-tooltip { position: 'absolute' }`",name:"unstyled",required:!1,type:{name:"boolean"}},zIndex:{defaultValue:null,description:"Optional z-index to set on the Portal.",name:"zIndex",required:!1,type:{name:"string | number"}},debounce:{defaultValue:null,description:"Debounce resize or scroll events in milliseconds (needed for positioning)",name:"debounce",required:!1,type:{name:"number | { scroll: number; resize: number; }"}},detectBounds:{defaultValue:null,description:"whether TooltipWithBounds should be used to auto-detect (page) boundaries and reposition itself.",name:"detectBounds",required:!1,type:{name:"boolean"}},scroll:{defaultValue:null,description:"React to nested scroll changes, don't use this if you know your view is static",name:"scroll",required:!1,type:{name:"boolean"}}}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/components/tooltip/accessible-tooltip.tsx#accessibletooltip"]={docgenInfo:accessibletooltip.__docgenInfo,name:"accessibletooltip",path:"../charts/src/components/tooltip/accessible-tooltip.tsx#accessibletooltip"})}catch{}},"../charts/src/stories/legend-config.tsx":(_,p,n)=>{n.d(p,{r:()=>h});var m=n("../charts/src/providers/theme/themes.ts");const h={showLegend:{control:{type:"boolean"},table:{category:"Legend"}},legendPosition:{control:{type:"select"},options:["top","bottom"],table:{category:"Legend"}},legendAlignment:{control:{type:"select"},options:["start","center","end"],table:{category:"Legend"}},legendOrientation:{control:{type:"select"},options:["horizontal","vertical"],table:{category:"Legend"}},legendShape:{control:{type:"select"},options:["circle","rect"],table:{category:"Legend"}},withLegendGlyph:{control:{type:"boolean"},table:{category:"Legend"},description:"Show glyphs in legend (Line charts only)"},theme:{control:{type:"select"},options:{default:void 0,jetpack:m.QI,woo:m.pk},defaultValue:void 0,table:{category:"Theme"}}};try{h.displayName="legendArgTypes",h.__docgenInfo={description:`Shared legend configuration for chart stories
Provides consistent argTypes and decorators across all chart legend stories`,displayName:"legendArgTypes",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/stories/legend-config.tsx#legendArgTypes"]={docgenInfo:h.__docgenInfo,name:"legendArgTypes",path:"../charts/src/stories/legend-config.tsx#legendArgTypes"})}catch{}},"../charts/src/utils/create-composition.ts":(_,p,n)=>{n.d(p,{E:()=>m});function m(h,c){return Object.assign(h,c)}},"../../../node_modules/.pnpm/clsx@2.1.1/node_modules/clsx/dist/clsx.mjs":(_,p,n)=>{n.d(p,{A:()=>c});function m(i){var s,e,t="";if(typeof i=="string"||typeof i=="number")t+=i;else if(typeof i=="object")if(Array.isArray(i)){var o=i.length;for(s=0;s<o;s++)i[s]&&(e=m(i[s]))&&(t&&(t+=" "),t+=e)}else for(e in i)i[e]&&(t&&(t+=" "),t+=e);return t}function h(){for(var i,s,e=0,t="",o=arguments.length;e<o;e++)(i=arguments[e])&&(s=m(i))&&(t&&(t+=" "),t+=s);return t}const c=h}}]);
