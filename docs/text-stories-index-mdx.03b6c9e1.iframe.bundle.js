(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[1943,2593],{"../../../node_modules/.pnpm/@storybook+addon-docs@10.1.10_@types+react@18.3.27_storybook@10.1.10_@testing-library+d_486c6509fdfe2be64b4e30c6761707fc/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive":(g=>{function c(t){var d=new Error("Cannot find module '"+t+"'");throw d.code="MODULE_NOT_FOUND",d}c.keys=()=>[],c.resolve=c,c.id="../../../node_modules/.pnpm/@storybook+addon-docs@10.1.10_@types+react@18.3.27_storybook@10.1.10_@testing-library+d_486c6509fdfe2be64b4e30c6761707fc/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive",g.exports=c}),"../../../node_modules/.pnpm/ts-dedent@2.2.0/node_modules/ts-dedent/esm/index.js":((g,c,t)=>{"use strict";t.d(c,{A:()=>e,T:()=>d});function d(p){for(var o=[],m=1;m<arguments.length;m++)o[m-1]=arguments[m];var i=Array.from(typeof p=="string"?[p]:p);i[i.length-1]=i[i.length-1].replace(/\r?\n([\t ]*)$/,"");var j=i.reduce(function(n,v){var a=v.match(/\n([\t ]+|(?!\s).)/g);return a?n.concat(a.map(function(s){var u,r;return(r=(u=s.match(/[\t ]/g))===null||u===void 0?void 0:u.length)!==null&&r!==void 0?r:0})):n},[]);if(j.length){var x=new RegExp(`
[	 ]{`+Math.min.apply(Math,j)+"}","g");i=i.map(function(n){return n.replace(x,`
`)})}i[0]=i[0].replace(/^\r?\n/,"");var l=i[0];return o.forEach(function(n,v){var a=l.match(/(?:^|\n)( *)$/),s=a?a[1]:"",u=n;typeof n=="string"&&n.includes(`
`)&&(u=String(n).split(`
`).map(function(r,h){return h===0?r:""+s+r}).join(`
`)),l+=u+i[v+1]}),l}const e=d}),"../../../node_modules/.pnpm/use-sync-external-store@1.6.0_react@18.3.1/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.production.js":((g,c,t)=>{"use strict";/**
 * @license React
 ...
 */var d=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");function e(a,s){return a===s&&(a!==0||1/a===1/s)||a!==a&&s!==s}var p=typeof Object.is=="function"?Object.is:e,o=d.useState,m=d.useEffect,i=d.useLayoutEffect,j=d.useDebugValue;function x(a,s){var u=s(),r=o({inst:{value:u,getSnapshot:s}}),h=r[0].inst,f=r[1];return i(function(){h.value=u,h.getSnapshot=s,l(h)&&f({inst:h})},[a,u,s]),m(function(){return l(h)&&f({inst:h}),a(function(){l(h)&&f({inst:h})})},[a]),j(u),u}function l(a){var s=a.getSnapshot;a=a.value;try{var u=s();return!p(a,u)}catch{return!0}}function n(a,s){return s()}var v=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?n:x;c.useSyncExternalStore=d.useSyncExternalStore!==void 0?d.useSyncExternalStore:v}),"../../../node_modules/.pnpm/use-sync-external-store@1.6.0_react@18.3.1/node_modules/use-sync-external-store/shim/index.js":((g,c,t)=>{"use strict";g.exports=t("../../../node_modules/.pnpm/use-sync-external-store@1.6.0_react@18.3.1/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.production.js")}),"../components/components/text/stories/index.mdx":((g,c,t)=>{"use strict";t.r(c),t.d(c,{default:()=>x});var d=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),p=t("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.26_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),o=t("../../../node_modules/.pnpm/@storybook+addon-docs@10.1.10_@types+react@18.3.27_storybook@10.1.10_@testing-library+d_486c6509fdfe2be64b4e30c6761707fc/node_modules/@storybook/addon-docs/dist/blocks.js"),m=t("../../../node_modules/.pnpm/ts-dedent@2.2.0/node_modules/ts-dedent/esm/index.js"),i=t("../components/components/text/stories/index.stories.tsx");function j(l){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...(0,p.R)(),...l.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(o.W8,{of:i}),`
...
`,(0,e.jsx)(o.kL,{language:"jsx",code:(0,m.A)`
...
`}),`
`,(0,e.jsx)(n.p,{children:(0,e.jsx)(n.a,{href:".?path=/story/js-packages-components-text-title--default",children:"\u25B6\uFE0F Story"})})]})}function x(l={}){const{wrapper:n}={...(0,p.R)(),...l.components};return n?(0,e.jsx)(n,{...l,children:(0,e.jsx)(j,{...l})}):j(l)}}),"../components/components/text/stories/index.stories.tsx":((g,c,t)=>{"use strict";t.r(c),t.d(c,{BoxModel:()=>s,CustomComponent:()=>v,CustomTag:()=>l,Default:()=>x,__namedExportsOrder:()=>u,default:()=>i});var d=t("../components/components/text/index.tsx"),e=t("../components/components/text/constants.ts"),p=t("../components/components/text/stories/style.module.scss"),o=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const m=[0,1,2,3,4,5,6,7,8],i={title:"JS Packages/Components/Text",component:d.Ay,argTypes:{...e.Z.reduce((r,h)=>({...r,[h]:{control:{type:"select"},options:m}}),{}),variant:{control:{type:"select"},options:Object.keys(e.Q)}},subcomponents:{H2:d.H2,H3:d.H3,Title:d.hE}},j=r=>(0,o.jsx)(d.Ay,{...r,children:r.variant??"body"}),x=j.bind({});x.args={variant:"headline-medium"};const l=j.bind({});l.args={variant:"title-small",component:"div"};const n=({className:r,children:h})=>(0,o.jsxs)("span",{className:r,children:[h," Composition"]}),v=j.bind({});v.args={variant:"headline-small",component:n};const s=(r=>(0,o.jsxs)("div",{className:p.A["box-model-wrapper"],children:[(0,o.jsx)("div",{className:p.A["box-model-side-left"]}),(0,o.jsx)("div",{className:p.A["box-model-side-center"],children:(0,o.jsx)(d.Ay,{...r,children:(0,o.jsx)("div",{className:p.A["box-model-inner"],children:"Box Model"})})}),(0,o.jsx)("div",{className:p.A["box-model-side-right"]})]})).bind({}),u=["Default","CustomTag","CustomComponent","BoxModel"];x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:"args => <Text {...args}>{args.variant ?? 'body'}</Text>",...x.parameters?.docs?.source}}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"args => <Text {...args}>{args.variant ?? 'body'}</Text>",...l.parameters?.docs?.source}}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:"args => <Text {...args}>{args.variant ?? 'body'}</Text>",...v.parameters?.docs?.source}}},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`args => <div className={styles['box-model-wrapper']}>
