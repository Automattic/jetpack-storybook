"use strict";(()=>{(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[1366],{"../../packages/videopress/src/client/admin/components/input/stories/index.stories.tsx":(W,E,n)=>{var S,C,H,m,p,v,l,y,b,T,D,d,f,a,o;n.r(E),n.d(E,{Default:()=>g,Search:()=>x,TextArea:()=>i,WithIcon:()=>h,WithLabel:()=>L,__namedExportsOrder:()=>k,default:()=>B});var t=n("../../../node_modules/.pnpm/@storybook+addon-actions@7.6.17/node_modules/@storybook/addon-actions/dist/index.mjs"),M=n("../../../node_modules/.pnpm/@wordpress+icons@9.44.0_react@18.2.0/node_modules/@wordpress/icons/build-module/icon/index.js"),V=n("../../../node_modules/.pnpm/@wordpress+icons@9.44.0_react@18.2.0/node_modules/@wordpress/icons/build-module/library/map-marker.js"),A=n("../../../node_modules/.pnpm/react@18.2.0/node_modules/react/index.js"),_=n("../../packages/videopress/src/client/admin/components/input/index.tsx"),j=n("../../../node_modules/.pnpm/react@18.2.0/node_modules/react/jsx-runtime.js"),N=`import { action } from '@storybook/addon-actions';
...
`,locationsMap:{default:{startLoc:{col:49,line:36},endLoc:{col:1,line:43},startBody:{col:49,line:36},endBody:{col:1,line:43}},"with-icon":{startLoc:{col:49,line:36},endLoc:{col:1,line:43},startBody:{col:49,line:36},endBody:{col:1,line:43}},"with-label":{startLoc:{col:49,line:36},endLoc:{col:1,line:43},startBody:{col:49,line:36},endBody:{col:1,line:43}},"text-area":{startLoc:{col:49,line:36},endLoc:{col:1,line:43},startBody:{col:49,line:36},endBody:{col:1,line:43}},search:{startLoc:{col:66,line:66},endLoc:{col:1,line:74},startBody:{col:66,line:66},endBody:{col:1,line:74}}}}},title:"Packages/VideoPress/Input",component:_.II,argTypes:{size:{options:["small","large"],control:{type:"radio"}},type:{options:["text","textarea","number","url","email","password","tel","search"],control:{type:"select"}}}},u=s=>{(0,t.aD)("onEnter")(s)},e={placeholder:"Placeholder text",disabled:!1,loading:!1,size:"small",type:"text",label:""},c=s=>{const[I,z]=(0,A.useState)(""),R=w=>{z(w)};return(0,j.jsx)(_.II,{...s,value:I,onChange:R,onEnter:u})};c.displayName="Template";const g=c.bind({});g.args=e;const h=c.bind({});h.args={...e,icon:(0,j.jsx)(M.Z,{icon:V.Z,size:24})};const L=c.bind({});L.args={...e,label:"My Label"};const i=c.bind({});i.args={...e,type:"textarea"};const r=s=>{const[I,z]=(0,A.useState)(""),R=w=>{z(w),(0,t.aD)("onChange")(w)};return(0,j.jsx)(_.Mj,{...s,value:I,onChange:R,onEnter:u})};r.displayName="SearchInputTemplate";const x=r.bind({});x.args={disabled:!1,loading:!1,onEnter:(0,t.aD)("onEnter"),onChange:(0,t.aD)("onChange"),onSearch:(0,t.aD)("onSearch"),wait:500},g.parameters={...g.parameters,docs:{...(S=g.parameters)==null?void 0:S.docs,source:{originalSource:`args => {
  const [value, setValue] = useState('');
  const onChange = inputValue => {
    setValue(inputValue);
  };
  return <Input {...args} value={value} onChange={onChange} onEnter={onEnter} />;
}`,...(H=(C=g.parameters)==null?void 0:C.docs)==null?void 0:H.source}}},h.parameters={...h.parameters,docs:{...(m=h.parameters)==null?void 0:m.docs,source:{originalSource:`args => {
  const [value, setValue] = useState('');
  const onChange = inputValue => {
    setValue(inputValue);
  };
  return <Input {...args} value={value} onChange={onChange} onEnter={onEnter} />;
}`,...(v=(p=h.parameters)==null?void 0:p.docs)==null?void 0:v.source}}},L.parameters={...L.parameters,docs:{...(l=L.parameters)==null?void 0:l.docs,source:{originalSource:`args => {
  const [value, setValue] = useState('');
  const onChange = inputValue => {
    setValue(inputValue);
  };
