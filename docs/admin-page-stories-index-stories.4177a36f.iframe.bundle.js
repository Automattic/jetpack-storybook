...
`,P={_default:{startLoc:{col:17,line:31},endLoc:{col:2,line:33},startBody:{col:17,line:31},endBody:{col:2,line:33}},CustomHeader:{startLoc:{col:17,line:31},endLoc:{col:2,line:33},startBody:{col:17,line:31},endBody:{col:2,line:33}}};const x={parameters:{storySource:{source:`import React from 'react';
import JetpackLogo from '../../jetpack-logo/index.js';
import Text from '../../text/index.js';
import AdminPage from '../index.js';
import styles from './style.module.scss';
