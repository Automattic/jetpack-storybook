(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[6936],{"../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.25_react@18.3.1/node_modules/@mdx-js/react/lib/index.js":((x,i,t)=>{"use strict";t.d(i,{R:()=>r,x:()=>o});var c=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");const e={},y=c.createContext(e);function r(h){const s=c.useContext(y);return c.useMemo(function(){return typeof h=="function"?h(s):{...s,...h}},[s,h])}function o(h){let s;return h.disableParentContext?s=typeof h.components=="function"?h.components(e):h.components||e:s=r(h.components),c.createElement(y.Provider,{value:s},h.children)}}),"../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.25_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive":(x=>{function i(t){var c=new Error("Cannot find module '"+t+"'");throw c.code="MODULE_NOT_FOUND",c}i.keys=()=>[],i.resolve=i,i.id="../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.25_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive",x.exports=i}),"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive":(x=>{function i(t){var c=new Error("Cannot find module '"+t+"'");throw c.code="MODULE_NOT_FOUND",c}i.keys=()=>[],i.resolve=i,i.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive",x.exports=i}),"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive":(x=>{function i(t){var c=new Error("Cannot find module '"+t+"'");throw c.code="MODULE_NOT_FOUND",c}i.keys=()=>[],i.resolve=i,i.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive",x.exports=i}),"../charts/src/components/line-chart/stories/glyph.stories.tsx":((x,i,t)=>{"use strict";t.r(i),t.d(i,{Custom:()=>C,CustomPerDataPoint:()=>L,CustomSvg:()=>S,End:()=>b,InTooltip:()=>_,Start:()=>v,__namedExportsOrder:()=>A,default:()=>z});var c=t("../../../node_modules/.pnpm/@visx+glyph@3.12.0_react@18.3.1/node_modules/@visx/glyph/esm/glyphs/GlyphStar.js"),e=t("../charts/src/providers/chart-context/global-charts-provider.tsx"),y=t("../charts/src/providers/chart-context/hooks/use-global-charts-theme.ts"),r=t("../charts/src/stories/theme-config.tsx"),o=t("../charts/src/components/line-chart/line-chart.tsx"),h=t("../charts/src/components/line-chart/stories/config.tsx"),s=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const G={...r.yI,glyph:h.Em},g=(p,{args:l})=>{const a=l.themeName,d=G[a||"default"];return(0,s.jsx)(e.S,{theme:d,children:(0,s.jsx)("div",{style:{resize:"both",overflow:"auto",padding:"2rem",width:"800px",maxWidth:"1200px",border:"1px dashed #ccc",display:"inline-block"},children:(0,s.jsx)(p,{})})})},z={...h.Nc,title:"JS Packages/Charts/Types/Line Chart/Glyphs",decorators:[g],argTypes:{...h.Nc.argTypes,themeName:{...r.jW.themeName,options:["default","jetpack","woo","custom","glyph"]},withStartGlyphs:{control:"boolean",description:"Show glyphs at line start",table:{category:"Glyphs"}},withEndGlyphs:{control:"boolean",description:"Show glyphs at line end",table:{category:"Glyphs"}},withLegendGlyph:{control:"boolean",description:"Show glyphs in legend",table:{category:"Glyphs"}},glyphType:{control:"radio",options:["default","star","heart"],description:"Glyph shape",table:{category:"Glyphs"}},glyphSize:{control:{type:"range",min:4,max:16,step:1},description:"Glyph size (radius)",table:{category:"Glyphs"}}}},D=({color:p,size:l,x:a,y:d})=>{const j=typeof a=="number"&&typeof d=="number"&&(a!==0||d!==0)?{transform:`translate(${a}, ${d})`}:{};return(0,s.jsx)("g",{...j,children:(0,s.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:l*2,height:l*2,viewBox:"0 0 24 24",style:{overflow:"visible",pointerEvents:"none"},children:(0,s.jsx)("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z",fill:p,stroke:p,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",transform:"translate(-12, -12)"})})})},m=p=>{const{glyphType:l,glyphSize:a,...d}=p;let u=d.renderGlyph;l==="star"?u=({color:P,size:w,x:k,y:T})=>(0,s.jsx)(c.A,{top:T,left:k,size:w*w,fill:P}):l==="heart"&&(u=({color:P,size:w,x:k,y:T})=>(0,s.jsx)(D,{color:P,size:w,x:k,y:T}));const j=a?{radius:a}:d.glyphStyle;return(0,s.jsx)(o.A,{...d,renderGlyph:u,glyphStyle:j})},f={...h.pn,withStartGlyphs:!0},v=m.bind({});v.args={...f};const b=m.bind({});b.args={...f,withStartGlyphs:!1,withEndGlyphs:!0};const C=m.bind({});C.args={...f,withLegendGlyph:!0,renderGlyph:({color:p,size:l,x:a,y:d})=>(0,s.jsx)(c.A,{top:d,left:a,size:l*l,fill:p}),glyphStyle:{radius:10}};const E=({color:p,size:l,x:a,y:d})=>{const j=typeof a=="number"&&typeof d=="number"&&(a!==0||d!==0)?{transform:`translate(${a}, ${d})`}:{};return(0,s.jsx)("g",{...j,children:(0,s.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:l*2,height:l*2,viewBox:"0 0 24 24",style:{overflow:"visible",pointerEvents:"none"},children:(0,s.jsx)("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z",fill:p,stroke:p,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",transform:"translate(-12, -12)"})})})},S=m.bind({});S.args={...f,withLegendGlyph:!0,renderGlyph:({color:p,size:l,x:a,y:d})=>(0,s.jsx)(E,{color:p,size:l,x:a,y:d}),glyphStyle:{radius:8}};const O=({tooltipData:p})=>{const l=(0,y.p)();return(0,s.jsxs)("div",{children:[(0,s.jsx)("div",{style:{marginBottom:"0.5rem"},children:p?.nearestDatum?.datum?.date?.toLocaleDateString()}),(0,s.jsx)("div",{children:Object.entries(p?.datumByKey||{}).map(([a,d],u)=>{const{datum:j}=d;return(0,s.jsx)("div",{children:(0,s.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"0.5rem",marginBottom:"0.2rem"},children:[(0,s.jsx)("svg",{width:20,height:20,children:(0,s.jsx)(c.A,{size:100,top:10,left:10,fill:"#fff",stroke:l.colors[u%l.colors.length]})}),a,": ",j.value]})},a)})})]})},_=m.bind({});_.args={...f,renderGlyph:({color:p,size:l,x:a,y:d})=>(0,s.jsx)(c.A,{top:d,left:a,size:l*l,fill:"#fff",stroke:p}),glyphStyle:{radius:10},renderTooltip:O};const L=m.bind({});L.args={...f,showLegend:!0,withStartGlyphs:!0,withLegendGlyph:!0,themeName:"glyph",glyphStyle:{radius:8}};const A=["Start","End","Custom","CustomSvg","InTooltip","CustomPerDataPoint"];v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`args => {
  const {
    glyphType,
    glyphSize,
    ...chartProps
  ...
  return <LineChart {...chartProps} renderGlyph={renderGlyph} glyphStyle={glyphStyle} />;
}`,...S.parameters?.docs?.source}}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`args => {
  const {
    glyphType,
    glyphSize,
    ...chartProps
  ...
  return <LineChart {...chartProps} renderGlyph={renderGlyph} glyphStyle={glyphStyle} />;
}`,..._.parameters?.docs?.source}}},L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`args => {
  const {
    glyphType,
    glyphSize,
    ...chartProps
  ...
  return <LineChart {...chartProps} renderGlyph={renderGlyph} glyphStyle={glyphStyle} />;
}`,...L.parameters?.docs?.source}}}}),"../charts/src/components/line-chart/stories/index.docs.mdx":((x,i,t)=>{"use strict";t.r(i),t.d(i,{default:()=>G});var c=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),y=t("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.25_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),r=t("../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.25_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist/blocks.mjs"),o=t("../charts/src/components/line-chart/stories/index.stories.tsx"),h=t("../charts/src/components/line-chart/stories/glyph.stories.tsx");function s(g){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...(0,y.R)(),...g.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(r.W8,{title:"JS Packages/Charts/Types/Line Chart",of:o}),`
...
`,(0,e.jsxs)(n.p,{children:["For detailed information about component props, types, and method signatures, see the ",(0,e.jsx)(n.a,{href:"./?path=/docs/js-packages-charts-types-line-chart-api-reference--docs",children:"Line Chart API Reference"}),"."]}),`
...
`,(0,e.jsx)(r.Hl,{of:o.SingleSeries}),`
...
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"interactive"})}),": Enable interactive legend items that can toggle series visibility (",(0,e.jsx)(n.code,{children:"false"})," by default, requires ",(0,e.jsx)(n.code,{children:"chartId"})," and ",(0,e.jsx)(n.code,{children:"GlobalChartsProvider"}),")"]}),`
`]}),`
...
`]}),`
`,(0,e.jsxs)(n.p,{children:["For detailed prop information, type definitions, gradient configuration options, and complete annotation API reference, see the ",(0,e.jsx)(n.a,{href:"./?path=/docs/js-packages-charts-types-line-chart-api-reference--docs",children:"Line Chart API Reference"}),"."]}),`
...
`,(0,e.jsx)(r.Hl,{of:o.GradientFilled}),`
`,(0,e.jsx)(r.kL,{language:"jsx",code:`<LineChart
	data={data}
...
`,(0,e.jsx)(r.Hl,{of:o.GradientCustomColors}),`
...
`,(0,e.jsx)(r.Hl,{of:o.GradientTransparent}),`
`,(0,e.jsx)(r.kL,{language:"jsx",code:`const data = [
	{
		label: 'Temperature',
...
`,(0,e.jsx)(r.Hl,{of:o.WithPointerEvents}),`
`,(0,e.jsx)(r.kL,{language:"jsx",code:`<LineChart
	data={data}
...
`,(0,e.jsxs)(n.li,{children:["Set ",(0,e.jsx)(n.code,{children:"interactive={true}"})," and ",(0,e.jsx)(n.code,{children:"showLegend={true}"})]}),`
`]}),`
`,(0,e.jsxs)(n.p,{children:[(0,e.jsx)(n.strong,{children:"Note:"})," Interactive legends are currently supported for LineChart only. Support for other chart types will be added in future releases."]}),`
...
`,(0,e.jsx)(r.Hl,{of:o.SmartFormatting}),`
`,(0,e.jsx)(r.kL,{language:"jsx",code:`<LineChart
	data={data}
	options={{
		axis: {
...
`,(0,e.jsx)(r.Hl,{of:o.FixedDimensions}),`
...
`,(0,e.jsxs)(n.p,{children:["Add contextual information to highlight specific data points or events. For comprehensive annotation documentation, see the ",(0,e.jsx)(n.a,{href:"?path=/docs/js-packages-charts-types-line-chart-annotations--docs",children:"Line Chart Annotations"})," guide. For detailed annotation API reference, see the ",(0,e.jsx)(n.a,{href:"./?path=/docs/js-packages-charts-types-line-chart-api-reference--docs",children:"Line Chart API Reference"}),":"]}),`
...
`,(0,e.jsx)(r.Hl,{of:o.DateStringFormats}),`
...
`,(0,e.jsx)(r.kL,{language:"jsx",code:`import { GlobalChartsProvider, jetpackTheme } from '@automattic/charts';
...
`]})]})}function G(g={}){const{wrapper:n}={...(0,y.R)(),...g.components};return n?(0,e.jsx)(n,{...g,children:(0,e.jsx)(s,{...g})}):s(g)}})}]);
