(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[8731],{"../../../node_modules/.pnpm/@mdx-js+react@3.1.0_@types+react@18.3.23_react@18.3.1/node_modules/@mdx-js/react/lib/index.js":(h,i,r)=>{"use strict";r.d(i,{R:()=>t,x:()=>d});var a=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");const e={},c=a.createContext(e);function t(s){const o=a.useContext(c);return a.useMemo(function(){return typeof s=="function"?s(o):{...o,...s}},[o,s])}function d(s){let o;return s.disableParentContext?o=typeof s.components=="function"?s.components(e):s.components||e:o=t(s.components),a.createElement(c.Provider,{value:o},s.children)}},"../charts/src/components/bar-chart/stories/index.docs.mdx":(h,i,r)=>{"use strict";r.r(i),r.d(i,{default:()=>x});var a=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),c=r("../../../node_modules/.pnpm/@mdx-js+react@3.1.0_@types+react@18.3.23_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),t=r("../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist/blocks.mjs"),d=r("../charts/src/components/bar-chart/stories/index.stories.tsx"),s=r("../charts/src/components/bar-chart/stories/legend.stories.tsx");function o(l){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...(0,c.R)(),...l.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(t.W8,{title:"JS Packages/Charts/Types/Bar Chart",of:d}),`
...
`,(0,e.jsx)(t.Hl,{of:d.HorizontalBarChart}),`
`,(0,e.jsx)(t.kL,{language:"jsx",code:`<BarChart
	data={data}
...
`,(0,e.jsx)(t.Hl,{of:d.ManyDataSeries}),`
`,(0,e.jsx)(t.kL,{language:"jsx",code:`<BarChart
...
`,(0,e.jsx)(t.Hl,{of:d.WithPatterns}),`
`,(0,e.jsx)(t.kL,{language:"jsx",code:`<BarChart
	data={data}
	withPatterns={true}
	withTooltips={true}
...
`,(0,e.jsx)(t.Hl,{of:s.AlignmentPositioning}),`
`,(0,e.jsx)(t.kL,{language:"jsx",code:`<BarChart
	data={data}
	showLegend={true}
...
`,(0,e.jsx)(t.Hl,{of:s.VerticalOrientation}),`
`,(0,e.jsx)(t.kL,{language:"jsx",code:`<BarChart
	data={data}
	showLegend={true}
...
`,(0,e.jsx)(t.Hl,{of:s.HorizontalBars}),`
...
`]}),`
`,(0,e.jsx)(n.p,{children:"The component automatically adapts bar colors, patterns, and styling based on the active theme while maintaining accessibility standards."})]})}function x(l={}){const{wrapper:n}={...(0,c.R)(),...l.components};return n?(0,e.jsx)(n,{...l,children:(0,e.jsx)(o,{...l})}):o(l)}},"../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive":h=>{function i(r){var a=new Error("Cannot find module '"+r+"'");throw a.code="MODULE_NOT_FOUND",a}i.keys=()=>[],i.resolve=i,i.id="../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive",h.exports=i},"../charts/src/components/bar-chart/stories/legend.stories.tsx":(h,i,r)=>{"use strict";r.r(i),r.d(i,{AlignmentPositioning:()=>n,Default:()=>l,HorizontalBars:()=>g,VerticalOrientation:()=>j,__namedExportsOrder:()=>p,default:()=>s});var a=r("../charts/src/stories/legend-config.tsx"),e=r("../charts/src/components/bar-chart/bar-chart.tsx"),c=r("../charts/src/components/bar-chart/stories/sample-data.ts"),t=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const s={title:"JS Packages/Charts/Types/Bar Chart/Legend",component:e.A,parameters:{layout:"centered"},decorators:a.x,argTypes:a.r},o=m=>(0,t.jsx)(e.A,{...m}),x={data:c.A.slice(0,3),height:400,showLegend:!0,legendOrientation:"horizontal",withTooltips:!0},l=o.bind({});l.args={...x};const n=o.bind({});n.args={...x,legendAlignmentHorizontal:"right",legendAlignmentVertical:"top"};const j=o.bind({});j.args={...x,legendOrientation:"vertical",legendAlignmentHorizontal:"right",legendAlignmentVertical:"top"};const g=o.bind({});g.args={...x,orientation:"horizontal",legendAlignmentHorizontal:"right",legendAlignmentVertical:"top"};const p=["Default","AlignmentPositioning","VerticalOrientation","HorizontalBars"];l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"args => <BarChart {...args} />",...l.parameters?.docs?.source}}},n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"args => <BarChart {...args} />",...n.parameters?.docs?.source}}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:"args => <BarChart {...args} />",...j.parameters?.docs?.source}}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:"args => <BarChart {...args} />",...g.parameters?.docs?.source}}}},"../charts/src/stories/legend-config.tsx":(h,i,r)=>{"use strict";r.d(i,{r:()=>t,x:()=>d});var a=r("../charts/src/providers/theme/themes.ts"),e=r("../charts/src/providers/theme/theme-provider.tsx"),c=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const t={showLegend:{control:"boolean",table:{category:"Legend"}},legendAlignmentHorizontal:{control:"select",options:["left","center","right"],table:{category:"Legend"}},legendAlignmentVertical:{control:"select",options:["top","bottom"],table:{category:"Legend"}},legendOrientation:{control:"select",options:["horizontal","vertical"],table:{category:"Legend"}},legendShape:{control:"select",options:["circle","rect"],table:{category:"Legend"}},withLegendGlyph:{control:"boolean",table:{category:"Legend"},description:"Show glyphs in legend (Line charts only)"},theme:{control:"select",options:{default:void 0,jetpack:a.QI,woo:a.pk},defaultValue:void 0,table:{category:"Theme"}}},d=[(s,{args:o})=>(0,c.jsx)(e.NP,{theme:o.theme,children:(0,c.jsx)("div",{style:{resize:"both",overflow:"auto",padding:"2rem",width:"800px",height:"600px",minWidth:"400px",maxWidth:"1200px",border:"1px dashed #ccc"},children:(0,c.jsx)(s,{})})})];try{t.displayName="legendArgTypes",t.__docgenInfo={description:`Shared legend configuration for chart stories
Provides consistent argTypes and decorators across all chart legend stories`,displayName:"legendArgTypes",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/stories/legend-config.tsx#legendArgTypes"]={docgenInfo:t.__docgenInfo,name:"legendArgTypes",path:"../charts/src/stories/legend-config.tsx#legendArgTypes"})}catch{}try{d.displayName="legendDecorator",d.__docgenInfo={description:"Shared decorator for legend stories with theme support and resizable container",displayName:"legendDecorator",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/stories/legend-config.tsx#legendDecorator"]={docgenInfo:d.__docgenInfo,name:"legendDecorator",path:"../charts/src/stories/legend-config.tsx#legendDecorator"})}catch{}},"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive":h=>{function i(r){var a=new Error("Cannot find module '"+r+"'");throw a.code="MODULE_NOT_FOUND",a}i.keys=()=>[],i.resolve=i,i.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive",h.exports=i},"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive":h=>{function i(r){var a=new Error("Cannot find module '"+r+"'");throw a.code="MODULE_NOT_FOUND",a}i.keys=()=>[],i.resolve=i,i.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive",h.exports=i}}]);
