...
`,i={_default:{startLoc:{col:17,line:21},endLoc:{col:1,line:25},startBody:{col:17,line:21},endBody:{col:1,line:25}}};const l={parameters:{storySource:{source:`import { Tooltip } from '../tooltip';
