"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[4722],{"../charts/src/components/line-chart/stories/index.stories.tsx":(Y,b,r)=>{r.r(b),r.d(b,{BrokenLine:()=>h,Comparison:()=>C,CurveTypes:()=>L,CustomDimensions:()=>m,CustomLegendPositioning:()=>o,DateStringFormats:()=>S,Default:()=>s,ErrorStates:()=>D,FixedDimensions:()=>d,GradientFilled:()=>u,SingleSeries:()=>p,SmartFormatting:()=>l,WithCompositionLegend:()=>f,WithLegend:()=>g,WithPointerEvents:()=>w,WithoutSmoothing:()=>v,__namedExportsOrder:()=>G,default:()=>_});var c=r("../charts/src/hooks/use-global-chart-theme.ts"),x=r("../charts/src/stories/legend-config.tsx"),a=r("../charts/src/stories/sample-data/index.ts"),t=r("../charts/src/components/line-chart/line-chart.tsx"),y=r("../charts/src/components/line-chart/stories/config.tsx"),e=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const _={...y.N,title:"JS Packages/Charts/Types/Line Chart",argTypes:{...y.N.argTypes,...x.r}},n=i=>(0,e.jsx)(t.A,{...i}),s=n.bind({});s.args={...y.p};const p=n.bind({});p.args={data:[a.B2[0]]};const g=n.bind({});g.args={...y.p,showLegend:!0};const o=n.bind({});o.args={data:a.B2,showLegend:!0,height:400,legendAlignment:"start",legendPosition:"top",legendOrientation:"horizontal",withLegendGlyph:!0},o.parameters={docs:{description:{story:"Line chart with top-left positioned horizontal legend. This demonstrates non-default legend positioning to showcase different legend placement possibilities with temperature data for London, Canberra, and Mars."}}};const f={render:()=>(0,e.jsx)("div",{style:{width:"600px",height:"400px"},children:(0,e.jsx)(t.A,{data:a.Sb,width:600,height:300,withGradientFill:!1,withLegendGlyph:!1,children:(0,e.jsx)(t.A.Legend,{orientation:"horizontal",alignment:"center",position:"bottom"})})}),parameters:{docs:{description:{story:"Legend used with LineChart using the composition API, positioned below the chart."}}}},m=n.bind({});m.args={width:800,height:400,data:a.B2};const d=n.bind({});d.args={width:800,height:400,data:a.B2,withTooltips:!0},d.parameters={docs:{description:{story:"Line chart with fixed dimensions that override the responsive behavior."}}};const u=n.bind({});u.args={...s.args,margin:void 0,data:a.Sb,withGradientFill:!0,options:{axis:{y:{orientation:"right"}}}};const D={render:()=>(0,e.jsxs)("div",{style:{display:"grid",gap:"2rem",gridTemplateColumns:"repeat(2, 1fr)"},children:[(0,e.jsxs)("div",{children:[(0,e.jsx)("h3",{children:"Empty Data"}),(0,e.jsx)(t.A,{width:300,height:200,data:[],withGradientFill:!1,withLegendGlyph:!1})]}),(0,e.jsxs)("div",{children:[(0,e.jsx)("h3",{children:"Invalid Date Values"}),(0,e.jsx)(t.A,{width:300,height:200,data:[{label:"Invalid Dates",data:[{date:new Date("invalid"),value:10},{date:new Date("2024-01-02"),value:20}],options:{}}],withGradientFill:!1,withLegendGlyph:!1})]}),(0,e.jsxs)("div",{children:[(0,e.jsx)("h3",{children:"Invalid Values"}),(0,e.jsx)(t.A,{width:300,height:200,data:[{label:"Invalid Values",data:[{date:new Date("2024-01-01"),value:NaN},{date:new Date("2024-01-02"),value:null}],options:{}}],withGradientFill:!1,withLegendGlyph:!1})]}),(0,e.jsxs)("div",{children:[(0,e.jsx)("h3",{children:"Single Data Point"}),(0,e.jsx)(t.A,{width:300,height:200,data:[{label:"Single Point",data:[{date:new Date("2024-01-01"),value:100}],options:{}}],withGradientFill:!1,withLegendGlyph:!1})]})]}),parameters:{docs:{description:{story:"Examples of how the line chart handles various error states and edge cases."}}}},v=n.bind({});v.args={...s.args,smoothing:!1};const w=n.bind({});w.args={...s.args,onPointerDown:({datum:i})=>alert("Pointer down:"+JSON.stringify(i))};const L={render:()=>{const i=[{label:"Sample Series",data:[{date:new Date("2024-01-01"),value:10},{date:new Date("2024-01-02"),value:90},{date:new Date("2024-01-03"),value:85},{date:new Date("2024-01-04"),value:82},{date:new Date("2024-01-05"),value:5},{date:new Date("2024-01-06"),value:8},{date:new Date("2024-01-07"),value:10}],options:{}}];return(0,e.jsxs)("div",{style:{display:"grid",gap:"2rem",gridTemplateColumns:"repeat(3, 1fr)"},children:[(0,e.jsxs)("div",{children:[(0,e.jsx)("h3",{children:"Linear Curve"}),(0,e.jsx)(t.A,{width:300,height:200,data:i,curveType:"linear",withGradientFill:!1,withLegendGlyph:!1})]}),(0,e.jsxs)("div",{children:[(0,e.jsx)("h3",{children:"Smooth Curve (Catmull-Rom)"}),(0,e.jsx)(t.A,{width:300,height:200,data:i,curveType:"smooth",withGradientFill:!1,withLegendGlyph:!1})]}),(0,e.jsxs)("div",{children:[(0,e.jsx)("h3",{children:"Monotone X Curve"}),(0,e.jsx)(t.A,{width:300,height:200,data:i,curveType:"monotone",withGradientFill:!1,withLegendGlyph:!1})]})]})},parameters:{docs:{description:{story:"Examples of the three different curve types available. The data points are designed to highlight how Monotone X prevents overshooting (going above/below data points) compared to Catmull-Rom smoothing, while still maintaining a smooth curve. Linear shows the raw connections between points."}}}},l=n.bind({});l.args={data:a.Gv,withGradientFill:!1,smoothing:!0,options:{axis:{x:{orientation:"bottom"},y:{orientation:"left"}}}},l.parameters={docs:{description:{story:'Demonstrates the Smart Formatting feature (formatYTick) that automatically formats Y-axis tick labels based on the data range. Values \u22651B are formatted as "1.23B", \u22651M as "1.2M", \u22651K as "1k", and smaller values as "1,234". This example shows revenue in billions and users in millions.'}}};const h=n.bind({});h.args={...s.args,margin:{bottom:40},data:[{...a.Sb[0],label:"Vistors to compare",options:{seriesLineStyle:{strokeDasharray:"5 5 1"}}},a.Sb[0]],showLegend:!0},h.parameters={docs:{description:{story:"Demonstrates the option of setting a seriesLineStyle to a dash array."}}};const S={render:()=>(0,e.jsx)(t.A,{data:[{label:"String Dates",data:[{dateString:"2024-01-01",value:10},{dateString:"2024-01-02",value:20},{dateString:"2024-01-03 00:00:00",value:15},{dateString:"2024-01-04",value:25},{dateString:"2024-01-05 00:00",value:30}],options:{}}],withGradientFill:!1,withLegendGlyph:!1}),parameters:{docs:{description:{story:`Demonstrates the line chart's ability to handle various date string formats and mixed date types. All dates are converted to local timezone. The chart can process:
...
}`,...C.parameters?.docs?.source}}}},"../charts/src/stories/legend-config.tsx":(Y,b,r)=>{r.d(b,{r:()=>c});const c={showLegend:{control:{type:"boolean"},table:{category:"Legend"}},legendPosition:{control:{type:"select"},options:["top","bottom"],table:{category:"Legend"}},legendAlignment:{control:{type:"select"},options:["start","center","end"],table:{category:"Legend"}},legendOrientation:{control:{type:"select"},options:["horizontal","vertical"],table:{category:"Legend"}},legendShape:{control:{type:"select"},options:["circle","rect"],table:{category:"Legend"}},withLegendGlyph:{control:{type:"boolean"},table:{category:"Legend"},description:"Show glyphs in legend (Line charts only)"}};try{c.displayName="legendArgTypes",c.__docgenInfo={description:`Shared legend configuration for chart stories
