...
export default meta;
`,q={Default:{startLoc:{col:17,line:90},endLoc:{col:58,line:90},startBody:{col:17,line:90},endBody:{col:58,line:90}}};const b=({timeslice:s})=>{const{controls:t,state:c,blob:a,duration:l}=U(),{start:i,pause:g,resume:d,stop:u}=t;return(0,e.jsxs)("div",{children:[(0,e.jsxs)("div",{style:{fontFamily:"monospace",display:"flex",flexDirection:"column",gap:"10px"},children:[(0,e.jsxs)("div",{children:[(0,e.jsx)("span",{children:"State: "}),(0,e.jsx)("strong",{children:c})]}),(0,e.jsx)("div",{children:(0,e.jsxs)("span",{children:["Blob: ",(0,e.jsx)("strong",{children:a?`${a.size} - type: ${a.type}`:"No blob"})]})}),(0,e.jsxs)("div",{children:[(0,e.jsx)("span",{children:"Duration: "}),(0,e.jsx)("strong",{children:(0,e.jsx)(C,{duration:l})})]})]}),(0,e.jsx)("br",{}),(0,e.jsxs)("div",{style:{display:"flex",flexDirection:"row",gap:"1px"},children:[(0,e.jsx)(f.ZP,{variant:"primary",onClick:()=>i(s),disabled:c!=="inactive",children:"Begin recording"}),(0,e.jsx)(f.ZP,{variant:"primary",onClick:()=>g(),disabled:c!=="recording",children:"Pause"}),(0,e.jsx)(f.ZP,{variant:"primary",onClick:()=>d(),disabled:c!=="paused",children:"Resume"}),(0,e.jsx)(f.ZP,{variant:"primary",onClick:()=>u(),disabled:c==="inactive",children:"Stop"})]})]})};b.displayName="RecorderComponent";const $={parameters:{storySource:{source:`/**
 * External dependencies
 */
import { Button } from '@wordpress/components';
import React from 'react';
