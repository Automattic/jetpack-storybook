(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[3601,7733],{"../../../node_modules/.pnpm/@mdx-js+react@3.1.0_@types+react@18.3.23_react@18.3.1/node_modules/@mdx-js/react/lib/index.js":(u,r,t)=>{"use strict";t.d(r,{R:()=>s,x:()=>o});var i=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");const e={},a=i.createContext(e);function s(h){const d=i.useContext(a);return i.useMemo(function(){return typeof h=="function"?h(d):{...d,...h}},[d,h])}function o(h){let d;return h.disableParentContext?d=typeof h.components=="function"?h.components(e):h.components||e:d=s(h.components),i.createElement(a.Provider,{value:d},h.children)}},"../charts/src/components/line-chart/stories/annotation.docs.mdx":(u,r,t)=>{"use strict";t.r(r),t.d(r,{default:()=>d});var i=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),a=t("../../../node_modules/.pnpm/@mdx-js+react@3.1.0_@types+react@18.3.23_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),s=t("../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist/blocks.mjs"),o=t("../charts/src/components/line-chart/stories/annotation.stories.tsx");function h(p){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...(0,a.R)(),...p.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(s.W8,{title:"JS Packages/Charts/Types/Line Chart/Annotations",of:o}),`
...
`,(0,e.jsx)(s.kL,{language:"jsx",code:`import { LineChart } from '@automattic/jetpack-charts';
...
`,(0,e.jsx)(s.Hl,{of:o.Vertical}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<LineChart.Annotation
	datum={dataPoint}
	title="Deployment"
...
`]}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`const customTheme = {
	...jetpackTheme,
	annotationStyles: {
		label: {
...
`,(0,e.jsx)(s.Hl,{of:o.Custom}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`const DeployIcon = () => (
	<span style={{
		background: 'black',
		color: 'white',
		width: '24px',
...
`,(0,e.jsx)(s.kL,{language:"jsx",code:`// Position at chart edges
<LineChart.Annotation
	styles={{
		label: {
...
`,(0,e.jsx)(s.kL,{language:"jsx",code:`// Old API (deprecated)
<LineChart
data={data}
annotations={[
	{
...
`}),`
`,(0,e.jsx)(n.p,{children:"The new compound component pattern provides better TypeScript support, more flexibility, and clearer composition."})]})}function d(p={}){const{wrapper:n}={...(0,a.R)(),...p.components};return n?(0,e.jsx)(n,{...p,children:(0,e.jsx)(h,{...p})}):h(p)}},"../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive":u=>{function r(t){var i=new Error("Cannot find module '"+t+"'");throw i.code="MODULE_NOT_FOUND",i}r.keys=()=>[],r.resolve=r,r.id="../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.23_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive",u.exports=r},"../charts/src/components/line-chart/stories/annotation.stories.tsx":(u,r,t)=>{"use strict";t.r(r),t.d(r,{Colored:()=>g,Custom:()=>C,Default:()=>n,Horizontal:()=>c,Mixed:()=>m,Vertical:()=>x,__namedExportsOrder:()=>E,default:()=>h});var i=t("../charts/src/stories/sample-data/index.ts"),e=t("../charts/src/components/line-chart/line-chart.tsx"),a=t("../charts/src/components/line-chart/stories/config.tsx"),s=t("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const h={...a.Nc,title:"JS Packages/Charts/Types/Line Chart/Annotations",args:{...a.pn}},d=R=>P=>(0,s.jsx)(e.A,{...P,children:(0,s.jsxs)(e.A.AnnotationsOverlay,{children:[(0,s.jsx)(e.A.Annotation,{datum:i.B2[0].data[10],title:"Notable event",subtitle:"This is a notable event",...R?.[0]||{}}),(0,s.jsx)(e.A.Annotation,{datum:i.B2[1].data[i.B2[1].data.length-10],title:"Another notable event",subtitle:"This is another notable event",...R?.[1]||{}}),(0,s.jsx)(e.A.Annotation,{datum:i.B2[2].data[i.B2[2].data.length-51],title:"Concerning event",subtitle:"This is a concerning event",...R?.[2]||{}})]})}),n=d([{},{},{styles:{circleSubject:{fill:"var(--jp-red)"},connector:{stroke:"var(--jp-red)"},label:{anchorLineStroke:"var(--jp-red)"}}}]).bind({}),x=d([{subjectType:"line-vertical"},{subjectType:"line-vertical"},{subjectType:"line-vertical",styles:{connector:{stroke:"var(--jp-red)"},label:{anchorLineStroke:"var(--jp-red)"}}}]).bind({}),c=d([{subjectType:"line-horizontal"},{subjectType:"line-horizontal"},{subjectType:"line-horizontal",styles:{connector:{stroke:"var(--jp-red)"},label:{anchorLineStroke:"var(--jp-red)"}}}]).bind({}),m=d([{subjectType:"circle"},{subjectType:"line-vertical"},{subjectType:"line-horizontal",styles:{connector:{stroke:"var(--jp-red)"},label:{anchorLineStroke:"var(--jp-red)"}}}]).bind({}),g=d([{styles:{label:{backgroundFill:"#98C8DF",showAnchorLine:!1},circleSubject:{fill:"#98C8DF"},connector:{stroke:"#98C8DF"}}},{styles:{label:{backgroundFill:"#006DAB",fontColor:"#fff",showAnchorLine:!1},circleSubject:{fill:"#006DAB"},connector:{stroke:"#006DAB"}}},{styles:{label:{backgroundFill:"var(--jp-red)",showAnchorLine:!1,fontColor:"#fff"},circleSubject:{fill:"var(--jp-red)"},connector:{stroke:"var(--jp-red)"}}}]).bind({}),y=()=>(0,s.jsx)("span",{style:{background:"black",color:"white",width:"24px",height:"24px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"50%"},children:"D"}),L={subjectType:"line-vertical",styles:{label:{showAnchorLine:!1,y:"start"}},title:"Deployed",renderLabel:()=>(0,s.jsx)("span",{style:{transform:"translate(0, 6px)"},children:(0,s.jsx)(y,{})}),renderLabelPopover:()=>(0,s.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:"0.5rem"},children:[(0,s.jsxs)("div",{style:{margin:0,display:"flex",alignItems:"center",gap:"6px",paddingBlock:"0.25rem "},children:[(0,s.jsx)(y,{}),(0,s.jsx)("strong",{children:"Deploy finished"})]}),(0,s.jsx)("p",{style:{margin:0},children:"Thu. Apr 24, 2025. 09:57:23 UTC"})]})},f=()=>(0,s.jsx)("span",{style:{background:"var(--jp-red)",color:"white",width:"20px",height:"20px",display:"inline-flex",alignItems:"center",justifyContent:"center",borderRadius:"50%"},children:"!"}),I={subjectType:"circle",styles:{circleSubject:{radius:0},label:{showAnchorLine:!1},connector:{stroke:"transparent"}},title:"Alert",renderLabel:()=>(0,s.jsx)(f,{}),renderLabelPopover:()=>(0,s.jsxs)("div",{style:{display:"flex",flexDirection:"column",gap:"0.5rem"},children:[(0,s.jsxs)("div",{style:{margin:0,display:"flex",alignItems:"center",gap:"6px",paddingBlock:"0.25rem "},children:[(0,s.jsx)(f,{}),(0,s.jsx)("strong",{children:"Origin HTTP 5xx Response Codes Rate Anomaly [Beta]"})]}),(0,s.jsx)("p",{style:{margin:0},children:"Unusually high number of HTTP 5xx response codes detected on Origin"})]})},C=d([{...L},{...L},{...I}]).bind({}),E=["Default","Vertical","Horizontal","Mixed","Colored","Custom"];n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`createAnnotationTemplate([{}, {}, {
  styles: {
    circleSubject: {
      fill: 'var(--jp-red)'
    },
