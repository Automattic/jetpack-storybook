"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[7617],{"../charts/src/stories/index.docs.mdx"(c,i,s){s.r(i),s.d(i,{default:()=>d});var h=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),a=s("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.26_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),n=s("../../../node_modules/.pnpm/@storybook+addon-docs@10.2.3_@types+react@18.3.26_esbuild@0.25.9_storybook@10.2.3_@test_1e909a19285aafcb7051ac1c3970312d/node_modules/@storybook/addon-docs/dist/blocks.js");function o(r){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...(0,a.R)(),...r.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(n.W8,{title:"JS Packages/Charts Library/Introduction"}),`
...
`,(0,e.jsxs)(t.li,{children:["\u2728 ",(0,e.jsx)(t.strong,{children:"Rich Chart Types"})," - Bar charts, bar list charts, conversion funnel charts, donut charts, geo charts, leaderboard visualizations, line charts, pie charts, and sparklines"]}),`
...
`,(0,e.jsx)(n.kL,{language:"jsx",code:`import { LineChart, GlobalChartsProvider } from '@automattic/charts';
...
`,(0,e.jsx)(t.h3,{id:"design-tokens",children:"Design Tokens"}),`
`,(0,e.jsx)(t.p,{children:"Some chart components use WordPress design tokens for consistent spacing and styling. If your application doesn't already include the WordPress theme package, you'll need to import the design tokens CSS:"}),`
`,(0,e.jsx)(n.kL,{language:"jsx",code:`// Add this import to your app's entry point if tokens aren't already available
import '@wordpress/theme/design-tokens.css';`}),`
`,(0,e.jsx)(t.p,{children:"In WordPress environments (wp-admin, Gutenberg editor), these tokens are typically already loaded. For standalone applications or Storybook, you may need to add this import explicitly."}),`
...
`,(0,e.jsx)(t.h3,{id:"geo-chart",children:(0,e.jsx)(t.a,{href:"./?path=/docs/js-packages-charts-library-charts-geo-chart--docs",children:"Geo Chart"})}),`
`,(0,e.jsx)(t.p,{children:"Visualizes geographical data on an interactive world map, making it easy to understand the distribution of values across countries."}),`
...
`,(0,e.jsx)(t.h3,{id:"sparkline",children:(0,e.jsx)(t.a,{href:"./?path=/docs/js-packages-charts-library-charts-sparkline--docs",children:"Sparkline"})}),`
...
`,(0,e.jsxs)(t.p,{children:["All charts automatically adapt to their container size using the ",(0,e.jsx)(t.code,{children:"withResponsive"})," higher-order component. By default, charts ",(0,e.jsx)(t.strong,{children:"fill their parent container's dimensions"})," rather than calculating height from a fixed aspect ratio."]}),`
`,(0,e.jsx)(t.h4,{id:"default-behavior-fill-container",children:"Default Behavior (Fill Container)"}),`
`,(0,e.jsx)(t.p,{children:"When you omit dimension props, the chart expands to fill its parent container:"}),`
`,(0,e.jsx)(n.kL,{language:"jsx",code:`// Chart fills parent container's width and height
<div style={{ width: '100%', height: '400px' }}>
	<LineChart data={data} />
</div>`}),`
`,(0,e.jsxs)(t.p,{children:[(0,e.jsx)(t.strong,{children:"Important"}),": The parent container must have an explicit height. Without a defined height, the chart cannot determine how tall to render."]}),`
`,(0,e.jsx)(t.h4,{id:"aspect-ratio-mode",children:"Aspect Ratio Mode"}),`
`,(0,e.jsxs)(t.p,{children:["For layouts where you want height calculated from width, pass the ",(0,e.jsx)(t.code,{children:"aspectRatio"})," prop:"]}),`
`,(0,e.jsx)(n.kL,{language:"jsx",code:`// Height = width \xD7 aspectRatio (e.g., 2:1 ratio)
<div style={{ width: '100%' }}>
	<LineChart data={data} aspectRatio={0.5} />
</div>`}),`
`,(0,e.jsx)(t.p,{children:"This is useful for responsive layouts where the container width varies but you want consistent proportions."}),`
`,(0,e.jsx)(t.h4,{id:"fixed-dimensions",children:"Fixed Dimensions"}),`
`,(0,e.jsxs)(t.p,{children:["For complete control, specify explicit ",(0,e.jsx)(t.code,{children:"width"})," and ",(0,e.jsx)(t.code,{children:"height"})," props:"]}),`
`,(0,e.jsx)(n.kL,{language:"jsx",code:"<LineChart data={data} width={800} height={400} />"}),`
`,(0,e.jsx)(t.h4,{id:"responsive-props",children:"Responsive Props"}),`
`,(0,e.jsxs)(t.table,{children:[(0,e.jsx)(t.thead,{children:(0,e.jsxs)(t.tr,{children:[(0,e.jsx)(t.th,{children:"Prop"}),(0,e.jsx)(t.th,{children:"Type"}),(0,e.jsx)(t.th,{children:"Default"}),(0,e.jsx)(t.th,{children:"Description"})]})}),(0,e.jsxs)(t.tbody,{children:[(0,e.jsxs)(t.tr,{children:[(0,e.jsx)(t.td,{children:(0,e.jsx)(t.code,{children:"width"})}),(0,e.jsx)(t.td,{children:(0,e.jsx)(t.code,{children:"number"})}),(0,e.jsx)(t.td,{children:"-"}),(0,e.jsx)(t.td,{children:"Fixed width in pixels (omit for responsive)"})]}),(0,e.jsxs)(t.tr,{children:[(0,e.jsx)(t.td,{children:(0,e.jsx)(t.code,{children:"height"})}),(0,e.jsx)(t.td,{children:(0,e.jsx)(t.code,{children:"number"})}),(0,e.jsx)(t.td,{children:"-"}),(0,e.jsx)(t.td,{children:"Fixed height in pixels (omit for responsive)"})]}),(0,e.jsxs)(t.tr,{children:[(0,e.jsx)(t.td,{children:(0,e.jsx)(t.code,{children:"aspectRatio"})}),(0,e.jsx)(t.td,{children:(0,e.jsx)(t.code,{children:"number"})}),(0,e.jsx)(t.td,{children:"-"}),(0,e.jsxs)(t.td,{children:["Height as ratio of width (e.g., ",(0,e.jsx)(t.code,{children:"0.5"})," = half width)"]})]}),(0,e.jsxs)(t.tr,{children:[(0,e.jsx)(t.td,{children:(0,e.jsx)(t.code,{children:"maxWidth"})}),(0,e.jsx)(t.td,{children:(0,e.jsx)(t.code,{children:"number"})}),(0,e.jsx)(t.td,{children:(0,e.jsx)(t.code,{children:"1200"})}),(0,e.jsx)(t.td,{children:"Maximum width constraint"})]}),(0,e.jsxs)(t.tr,{children:[(0,e.jsx)(t.td,{children:(0,e.jsx)(t.code,{children:"resizeDebounceTime"})}),(0,e.jsx)(t.td,{children:(0,e.jsx)(t.code,{children:"number"})}),(0,e.jsx)(t.td,{children:(0,e.jsx)(t.code,{children:"300"})}),(0,e.jsx)(t.td,{children:"Debounce delay for resize events (ms)"})]})]})]}),`
`,(0,e.jsx)(t.h4,{id:"unresponsive-variants",children:"Unresponsive Variants"}),`
`,(0,e.jsx)(t.p,{children:'Each chart exports an "Unresponsive" variant for cases where you need direct control without the responsive wrapper:'}),`
`,(0,e.jsx)(n.kL,{language:"jsx",code:`import { LineChartUnresponsive } from '@automattic/charts';
...
`]}),`
`,(0,e.jsx)(t.p,{children:"Start exploring the components and examples in the sidebar to see the full capabilities of the Automattic Charts library!"})]})}function d(r={}){const{wrapper:t}={...(0,a.R)(),...r.components};return t?(0,e.jsx)(t,{...r,children:(0,e.jsx)(o,{...r})}):o(r)}}}]);
