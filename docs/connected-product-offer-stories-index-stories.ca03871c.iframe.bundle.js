"use strict";(()=>{(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[9414],{"../../packages/my-jetpack/_inc/components/connected-product-offer/stories/index.stories.jsx":(O,d,t)=>{var b,_,v;t.r(d),t.d(d,{Default:()=>a,__namedExportsOrder:()=>M,default:()=>w});var m=t("../../../node_modules/.pnpm/react@18.2.0/node_modules/react/index.js"),g=t("../components/components/product-offer/index.tsx"),l=t("../../../node_modules/.pnpm/prop-types@15.8.1/node_modules/prop-types/index.js"),p=t.n(l),y=t("../../packages/my-jetpack/_inc/hooks/use-my-jetpack-connection/index.js"),f=t("../../packages/my-jetpack/_inc/hooks/use-product/index.js");function k(o,n){const{siteSuffix:s,myJetpackUrl:i}=(window==null?void 0:window.myJetpackInitialState)||{},u=new URL("https://wordpress.com/checkout/"),e=new URL(`${u}${s}/${o}`);return e.searchParams.set("redirect_to",i),n||e.searchParams.set("unlinked",1),e.searchParams.set("site",s),e.toString()}var P=t("../../../node_modules/.pnpm/react@18.2.0/node_modules/react/jsx-runtime.js");const c=({slug:o,onClick:n,trackButtonClick:s,...i})=>{const{detail:u,isFetching:e}=(0,f.i)(o),{title:J,longDescription:R,features:F,pricingForUi:T,isBundle:E,supportedProducts:I,hasRequiredPlan:C}=u,{isFree:S,fullPricePerMonth:L,currencyCode:H,discountPricePerMonth:N,wpcomProductSlug:x}=T,{isUserConnected:W}=(0,y.Z)(),G=!S&&!C&&x?k(x,W):null,$=(0,m.useCallback)(()=>{s(),n&&n()},[n,s]);return(0,P.jsx)(g.Z,{slug:o,title:J,description:R,features:F,pricing:{isFree:S,price:L,offPrice:N,currency:H},isBundle:E,supportedProducts:I,hasRequiredPlan:C,onAdd:$,addProductUrl:n?void 0:G,isLoading:e,...i})};c.displayName="ConnectedProductOffer",c.propTypes={slug:p().string.isRequired},c.defaultProps={trackButtonClick:()=>{}},c.__docgenInfo={description:`Product Detail component.
...
`,oe={Default:{startLoc:{col:35,line:26},endLoc:{col:78,line:26},startBody:{col:35,line:26},endBody:{col:78,line:26}}};const w={title:"Packages/My Jetpack/Connected Product Offer",component:D,parameters:{storySource:{source:`
import React from 'react';
import ConnectedProductOffer from '../index.jsx';
import { getAllMockData, getProductSlugs } from './utils.js';
export default {
