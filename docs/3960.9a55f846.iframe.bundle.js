...
`,Vo)),u.push(_o(tn(f))),Pn=bo;li=j.substring(bo[1],zt[1]),Vo=(li.match(/\n/g)||[]).length,u.push(Bn(`
...
`),u.push(_o(Fe));u.push(_o(Y))}if(r.trailingComments)if(Q)f=r.trailingComments[0],zt=f.extendedRange,bo=f.range,Gn=j.substring(zt[0],bo[0]),Vo=(Gn.match(/\n/g)||[]).length,Vo>0?(u.push(Bn(`
