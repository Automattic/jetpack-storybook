...
`]}),`
`,(0,e.jsx)(n.p,{children:"The component automatically adapts bar colors, patterns, and styling based on the active theme while maintaining accessibility standards."})]})}function l(c={}){const{wrapper:n}={...(0,h.R)(),...c.components};return n?(0,e.jsx)(n,{...c,children:(0,e.jsx)(a,{...c})}):a(c)}})}]);
