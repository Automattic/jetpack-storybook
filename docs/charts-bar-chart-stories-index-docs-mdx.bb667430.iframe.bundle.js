(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[1954],{"../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.0.8_@test_ca37a3433c216fd610726ebbc5860d83/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive":(l=>{function t(r){var o=new Error("Cannot find module '"+r+"'");throw o.code="MODULE_NOT_FOUND",o}t.keys=()=>[],t.resolve=t,t.id="../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.0.8_@test_ca37a3433c216fd610726ebbc5860d83/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive",l.exports=t}),"../charts/src/charts/bar-chart/stories/index.docs.mdx":((l,t,r)=>{"use strict";r.r(t),r.d(t,{default:()=>h});var o=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),d=r("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.26_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),n=r("../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.0.8_@test_ca37a3433c216fd610726ebbc5860d83/node_modules/@storybook/addon-docs/dist/blocks.js"),a=r("../charts/src/charts/bar-chart/stories/index.stories.tsx");function c(s){const i={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...(0,d.R)(),...s.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(n.W8,{title:"JS Packages/Charts Library/Charts/Bar Chart",of:a}),`
...
`,(0,e.jsxs)(i.ul,{children:[`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:(0,e.jsx)(i.code,{children:"width"})}),": Chart width in pixels (responsive by default)"]}),`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:(0,e.jsx)(i.code,{children:"height"})}),": Chart height in pixels (responsive by default, defaults to 400)"]}),`
...
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:(0,e.jsx)(i.code,{children:"legendInteractive"})}),": Enable interactive legend with series toggle (",(0,e.jsx)(i.code,{children:"false"})," by default, requires ",(0,e.jsx)(i.code,{children:"chartId"}),")"]}),`
...
`,(0,e.jsx)(i.p,{children:"The component handles large numbers of series gracefully with automatic color cycling:"}),`
`,(0,e.jsx)(n.Hl,{of:a.ManyDataSeries}),`
`,(0,e.jsx)(n.kL,{language:"jsx",code:`<BarChart
...
`,(0,e.jsx)(i.h3,{id:"basic-legend",children:"Basic Legend"}),`
`,(0,e.jsx)(i.p,{children:"Display series information with automatic color and pattern matching:"}),`
`,(0,e.jsx)(n.Hl,{of:a.WithInteractiveLegend}),`
`,(0,e.jsx)(n.kL,{language:"jsx",code:`<BarChart
	data={data}
	showLegend={true}
	...
	legendShape="rect"
/>`}),`
`,(0,e.jsx)(i.h3,{id:"vertical-legend",children:"Vertical Legend"}),`
`,(0,e.jsx)(i.p,{children:"Display legends vertically for charts with many series:"}),`
`,(0,e.jsx)(n.Hl,{of:a.CustomLegendPositioning}),`
`,(0,e.jsx)(n.kL,{language:"jsx",code:`<BarChart
	data={data}
	showLegend={true}
	...
	legendPosition="top"
/>`}),`
`,(0,e.jsx)(i.h3,{id:"composition-api",children:"Composition API"}),`
`,(0,e.jsxs)(i.p,{children:["For more flexible legend positioning and future extensibility, use the composition API with ",(0,e.jsx)(i.code,{children:"<BarChart.Legend />"})," as a child component:"]}),`
...
`,(0,e.jsx)(i.p,{children:(0,e.jsx)(i.strong,{children:"Benefits of the composition API:"})}),`
`,(0,e.jsxs)(i.ul,{children:[`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"Flexible positioning"}),": Place legends anywhere within the chart container"]}),`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"Future extensibility"}),": Enables additional chart components like annotations"]}),`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"Consistent API"}),": Same pattern as LineChart for a unified developer experience"]}),`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"Backward compatibility"}),": Existing ",(0,e.jsx)(i.code,{children:"showLegend"})," prop continues to work"]}),`
`]}),`
`,(0,e.jsx)(i.p,{children:(0,e.jsx)(i.strong,{children:"Usage patterns:"})}),`
`,(0,e.jsx)(n.kL,{language:"jsx",code:`// Composition API (recommended for new code)
<BarChart data={data}>
...
<BarChart
	...
	legendAlignment="end"
/>`}),`
`,(0,e.jsx)(i.h3,{id:"interactive-legend",children:"Interactive Legend"}),`
`,(0,e.jsxs)(i.p,{children:["Enable interactive legend items that users can click to toggle series visibility. This feature requires a ",(0,e.jsx)(i.code,{children:"chartId"})," and wrapping your chart in a ",(0,e.jsx)(i.code,{children:"GlobalChartsProvider"}),":"]}),`
`,(0,e.jsx)(n.Hl,{of:a.WithInteractiveLegend}),`
`,(0,e.jsx)(n.kL,{language:"jsx",code:`import { BarChart, GlobalChartsProvider } from '@automattic/charts';
...
`,(0,e.jsx)(i.p,{children:(0,e.jsx)(i.strong,{children:"Interactive legend features:"})}),`
`,(0,e.jsxs)(i.ul,{children:[`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"Click to toggle"}),": Click legend items to show/hide series"]}),`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"Visual feedback"}),": Legend items visually indicate their active/inactive state"]}),`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"Accessibility"}),": Full keyboard support with proper ARIA attributes"]}),`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"Empty state"}),": When all series are hidden, a message prompts users to re-enable series"]}),`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"State management"}),": Visibility state is managed through the global charts provider"]}),`
`]}),`
`,(0,e.jsx)(i.p,{children:(0,e.jsx)(i.strong,{children:"Requirements:"})}),`
`,(0,e.jsxs)(i.ul,{children:[`
`,(0,e.jsxs)(i.li,{children:["Set ",(0,e.jsx)(i.code,{children:"legendInteractive={true}"})," to enable the feature"]}),`
`,(0,e.jsxs)(i.li,{children:["Provide a unique ",(0,e.jsx)(i.code,{children:"chartId"})," prop for state tracking"]}),`
`,(0,e.jsxs)(i.li,{children:["Wrap the chart in a ",(0,e.jsx)(i.code,{children:"<GlobalChartsProvider>"})," component"]}),`
`]}),`
...
`,(0,e.jsx)(i.h3,{id:"responsive-behavior",children:"Responsive Behavior"}),`
`,(0,e.jsx)(i.p,{children:"Charts automatically resize based on container size:"}),`
`,(0,e.jsx)(n.Hl,{of:a.FixedDimensions}),`
...
`]}),`
`,(0,e.jsx)(i.h2,{id:"browser-compatibility",children:"Browser Compatibility"}),`
`,(0,e.jsx)(i.h3,{id:"modern-browser-support",children:"Modern Browser Support"}),`
`,(0,e.jsx)(i.p,{children:"Full functionality in all modern browsers supporting:"}),`
`,(0,e.jsxs)(i.ul,{children:[`
`,(0,e.jsx)(i.li,{children:"SVG rendering and manipulation"}),`
`,(0,e.jsx)(i.li,{children:"CSS Grid and Flexbox layouts"}),`
`,(0,e.jsx)(i.li,{children:"ES6+ JavaScript features"}),`
`]}),`
`,(0,e.jsx)(i.h3,{id:"performance-considerations",children:"Performance Considerations"}),`
`,(0,e.jsxs)(i.ul,{children:[`
`,(0,e.jsxs)(i.li,{children:["Optimized rendering using ",(0,e.jsx)(i.code,{children:"@visx/xychart"})," for efficient SVG generation"]}),`
`,(0,e.jsx)(i.li,{children:"Automatic data validation and error boundaries"}),`
`,(0,e.jsx)(i.li,{children:"Efficient pattern generation for accessibility features"}),`
`]}),`
`,(0,e.jsx)(i.h2,{id:"performance-considerations-1",children:"Performance Considerations"}),`
`,(0,e.jsx)(i.h3,{id:"built-in-optimizations",children:"Built-in Optimizations"}),`
`,(0,e.jsxs)(i.ul,{children:[`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"Efficient rendering"}),": Built on ",(0,e.jsx)(i.code,{children:"@visx/xychart"})," for optimized SVG rendering"]}),`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"Data validation"}),": Automatic validation prevents rendering invalid data"]}),`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"Responsive behavior"}),": Uses ",(0,e.jsx)(i.code,{children:"ResizeObserver"})," for efficient chart resizing"]}),`
`,(0,e.jsxs)(i.li,{children:[(0,e.jsx)(i.strong,{children:"Pattern caching"}),": Pattern definitions are cached and reused for performance"]}),`
`]}),`
...
<GlobalChartsProvider theme={customTheme}>
	<BarChart data={data} />
</GlobalChartsProvider>`})]})}function h(s={}){const{wrapper:i}={...(0,d.R)(),...s.components};return i?(0,e.jsx)(i,{...s,children:(0,e.jsx)(c,{...s})}):c(s)}})}]);
