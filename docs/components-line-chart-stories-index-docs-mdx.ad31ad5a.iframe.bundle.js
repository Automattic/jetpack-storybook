(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[6936],{"../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.25_react@18.3.1/node_modules/@mdx-js/react/lib/index.js":((x,i,r)=>{"use strict";r.d(i,{R:()=>s,x:()=>o});var a=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");const e={},u=a.createContext(e);function s(d){const t=a.useContext(u);return a.useMemo(function(){return typeof d=="function"?d(t):{...t,...d}},[t,d])}function o(d){let t;return d.disableParentContext?t=typeof d.components=="function"?d.components(e):d.components||e:t=s(d.components),a.createElement(u.Provider,{value:t},d.children)}}),"../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.25_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive":(x=>{function i(r){var a=new Error("Cannot find module '"+r+"'");throw a.code="MODULE_NOT_FOUND",a}i.keys=()=>[],i.resolve=i,i.id="../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.25_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist sync recursive",x.exports=i}),"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive":(x=>{function i(r){var a=new Error("Cannot find module '"+r+"'");throw a.code="MODULE_NOT_FOUND",a}i.keys=()=>[],i.resolve=i,i.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/components sync recursive",x.exports=i}),"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive":(x=>{function i(r){var a=new Error("Cannot find module '"+r+"'");throw a.code="MODULE_NOT_FOUND",a}i.keys=()=>[],i.resolve=i,i.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/theming sync recursive",x.exports=i}),"../charts/src/components/line-chart/stories/glyph.stories.tsx":((x,i,r)=>{"use strict";r.r(i),r.d(i,{Custom:()=>v,CustomPerDataPoint:()=>b,CustomSvg:()=>_,End:()=>f,InTooltip:()=>C,Start:()=>y,__namedExportsOrder:()=>P,default:()=>S});var a=r("../../../node_modules/.pnpm/@visx+glyph@3.12.0_react@18.3.1/node_modules/@visx/glyph/esm/glyphs/GlyphStar.js"),e=r("../charts/src/providers/chart-context/global-charts-provider.tsx"),u=r("../charts/src/providers/chart-context/hooks/use-global-charts-theme.ts"),s=r("../charts/src/stories/theme-config.tsx"),o=r("../charts/src/components/line-chart/line-chart.tsx"),d=r("../charts/src/components/line-chart/stories/config.tsx"),t=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const L={...s.yI,glyph:d.Em},j=(l,{args:c})=>{const h=c.themeName,p=L[h||"default"];return(0,t.jsx)(e.S,{theme:p,children:(0,t.jsx)("div",{style:{resize:"both",overflow:"auto",padding:"2rem",width:"800px",maxWidth:"1200px",border:"1px dashed #ccc",display:"inline-block"},children:(0,t.jsx)(l,{})})})},S={...d.Nc,title:"JS Packages/Charts/Types/Line Chart/Glyphs",decorators:[j],argTypes:{...d.Nc.argTypes,themeName:{...s.jW.themeName,options:["default","jetpack","woo","custom","glyph"]}}},m=l=>(0,t.jsx)(o.A,{...l}),g={...d.pn,withStartGlyphs:!0},y=m.bind({});y.args={...g};const f=m.bind({});f.args={...g,withStartGlyphs:!1,withEndGlyphs:!0};const v=m.bind({});v.args={...g,withLegendGlyph:!0,renderGlyph:({color:l,size:c,x:h,y:p})=>(0,t.jsx)(a.A,{top:p,left:h,size:c*c,fill:l}),glyphStyle:{radius:10}};const D=({color:l,size:c,x:h,y:p})=>{const w=typeof h=="number"&&typeof p=="number"&&(h!==0||p!==0)?{transform:`translate(${h}, ${p})`}:{};return(0,t.jsx)("g",{...w,children:(0,t.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:c*2,height:c*2,viewBox:"0 0 24 24",style:{overflow:"visible",pointerEvents:"none"},children:(0,t.jsx)("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z",fill:l,stroke:l,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",transform:"translate(-12, -12)"})})})},_=m.bind({});_.args={...g,withLegendGlyph:!0,renderGlyph:({color:l,size:c,x:h,y:p})=>(0,t.jsx)(D,{color:l,size:c,x:h,y:p}),glyphStyle:{radius:8}};const E=({tooltipData:l})=>{const c=(0,u.p)();return(0,t.jsxs)("div",{children:[(0,t.jsx)("div",{style:{marginBottom:"0.5rem"},children:l?.nearestDatum?.datum?.date?.toLocaleDateString()}),(0,t.jsx)("div",{children:Object.entries(l?.datumByKey||{}).map(([h,p],k)=>{const{datum:w}=p;return(0,t.jsx)("div",{children:(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"0.5rem",marginBottom:"0.2rem"},children:[(0,t.jsx)("svg",{width:20,height:20,children:(0,t.jsx)(a.A,{size:100,top:10,left:10,fill:"#fff",stroke:c.colors[k%c.colors.length]})}),h,": ",w.value]})},h)})})]})},C=m.bind({});C.args={...g,renderGlyph:({color:l,size:c,x:h,y:p})=>(0,t.jsx)(a.A,{top:p,left:h,size:c*c,fill:"#fff",stroke:l}),glyphStyle:{radius:10},renderTooltip:E};const b=m.bind({});b.args={...g,showLegend:!0,withStartGlyphs:!0,withLegendGlyph:!0,themeName:"glyph",glyphStyle:{radius:8}};const P=["Start","End","Custom","CustomSvg","InTooltip","CustomPerDataPoint"];y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:"args => <LineChart {...args} />",...y.parameters?.docs?.source}}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:"args => <LineChart {...args} />",...f.parameters?.docs?.source}}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:"args => <LineChart {...args} />",...v.parameters?.docs?.source}}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:"args => <LineChart {...args} />",..._.parameters?.docs?.source}}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:"args => <LineChart {...args} />",...C.parameters?.docs?.source}}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:"args => <LineChart {...args} />",...b.parameters?.docs?.source}}}}),"../charts/src/components/line-chart/stories/index.docs.mdx":((x,i,r)=>{"use strict";r.r(i),r.d(i,{default:()=>L});var a=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),u=r("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.25_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),s=r("../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.25_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist/blocks.mjs"),o=r("../charts/src/components/line-chart/stories/index.stories.tsx"),d=r("../charts/src/components/line-chart/stories/glyph.stories.tsx");function t(j){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...(0,u.R)(),...j.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(s.W8,{title:"JS Packages/Charts/Types/Line Chart",of:o}),`
...
`,(0,e.jsx)(s.Hl,{of:o.SingleSeries}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<LineChart
	data={[
		{
			label: 'Temperature',
			data: [
...
`,(0,e.jsx)(s.kL,{language:"jsx",code:`// Theme configuration example
const customTheme = {
	lineChart: {
		lineStyles: {
			comparison: {
...
`,(0,e.jsx)(s.Hl,{of:o.GradientFilled}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<LineChart
	data={data}
...
`,(0,e.jsx)(s.Hl,{of:o.GradientCustomColors}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`const data = [
	{
		label: 'Revenue',
		data: chartData,
		options: {
...
`,(0,e.jsx)(s.Hl,{of:o.GradientTransparent}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`const data = [
	{
		label: 'Temperature',
...
`,(0,e.jsx)(s.Hl,{of:o.WithPointerEvents}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<LineChart
	data={data}
...
`,(0,e.jsx)(s.Hl,{of:o.SmartFormatting}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<LineChart
	data={data}
	options={{
		axis: {
...
`,(0,e.jsx)(s.Hl,{of:o.FixedDimensions}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`// Responsive (default)
<LineChart data={data} />
...
`,(0,e.jsx)(s.kL,{language:"jsx",code:`<LineChart data={data}>
	<LineChart.AnnotationsOverlay>
		<LineChart.Annotation
...
`,(0,e.jsx)(s.Hl,{of:o.DateStringFormats}),`
`,(0,e.jsx)(s.kL,{language:"jsx",code:`// Date objects
...
`]})]})}function L(j={}){const{wrapper:n}={...(0,u.R)(),...j.components};return n?(0,e.jsx)(n,{...j,children:(0,e.jsx)(t,{...j})}):t(j)}})}]);
