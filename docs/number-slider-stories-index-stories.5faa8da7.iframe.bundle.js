...
`,V={_default:{startLoc:{col:17,line:11},endLoc:{col:2,line:13},startBody:{col:17,line:11},endBody:{col:2,line:13}},WithDefaultValue:{startLoc:{col:34,line:19},endLoc:{col:1,line:41},startBody:{col:34,line:19},endBody:{col:1,line:41}}};const i={parameters:{storySource:{source:`import { useState } from 'react';
import NumberSlider from '../index.js';
...
// Export With Default Value story
export const WithDefaultValue = TemplateWithChangingValue.bind({});`,locationsMap:{default:{startLoc:{col:17,line:11},endLoc:{col:2,line:13},startBody:{col:17,line:11},endBody:{col:2,line:13}},"with-default-value":{startLoc:{col:34,line:19},endLoc:{col:1,line:41},startBody:{col:34,line:19},endBody:{col:1,line:41}}}}},title:"JS Packages/Components/Number Slider",component:r.A},t=(s=>(0,e.jsx)(r.A,{...s})).bind({}),a=(s=>{const[d,m]=(0,l.useState)(10),[p,_]=(0,l.useState)(10),h=(v,u)=>(0,e.jsxs)("div",{...v,children:[u.valueNow," - ",u.valueNow%2===0?"Even":"Odd"]});return(0,e.jsxs)("div",{children:[(0,e.jsx)(r.A,{...s,value:d,onChange:m,onAfterChange:_,renderThumb:h}),(0,e.jsx)("div",{children:`Value on changing: ${d}`}),(0,e.jsx)("div",{children:`Value on change ends: ${p}`})]})}).bind({}),c=["_default","WithDefaultValue"];t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"args => <NumberSlider {...args} />",...t.parameters?.docs?.source}}},a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`args => {
  const [value, setValue] = useState(10);
  const [endValue, setEndValue] = useState(10);
  const renderThumb = (props, state) => {
    return <div {...props}>
