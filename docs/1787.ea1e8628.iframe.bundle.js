"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[1787],{"../../../node_modules/.pnpm/@wordpress+components@29.3.0_@types+react@18.3.18_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-module/sandbox/index.js":(k,p,s)=>{s.d(p,{A:()=>l});var d=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),_=s("../../../node_modules/.pnpm/@wordpress+element@6.17.0/node_modules/@wordpress/element/build-module/serialize.js"),w=s("../../../node_modules/.pnpm/@wordpress+compose@7.17.0_react@18.3.1/node_modules/@wordpress/compose/build-module/hooks/use-merge-refs/index.js"),c=s("../../../node_modules/.pnpm/@wordpress+compose@7.17.0_react@18.3.1/node_modules/@wordpress/compose/build-module/hooks/use-focusable-iframe/index.js"),e=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const n=function(){const{MutationObserver:m}=window;if(!m||!document.body||!window.parent)return;function t(){const a=document.body.getBoundingClientRect();window.parent.postMessage({action:"resize",width:a.width,height:a.height},"*")}new m(t).observe(document.body,{attributes:!0,attributeOldValue:!1,characterData:!0,characterDataOldValue:!1,childList:!0,subtree:!0}),window.addEventListener("load",t,!0);function r(a){a.style&&["width","height","minHeight","maxHeight"].forEach(function(h){/^\\d+(vw|vh|svw|lvw|dvw|svh|lvh|dvh|vi|svi|lvi|dvi|vb|svb|lvb|dvb|vmin|svmin|lvmin|dvmin|vmax|svmax|lvmax|dvmax)$/.test(a.style[h])&&(a.style[h]="")})}Array.prototype.forEach.call(document.querySelectorAll("[style]"),r),Array.prototype.forEach.call(document.styleSheets,function(a){Array.prototype.forEach.call(a.cssRules||a.rules,r)}),document.body.style.position="absolute",document.body.style.width="100%",document.body.setAttribute("data-resizable-iframe-connected",""),t(),window.addEventListener("resize",t,!0)},i=`
	body {
		margin: 0;
	}
	html,
...
`;function o({html:m="",title:t="",type:v,styles:r=[],scripts:a=[],onFocus:h,tabIndex:R}){const g=(0,d.useRef)(),[M,A]=(0,d.useState)(0),[D,O]=(0,d.useState)(0);function P(){try{return!!g.current?.contentDocument?.body}catch{return!1}}function E(x=!1){if(!P())return;const{contentDocument:f,ownerDocument:y}=g.current;if(!x&&f?.body.getAttribute("data-resizable-iframe-connected")!==null)return;const z=(0,e.jsxs)("html",{lang:y.documentElement.lang,className:v,children:[(0,e.jsxs)("head",{children:[(0,e.jsx)("title",{children:t}),(0,e.jsx)("style",{dangerouslySetInnerHTML:{__html:i}}),r.map((u,j)=>(0,e.jsx)("style",{dangerouslySetInnerHTML:{__html:u}},j))]}),(0,e.jsxs)("body",{"data-resizable-iframe-connected":"data-resizable-iframe-connected",className:v,children:[(0,e.jsx)("div",{dangerouslySetInnerHTML:{__html:m}}),(0,e.jsx)("script",{type:"text/javascript",dangerouslySetInnerHTML:{__html:`(${n.toString()})();`}}),a.map(u=>(0,e.jsx)("script",{src:u},u))]})]});f.open(),f.write("<!DOCTYPE html>"+(0,_.Ay)(z)),f.close()}return(0,d.useEffect)(()=>{E();function x(){E(!1)}function f(u){const j=g.current;if(!j||j.contentWindow!==u.source)return;let b=u.data||{};if(typeof b=="string")try{b=JSON.parse(b)}catch{}b.action==="resize"&&(A(b.width),O(b.height))}const y=g.current,z=y?.ownerDocument?.defaultView;return y?.addEventListener("load",x,!1),z?.addEventListener("message",f),()=>{y?.removeEventListener("load",x,!1),z?.removeEventListener("message",f)}},[]),(0,d.useEffect)(()=>{E()},[t,r,a]),(0,d.useEffect)(()=>{E(!0)},[m,v]),(0,e.jsx)("iframe",{ref:(0,w.A)([g,(0,c.A)()]),title:t,tabIndex:R,className:"components-sandbox",sandbox:"allow-scripts allow-same-origin allow-presentation",onFocus:h,width:Math.ceil(M),height:Math.ceil(D)})}const l=o},"../../../node_modules/.pnpm/@wordpress+compose@7.17.0_react@18.3.1/node_modules/@wordpress/compose/build-module/hooks/use-focusable-iframe/index.js":(k,p,s)=>{s.d(p,{A:()=>_});var d=s("../../../node_modules/.pnpm/@wordpress+compose@7.17.0_react@18.3.1/node_modules/@wordpress/compose/build-module/hooks/use-ref-effect/index.js");function _(){return(0,d.A)(w=>{const{ownerDocument:c}=w;if(!c)return;const{defaultView:e}=c;if(!e)return;function n(){c&&c.activeElement===w&&w.focus()}return e.addEventListener("blur",n),()=>{e.removeEventListener("blur",n)}},[])}},"../../../node_modules/.pnpm/@wordpress+undo-manager@1.17.0/node_modules/@wordpress/undo-manager/build-module/index.js":(k,p,s)=>{s.d(p,{u:()=>c});var d=s("../../../node_modules/.pnpm/@wordpress+is-shallow-equal@5.17.0/node_modules/@wordpress/is-shallow-equal/build-module/index.js");function _(e,n){const i={...e};return Object.entries(n).forEach(([o,l])=>{i[o]?i[o]={...i[o],to:l.to}:i[o]=l}),i}const w=(e,n)=>{const i=e?.findIndex(({id:l})=>typeof l=="string"?l===n.id:(0,d.Ay)(l,n.id)),o=[...e];return i!==-1?o[i]={id:n.id,changes:_(o[i].changes,n.changes)}:o.push(n),o};function c(){let e=[],n=[],i=0;const o=()=>{e=e.slice(0,i||void 0),i=0},l=()=>{var t;const v=e.length===0?0:e.length-1;let r=(t=e[v])!==null&&t!==void 0?t:[];n.forEach(a=>{r=w(r,a)}),n=[],e[v]=r},m=t=>!t.filter(({changes:r})=>Object.values(r).some(({from:a,to:h})=>typeof a!="function"&&typeof h!="function"&&!(0,d.Ay)(a,h))).length;return{addRecord(t,v=!1){const r=!t||m(t);if(v){if(r)return;t.forEach(a=>{n=w(n,a)})}else{if(o(),n.length&&l(),r)return;e.push(t)}},undo(){n.length&&(o(),l());const t=e[e.length-1+i];if(t)return i-=1,t},redo(){const t=e[e.length+i];if(t)return i+=1,t},hasUndo(){return!!e[e.length-1+i]},hasRedo(){return!!e[e.length+i]}}}},"../../../node_modules/.pnpm/css-loader@6.5.1_webpack@5.94.0/node_modules/css-loader/dist/cjs.js!../../../node_modules/.pnpm/@wordpress+dataviews@4.13.0_patch_hash=uzs6glhpt3sq2uqjvqzk6vk2ze_@types+react@18.3.18_react-_wnq25j7jgqchcpg3isuepzuh7u/node_modules/@wordpress/dataviews/build-style/style.css":(k,p,s)=>{s.d(p,{A:()=>n});var d=s("../../../node_modules/.pnpm/css-loader@6.5.1_webpack@5.94.0/node_modules/css-loader/dist/runtime/noSourceMaps.js"),_=s.n(d),w=s("../../../node_modules/.pnpm/css-loader@6.5.1_webpack@5.94.0/node_modules/css-loader/dist/runtime/api.js"),c=s.n(w),e=c()(_());e.push([k.id,`/**
