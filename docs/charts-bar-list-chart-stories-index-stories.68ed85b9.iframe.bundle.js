"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[2885],{"../charts/src/charts/bar-list-chart/stories/index.stories.tsx"(q,_,l){l.r(_),l.d(_,{Animation:()=>i,AspectRatio:()=>n,CustomLabelComponent:()=>f,CustomValueComponent:()=>P,Default:()=>r,FixedDimensions:()=>a,MultiSeries:()=>m,__namedExportsOrder:()=>b,default:()=>t});var A=l("../number-formatters/src/index.ts"),T=l("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),D=l("../../../node_modules/.pnpm/classnames@2.5.1/node_modules/classnames/index.js"),c=l.n(D),v=["className","innerRef"];function o(){return o=Object.assign?Object.assign.bind():function(s){for(var p=1;p<arguments.length;p++){var d=arguments[p];for(var h in d)Object.prototype.hasOwnProperty.call(d,h)&&(s[h]=d[h])}return s},o.apply(this,arguments)}function u(s,p){if(s==null)return{};var d={},h=Object.keys(s),x,g;for(g=0;g<h.length;g++)x=h[g],!(p.indexOf(x)>=0)&&(d[x]=s[x]);return d}function O(s){var p=s.className,d=s.innerRef,h=u(s,v);return T.createElement("circle",o({ref:d,className:c()("visx-circle",p)},h))}var j=l("../../../node_modules/.pnpm/@visx+text@3.12.0_react@18.3.1/node_modules/@visx/text/esm/Text.js"),y=l("../charts/src/providers/chart-context/hooks/use-global-charts-theme.ts"),w=l("../charts/src/stories/chart-decorator.tsx"),M=l("../charts/src/stories/theme-config.tsx"),E=l("../charts/src/stories/sample-data/index.ts"),S=l("../charts/src/charts/bar-list-chart/bar-list-chart.tsx"),C=l("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const t={title:"JS Packages/Charts Library/Charts/Bar List Chart",component:S.A,parameters:{layout:"centered"},decorators:[w.OI],argTypes:{...w.xo,...M.jW}},r={args:{...M.In,withTooltips:!0,data:E.V_}},a={args:{...r.args,width:600,height:300}},n={args:{...r.args,aspectRatio:.3}},m={args:{...r.args,data:E._v}},i={args:{...r.args,animation:!0}},f={args:{...r.args,data:E.V_,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{xScale:{},yScale:{},labelComponent:({textProps:s,x:p,y:d,label:h,formatter:x})=>{const V=(0,y.p)().colors[1];return(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(O,{cx:p+6,cy:d,r:8,fill:V}),(0,C.jsx)(j.A,{...s,textAnchor:"start",x:p+24,y:d,fontWeight:500,children:x(h)})]})}}}},P={args:{...r.args,data:E._v,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{xScale:{},yScale:{},valueComponent:({textProps:s,x:p,y:d,value:h,formatter:x,data:g,index:V})=>{const R=g[0].data[V].value,W=g[1].data[V].value,L=W===0?0:((R-W)/W*100).toFixed(0);return(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(j.A,{...s,textAnchor:"end",x:p,y:d,dx:-50,fontWeight:500,children:x(h)}),(0,C.jsx)(j.A,{...s,textAnchor:"end",x:p,y:d,dx:-10,fill:"#008A20",fontWeight:500,children:`${Number(L)>0?"+":""}${L}%`})]})},valueFormatter:s=>`$${(0,A.qe)(s)}`}}},b=["Default","FixedDimensions","AspectRatio","MultiSeries","Animation","CustomLabelComponent","CustomValueComponent"];r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    ...sharedThemeArgs,
    withTooltips: true,
    data: salesByProduct
