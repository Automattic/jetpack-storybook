"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[5951],{"../charts/src/charts/line-chart/stories/index.docs.mdx"(z,b,l){l.r(b),l.d(b,{default:()=>_});var S=l("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=l("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),L=l("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.28_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),t=l("../../../node_modules/.pnpm/@storybook+addon-docs@10.2.11_@types+react@18.3.28_esbuild@0.25.9_storybook@10.2.11_@te_623b11407ff81c3407704a8a948465b9/node_modules/@storybook/addon-docs/dist/blocks.js"),o=l("../charts/src/charts/line-chart/stories/index.stories.tsx"),x=l("../charts/src/charts/line-chart/stories/glyph.stories.tsx");function r(c){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...(0,L.R)(),...c.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(t.W8,{title:"JS Packages/Charts Library/Charts/Line Chart",of:o}),`
...
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"aspectRatio"})}),": Height as a fraction of width (e.g., ",(0,e.jsx)(n.code,{children:"0.5"})," = 50% height). When omitted, fills parent container height"]}),`
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"maxWidth"})}),": Maximum width constraint for responsive charts (default: ",(0,e.jsx)(n.code,{children:"1200"}),")"]}),`
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"resizeDebounceTime"})}),": Debounce delay for resize events in ms (default: ",(0,e.jsx)(n.code,{children:"300"}),")"]}),`
`]}),`
...
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:(0,e.jsx)(n.code,{children:"legend"})}),": Legend configuration object (",(0,e.jsx)(n.code,{children:"ChartLegendConfig"}),") for controlling orientation, position, alignment, shape, interactivity, and styling"]}),`
...
`,(0,e.jsxs)(n.p,{children:[(0,e.jsx)(n.strong,{children:"Note"}),": Annotation popovers use the native Popover API. Due to Safari's ",(0,e.jsx)(n.code,{children:"foreignObject"})," positioning limitations, interactive popovers are positioned in the viewport center rather than next to the annotation."]}),`
...
`,(0,e.jsxs)(n.p,{children:["Use the composition API to add a legend by placing ",(0,e.jsx)(n.code,{children:"<LineChart.Legend />"})," as a child:"]}),`
`,(0,e.jsx)(t.Hl,{of:o.WithCompositionLegend}),`
`,(0,e.jsx)(t.kL,{language:"jsx",code:`<LineChart data={data}>
	<LineChart.Legend />
</LineChart>`}),`
`,(0,e.jsxs)(n.p,{children:["For full legend configuration options \u2014 positioning, orientation, shapes, interactivity, and the composition API \u2014 see the ",(0,e.jsx)(n.a,{href:"./?path=/docs/js-packages-charts-library-components-legend--docs",children:"Legend component docs"}),"."]}),`
...
`,(0,e.jsx)(t.kL,{language:"tsx",code:`import { GlobalChartsProvider, LineChart, type ChartTheme } from '@automattic/charts';
...
`,(0,e.jsxs)(n.p,{children:["By default, charts ",(0,e.jsx)(n.strong,{children:"fill their parent container's dimensions"}),". The parent must have an explicit height:"]}),`
...
`,(0,e.jsx)(n.p,{children:"The Line Chart component supports an optional entry animation that creates a smooth reveal effect when the chart first renders:"}),`
`,(0,e.jsx)(t.Hl,{of:o.Animation}),`
...
`,(0,e.jsxs)(n.li,{children:[(0,e.jsx)(n.strong,{children:"Effect"}),": Creates a rising effect where lines scale up from the bottom, revealing the data progressively"]}),`
...
`]})]})}function _(c={}){const{wrapper:n}={...(0,L.R)(),...c.components};return n?(0,e.jsx)(n,{...c,children:(0,e.jsx)(r,{...c})}):r(c)}},"../charts/src/charts/line-chart/stories/glyph.stories.tsx"(z,b,l){l.r(b),l.d(b,{Custom:()=>m,CustomPerDataPoint:()=>C,CustomSvg:()=>f,End:()=>u,InTooltip:()=>v,Start:()=>j,__namedExportsOrder:()=>O,default:()=>D});var S=l("../../../node_modules/.pnpm/@visx+glyph@3.12.0_react@18.3.1/node_modules/@visx/glyph/esm/glyphs/GlyphStar.js"),e=l("../charts/src/providers/chart-context/global-charts-provider.tsx"),L=l("../charts/src/providers/chart-context/hooks/use-global-charts-theme.ts"),t=l("../charts/src/stories/theme-config.tsx"),o=l("../charts/src/charts/line-chart/line-chart.tsx"),x=l("../charts/src/charts/line-chart/stories/config.tsx"),r=l("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const _={...t.yI,glyph:x.Em},c=(d,{args:i})=>{const s=i,a=s.themeName,h=_[a||"default"];return(0,r.jsx)(e.S,{theme:h,children:(0,r.jsx)("div",{style:{resize:"both",overflow:"auto",padding:"2rem",width:"800px",height:s.containerHeight||"400px",maxWidth:"1200px",border:"1px dashed #ccc",display:"inline-block"},children:(0,r.jsx)(d,{})})})},D={...x.Nc,title:"JS Packages/Charts Library/Charts/Line Chart/Glyphs",decorators:[c],argTypes:{...x.Nc.argTypes,themeName:{...t.jW.themeName,options:["default","custom","glyph"]},withStartGlyphs:{control:"boolean",description:"Show glyphs at line start",table:{category:"Glyphs"}},withEndGlyphs:{control:"boolean",description:"Show glyphs at line end",table:{category:"Glyphs"}},withLegendGlyph:{control:"boolean",description:"Show glyphs in legend",table:{category:"Glyphs"}},glyphType:{control:"radio",options:["default","star","heart"],description:"Glyph shape",table:{category:"Glyphs"}},glyphSize:{control:{type:"range",min:4,max:16,step:1},description:"Glyph size (radius)",table:{category:"Glyphs"}}}},k=({color:d,size:i,x:s,y:a})=>{const p=typeof s=="number"&&typeof a=="number"&&(s!==0||a!==0)?{transform:`translate(${s}, ${a})`}:{};return(0,r.jsx)("g",{...p,children:(0,r.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:i*2,height:i*2,viewBox:"0 0 24 24",style:{overflow:"visible",pointerEvents:"none"},children:(0,r.jsx)("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z",fill:d,stroke:d,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",transform:"translate(-12, -12)"})})})},g=d=>{const{glyphType:i,glyphSize:s,...a}=d;let h=a.renderGlyph;i==="star"?h=({color:G,size:w,x:T,y:P})=>(0,r.jsx)(S.A,{top:P,left:T,size:w*w,fill:G}):i==="heart"&&(h=({color:G,size:w,x:T,y:P})=>(0,r.jsx)(k,{color:G,size:w,x:T,y:P}));const p=s?{radius:s}:a.glyphStyle;return(0,r.jsx)(o.A,{...a,renderGlyph:h,glyphStyle:p})},y={...x.pn,withStartGlyphs:!0},j=g.bind({});j.args={...y};const u=g.bind({});u.args={...y,withStartGlyphs:!1,withEndGlyphs:!0};const m=g.bind({});m.args={...y,withLegendGlyph:!0,renderGlyph:({color:d,size:i,x:s,y:a})=>(0,r.jsx)(S.A,{top:a,left:s,size:i*i,fill:d}),glyphStyle:{radius:10}};const E=({color:d,size:i,x:s,y:a})=>{const p=typeof s=="number"&&typeof a=="number"&&(s!==0||a!==0)?{transform:`translate(${s}, ${a})`}:{};return(0,r.jsx)("g",{...p,children:(0,r.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:i*2,height:i*2,viewBox:"0 0 24 24",style:{overflow:"visible",pointerEvents:"none"},children:(0,r.jsx)("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z",fill:d,stroke:d,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",transform:"translate(-12, -12)"})})})},f=g.bind({});f.args={...y,withLegendGlyph:!0,renderGlyph:({color:d,size:i,x:s,y:a})=>(0,r.jsx)(E,{color:d,size:i,x:s,y:a}),glyphStyle:{radius:8}};const A=({tooltipData:d})=>{const i=(0,L.p)();return(0,r.jsxs)("div",{children:[(0,r.jsx)("div",{style:{marginBottom:"0.5rem"},children:d?.nearestDatum?.datum?.date?.toLocaleDateString()}),(0,r.jsx)("div",{children:Object.entries(d?.datumByKey||{}).map(([s,a],h)=>{const{datum:p}=a;return(0,r.jsx)("div",{children:(0,r.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"0.5rem",marginBottom:"0.2rem"},children:[(0,r.jsx)("svg",{width:20,height:20,children:(0,r.jsx)(S.A,{size:100,top:10,left:10,fill:"#fff",stroke:i.colors[h%i.colors.length]})}),s,": ",p.value]})},s)})})]})},v=g.bind({});v.args={...y,renderGlyph:({color:d,size:i,x:s,y:a})=>(0,r.jsx)(S.A,{top:a,left:s,size:i*i,fill:"#fff",stroke:d}),glyphStyle:{radius:10},renderTooltip:A};const C=g.bind({});C.args={...y,showLegend:!0,withStartGlyphs:!0,withLegendGlyph:!0,themeName:"glyph",glyphStyle:{radius:8}};const O=["Start","End","Custom","CustomSvg","InTooltip","CustomPerDataPoint"];j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`args => {
  const {
    glyphType,
    glyphSize,
    ...chartProps
...
}`,...j.parameters?.docs?.source}}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`args => {
  const {
    glyphType,
    glyphSize,
    ...chartProps
