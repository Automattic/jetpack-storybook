(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[805,8513],{"../../../node_modules/.pnpm/@storybook+addon-docs@10.1.10_@types+react@18.3.26_esbuild@0.25.9_storybook@10.1.10_@te_0dab3ad5060a2aa8d937367f454f05ee/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive":(D=>{function l(r){var d=new Error("Cannot find module '"+r+"'");throw d.code="MODULE_NOT_FOUND",d}l.keys=()=>[],l.resolve=l,l.id="../../../node_modules/.pnpm/@storybook+addon-docs@10.1.10_@types+react@18.3.26_esbuild@0.25.9_storybook@10.1.10_@te_0dab3ad5060a2aa8d937367f454f05ee/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive",D.exports=l}),"../charts/src/charts/pie-chart/stories/donut.docs.mdx":((D,l,r)=>{"use strict";r.r(l),r.d(l,{default:()=>P});var d=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),y=r("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.26_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),i=r("../../../node_modules/.pnpm/@storybook+addon-docs@10.1.10_@types+react@18.3.26_esbuild@0.25.9_storybook@10.1.10_@te_0dab3ad5060a2aa8d937367f454f05ee/node_modules/@storybook/addon-docs/dist/blocks.js"),p=r("../charts/src/charts/pie-chart/stories/donut.stories.tsx");function m(u){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...(0,y.R)(),...u.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(i.W8,{title:"JS Packages/Charts Library/Charts/Donut Chart",of:p}),`
...
}`,...k.parameters?.docs?.source}}}}),"../charts/src/components/legend/hooks/use-chart-legend-items.ts":((D,l,r)=>{"use strict";r.d(l,{f:()=>t});var d=r("../number-formatters/src/index.ts"),e=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),y=r("../charts/src/providers/chart-context/hooks/use-global-charts-context.ts"),i=r("../charts/src/utils/format-percentage.ts");function p(s,c,n="percentage"){if(!c||n==="none")return"";if("percentage"in s){const h=s;switch(n){case"percentage":return(0,i.E)(h.percentage);case"value":return(0,d.ZV)(h.value);case"valueDisplay":return h.valueDisplay||(0,d.ZV)(h.value);default:return""}}return"value"in s&&s.value!==null?(0,d.ZV)(s.value):""}function m(s,c,n,h,j){if(c){const v=n||h;if(v)return{...s,glyphSize:j,renderGlyph:v}}return s}function P(s,c,n,h,j,v,a){const x=(g,f)=>{const{color:_,glyph:A,shapeStyles:T}=c({data:g,index:f,legendShape:a}),C={label:g.label,value:n?g.data?.length?.toString()||"0":"",color:_,shapeStyle:T};return m(C,h,A,v,j)};return s.map(x)}function u(s,c,n,h,j,v,a,x){const g=(f,_)=>{const{color:A,glyph:T,shapeStyles:C}=c({data:f,index:_,legendShape:x}),b={label:f.label,value:p(f,n,h),color:A,shapeStyle:C};return m(b,j,T,a,v)};return s.map(g)}function t(s,c={},n){const{showValues:h=!1,legendValueDisplay:j="percentage",withGlyph:v=!1,glyphSize:a=8,renderGlyph:x}=c,{getElementStyles:g}=(0,y.j)();return(0,e.useMemo)(()=>!s||!Array.isArray(s)||s.length===0?[]:"data"in s[0]?P(s,g,h,v,a,x,n):u(s,g,h,j,v,a,x,n),[s,g,h,j,v,a,x,n])}}),"../charts/src/hooks/use-element-height.ts":((D,l,r)=>{"use strict";r.d(l,{v:()=>e});var d=r("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");function e({initialHeight:y=0}={}){const[i,p]=(0,d.useState)(y),m=(0,d.useRef)(null);return[(0,d.useCallback)(u=>{if(m.current&&(m.current.disconnect(),m.current=null),u){const t=()=>{p(u.getBoundingClientRect().height||0)};t();const s=new window.ResizeObserver(t);s.observe(u),m.current=s}},[]),i]}}),"../charts/src/stories/legend-config.tsx":((D,l,r)=>{"use strict";r.d(l,{r:()=>d});const d={showLegend:{control:{type:"boolean"},description:"Show or hide the legend",table:{category:"Legend"}},legendPosition:{control:{type:"select"},options:["top","bottom"],description:"Position of the legend relative to the chart",table:{category:"Legend"}},legendAlignment:{control:{type:"select"},options:["start","center","end"],description:"Horizontal alignment of the legend within its position",table:{category:"Legend"}},legendOrientation:{control:{type:"select"},options:["horizontal","vertical"],description:"Layout direction of legend items",table:{category:"Legend"}},legendShape:{control:{type:"select"},options:["circle","rect"],description:"Shape of the legend marker icon",table:{category:"Legend"}},withLegendGlyph:{control:{type:"boolean"},table:{category:"Legend"},description:"Show glyphs in legend (Line charts only)"},legendValueDisplay:{control:{type:"select"},options:["percentage","value","valueDisplay","none"],table:{category:"Legend"},description:'What type of value to display in the legend when showValues is true. Note: Enable "showLegend" to see the effect of this control.'},legendMaxWidth:{control:{type:"text"},table:{category:"Legend"},description:'Maximum width for legend items as CSS value (e.g. "200px", "50%", "10rem"). When set, text overflow behavior is controlled by legendTextOverflow.'},legendTextOverflow:{control:{type:"select"},options:["wrap","ellipsis"],table:{category:"Legend"},description:'Controls how text behaves when it exceeds legendMaxWidth. "ellipsis" truncates with ... (ideal for widgets), "wrap" allows text to wrap to multiple lines.'},legendItemClassName:{control:{type:"text"},table:{category:"Legend"},description:"Additional CSS class name for legend items. This allows consumers to customize individual legend item styling."},legendInteractive:{control:{type:"boolean"},table:{category:"Legend"},description:"Enable interactive legend items that can toggle series visibility. Requires GlobalChartsProvider and chartId to be set."}};try{d.displayName="legendArgTypes",d.__docgenInfo={description:`Shared legend configuration for chart stories
Provides consistent argTypes and decorators across all chart legend stories`,displayName:"legendArgTypes",props:{}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../charts/src/stories/legend-config.tsx#legendArgTypes"]={docgenInfo:d.__docgenInfo,name:"legendArgTypes",path:"../charts/src/stories/legend-config.tsx#legendArgTypes"})}catch{}}),"../charts/src/utils/format-percentage.ts":((D,l,r)=>{"use strict";r.d(l,{E:()=>e});var d=r("../number-formatters/src/index.ts");const e=y=>(0,d.ZV)(y/100,{numberFormatOptions:{style:"percent",minimumFractionDigits:0,maximumFractionDigits:2}})})}]);
