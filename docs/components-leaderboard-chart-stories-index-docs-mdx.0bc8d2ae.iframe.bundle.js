(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[9637],{"../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.26_react@18.3.1/node_modules/@mdx-js/react/lib/index.js":((l,t,s)=>{"use strict";s.d(t,{R:()=>r,x:()=>n});var o=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js");const e={},h=o.createContext(e);function r(i){const d=o.useContext(h);return o.useMemo(function(){return typeof i=="function"?i(d):{...d,...i}},[d,i])}function n(i){let d;return i.disableParentContext?d=typeof i.components=="function"?i.components(e):i.components||e:d=r(i.components),o.createElement(h.Provider,{value:d},i.children)}}),"../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.26_storybook@9.0.15_@testing-library+dom@10.4.1_/node_modules/@storybook/addon-docs/dist sync recursive":(l=>{function t(s){var o=new Error("Cannot find module '"+s+"'");throw o.code="MODULE_NOT_FOUND",o}t.keys=()=>[],t.resolve=t,t.id="../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.26_storybook@9.0.15_@testing-library+dom@10.4.1_/node_modules/@storybook/addon-docs/dist sync recursive",l.exports=t}),"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.1/node_modules/storybook/dist/components sync recursive":(l=>{function t(s){var o=new Error("Cannot find module '"+s+"'");throw o.code="MODULE_NOT_FOUND",o}t.keys=()=>[],t.resolve=t,t.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.1/node_modules/storybook/dist/components sync recursive",l.exports=t}),"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.1/node_modules/storybook/dist/theming sync recursive":(l=>{function t(s){var o=new Error("Cannot find module '"+s+"'");throw o.code="MODULE_NOT_FOUND",o}t.keys=()=>[],t.resolve=t,t.id="../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.1/node_modules/storybook/dist/theming sync recursive",l.exports=t}),"../charts/src/components/leaderboard-chart/stories/index.docs.mdx":((l,t,s)=>{"use strict";s.r(t),s.d(t,{default:()=>d});var o=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),e=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js"),h=s("../../../node_modules/.pnpm/@mdx-js+react@3.1.1_@types+react@18.3.26_react@18.3.1/node_modules/@mdx-js/react/lib/index.js"),r=s("../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.26_storybook@9.0.15_@testing-library+dom@10.4.1_/node_modules/@storybook/addon-docs/dist/blocks.mjs"),n=s("../charts/src/components/leaderboard-chart/stories/index.stories.tsx");function i(c){const a={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...(0,h.R)(),...c.components};return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)(r.W8,{title:"JS Packages/Charts/Types/Leaderboard Chart",of:n}),`
...
`,(0,e.jsxs)(a.p,{children:["For detailed information about component props, types, and method signatures, see the ",(0,e.jsx)(a.a,{href:"./?path=/docs/js-packages-charts-types-leaderboard-chart-api-reference--docs",children:"Leaderboard Chart API Reference"}),"."]}),`
...
`,(0,e.jsx)(r.Hl,{of:n.WithoutComparison}),`
...
`]}),`
`,(0,e.jsxs)(a.p,{children:["For detailed prop information, type definitions, and examples, see the ",(0,e.jsx)(a.a,{href:"./?path=/docs/js-packages-charts-types-leaderboard-chart-api-reference--docs",children:"Leaderboard Chart API Reference"}),"."]}),`
...
`,(0,e.jsx)(r.Hl,{of:n.NegativeGrowth}),`
...
`,(0,e.jsx)(r.Hl,{of:n.CurrencyFormatting}),`
`,(0,e.jsx)(r.kL,{language:"tsx",code:`<LeaderboardChart
	data={data}
	withComparison={true}
...
`,(0,e.jsx)(r.Hl,{of:n.NumberFormatting}),`
`,(0,e.jsx)(r.kL,{language:"tsx",code:`<LeaderboardChart
	data={data}
	valueFormatter={(value) =>
...
`,(0,e.jsx)(r.Hl,{of:n.AdvancedFormatting}),`
`,(0,e.jsx)(r.kL,{language:"tsx",code:`<LeaderboardChart
	data={largeValues}
	valueFormatter={(value) => {
		if (value >= 1000000) {
...
`,(0,e.jsx)(r.Hl,{of:n.CustomColors}),`
`,(0,e.jsx)(r.kL,{language:"tsx",code:`<LeaderboardChart
	data={data}
	withComparison={true}
	primaryColor="red"
...
`,(0,e.jsx)(r.Hl,{of:n.WithOverlayLabel}),`
`,(0,e.jsx)(r.kL,{language:"tsx",code:`<LeaderboardChart
	data={data}
...
`,(0,e.jsx)(r.Hl,{of:n.OverlayLabelWithImage}),`
`,(0,e.jsx)(r.kL,{language:"tsx",code:`<LeaderboardChart
	data={richLabelData}
	withComparison={true}
	withOverlayLabel={true}
...
`,(0,e.jsx)(r.Hl,{of:n.CustomLegendLabels}),`
`,(0,e.jsx)(r.kL,{language:"tsx",code:`<LeaderboardChart
	data={data}
	withComparison={true}
	showLegend={true}
...
`]}),`
`,(0,e.jsxs)(a.p,{children:["See the ",(0,e.jsx)(a.a,{href:"./?path=/docs/js-packages-charts-types-leaderboard-chart-api-reference--docs",children:"API Reference"})," for detailed prop information."]}),`
...
`,(0,e.jsx)(a.h3,{id:"theme-integration",children:"Theme Integration"}),`
`,(0,e.jsx)(a.p,{children:"The chart integrates with the global charts theming system:"}),`
`,(0,e.jsx)(r.kL,{language:"tsx",code:`import { GlobalChartsProvider, jetpackTheme } from '@automattic/charts';

<GlobalChartsProvider theme={jetpackTheme}>
	<LeaderboardChart data={data} />
</GlobalChartsProvider>`}),`
`,(0,e.jsx)(a.p,{children:(0,e.jsx)(a.strong,{children:"Available themes:"})}),`
`,(0,e.jsxs)(a.ul,{children:[`
`,(0,e.jsxs)(a.li,{children:[(0,e.jsx)(a.strong,{children:"Default"}),": Neutral colors and styling"]}),`
`,(0,e.jsxs)(a.li,{children:[(0,e.jsx)(a.strong,{children:"Jetpack"}),": Jetpack brand colors and styling"]}),`
`,(0,e.jsxs)(a.li,{children:[(0,e.jsx)(a.strong,{children:"Woo"}),": WooCommerce brand colors and styling"]}),`
`,(0,e.jsxs)(a.li,{children:[(0,e.jsx)(a.strong,{children:"Custom"}),": Define your own theme object"]}),`
`]}),`
...
`})]})}function d(c={}){const{wrapper:a}={...(0,h.R)(),...c.components};return a?(0,e.jsx)(a,{...c,children:(0,e.jsx)(i,{...c})}):i(c)}})}]);
