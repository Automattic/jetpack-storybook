(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[4304,5718],{"../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.0.8_@test_ca37a3433c216fd610726ebbc5860d83/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive":(w=>{function x(n){var T=new Error("Cannot find module '"+n+"'");throw T.code="MODULE_NOT_FOUND",T}x.keys=()=>[],x.resolve=x,x.id="../../../node_modules/.pnpm/@storybook+addon-docs@10.0.8_@types+react@18.3.26_esbuild@0.25.9_storybook@10.0.8_@test_ca37a3433c216fd610726ebbc5860d83/node_modules/@storybook/addon-docs/dist/_browser-chunks sync recursive",w.exports=x}),"../../../node_modules/.pnpm/clsx@2.1.1/node_modules/clsx/dist/clsx.mjs":((w,x,n)=>{"use strict";n.d(x,{A:()=>g});function T(l){var h,p,d="";if(typeof l=="string"||typeof l=="number")d+=l;else if(typeof l=="object")if(Array.isArray(l)){var r=l.length;for(h=0;h<r;h++)l[h]&&(p=T(l[h]))&&(d&&(d+=" "),d+=p)}else for(p in l)l[p]&&(d&&(d+=" "),d+=p);return d}function e(){for(var l,h,p=0,d="",r=arguments.length;p<r;p++)(l=arguments[p])&&(h=T(l))&&(d&&(d+=" "),d+=h);return d}const g=e}),"../../../node_modules/.pnpm/deepmerge@4.3.1/node_modules/deepmerge/dist/cjs.js":(w=>{"use strict";var x=function(a){return n(a)&&!T(a)};function n(o){return!!o&&typeof o=="object"}function T(o){var a=Object.prototype.toString.call(o);return a==="[object RegExp]"||a==="[object Date]"||l(o)}var e=typeof Symbol=="function"&&Symbol.for,g=e?Symbol.for("react.element"):60103;function l(o){return o.$$typeof===g}function h(o){return Array.isArray(o)?[]:{}}function p(o,a){return a.clone!==!1&&a.isMergeableObject(o)?O(h(o),o,a):o}function d(o,a,s){return o.concat(a).map(function(i){return p(i,s)})}function r(o,a){if(!a.customMerge)return O;var s=a.customMerge(o);return typeof s=="function"?s:O}function t(o){return Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(o).filter(function(a){return Object.propertyIsEnumerable.call(o,a)}):[]}function m(o){return Object.keys(o).concat(t(o))}function f(o,a){try{return a in o}catch{return!1}}function c(o,a){return f(o,a)&&!(Object.hasOwnProperty.call(o,a)&&Object.propertyIsEnumerable.call(o,a))}function y(o,a,s){var i={};return s.isMergeableObject(o)&&m(o).forEach(function(u){i[u]=p(o[u],s)}),m(a).forEach(function(u){c(o,u)||(f(o,u)&&s.isMergeableObject(a[u])?i[u]=r(u,s)(o[u],a[u],s):i[u]=p(a[u],s))}),i}function O(o,a,s){s=s||{},s.arrayMerge=s.arrayMerge||d,s.isMergeableObject=s.isMergeableObject||x,s.cloneUnlessOtherwiseSpecified=p;var i=Array.isArray(a),u=Array.isArray(o),S=i===u;return S?i?s.arrayMerge(o,a,s):y(o,a,s):p(a,s)}O.all=function(a,s){if(!Array.isArray(a))throw new Error("first argument should be an array");return a.reduce(function(i,u){return O(i,u,s)},{})};var j=O;w.exports=j}),"../charts/src/components/bar-list-chart/bar-list-chart.tsx":((w,x,n)=>{"use strict";n.d(x,{A:()=>s});var T=n("../number-formatters/src/index.ts"),e=n("../../../node_modules/.pnpm/@visx+group@3.12.0_react@18.3.1/node_modules/@visx/group/esm/Group.js"),g=n("../../../node_modules/.pnpm/@visx+scale@3.12.0/node_modules/@visx/scale/esm/scales/band.js"),l=n("../../../node_modules/.pnpm/@visx+scale@3.12.0/node_modules/@visx/scale/esm/createScale.js"),h=n("../../../node_modules/.pnpm/@visx+text@3.12.0_react@18.3.1/node_modules/@visx/text/esm/Text.js"),p=n("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),d=n("../charts/src/providers/chart-context/global-charts-provider.tsx"),r=n("../charts/src/components/bar-chart/bar-chart.tsx"),t=n("../charts/src/components/private/with-responsive/with-responsive.tsx"),m=n("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const f=i=>{const u=i;return u&&"bandwidth"in u?u?.bandwidth()??0:0},c=({textProps:i,x:u,y:S,label:b,formatter:A})=>(0,m.jsx)(h.A,{...i,textAnchor:"start",x:u,y:S,children:A(b)}),y=({textProps:i,x:u,y:S,value:b,formatter:A})=>(0,m.jsx)(h.A,{...i,textAnchor:"end",x:u,y:S,fontWeight:500,children:A(b)}),O=({ticks:i,tickLabelProps:u,yOffset:S,labelPosition:b,valuePosition:A,data:C,labelFormatter:v,valueFormatter:_,LabelComponent:P=c,ValueComponent:V=y})=>{if(i.length===0)return null;const D=i.map(({value:E,index:L})=>typeof u=="function"?u(E,L,i):{});return i.map(({from:E,formattedValue:L},M)=>{const R=D[M]??{};delete R.textAnchor,delete R.dx;const W=C.reduce((q,{data:I})=>q+(I[M]?.value??0),0),B=E.y+S;return(0,m.jsxs)(e.A,{children:[(0,m.jsx)(P,{textProps:R,x:b,y:B,label:L,formatter:v}),(0,m.jsx)(V,{textProps:R,x:A,y:B,value:W,formatter:_,data:C,index:M})]},M)})},j=(i,u,S,b)=>{if(!b)return 0;const A=i.map(({label:V})=>V),C=(0,l.A)({type:"band",range:[0,S],domain:A,...u}),v=(0,g.A)({domain:A,range:[0,f(C)],padding:u.paddingInner});return-(f(v)+6)},o=({data:i,width:u,height:S,options:b={},margin:A={left:0,right:20,bottom:0,top:0},...C})=>{const v=(0,p.useMemo)(()=>{const _=i.length>1,P={paddingInner:_?.3:.1,padding:_?.3:.1},V={zero:!0},D={...P,...b.yScale??{}},E={...V,...b.xScale??{}};return{yScale:D,xScale:E,labelPosition:b.labelPosition??(_?0:10),valueFormatter:b.valueFormatter??(L=>(0,T.qe)(L)),labelFormatter:b.labelFormatter??(L=>String(L)),valuePosition:b.valuePosition??u,yOffset:b.yOffset??j(i,D,S,_)}},[b,u,i,S]);return(0,m.jsx)(r.A,{orientation:"horizontal",gridVisibility:"none",data:i,width:u,height:S,margin:A,options:{axis:{y:{children:_=>(0,m.jsx)(O,{..._,data:i,yOffset:v.yOffset,labelPosition:v.labelPosition,valuePosition:v.valuePosition,labelFormatter:v.labelFormatter,valueFormatter:v.valueFormatter,LabelComponent:b.labelComponent,ValueComponent:b.valueComponent})},x:{children:()=>null}},xScale:v.xScale,yScale:v.yScale},...C})},a=i=>(0,p.useContext)(d.m)?(0,m.jsx)(o,{...i}):(0,m.jsx)(d.S,{children:(0,m.jsx)(o,{...i})});a.displayName="BarListChart";const s=(0,t.F)(a);try{ResponsiveChart.displayName="ResponsiveChart",ResponsiveChart.__docgenInfo={description:"",displayName:"ResponsiveChart",props:{size:{defaultValue:null,description:"Size of the chart in pixels for pie and donut charts",name:"size",required:!1,type:{name:"number"}},height:{defaultValue:null,description:"Height of the chart in pixels",name:"height",required:!1,type:{name:"number"}},width:{defaultValue:null,description:"Width of the chart in pixels",name:"width",required:!1,type:{name:"number"}},className:{defaultValue:null,description:"Additional CSS class name for the chart container",name:"className",required:!1,type:{name:"string"}},data:{defaultValue:null,description:"Array of data points to display in the chart",name:"data",required:!0,type:{name:"SeriesData[]"}},onPointerDown:{defaultValue:null,description:"Callback function for pointer down event",name:"onPointerDown",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerMove:{defaultValue:null,description:"Callback function for pointer move event",name:"onPointerMove",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerUp:{defaultValue:null,description:"Callback function for pointer up event",name:"onPointerUp",required:!1,type:{name:"(event: EventHandlerParams<DataPoint | DataPointDate>) => void"}},onPointerOut:{defaultValue:null,description:"Callback function for pointer out event",name:"onPointerOut",required:!1,type:{name:"(event: PointerEvent<Element>) => void"}},options:{defaultValue:null,description:"More options for the chart.",name:"options",required:!1,type:{name:'{ yScale: Omit<ScaleOptions, "type">; xScale: Omit<ScaleOptions, "type">; labelFormatter?: (value: string) => string; valueFormatter?: (value: number) => string; ... 4 more ...; valueComponent?: ComponentType<...>; }'}},legendInteractive:{defaultValue:null,description:`Enable interactive legend items that can toggle series visibility.
...
`,(0,e.jsx)(l.kL,{language:"tsx",code:`import { GlobalChartsProvider, BarListChart, type ChartTheme } from '@automattic/charts';
...
`]})]})}function d(r={}){const{wrapper:t}={...(0,g.R)(),...r.components};return t?(0,e.jsx)(t,{...r,children:(0,e.jsx)(p,{...r})}):p(r)}}),"../charts/src/components/bar-list-chart/stories/index.stories.tsx":((w,x,n)=>{"use strict";n.r(x),n.d(x,{Animation:()=>u,CustomLabelComponent:()=>S,CustomValueComponent:()=>b,Default:()=>s,MultiSeries:()=>i,__namedExportsOrder:()=>A,default:()=>a});var T=n("../number-formatters/src/index.ts"),e=n("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),g=n("../../../node_modules/.pnpm/classnames@2.5.1/node_modules/classnames/index.js"),l=n.n(g),h=["className","innerRef"];function p(){return p=Object.assign?Object.assign.bind():function(C){for(var v=1;v<arguments.length;v++){var _=arguments[v];for(var P in _)Object.prototype.hasOwnProperty.call(_,P)&&(C[P]=_[P])}return C},p.apply(this,arguments)}function d(C,v){if(C==null)return{};var _={},P=Object.keys(C),V,D;for(D=0;D<P.length;D++)V=P[D],!(v.indexOf(V)>=0)&&(_[V]=C[V]);return _}function r(C){var v=C.className,_=C.innerRef,P=d(C,h);return e.createElement("circle",p({ref:_,className:l()("visx-circle",v)},P))}var t=n("../../../node_modules/.pnpm/@visx+text@3.12.0_react@18.3.1/node_modules/@visx/text/esm/Text.js"),m=n("../charts/src/providers/chart-context/hooks/use-global-charts-theme.ts"),f=n("../charts/src/stories/chart-decorator.tsx"),c=n("../charts/src/stories/theme-config.tsx"),y=n("../charts/src/stories/sample-data/index.ts"),O=n("../charts/src/components/bar-list-chart/bar-list-chart.tsx"),j=n("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");const a={title:"JS Packages/Charts/Types/Bar List Chart",component:O.A,parameters:{layout:"centered"},decorators:[f.OI],argTypes:{...f.xo,...c.jW}},s={args:{...c.In,withTooltips:!0,data:y.V_,containerWidth:"600px",containerHeight:"332px"}},i={args:{...s.args,data:y._v}},u={args:{...s.args,animation:!0}},S={args:{...s.args,data:y.V_,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{xScale:{},yScale:{},labelComponent:({textProps:C,x:v,y:_,label:P,formatter:V})=>{const E=(0,m.p)().colors[1];return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(r,{cx:v+6,cy:_,r:8,fill:E}),(0,j.jsx)(t.A,{...C,textAnchor:"start",x:v+24,y:_,fontWeight:500,children:V(P)})]})}}}},b={args:{...s.args,data:y._v,width:450,margin:{top:0,right:100,bottom:0,left:0},options:{xScale:{},yScale:{},valueComponent:({textProps:C,x:v,y:_,value:P,formatter:V,data:D,index:E})=>{const L=D[0].data[E].value,M=D[1].data[E].value,R=M===0?0:((L-M)/M*100).toFixed(0);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(t.A,{...C,textAnchor:"end",x:v,y:_,dx:-50,fontWeight:500,children:V(P)}),(0,j.jsx)(t.A,{...C,textAnchor:"end",x:v,y:_,dx:-10,fill:"#008A20",fontWeight:500,children:`${Number(R)>0?"+":""}${R}%`})]})},valueFormatter:C=>`$${(0,T.qe)(C)}`}}},A=["Default","MultiSeries","Animation","CustomLabelComponent","CustomValueComponent"];s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    ...sharedThemeArgs,
    withTooltips: true,
    data: salesByProduct,
