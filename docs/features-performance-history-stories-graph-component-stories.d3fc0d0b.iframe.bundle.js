...
export const _default = Template.bind({});
_default.args = defaultValues;`,locationsMap:{default:{startLoc:{col:17,line:197},endLoc:{col:1,line:217},startBody:{col:17,line:197},endBody:{col:1,line:217}}}}},title:"Plugins/Boost/Performance History Graph",component:ft,argTypes:{startDate:{control:"date"},endDate:{control:"date"},periods:{control:"object"},annotations:{control:"object"},isLoading:{control:"boolean"},needsUpgrade:{control:"boolean"},isFreshStart:{control:"boolean"}},decorators:[t=>(0,c.jsx)("div",{style:{maxWidth:"1320px",margin:"200px auto",fontSize:"16px"},children:(0,c.jsx)(t,{})})]},ns={startDate:Re.data._meta.start,endDate:Re.data._meta.end,periods:Re.data.periods,annotations:Re.data.annotations,isLoading:!1,needsUpgrade:!1,isFreshStart:!1},os=ss,re=(t=>{const[o,i]=a.useState(t.isFreshStart),[l,d]=a.useState(t.needsUpgrade);return(0,a.useEffect)(()=>{i(t.isFreshStart),d(t.needsUpgrade)},[t.isFreshStart,t.needsUpgrade]),t.handleUpgrade=()=>{d(!1)},t.handleDismissFreshStart=()=>{i(!1)},(0,c.jsx)(ft,{...t,isFreshStart:o,needsUpgrade:l})}).bind({});re.args=ns;const rs=["_default"];re.parameters={...re.parameters,docs:{...re.parameters?.docs,source:{originalSource:`args => {
  const [isFreshStart, setIsFreshStart] = React.useState(args.isFreshStart);
  const [needsUpgrade, setNeedsUpgrade] = React.useState(args.needsUpgrade);
