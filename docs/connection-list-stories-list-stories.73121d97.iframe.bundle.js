...
`,T={_default:{startLoc:{col:17,line:13},endLoc:{col:1,line:26},startBody:{col:17,line:13},endBody:{col:1,line:26}},NoTitle:{startLoc:{col:17,line:13},endLoc:{col:1,line:26},startBody:{col:17,line:13},endBody:{col:1,line:26}}};const L={parameters:{storySource:{source:`/* wp:polyfill */
...
NoTitle.args = {
  ...DefaultArgs,
  title: undefined
};`,locationsMap:{default:{startLoc:{col:17,line:13},endLoc:{col:1,line:26},startBody:{col:17,line:13},endBody:{col:1,line:26}},"no-title":{startLoc:{col:17,line:13},endLoc:{col:1,line:26},startBody:{col:17,line:13},endBody:{col:1,line:26}}}}},title:"JS Packages/Publicize Components/Connection List/List",component:s},j=b=>{const[f,y]=(0,c.useState)(b.connections),v=(0,c.useCallback)(p=>{y(h=>h.map(C=>C.connection_id===p?{...C,enabled:!C.enabled}:C))},[]);return(0,t.jsx)(s,{connections:f,onToggle:v,title:b.title})},S={connections:[{display_name:"Matt Mullenweg",profile_picture:"https://gravatar.com/avatar/5a5f21e099ba62ae525e62cd1ad859985c8170b8811431e7fa6ccbc9da22405b",connection_id:"1234",service_name:"tumblr",enabled:!0},{display_name:"Matt Mullenweg",profile_picture:"https://gravatar.com/avatar/5a5f21e099ba62ae525e62cd1ad859985c8170b8811431e7fa6ccbc9da22405b",connection_id:"4567",service_name:"bluesky",enabled:!1},{display_name:"Matt Mullenweg",profile_picture:"https://gravatar.com/avatar/5a5f21e099ba62ae525e62cd1ad859985c8170b8811431e7fa6ccbc9da22405b",connection_id:"6789",service_name:"mastodon",enabled:!0}],onToggle:()=>{},title:"Select where to share"},m=j.bind({});m.args=S;const u=j.bind({});u.args={...S,title:void 0};const E=["_default","NoTitle"];m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`args => {
  const [connections, setConnections] = useState(args.connections);
  const handleToggle = useCallback((connectionId: string) => {
    setConnections(prevConnections => prevConnections.map(connection => connection.connection_id === connectionId ? {
      ...connection,
