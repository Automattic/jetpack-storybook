"use strict";(self.webpackChunk_automattic_jetpack_storybook=self.webpackChunk_automattic_jetpack_storybook||[]).push([[6231],{"../../../node_modules/.pnpm/@storybook+addon-a11y@9.0.15_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-a11y/dist/preview.mjs":((Nt,ue,W)=>{W.r(ue),W.d(ue,{afterEach:()=>Be,initialGlobals:()=>Qe,parameters:()=>At});var nt=W("storybook/test"),X=W.n(nt),re=W("storybook/internal/preview-errors"),Ke=W.n(re),st=W("@storybook/global"),pt=W.n(st),rt=W("storybook/preview-api"),Et=W.n(rt),p="storybook/a11y",Rt=`${p}/panel`,xe=`${p}/result`,yt=`${p}/request`,He=`${p}/running`,he=`${p}/error`,De=`${p}/manual`,ze=`${p}/select`,Le={RESULT:xe,REQUEST:yt,RUNNING:He,ERROR:he,MANUAL:De,SELECT:ze},{document:et}=st.global,kt=(Pe,jt)=>{let it=et.location.pathname.replace(/iframe\.html$/,""),Ge={...Pe};return["incomplete","passes","violations"].forEach(B=>{Array.isArray(Pe[B])&&(Ge[B]=Pe[B].map(ie=>({...ie,nodes:ie.nodes.map((ot,Ie)=>{let lt=`${B}.${ie.id}.${Ie+1}`,dt=`${it}?path=/story/${jt}&addonPanel=${Rt}&a11ySelection=${lt}`;return{id:lt,...ot,linkPath:dt}})})))}),Ge},{document:$t}=st.global,xt=rt.addons.getChannel(),We={config:{},options:{}},tt=["region"],Ne=[],wt=!1,Bt=async()=>{if(Ne.length===0){wt=!1;return}wt=!0;let Pe=Ne.shift();Pe&&await Pe(),Bt()},Oe=async(Pe=We,jt)=>{let it=(await W.e(131).then(W.t.bind(W,"../../../node_modules/.pnpm/axe-core@4.11.0/node_modules/axe-core/axe.js",23)))?.default||globalThis.axe,{config:Ge={},options:B={}}=Pe;if(Pe.element)throw new re.ElementA11yParameterError;let ie={include:$t?.body,exclude:[".sb-wrapper","#storybook-docs","#storybook-highlights-root"]};if(Pe.context){let Ie=typeof Pe.context=="object"&&"include"in Pe.context&&Pe.context.include!==void 0,lt=typeof Pe.context=="object"&&"exclude"in Pe.context&&Pe.context.exclude!==void 0;Ie?ie.include=Pe.context.include:!Ie&&!lt&&(ie.include=Pe.context),lt&&(ie.exclude=ie.exclude.concat(Pe.context.exclude))}it.reset();let ot={...Ge,rules:[...tt.map(Ie=>({id:Ie,enabled:!1})),...Ge?.rules??[]]};return it.configure(ot),new Promise((Ie,lt)=>{let dt=$t?.getElementById("storybook-highlights-root");dt&&(dt.style.display="none");let Pt=async()=>{try{let It=await it.run(ie,B),Jt=kt(It,jt);Ie(Jt)}catch(It){lt(It)}};Ne.push(Pt),wt||Bt(),dt&&(dt.style.display="")})};xt.on(Le.MANUAL,async(Pe,jt=We)=>{try{await(0,rt.waitForAnimations)();let it=await Oe(jt,Pe),Ge=JSON.parse(JSON.stringify(it));xt.emit(Le.RESULT,Ge,Pe)}catch(it){xt.emit(Le.ERROR,it)}});function ae(){try{return(void 0).VITEST_STORYBOOK==="false"}catch{return!1}}var ve=!1,Be=async({id:Pe,reporting:jt,parameters:it,globals:Ge,viewMode:B})=>{let ie=it.a11y,ot=Ge.a11y,Ie=ie?.disable!==!0&&ie?.test!=="off"&&ot?.manual!==!0,lt=()=>{switch(ie?.test){case"todo":return"warning";case"error":default:return"failed"}};if(Ie&&B==="story")try{let dt=await Oe(ie,Pe);if(dt){let Pt=(dt?.violations.length??0)>0;if(jt.addReport({type:"a11y",version:1,result:dt,status:Pt?lt():"passed"}),ae()&&Pt&&lt()==="failed"){if(!ve){let{toHaveNoViolations:It}=await W.e(5785).then(W.bind(W,"../../../node_modules/.pnpm/@storybook+addon-a11y@9.0.15_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-a11y/dist/matchers-7Z3WT2CE.mjs"));nt.expect.extend({toHaveNoViolations:It}),ve=!0}(0,nt.expect)(dt).toHaveNoViolations()}}}catch(dt){if(jt.addReport({type:"a11y",version:1,result:{error:dt},status:"failed"}),ae())throw dt}},Qe={a11y:{manual:!1}},At={a11y:{test:"todo"}}}),"../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.26_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist/preview.mjs":((Nt,ue,W)=>{W.r(ue),W.d(ue,{parameters:()=>X});var nt=Object.entries(globalThis.TAGS_OPTIONS??{}).reduce((re,Ke)=>{let[st,pt]=Ke;return pt.excludeFromDocsStories&&(re[st]=!0),re},{}),X={docs:{renderer:async()=>{let{DocsRenderer:re}=await Promise.all([W.e(4833),W.e(2164),W.e(7058)]).then(W.bind(W,"../../../node_modules/.pnpm/@storybook+addon-docs@9.0.15_@types+react@18.3.26_storybook@9.0.15_@testing-library+dom@10.4.0_/node_modules/@storybook/addon-docs/dist/DocsRenderer-PQXLIZUC.mjs"));return new re},stories:{filter:re=>(re.tags||[]).filter(Ke=>nt[Ke]).length===0&&!re.parameters.docs?.disable}}}}),"../../../node_modules/.pnpm/@storybook+react@9.0.15_react-dom@18.3.1_react@18.3.1__react@18.3.1_storybook@9.0.15_@t_d31ab8249bad5412cdefff463bc771e1/node_modules/@storybook/react/dist/chunk-CKO6TW2F.mjs":((Nt,ue,W)=>{W.d(ue,{HA:()=>Ko,Jz:()=>Et,Rf:()=>rt});var nt=W("../../../node_modules/.pnpm/@storybook+react@9.0.15_react-dom@18.3.1_react@18.3.1__react@18.3.1_storybook@9.0.15_@t_d31ab8249bad5412cdefff463bc771e1/node_modules/@storybook/react/dist/chunk-XP5HYGXS.mjs"),X=W("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js"),re=(0,nt.P$)({"../../node_modules/@base2/pretty-print-object/dist/index.js"(y){var T=y&&y.__assign||function(){return T=Object.assign||function(C){for(var P,R=1,G=arguments.length;R<G;R++){P=arguments[R];for(var te in P)Object.prototype.hasOwnProperty.call(P,te)&&(C[te]=P[te])}return C},T.apply(this,arguments)},ce=y&&y.__spreadArrays||function(){for(var C=0,P=0,R=arguments.length;P<R;P++)C+=arguments[P].length;for(var G=Array(C),te=0,P=0;P<R;P++)for(var v=arguments[P],pe=0,K=v.length;pe<K;pe++,te++)G[te]=v[pe];return G};Object.defineProperty(y,"__esModule",{value:!0});var se=[];function mt(C){var P=typeof C;return C!==null&&(P==="object"||P==="function")}function s(C){return Object.prototype.toString.call(C)==="[object RegExp]"}function M(C){return Object.getOwnPropertySymbols(C).filter(function(P){return Object.prototype.propertyIsEnumerable.call(C,P)})}function N(C,P,R){R===void 0&&(R="");var G={indent:"	",singleQuotes:!0},te=T(T({},G),P),v;te.inlineCharacterLimit===void 0?v={newLine:`
`,newLineOrSpace:`
...
}`,""]);const pt=st}),"../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/cjs.js!../../../node_modules/.pnpm/@wordpress+block-library@9.31.0_@types+react@18.3.26_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/block-library/build-style/editor.css":((Nt,ue,W)=>{W.d(ue,{A:()=>Rt});var nt=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/noSourceMaps.js"),X=W.n(nt),re=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/api.js"),Ke=W.n(re),st=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/getUrl.js"),pt=W.n(st),rt=new URL(W("data:image/png;base64,"),W.b),Et=Ke()(X()),p=pt()(rt);Et.push([Nt.id,`/**
 * Colors
 */
/**
 * Breakpoints & Media Queries
...
:where(.editor-styles-wrapper) iframe:not([frameborder]) {
  border: 0;
}`,""]);const Rt=Et}),"../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/cjs.js!../../../node_modules/.pnpm/@wordpress+block-library@9.31.0_@types+react@18.3.26_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/block-library/build-style/style.css":((Nt,ue,W)=>{W.d(ue,{A:()=>Rt});var nt=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/noSourceMaps.js"),X=W.n(nt),re=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/api.js"),Ke=W.n(re),st=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/getUrl.js"),pt=W.n(st),rt=new URL(W('data:image/svg+xml;utf8,<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="50"/></svg>'),W.b),Et=Ke()(X()),p=pt()(rt);Et.push([Nt.id,`@charset "UTF-8";
/**
 * Colors
 */
/**
...
}`,""]);const Rt=Et}),"../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/cjs.js!../../../node_modules/.pnpm/@wordpress+block-library@9.31.0_@types+react@18.3.26_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/block-library/build-style/theme.css":((Nt,ue,W)=>{W.d(ue,{A:()=>pt});var nt=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/noSourceMaps.js"),X=W.n(nt),re=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/api.js"),Ke=W.n(re),st=Ke()(X());st.push([Nt.id,`/**
 * Colors
 */
/**
 * Breakpoints & Media Queries
...
:root :where(.wp-block-template-part.has-background) {
  ...
  margin-top: 0;
  margin-bottom: 0;
}`,""]);const pt=st}),"../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/cjs.js!../../../node_modules/.pnpm/@wordpress+components@30.4.0_@types+react@18.3.26_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/components/build-style/style.css":((Nt,ue,W)=>{W.d(ue,{A:()=>Rt});var nt=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/noSourceMaps.js"),X=W.n(nt),re=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/api.js"),Ke=W.n(re),st=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/getUrl.js"),pt=W.n(st),rt=new URL(W('data:image/svg+xml,%3Csvg width="28" height="28" fill="none" xmlns="http://www.w3.org/2000/svg"%3E%3Cpath d="M6 8V6H4v2h2zM8 8V6h2v2H8zM10 16H8v-2h2v2zM12 16v-2h2v2h-2zM12 18v-2h-2v2H8v2h2v-2h2zM14 18v2h-2v-2h2zM16 18h-2v-2h2v2z" fill="%23555D65"/%3E%3Cpath fill-rule="evenodd" clip-rule="evenodd" d="M18 18h2v-2h-2v-2h2v-2h-2v-2h2V8h-2v2h-2V8h-2v2h2v2h-2v2h2v2h2v2zm-2-4v-2h2v2h-2z" fill="%23555D65"/%3E%3Cpath d="M18 18v2h-2v-2h2z" fill="%23555D65"/%3E%3Cpath fill-rule="evenodd" clip-rule="evenodd" d="M8 10V8H6v2H4v2h2v2H4v2h2v2H4v2h2v2H4v2h2v-2h2v2h2v-2h2v2h2v-2h2v2h2v-2h2v2h2v-2h2v-2h-2v-2h2v-2h-2v-2h2v-2h-2v-2h2V8h-2V6h2V4h-2v2h-2V4h-2v2h-2V4h-2v2h-2V4h-2v2h2v2h-2v2H8zm0 2v-2H6v2h2zm2 0v-2h2v2h-2zm0 2v-2H8v2H6v2h2v2H6v2h2v2h2v-2h2v2h2v-2h2v2h2v-2h2v2h2v-2h-2v-2h2v-2h-2v-2h2v-2h-2v-2h2V8h-2V6h-2v2h-2V6h-2v2h-2v2h2v2h-2v2h-2z" fill="%23555D65"/%3E%3Cpath fill-rule="evenodd" clip-rule="evenodd" d="M4 0H2v2H0v2h2v2H0v2h2v2H0v2h2v2H0v2h2v2H0v2h2v2H0v2h2v2H0v2h2v-2h2v2h2v-2h2v2h2v-2h2v2h2v-2h2v2h2v-2h2v2h2v-2h2v2h2v-2h2v-2h-2v-2h2v-2h-2v-2h2v-2h-2v-2h2v-2h-2v-2h2V8h-2V6h2V4h-2V2h2V0h-2v2h-2V0h-2v2h-2V0h-2v2h-2V0h-2v2h-2V0h-2v2H8V0H6v2H4V0zm0 4V2H2v2h2zm2 0V2h2v2H6zm0 2V4H4v2H2v2h2v2H2v2h2v2H2v2h2v2H2v2h2v2H2v2h2v2h2v-2h2v2h2v-2h2v2h2v-2h2v2h2v-2h2v2h2v-2h2v2h2v-2h-2v-2h2v-2h-2v-2h2v-2h-2v-2h2v-2h-2v-2h2V8h-2V6h2V4h-2V2h-2v2h-2V2h-2v2h-2V2h-2v2h-2V2h-2v2H8v2H6z" fill="%23555D65"/%3E%3C/svg%3E'),W.b),Et=Ke()(X()),p=pt()(rt);Et.push([Nt.id,`@charset "UTF-8";
/**
 * Colors
 */
/**
...
}`,""]);const Rt=Et}),"../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/cjs.js!../../../node_modules/.pnpm/@wordpress+format-library@5.31.0_@types+react@18.3.26_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@wordpress/format-library/build-style/style.css":((Nt,ue,W)=>{W.d(ue,{A:()=>pt});var nt=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/noSourceMaps.js"),X=W.n(nt),re=W("../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/api.js"),Ke=W.n(re),st=Ke()(X());st.push([Nt.id,`/**
 * Colors
 */
/**
 * Breakpoints & Media Queries
...
.block-editor-format-toolbar__language-popover .components-popover__content {
  width: auto;
  padding: 1rem;
}`,""]);const pt=st}),"../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/api.js":(Nt=>{Nt.exports=function(ue){var W=[];return W.toString=function(){return this.map(function(X){var re="",Ke=typeof X[5]<"u";return X[4]&&(re+="@supports (".concat(X[4],") {")),X[2]&&(re+="@media ".concat(X[2]," {")),Ke&&(re+="@layer".concat(X[5].length>0?" ".concat(X[5]):""," {")),re+=ue(X),Ke&&(re+="}"),X[2]&&(re+="}"),X[4]&&(re+="}"),re}).join("")},W.i=function(X,re,Ke,st,pt){typeof X=="string"&&(X=[[null,X,void 0]]);var rt={};if(Ke)for(var Et=0;Et<this.length;Et++){var p=this[Et][0];p!=null&&(rt[p]=!0)}for(var Rt=0;Rt<X.length;Rt++){var xe=[].concat(X[Rt]);Ke&&rt[xe[0]]||(typeof pt<"u"&&(typeof xe[5]>"u"||(xe[1]="@layer".concat(xe[5].length>0?" ".concat(xe[5]):""," {").concat(xe[1],"}")),xe[5]=pt),re&&(xe[2]&&(xe[1]="@media ".concat(xe[2]," {").concat(xe[1],"}")),xe[2]=re),st&&(xe[4]?(xe[1]="@supports (".concat(xe[4],") {").concat(xe[1],"}"),xe[4]=st):xe[4]="".concat(st)),W.push(xe))}},W}}),"../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/getUrl.js":(Nt=>{Nt.exports=function(ue,W){return W||(W={}),ue&&(ue=String(ue.__esModule?ue.default:ue),/^['"].*['"]$/.test(ue)&&(ue=ue.slice(1,-1)),W.hash&&(ue+=W.hash),/["'() \t\n]|(%20)/.test(ue)||W.needQuotes?'"'.concat(ue.replace(/"/g,'\\"').replace(/\n/g,"\\n"),'"'):ue)}}),"../../../node_modules/.pnpm/css-loader@6.11.0_webpack@5.101.3/node_modules/css-loader/dist/runtime/noSourceMaps.js":(Nt=>{Nt.exports=function(ue){return ue[1]}}),"../../../node_modules/.pnpm/react@18.3.1/node_modules/react/cjs/react-jsx-runtime.production.min.js":((Nt,ue,W)=>{/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var W=Symbol.for("react.element"),nt=Symbol.for("react.portal"),X=Symbol.for("react.fragment"),re=Symbol.for("react.strict_mode"),Ke=Symbol.for("react.profiler"),st=Symbol.for("react.provider"),pt=Symbol.for("react.context"),rt=Symbol.for("react.forward_ref"),Et=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),Rt=Symbol.for("react.lazy"),xe=Symbol.iterator;function yt(B){return B===null||typeof B!="object"?null:(B=xe&&B[xe]||B["@@iterator"],typeof B=="function"?B:null)}var He={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},he=Object.assign,De={};function ze(B,ie,ot){this.props=B,this.context=ie,this.refs=De,this.updater=ot||He}ze.prototype.isReactComponent={},ze.prototype.setState=function(B,ie){if(typeof B!="object"&&typeof B!="function"&&B!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,B,ie,"setState")},ze.prototype.forceUpdate=function(B){this.updater.enqueueForceUpdate(this,B,"forceUpdate")};function Le(){}Le.prototype=ze.prototype;function et(B,ie,ot){this.props=B,this.context=ie,this.refs=De,this.updater=ot||He}var kt=et.prototype=new Le;kt.constructor=et,he(kt,ze.prototype),kt.isPureReactComponent=!0;var $t=Array.isArray,xt=Object.prototype.hasOwnProperty,We={current:null},tt={key:!0,ref:!0,__self:!0,__source:!0};function Ne(B,ie,ot){var Ie,lt={},dt=null,Pt=null;if(ie!=null)for(Ie in ie.ref!==void 0&&(Pt=ie.ref),ie.key!==void 0&&(dt=""+ie.key),ie)xt.call(ie,Ie)&&!tt.hasOwnProperty(Ie)&&(lt[Ie]=ie[Ie]);var It=arguments.length-2;if(It===1)lt.children=ot;else if(1<It){for(var Jt=Array(It),io=0;io<It;io++)Jt[io]=arguments[io+2];lt.children=Jt}if(B&&B.defaultProps)for(Ie in It=B.defaultProps,It)lt[Ie]===void 0&&(lt[Ie]=It[Ie]);return{$$typeof:W,type:B,key:dt,ref:Pt,props:lt,_owner:We.current}}function wt(B,ie){return{$$typeof:W,type:B.type,key:ie,ref:B.ref,props:B.props,_owner:B._owner}}function Bt(B){return typeof B=="object"&&B!==null&&B.$$typeof===W}function Oe(B){var ie={"=":"=0",":":"=2"};return"$"+B.replace(/[=:]/g,function(ot){return ie[ot]})}var ae=/\/+/g;function ve(B,ie){return typeof B=="object"&&B!==null&&B.key!=null?Oe(""+B.key):ie.toString(36)}function Be(B,ie,ot,Ie,lt){var dt=typeof B;(dt==="undefined"||dt==="boolean")&&(B=null);var Pt=!1;if(B===null)Pt=!0;else switch(dt){case"string":case"number":Pt=!0;break;case"object":switch(B.$$typeof){case W:case nt:Pt=!0}}if(Pt)return Pt=B,lt=lt(Pt),B=Ie===""?"."+ve(Pt,0):Ie,$t(lt)?(ot="",B!=null&&(ot=B.replace(ae,"$&/")+"/"),Be(lt,ie,ot,"",function(io){return io})):lt!=null&&(Bt(lt)&&(lt=wt(lt,ot+(!lt.key||Pt&&Pt.key===lt.key?"":(""+lt.key).replace(ae,"$&/")+"/")+B)),ie.push(lt)),1;if(Pt=0,Ie=Ie===""?".":Ie+":",$t(B))for(var It=0;It<B.length;It++){dt=B[It];var Jt=Ie+ve(dt,It);Pt+=Be(dt,ie,ot,Jt,lt)}else if(Jt=yt(B),typeof Jt=="function")for(B=Jt.call(B),It=0;!(dt=B.next()).done;)dt=dt.value,Jt=Ie+ve(dt,It++),Pt+=Be(dt,ie,ot,Jt,lt);else if(dt==="object")throw ie=String(B),Error("Objects are not valid as a React child (found: "+(ie==="[object Object]"?"object with keys {"+Object.keys(B).join(", ")+"}":ie)+"). If you meant to render a collection of children, use an array instead.");return Pt}function Qe(B,ie,ot){if(B==null)return B;var Ie=[],lt=0;return Be(B,Ie,"","",function(dt){return ie.call(ot,dt,lt++)}),Ie}function At(B){if(B._status===-1){var ie=B._result;ie=ie(),ie.then(function(ot){(B._status===0||B._status===-1)&&(B._status=1,B._result=ot)},function(ot){(B._status===0||B._status===-1)&&(B._status=2,B._result=ot)}),B._status===-1&&(B._status=0,B._result=ie)}if(B._status===1)return B._result.default;throw B._result}var Pe={current:null},jt={transition:null},it={ReactCurrentDispatcher:Pe,ReactCurrentBatchConfig:jt,ReactCurrentOwner:We};function Ge(){throw Error("act(...) is not supported in production builds of React.")}ue.Children={map:Qe,forEach:function(B,ie,ot){Qe(B,function(){ie.apply(this,arguments)},ot)},count:function(B){var ie=0;return Qe(B,function(){ie++}),ie},toArray:function(B){return Qe(B,function(ie){return ie})||[]},only:function(B){if(!Bt(B))throw Error("React.Children.only expected to receive a single React element child.");return B}},ue.Component=ze,ue.Fragment=X,ue.Profiler=Ke,ue.PureComponent=et,ue.StrictMode=re,ue.Suspense=Et,ue.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=it,ue.act=Ge,ue.cloneElement=function(B,ie,ot){if(B==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+B+".");var Ie=he({},B.props),lt=B.key,dt=B.ref,Pt=B._owner;if(ie!=null){if(ie.ref!==void 0&&(dt=ie.ref,Pt=We.current),ie.key!==void 0&&(lt=""+ie.key),B.type&&B.type.defaultProps)var It=B.type.defaultProps;for(Jt in ie)xt.call(ie,Jt)&&!tt.hasOwnProperty(Jt)&&(Ie[Jt]=ie[Jt]===void 0&&It!==void 0?It[Jt]:ie[Jt])}var Jt=arguments.length-2;if(Jt===1)Ie.children=ot;else if(1<Jt){It=Array(Jt);for(var io=0;io<Jt;io++)It[io]=arguments[io+2];Ie.children=It}return{$$typeof:W,type:B.type,key:lt,ref:dt,props:Ie,_owner:Pt}},ue.createContext=function(B){return B={$$typeof:pt,_currentValue:B,_currentValue2:B,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},B.Provider={$$typeof:st,_context:B},B.Consumer=B},ue.createElement=Ne,ue.createFactory=function(B){var ie=Ne.bind(null,B);return ie.type=B,ie},ue.createRef=function(){return{current:null}},ue.forwardRef=function(B){return{$$typeof:rt,render:B}},ue.isValidElement=Bt,ue.lazy=function(B){return{$$typeof:Rt,_payload:{_status:-1,_result:B},_init:At}},ue.memo=function(B,ie){return{$$typeof:p,type:B,compare:ie===void 0?null:ie}},ue.startTransition=function(B){var ie=jt.transition;jt.transition={};try{B()}finally{jt.transition=ie}},ue.unstable_act=Ge,ue.useCallback=function(B,ie){return Pe.current.useCallback(B,ie)},ue.useContext=function(B){return Pe.current.useContext(B)},ue.useDebugValue=function(){},ue.useDeferredValue=function(B){return Pe.current.useDeferredValue(B)},ue.useEffect=function(B,ie){return Pe.current.useEffect(B,ie)},ue.useId=function(){return Pe.current.useId()},ue.useImperativeHandle=function(B,ie,ot){return Pe.current.useImperativeHandle(B,ie,ot)},ue.useInsertionEffect=function(B,ie){return Pe.current.useInsertionEffect(B,ie)},ue.useLayoutEffect=function(B,ie){return Pe.current.useLayoutEffect(B,ie)},ue.useMemo=function(B,ie){return Pe.current.useMemo(B,ie)},ue.useReducer=function(B,ie,ot){return Pe.current.useReducer(B,ie,ot)},ue.useRef=function(B){return Pe.current.useRef(B)},ue.useState=function(B){return Pe.current.useState(B)},ue.useSyncExternalStore=function(B,ie,ot){return Pe.current.useSyncExternalStore(B,ie,ot)},ue.useTransition=function(){return Pe.current.useTransition()},ue.version="18.3.1"}),"../../../node_modules/.pnpm/react@18.3.1/node_modules/react/index.js":((Nt,ue,W)=>{Nt.exports=W("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/cjs/react.production.min.js")}),"../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js":((Nt,ue,W)=>{Nt.exports=W("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/cjs/react-jsx-runtime.production.min.js")}),"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/csf/index.js":((Nt,ue,W)=>{W.d(ue,{aj:()=>$t,bU:()=>Le,hX:()=>ze});var nt=Object.create,X=Object.defineProperty,re=Object.getOwnPropertyDescriptor,Ke=Object.getOwnPropertyNames,st=Object.getPrototypeOf,pt=Object.prototype.hasOwnProperty,rt=(ae,ve)=>X(ae,"name",{value:ve,configurable:!0}),Et=(ae,ve)=>()=>(ve||ae((ve={exports:{}}).exports,ve),ve.exports),p=(ae,ve,Be,Qe)=>{if(ve&&typeof ve=="object"||typeof ve=="function")for(let At of Ke(ve))!pt.call(ae,At)&&At!==Be&&X(ae,At,{get:()=>ve[At],enumerable:!(Qe=re(ve,At))||Qe.enumerable});return ae},Rt=(ae,ve,Be)=>(Be=ae!=null?nt(st(ae)):{},p(ve||!ae||!ae.__esModule?X(Be,"default",{value:ae,enumerable:!0}):Be,ae)),xe=Et(ae=>{Object.defineProperty(ae,"__esModule",{value:!0}),ae.isEqual=(function(){var ve=Object.prototype.toString,Be=Object.getPrototypeOf,Qe=Object.getOwnPropertySymbols?function(At){return Object.keys(At).concat(Object.getOwnPropertySymbols(At))}:Object.keys;return function(At,Pe){return rt(function jt(it,Ge,B){var ie,ot,Ie,lt=ve.call(it),dt=ve.call(Ge);if(it===Ge)return!0;if(it==null||Ge==null)return!1;if(B.indexOf(it)>-1&&B.indexOf(Ge)>-1)return!0;if(B.push(it,Ge),lt!=dt||(ie=Qe(it),ot=Qe(Ge),ie.length!=ot.length||ie.some(function(Pt){return!jt(it[Pt],Ge[Pt],B)})))return!1;switch(lt.slice(8,-1)){case"Symbol":return it.valueOf()==Ge.valueOf();case"Date":case"Number":return+it==+Ge||+it!=+it&&+Ge!=+Ge;case"RegExp":case"Function":case"String":case"Boolean":return""+it==""+Ge;case"Set":case"Map":ie=it.entries(),ot=Ge.entries();do if(!jt((Ie=ie.next()).value,ot.next().value,B))return!1;while(!Ie.done);return!0;case"ArrayBuffer":it=new Uint8Array(it),Ge=new Uint8Array(Ge);case"DataView":it=new Uint8Array(it.buffer),Ge=new Uint8Array(Ge.buffer);case"Float32Array":case"Float64Array":case"Int8Array":case"Int16Array":case"Int32Array":case"Uint8Array":case"Uint16Array":case"Uint32Array":case"Uint8ClampedArray":case"Arguments":case"Array":if(it.length!=Ge.length)return!1;for(Ie=0;Ie<it.length;Ie++)if((Ie in it||Ie in Ge)&&(Ie in it!=Ie in Ge||!jt(it[Ie],Ge[Ie],B)))return!1;return!0;case"Object":return jt(Be(it),Be(Ge),B);default:return!1}},"n")(At,Pe,[])}})()});function yt(ae){return ae.replace(/_/g," ").replace(/-/g," ").replace(/\./g," ").replace(/([^\n])([A-Z])([a-z])/g,(ve,Be,Qe,At)=>`${Be} ${Qe}${At}`).replace(/([a-z])([A-Z])/g,(ve,Be,Qe)=>`${Be} ${Qe}`).replace(/([a-z])([0-9])/gi,(ve,Be,Qe)=>`${Be} ${Qe}`).replace(/([0-9])([a-z])/gi,(ve,Be,Qe)=>`${Be} ${Qe}`).replace(/(\s|^)(\w)/g,(ve,Be,Qe)=>`${Be}${Qe.toUpperCase()}`).replace(/ +/g," ").trim()}rt(yt,"toStartCaseStr");var He=Rt(xe(),1),he=rt(ae=>ae.map(ve=>typeof ve<"u").filter(Boolean).length,"count"),De=rt((ae,ve)=>{let{exists:Be,eq:Qe,neq:At,truthy:Pe}=ae;if(he([Be,Qe,At,Pe])>1)throw new Error(`Invalid conditional test ${JSON.stringify({exists:Be,eq:Qe,neq:At})}`);if(typeof Qe<"u")return(0,He.isEqual)(ve,Qe);if(typeof At<"u")return!(0,He.isEqual)(ve,At);if(typeof Be<"u"){let jt=typeof ve<"u";return Be?jt:!jt}return typeof Pe>"u"||Pe?!!ve:!ve},"testValue"),ze=rt((ae,ve,Be)=>{if(!ae.if)return!0;let{arg:Qe,global:At}=ae.if;if(he([Qe,At])!==1)throw new Error(`Invalid conditional value ${JSON.stringify({arg:Qe,global:At})}`);let Pe=Qe?ve[Qe]:Be[At];return De(ae.if,Pe)},"includeConditionalArg");function Le(ae){return ae!=null&&typeof ae=="object"&&"_tag"in ae&&ae?._tag==="Preview"}rt(Le,"isPreview");function et(ae){return ae!=null&&typeof ae=="object"&&"_tag"in ae&&ae?._tag==="Meta"}rt(et,"isMeta");function kt(ae){return ae!=null&&typeof ae=="object"&&"_tag"in ae&&ae?._tag==="Story"}rt(kt,"isStory");var $t=rt(ae=>ae.toLowerCase().replace(/[ ’–—―′¿'`~!@#$%^&*()_|+\-=?;:'",.<>\{\}\[\]\\\/]/gi,"-").replace(/-+/g,"-").replace(/^-+/,"").replace(/-+$/,""),"sanitize"),xt=null,We=null,tt=null;function Ne(ae,ve){return Array.isArray(ve)?ve.includes(ae):ae.match(ve)}rt(Ne,"matches");function wt(ae,{includeStories:ve,excludeStories:Be}){return ae!=="__esModule"&&(!ve||Ne(ae,ve))&&(!Be||!Ne(ae,Be))}rt(wt,"isExportStory");var Bt=null,Oe=null}),"../../../node_modules/.pnpm/storybook@9.0.15_@testing-library+dom@10.4.0/node_modules/storybook/dist/docs-tools/index.js":((Nt,ue,W)=>{W.d(ue,{C2:()=>Xn,Op:()=>Hn,Sy:()=>Ze,TQ:()=>Pe,UO:()=>it,Ux:()=>Ee,Y1:()=>In,YF:()=>ve,i3:()=>oe,p6:()=>gn,rl:()=>Ht});var nt=W("storybook/internal/preview-errors"),X=W.n(nt),re=Object.create,Ke=Object.defineProperty,st=Object.getOwnPropertyDescriptor,pt=Object.getOwnPropertyNames,rt=Object.getPrototypeOf,Et=Object.prototype.hasOwnProperty,p=(m,w)=>Ke(m,"name",{value:w,configurable:!0}),Rt=(m,w)=>()=>(w||m((w={exports:{}}).exports,w),w.exports),xe=(m,w,O,ee)=>{if(w&&typeof w=="object"||typeof w=="function")for(let $ of pt(w))!Et.call(m,$)&&$!==O&&Ke(m,$,{get:()=>w[$],enumerable:!(ee=st(w,$))||ee.enumerable});return m},yt=(m,w,O)=>(O=m!=null?re(rt(m)):{},xe(w||!m||!m.__esModule?Ke(O,"default",{value:m,enumerable:!0}):O,m)),He=Rt((m,w)=>{(function(O,ee){typeof m=="object"&&typeof w<"u"?ee(m):typeof define=="function"&&W.amdO?define(["exports"],ee):(O=typeof globalThis<"u"?globalThis:O||self,ee(O.jtpp={}))})(m,function(O){"use strict";function ee(n){return n.text!==void 0&&n.text!==""?`'${n.type}' with value '${n.text}'`:`'${n.type}'`}p(ee,"tokenToString");let $=class ci extends Error{constructor(c){super(`No parslet found for token: ${ee(c)}`),this.token=c,Object.setPrototypeOf(this,ci.prototype)}getToken(){return this.token}};p($,"NoParsletFoundError");let de=$,Ve=class pi extends Error{constructor(c){super(`The parsing ended early. The next token was: ${ee(c)}`),this.token=c,Object.setPrototypeOf(this,pi.prototype)}getToken(){return this.token}};p(Ve,"EarlyEndOfParseError");let Se=Ve,vt=class ui extends Error{constructor(c,_){let q=`Unexpected type: '${c.type}'.`;_!==void 0&&(q+=` Message: ${_}`),super(q),Object.setPrototypeOf(this,ui.prototype)}};p(vt,"UnexpectedTypeError");let Wt=vt;function ht(n){return c=>c.startsWith(n)?{type:n,text:n}:null}p(ht,"makePunctuationRule");function On(n){let c=0,_,q=n[0],ke=!1;if(q!=="'"&&q!=='"')return null;for(;c<n.length;){if(c++,_=n[c],!ke&&_===q){c++;break}ke=!ke&&_==="\\"}if(_!==q)throw new Error("Unterminated String");return n.slice(0,c)}p(On,"getQuoted");let fn=new RegExp("[$_\\p{ID_Start}]|\\\\u\\p{Hex_Digit}{4}|\\\\u\\{0*(?:\\p{Hex_Digit}{1,5}|10\\p{Hex_Digit}{4})\\}","u"),kn=new RegExp("[$\\-\\p{ID_Continue}\\u200C\\u200D]|\\\\u\\p{Hex_Digit}{4}|\\\\u\\{0*(?:\\p{Hex_Digit}{1,5}|10\\p{Hex_Digit}{4})\\}","u");function _n(n){let c=n[0];if(!fn.test(c))return null;let _=1;do{if(c=n[_],!kn.test(c))break;_++}while(_<n.length);return n.slice(0,_)}p(_n,"getIdentifier");let Yn=/^(NaN|-?((\d*\.\d+|\d+)([Ee][+-]?\d+)?|Infinity))/;function an(n){var c,_;return(_=(c=Yn.exec(n))===null||c===void 0?void 0:c[0])!==null&&_!==void 0?_:null}p(an,"getNumber");let wn=p(n=>{let c=_n(n);return c==null?null:{type:"Identifier",text:c}},"identifierRule");function ao(n){return c=>{if(!c.startsWith(n))return null;let _=c[n.length];return _!==void 0&&kn.test(_)?null:{type:n,text:n}}}p(ao,"makeKeyWordRule");let Ir=p(n=>{let c=On(n);return c==null?null:{type:"StringValue",text:c}},"stringValueRule"),sn=p(n=>n.length>0?null:{type:"EOF",text:""},"eofRule"),ln=p(n=>{let c=an(n);return c===null?null:{type:"Number",text:c}},"numberRule"),Or=[sn,ht("=>"),ht("("),ht(")"),ht("{"),ht("}"),ht("["),ht("]"),ht("|"),ht("&"),ht("<"),ht(">"),ht(","),ht(";"),ht("*"),ht("?"),ht("!"),ht("="),ht(":"),ht("..."),ht("."),ht("#"),ht("~"),ht("/"),ht("@"),ao("undefined"),ao("null"),ao("function"),ao("this"),ao("new"),ao("module"),ao("event"),ao("external"),ao("typeof"),ao("keyof"),ao("readonly"),ao("import"),ao("is"),ao("in"),ao("asserts"),ln,wn,Ir],Nr=/^\s*\n\s*/,Qn=class Tr{static create(c){let _=this.read(c);c=_.text;let q=this.read(c);return c=q.text,new Tr(c,void 0,_.token,q.token)}constructor(c,_,q,ke){this.text="",this.text=c,this.previous=_,this.current=q,this.next=ke}static read(c,_=!1){_=_||Nr.test(c),c=c.trim();for(let q of Or){let ke=q(c);if(ke!==null){let Ue=Object.assign(Object.assign({},ke),{startOfLine:_});return c=c.slice(Ue.text.length),{text:c,token:Ue}}}throw new Error("Unexpected Token "+c)}advance(){let c=Tr.read(this.text);return new Tr(c.text,this.current,this.next,c.token)}};p(Qn,"Lexer");let Rr=Qn;function Yt(n){if(n===void 0)throw new Error("Unexpected undefined");if(n.type==="JsdocTypeKeyValue"||n.type==="JsdocTypeParameterList"||n.type==="JsdocTypeProperty"||n.type==="JsdocTypeReadonlyProperty"||n.type==="JsdocTypeObjectField"||n.type==="JsdocTypeJsdocObjectField"||n.type==="JsdocTypeIndexSignature"||n.type==="JsdocTypeMappedType")throw new Wt(n);return n}p(Yt,"assertRootResult");function Eo(n){return n.type==="JsdocTypeKeyValue"?yn(n):Yt(n)}p(Eo,"assertPlainKeyValueOrRootResult");function Nn(n){return n.type==="JsdocTypeName"?n:yn(n)}p(Nn,"assertPlainKeyValueOrNameResult");function yn(n){if(n.type!=="JsdocTypeKeyValue")throw new Wt(n);return n}p(yn,"assertPlainKeyValueResult");function Zn(n){var c;if(n.type==="JsdocTypeVariadic"){if(((c=n.element)===null||c===void 0?void 0:c.type)==="JsdocTypeName")return n;throw new Wt(n)}if(n.type!=="JsdocTypeNumber"&&n.type!=="JsdocTypeName")throw new Wt(n);return n}p(Zn,"assertNumberOrVariadicNameResult");function Rn(n){return n.type==="JsdocTypeIndexSignature"||n.type==="JsdocTypeMappedType"}p(Rn,"isSquaredProperty");var ct;(function(n){n[n.ALL=0]="ALL",n[n.PARAMETER_LIST=1]="PARAMETER_LIST",n[n.OBJECT=2]="OBJECT",n[n.KEY_VALUE=3]="KEY_VALUE",n[n.INDEX_BRACKETS=4]="INDEX_BRACKETS",n[n.UNION=5]="UNION",n[n.INTERSECTION=6]="INTERSECTION",n[n.PREFIX=7]="PREFIX",n[n.INFIX=8]="INFIX",n[n.TUPLE=9]="TUPLE",n[n.SYMBOL=10]="SYMBOL",n[n.OPTIONAL=11]="OPTIONAL",n[n.NULLABLE=12]="NULLABLE",n[n.KEY_OF_TYPE_OF=13]="KEY_OF_TYPE_OF",n[n.FUNCTION=14]="FUNCTION",n[n.ARROW=15]="ARROW",n[n.ARRAY_BRACKETS=16]="ARRAY_BRACKETS",n[n.GENERIC=17]="GENERIC",n[n.NAME_PATH=18]="NAME_PATH",n[n.PARENTHESIS=19]="PARENTHESIS",n[n.SPECIAL_TYPES=20]="SPECIAL_TYPES"})(ct||(ct={}));let br=class{constructor(c,_,q){this.grammar=c,typeof _=="string"?this._lexer=Rr.create(_):this._lexer=_,this.baseParser=q}get lexer(){return this._lexer}parse(){let c=this.parseType(ct.ALL);if(this.lexer.current.type!=="EOF")throw new Se(this.lexer.current);return c}parseType(c){return Yt(this.parseIntermediateType(c))}parseIntermediateType(c){let _=this.tryParslets(null,c);if(_===null)throw new de(this.lexer.current);return this.parseInfixIntermediateType(_,c)}parseInfixIntermediateType(c,_){let q=this.tryParslets(c,_);for(;q!==null;)c=q,q=this.tryParslets(c,_);return c}tryParslets(c,_){for(let q of this.grammar){let ke=q(this,_,c);if(ke!==null)return ke}return null}consume(c){return Array.isArray(c)||(c=[c]),c.includes(this.lexer.current.type)?(this._lexer=this.lexer.advance(),!0):!1}acceptLexerState(c){this._lexer=c.lexer}};p(br,"Parser");let Ho=br;function er(n){return n==="EOF"||n==="|"||n===","||n===")"||n===">"}p(er,"isQuestionMarkUnknownType");let xn=p((n,c,_)=>{let q=n.lexer.current.type,ke=n.lexer.next.type;return _==null&&q==="?"&&!er(ke)||_!=null&&q==="?"?(n.consume("?"),_==null?{type:"JsdocTypeNullable",element:n.parseType(ct.NULLABLE),meta:{position:"prefix"}}:{type:"JsdocTypeNullable",element:Yt(_),meta:{position:"suffix"}}):null},"nullableParslet");function Tt(n){let c=p((_,q,ke)=>{let Ue=_.lexer.current.type,_t=_.lexer.next.type;if(ke===null){if("parsePrefix"in n&&n.accept(Ue,_t))return n.parsePrefix(_)}else if("parseInfix"in n&&n.precedence>q&&n.accept(Ue,_t))return n.parseInfix(_,ke);return null},"parslet");return Object.defineProperty(c,"name",{value:n.name}),c}p(Tt,"composeParslet");let ge=Tt({name:"optionalParslet",accept:p(n=>n==="=","accept"),precedence:ct.OPTIONAL,parsePrefix:p(n=>(n.consume("="),{type:"JsdocTypeOptional",element:n.parseType(ct.OPTIONAL),meta:{position:"prefix"}}),"parsePrefix"),parseInfix:p((n,c)=>(n.consume("="),{type:"JsdocTypeOptional",element:Yt(c),meta:{position:"suffix"}}),"parseInfix")}),cn=Tt({name:"numberParslet",accept:p(n=>n==="Number","accept"),parsePrefix:p(n=>{let c=parseFloat(n.lexer.current.text);return n.consume("Number"),{type:"JsdocTypeNumber",value:c}},"parsePrefix")}),jr=Tt({name:"parenthesisParslet",accept:p(n=>n==="(","accept"),parsePrefix:p(n=>{if(n.consume("("),n.consume(")"))return{type:"JsdocTypeParameterList",elements:[]};let c=n.parseIntermediateType(ct.ALL);if(!n.consume(")"))throw new Error("Unterminated parenthesis");return c.type==="JsdocTypeParameterList"?c:c.type==="JsdocTypeKeyValue"?{type:"JsdocTypeParameterList",elements:[c]}:{type:"JsdocTypeParenthesis",element:Yt(c)}},"parsePrefix")}),vn=Tt({name:"specialTypesParslet",accept:p((n,c)=>n==="?"&&er(c)||n==="null"||n==="undefined"||n==="*","accept"),parsePrefix:p(n=>{if(n.consume("null"))return{type:"JsdocTypeNull"};if(n.consume("undefined"))return{type:"JsdocTypeUndefined"};if(n.consume("*"))return{type:"JsdocTypeAny"};if(n.consume("?"))return{type:"JsdocTypeUnknown"};throw new Error("Unacceptable token: "+n.lexer.current.text)},"parsePrefix")}),hr=Tt({name:"notNullableParslet",accept:p(n=>n==="!","accept"),precedence:ct.NULLABLE,parsePrefix:p(n=>(n.consume("!"),{type:"JsdocTypeNotNullable",element:n.parseType(ct.NULLABLE),meta:{position:"prefix"}}),"parsePrefix"),parseInfix:p((n,c)=>(n.consume("!"),{type:"JsdocTypeNotNullable",element:Yt(c),meta:{position:"suffix"}}),"parseInfix")});function tr({allowTrailingComma:n}){return Tt({name:"parameterListParslet",accept:p(c=>c===",","accept"),precedence:ct.PARAMETER_LIST,parseInfix:p((c,_)=>{let q=[Eo(_)];c.consume(",");do try{let ke=c.parseIntermediateType(ct.PARAMETER_LIST);q.push(Eo(ke))}catch(ke){if(n&&ke instanceof de)break;throw ke}while(c.consume(","));if(q.length>0&&q.slice(0,-1).some(ke=>ke.type==="JsdocTypeVariadic"))throw new Error("Only the last parameter may be a rest parameter");return{type:"JsdocTypeParameterList",elements:q}},"parseInfix")})}p(tr,"createParameterListParslet");let zr=Tt({name:"genericParslet",accept:p((n,c)=>n==="<"||n==="."&&c==="<","accept"),precedence:ct.GENERIC,parseInfix:p((n,c)=>{let _=n.consume(".");n.consume("<");let q=[];do q.push(n.parseType(ct.PARAMETER_LIST));while(n.consume(","));if(!n.consume(">"))throw new Error("Unterminated generic parameter list");return{type:"JsdocTypeGeneric",left:Yt(c),elements:q,meta:{brackets:"angle",dot:_}}},"parseInfix")}),Lr=Tt({name:"unionParslet",accept:p(n=>n==="|","accept"),precedence:ct.UNION,parseInfix:p((n,c)=>{n.consume("|");let _=[];do _.push(n.parseType(ct.UNION));while(n.consume("|"));return{type:"JsdocTypeUnion",elements:[Yt(c),..._]}},"parseInfix")}),or=[xn,ge,cn,jr,vn,hr,tr({allowTrailingComma:!0}),zr,Lr,ge];function En({allowSquareBracketsOnAnyType:n,allowJsdocNamePaths:c,pathGrammar:_}){return p(function(q,ke,Ue){if(Ue==null||ke>=ct.NAME_PATH)return null;let _t=q.lexer.current.type,Qt=q.lexer.next.type;if(!(_t==="."&&Qt!=="<"||_t==="["&&(n||Ue.type==="JsdocTypeName")||c&&(_t==="~"||_t==="#")))return null;let Zt,ho=!1;q.consume(".")?Zt="property":q.consume("[")?(Zt="property-brackets",ho=!0):q.consume("~")?Zt="inner":(q.consume("#"),Zt="instance");let zo=_!==null?new Ho(_,q.lexer,q):q,Ao=zo.parseIntermediateType(ct.NAME_PATH);q.acceptLexerState(zo);let Fn;switch(Ao.type){case"JsdocTypeName":Fn={type:"JsdocTypeProperty",value:Ao.value,meta:{quote:void 0}};break;case"JsdocTypeNumber":Fn={type:"JsdocTypeProperty",value:Ao.value.toString(10),meta:{quote:void 0}};break;case"JsdocTypeStringValue":Fn={type:"JsdocTypeProperty",value:Ao.value,meta:{quote:Ao.meta.quote}};break;case"JsdocTypeSpecialNamePath":if(Ao.specialType==="event")Fn=Ao;else throw new Wt(Ao,"Type 'JsdocTypeSpecialNamePath' is only allowed with specialType 'event'");break;default:throw new Wt(Ao,"Expecting 'JsdocTypeName', 'JsdocTypeNumber', 'JsdocStringValue' or 'JsdocTypeSpecialNamePath'")}if(ho&&!q.consume("]")){let pr=q.lexer.current;throw new Error(`Unterminated square brackets. Next token is '${pr.type}' with text '${pr.text}'`)}return{type:"JsdocTypeNamePath",left:Yt(Ue),right:Fn,pathType:Zt}},"namePathParslet")}p(En,"createNamePathParslet");function Ro({allowedAdditionalTokens:n}){return Tt({name:"nameParslet",accept:p(c=>c==="Identifier"||c==="this"||c==="new"||n.includes(c),"accept"),parsePrefix:p(c=>{let{type:_,text:q}=c.lexer.current;return c.consume(_),{type:"JsdocTypeName",value:q}},"parsePrefix")})}p(Ro,"createNameParslet");let An=Tt({name:"stringValueParslet",accept:p(n=>n==="StringValue","accept"),parsePrefix:p(n=>{let c=n.lexer.current.text;return n.consume("StringValue"),{type:"JsdocTypeStringValue",value:c.slice(1,-1),meta:{quote:c[0]==="'"?"single":"double"}}},"parsePrefix")});function pn({pathGrammar:n,allowedTypes:c}){return Tt({name:"specialNamePathParslet",accept:p(_=>c.includes(_),"accept"),parsePrefix:p(_=>{let q=_.lexer.current.type;if(_.consume(q),!_.consume(":"))return{type:"JsdocTypeName",value:q};let ke,Ue=_.lexer.current;if(_.consume("StringValue"))ke={type:"JsdocTypeSpecialNamePath",value:Ue.text.slice(1,-1),specialType:q,meta:{quote:Ue.text[0]==="'"?"single":"double"}};else{let Zt="",ho=["Identifier","@","/"];for(;ho.some(zo=>_.consume(zo));)Zt+=Ue.text,Ue=_.lexer.current;ke={type:"JsdocTypeSpecialNamePath",value:Zt,specialType:q,meta:{quote:void 0}}}let _t=new Ho(n,_.lexer,_),Qt=_t.parseInfixIntermediateType(ke,ct.ALL);return _.acceptLexerState(_t),Yt(Qt)},"parsePrefix")})}p(pn,"createSpecialNamePathParslet");let gr=[Ro({allowedAdditionalTokens:["external","module"]}),An,cn,En({allowSquareBracketsOnAnyType:!1,allowJsdocNamePaths:!0,pathGrammar:null})],un=[...gr,pn({allowedTypes:["event"],pathGrammar:gr})];function jn(n){let c;if(n.type==="JsdocTypeParameterList")c=n.elements;else if(n.type==="JsdocTypeParenthesis")c=[n.element];else throw new Wt(n);return c.map(_=>Eo(_))}p(jn,"getParameters");function jo(n){let c=jn(n);if(c.some(_=>_.type==="JsdocTypeKeyValue"))throw new Error("No parameter should be named");return c}p(jo,"getUnnamedParameters");function zn({allowNamedParameters:n,allowNoReturnType:c,allowWithoutParenthesis:_,allowNewAsFunctionKeyword:q}){return Tt({name:"functionParslet",accept:p((ke,Ue)=>ke==="function"||q&&ke==="new"&&Ue==="(","accept"),parsePrefix:p(ke=>{let Ue=ke.consume("new");ke.consume("function");let _t=ke.lexer.current.type==="(";if(!_t){if(!_)throw new Error("function is missing parameter list");return{type:"JsdocTypeName",value:"function"}}let Qt={type:"JsdocTypeFunction",parameters:[],arrow:!1,constructor:Ue,parenthesis:_t},Zt=ke.parseIntermediateType(ct.FUNCTION);if(n===void 0)Qt.parameters=jo(Zt);else{if(Ue&&Zt.type==="JsdocTypeFunction"&&Zt.arrow)return Qt=Zt,Qt.constructor=!0,Qt;Qt.parameters=jn(Zt);for(let ho of Qt.parameters)if(ho.type==="JsdocTypeKeyValue"&&!n.includes(ho.key))throw new Error(`only allowed named parameters are ${n.join(", ")} but got ${ho.type}`)}if(ke.consume(":"))Qt.returnType=ke.parseType(ct.PREFIX);else if(!c)throw new Error("function is missing return type");return Qt},"parsePrefix")})}p(zn,"createFunctionParslet");function dn({allowPostfix:n,allowEnclosingBrackets:c}){return Tt({name:"variadicParslet",accept:p(_=>_==="...","accept"),precedence:ct.PREFIX,parsePrefix:p(_=>{_.consume("...");let q=c&&_.consume("[");try{let ke=_.parseType(ct.PREFIX);if(q&&!_.consume("]"))throw new Error("Unterminated variadic type. Missing ']'");return{type:"JsdocTypeVariadic",element:Yt(ke),meta:{position:"prefix",squareBrackets:q}}}catch(ke){if(ke instanceof de){if(q)throw new Error("Empty square brackets for variadic are not allowed.");return{type:"JsdocTypeVariadic",meta:{position:void 0,squareBrackets:!1}}}else throw ke}},"parsePrefix"),parseInfix:n?(_,q)=>(_.consume("..."),{type:"JsdocTypeVariadic",element:Yt(q),meta:{position:"suffix",squareBrackets:!1}}):void 0})}p(dn,"createVariadicParslet");let nr=Tt({name:"symbolParslet",accept:p(n=>n==="(","accept"),precedence:ct.SYMBOL,parseInfix:p((n,c)=>{if(c.type!=="JsdocTypeName")throw new Error("Symbol expects a name on the left side. (Reacting on '(')");n.consume("(");let _={type:"JsdocTypeSymbol",value:c.value};if(!n.consume(")")){let q=n.parseIntermediateType(ct.SYMBOL);if(_.element=Zn(q),!n.consume(")"))throw new Error("Symbol does not end after value")}return _},"parseInfix")}),rr=Tt({name:"arrayBracketsParslet",precedence:ct.ARRAY_BRACKETS,accept:p((n,c)=>n==="["&&c==="]","accept"),parseInfix:p((n,c)=>(n.consume("["),n.consume("]"),{type:"JsdocTypeGeneric",left:{type:"JsdocTypeName",value:"Array"},elements:[Yt(c)],meta:{brackets:"square",dot:!1}}),"parseInfix")});function mn({objectFieldGrammar:n,allowKeyTypes:c}){return Tt({name:"objectParslet",accept:p(_=>_==="{","accept"),parsePrefix:p(_=>{_.consume("{");let q={type:"JsdocTypeObject",meta:{separator:"comma"},elements:[]};if(!_.consume("}")){let ke,Ue=new Ho(n,_.lexer,_);for(;;){Ue.acceptLexerState(_);let _t=Ue.parseIntermediateType(ct.OBJECT);_.acceptLexerState(Ue),_t===void 0&&c&&(_t=_.parseIntermediateType(ct.OBJECT));let Qt=!1;if(_t.type==="JsdocTypeNullable"&&(Qt=!0,_t=_t.element),_t.type==="JsdocTypeNumber"||_t.type==="JsdocTypeName"||_t.type==="JsdocTypeStringValue"){let Zt;_t.type==="JsdocTypeStringValue"&&(Zt=_t.meta.quote),q.elements.push({type:"JsdocTypeObjectField",key:_t.value.toString(),right:void 0,optional:Qt,readonly:!1,meta:{quote:Zt}})}else if(_t.type==="JsdocTypeObjectField"||_t.type==="JsdocTypeJsdocObjectField")q.elements.push(_t);else throw new Wt(_t);if(_.lexer.current.startOfLine)ke="linebreak";else if(_.consume(","))ke="comma";else if(_.consume(";"))ke="semicolon";else break;if(_.lexer.current.type==="}")break}if(q.meta.separator=ke??"comma",!_.consume("}"))throw new Error("Unterminated record type. Missing '}'")}return q},"parsePrefix")})}p(mn,"createObjectParslet");function Yo({allowSquaredProperties:n,allowKeyTypes:c,allowReadonly:_,allowOptional:q}){return Tt({name:"objectFieldParslet",precedence:ct.KEY_VALUE,accept:p(ke=>ke===":","accept"),parseInfix:p((ke,Ue)=>{var _t;let Qt=!1,Zt=!1;q&&Ue.type==="JsdocTypeNullable"&&(Qt=!0,Ue=Ue.element),_&&Ue.type==="JsdocTypeReadonlyProperty"&&(Zt=!0,Ue=Ue.element);let ho=(_t=ke.baseParser)!==null&&_t!==void 0?_t:ke;if(ho.acceptLexerState(ke),Ue.type==="JsdocTypeNumber"||Ue.type==="JsdocTypeName"||Ue.type==="JsdocTypeStringValue"||Rn(Ue)){if(Rn(Ue)&&!n)throw new Wt(Ue);ho.consume(":");let zo;Ue.type==="JsdocTypeStringValue"&&(zo=Ue.meta.quote);let Ao=ho.parseType(ct.KEY_VALUE);return ke.acceptLexerState(ho),{type:"JsdocTypeObjectField",key:Rn(Ue)?Ue:Ue.value.toString(),right:Ao,optional:Qt,readonly:Zt,meta:{quote:zo}}}else{if(!c)throw new Wt(Ue);ho.consume(":");let zo=ho.parseType(ct.KEY_VALUE);return ke.acceptLexerState(ho),{type:"JsdocTypeJsdocObjectField",left:Yt(Ue),right:zo}}},"parseInfix")})}p(Yo,"createObjectFieldParslet");function Dn({allowOptional:n,allowVariadic:c}){return Tt({name:"keyValueParslet",precedence:ct.KEY_VALUE,accept:p(_=>_===":","accept"),parseInfix:p((_,q)=>{let ke=!1,Ue=!1;if(n&&q.type==="JsdocTypeNullable"&&(ke=!0,q=q.element),c&&q.type==="JsdocTypeVariadic"&&q.element!==void 0&&(Ue=!0,q=q.element),q.type!=="JsdocTypeName")throw new Wt(q);_.consume(":");let _t=_.parseType(ct.KEY_VALUE);return{type:"JsdocTypeKeyValue",key:q.value,right:_t,optional:ke,variadic:Ue}},"parseInfix")})}p(Dn,"createKeyValueParslet");let fr=[...or,zn({allowWithoutParenthesis:!0,allowNamedParameters:["this","new"],allowNoReturnType:!0,allowNewAsFunctionKeyword:!1}),An,pn({allowedTypes:["module","external","event"],pathGrammar:un}),dn({allowEnclosingBrackets:!0,allowPostfix:!0}),Ro({allowedAdditionalTokens:["keyof"]}),nr,rr,En({allowSquareBracketsOnAnyType:!1,allowJsdocNamePaths:!0,pathGrammar:un})],Mr=[...fr,mn({objectFieldGrammar:[Ro({allowedAdditionalTokens:["module","in"]}),Yo({allowSquaredProperties:!1,allowKeyTypes:!0,allowOptional:!1,allowReadonly:!1}),...fr],allowKeyTypes:!0}),Dn({allowOptional:!0,allowVariadic:!0})],ir=Tt({name:"typeOfParslet",accept:p(n=>n==="typeof","accept"),parsePrefix:p(n=>(n.consume("typeof"),{type:"JsdocTypeTypeof",element:Yt(n.parseType(ct.KEY_OF_TYPE_OF))}),"parsePrefix")}),Jr=[Ro({allowedAdditionalTokens:["module","keyof","event","external","in"]}),xn,ge,An,cn,Yo({allowSquaredProperties:!1,allowKeyTypes:!1,allowOptional:!1,allowReadonly:!1})],kr=[...or,mn({allowKeyTypes:!1,objectFieldGrammar:Jr}),Ro({allowedAdditionalTokens:["event","external","in"]}),ir,zn({allowWithoutParenthesis:!1,allowNamedParameters:["this","new"],allowNoReturnType:!0,allowNewAsFunctionKeyword:!1}),dn({allowEnclosingBrackets:!1,allowPostfix:!1}),Ro({allowedAdditionalTokens:["keyof"]}),pn({allowedTypes:["module"],pathGrammar:un}),En({allowSquareBracketsOnAnyType:!1,allowJsdocNamePaths:!0,pathGrammar:un}),Dn({allowOptional:!1,allowVariadic:!1}),nr],Ur=Tt({name:"assertsParslet",accept:p(n=>n==="asserts","accept"),parsePrefix:p(n=>{n.consume("asserts");let c=n.parseIntermediateType(ct.SYMBOL);if(c.type!=="JsdocTypeName")throw new Wt(c,"A typescript asserts always has to have a name on the left side.");return n.consume("is"),{type:"JsdocTypeAsserts",left:c,right:Yt(n.parseIntermediateType(ct.INFIX))}},"parsePrefix")});function ar({allowQuestionMark:n}){return Tt({name:"tupleParslet",accept:p(c=>c==="[","accept"),parsePrefix:p(c=>{c.consume("[");let _={type:"JsdocTypeTuple",elements:[]};if(c.consume("]"))return _;let q=c.parseIntermediateType(ct.ALL);if(q.type==="JsdocTypeParameterList"?q.elements[0].type==="JsdocTypeKeyValue"?_.elements=q.elements.map(yn):_.elements=q.elements.map(Yt):q.type==="JsdocTypeKeyValue"?_.elements=[yn(q)]:_.elements=[Yt(q)],!c.consume("]"))throw new Error("Unterminated '['");if(!n&&_.elements.some(ke=>ke.type==="JsdocTypeUnknown"))throw new Error("Question mark in tuple not allowed");return _},"parsePrefix")})}p(ar,"createTupleParslet");let _r=Tt({name:"keyOfParslet",accept:p(n=>n==="keyof","accept"),parsePrefix:p(n=>(n.consume("keyof"),{type:"JsdocTypeKeyof",element:Yt(n.parseType(ct.KEY_OF_TYPE_OF))}),"parsePrefix")}),wr=Tt({name:"importParslet",accept:p(n=>n==="import","accept"),parsePrefix:p(n=>{if(n.consume("import"),!n.consume("("))throw new Error("Missing parenthesis after import keyword");let c=n.parseType(ct.PREFIX);if(c.type!=="JsdocTypeStringValue")throw new Error("Only string values are allowed as paths for imports");if(!n.consume(")"))throw new Error("Missing closing parenthesis after import keyword");return{type:"JsdocTypeImport",element:c}},"parsePrefix")}),Vr=Tt({name:"readonlyPropertyParslet",accept:p(n=>n==="readonly","accept"),parsePrefix:p(n=>(n.consume("readonly"),{type:"JsdocTypeReadonlyProperty",element:n.parseType(ct.KEY_VALUE)}),"parsePrefix")}),$r=Tt({name:"arrowFunctionParslet",precedence:ct.ARROW,accept:p(n=>n==="=>","accept"),parseInfix:p((n,c)=>(n.consume("=>"),{type:"JsdocTypeFunction",parameters:jn(c).map(Nn),arrow:!0,constructor:!1,parenthesis:!0,returnType:n.parseType(ct.OBJECT)}),"parseInfix")}),qr=Tt({name:"intersectionParslet",accept:p(n=>n==="&","accept"),precedence:ct.INTERSECTION,parseInfix:p((n,c)=>{n.consume("&");let _=[];do _.push(n.parseType(ct.INTERSECTION));while(n.consume("&"));return{type:"JsdocTypeIntersection",elements:[Yt(c),..._]}},"parseInfix")}),Wr=Tt({name:"predicateParslet",precedence:ct.INFIX,accept:p(n=>n==="is","accept"),parseInfix:p((n,c)=>{if(c.type!=="JsdocTypeName")throw new Wt(c,"A typescript predicate always has to have a name on the left side.");return n.consume("is"),{type:"JsdocTypePredicate",left:c,right:Yt(n.parseIntermediateType(ct.INFIX))}},"parseInfix")}),Gr=Tt({name:"objectSquareBracketPropertyParslet",accept:p(n=>n==="[","accept"),parsePrefix:p(n=>{if(n.baseParser===void 0)throw new Error("Only allowed inside object grammar");n.consume("[");let c=n.lexer.current.text;n.consume("Identifier");let _;if(n.consume(":")){let q=n.baseParser;q.acceptLexerState(n),_={type:"JsdocTypeIndexSignature",key:c,right:q.parseType(ct.INDEX_BRACKETS)},n.acceptLexerState(q)}else if(n.consume("in")){let q=n.baseParser;q.acceptLexerState(n),_={type:"JsdocTypeMappedType",key:c,right:q.parseType(ct.ARRAY_BRACKETS)},n.acceptLexerState(q)}else throw new Error("Missing ':' or 'in' inside square bracketed property.");if(!n.consume("]"))throw new Error("Unterminated square brackets");return _},"parsePrefix")}),yr=[Vr,Ro({allowedAdditionalTokens:["module","event","keyof","event","external","in"]}),xn,ge,An,cn,Yo({allowSquaredProperties:!0,allowKeyTypes:!1,allowOptional:!0,allowReadonly:!0}),Gr],Xr=[...or,mn({allowKeyTypes:!1,objectFieldGrammar:yr}),ir,_r,wr,An,zn({allowWithoutParenthesis:!0,allowNoReturnType:!1,allowNamedParameters:["this","new","args"],allowNewAsFunctionKeyword:!0}),ar({allowQuestionMark:!1}),dn({allowEnclosingBrackets:!1,allowPostfix:!1}),Ur,Ro({allowedAdditionalTokens:["event","external","in"]}),pn({allowedTypes:["module"],pathGrammar:un}),rr,$r,En({allowSquareBracketsOnAnyType:!0,allowJsdocNamePaths:!1,pathGrammar:un}),qr,Wr,Dn({allowVariadic:!0,allowOptional:!0})];function Ln(n,c){switch(c){case"closure":return new Ho(kr,n).parse();case"jsdoc":return new Ho(Mr,n).parse();case"typescript":return new Ho(Xr,n).parse()}}p(Ln,"parse");function xr(n,c=["typescript","closure","jsdoc"]){let _;for(let q of c)try{return Ln(n,q)}catch(ke){_=ke}throw _}p(xr,"tryParse");function bn(n,c){let _=n[c.type];if(_===void 0)throw new Error(`In this set of transform rules exists no rule for type ${c.type}.`);return _(c,q=>bn(n,q))}p(bn,"transform");function uo(n){throw new Error("This transform is not available. Are you trying the correct parsing mode?")}p(uo,"notAvailableTransform");function sr(n){let c={params:[]};for(let _ of n.parameters)_.type==="JsdocTypeKeyValue"?_.key==="this"?c.this=_.right:_.key==="new"?c.new=_.right:c.params.push(_):c.params.push(_);return c}p(sr,"extractSpecialParams");function no(n,c,_){return n==="prefix"?_+c:c+_}p(no,"applyPosition");function To(n,c){switch(c){case"double":return`"${n}"`;case"single":return`'${n}'`;case void 0:return n}}p(To,"quote");function Mn(){return{JsdocTypeParenthesis:p((n,c)=>`(${n.element!==void 0?c(n.element):""})`,"JsdocTypeParenthesis"),JsdocTypeKeyof:p((n,c)=>`keyof ${c(n.element)}`,"JsdocTypeKeyof"),JsdocTypeFunction:p((n,c)=>{if(n.arrow){if(n.returnType===void 0)throw new Error("Arrow function needs a return type.");let _=`(${n.parameters.map(c).join(", ")}) => ${c(n.returnType)}`;return n.constructor&&(_="new "+_),_}else{let _=n.constructor?"new":"function";return n.parenthesis&&(_+=`(${n.parameters.map(c).join(", ")})`,n.returnType!==void 0&&(_+=`: ${c(n.returnType)}`)),_}},"JsdocTypeFunction"),JsdocTypeName:p(n=>n.value,"JsdocTypeName"),JsdocTypeTuple:p((n,c)=>`[${n.elements.map(c).join(", ")}]`,"JsdocTypeTuple"),JsdocTypeVariadic:p((n,c)=>n.meta.position===void 0?"...":no(n.meta.position,c(n.element),"..."),"JsdocTypeVariadic"),JsdocTypeNamePath:p((n,c)=>{let _=c(n.left),q=c(n.right);switch(n.pathType){case"inner":return`${_}~${q}`;case"instance":return`${_}#${q}`;case"property":return`${_}.${q}`;case"property-brackets":return`${_}[${q}]`}},"JsdocTypeNamePath"),JsdocTypeStringValue:p(n=>To(n.value,n.meta.quote),"JsdocTypeStringValue"),JsdocTypeAny:p(()=>"*","JsdocTypeAny"),JsdocTypeGeneric:p((n,c)=>{if(n.meta.brackets==="square"){let _=n.elements[0],q=c(_);return _.type==="JsdocTypeUnion"||_.type==="JsdocTypeIntersection"?`(${q})[]`:`${q}[]`}else return`${c(n.left)}${n.meta.dot?".":""}<${n.elements.map(c).join(", ")}>`},"JsdocTypeGeneric"),JsdocTypeImport:p((n,c)=>`import(${c(n.element)})`,"JsdocTypeImport"),JsdocTypeObjectField:p((n,c)=>{let _="";return n.readonly&&(_+="readonly "),typeof n.key=="string"?_+=To(n.key,n.meta.quote):_+=c(n.key),n.optional&&(_+="?"),n.right===void 0?_:_+`: ${c(n.right)}`},"JsdocTypeObjectField"),JsdocTypeJsdocObjectField:p((n,c)=>`${c(n.left)}: ${c(n.right)}`,"JsdocTypeJsdocObjectField"),JsdocTypeKeyValue:p((n,c)=>{let _=n.key;return n.optional&&(_+="?"),n.variadic&&(_="..."+_),n.right===void 0?_:_+`: ${c(n.right)}`},"JsdocTypeKeyValue"),JsdocTypeSpecialNamePath:p(n=>`${n.specialType}:${To(n.value,n.meta.quote)}`,"JsdocTypeSpecialNamePath"),JsdocTypeNotNullable:p((n,c)=>no(n.meta.position,c(n.element),"!"),"JsdocTypeNotNullable"),JsdocTypeNull:p(()=>"null","JsdocTypeNull"),JsdocTypeNullable:p((n,c)=>no(n.meta.position,c(n.element),"?"),"JsdocTypeNullable"),JsdocTypeNumber:p(n=>n.value.toString(),"JsdocTypeNumber"),JsdocTypeObject:p((n,c)=>`{${n.elements.map(c).join((n.meta.separator==="comma"?",":";")+" ")}}`,"JsdocTypeObject"),JsdocTypeOptional:p((n,c)=>no(n.meta.position,c(n.element),"="),"JsdocTypeOptional"),JsdocTypeSymbol:p((n,c)=>`${n.value}(${n.element!==void 0?c(n.element):""})`,"JsdocTypeSymbol"),JsdocTypeTypeof:p((n,c)=>`typeof ${c(n.element)}`,"JsdocTypeTypeof"),JsdocTypeUndefined:p(()=>"undefined","JsdocTypeUndefined"),JsdocTypeUnion:p((n,c)=>n.elements.map(c).join(" | "),"JsdocTypeUnion"),JsdocTypeUnknown:p(()=>"?","JsdocTypeUnknown"),JsdocTypeIntersection:p((n,c)=>n.elements.map(c).join(" & "),"JsdocTypeIntersection"),JsdocTypeProperty:p(n=>To(n.value,n.meta.quote),"JsdocTypeProperty"),JsdocTypePredicate:p((n,c)=>`${c(n.left)} is ${c(n.right)}`,"JsdocTypePredicate"),JsdocTypeIndexSignature:p((n,c)=>`[${n.key}: ${c(n.right)}]`,"JsdocTypeIndexSignature"),JsdocTypeMappedType:p((n,c)=>`[${n.key} in ${c(n.right)}]`,"JsdocTypeMappedType"),JsdocTypeAsserts:p((n,c)=>`asserts ${c(n.left)} is ${c(n.right)}`,"JsdocTypeAsserts")}}p(Mn,"stringifyRules");let Jn=Mn();function lr(n){return bn(Jn,n)}p(lr,"stringify");let Kr=["null","true","false","break","case","catch","class","const","continue","debugger","default","delete","do","else","export","extends","finally","for","function","if","import","in","instanceof","new","return","super","switch","this","throw","try","typeof","var","void","while","with","yield"];function Bo(n){let c={type:"NameExpression",name:n};return Kr.includes(n)&&(c.reservedWord=!0),c}p(Bo,"makeName");let Hr={JsdocTypeOptional:p((n,c)=>{let _=c(n.element);return _.optional=!0,_},"JsdocTypeOptional"),JsdocTypeNullable:p((n,c)=>{let _=c(n.element);return _.nullable=!0,_},"JsdocTypeNullable"),JsdocTypeNotNullable:p((n,c)=>{let _=c(n.element);return _.nullable=!1,_},"JsdocTypeNotNullable"),JsdocTypeVariadic:p((n,c)=>{if(n.element===void 0)throw new Error("dots without value are not allowed in catharsis mode");let _=c(n.element);return _.repeatable=!0,_},"JsdocTypeVariadic"),JsdocTypeAny:p(()=>({type:"AllLiteral"}),"JsdocTypeAny"),JsdocTypeNull:p(()=>({type:"NullLiteral"}),"JsdocTypeNull"),JsdocTypeStringValue:p(n=>Bo(To(n.value,n.meta.quote)),"JsdocTypeStringValue"),JsdocTypeUndefined:p(()=>({type:"UndefinedLiteral"}),"JsdocTypeUndefined"),JsdocTypeUnknown:p(()=>({type:"UnknownLiteral"}),"JsdocTypeUnknown"),JsdocTypeFunction:p((n,c)=>{let _=sr(n),q={type:"FunctionType",params:_.params.map(c)};return _.this!==void 0&&(q.this=c(_.this)),_.new!==void 0&&(q.new=c(_.new)),n.returnType!==void 0&&(q.result=c(n.returnType)),q},"JsdocTypeFunction"),JsdocTypeGeneric:p((n,c)=>({type:"TypeApplication",applications:n.elements.map(_=>c(_)),expression:c(n.left)}),"JsdocTypeGeneric"),JsdocTypeSpecialNamePath:p(n=>Bo(n.specialType+":"+To(n.value,n.meta.quote)),"JsdocTypeSpecialNamePath"),JsdocTypeName:p(n=>n.value!=="function"?Bo(n.value):{type:"FunctionType",params:[]},"JsdocTypeName"),JsdocTypeNumber:p(n=>Bo(n.value.toString()),"JsdocTypeNumber"),JsdocTypeObject:p((n,c)=>{let _={type:"RecordType",fields:[]};for(let q of n.elements)q.type!=="JsdocTypeObjectField"&&q.type!=="JsdocTypeJsdocObjectField"?_.fields.push({type:"FieldType",key:c(q),value:void 0}):_.fields.push(c(q));return _},"JsdocTypeObject"),JsdocTypeObjectField:p((n,c)=>{if(typeof n.key!="string")throw new Error("Index signatures and mapped types are not supported");return{type:"FieldType",key:Bo(To(n.key,n.meta.quote)),value:n.right===void 0?void 0:c(n.right)}},"JsdocTypeObjectField"),JsdocTypeJsdocObjectField:p((n,c)=>({type:"FieldType",key:c(n.left),value:c(n.right)}),"JsdocTypeJsdocObjectField"),JsdocTypeUnion:p((n,c)=>({type:"TypeUnion",elements:n.elements.map(_=>c(_))}),"JsdocTypeUnion"),JsdocTypeKeyValue:p((n,c)=>({type:"FieldType",key:Bo(n.key),value:n.right===void 0?void 0:c(n.right)}),"JsdocTypeKeyValue"),JsdocTypeNamePath:p((n,c)=>{let _=c(n.left),q;n.right.type==="JsdocTypeSpecialNamePath"?q=c(n.right).name:q=To(n.right.value,n.right.meta.quote);let ke=n.pathType==="inner"?"~":n.pathType==="instance"?"#":".";return Bo(`${_.name}${ke}${q}`)},"JsdocTypeNamePath"),JsdocTypeSymbol:p(n=>{let c="",_=n.element,q=!1;return _?.type==="JsdocTypeVariadic"&&(_.meta.position==="prefix"?c="...":q=!0,_=_.element),_?.type==="JsdocTypeName"?c+=_.value:_?.type==="JsdocTypeNumber"&&(c+=_.value.toString()),q&&(c+="..."),Bo(`${n.value}(${c})`)},"JsdocTypeSymbol"),JsdocTypeParenthesis:p((n,c)=>c(Yt(n.element)),"JsdocTypeParenthesis"),JsdocTypeMappedType:uo,JsdocTypeIndexSignature:uo,JsdocTypeImport:uo,JsdocTypeKeyof:uo,JsdocTypeTuple:uo,JsdocTypeTypeof:uo,JsdocTypeIntersection:uo,JsdocTypeProperty:uo,JsdocTypePredicate:uo,JsdocTypeAsserts:uo};function vr(n){return bn(Hr,n)}p(vr,"catharsisTransform");function Mo(n){switch(n){case void 0:return"none";case"single":return"single";case"double":return"double"}}p(Mo,"getQuoteStyle");function Un(n){switch(n){case"inner":return"INNER_MEMBER";case"instance":return"INSTANCE_MEMBER";case"property":return"MEMBER";case"property-brackets":return"MEMBER"}}p(Un,"getMemberType");function Vn(n,c){return c.length===2?{type:n,left:c[0],right:c[1]}:{type:n,left:c[0],right:Vn(n,c.slice(1))}}p(Vn,"nestResults");let Yr={JsdocTypeOptional:p((n,c)=>({type:"OPTIONAL",value:c(n.element),meta:{syntax:n.meta.position==="prefix"?"PREFIX_EQUAL_SIGN":"SUFFIX_EQUALS_SIGN"}}),"JsdocTypeOptional"),JsdocTypeNullable:p((n,c)=>({type:"NULLABLE",value:c(n.element),meta:{syntax:n.meta.position==="prefix"?"PREFIX_QUESTION_MARK":"SUFFIX_QUESTION_MARK"}}),"JsdocTypeNullable"),JsdocTypeNotNullable:p((n,c)=>({type:"NOT_NULLABLE",value:c(n.element),meta:{syntax:n.meta.position==="prefix"?"PREFIX_BANG":"SUFFIX_BANG"}}),"JsdocTypeNotNullable"),JsdocTypeVariadic:p((n,c)=>{let _={type:"VARIADIC",meta:{syntax:n.meta.position==="prefix"?"PREFIX_DOTS":n.meta.position==="suffix"?"SUFFIX_DOTS":"ONLY_DOTS"}};return n.element!==void 0&&(_.value=c(n.element)),_},"JsdocTypeVariadic"),JsdocTypeName:p(n=>({type:"NAME",name:n.value}),"JsdocTypeName"),JsdocTypeTypeof:p((n,c)=>({type:"TYPE_QUERY",name:c(n.element)}),"JsdocTypeTypeof"),JsdocTypeTuple:p((n,c)=>({type:"TUPLE",entries:n.elements.map(c)}),"JsdocTypeTuple"),JsdocTypeKeyof:p((n,c)=>({type:"KEY_QUERY",value:c(n.element)}),"JsdocTypeKeyof"),JsdocTypeImport:p(n=>({type:"IMPORT",path:{type:"STRING_VALUE",quoteStyle:Mo(n.element.meta.quote),string:n.element.value}}),"JsdocTypeImport"),JsdocTypeUndefined:p(()=>({type:"NAME",name:"undefined"}),"JsdocTypeUndefined"),JsdocTypeAny:p(()=>({type:"ANY"}),"JsdocTypeAny"),JsdocTypeFunction:p((n,c)=>{let _=sr(n),q={type:n.arrow?"ARROW":"FUNCTION",params:_.params.map(ke=>{if(ke.type==="JsdocTypeKeyValue"){if(ke.right===void 0)throw new Error("Function parameter without ':' is not expected to be 'KEY_VALUE'");return{type:"NAMED_PARAMETER",name:ke.key,typeName:c(ke.right)}}else return c(ke)}),new:null,returns:null};return _.this!==void 0?q.this=c(_.this):n.arrow||(q.this=null),_.new!==void 0&&(q.new=c(_.new)),n.returnType!==void 0&&(q.returns=c(n.returnType)),q},"JsdocTypeFunction"),JsdocTypeGeneric:p((n,c)=>{let _={type:"GENERIC",subject:c(n.left),objects:n.elements.map(c),meta:{syntax:n.meta.brackets==="square"?"SQUARE_BRACKET":n.meta.dot?"ANGLE_BRACKET_WITH_DOT":"ANGLE_BRACKET"}};return n.meta.brackets==="square"&&n.elements[0].type==="JsdocTypeFunction"&&!n.elements[0].parenthesis&&(_.objects[0]={type:"NAME",name:"function"}),_},"JsdocTypeGeneric"),JsdocTypeObjectField:p((n,c)=>{if(typeof n.key!="string")throw new Error("Index signatures and mapped types are not supported");if(n.right===void 0)return{type:"RECORD_ENTRY",key:n.key,quoteStyle:Mo(n.meta.quote),value:null,readonly:!1};let _=c(n.right);return n.optional&&(_={type:"OPTIONAL",value:_,meta:{syntax:"SUFFIX_KEY_QUESTION_MARK"}}),{type:"RECORD_ENTRY",key:n.key.toString(),quoteStyle:Mo(n.meta.quote),value:_,readonly:!1}},"JsdocTypeObjectField"),JsdocTypeJsdocObjectField:p(()=>{throw new Error("Keys may not be typed in jsdoctypeparser.")},"JsdocTypeJsdocObjectField"),JsdocTypeKeyValue:p((n,c)=>{if(n.right===void 0)return{type:"RECORD_ENTRY",key:n.key,quoteStyle:"none",value:null,readonly:!1};let _=c(n.right);return n.optional&&(_={type:"OPTIONAL",value:_,meta:{syntax:"SUFFIX_KEY_QUESTION_MARK"}}),{type:"RECORD_ENTRY",key:n.key,quoteStyle:"none",value:_,readonly:!1}},"JsdocTypeKeyValue"),JsdocTypeObject:p((n,c)=>{let _=[];for(let q of n.elements)(q.type==="JsdocTypeObjectField"||q.type==="JsdocTypeJsdocObjectField")&&_.push(c(q));return{type:"RECORD",entries:_}},"JsdocTypeObject"),JsdocTypeSpecialNamePath:p(n=>{if(n.specialType!=="module")throw new Error(`jsdoctypeparser does not support type ${n.specialType} at this point.`);return{type:"MODULE",value:{type:"FILE_PATH",quoteStyle:Mo(n.meta.quote),path:n.value}}},"JsdocTypeSpecialNamePath"),JsdocTypeNamePath:p((n,c)=>{let _=!1,q,ke;n.right.type==="JsdocTypeSpecialNamePath"&&n.right.specialType==="event"?(_=!0,q=n.right.value,ke=Mo(n.right.meta.quote)):(q=n.right.value,ke=Mo(n.right.meta.quote));let Ue={type:Un(n.pathType),owner:c(n.left),name:q,quoteStyle:ke,hasEventPrefix:_};if(Ue.owner.type==="MODULE"){let _t=Ue.owner;return Ue.owner=Ue.owner.value,_t.value=Ue,_t}else return Ue},"JsdocTypeNamePath"),JsdocTypeUnion:p((n,c)=>Vn("UNION",n.elements.map(c)),"JsdocTypeUnion"),JsdocTypeParenthesis:p((n,c)=>({type:"PARENTHESIS",value:c(Yt(n.element))}),"JsdocTypeParenthesis"),JsdocTypeNull:p(()=>({type:"NAME",name:"null"}),"JsdocTypeNull"),JsdocTypeUnknown:p(()=>({type:"UNKNOWN"}),"JsdocTypeUnknown"),JsdocTypeStringValue:p(n=>({type:"STRING_VALUE",quoteStyle:Mo(n.meta.quote),string:n.value}),"JsdocTypeStringValue"),JsdocTypeIntersection:p((n,c)=>Vn("INTERSECTION",n.elements.map(c)),"JsdocTypeIntersection"),JsdocTypeNumber:p(n=>({type:"NUMBER_VALUE",number:n.value.toString()}),"JsdocTypeNumber"),JsdocTypeSymbol:uo,JsdocTypeProperty:uo,JsdocTypePredicate:uo,JsdocTypeMappedType:uo,JsdocTypeIndexSignature:uo,JsdocTypeAsserts:uo};function Er(n){return bn(Yr,n)}p(Er,"jtpTransform");function Ar(){return{JsdocTypeIntersection:p((n,c)=>({type:"JsdocTypeIntersection",elements:n.elements.map(c)}),"JsdocTypeIntersection"),JsdocTypeGeneric:p((n,c)=>({type:"JsdocTypeGeneric",left:c(n.left),elements:n.elements.map(c),meta:{dot:n.meta.dot,brackets:n.meta.brackets}}),"JsdocTypeGeneric"),JsdocTypeNullable:p(n=>n,"JsdocTypeNullable"),JsdocTypeUnion:p((n,c)=>({type:"JsdocTypeUnion",elements:n.elements.map(c)}),"JsdocTypeUnion"),JsdocTypeUnknown:p(n=>n,"JsdocTypeUnknown"),JsdocTypeUndefined:p(n=>n,"JsdocTypeUndefined"),JsdocTypeTypeof:p((n,c)=>({type:"JsdocTypeTypeof",element:c(n.element)}),"JsdocTypeTypeof"),JsdocTypeSymbol:p((n,c)=>{let _={type:"JsdocTypeSymbol",value:n.value};return n.element!==void 0&&(_.element=c(n.element)),_},"JsdocTypeSymbol"),JsdocTypeOptional:p((n,c)=>({type:"JsdocTypeOptional",element:c(n.element),meta:{position:n.meta.position}}),"JsdocTypeOptional"),JsdocTypeObject:p((n,c)=>({type:"JsdocTypeObject",meta:{separator:"comma"},elements:n.elements.map(c)}),"JsdocTypeObject"),JsdocTypeNumber:p(n=>n,"JsdocTypeNumber"),JsdocTypeNull:p(n=>n,"JsdocTypeNull"),JsdocTypeNotNullable:p((n,c)=>({type:"JsdocTypeNotNullable",element:c(n.element),meta:{position:n.meta.position}}),"JsdocTypeNotNullable"),JsdocTypeSpecialNamePath:p(n=>n,"JsdocTypeSpecialNamePath"),JsdocTypeObjectField:p((n,c)=>({type:"JsdocTypeObjectField",key:n.key,right:n.right===void 0?void 0:c(n.right),optional:n.optional,readonly:n.readonly,meta:n.meta}),"JsdocTypeObjectField"),JsdocTypeJsdocObjectField:p((n,c)=>({type:"JsdocTypeJsdocObjectField",left:c(n.left),right:c(n.right)}),"JsdocTypeJsdocObjectField"),JsdocTypeKeyValue:p((n,c)=>({type:"JsdocTypeKeyValue",key:n.key,right:n.right===void 0?void 0:c(n.right),optional:n.optional,variadic:n.variadic}),"JsdocTypeKeyValue"),JsdocTypeImport:p((n,c)=>({type:"JsdocTypeImport",element:c(n.element)}),"JsdocTypeImport"),JsdocTypeAny:p(n=>n,"JsdocTypeAny"),JsdocTypeStringValue:p(n=>n,"JsdocTypeStringValue"),JsdocTypeNamePath:p(n=>n,"JsdocTypeNamePath"),JsdocTypeVariadic:p((n,c)=>{let _={type:"JsdocTypeVariadic",meta:{position:n.meta.position,squareBrackets:n.meta.squareBrackets}};return n.element!==void 0&&(_.element=c(n.element)),_},"JsdocTypeVariadic"),JsdocTypeTuple:p((n,c)=>({type:"JsdocTypeTuple",elements:n.elements.map(c)}),"JsdocTypeTuple"),JsdocTypeName:p(n=>n,"JsdocTypeName"),JsdocTypeFunction:p((n,c)=>{let _={type:"JsdocTypeFunction",arrow:n.arrow,parameters:n.parameters.map(c),constructor:n.constructor,parenthesis:n.parenthesis};return n.returnType!==void 0&&(_.returnType=c(n.returnType)),_},"JsdocTypeFunction"),JsdocTypeKeyof:p((n,c)=>({type:"JsdocTypeKeyof",element:c(n.element)}),"JsdocTypeKeyof"),JsdocTypeParenthesis:p((n,c)=>({type:"JsdocTypeParenthesis",element:c(n.element)}),"JsdocTypeParenthesis"),JsdocTypeProperty:p(n=>n,"JsdocTypeProperty"),JsdocTypePredicate:p((n,c)=>({type:"JsdocTypePredicate",left:c(n.left),right:c(n.right)}),"JsdocTypePredicate"),JsdocTypeIndexSignature:p((n,c)=>({type:"JsdocTypeIndexSignature",key:n.key,right:c(n.right)}),"JsdocTypeIndexSignature"),JsdocTypeMappedType:p((n,c)=>({type:"JsdocTypeMappedType",key:n.key,right:c(n.right)}),"JsdocTypeMappedType"),JsdocTypeAsserts:p((n,c)=>({type:"JsdocTypeAsserts",left:c(n.left),right:c(n.right)}),"JsdocTypeAsserts")}}p(Ar,"identityTransformRules");let $n={JsdocTypeAny:[],JsdocTypeFunction:["parameters","returnType"],JsdocTypeGeneric:["left","elements"],JsdocTypeImport:[],JsdocTypeIndexSignature:["right"],JsdocTypeIntersection:["elements"],JsdocTypeKeyof:["element"],JsdocTypeKeyValue:["right"],JsdocTypeMappedType:["right"],JsdocTypeName:[],JsdocTypeNamePath:["left","right"],JsdocTypeNotNullable:["element"],JsdocTypeNull:[],JsdocTypeNullable:["element"],JsdocTypeNumber:[],JsdocTypeObject:["elements"],JsdocTypeObjectField:["right"],JsdocTypeJsdocObjectField:["left","right"],JsdocTypeOptional:["element"],JsdocTypeParenthesis:["element"],JsdocTypeSpecialNamePath:[],JsdocTypeStringValue:[],JsdocTypeSymbol:["element"],JsdocTypeTuple:["elements"],JsdocTypeTypeof:["element"],JsdocTypeUndefined:[],JsdocTypeUnion:["elements"],JsdocTypeUnknown:[],JsdocTypeVariadic:["element"],JsdocTypeProperty:[],JsdocTypePredicate:["left","right"],JsdocTypeAsserts:["left","right"]};function Cn(n,c,_,q,ke){q?.(n,c,_);let Ue=$n[n.type];for(let _t of Ue){let Qt=n[_t];if(Qt!==void 0)if(Array.isArray(Qt))for(let Zt of Qt)Cn(Zt,n,_t,q,ke);else Cn(Qt,n,_t,q,ke)}ke?.(n,c,_)}p(Cn,"_traverse");function cr(n,c,_){Cn(n,void 0,void 0,c,_)}p(cr,"traverse"),O.catharsisTransform=vr,O.identityTransformRules=Ar,O.jtpTransform=Er,O.parse=Ln,O.stringify=lr,O.stringifyRules=Mn,O.transform=bn,O.traverse=cr,O.tryParse=xr,O.visitorKeys=$n})}),he=p(m=>m.name==="literal","isLiteral"),De=p(m=>m.value.replace(/['|"]/g,""),"toEnumOption"),ze=p(m=>{switch(m.type){case"function":return{name:"function"};case"object":let w={};return m.signature.properties.forEach(O=>{w[O.key]=Le(O.value)}),{name:"object",value:w};default:throw new nt.UnknownArgTypesError({type:m,language:"Flow"})}},"convertSig"),Le=p(m=>{let{name:w,raw:O}=m,ee={};switch(typeof O<"u"&&(ee.raw=O),m.name){case"literal":return{...ee,name:"other",value:m.value};case"string":case"number":case"symbol":case"boolean":return{...ee,name:w};case"Array":return{...ee,name:"array",value:m.elements.map(Le)};case"signature":return{...ee,...ze(m)};case"union":return m.elements?.every(he)?{...ee,name:"enum",value:m.elements?.map(De)}:{...ee,name:w,value:m.elements?.map(Le)};case"intersection":return{...ee,name:w,value:m.elements?.map(Le)};default:return{...ee,name:"other",value:w}}},"convert");function et(m){if(!m||typeof m!="object")return!1;let w=Object.getPrototypeOf(m);return w===null||w===Object.prototype||Object.getPrototypeOf(w)===null?Object.prototype.toString.call(m)==="[object Object]":!1}p(et,"isPlainObject");function kt(m,w){let O={},ee=Object.keys(m);for(let $=0;$<ee.length;$++){let de=ee[$],Ve=m[de];O[de]=w(Ve,de,m)}return O}p(kt,"mapValues");var $t=/^['"]|['"]$/g,xt=p(m=>m.replace($t,""),"trimQuotes"),We=p(m=>$t.test(m),"includesQuotes"),tt=p(m=>{let w=xt(m);return We(m)||Number.isNaN(Number(w))?w:Number(w)},"parseLiteral"),Ne=/^\(.*\) => /,wt=p(m=>{let{name:w,raw:O,computed:ee,value:$}=m,de={};switch(typeof O<"u"&&(de.raw=O),w){case"enum":{let Se=ee?$:$.map(vt=>tt(vt.value));return{...de,name:w,value:Se}}case"string":case"number":case"symbol":return{...de,name:w};case"func":return{...de,name:"function"};case"bool":case"boolean":return{...de,name:"boolean"};case"arrayOf":case"array":return{...de,name:"array",value:$&&wt($)};case"object":return{...de,name:w};case"objectOf":return{...de,name:w,value:wt($)};case"shape":case"exact":let Ve=kt($,Se=>wt(Se));return{...de,name:"object",value:Ve};case"union":return{...de,name:"union",value:$.map(Se=>wt(Se))};case"instanceOf":case"element":case"elementType":default:{if(w?.indexOf("|")>0)try{let Wt=w.split("|").map(ht=>JSON.parse(ht));return{...de,name:"enum",value:Wt}}catch{}let Se=$?`${w}(${$})`:w,vt=Ne.test(w)?"function":"other";return{...de,name:vt,value:Se}}}},"convert"),Bt=p(m=>{switch(m.type){case"function":return{name:"function"};case"object":let w={};return m.signature.properties.forEach(O=>{w[O.key]=Oe(O.value)}),{name:"object",value:w};default:throw new nt.UnknownArgTypesError({type:m,language:"Typescript"})}},"convertSig"),Oe=p(m=>{let{name:w,raw:O}=m,ee={};switch(typeof O<"u"&&(ee.raw=O),m.name){case"string":case"number":case"symbol":case"boolean":return{...ee,name:w};case"Array":return{...ee,name:"array",value:m.elements.map(Oe)};case"signature":return{...ee,...Bt(m)};case"union":let $;return m.elements?.every(de=>de.name==="literal")?$={...ee,name:"enum",value:m.elements?.map(de=>tt(de.value))}:$={...ee,name:w,value:m.elements?.map(Oe)},$;case"intersection":return{...ee,name:w,value:m.elements?.map(Oe)};default:return{...ee,name:"other",value:w}}},"convert"),ae=p(m=>{let{type:w,tsType:O,flowType:ee}=m;try{if(w!=null)return wt(w);if(O!=null)return Oe(O);if(ee!=null)return Le(ee)}catch($){console.error($)}return null},"convert"),ve=(m=>(m.JAVASCRIPT="JavaScript",m.FLOW="Flow",m.TYPESCRIPT="TypeScript",m.UNKNOWN="Unknown",m))(ve||{}),Be=["null","undefined"];function Qe(m){return Be.some(w=>w===m)}p(Qe,"isDefaultValueBlacklisted");var At=p(m=>{if(!m)return"";if(typeof m=="string")return m;throw new Error(`Description: expected string, got: ${JSON.stringify(m)}`)},"str");function Pe(m){return!!m.__docgenInfo}p(Pe,"hasDocgen");function jt(m){return m!=null&&Object.keys(m).length>0}p(jt,"isValidDocgenSection");function it(m,w){return Pe(m)?m.__docgenInfo[w]:null}p(it,"getDocgenSection");function Ge(m){return Pe(m)?At(m.__docgenInfo.description):""}p(Ge,"getDocgenDescription");var B;(function(m){m.start="/**",m.nostart="/***",m.delim="*",m.end="*/"})(B=B||(B={}));function ie(m){return/^\s+$/.test(m)}p(ie,"isSpace");function ot(m){let w=m.match(/\r+$/);return w==null?["",m]:[m.slice(-w[0].length),m.slice(0,-w[0].length)]}p(ot,"splitCR");function Ie(m){let w=m.match(/^\s+/);return w==null?["",m]:[m.slice(0,w[0].length),m.slice(w[0].length)]}p(Ie,"splitSpace");function lt(m){return m.split(/\n/)}p(lt,"splitLines");function dt(m={}){return Object.assign({tag:"",name:"",type:"",optional:!1,description:"",problems:[],source:[]},m)}p(dt,"seedSpec");function Pt(m={}){return Object.assign({start:"",delimiter:"",postDelimiter:"",tag:"",postTag:"",name:"",postName:"",type:"",postType:"",description:"",end:"",lineEnd:""},m)}p(Pt,"seedTokens");var It=/^@\S+/;function Jt({fence:m="```"}={}){let w=io(m),O=p((ee,$)=>w(ee)?!$:$,"toggleFence");return p(function(ee){let $=[[]],de=!1;for(let Ve of ee)It.test(Ve.tokens.description)&&!de?$.push([Ve]):$[$.length-1].push(Ve),de=O(Ve.tokens.description,de);return $},"parseBlock")}p(Jt,"getParser");function io(m){return typeof m=="string"?w=>w.split(m).length%2===0:m}p(io,"getFencer");function Po({startLine:m=0,markers:w=B}={}){let O=null,ee=m;return p(function($){let de=$,Ve=Pt();if([Ve.lineEnd,de]=ot(de),[Ve.start,de]=Ie(de),O===null&&de.startsWith(w.start)&&!de.startsWith(w.nostart)&&(O=[],Ve.delimiter=de.slice(0,w.start.length),de=de.slice(w.start.length),[Ve.postDelimiter,de]=Ie(de)),O===null)return ee++,null;let Se=de.trimRight().endsWith(w.end);if(Ve.delimiter===""&&de.startsWith(w.delim)&&!de.startsWith(w.end)&&(Ve.delimiter=w.delim,de=de.slice(w.delim.length),[Ve.postDelimiter,de]=Ie(de)),Se){let vt=de.trimRight();Ve.end=de.slice(vt.length-w.end.length),de=vt.slice(0,-w.end.length)}if(Ve.description=de,O.push({number:ee,source:$,tokens:Ve}),ee++,Se){let vt=O.slice();return O=null,vt}return null},"parseSource")}p(Po,"getParser");function $o({tokenizers:m}){return p(function(w){var O;let ee=dt({source:w});for(let $ of m)if(ee=$(ee),!((O=ee.problems[ee.problems.length-1])===null||O===void 0)&&O.critical)break;return ee},"parseSpec")}p($o,"getParser");function qo(){return m=>{let{tokens:w}=m.source[0],O=w.description.match(/\s*(@(\S+))(\s*)/);return O===null?(m.problems.push({code:"spec:tag:prefix",message:'tag should start with "@" symbol',line:m.source[0].number,critical:!0}),m):(w.tag=O[1],w.postTag=O[3],w.description=w.description.slice(O[0].length),m.tag=O[2],m)}}p(qo,"tagTokenizer");function Lo(m="compact"){let w=Io(m);return O=>{let ee=0,$=[];for(let[Se,{tokens:vt}]of O.source.entries()){let Wt="";if(Se===0&&vt.description[0]!=="{")return O;for(let ht of vt.description)if(ht==="{"&&ee++,ht==="}"&&ee--,Wt+=ht,ee===0)break;if($.push([vt,Wt]),ee===0)break}if(ee!==0)return O.problems.push({code:"spec:type:unpaired-curlies",message:"unpaired curlies",line:O.source[0].number,critical:!0}),O;let de=[],Ve=$[0][0].postDelimiter.length;for(let[Se,[vt,Wt]]of $.entries())vt.type=Wt,Se>0&&(vt.type=vt.postDelimiter.slice(Ve)+Wt,vt.postDelimiter=vt.postDelimiter.slice(0,Ve)),[vt.postType,vt.description]=Ie(vt.description.slice(Wt.length)),de.push(vt.type);return de[0]=de[0].slice(1),de[de.length-1]=de[de.length-1].slice(0,-1),O.type=w(de),O}}p(Lo,"typeTokenizer");var hn=p(m=>m.trim(),"trim");function Io(m){return m==="compact"?w=>w.map(hn).join(""):m==="preserve"?w=>w.join(`
`):m}p(Io,"getJoiner");var en=p(m=>m&&m.startsWith('"')&&m.endsWith('"'),"isQuoted");function wo(){let m=p((w,{tokens:O},ee)=>O.type===""?w:ee,"typeEnd");return w=>{let{tokens:O}=w.source[w.source.reduce(m,0)],ee=O.description.trimLeft(),$=ee.split('"');if($.length>1&&$[0]===""&&$.length%2===1)return w.name=$[1],O.name=`"${$[1]}"`,[O.postName,O.description]=Ie(ee.slice(O.name.length)),w;let de=0,Ve="",Se=!1,vt;for(let ht of ee){if(de===0&&ie(ht))break;ht==="["&&de++,ht==="]"&&de--,Ve+=ht}if(de!==0)return w.problems.push({code:"spec:name:unpaired-brackets",message:"unpaired brackets",line:w.source[0].number,critical:!0}),w;let Wt=Ve;if(Ve[0]==="["&&Ve[Ve.length-1]==="]"){Se=!0,Ve=Ve.slice(1,-1);let ht=Ve.split("=");if(Ve=ht[0].trim(),ht[1]!==void 0&&(vt=ht.slice(1).join("=").trim()),Ve==="")return w.problems.push({code:"spec:name:empty-name",message:"empty name",line:w.source[0].number,critical:!0}),w;if(vt==="")return w.problems.push({code:"spec:name:empty-default",message:"empty default value",line:w.source[0].number,critical:!0}),w;if(!en(vt)&&/=(?!>)/.test(vt))return w.problems.push({code:"spec:name:invalid-default",message:"invalid default value syntax",line:w.source[0].number,critical:!0}),w}return w.optional=Se,w.name=Ve,O.name=Wt,vt!==void 0&&(w.default=vt),[O.postName,O.description]=Ie(ee.slice(O.name.length)),w}}p(wo,"nameTokenizer");function Wo(m="compact",w=B){let O=tn(m);return ee=>(ee.description=O(ee.source,w),ee)}p(Wo,"descriptionTokenizer");function tn(m){return m==="compact"?Co:m==="preserve"?Go:m}p(tn,"getJoiner");function Co(m,w=B){return m.map(({tokens:{description:O}})=>O.trim()).filter(O=>O!=="").join(" ")}p(Co,"compactJoiner");var Oo=p((m,{tokens:w},O)=>w.type===""?m:O,"lineNo"),on=p(({tokens:m})=>(m.delimiter===""?m.start:m.postDelimiter.slice(1))+m.description,"getDescription");function Go(m,w=B){if(m.length===0)return"";m[0].tokens.description===""&&m[0].tokens.delimiter===w.start&&(m=m.slice(1));let O=m[m.length-1];return O!==void 0&&O.tokens.description===""&&O.tokens.end.endsWith(w.end)&&(m=m.slice(0,-1)),m=m.slice(m.reduce(Oo,0)),m.map(on).join(`
`)}p(Go,"preserveJoiner");function Fo({startLine:m=0,fence:w="```",spacing:O="compact",markers:ee=B,tokenizers:$=[qo(),Lo(O),wo(),Wo(O)]}={}){if(m<0||m%1>0)throw new Error("Invalid startLine");let de=Po({startLine:m,markers:ee}),Ve=Jt({fence:w}),Se=$o({tokenizers:$}),vt=tn(O);return function(Wt){let ht=[];for(let On of lt(Wt)){let fn=de(On);if(fn===null)continue;let kn=Ve(fn),_n=kn.slice(1).map(Se);ht.push({description:vt(kn[0],ee),tags:_n,source:fn,problems:_n.reduce((Yn,an)=>Yn.concat(an.problems),[])})}return ht}}p(Fo,"getParser");function So(m){return m.start+m.delimiter+m.postDelimiter+m.tag+m.postTag+m.type+m.postType+m.name+m.postName+m.description+m.end+m.lineEnd}p(So,"join");function xo(){return m=>m.source.map(({tokens:w})=>So(w)).join(`
`)}p(xo,"getStringifier");var Xo={line:0,start:0,delimiter:0,postDelimiter:0,tag:0,postTag:0,name:0,postName:0,type:0,postType:0,description:0,end:0,lineEnd:0},Ko=Object.keys(Xo);function y(m,w={}){return Fo(w)(m)}p(y,"parse");var T=xo(),ce=yt(He(),1);function se(m){return m!=null&&m.includes("@")}p(se,"containsJsDoc");function mt(m){let w=`/**
`+(m??"").split(`
`).map(ee=>` * ${ee}`).join(`
`)+`
*/`,O=y(w,{spacing:"preserve"});if(!O||O.length===0)throw new Error("Cannot parse JSDoc tags.");return O[0]}p(mt,"parse");var s={tags:["param","arg","argument","returns","ignore","deprecated"]},M=p((m,w=s)=>{if(!se(m))return{includesJsDoc:!1,ignore:!1};let O=mt(m),ee=N(O,w.tags);return ee.ignore?{includesJsDoc:!0,ignore:!0}:{includesJsDoc:!0,ignore:!1,description:O.description.trim(),extractedTags:ee}},"parseJsDoc");function N(m,w){let O={params:null,deprecated:null,returns:null,ignore:!1};for(let ee of m.tags)if(!(w!==void 0&&!w.includes(ee.tag)))if(ee.tag==="ignore"){O.ignore=!0;break}else switch(ee.tag){case"param":case"arg":case"argument":{let $=P(ee);$!=null&&(O.params==null&&(O.params=[]),O.params.push($));break}case"deprecated":{let $=R(ee);$!=null&&(O.deprecated=$);break}case"returns":{let $=v(ee);$!=null&&(O.returns=$);break}default:break}return O}p(N,"extractJsDocTags");function C(m){return m.replace(/[\.-]$/,"")}p(C,"normaliseParamName");function P(m){if(!m.name||m.name==="-")return null;let w=J(m.type);return{name:m.name,type:w,description:te(m.description),getPrettyName:p(()=>C(m.name),"getPrettyName"),getTypeName:p(()=>w?D(w):null,"getTypeName")}}p(P,"extractParam");function R(m){return m.name?G(m.name,m.description):null}p(R,"extractDeprecated");function G(m,w){let O=m===""?w:`${m} ${w}`;return te(O)}p(G,"joinNameAndDescription");function te(m){let w=m.replace(/^- /g,"").trim();return w===""?null:w}p(te,"normaliseDescription");function v(m){let w=J(m.type);return w?{type:w,description:G(m.name,m.description),getTypeName:p(()=>D(w),"getTypeName")}:null}p(v,"extractReturns");var pe=(0,ce.stringifyRules)(),K=pe.JsdocTypeObject;pe.JsdocTypeAny=()=>"any",pe.JsdocTypeObject=(m,w)=>`(${K(m,w)})`,pe.JsdocTypeOptional=(m,w)=>w(m.element),pe.JsdocTypeNullable=(m,w)=>w(m.element),pe.JsdocTypeNotNullable=(m,w)=>w(m.element),pe.JsdocTypeUnion=(m,w)=>m.elements.map(w).join("|");function J(m){try{return(0,ce.parse)(m,"typescript")}catch{return null}}p(J,"extractType");function D(m){return(0,ce.transform)(pe,m)}p(D,"extractTypeName");var H=90,me=50;function oe(m){return m.length>90}p(oe,"isTooLongForTypeSummary");function Ze(m){return m.length>50}p(Ze,"isTooLongForDefaultValueSummary");function Ee(m,w){return m===w?{summary:m}:{summary:m,detail:w}}p(Ee,"createSummaryValue");var bt=null;function St(m,w){if(m!=null){let{value:O}=m;if(!Qe(O))return Ze(O)?Ee(w?.name,O):Ee(O)}return null}p(St,"createDefaultValue");function Dt({name:m,value:w,elements:O,raw:ee}){return w??(O!=null?O.map(Dt).join(" | "):ee??m)}p(Dt,"generateUnionElement");function Ot({name:m,raw:w,elements:O}){return O!=null?Ee(O.map(Dt).join(" | ")):w!=null?Ee(w.replace(/^\|\s*/,"")):Ee(m)}p(Ot,"generateUnion");function po({type:m,raw:w}){return w!=null?Ee(w):Ee(m)}p(po,"generateFuncSignature");function qt({type:m,raw:w}){return w!=null?oe(w)?Ee(m,w):Ee(w):Ee(m)}p(qt,"generateObjectSignature");function Ut(m){let{type:w}=m;return w==="object"?qt(m):po(m)}p(Ut,"generateSignature");function Kt({name:m,raw:w}){return w!=null?oe(w)?Ee(m,w):Ee(w):Ee(m)}p(Kt,"generateDefault");function ut(m){if(m==null)return null;switch(m.name){case"union":return Ot(m);case"signature":return Ut(m);default:return Kt(m)}}p(ut,"createType");var Vt=p((m,w)=>{let{flowType:O,description:ee,required:$,defaultValue:de}=w;return{name:m,type:ut(O),required:$,description:ee,defaultValue:St(de??null,O??null)}},"createFlowPropDef");function yo({defaultValue:m}){if(m!=null){let{value:w}=m;if(!Qe(w))return Ee(w)}return null}p(yo,"createDefaultValue");function to({tsType:m,required:w}){if(m==null)return null;let O=m.name;return w||(O=O.replace(" | undefined","")),Ee(["Array","Record","signature"].includes(m.name)?m.raw:O)}p(to,"createType");var nn=p((m,w)=>{let{description:O,required:ee}=w;return{name:m,type:to(w),required:ee,description:O,defaultValue:yo(w)}},"createTsPropDef");function at(m){return m!=null?Ee(m.name):null}p(at,"createType");function ye(m){let{computed:w,func:O}=m;return typeof w>"u"&&typeof O>"u"}p(ye,"isReactDocgenTypescript");function fe(m){return m?m.name==="string"?!0:m.name==="enum"?Array.isArray(m.value)&&m.value.every(({value:w})=>typeof w=="string"&&w[0]==='"'&&w[w.length-1]==='"'):!1:!1}p(fe,"isStringValued");function Je(m,w){if(m!=null){let{value:O}=m;if(!Qe(O))return ye(m)&&fe(w)?Ee(JSON.stringify(O)):Ee(O)}return null}p(Je,"createDefaultValue");function Ce(m,w,O){let{description:ee,required:$,defaultValue:de}=O;return{name:m,type:at(w),required:$,description:ee,defaultValue:Je(de,w)}}p(Ce,"createBasicPropDef");function Re(m,w){if(w?.includesJsDoc){let{description:O,extractedTags:ee}=w;O!=null&&(m.description=w.description);let $={...ee,params:ee?.params?.map(de=>({name:de.getPrettyName(),description:de.description}))};Object.values($).filter(Boolean).length>0&&(m.jsDocTags=$)}return m}p(Re,"applyJsDocResult");var je=p((m,w,O)=>{let ee=Ce(m,w.type,w);return ee.sbType=ae(w),Re(ee,O)},"javaScriptFactory"),Me=p((m,w,O)=>{let ee=nn(m,w);return ee.sbType=ae(w),Re(ee,O)},"tsFactory"),we=p((m,w,O)=>{let ee=Vt(m,w);return ee.sbType=ae(w),Re(ee,O)},"flowFactory"),Ct=p((m,w,O)=>{let ee=Ce(m,{name:"unknown"},w);return Re(ee,O)},"unknownFactory"),zt=p(m=>{switch(m){case"JavaScript":return je;case"TypeScript":return Me;case"Flow":return we;default:return Ct}},"getPropDefFactory"),Ft=p(m=>m.type!=null?"JavaScript":m.flowType!=null?"Flow":m.tsType!=null?"TypeScript":"Unknown","getTypeSystem"),No=p(m=>{let w=Ft(m[0]),O=zt(w);return m.map(ee=>{let $=ee;return ee.type?.elements&&($={...ee,type:{...ee.type,value:ee.type.elements}}),go($.name,$,w,O)})},"extractComponentSectionArray"),vo=p(m=>{let w=Object.keys(m),O=Ft(m[w[0]]),ee=zt(O);return w.map($=>{let de=m[$];return de!=null?go($,de,O,ee):null}).filter(Boolean)},"extractComponentSectionObject"),gn=p((m,w)=>{let O=it(m,w);return jt(O)?Array.isArray(O)?No(O):vo(O):[]},"extractComponentProps");function go(m,w,O,ee){let $=M(w.description);return $.includesJsDoc&&$.ignore?null:{propDef:ee(m,w,$),jsDocTags:$.extractedTags,docgenInfo:w,typeSystem:O}}p(go,"extractProp");function Ht(m){return m!=null?Ge(m):""}p(Ht,"extractComponentDescription");var rn=p((...m)=>{let w={},O=m.filter(Boolean),ee=O.reduce(($,de)=>(Object.entries(de).forEach(([Ve,Se])=>{let vt=$[Ve];Array.isArray(Se)||typeof vt>"u"?$[Ve]=Se:et(Se)&&et(vt)?w[Ve]=!0:typeof Se<"u"&&($[Ve]=Se)}),$),{});return Object.keys(w).forEach($=>{let de=O.filter(Boolean).map(Ve=>Ve[$]).filter(Ve=>typeof Ve<"u");de.every(Ve=>et(Ve))?ee[$]=rn(...de):ee[$]=de[de.length-1]}),ee},"combineParameters"),Xn=p(m=>{let{component:w,argTypes:O,parameters:{docs:ee={}}}=m,{extractArgTypes:$}=ee;if(!$||!w)return O;let de=$(w);return de?rn(de,O):O},"enhanceArgTypes"),Kn="storybook/docs",Br=null,Pr="docs",Hn=`${Kn}/snippet-rendered`,In=(m=>(m.AUTO="auto",m.CODE="code",m.DYNAMIC="dynamic",m))(In||{})}),"../../../node_modules/.pnpm/style-loader@2.0.0_webpack@5.101.3/node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js":((Nt,ue,W)=>{var nt=(function(){var De;return function(){return typeof De>"u"&&(De=!!(window&&document&&document.all&&!window.atob)),De}})(),X=(function(){var De={};return function(Le){if(typeof De[Le]>"u"){var et=document.querySelector(Le);if(window.HTMLIFrameElement&&et instanceof window.HTMLIFrameElement)try{et=et.contentDocument.head}catch{et=null}De[Le]=et}return De[Le]}})(),re=[];function Ke(he){for(var De=-1,ze=0;ze<re.length;ze++)if(re[ze].identifier===he){De=ze;break}return De}function st(he,De){for(var ze={},Le=[],et=0;et<he.length;et++){var kt=he[et],$t=De.base?kt[0]+De.base:kt[0],xt=ze[$t]||0,We="".concat($t," ").concat(xt);ze[$t]=xt+1;var tt=Ke(We),Ne={css:kt[1],media:kt[2],sourceMap:kt[3]};tt!==-1?(re[tt].references++,re[tt].updater(Ne)):re.push({identifier:We,updater:He(Ne,De),references:1}),Le.push(We)}return Le}function pt(he){var De=document.createElement("style"),ze=he.attributes||{};if(typeof ze.nonce>"u"){var Le=W.nc;Le&&(ze.nonce=Le)}if(Object.keys(ze).forEach(function(kt){De.setAttribute(kt,ze[kt])}),typeof he.insert=="function")he.insert(De);else{var et=X(he.insert||"head");if(!et)throw new Error("Couldn't find a style target. This probably means that the value for the 'insert' parameter is invalid.");et.appendChild(De)}return De}function rt(he){if(he.parentNode===null)return!1;he.parentNode.removeChild(he)}var Et=(function(){var De=[];return function(Le,et){return De[Le]=et,De.filter(Boolean).join(`
