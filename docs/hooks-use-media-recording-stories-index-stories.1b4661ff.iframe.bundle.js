...
export const Default = Template.bind({});
Default.args = DefaultArgs;
export default meta;`,locationsMap:{default:{startLoc:{col:17,line:99},endLoc:{col:2,line:101},startBody:{col:17,line:99},endBody:{col:2,line:101}}}}},title:"JS Packages/AI Client/useMediaRecording",component:R,argTypes:{timeslice:{control:{type:"number"}}}},F=y=>(0,t.jsx)(R,{...y}),J={timeslice:1e3},u=F.bind({});u.args=J;const K=j,V=["Default"];u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:"args => <RecorderComponent {...args} />",...u.parameters?.docs?.source}}}},"../ai-client/src/components/audio-duration-display/index.tsx":(z,v,s)=>{s.d(v,{A:()=>n});function l(o,{addDecimalPart:f=!1,showMinutes:b=!0,showHours:D=!1}={}){const t=Math.floor(o/36e5),E=Math.floor(o/6e4)%60,P=Math.floor(o/1e3)%60,R=Math.floor(o/10)%100,j=[t>0||D?t.toString().padStart(2,"0")+":":"",t>0||E>0||b?E.toString().padStart(2,"0")+":":"",P.toString().padStart(2,"0")];return f&&j.push("."+R.toString().padStart(2,"0")),j.join("")}var h=s("../../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");function n({duration:o,className:f}){return(0,h.jsx)("span",{className:f,children:l(o,{addDecimalPart:!1})})}try{audiodurationdisplay.displayName="audiodurationdisplay",audiodurationdisplay.__docgenInfo={description:"AudioDurationDisplay component.",displayName:"audiodurationdisplay",props:{duration:{defaultValue:null,description:"",name:"duration",required:!0,type:{name:"number"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["../ai-client/src/components/audio-duration-display/index.tsx#audiodurationdisplay"]={docgenInfo:audiodurationdisplay.__docgenInfo,name:"audiodurationdisplay",path:"../ai-client/src/components/audio-duration-display/index.tsx#audiodurationdisplay"})}catch{}}}]);
