...
`,n={Default:{startLoc:{col:17,line:22},endLoc:{col:2,line:32},startBody:{col:17,line:22},endBody:{col:2,line:32}}};const t=["medium","small"],o={parameters:{storySource:{source:`import { Title } from '../index.js';
import styles from './style.module.scss';
